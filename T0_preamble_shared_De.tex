...
% =============================================================================
% SECTION 2: Page Geometry (Kindle-optimized with larger margins)
% =============================================================================
\usepackage[a4paper, left=3cm, right=3cm, top=3cm, bottom=3.5cm]{geometry}
\setlength{\headheight}{15pt}

% =============================================================================
% Hyphenation and Line Breaking for Kindle Compatibility
% =============================================================================
% Enable better hyphenation for long German compound words
\usepackage{hyphenat}
\sloppy                     % More tolerant line breaking
\emergencystretch=2em      % Balanced stretch to avoid overfull boxes
\hyphenpenalty=1000        % Moderate hyphenation (not too aggressive)
\tolerance=5000            % Reasonable tolerance for word spacing
\hbadness=3000            % Reasonable threshold for warnings

% Allow breaking at more points in compound words
\hyphenchar\font=45        % Use hyphen character
\lccode`\-=`\-            % Make hyphen a lowercase letter for hyphenation
...
% Prevent inline math from being scaled down - enforce readable sizes
% Alternative approach to avoid halign errors: selectively use \textstyle where needed
\everymath{\displaystyle}  % Use display style in all inline math for readability
...
\DeclareSIUnit\kilolightyear{kly}
\DeclareSIUnit\megalightyear{Mly}
\DeclareSIUnit\gigalightyear{Gly}
\DeclareSIUnit\mev{MeV}
\DeclareSIUnit\gev{GeV}
\DeclareSIUnit\tev{TeV}
...
\hfuzz=2pt  % Only suppress trivial overfull warnings (Kindle needs readable text!)
\vfuzz=2pt  
\tolerance=5000  % Moderate tolerance - not too aggressive
\emergencystretch=2em  % Reasonable stretch to avoid overfull boxes
\hbadness=3000  % Moderate threshold for underfull box warnings
\vbadness=3000  % Moderate threshold for underfull vbox warnings
\raggedbottom

% Ensure minimum font size for Kindle readability (7pt minimum)
