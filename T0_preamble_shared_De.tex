...
% Note: \everymath{\displaystyle} causes \halign errors with align environments
% Better approach: Use minimum font sizes and let LaTeX handle display math naturally
