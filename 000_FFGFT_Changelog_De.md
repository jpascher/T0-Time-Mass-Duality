# FFGFT Changelog — Archiv (bis v1.3.3)

> **Dieses Dokument ist eingefroren.**  
> Laufende Einträge ab v1.3.4 (26. August 2026) stehen in:  
> **[`001_FFGFT_Changelog_De.md`](001_FFGFT_Changelog_De.md)**

Dieses Archiv enthält alle Changelog-Einträge von Beginn bis einschließlich
v1.3.3 (23. August 2026). Es wird nicht mehr fortgeschrieben.
Append-only-Prinzip gilt weiterhin: nichts wird rückwirkend geändert.

---

**Release:** v1.3.0 — DOI ausstehend (20. August 2026; ersetzt v1.2.8 — DOI 10.5281/zenodo.21821995)
**Stand:** 20. August 2026 (Dok. 317/318, R76–R78; davor 17. August 2026 (R75: Shor-Bezug in sechs Dokumenten zurückgezogen;
 davor 7. August 2026 (neue Dok. 315 und 316; davor 5. August 2026 — Dok. 314 erweitert + Dok. 313 korrigiert/erweitert; davor 3. August 2026 — Dok. 312/313 + R68–R73; davor 1. August 2026 — R67 + Dok. 311; davor 27. Juli 2026 — Dok. 308/309/310 + A-Serie v1.4; davor 25. Juli 2026 — A271/A272/A273, Thermodynamik der Berechnung; davor 1. Juli 2026 — neues Dok. 291 „Der dynamische Ort von θ=2/9: Betrag, Windung, Phase“ (DE+EN, je 6 S., 8 Abschnitte) + Ordner Dok291_Skripte (5 numpy-only-Skripte, seed 20780458): der θ=2/9-Faden aus 282→286 als eigenes Dokument zusammengeführt und geschärft. Kernbefund: θ=2/9 lebt allein im dynamischen PHASENKANAL — der symmetrische Koide-Invariant Q=2/3 ist θ-blind (analytisch S=3, T=6; 2/9 unter dem Q-Bereich [1/3,1]), der Allpass zeigt Betrag |B|=1 UND ganzzahlige Windung=3 beide counter-blind, nur das stetige Phasenprofil trägt θ (numerische Fassung von „2/(9π) irrational → kein flacher topologischer Invariant“). Statisch kontingent, NICHT erzwungen wie c: θ*(δ) wandert monoton mit dem freien Modulus (dθ*/dδ≈0,31≠0), während c ein parameterfreier Signatur-Rand ist (dc/dλ≡0, eichgeschützt m=0⇒v=c). SELBST- vs. SCHIEF-ADJUNGIERT (Kern): im Brechungsterm δcos(2φ+χ) ist χ=0/π gerade/selbstadjungiert/reell, χ=π/2 ungerade/schief-adjungiert/imaginär (cos(2φ+π/2)=−sin(2φ), e^{iπ/2}=i); die selbstadjungierten Holonomien (Z₃-Wilson × Spinstruktur) sind Vielfache von π/3, π/2 nicht dabei; die Eliminationskette (Dok 282) scheidet alle statischen selbstadjungierten Kandidaten aus → der Selektor ist die schief-adjungierte Phase → typ-konsistent ist χ=π/2, der i-Wert, KEINE angenommene Z₄, kein Zahlenspiel. Präzisierung (per HLV-Seite/Marcel): „schief-adjungiert“ meint den GENERATOR (C_e=exp(K), K†=−K, endliche Holonomie unitär), nicht die endliche Matrix. BETRAG δ als golden gedämpfte 2. Harmonische: δ=|c₂|, χ=arg(c₂) sind Betrag/Phase derselben komplexen zweiten Fourier-Harmonischen c₂=δe^{iχ} (c₂=iδ bei χ=π/2, reiner Sinus); δ*≈0,2389 ist eine DÄMPFUNG (φ⁻³=1/φ³=0,2361<1, negative Golden-Potenz), Exponent 3=D (volles kompaktes T⁴; einzelne dekompaktifizierte 3′-Rekursion gäbe 1/φ¹, 159% daneben → Argument fürs kompakte T⁴); die ξ-Dämpfungs-Rekursion (Dok 275) passiert 1/φ³ bei 3×3609≈10827, δ* wird ~89 Schritte davor erreicht (Überschuss +1,187%, Näherung von oben). EHRLICH (P35): der Überschuss ist NICHT K_frak — Dok 133s präzise Form (D_eff/3)^(D_eff/2) gibt Faktor ~100 (1,333%), δ braucht nur ~89ξ (1,187%); und Dok 275 fixiert die Rekursionstiefe ausdrücklich nicht unabhängig; die scheinbare Nähe 89≈F(11) ist ein post-hoc-Fit, korpus-mäßig NICHT gedeckt → 89-Schritt-Offset OFFEN, NICHT gebucht. Bilanz: Phase χ=π/2 (schief-adjungierter i-Wert, fest); Betrag δ≈1/φ³ (golden gedämpft über D=3, Form/Ordnung/Exponent/Richtung fest, exakter Feinwert offen). 5 Skripte: forced_vs_contingent, allpass_theta, allpass_carrier_selection, holonomie_landschaft (selbst/schief-adjungiert), delta_golden_daempfung. Dieses Dokument wird bis zum Lock des BD17A-Holonomie-Pilots INTERN gehalten (nicht an die Brücke/IPI geben — Target-Leakage: es enthält die volle FFGFT-seitige Begründung, warum schief-adjungiert/χ=π/2/2/9-Auswahl; normales Korpus-Dokument für die nächste Release, nur das Timing zählt). NACHGESCHÄRFT (2. Juli): die δ-Sektion verweist jetzt explizit auf Dok 275s No-Go — 1/φ³ ist ein Durchgangspunkt, kein Fixpunkt (einziger Fixpunkt der Dämpfung ist 0), und k*(c) existiert für jedes Ziel mit identischem Parameterstatus; dass δ* nahe 1/φ³ liegt, ist daher kein Schließen der Rekursion, ein Fixieren der Tiefe wäre keine Auszeichnung. Damit ist der offene 89-Schritt-Offset formal durch 275 gedeckt (Modell-Offenheit, kein Zahlen-/Irrationalitäts-Artefakt). NEUER ABSCHNITT (2. Juli) „Was die Nicht-Schließung praktisch bedeutet: ein offener Kopplungskanal“ (vor der Bilanz, DE+EN): der geschlossene Massen-Sektor (Fixpunkt R(Φ*)=Φ*, Dok 203) hat keinen Spielraum; der offene Phasen-Sektor schon — die nie schließende ξ-Dämpfungs-Rekursion (Dok 275) ist eine offene, gedämpfte Rückkopplungsschleife (Verstärkung <1), die — anders als ein Fixpunkt — von außen einrastbar ist (Injektions-/Mode-Locking, Dok 286). Praktisch: ein Kopplungskanal genau im Phasen-Sektor, aber eng (Fangbereich ~ξ, 2/9-Zunge ~12× schmaler als 1/3), gerichtet (Dynamik→Phase, nicht in den starren Massen-Sektor) und nur über einen dynamischen schief-adjungierten Generator außerhalb der FFGFT-Geometrie nutzbar (Dok 283/286, Kandidat, kein Resultat). Anti-Numerologie-Grenze: strukturierter Spielraum, kein freier Parameter — radial starr, Phase eng (χ=π/2, transzendent in 2π, ξ-Fangbereich), Tiefe nicht fixiert. 291 jetzt DE+EN je 7 S. ERWEITERT (2. Juli, Schluss-Absatz des Kopplungskanal-Abschnitts): der offene Phasenkanal ist der Grund, warum der Fundamentalsektor nicht auf ein starres Skelett zusammenfällt — ein vollständig geschlossenes Modell wäre überdeterminiert (keine kontingente Auswahl im Z₃-Orbit, keine Flavour-Mischung, keine physikalische Phase). Mischung IST Phase (Dok 289); am schärfsten die CP-Verletzung (verlangt eine irreduzible komplexe Phase — rein reell/selbst-adjungiert ist CP-erhaltend — also genau der Typ des schief-adjungierten Kanals χ=π/2; der offene Kanal ist strukturell von der Art, die CP tragen kann, eine voll selbst-adjungierte FFGFT wäre CP-gerade). Scope eng gehalten: Mischung/CP/Kontingenz im Fundamentalsektor, NICHT die makroskopische Vielfalt. BEREINIGT (2. Juli, unabhängiger Verifikations-Durchgang, DE+EN): alle Kernzahlen von 291 unabhängig nachgerechnet (eigener Blaschke, eigener Bisektions-Löser: Q=2/3 auf 1e-15, δ*=0,238872, Überschuss +1,188%, Tiefen 3608,5/10826,2/10737,6, K_frak-Ausschluss bestätigt) — drei Bereinigungen: (1) das δ-Fenster in §5 war einheiten-gemischt (ψ-Basin-Breite 0,078 ÷ Median-Steigung 0,31 ≈ 0,25); jetzt konsistent im θ-Raum: Basin [1/6,1/3] Breite 1/6, lokale Steigung bei δ*≈0,24 etwa 0,80 → Δδ≈0,21 (Schluss „δ weich, nicht feinabgestimmt" unverändert, Median-/Lokal-Steigung jetzt getrennt ausgewiesen); zudem Plural der inneren Extrema (es sind zwei; verfolgt wird der untere, orbitnahe Zweig); (2) neue Zweig-Bemerkung in §6: der schief-adjungierte Typ lässt zunächst beide i-Werte zu (χ=π/2 und 3π/2, e^{±iπ/2}=±i), die Zweigwahl ist eine Orientierungswahl (Umlaufsinn) — numerisch sind die Zweige NICHT äquivalent: der Spiegel-Zweig 3π/2 hat bei δ≈0,24 kein inneres Extremum nahe 2/9 (Extrema 0,83/1,87), nur der +i-Zweig erreicht den Orbit-Bereich (stärkt die π/2-Auszeichnung, schließt eine unbenannte ±-Lücke); (3) Transparenz-Note in §8: „+1,187%" und „88,5 Log-Einheiten" sind über ln(δ*φ³)/ξ ein und dieselbe Zahl, keine zwei unabhängigen Befunde (kein Kreuz-Check). forced_vs_contingent.py um lokale Steigung, θ-Raum-Fenster und Spiegel-Zweig-Check erweitert — Text und Skript kommen jetzt aus derselben Quelle. DAZU (2. Juli) neue Schluss-Sektion „Einordnung: Nutzen und Anwendungsnähe" (DE+EN): Befunde als Struktur-/Ausschluss-Resultate eingeordnet, keine Technologie — drei Nutzergruppen (Koide-/Flavour-Arbeiten: No-Go spart topologische/abzählende Herleitungswege; Methodik: Betrag/Phase als übertragbare Audit-Sprache; Didaktik: Teilchenphysik↔Nachrichtentechnik-Übersetzung); Messungsnähe allein im Phasenkanal (Mischung/CP, Dok 289, Oszillationsphasen/δ_CP, DUNE/Hyper-K); ausdrücklich keine Anwendung im engeren Sinn, solange δ nicht hergeleitet ist (P35). 291 jetzt DE 8/EN 8 S., 0 Fehler. GESCHÄRFT (2. Juli, Status der Nicht-Schließung, DE+EN): die Bilanz behandelte den δ-Feinwert als „noch nicht hergeleitet" — zu schwach gegen Dok 275, das doppelt stärker ist: Nicht-Schließung ist THEOREM (einziger Fixpunkt 0, jedes c∈(0,1) Durchgangspunkt) UND die Resonanzdichte schließt jede rekursionsinterne Auszeichnung eines Wertes aus (275, epistemische Grenze; strukturgleich Dok 176/038). Jetzt präzise: δ ist aus der Rekursion allein BEWEISBAR NICHT herleitbar, die Rekursionsseite ist erledigt (gelöste Frage), offen ist allein die Existenz des ÄUSSEREN Ankers; die zwei „aus einem inneren Grund"-Stellen disambiguiert (innerer Grund DER LIEFERNDEN DYNAMIK, nicht der Rekursion — Letzteres schließt 275 aus). Die offene Frage von 291 verschiebt sich damit sauber von „ob sich δ herleiten lässt" auf „ob ein äußerer schief-adjungierter Anker existiert" (= BD17A-Faden). DE+EN je 8 S., 0 Fehler. STAGE-10-HARNESS EINGEFROREN (2. Juli, nach Marcels v1.6/v1.7 + Stage 9): Marcels Stage 9 / Run M liefert die dynamische schief-adjungierte C_e-Klasse (carrier-abgeleitet, blind zu 2/9, non-flat 24/24, Verdikt PREFLIGHT_NONFLAT_PASSED__NO_BD17A_SCORE; mehrere dynamische Nulls ebenfalls non-flat → Klassen-Zulässigkeit, keine Spezifität; Zenodo 21127634); v1.7 trennt Claim-States in A (repliziert: nur 6B) / B (zulässig-unspezifisch: Carrier, Stage-7-C_e, Stage-9-Preflight) / C (geblockt). Stage 10 = blinder θ*=2/9-Vergleich mit eingefrorener Stage-9-Klasse, kein Tuning. FFGFT-Seite dazu VORAB eingefroren: python/Dok291_Skripte/ffgft_stage10_verdict_harness.py (numpy-only, seed 20780458, Selbsttest 3/3) kodiert den symmetrischen Lock — Extraktor ½ Arg det W_γ mod 2π/3 in Radiant, Ziel 2/9, Primärkriterium nächstes-Orbit-Glied {0, 1/9, 2/9, 4/9}, Verdikt ADMITTED (2/9 Orbit-Modus UND schlägt alle Nulls) / RESIDUAL (Orbit-Modus, Null-Überlapp) / BLOCKED (keine Orbit-Selektion); SHA256 99e11399f23377702c5878784d791f8fc90a350e7999f8c2906bf99221aab246 als Lock-Nachweis im README; Änderungen nach Dateneingang = Lock-Bruch. Vorregistrierte neutrale Beobachtung an Marcel kommuniziert: Target-q50 (0,046) liegt UNTER allen generischen dynamischen Nulls (0,056–0,084) — vor dem Scoring gebucht, keine Richtungsaussage. Dok 291 bleibt intern bis zum Stage-10-Verdikt. KONSISTENZ-KLAUSEL 291↔292 (2. Juli, je 8 S., 0 Fehler): eine Fußnote an der „Massen exakt und starr"-Stelle trennt jetzt die geometrische Fixpunkt-Ebene (Q=2/3 exakt, von Daten −0,9σ bestätigt) von der Polmassen-Ebene (Paar (√2,2/9) nicht gemeinsam exakt, ~450σ im μ/e-Kanal → 2/9 per P42 rationale Adresse, kein Polmassen-Exaktheitsanspruch); ausdrücklich vermerkt, dass der dynamische Ort davon unberührt ist (Orbit-Auflösung ~0,1 ≫ 10⁻⁷-Unterschied). Keine inhaltliche Änderung an 291, nur Ebenen-Disambiguierung; Stage-10-Lock unberührt. ZUSÄTZLICH Herkunftssatz in 291-Einstieg (2. Juli): θ=2/9 ist selbst keine Eingabe, sondern gefunden — Hilbertraum-Übersetzung 230/231/232 + Fortführung zu den Massen (282) macht die drei Lepton-Massen als Z₃-Zirkulant-Spektrum auf der ℂ³-Faser sichtbar, in dessen Eigenwerten 2/9 als Diagonalisierungs-Ergebnis erscheint; genau dieser Zirkulant liefert die Amplituden a_k von 291. Verweis auf 292/P42 (rationale Adresse) und Hinweis, dass der dynamische Ort davon unberührt ist. Parallel zur Herkunfts-Sektion in 292, damit beide Docs die kausale Kette Hilbertraum→Zirkulant→2/9 nennen. NEU P41 in Dok 190 (2. Juli, DE+EN, je +1 Eintrag, DE 35/EN 31 S.): Rotverschiebungs-Drift (Sandage-Loeb) als Kandidat-Diskriminator statisch vs. Expansion GEPRÜFT UND NICHT GEBUCHT — ΛCDM-Signal über 25 J: +6 cm/s (z=0,5), Vorzeichenwechsel z₀=1,92, −14/−20 cm/s (z=4/5), ELT σ~2 cm/s; Amplituden-Test nicht entartungsfest (säkulare ξx-Evolution bei 0,1–0,4·H₀ imitiert ΛCDM, natürliche FFGFT-Rate c/R_H=H₀ exakt — geteilte Skala P36/P39; Dipol-Systematik der galaktischen Beschleunigung ~17 cm/s gleiche Ordnung); bedingt scharf nur der Form-Test (Vorzeichenwechsel/Zwei-Band-Kontrast ~+20 cm/s, von keinem z-konstanten Säkularkanal imitierbar), verlangt aber Vorab-Festlegung auf strikte Statik und Niedrig-z-Träger; Zeithorizont ~2 Jahrzehnte. Rechnung: python/Dok190_Skripte/drift_sandage_loeb_check.py (numpy-only, seed 20780458). Bestätigt Johanns Vorsichts-These quantitativ: auch dieser Unterscheidungsversuch stirbt in der Amplitude an der geteilten R_H/H₀-Skala. ZUDEM P14-Dublette in Dok 190 aufgelöst (2. Juli): die doppelt vergebene Überschrift „Präzisierung 14" umbenannt in P14a (Rotverschiebung Dok 041, inkl. Tabellenzeile P14→P14a bzw. EN R14→R14a) und P14b (CMB-Anharmonizität/Forward-Retrodiktion, deckt P29–P31, keine eigene Tabellenzeile); alle Querverweise korpusweit nachgezogen (268 DE+EN je 3, 269 DE+EN je 2, 279 DE+EN je 1, 190-intern je 3); acht Dokumente neu gebaut (190/268/269/279 DE+EN), 0 Fehler/0 Glyphen. NEU python/Dok292_Skripte/leptonen_empirie_check.py (2. Juli, Empirie→FFGFT-Richtung auf Johanns Vorgabe): vollständige Nachrechnung des Leptonsektors AUS den PDG-Daten (m_e=0,51099895069, m_μ=105,6583755, m_τ=1776,86±0,12 MeV). Ergebnisse: Q=0,666660511±0,0000068 (−0,91σ von 2/3); Brannen-Fit r_emp=1,4142005 (−1,3e-5 von √2), θ_emp=0,22222963±8,4e-6 (+0,89σ von 2/9, τ-limitiert); θ aus m_μ/m_e allein (τ-frei, r=√2 fix): 0,2222220471, |θ−2/9|=1,75e-7 — reproduziert exakt die Dok-282-Angabe (~1,8e-7, sieben Stellen); Zirkulant-vorwärts (√2, 2/9 exakt) trifft m_μ/m_e auf +0,0010%, m_τ/m_μ auf +0,0060%; ξ-Leiter-Verhältnisse +0,52/+1,04/+1,57%, Reverse-ξ je Verhältnis 1,347/1,375/1,358e-4 (+1,1 bis +3,2% vs 4/30000); Brückenkonstanten v_eff=248,9/247,6/245,1 GeV (P40-konform); ALLE vier Spannungsmaße (Q, θ_3Massen, m_τ-Invertierung, m_τ-Vorhersage) sind DIESELBE eine ~0,9σ-τ-Spannung: m_τ(Koide-exakt)=1776,969, m_τ(θ=2/9-exakt)=1776,967, Vorhersage aus (m_e,m_μ;√2,2/9)=1776,968 MeV vs PDG 1776,86±0,12 — Belle-II-Präzision (~0,05 MeV) entscheidet. K_frak-Gegenprobe der Leiterabweichungen ohne einfaches Muster (+0,52/+1,04% vs −1,33%), ehrlich offen gebucht. NEU DOK 292 (2. Juli, DE+EN je 5 S., 0 Fehler): „Leptonen-Empirie-Check" — die Skript-Nachrechnung (leptonen_empirie_check.py) als Korpus-Dokument nach Standardmuster: Richtung Empirie→FFGFT (Kompatibilitätsmodus, P35/P40); Ebene 1 Zirkulant (Q=0,666660511±68e-7, r_emp=1,4142005, θ_emp=0,22222963±8,4e-6; τ-freier Test θ(μ/e)=0,2222220471, |θ−2/9|=1,75e-7, reproduziert Dok 282; alle Restspannungen = EINE 0,9σ-τ-Spannung; vorab gebuchte Vorhersage m_τ=1776,968 MeV, drei Invertierungswege konsistent, Belle-II entscheidet); Ebene 2 ξ-Leiter (Verhältnisse +0,52/+1,04/+1,57%, Reverse-ξ 1,347/1,375/1,358e-4, Brückenkonstanten v_eff=248,9/247,6/245,1 GeV, K_frak-Gegenprobe negativ und offen deklariert; τ/μ-Abweichung ≈ 2× μ/e-Abweichung als ungebuchte Auffälligkeit notiert). Wrapper DE+EN angelegt. ERWEITERT UM PRÄZISIONSANALYSE (gleicher Tag, jetzt je 6 S.): neue Sektion „Relation zu den Messgenauigkeiten" + Skript-Teil I — 2-Parameter-Analyse (r,θ) gegen (R1=μ/e, R2=τ/μ): Messpräzisionen 2,2e-8 vs 6,8e-5 (μ/e 3100× präziser) → extrem anisotrope Kovarianz (dünne Hauptrichtung σ=3,4e-10, dicke σ=1,7e-5, Korrelation ≈−1); Punkt (√2, 2/9) liegt 0,90σ in der dicken (= die τ-Spannung), aber ~450σ in der dünnen Richtung: ALS EXAKTES PAAR VON HEUTIGEN DATEN AUSGESCHLOSSEN (verfehlt m_μ/m_e um 1,0e-5 bei Messgenauigkeit 2,2e-8), bestätigt auf 1e-5 (die „4–5 Stellen" aus Dok 282 als Messrelation präzisiert); der 1,75e-7-θ-Rest ist heute schon gemessener Offset, den auch perfektes Belle-II nicht auflöst (radiative Polmassen-Korrekturen als Kandidat, deren typische Größe α/π~1e-3 das Rätsel eher vergrößert — offen per P35); §2.4-Formulierung „auf acht Stellen" entsprechend korrigiert; ξ-Leiter in σ_exp: 2,4e5/154/232 → theorieseitig, nicht datenlimitiert; Testschärfe m_τ-Vorhersage 0,9/2,2/5,4σ bei σ=0,12/0,05/0,02 MeV. DAZU Unterabschnitt „Gedankenmodell: Umkehrung der Präzisionsaussage" (Johanns Einwand): drei Stärkegrade — schwach (σ um 450× unterschätzt: kaum haltbar, Kreuzcheck-Netz), mittel (m_μ/m_e ist QED-extrahiert, nicht abgelesen; Vollständigkeitsannahme der Extraktionstheorie; logisch offen), stark/FFGFT-nativ (Präzision gilt für die ANGEZOGENE Polmassen-Größe, Zirkulant lebt auf geometrischer Ebene darunter; 10⁻⁵-Offset = gemessene Dicke der Verkleidungsschicht im μ/e-Kanal; konsequente P40-Verlängerung: in Verhältnissen kürzt nur der generationsUNabhängige Korrekturteil); Bringschuld ausgewiesen (Offset müsste aus generationsabhängiger radiativer Struktur berechenbar sein, sonst unfalsifizierbar); als Gedankenmodell gebucht, nicht als Auflösung — Widerspruch bleibt für Polmassen-Ebene bestehen. Jetzt je 7 S. AUFGELÖST DURCH P42 (2. Juli, Johanns Rahmenentscheidung): Grundsätzlich bleibt die rein theoretische Ableitung aus ξ; der Leptonsektor erhält EINEN deklarierten Referenzpunkt — das Verhältnis m_μ/m_e (analog P39 für H₀/R_H). Bei strukturellem r=√2 (aus Q=2/3) fixiert es θ_ref=0,2222220471; 2/9 ist dessen RATIONALE ADRESSE auf sieben Stellen, kein Exaktheitsanspruch auf Polmassen-Ebene → 450σ-Befund ist Kalibrierung, keine Falsifikation. Anspruchsschicht auf Johanns Korrektur präzisiert: ξ-Status unberührt (als zwingend aus der Geometrie behauptet — Streitpunkt hier nicht verhandelt); Leptonmassen an sich KEINE Eingabe der Theorie — der Referenzpunkt gehört zur VERGLEICHSEBENE (verortet die geometrische Relation in den Polmassen-Daten, ohne Vergleichsabsicht nicht nötig; analog P39/P40); ehrlicher Preis liegt in der TESTBILANZ, nicht der Parameterzählung: m_μ/m_e als Anker verbraucht, scheidet als Prüfgröße aus, Prüfgröße allein m_τ. Gewinn: eingabefehlerfrei scharfe Vorhersage m_τ=1776,9690±0,0001 MeV (+0,91σ zu PDG; Belle-II-Weltmittel entscheidet ohne Ausweichmöglichkeit). Brückenziel verschärft: Dynamik muss θ_ref selektieren, 2/9 bleibt Adresse und Stage-10-Ziel (Orbit-Auflösung ~0,1 unberührt). P42 als Tabellenzeile in Dok 190 DE+EN (36/32 S.), Header-Nachtrag 2. Juli deckt P41+P42+14a/b; Dok 292 um Unterabschnitt „Aufgelöst durch Deklaration" erweitert (je 7 S.). DOK 292 ERWEITERT um Sektion „Die Feinstrukturkonstante aus den Leptonmassen" + Skript-Teil J (2. Juli, Johanns Hinweis auf α-Herleitung und G-Buchhaltung als Kernstücke): Dok-011-Relation α⁻¹=(7500/E₀²)·K_frak von der Datenseite verifiziert — E₀_req=7,39798 vs √(m_e·m_μ)=7,34788 MeV, Verhältnis 1,006819 vs K_frak^(−1/2)=1,006734 (Match 8e-5): derselbe deklarierte Faktor K_frak=1−100ξ (X-Flip, T_CMB) schließt 98,8% der α-Lücke — Sektor-übergreifende interne Konsistenz, kein Fit; geschlossene parameterfreie Relation α=ξ·m_e·m_μ/(K_frak·MeV²) → 1/α=137,059 vs 137,036 (1,7e-4 = ~10⁶ σ_exp, theorieseitiges Residuum wie Leiter, nächste Ordnung offen); E₀=7,398-Brücke (5e-6) ausdrücklich als Kalibrierung nicht als Erfolg gezählt. KORRIGIERT (Johanns Hinweis „lies die Dokumente genauer, α ist keine Kalibrierung"): α läuft NICHT über eine gefittete Brückenkonstante, sondern über ZWEI UNABHÄNGIGE E₀-Wege (Dok 011) — Weg 1 empirisch E₀=√(m_e·m_μ)=7,348, Weg 2 eigenständig-geometrisch E₀²=4√2·m_μ/ξ^p=7,398 (aus ξ und m_μ allein, keine Rückrechnung aus α). Zwei Konsistenzen: (i) Weg 2 trifft 7,398 → α auf +5e-6; (ii) Differenz der Wege 7,398/7,348=1,00682 = K_frak^(−1/2) auf 9e-5. α damit ÜBERBESTIMMT (zwei Herleitungen treffen sich auf 8e-5), Rekursionstiefe strukturell fixiert (E₀ quadratisch in α → K_frak^(1/2) auf E₀-Ebene = volle K_frak-Ordnung auf α-Ebene). α aus der Unvollständigkeits-Rest-Liste HERAUSGENOMMEN: es ist die eine Stelle OHNE offenen Rest im Leiter-Sinn, weil zwei Wege die Tiefe fixieren; offener Rest nur bei Leiter-Stellen (nur ein Weg). ZUSATZ-ABSCHNITT „Der α-Restwert als zweiter Zeuge der Verkleidungsschicht" (Johanns Präzisierung, nur auf α bezogen): nimmt man α (1,5e-10) UND Weg 2 (rein geometrisch, kein Messfehler) als exakt, ist in α=ξE₀² die einzige Größe mit Spielraum Weg 1 = √(m_e·m_μ), also die Polmassen; K_frak schließt 99,99%, es bleibt Rest 8,4e-5 = ~7700σ der Massengenauigkeit (1,1e-8) → zu groß für Messrauschen, Aussage ÜBER die Polmassen: √(m_e·m_μ) ist unter starker Lesart nicht die geometrisch exakte Größe. Strukturgleich zum θ-Fall (dort (√2,2/9) verfehlt m_μ/m_e um 1e-5, hier E₀-Konstruktion verfehlt Polmassen-E₀ um 8e-5) — θ-Rest (1e-7) und α-Rest (8e-5) = ZWEI UNABHÄNGIGE ZEUGEN desselben Effekts (Polmasse ≠ geometrisch exakte Ebene). Preis: setzt starke Lesart voraus (Weg 2 exakt), Verkleidungs-Berechnung bleibt Bringschuld; als Kalibrierungsartefakt aber nicht mehr abtubar (α überbestimmt, Massenpräzision zu hoch). PRÄZISIERT (Johann: „es gibt die zwei Wege bei α"): die zwei Zeugen sind NICHT gleich stark — ASYMMETRIE. α-Rest ist MODUSUNABHÄNGIG, weil Weg 2 (E₀²=4√2·m_μ/ξ^p) m_e gar nicht benutzt → μ/e ist bei α KEIN Anker → 8e-5 ist echter Test von m_e gegen Geometrie, keine Selbstreferenz, gilt referenzfrei UND unter P42. θ-Seite dagegen: θ_ref aus μ/e gewonnen → μ/e Anker → 450σ zur Hälfte Selbstreferenz → Zeuge NUR referenzfrei. Der starke, modusunabhängige Beleg der Verkleidungsschicht ist damit α ALLEIN; θ stützt denselben Schluss nur unter Referenzfreiheit. (Korrigiert meinen Zwischenfehler, α und θ gemeinsam als modusabhängig abzuwerten — die zwei α-Wege machen α gerade zum robusten Zeugen.) WICHTIG: gilt NUR für α — bei der Leiter (Rest 0,5% = 250000× Messgenauigkeit) trägt das Argument NICHT, dort reine Theorie-Näherung. ABSCHNITT „Leiterübergreifende Kopplung: ein generationslineares Korrekturgesetz" + Skript-Teil K (Johanns Hinweis, dass leiterübergreifende Beeinflussungen denkbar sind): die drei krummen Exponenten p1=0,387/p2=0,769/p3=1,157 sind NICHT unabhängig — (1) multiplikativ konsistent: p3=p1+p2 auf 6e-14 (τ/e trägt keine neue Info, ist Produkt der Stufen); (2) effektive Faktoren N1:N2:N3=38,89:77,06:115,55 = 1:1,981:2,971 ≈ 1:2:3 → Korrektur wächst LINEAR mit Generationszahl, N_g≈g·N₀ mit N₀≈38,6 (Einzelschätzungen N1,N2/2,N3/3=38,89/38,53/38,52, <1% konsistent). Das ist der strukturelle Grund, warum konstantes K_frak die Leiter nicht schließt und warum 89-statt-100 ins Leere läuft: Leiter verlangt generationszählenden Faktor, nicht festen; bei α nur eine Skala → ein Faktor genügt. Generationsabhängige Verkleidung damit konkret: linear in g. OFFEN (P35): N₀≈38,6 nicht hergeleitet (100/e=36,8, 100/φ²=38,2, 39 treffen nicht genau); δ-Phasensektor (p=−0,88) fügt sich nicht offensichtlich in die Magnitude-Leiter. Aus „drei krumme Exponenten" wird „generationslineares Gesetz N_g=g·N₀ mit unbestimmtem N₀". METHODEN-KORREKTUR (Johanns Einwand: man darf nicht Referenzpunkt UND Vergleich zugleich): zwei EINANDER AUSSCHLIESSENDE Modi klargestellt — Modus 1 (referenzfrei, alle Verhältnisse aus ξ vorhergesagt: μ/e, τ/μ, τ/e alle Prüfpunkte, N_g-Gesetz zulässig, 1:2:3 an 3 Punkten); Modus 2 (P42: m_μ/m_e ist Anker, verbraucht, KEINE Prüfgröße mehr → N_g-Bilanz gegenstandslos, einzige unabhängige Leiter-Prüfung m_τ läuft über Zirkulant). N_g-Analyse gehört AUSSCHLIESSLICH in Modus 1. μ/e als Anker UND N_g-Prüfpunkt = unzulässige Doppelbuchung (mein vorheriger Fehler mit den „1500σ"). Das 1:2:3 ist nur referenzfrei dreifach belegt; unter P42 stützt es sich nur auf τ/μ, τ/e (gleiche τ-Masse, geringe Präzision). Zirkulant trägt μ/e ohnehin auf 1e-5 ohne g-Korrektur — die g-Korrektur betrifft allein die grobe ξ-Leiter, nicht die präzise Zirkulant-Schicht. TOLERANZ-BILANZ nachgetragen (Johann: „wo sind die Rechnungen zu den Abweichungs-Toleranzen") — Skript-Teil L + Tabelle in 292: roh vs. N_g-korrigiert je Stelle in %-und-σ_exp (μ/e 0,521%→0,0033% aber 2,4e5→1,5e3σ; τ/μ 1,038%→−0,0031%, 154→0,47σ; τ/e 1,565%→−0,0052%, 232→0,78σ). Gesetz drückt Leiter-Abweichung Faktor ~300; τ-Stellen fallen IN die Toleranz (<1σ), μ/e bleibt 1500σ (500× präziser gemessen) — aber dieser Eintrag ist NUR im referenzfreien Modus 1 eine Aussage, unter P42 fällt μ/e als Anker aus der Bilanz. Zirkulant-vs-Leiter für μ/e (0,001% vs 0,52%, Faktor 530) ebenfalls gebucht: Zirkulant trägt Präzision, Leiter Größenordnung. Rest sitzt in 1:2:3-Feinabweichung (~1-2%) und N₀. KLÄRUNG „100 vs 38,6" + 100/φ²-Spur (Johann): häufiges Missverständnis ausgeräumt — die 100 in K_frak=1−100ξ (feste korpusweite Skala: X-Flip, T_CMB, E₀-Brücke) und N₀≈38,6 (Faktor pro Generation in der Leiter) sind NICHT dieselbe Größe; die Leiter braucht nicht „weniger Rekursionen", sondern eine ANDERE Art: generationszählend N_g=g·N₀ (g=2→77, g=3→116, teils MEHR als 100). Vergleich als „Rekursionstiefen" geht ins Leere. Als ausdrücklich UNBEWIESENE Spur (P35, nicht als Herleitung gebucht): 100/φ²=38,20 nahe N₀, gegen τ-Stellen (im referenzierten Modus einzige Prüfgrößen) nur 0,87% Abweichung — wäre N₀=100/φ² exakt, folgte die Leiter-Grundeinheit über einen Faktor φ⁻² aus der K_frak-Skala (Magnitude+Korrektursektor an derselben Konstante); das knappe 1% trägt die Behauptung aber nicht, bleibt Spur bis zur N₀-Herleitung. TOLERANZ-MASSSTAB (Johanns Methodenpunkt: „du versuchst erneut punktgenau zu landen, das ist prinzipiell unmöglich, das Ergebnis soll nur innerhalb der Toleranzen bleiben"): 100/φ²-Bewertung KORRIGIERT — der richtige Maßstab ist nicht Punktgenauigkeit (prinzipiell unerreichbar, Werkstatt-Prinzip: Realität reicher als Messtechnik) sondern Verträglichkeit INNERHALB der Bestimmungstoleranz von N₀. N₀ folgt im referenzierten Modus allein aus τ-Stellen, begrenzt durch m_τ-Unsicherheit (±0,12 MeV) → N₀=38,52±0,21 (~0,5% Toleranz). 100/φ²=38,20 liegt damit 1,6σ_N₀ entfernt = INNERHALB der Toleranz → ZULÄSSIGER Kandidat, NICHT „knapp verfehlt und verworfen" sondern „mit gegenwärtiger Bestimmung verträglich, nicht widerlegt". Belle II oder N₀-Herleitung entscheidet. ZUSÄTZLICH Unvollständigkeits-Schluss umgestellt: Vollständigkeit heißt NICHT punktgenaue Landung auf letzter Ziffer (weder möglich noch Ziel), sondern kein Rest mehr der ÜBER die Toleranzen hinausragt und nur durch freien Parameter geschlossen wird. Maßstab = Toleranz, nicht letzte Ziffer. DE+EN je 12 S.

## 17. August 2026 — R75: Neufassung der Shor-/Quantencomputing-Dokumente (Dok. 024, 034, 075, 076, 147, 176)

**R75 in Dok. 190 deklariert. Sechs Dokumente vollständig überarbeitet, davon vier neu geschrieben.**

**Der Kernbefund: Namenskollision beim Parameter ξ.** Die betroffenen Dokumente verwendeten dasselbe Symbol für zwei unabhängige Größen — den FFGFT-Geometrieparameter ξ = 4/30000 und einen numerischen Suchparameter der Faktorisierungsalgorithmen (Werte 1/42, 1/100, 1/1000, 1/100000). Beide haben nichts miteinander zu tun. In der Neufassung ist der Suchparameter durchgehend als **σ** bezeichnet und ausdrücklich als Abtastraster ohne physikalische Bedeutung eingeordnet.

**Drei getrennte Parameterräume** (Dok. 176): geometrischer Raum (ξ = 4/30000, fest), algebraischer Raum (ξ_Higgs ≈ 1,038·10⁻⁵, Feldkorrektur), zahlentheoretischer Raum ℤ/Nℤ (**kein** universeller Parameter; die Periode r ist durch lcm(p−1,q−1) bestimmt). Die Faktorisierung lebt ausschließlich im dritten Raum.

**Was inhaltlich korrigiert wurde:**
- **Resonanzprinzip bleibt, Träger korrigiert:** Periodenfindung *ist* ein Spektralproblem — aber ihre Generatoren sind die **Primzahlen**, nicht ein einstellbarer Parameter. Belegt durch den Bikohärenztest an 2469 Riemann-Nullstellen (Dok. 316): Kopplung genau bei Primzahlpotenzen (b² = 0,76–0,85), keine bei zusammengesetzten Zahlen (b² = 0,018–0,025). Da alle σ-Werte zusammengesetzte Nenner haben (42 = 2·3·7, 100 = 2²·5², 1000 = 2³·5³), bilden sie Mischpunkte ohne eigene Kopplungslinie.
- **Skalierungsgrenze strukturell statt technisch:** Das Versagen bei kryptographisch relevanten Bitgrößen folgt aus der **Weyl-Obstruktion** — N(λ) ~ λ^(d/2) für jeden kompakten Resonanzraum gegen N(T) ~ T·ln T arithmetisch. Keine Potenz; ein endlicher Raum kann diese Dichte nicht tragen, unabhängig von Rasterweite und Rechengenauigkeit.
- **Windungszahl statt Frequenzverhältnis:** Für geschlossene Trajektorien entscheidet W = log₂(r), nicht r selbst. Reine Quinte: Verhältnis rational, Windung irrational → offene Spirale (pythagoreisches Komma). Temperierte Quinte: Verhältnis irrational, Windung 7/12 rational → geschlossen. Schließung ist ein Artefakt der Rationalisierung.
- **Fouriertransformation als Projektion:** QFT, klassische FFT und optische Realisierung erzeugen keine Information — sie machen Periodizitäten sichtbar, die in den präparierten Zuständen bereits vorhanden sind. Der limitierende Schritt ist die Zustandspräparation (Auswertung von aˣ mod N), nicht die Transformation.
- **Quantenvorteil korrekt eingeordnet:** Shor faktorisiert auf Quantenhardware theoretisch in O((log N)³) — eine reale Leistung für ein spezifisches Problem. Ein *allgemeiner* exponentieller Quantenvorteil ist nicht nachgewiesen; die frühere Behauptung, das klassische T0-Verfahren teile diese Komplexität, ist nicht belegt und zurückgezogen.
- **Zwillingsprim-Optimierung:** nicht reproduzierbar, entfernt.

**Präzisierung der Grenzen (wichtig gegen Überdehnung):** Zwei Grenzen sind zu trennen. *Strukturell (Weyl):* Ein kompakter Zustandsraum kann ein **unendliches** arithmetisches Spektrum der Dichte T·ln T nicht tragen — der Faktor wächst unbeschränkt wie ln(T)/2π. Prinzipiell, hardwareunabhängig. *Ressource (Shor):* Die Faktorisierung **einer konkreten** Zahl ist eine endliche Aufgabe; ein Register mit 2n+3 Qubits genügt. Shor scheitert bei großen N an der Gatterzahl (n³) und am Fehlerkorrektur-Overhead (RSA-2048: ~4099 logische Qubits, 8,6·10⁹ Gatter, ~4,1·10⁶ physikalische Qubits) — **nicht** an der Weyl-Obstruktion. Beide Ansätze versagen bei kryptographisch relevanten Größen, aber aus verschiedenen Gründen; die Weyl-Grenze gegen Shor anzuführen wäre eine Überdehnung.

**Thermik und Zustandsraum (Dok. 176, ergänzt):** Der thermische Vorteil optischer Realisierung folgt aus hν/(k_BT) und ist groß — bei 600 nm und 300 K beträgt die thermische Besetzung 1,8·10⁻³⁵, bei 5 GHz dagegen **1250 Anregungen im Mode**. Supraleitende Systeme verlangen daher T < 52 mK für eine Besetzung unter 0,01; die Carnot-Mindestarbeit beträgt 3·10⁴ Einheiten je bei 10 mK abgeführter Wärmeeinheit (real: Verdünnungskryostat 10–25 kW Dauerleistung). Der Vorteil betrifft **Infrastruktur, nicht Rechenmächtigkeit**. — Zwei weitere Fehlzuschreibungen sind korrigiert: (a) Die exponentielle Dimension folgt aus der **Tensorproduktstruktur**, nicht aus dem Trägermedium — ein einzelnes Photon in n Moden gibt dieselbe Dimension n wie eine klassische Welle, m ununterscheidbare Photonen geben C(n+m−1, m); die Gegenüberstellung „Optik gegen Quantenrechner" stellte eine Technologie gegen ein Rechenmodell und ist entfernt (photonische Quantenrechner existieren). (b) **Verschränkung trägt den Rechenvorteil nicht allein** — der Satz von Gottesman-Knill zeigt maximal verschränkte Clifford-Schaltkreise als klassisch in Polynomzeit simulierbar (GHZ über 1000 Qubits: ~2·10⁶ Bits Stabilisatordarstellung). Weitere Gegenbelege: DQC1, Boson-Sampling; Jozsa & Linden (2003) zeigen Notwendigkeit, nicht Hinreichen. Welche Größe den Vorteil trägt, ist in der Fachliteratur offen und wird als offen benannt.

**Verifikation:** Drei neue Prüfskripte in `2/python/Shor_Skripte/` (reine Standardbibliothek, Assertions, Seed 20780458). `s1_periodensuche.py`: Korrektheit an sieben Semiprimzahlen; Skalierung über die mittlere multiplikative Ordnung mit gemessenem **Wachstumsexponenten 0,95** (praktisch O(N), nicht polylogarithmisch — die O((log N)³)-Behauptung für das klassische Verfahren ist damit empirisch widerlegt); Primfaktorzerlegung aller σ-Nenner; Vergleich mit Probeteilung und Pollard ρ. `s2_grenzen.py`: Weyl-Obstruktion gegen äquidistantes Register, Abgrenzung von Shors Aufgabe, Ressourcenabschätzung, Windungszahl-Probe. `s3_thermik_zustandsraum.py`: thermische Besetzung nach Trägerfrequenz, Kühlkosten nach Carnot, Dimensionsvergleich der Zustandsräume, Gottesman-Knill.

**Betroffene Dokumente:** Dok. 075 (Periodenfindung als Resonanzproblem, neu geschrieben, 6 S.), Dok. 076 (empirische Tests, DE+EN neu geschrieben, je 5 S.), Dok. 176 (QFT als Wellenoperation, DE+EN neu geschrieben, je 5 S.), Dok. 147 (Rahmung überarbeitet, Strukturabschnitt ergänzt, DE+EN je 31 S. — die IBM-Heron-r2-Messungen vom Mai 2026 bleiben unverändert und sind weiterhin tragend), Dok. 024 (Faktorisierungsabschnitt ersetzt), Dok. 034 (Rahmung korrigiert, DE+EN). R75 ist in **beiden** Fassungen von Dok. 190 deklariert (DE 66 S., EN 55 S.); Dok. 176 umfasst nach Ergänzung des Thermik-Abschnitts je 7 S.

**Folgenachträge (18. August 2026):** Die neue Kostentabelle in Dok. 176 belegt, dass die Aufbereitung ~95 % der Gatterkosten trägt, die QFT nur ~5 %; dieser Wert wurde in Dok. 075, 076 (DE+EN) und 147 (DE+EN) nachgetragen. Die Kurzbeschreibung von Dok. 176 in Dok. 173 (EN) wurde auf den neuen Inhalt angepasst.

**Anmerkung zur Nummer 075:** Die englische Datei `075_RSA_En` ist ein **anderes Dokument** — allgemeine RSA-Kryptographie ohne T0-Bezug, ohne Shor-Anbindung, ohne ξ- oder σ-Parameter. Sie ist von R75 nicht betroffen und bleibt unverändert. Die Doppelbelegung der Nummer 075 für zwei inhaltlich verschiedene Dokumente ist als eigener Punkt zu bereinigen (in Dok. 190 vermerkt).

## 7. August 2026 — Dok. 316 „FFGFT und die Riemannsche Zeta-Funktion" (DE+EN, je 23 S. + 12 Prüfskripte)

**Neues Arbeitsdokument (nicht A-Serie), DE+EN je 23 S., `python/316_Skripte/` (12 Skripte, reine Standardbibliothek, Sollwerte als Assertions, Seed 20780458), formales Literaturverzeichnis (13 Einträge mit DOI/URL).** **Kernaussage: Die Riemann-Hypothese ist eine arithmetische Angelegenheit; Torus und ξ tragen zu ihrer Lösung nichts bei.** Sechs Wege werden mit Begründung ausgeschlossen, vier positive Befunde stehen daneben — zwei Identitäten des Rahmens und zwei Messungen an der Primzahlstruktur. **Zwei Identitäten [K]:** (a) die Riemann-Zeta ist ein FAKTOR der Torus-Spektral-Zeta, Z_{Z⁴}(s) = 8(1−4^{1−s})·ζ(s)·ζ(s−1) — hier gegen die Direktsumme mit analytischer Schwanzkorrektur auf 10⁻⁷ bis 10⁻¹² bestätigt; die RH ist damit eine Aussage über das Spektrum eines geometrischen Objekts des Rahmens; (b) der Casimir-Punkt s = −1/2 (Dok. 314, Ordnungsumkehr D4/Z⁴) liegt mit seinem funktionalen Spiegel s = 3/2 symmetrisch zur kritischen Linie Re(s) = 1/2. **Die entscheidende Obstruktion [X] auf Satzebene:** Weyl liefert für JEDE kompakte Riemannsche Mannigfaltigkeit N(λ) ~ λ^(d/2) (reine Potenz; Krümmung/Rand/Orbifold ändern nur niedrigere Ordnungen), Riemann-von Mangoldt liefert N(T) ~ (T/2π)ln(T/2π); der lokale Exponent 1 + 1/ln(T/2π) ist nie konstant (Spanne 0,22 über 17 Dekaden, bester Potenzfit weicht bis 11 % ab) ⇒ **es gibt keine kompakte Mannigfaltigkeit irgendeiner Dimension/Krümmung mit den Nullstellen als Laplace-Spektrum** — der gesamte Zweig „T⁴/Z₃ deformieren" ist erledigt. Das ln T ist die Signatur eines Skalenfreiheitsgrads, verweist also auf die ausgerollte Domäne (Dok. 315). **Konstruktiver Anschluss [B]:** Berry-Keating-Zählung von H = xp reproduziert bei Zelle 2π exakt Riemann-von Mangoldt (Differenz konstant 0,125 = Randterm); die Zellbedingung selbst ist jedoch nur ħ = 1, der FFGFT-Doppel-Cutoff verfehlt die Planck-Zelle um 65 Dekaden, und ein endliches Skalenfenster (16,93 ξ-Leiterstufen, ~1816 Moden) trägt endlich viele gegen abzählbar unendlich viele Nullstellen — es bleibt allein die Strukturaussage, dass die Nullstellendichte einen Dilatationserzeuger verlangt. **Randbedingung [X]:** Die ξ-Leiter kompaktifiziert ℝ₊* zum Kreis mit Umfang ln(1/ξ) = 8,9227, diskretisiert die Nullstellen aber nicht — kein Periodenkandidat überlebt die Out-of-Sample-Prüfung (bester in-sample p = 0,005 → out-of-sample p = 0,81, look-elsewhere-korrigiert 1,0); strukturell erwartbar, da eine Ein-Perioden-Kompaktifizierung äquidistante Spektren erzeugt, die Nullstellen aber GUE-Statistik mit Niveauabstoßung zeigen (Anteil normierter Abstände < 0,3 = 0,000 gegen ~0,26 gitterartig). **Tonnetz-Zugang [X]:** ξ = 1/(2²·3·5⁴) ist ein Punkt im Eulerschen Tonnetz mit Koordinaten (−2,−1,−4); das Weil-Längenspektrum enthält aber nur k·ln p, Logarithmen EINZELNER Primzahlen. Fourier-Nachweis an 100 Nullstellen zeigt ln3/ln5/ln7/ln11/ln13 über den Schwellen, keine ξ-Größe erreicht sie (ln(1/ξ): F = 0,1775); Grund strukturell, nicht größenordnungsbedingt: **Tonnetz und Euler-Produkt teilen die Primzahlachsen, nutzen sie aber entgegengesetzt** — das Euler-Produkt faktorisiert (keine Mischterme), das Tonnetz kombiniert. Der Ausschluss gälte unverändert, wenn ξ von Ordnung 1 wäre; entscheidend ist, dass 1/ξ zusammengesetzt ist. **Gewichtungsfrage [X]:** Weder die Gewichtungsstärke (α von ungewichtet bis Tenney, Gewichtssumme ∏ₚ[1+2p^−α/(1−p^−α)], einschließlich der Mitte bei α≈0,3 mit ~1800 effektiven Punkten) noch die Limit-Erweiterung (5-/7-/11-Limit, bis 371 293 Punkte) erzeugt Selektion; vor allem sind die Weil-Gewichte ln(p)/p^(k/2) keine freien Parameter — jede Gewichtung ändert das Euler-Produkt und zerstört die Funktionalgleichung, also gerade die kritische Linie. Strukturell: ein Tonnetz mit Limit L deckt die endlich vielen p ≤ L trivial ab und die unendlich vielen darüber gar nicht. **Mischterme GEMESSEN [K]:** Bikohärenztest nach Kim & Powers mit Monte-Carlo-Phasenrandomisierung (Pólóskei et al.) an **2469 selbst per Riemann-Siegel berechneten Nullstellen** bis t = 3000 (erwartet 2468,6; Phasenfehler 0,02 rad); Positivkontrollen (ln2,ln2)→ln4, (ln3,ln3)→ln9, (ln2,2ln2)→ln8 zeigen b² = 0,76–0,85, Negativkontrollen (ln2,ln3)→ln6, (ln2,ln5)→ln10, (ln3,ln5)→ln15 zeigen b² = 0,018–0,025 — **sechs von sechs Vorhersagen, Kontrast Faktor 30 bis 50**. Damit ruht der Tonnetz-Ausschluss auf einer Messung statt auf einem Formargument. **Limit-Einschließung:** Das 5-Limit enthält die höheren nicht exakt (Primfaktorzerlegung), wohl aber als dichte Näherung — der Näherungsfehler an ln7 mit Exponenten (1,7,−4) ist **exakt das Ragisma 4375/4374**, der der groben Näherung (6,−2,0) das Archytas-Komma 64/63; bei der Peakbreite 0,0021 ist die feine Näherung von ln7 ununterscheidbar (Leistung 2,144 = 2,144), amplitudengewichtet aber um Faktor 3,9·10⁵ zu leicht; durch Temperierung ja, aber per Setzung. **Einschließung entsteht durch Rationalisierung oder Unschärfe, nie durch Struktur.** **Physikalischer Beleg [K]:** Die Naturtonreihe (Alphorn, n·f₀ ohne Ventile) zeigt dieselbe Generator-Struktur — genau die Primzahl-Ordnungen führen neue Klangqualitäten ein, 4 = 2·2, 6 = 2·3, 9 = 3·3 sind Kombinationen; der Amplitudenabfall ~1/n entspricht formal der Tenney-Höhe; festgehalten außerdem die Unterscheidung Windungszahl vs. Frequenzverhältnis (reine Quinte: Verhältnis rational, Windung log₂(3/2) irrational → schließt nie, Rest = pythagoreisches Komma; temperierte: Verhältnis irrational, Windung 7/12 rational → schließt exakt nach 12). Verweis auf Dok. 006: die Massenformel ξᵢ = ξ₀·f(nᵢ,lᵢ,jᵢ) indiziert ebenfalls ganzzahlig, die Leptonenfaktoren 4/3, 16/5, 25/9 liegen im 5-Limit wie ξ selbst — Primzahlen erscheinen dort als BAUSTEINE von Verhältnissen, nicht als LÄNGEN eines Spektrums. **Instrumentenfrage [X]:** K_frak ist nicht das temperierende Instrument — der P-315-2-Rest (1,36·10⁻⁵ ≈ 7 eV) hat keine Kommastruktur (beste Näherungen 73530/73529, 882365/882353, 1250017/1250000, keine glatt; Kontrollprobe erkennt alle sechs echten Kommas); die Setzung sitzt eine Ebene tiefer bei ξ selbst, K_frak ist deren Folge. Sie sitzt aber strukturell dort, wo ein Instrument säße (Dok. 314 D2: Eigenschaft der Durchquerung, nicht des lokalen Operators). Eigentlicher Kandidat ist der Doppel-Cutoff: **eine Temperierung verändert die Werte und hinterlässt ein Komma, eine Auflösungsgrenze verändert nichts und hinterlässt nichts.** **Quantenrechner:** bringen hier nichts — kein Suchraum, Informationsverlust statt Komplexitätsproblem, unendlich viele ausgelassene Primzahlen; Numerik kann die RH widerlegen, nie beweisen. **Alle aufgeworfenen Punkte entschieden:** Z-1 negativ (keine Gewichtung möglich), Z-4 geschlossen (Bikohärenztest), sowie neu **Z-2 geklärt** — der Gitterfaktor (1−4^{1−s}) ist die Dirichlet-Signatur von Jacobis Vier-Quadrate-Satz r₄(n) = 8·Σ_{d|n, 4∤d} d (auf zwölf Werten verifiziert) und kodiert die Teilbarkeitsbedingung „4 teilt d nicht“; seine Nullstellenleiter s = 1 + 2πik/ln4 mit Sprossenabstand π/ln2 = 4,5324 ist eine Eigenschaft der Summe von vier Quadraten, die nächstgelegene Rahmengröße (Vorfaktor 4 aus L*, R73) liegt 12 % daneben — und **Z-3 gegenstandslos**, da der D4/Z⁴-Unterschied im Wärmekern eine reine Paritätsbedingung ist (D4 besetzt nur gerade Normen, bei diesen stimmen beide Gitter exakt überein); die aussagekräftige Stelle ist der Casimir-Punkt s = −1/2, dessen Auswertung in Dok. 314 vorliegt. Skripte: z1_weyl_obstruktion, z2_zellbedingung, z3_randbedingung_test, z4_epstein_casimir, z5_zellbedingung_kritik, z6_tonnetz_weil, z7_gewichtung_unmoeglich, z8_bikohaerenz, z9_limit_einschluss, z10_kommatest, z11_alphorn, z12_gitterfaktor_waermekern.

## 6. August 2026 — Dok. 315 „Die Form von K_frak: additiv oder multiplikativ?" (DE+EN, je 10 S. + 4 Prüfskripte)

**Neues Arbeitsdokument (nicht A-Serie), DE+EN je 10 S., `python/315_Skripte/` (4 Skripte, reine Standardbibliothek, exakte Bruchrechnung).** Der Korpus bestätigt den **Wert** K_frak = 1−100ξ = 74/75 mehrfach (A040, A130, A270); ob damit auch die **Form** — additiv gegen multiplikativ (1−ξ)^100 — diskriminiert ist, war ungeprüft. **Formabstand:** relativ 8,88×10⁻⁵ = exakt der zweite Binomialterm 4950ξ² (99,6 % des vollen Abstands) — die beiden Formen sind dieselbe Korrektur in zwei Darstellungen, Trennung erst in 2. Ordnung. **Kontrollfall Euler-Spirale (5/7-Limit):** exakter Schluss unmöglich (Primfaktorzerlegung), nur Kommas — 5-Limit bester Beinahe-Schluss Schisma (1,95 Cent), 7-Limit dreifach besser: Landscape-Komma 0,33 / **Ragisma 4375/4374 = 0,40** / Breedsma 0,72 Cent (systematische Skriptsuche mit Assertion gegen exakten Schluss); geschlossen wird nur durch Temperierung = Rationalisierung der Schrittweite — genau die Rationalität, die der ξ-Zyklus (1/75, ggT(74,75)=1) von Anfang an trägt. **Drei Zeugen:** (A) Zwei-Routen-Verhältnis A130 — m_μ kürzt sich vollständig, Hebel dK/K = |ln ξ|·dp ≈ 8,92·dp; das Korpus-Literal p = −0,2679 (4 Stellen) löst NICHT auf (Rundung 4,5×10⁻⁴ > Formabstand); mit p = −(2−√3) exakt diskriminiert A **7,5:1 additiv** — die Identität ist aber weder deklariert noch hergeleitet (P-315-1); R72-Lage eingearbeitet (nackt/korrigiert statt zwei Wege; n-Sprache: Formdiskriminierung verlangt Δn ≤ 0,66 = n(n−1)ξ/2, keiner der drei n-Wege 101,3/100±2/100,27 erreicht das → P-315-3). (B) Hochpotenz A270 K⁻³⁶ ≈ 16/π² — der ×36-Verstärker macht den Formabstand zu 0,32 %: additiv trifft auf 1,0×10⁻⁴, multiplikativ verfehlt um 3,1×10⁻³ → **31:1 additiv**; Referenz durch Dok. 314 aufgewertet: **16/π² = 1/Δ(D4)** (Kehrwert der D4-Packungsdichte π²/16) — korpus-native Gitterinvariante statt freischwebender Konstante, **P35 verengt** auf die Kopplung des Bulk-Exponenten 36 an Δ(D4). (C) Potenzform A040 (D_eff = 2,973): tendiert additiv (1,6×10⁻⁵ vs. 1,0×10⁻⁴), 4-stellige Rundung aber nicht auflösungsfähig. **Nachrechnung der p-Identität:** q* exakt bestimmbar (m_e-Boden 3×10⁻¹¹) — q*_add = 0,267950715, q*_mul = 0,267960667, 2−√3 = 0,267949192; fairer Scan von 175 geschlossenen Ausdrücken: im ±3×10⁻⁶-Fenster um q*_add AUSSCHLIESSLICH 2−√3, um q*_mul KEIN Kandidat; Signifikanz der Nähe ~10⁻⁴ (niederkomplex), aber **realer Rest** +1,52×10⁻⁶ in q = 1,36×10⁻⁵ auf K/m_e-Ebene ≈ **7 eV in m_e** (45 000× über Messboden; Kettenbruch folgt 9 Terme dem periodischen 2−√3-Muster, dann Ausbruch); zehn F(ξ)-Korrekturfamilien und Präfaktor-Gegenprobe (4√2 ↔ 5,6567774) ohne einfachen Treffer → **P-315-2** (derselbe Posten wie R72s n = 101,3-Überschuss; Größenordnung QED-Selbstenergie). **Strukturargument „eingerollt/ausgerollt":** additive Form = native, exakte Windungsbuchhaltung der eingerollten Domäne (75(1−ε) = 74 als Identität); multiplikativ = Stufenkomposition der ausgerollten Skalendomäne (e^(−100ξ)); die Euler-Spirale ist der Kontrollfall mit unstrittiger Zuordnung (Frequenz gemessen → multiplikativ → Logarithmus → irrational → offen). Anbindung an die **Schließungsgabelung** (295/313, per 314-D2): Fall B (ξ eingefroren, rationale Windung) IST die additive Buchhaltung, Fall C (ξ läuft, kumulierter Defekt logarithmisch, äquianguläre Spirale) IST die multiplikativ-logarithmische — die Formfrage ist die Frage, welcher Gabelast die Korrektur trägt; alle Korpus-Verwendungen buchen Fall B. Löst zugleich die scheinbare A040-Spannung (Schließungskomma vs. RG-Lauf: konsistent in 1. Ordnung; RG liefert die GRÖSSE 100ξ, die Windung die KOMPOSITIONSREGEL). **Buchungsstand:** Wert [K]; Form additiv [B], zweifach bedingt-bestätigt (Bedingung 1: p-Identität offen mit realem Rest; Bedingung 2 durch Δ(D4)-Identifikation wesentlich geschwächt); multiplikativ von beiden bedingten Zeugen konsistent disfavorisiert, von keinem gestützt, bleibt logisch möglich solange beide Bedingungen offen. **Falsifikationslinie:** Baryon-Stelle A270 (K³⁸-Niveau, Formabstand 0,34 %) als unbedingter Formtest — testet zugleich die Gabelzuordnung und bindet die Formfrage an die Primatsfrage der Geometrie. Offene Punkte: P-315-1 (p-Identität), P-315-2 (7-eV-Rest), P-315-3 (n-Schärfe; Sektorleiter aussichtsreichster Kandidat), P35 (verengt), D_eff-Präzisierung. Skripte: euler_spirale_7limit, pruefrechnung_kfrak_form, pruefrechnung_p_identitaet, pruefrechnung_rest_0p1xi.

## 5. August 2026 — Dok. 314 „Gitter im Hilbertraum" erweitert + Dok. 313 korrigiert und erweitert

**Dok. 314 „Gitter im Hilbertraum" (DE 26 / EN 25 S., Standalone A4 + ch + 4 Prüfskripte):** Das Dokument ist jetzt **eigenständig** — sämtliche Rückbezüge auf frühere Fassungen entfernt (die Änderungshistorie lebt in der Git-Historie und hier, nicht im Dokument). Vier inhaltliche Erweiterungen:

**(1) Die Störungsrechnung ist ausgeführt** (Kap. J.3, Status von „offen" auf [K]): Die frühere Erwartungstabelle — Orbits blieben unter Störung zusammen — ist **falsch**. Multiplettgrößen folgen den **Irrep-Dimensionen** der respektierten Symmetrie, nicht den Bahnen: 9+8+4+2+1 bei voller Aut(D4)-Symmetrie, 8×1 + 8×2 bei Z₃ (abelsch, alle Irreps eindimensional; die Dubletts sind die antiunitäre χ₁/χ₂-Paarung), 24×1 bei −1 allein und generisch. Grund (i): jede ortsabhängige Störung bricht die **Translations**invarianz — und die trug die 24er-Entartung, nicht die Punktsymmetrie. Je drei unabhängige Seeds pro Klasse, seedunabhängig identisch.

**(2) Neues Kapitel D1 „Zeit aus dem Massenkreis"** [K]: Zeitperioden als Überlagerungsbuchhaltung (ℝ→S¹, Decktransformationsgruppe ℤ, wegen abelscher π₁ **verlustfrei**). Kernkorrektur: T_k = 2πR₄/k₄ ist eine **Bogenlänge**, also ein **Ort-Intervall**, kein Zeitmaß; λ₄·m = 2π ist die **de-Broglie-Relation** auf der Massenrichtung. Die *zeitliche* Ablesung trägt dagegen T_osc·m = 2π/γ ≤ 2π, Gleichheit nur bei p_Raum = 0. Im Gemisch nach Jensen ⟨k⟩⟨1/k⟩ ≥ 1, Gleichheit genau bei **scharfer** Schale (Gleichverteilung k ≤ 50 gibt 2,295; thermisch bis 2,600; 2000 Zufallsverteilungen, Minimum 1,077). **Drei Aussagen in drei Richtungen:** Ort = 2π immer, Zeit ≤ 2π (Bewegung), Gemisch ≥ 2π (Streuung) — exakt wird die Relation nur für die **ruhende, scharfe** Mode. Nebenbefund: die 12+12-Aufspaltung ist in dieser Lesart masselos gegen massiv, und die Levelkreuzung bei r > √3 heißt, dass bei starker Anisotropie eine reine Massenmode zum Grundton wird.

**(3) Neues Kapitel D2 „Die Schließungsgabelung ist spektral unsichtbar"** [K]: Die Fälle A/B/C aus Dok. 313/295 werden mit der Tabelle der **ausgerollten Zeiten** zitiert (91,9 / 6892 Gyr / Log-Spirale, τ_c = 2π/H₀). Zentraler Befund: **Im eingerollten Zustand gibt es keine fraktalen Korrekturen** — Eindeutigkeit der Mode erzwingt k₄ ∈ ℤ, eine Wicklungszahl ist topologisch und hat keinen Platz für 1/75; Korrekturen brauchen Akkumulation, und akkumulieren kann nur ein durchlaufener Weg. Die zunächst naheliegende **Twist-Lesart** (Scherk-Schwarz, k₄ → k₄ + 1/75) ist damit **falsch**; sie hätte 24 → 6+12+6 gegeben und Inversion wie Trialität als Spektralsymmetrie gebrochen. Folge: die Gabelung hat **keine spektrale Signatur**, und die Kapitel E–H sind **fallunabhängig**. Zuordnungstabelle eingerollt/ausgerollt. Randnotiz: 75 = 1/(100ξ); die Faktorisierung 3·5² trägt **keine** Bedeutung — die Fünf hat nichts mit der Fünffachsymmetrie aus Kap. F zu tun.

**(4) Kapitel J neu gefasst „Was hier noch nackt ist — und was nicht"** [K]: **D_f und K_frak sind verschiedene Dinge** (Dok. 133). D_f^Raum = 3−ξ ist **lokal** und wirkt mit 6,67×10⁻⁵; K_frak = 1−100ξ ist **kumulativ** über den RG-Lauf (17 Größenordnungen, Faktor 100 = RG-Verstärkung) und wirkt mit 1,33×10⁻² — Verhältnis exakt 200. Zwei Korrekturen: die frühere Schreibweise D_f = 4−ξ kennt der Korpus nicht (Dok. 133 definiert die **räumliche** Dimension 3−ξ; auch der Exponent 3/2 in K_frak^{3/2} ist die halbe **Raum**dimension), und die O(100ξ)-Zeile der Störungstabelle entfällt, weil eine kumulative Größe nicht auf einen lokalen Operator gehört. **Die Störung ist damit zwei Größenordnungen kleiner als angenommen** (~10⁻⁵ statt 10⁻²), die Container-Struktur bleibt praktisch intakt. Bilanz: **nackt sind nur die SI-Absolutwerte, und zwar über den Anker, nicht über den Operator** — die eingerollten Größen (Entartungen, Verhältnisse, Kongruenzen, Container, Casimir- und Wärmekern-Verhältnisse) sind nicht nackt, sondern korrekt.

**Neues Prüfskript** `d4_skript_4_stoerung_reziprozitaet.py` (Störungsmultipletts nach Symmetrieklasse, je 3 Seeds; Reziprozität modenweise und im Gemisch); README für `python/Dok314_Skripte/` angelegt. Alle vier Skripte tragen die Sollwerte als Assertions.

**Dok. 313 „Kein Anfang" — zwei Korrekturen, zwei Erweiterungen (DE 25 / EN 24 S.):**

**Korrektur 1 (π gegen 2π):** Beim Kondensieren aus Dok. 295 war eine Qualifikation verlorengegangen. 313 schrieb „eine Windung, die pro **Umlauf um 2π** vorrücken sollte, rückt nur um **π·K_frak** vor" — das mischt zwei Bezugsgrößen und liest sich wie ein Defekt von ~50 %, während gleich darauf d = 1/75 steht. Dok. 295 hat die **Halbdrehung**: „rückt gatterweise nur um π·K_frak vor und verfehlt π um 100π·ξ₀ je Halbdrehung". Nach dem Wortlaut von 295 korrigiert, mit Quellenangabe; der Übergang zu Umlauf-Einheiten ist jetzt explizit.

**Korrektur 2 (ggT):** „Die 75 fällt exakt heraus" war behauptet, nicht begründet — offen blieb, warum die Schließung nicht früher eintritt. Ergänzt: **ggT(74,75) = 1**, also ist das kleinste n mit n·74/75 ∈ ℤ genau n = 75.

**Erweiterung 1 — neuer Abschnitt F.4 „Reichweite: Gleichgewichte an anderen Orten des Zyklus"** [K]: Die übliche Rückwärtsextrapolation T(z) = T₀(1+z) setzt **eine** durchgehende thermodynamische Kette voraus — genau die grobkörnige Verkettung, die nach D(ii) offen ist. In der Ortslesart ist eine frühe Epoche **kein früherer Zustand desselben Systems**, sondern eine Stelle mit anderer lokaler Struktur (kleinere Massen, langsamere Uhren) und einem eigenen, lokal bestimmten Gleichgewicht. Der Korpus zeigt das an sich selbst: T₀ wird nicht extrapoliert, sondern strukturell aus ξ gewonnen (k_BT₀ = (16/9)ξ, Dok. 061). **Abgrenzung:** Die Ω_m*-Kette läuft über ξ, H₀ und K_frak, nicht über adiabatische Rückrechnung, und ist unberührt; betroffen sind allein Aussagen der Form „wie heiß war es in Epoche X" aus Fortschreibung des heutigen Gleichgewichts.

**Erweiterung 2 — Unterabschnitt „Welche Größen bleiben dann aussagekräftig?"** [K]: Kriterium dreiteilig — **keine Skalenbrücke, keine Dauer, gleiche Ebene**. Vier Klassen: *Zählungen* (|Aut(D4)| = 1152, Kusszahl 24, 9 Fixpunkte — exakt, Sätze statt Messungen); *Verhältnisse gleicher Ebene* (α, m_μ/m_e, Koide Q — belastbar, testbar auf 10⁻¹⁰ bis 10⁻⁵); *mit Skalenbrücke* (E₀, G, H₀, T₀, absolute Massen — nur mit Anker, Verhältnisse daraus wieder frei nach A040); *Zahl- und Dauergrößen* (η, Fensterdauern — nicht übertragbar). **Alle drei BBN-Observablen fallen in die unteren beiden Klassen, auch Y_p:** Es hängt zwar an den dimensionslosen Größen Q/T_f und t/τ_n, aber **T_f ist nicht gemessen** (folgt aus einer Ratengleichung mit H, also aus dem kosmologischen Modell) und t/τ_n enthält eine **Dauer**. Das Kürzungsargument ist eine **Implikation**, keine Prüffläche. D/H und ⁷Li stehen weiter außen (η, Fensterdauer, bei ⁷Li zusätzlich Sternatmosphärenmodelle in der Messung selbst). **Folge für die ⁷Li-Position:** Die Korpusbuchung (Dok. 025/063: Nukleosynthese ohne feste Zeitschranke) bleibt konsistent, ist aber **keine quantitative Vorhersage** — aus „keine feste Schranke" folgt kein Zahlenwert; die Faktor-3-Diskrepanz zeigt, dass irgendwo in der Kette etwas nicht stimmt, nicht wo. **Gegenprobe:** Dieselbe Klassifikation trifft ΛCDM genauso (Y_p auch dort kein modellfreier Test, η aus einem Mehrparameter-Fit) — Dok. 267 hält bereits fest: „keiner ist zirkelfrei". Die Klassifikation entlastet FFGFT nicht, sie stellt beide Seiten unter dasselbe Kriterium.
...
**R74 in Dok. 190 (DE+EN, Register jetzt R1–R74 + K1–K7):** Dok. 313 und 314 selbst brauchen keinen Eintrag — sie sind aktuelle Dokumente desselben Zyklus, Korrekturen direkt eingearbeitet (vgl. die Vorbemerkung zu R68–R73). Ein **älteres** Dokumentenpaar ist jedoch betroffen: **Dok. 025 und 063** führen das Lithiumproblem in der Tabelle „Kosmologische Probleme: Standard vs. T0" in der Spalte **„T0-Lösung"** mit dem Eintrag „Nukleosynthese über unbegrenzte Zeit". Die Anspruchsstufe ist eine zu hoch: Der Mechanismus setzt an der Fensterdauer an und ist mit der statischen Lesart konsistent, aber aus „keine feste Zeitschranke" folgt **kein Zahlenwert** für ⁷Li/H — Mechanismus-Skizze, keine quantitative Ableitung. Nach der Belastbarkeitsklassifikation (Dok. 313, F.4) gehört ⁷Li/H zu den Zahl- und Dauergrößen (η, Fensterdauer, zusätzlich Sternatmosphärenmodelle bei der Messung) und ist damit nicht belastbar; die Faktor-3-Diskrepanz zeigt, dass irgendwo in der Kette etwas nicht stimmt, nicht wo — und ist folglich auch kein sauberer Test *gegen* ΛCDM. Betroffen ist allein die Anspruchsstufe der Lithium-Zeile, nicht der Mechanismus und nicht die übrigen Zeilen der Tabelle; empfohlene Formulierung künftig „Mechanismus-Ansatz" statt „Lösung", mit dem Vermerk, dass eine quantitative ⁷Li-Vorhersage aussteht. Dieselbe Prüfung ergab, dass **kein weiteres älteres Dokument** BBN-Observable (Y_p, D/H) als bestandenen Test führt (geprüft: 007, 008, 059, 061, 142, 172, 201, 267); Dok. 267 bucht die BBN-Lücke bereits korrekt als offene Forschungsfrage. Symmetrie ausdrücklich vermerkt: dieselbe Klassifikation trifft ΛCDM genauso. Prüfskript: `python/Dok313_Skripte/ffgft_bbn_skaleninvarianz.py` (Teil C). Quelldokumente unverändert (append-only).

## 3. August 2026 — Dok. 312 „Die Abschlussskala" + Dok. 313 „Kein Anfang" (DE+EN) + R68–R71

**Dok. 312 „Die Abschlussskala" (DE 31 / EN 29 S., Standalone A4 + ch + 5 Prüfskripte):** Die Λ-Funktion der Feldgleichungen erhält einen Träger — Λ* := 1/R_H² = (π/2)²ξ²⁰/λ̄ₑ² = 5,218×10⁻⁵³ m⁻², kein neuer Parameter, dimensionslos Λ*λ̄ₑ² = (π/2)²ξ²⁰. **10¹²³-Problem aufgelöst:** Λ*l_P² = 10⁻¹²¹,⁸⁷ zerfällt in ξ²⁰(−77,5 dex) · (l_P/λ̄ₑ)²(−44,8) · (π/2)²(+0,4) — die Feinabstimmung reduziert sich **vollständig auf P20**. **Weichenstellung:** Die Einstein-Gleichungen werden VOLL übernommen (Lovelock erzwingt die Form inkl. Λ-Term; offen nur G-Wert, Λ-Wert, Lösungswahl) — modellabhängig ist die ΛCDM-Trias {Λ-Fit, FLRW-Anwendung, Expansionsdeutung von z}, nicht die Gleichung. Preis: die Eddington-Stabilitätsfrage greift und wird NICHT über „Geometrie nicht dynamisch" umgangen (Pflicht C); Anhang C1 rechnet das Windungs-/Impuls-Gleichgewicht: stabil bei L*=2πR_H genau dann, wenn T_w = ħcΛ*/(2π) = (π/8)(E_e/λ̄ₑ)ξ²⁰ = 2,63×10⁻⁷⁹ N — dieselbe Stufe ξ²⁰, keine zweite Skala; Impulsquant am Minimum exakt ħH₀; Kippgrenze N_Casimir < 12N_k. Neues bedingtes Label **[K|P20]** durchgehend. Weitere Kapitel: Zeit in den Feldgleichungen (ADM, Wheeler-DeWitt, T̃·m=1); **Statik der Relation** (Okun/Selivanov/Telegdi: Photonfrequenz konstant, Massenlandkarte m(x); Wetterich 2013: Expansion ≡ Massenlauf, Rahmenwahl statt Messung); **Denken in Lichtwegen** (dτ=0, SI bucht Zeit auf Materie/Länge auf Licht, Diskriminatoren sind Materie-Ablesungen; Grenze bei c relational: γ-Ko-Änderung, drei harte Grenzen — Beschleunigung c/g≈1 Jahr pro Faktor e, Energie, Umgebung mit letaler Dosis 267 µs bei 0,99c, Elektronik nicht immun: 0,2c → 19,3 MeV-Protonen, 20-Jahre-Fluenz 3,9×10¹⁸ p/cm² vs. Schwellen 10¹⁰–10¹⁴, 1-ng-Staub = 1,8 kJ, Starshot/Hoang-Loeb); **kompakte Zeitrichtung** (τ_c = 2π/H₀ = 91,9 Gyr, Quant exakt ħH₀ = Impulsquant der Raumzyklen; KMS → T = ħH₀/(2πk_B) = 2,63×10⁻³⁰ K = Gibbons-Hawking OHNE Horizont [S, Wick-Vorbehalt = Pflicht D(i)]; Unruh → a = cH₀ exakt, a₀-Vereinheitlichung mit Dok 308; CTC → Feldperiodizität = Pflicht D(ii), gekoppelt an die Kippgrenze); **Relativbewegung und Torus-Ruhesystem** (γ-Tabelle aller Bahnbewegungen ≤2×10⁻⁶; Vektorprobe Milchstraße-CMB 552 vs. ~550 km/s; Zwilling auf dem Torus β=0,99: 92,9/13,1 Gyr; CMB-Dipol als exakte v/c-Ablesung 369,8 km/s → Kandidat für das Torus-Ruhesystem [S]; Drift 34,8 Mpc/Zyklus harmlos); **Einstein-Epilog** (vier Gründe, warum er T̃·m=1 nicht sah: Programm andersherum/1911-Ironie, ħ im Fundament, fehlende Einheiten-Klarheit vor SI-2019, Grundsatz statt Gesetz; de Broglie 1924, Compton-Uhr Lan/Müller 2013 — „Arbeitsteilung statt Widerlegung"). Voran eine einseitige **Leseführung** (sieben Stationen). Skripte: ffgft_312_abschlussskala, _312C_stabilisierung, _312D_kompakte_zeit, _312_grenze_c, _312_relativbewegung.

**Dok. 313 „Kein Anfang: Die thermische Geschichte auf dem Zeitzyklus" (DE 22 / EN 21 S. + 3 Prüfskripte):** Beantwortet Pflicht D(ii) aus 312. **Antipoden-Befund [K|P20]:** Die gesamte beobachtbare Geschichte füllt EINEN Halbzyklus — mit fraktaler Wegkorrektur sitzt der Partikelhorizont auf 0,14 % am Antipoden (θ = 0,9986π; glatt 1,012π), die Streuwand bei 0,979π. Der „Urknall" ist ein ORT auf dem Zyklus (Region kleinster Massen, langsamster Uhren), kein Ereignis. **Glatte Schließung [K]:** Endpunktsteigung √Ω_r ≈ 0,0096 — die Glattheitsbedingung einer geraden periodischen Schließung ist auf 1 % erfüllt; die Rückkehr-Hälfte ist exakt die photonisch unbeobachtbare Hälfte (Folge des Antipoden-Befunds, keine Wahl). **Untergrenze:** E_min = ħH₀ = 2,28×10⁻⁵² J, m_min = 2,54×10⁻⁶⁹ kg, ħH₀/(mₑc²) = (π/2)ξ¹⁰ exakt → endliches z_max = 3,59×10³⁸; kein „z→∞". Drei Folgen: Singularität durch Quantisierung AUSGESCHLOSSEN (nicht nur falsch gestellt), EINE Skala setzt beide Grenzen (Λ* oben, ħH₀ unten), und Poincaré SETZT Endlichkeit voraus — die Endlichkeit ist Voraussetzung der Schließung, nicht ihr Hindernis. **Entropie-Hindernis [K]:** Poincaré-Diskrepanz 10¹⁰⁴ dex im Exponenten → Periodizität ist RANDBEDINGUNG ([SETZUNG]-Kategorie), nicht Dynamik; feinkörnig zulässig, grobkörnige Schließung offen = präzisierter harter Kern von D(ii). **Hawking-Kapitel:** eine KMS-Regel T = ħ/(k_Bτ) für Unruh/Gibbons-Hawking/Hawking; Membran-Thermometer (Kap.-04-Bild bekommt seine Temperaturbegründung über T̃·m=1); Familienleiter trifft den Kosmos bei r_s = R_H/2 exakt (halbe kritische Hubble-Masse); Verdampfung M* = 3,3×10¹¹ kg pro Zyklus, Sonne 56 dex / SMBH 83 dex zu langsam → **Hawking VERSCHÄRFT D(ii)**; FFGFT-Korrektur (1−ξln(M/M_P)) = 0,6–1,4 %; Information: Membran-Korrelationen = feinkörnige Konstanz, zwei Sprachen eine Aussage. **Ω_m-Kette allein aus ξ [K|P20×E]:** H₀ → T₀ (Dok 061, Atomskala) → Ω_r → Antipoden-Bedingung ∫dz/E = π/K_frak → **Ω_m* = 0,3136** gegen Planck 0,315±0,007 (−0,19σ); kein Schritt enthält einen an Ω_m angepassten Parameter. **Überbestimmung [K]:** Teilchensektor 0,3136 vs. kosmischer Sektor (FIRAS-T₀) 0,3139 — zwei unabhängige Sektoren, dieselbe Zahl auf 0,1 %, dasselbe Muster wie α in A130. Hebel dT₀/T₀ ÷ dΩ_m/Ω_m ≈ −12 → als Konsistenzprüfung zu führen, nicht als T₀-Bestimmung. κ* = 3Ω_Λ* = 2,059 (−2,8 % zu 2,12) → Pflicht B und Antipoden-Koinzidenz werden EINE Bedingung. **Drei deklarierte Erbschaften:** SI-Anker (309), E(z)-Form, und die Vergleichsgröße selbst (Planck-Ω_m ist Fit-Output → „Bedingung gegen Pipeline, nicht gegen Natur"). **Prüfflächen:** CνB/GW-Nichtmonotonie am Antipoden — nach der Wegkorrektur die EINZIGE verbliebene (Matched Circles entfallen). **DM zweigeteilt:** galaktisch erledigt via a₀ (308), Hintergrund-(1+z)³-Träger offen. Skripte: ffgft_313_zeitzyklus_geschichte, _313_hawking_zyklus, _313_fraktale_wegkorrektur.

**R68–R73 in Dok. 190 (DE+EN, je +6 Einträge, Register jetzt bis R73 + K7):** Nur Einträge, die ÄLTERE Dokumente präzisieren — Dok. 312/313 selbst sind aktuell und brauchen keine Registrierung (ihre Inhalte stehen in den Dokumenten, nicht im Korrekturverzeichnis). **R68** (A272, 279, 308): Die Λ-Funktion erhält mit Λ* = 1/R_H² einen Träger; A272 bleibt bestehen und erhält die konstruktive Ergänzung (Artefakt als Konstante, real als abgeleitete Skala); neues bedingtes Label [K|P20]; volle Übernahme der Feldgleichungen (Lovelock) mit der Konsequenz, dass die Eddington-Stabilitätsfrage greift (Pflicht C); 10¹²³-Problem reduziert sich vollständig auf P20; κ = 2,12 offen und die n=10-Kandidaten post-hoc markiert (R61-Disziplin). **R69** (308): Die kompakte Zeitrichtung ist die strukturelle Quelle der Unruh-Verankerung — aus den zwei getrennten a₀-Argumenten wird eines; neue Pflicht D(i) (KMS/Wick-Vorbehalt) und D(ii) (Feldperiodizität, gekoppelt an die Kippgrenze). **R70** (061, A085, A080): **T₀-Skalenlücke** — A085 [B] erlaubt nur EINE Kalibrierung, A080/A130 legen sie mit E₀ = √(mₑm_μ) = 7,348 MeV fest (überbestimmt durch einen zweiten, α-freien Weg); Dok. 061 verwendet stattdessen „1 eV" (verlangt U = 0,9908 eV, log_ξ(U/E₀) = 1,77, keine ganze Potenz). Die CMB-Temperatur ist damit die EINZIGE Korpus-Größe ohne Kammerton-Bezug (k_BT_CMB/(mₑc²) = 4,596×10⁻¹⁰, log_ξ = 2,41; gegen E₀: 2,71); eine systematische Suche über rationale Vorfaktoren liefert nur die Zufallsdichte an Treffern (R61-Kontrolle wie bei der Basis 74/75 in R67) → die Aufgabe lautet Vorwärtsherleitung, nicht Suche. Dazu zwei weitere Befunde: **Notationskollision** (T₀ bezeichnet in A085 die Kalibrierungstemperatur 8,53×10¹⁰ K, in 061/313 den CMB-Monopol 2,7255 K — Faktor 3×10¹⁰ unter demselben Symbol) und die **falsche Präzisionsangabe** in 061 („0,0002 %" in der Zusammenfassung gegen „Übereinstimmung zu 1 %" in der eigenen Detailrechnung; korrekt 0,92 %). **R71** (309, Verschärfung): Es gibt keinen SI-verankerten H₀-Wert — Planck 67,4 ist Fit-Output, SH0ES 73,0 stammt aus der mehrstufigen Entfernungsleiter, Diskrepanz 8,3 % (5–6σ, ungelöst). Die FFGFT erbt daher nicht nur eine Zahl, sondern die SEITENWAHL in der Hubble-Spannung, und diese ist bisher nicht als Setzung gebucht (SH0ES verlangte den Vorfaktor 1,716 statt π/2 = 1,571). Die theoretische Aussage selbst ist SI-frei (ħH₀/(mₑc²) = (π/2)ξ¹⁰); SI kommt erst beim Vergleich ins Spiel. Neuer offener Punkt: der Beweiswert der Kette hängt am VORFAKTOR — die ξ-Leiter ist grob (Stufenabstand 3,875 Dekaden), die Zufallschance eines 1-%-Treffers beträgt 0,22 % (signifikant, sofern π/2 unabhängig feststeht), ein im Bereich 0,5–2 freier Vorfaktor deckt dagegen 16 % der Stufe ab → **ist π/2 hergeleitet oder gesetzt?** Bis zur Klärung ist der 0,86-%-Treffer gegen Planck ein bedingter Befund. **R72** (A010, A080, A265, A130, direkt eingearbeitet): Drei Dokumente schreiben „E₀ = √(mₑm_μ) ≈ 7,398 MeV“, während das geometrische Mittel 7,348 MeV ergibt. **Der Kern des Befunds:** Die beiden Werte sind nicht zwei unabhängige Bestimmungen, sondern derselbe Wert **nackt und fraktal korrigiert** — E₀(α-Weg)/E₀(Massen) = 1,006818 gegen 1/√K_frak = 1,006734, Übereinstimmung auf **0,008 %**. Der Wurzelfaktor ist zwingend, weil E₀ quadratisch in α = ξE₀² eingeht; die Zuordnung folgt A040 [B] (absolute Werte tragen K_frak, Verhältnisse nicht). Daraus dreierlei: (i) Die Schreibweise in A010/A080/A265 ist verkürzt, aber strukturell begründet — **Zahlenwerte bleiben unverändert**, ein Vermerk stellt in allen dreien die Zuordnung klar (nackt = 7,348; α-verankert = 7,398), DE+EN eingearbeitet und neu kompiliert. (ii) E₀ als Kalibrierung ist eindeutig: geführt wird der korrigierte Wert, da nur er α auf 5×10⁻⁶ trifft und ein Anker EIN Wert sein muss. (iii) **K_frak ist damit überbestimmt:** aus den beiden E₀-Werten folgt K = (E₁/E₂)² = 0,9865, also n = 101,3 — neben n = 100±2 aus der D_f^eff-Konsistenz (A040/R67) und n = 100,27 aus der Sektorleiter (A270); drei unabhängige Wege, alle im R67-Intervall [98,3; 102,0]. **Korrektur einer Fehladressierung:** R68 nannte ursprünglich A272 als Λ-Lesart-Dokument — A272 ist jedoch „Träger und Information“ (Landauer); die Λ-als-Lesart-Artefakt-Aussage steht in Dok. 308, das auch a₀ trägt. R68 betrifft daher 279 und 308.

**R73** (026, 279): Der Korpus führt drei Schreibweisen derselben H₀-Kette, und zwei in 279 als offen gelistete Punkte sind bei genauem Hinsehen keine. **(i)** Die 279er-Form L_ξ H₀/c = (π/2)(15/π²)^(1/4)·(mₑc²/k_BT_CMB)·ξ^(41/4) und die Kammerton-Form H₀ = (π/2)cξ¹⁰/λ̄ₑ sind **algebraisch identisch** (beide 66,821 km/s/Mpc, Verhältnis 1,000000): L_ξ trägt selbst ξ^(1/4), beim Einsetzen kürzt sich ξ^(41/4)/ξ^(1/4) = ξ¹⁰. 41/4 ist die Schreibweise mit L_ξ-Anker, 10 die mit dem Kammerton — kein zweiter Exponent, keine zweite Kalibrierung (P20 bleibt unberührt). **(ii)** Das Verhältnis mₑc²/(k_BT_CMB) = 2,176×10⁹ **kürzt sich dabei vollständig heraus**, ebenso (15/π²)^(1/4) — es ist ein Durchgangsposten der L_ξ-Schreibweise und braucht keine geometrische Erklärung. Der in R70 gebuchte offene Punkt betrifft etwas anderes (was T₀ selbst setzt) und bleibt. **(iii)** Eine reale Abweichung: Dok. 026 führt eine dritte Kette, H₀ = E₀ξ^(41/4)/ħ mit E₀-Anker, und erhält 66,18 statt 66,82 — Faktor (E₀/mₑc²)ξ^(1/4)/(π/2) = 0,9904, also 0,96 %. **(iv)** **Die π/2-Frage aus R71 löst sich auf:** π/2 ist gar kein Vorfaktor. Schreibt man die Kette als Länge statt als Rate, verschwindet π vollständig — **L∗ = 2πc/H₀ = 4·λ̄ₑ/ξ¹⁰**, exakt auf zehn Stellen (2,252541×10³⁹). Die primäre Aussage lautet: *der Zyklus ist vier Kammertöne mal die Leiterstufe*; das π/2 entsteht allein aus H₀ = 2πc/L∗. Der Einwand eines frei wählbaren Ordnung-1-Vorfaktors (R71) entfällt damit — an seiner Stelle steht eine ganze Zahl. Diese Form ist in Dok. 312 als eigene Gleichung eingearbeitet. Offen bleibt die **Herkunft der Vier** (Torusrichtungen, 2², D4 — sämtlich post-hoc, nach R61 nicht bookbar) sowie die 0,96 % der 026-Kette, die in dieser Sprache 3,9616 statt 4,000 Kammertöne verlangt: eine ganze Zahl gegen eine krumme — die Abweichung ist in Dok. 026 zu suchen, nicht in der Kammerton-Kette. **Zusätzlich in Dok. 313 eingearbeitet:** ein zweiter, unabhängiger Test der Zuordnungsregel aus R70 — die Peakposition ℓ₁ = π D_A/r_s ist ein Weg/Weg-Verhältnis, K_frak kürzt sich, die CMB-Peaks bleiben exakt unverändert. Gäbe es die Kettenregel nicht und wirkte der Faktor nur auf D_A, verschöbe sich ℓ₁ um 1,35 % = 3 Multipole — bei Planck-Genauigkeit (±0,5) sofort falsifiziert. Die Regel besteht den Test, ohne dafür konstruiert worden zu sein. Quelldokumente sonst durchgehend unverändert (append-only).

## 1. August 2026 — R67 (Faktor 100, A040/A270) + Dok. 311 „Vier auf drei" (DE+EN)

**R67 in Dok. 190 (DE+EN, je +1 Eintrag, Register jetzt bis R67 + K7):** Der Faktor 100 in K_frak = 1−100ξ ist ein aus dem RG-Lauf gemittelter Wert mit einer **nirgends bezifferten Angabegenauigkeit von etwa ±2**. A040 führt ihn als [K] „abgeleitete Größe", der eigene Text weist ihn aber als Näherung aus („rund 100", „geometrische Mittelung"), und die beiden dort gebuchten Schreibweisen sind ungleich: (D_f^eff/3)^(D_f^eff/2)=0,986651 gegen 1−100ξ=0,986667. Bei D_f^eff=2,973 (drei Nachkommastellen) lässt das Rundungsintervall n∈[98,3, 102,0] offen; selbst D=2,973 exakt gibt n=100,12. Die Konsistenzbedingung, die D_f^eff festlegt (m_e/m_μ fraktal gegen 5√3/18·10⁻²), trägt selbst 0,52 %. **Folge für A270:** die 0,098-Differenz der beiden Wege zum Bulk-Exponenten 36 ist damit gedeckt, KEIN realer Rest — n=100,273 brächte Deckung (ΔD=4,2·10⁻⁵, vierte Nachkommastelle); zusätzlich verwendet A270 das naive k*=lnφ/ξ=3609,09 statt des in Dok. 275 selbst angegebenen exakten k*_exakt=3608,51 (erklärt 0,006 der 0,098). Fortpflanzung: ±2 auf n → ΔK_frak=±2ξ≈±2,7·10⁻⁴ (0,027 %); K_frak tritt im Quelltext von **18 der 48 A-Dokumente** auf (die früher genannten „46 von 48" waren falsch — nachgezählt) und geht über A080 in jeden absoluten Wert ein; Verhältnisse per Konstruktion unberührt. Unberührt auch: Zuordnung zur Ganzzahl 36 (beide Wege stabil, kein Wert näher als 0,4 an einer Rundungsgrenze) und P35. Prüfskripte python/Dok190_Skripte/: r67_faktor100_unsicherheit.py (neu), r67_toleranz_k36.py (Toleranzrechnung; **Nachtrag-Sektionen 2n und 7 im Skript** — Abschnitt 7 reproduziert die Basen-Prüfung aus der K36-Notiz: alle Basen m/(m+1), m=2–400, 17 Treffer besser als 0,010 % bei Erwartungswert ~16, Rang von 74/75 = 17/399 → der 0,010-%-Treffer ist für sich kein Signal, gleiches Ergebnis wie ξ-Glätte in Basis 30; Sektion 2n: die ursprüngliche Fassung behandelte die 100 als exakt und fand 16 σ — mit der Nenner-Unsicherheit σ=0,72 im Exponenten sind die 0,098 nur 0,13 σ; Fazit entsprechend korrigiert). Quelldokumente A040/A270 unverändert (append-only; Korrekturen leben allein im Register). NACHGEZOGEN (gleicher Tag): Kopf-Nachtrag in der 190-Vorbemerkung (Statuszeile → Stand 1. August, „Register bis R67 + K7"; die Klausel „100 ≠ 3609" bleibt, wird um die ±2-Genauigkeit präzisiert) UND R67-Nachtrag II: Betrifft um **Dok. 133** erweitert — Altkorpus-Gegenstück zu A040, gleiche Herleitung, teils schärfer („Verstärkungsfaktor von 100" ohne „rund", D_f^eff „die EINZIGE"), ebenfalls ohne Genauigkeitsangabe; alle Punkte (i)–(v) gelten unverändert; vgl. Dok. 300 (referiert 133s Fixierungs-Aussage). Betroffenheits-Bilanz korpusweit: KORREKTUR-betroffen nur A040, A270, Dok. 133 (Herleitungs-/Befund-Aussagen); FORTPFLANZUNGS-betroffen (benutzen K_frak in Absolutwerten, ±0,027 % relativ, Verhältnisse per A040 [B] unberührt, KEINE Korrektur nötig): 18 A-Dokumente und ~70 Altkorpus-Dokumente (Quelltext-grep). Register DE 61 S., EN 53 S., 0 Fehler/0 Glyphen. KLARGESTELLT (gleicher Tag, Johanns Entscheidung): KEINE In-Dokument-Nachträge in A040/A270 — Quelldokumente bleiben strikt unverändert; die vollständige Korrektur lebt allein in Dok. 190 (R67 mit (i)–(v), Nachtrag II zu Dok. 133, Kopf-Nachtrag der Vorbemerkung). Zwischenzeitlich eingesetzte Nachträge in A040/A270 (DE+EN) wurden vollständig auf den Git-Stand zurückgesetzt (tex + pdf identisch zum Original).

**Dok. 311 „Vier auf drei — Wie kommt ein 4D-Gitter auf drei Raumdimensionen?" (DE+EN je 22 S., Standalone A4 + ch-Fassungen + Skript):** Arbeitsnotiz (nicht A-Serie) aus NOTIZ_Vier_auf_Drei. Drei Wege (kompaktifizieren / projizieren / vierte-ist-kein-Raum) mit Kostenbilanz; Weg 1 und 3 einzeln unvollständig (Mechanismus ohne Bedeutung / Bedeutung ohne Mechanismus), geschlossen durch T̃·m=1 (kompakt UND gebunden → Skala ohne Modul). Weg 2 vertieft: Projektion ist Zugriff von außen (Schnittrichtung+Fenster = Beobachterparameter, nicht bindbar), D4→3D: 24 Vektoren→18 Bilder (12 FCC unberührt, 12 Wicklungsvektoren paarweise verschmolzen, zwei Bildlängen 1/√2 — Kennzahlen überleben nicht); φ bei cut-and-project ist Eigenschaft der GEWÄHLTEN Richtung. **Umkehrung:** wo φ GEFUNDEN wird (A120: Gewichte p₀=2/9 rational, p₁/p₂ mit φ, Nenner 9=3²; Ikosaeder-Achsen (0,±1,±φ), formfest, Umkugel/Kante=√(φ√5)/2), legt es Richtung und Fenster fest — Eigenwert statt Wahl, diskrete Zweifachwahl (2/9 oder 4/9) statt freier Winkel. **Verdichtung auf zwei Bedingungen** (statt drei Wege): (1) Zuordnung erzwungen oder gesetzt? (2) verlorene Ortsinformation von erhaltenem Index aufgefangen? — Beispieltabelle: KK frei nein/ja, cut-and-project generisch nein/nein, FFGFT ja/ja, ikosaedrisch ja/„nur mit Index". **Zerfallsbefund:** D4 muss nicht reduziert werden, es zerfällt selbst: 24=12+12 (x₄=0 → exakt die FCC-Kusszahl 12, Kuboktaeder als Nachbarschaftsfigur des 3D-Raums, Kepler/Hales-Einzigkeit; x₄≠0 → je 6 Wicklungsnachbarn pro Umlaufrichtung) = Gitterform von T⁴=T³×S¹_m, Aufteilung fällt heraus statt hineingelegt. **Kennzahlen-Folge:** wer räumlich mit 24 rechnet, behauptet implizit vier Raumdimensionen. **K⁻³⁶-Prüfung:** die 4D-Dichte gehört hinein (16/π²→Exponent 35,9926, Abstand 0,0074 zur Ganzzahl) — die 3D-Dichte scheidet aus (3√2/π→22,3836, 38 % daneben, 0,38 an der Rundungsgrenze); kein Widerspruch zum 12er-Befund: Packung zählt alle vier Torusrichtungen, räumliche Kusszahl nur drei (muss aber GESAGT werden — π²/16 ist nicht neutral). **Anwendung** (Frage, keine Feststellung): Konstruktionen mit 24 räumlichen Offsets ohne erklärte Zeitrichtung; drei unbequeme Auswege benannt. **Stringtheorie-Anlage:** Bedingung 2 vorbildlich erfüllt (alles erhaltene Indizes), Bedingung 1 halb (D=10/6 kompakte Richtungen erzwungen — stärker als FFGFTs [SETZUNG] T⁴; Calabi-Yau-Wahl/Flüsse/Moduli gesetzt) → **Landschaft = genau der unerfüllte Teil von Bedingung 1**, und über A060 (Zeit außen → Skalen aus Moduli) sind Landschaft und angeheftete Skalen EIN Problem, nicht zwei. NEUE SEKTION (gleicher Tag, aus K36-Notiz Abschnitt 2): „Wie scharf die Zuordnung ist" im K⁻³⁶-Kapitel — Tabelle der fünf Nachbar-Exponenten 34–38 ((75/74)ⁿ gegen 16/π²: −2,639/−1,323/+0,010/+1,361/+2,731 %), Fenster mit zwei Rändern, Nachbarn ~100× weiter; dazu zwei Einordnungen: 0,010 % misst die Rundung (nicht die Wege-Übereinstimmung, 0,098 per R67 gedeckt), Schärfe betrifft Zuordnung nicht Herleitung (P35). Bezüge inkl. R67. Skript python/Dok311_Skripte/ffgft_311_vier_auf_drei.py (alle Zahlen verifiziert: 24/12/12/18, {±1: je 6}, Dichten, Exponenten, φ-Projektionslängen, A120-Gewichte Summe 1, Ikosaeder-Quotient).

## 27. Juli 2026 — Dok. 308/309/310: Kosmischer Sektor, Skalenanker, Resonanzgeometrie (DE+EN, je Standalone + Prüfskripte)

Drei neue Korpus-Dokumente (nicht A-Serie), noch nicht auf Zenodo released.

**Dok. 308 „Der kosmische Sektor der FFGFT" (DE+EN je 11 S.)** — vollständig neu geschrieben als lesbares Gesamtdokument (Rotverschiebung, dunkler Sektor, geometrische Gravitation). Kette ξ→H₀→R_H→K3-Zyklen→a₀ = c²ξ¹⁰/(4λ̄ₑ) = 1,033×10⁻¹⁰ m/s². Terminologie final: a₀ ist die **Übergangsskala des Trägheitsregimes** (T̃·m=1 + Unruh), kein Gravitationsparameter (G ~ ξ², a₀ ~ ξ¹⁰ — verschiedene Mechanismen). Dunkle Materie: „ein Regime, kein Stoff". DDO 154 ratio 1,001; Bullet Cluster Peak 10 kpc. Vier Prüfskripte in `2/Dok308_Skripte/` (Stufe A a₀-Kette, B1 Faktor-2-FE-Raytracing, B2 κ-Herleitung, C Bullet Cluster).

**Dok. 309 „Das Skalenanker-Problem: ΛCDM und FFGFT" (DE+EN je 9 S.)** — Arbeitsnotiz. Kernthesen: SI seit 2019 auf einen konventionellen Anker (ν_Cs) zurückführbar, nur dimensionslose Verhältnisse wirklich festgelegt; ΛCDM ~6 freie Parameter, H₀ zirkulär (4-stufige Leiter); nicht ξ ist der Fit, sondern der **Exponent 10** in H₀=(π/2)·c·ξ¹⁰/λ̄ₑ (nur n=10 plausibel/ganzzahlig). **Vererbungsproblem** (neu benannt): Exponent 10 an H₀_ΛCDM kalibriert → FFGFT erbt die Systematik der Expansionslesart; lesartunabhängige Herleitung aus T⁴-Geometrie nicht geleistet (P20/P33). Querverankerung: ξ¹⁰ reproduziert H₀ UND a₀.

**Dok. 310 „Die Resonanzgeometrie als übergeordnete Referenz" (DE+EN je 13 S.) + 4 Prüfskripte** — beantwortet den Zirkularitätsvorwurf durch Korrektur der Hierarchie: **übergeordnet** ist die Geometrie mit Resonanzen (dimensionslos, legt alle Verhältnisse fest); der **Messwert** ist nur der Kammerton (Anker in SI, trägt keine Struktur). Drei Aussagen, alle **[K]** (an den gemessenen Massen nachprüfbar): (1) Koide Q=2/3 aus drei Massen ohne ξ, Winkel 44,9997° zu (1,1,1), Rest −6,2×10⁻⁶≠0 als Signatur echter Vorhersage; (2) Generationsleiter als **geometrische Folge** mit Verhältnis q=2/3 — derselbe Wert wie Koide Q, dieselbe Zahl ordnet Leiter und Massenrelation (Dok. 258), keine arithmetische Schrittweite (Sprünge 1/2, 1/3 als Konsequenz); (3) harmonische Vorfaktoren 4/3, 16/5, 25/9. Dass andere Sektoren auf anderen Sprossen sitzen, berührt die Realität dieser Leiter nicht (kein Alleinstellungsanspruch). **π-Faktoren sind Sphären-Geometrie, keine Schleifen:** 16π³ = S²·2S³ (T⁴-Randgeometrie); die frühere Version 64π⁴ zählte exakt eine 2-Sphäre zu viel (64π⁴/16π³=4π=S²). μ₀/ε₀ (Dok. 011/013/015) folgen aus α,e,c und trennen Geometrie (4π=S²) von Einheit (10⁻⁷); in α kürzt sich das 4π. **Zwei Stufen:** ℏ=c=1 → μ₀,ε₀ verschwinden, α,ξ bleiben; zusätzlich α=1 (T0-Einheiten, Ladung umdefiniert e=1) → nur ξ bleibt. **QM/RT-Vermengung berechtigt:** ℏ,c beide Einheiten-Brücken, T·m=1 ist selbst die Vermengung, Konflikt ist Interpretations- kein Formalismuskonflikt (Dok. 230, Bell topologisch auf T⁴). Skripte in `2/Dok310_Skripte/` (koide_referenz, massenleiter, pi_geometrie, higgs_zugang).

Zugehörig: Dok. 190 P44/R44 zurückgenommen (308 noch nicht released); nach 308-Release nachzutragen. Offen im Korpus (Kandidat für Registereintrag): Dok. 159/181 verkürzen die Generationsleiter fälschlich zu „konstante Schrittweite 1/3 = 1/D" — Dok. 258/310 korrigieren dies zur geometrischen Folge q=2/3.



Block 3 der A-Serie um die Thermodynamik der Berechnung erweitert. Alle drei Dokumente deklarieren **FFGFT-Berührung: keine** — sie leben auf der Ebene der statistischen Mechanik, das ξ-Schema wird nicht berührt (eigene Ebene, eigene Buchhaltung, P20/P39-analog). Neuer Schichtmarker **[Q] — Quelle: korpusexterne Primärquelle oder Messwert**; [K] (Kern, aus ξ hergeleitet) kommt in diesen Dokumenten nicht vor.

**A271 „Landauer und die Phasenraum-Buchhaltung" (DE 21 / EN 20 S.)** — Landauer nicht als Aussage über Information, sondern über Gebiete im Phasenraum. Kette: Gebietsreduktion verkleinert das Volumen; Liouville verbietet Schrumpfung im abgeschlossenen System; ein Bad muss das Volumen übernehmen; Preis Q ≥ k_B·T·ln(W_v/W_n), ln2 nur Binär-Spezialfall. Gezählt wird nach Unterscheidbarkeit (Orthogonalität), nicht nach Energie; Grund-Diskretisierung h^f. Daraus die Inhaltsneutralität: die Thermodynamik zählt Gebiete und liest sie nicht — es gibt keinen thermodynamischen Wahrheitsdetektor. Hinreichend für die Wärmeproduktion ist die **Nicht-Bijektivität der Gebietsabbildung**, nicht die logische Irreversibilität: mit der Gebietsabbildung fällt diese nur unter einer deklarierten Realisierungsannahme zusammen (disjunkte Gebiete, kein mitgeführtes Gebiet), ohne sie trägt sie nichts, weil Bennett jede logisch irreversible Funktion bijektiv ausführt. Drei Ebenen strikt getrennt (Konstruktion / Zustandsübergang / Beschreibung); daraus der kontinuierliche Entropiestrom eines realen Rechners (DRAM-Refresh, Qubit-Dekohärenz) statt diskreter Bit-Löschungen. Epistemischer Vorbehalt gebucht: nicht messbar heißt nicht nicht vorhanden — Landauer gilt wegen der Mechanik (Liouville), nicht wegen Unwissenheit; die Irreversibilität ist statistisch, nicht ontologisch absolut (Maxwells Dämon, Bennetts Auflösung). Prüfskript a271_landauer.py (Checks 1–10).

**A272 „Träger und Information" (DE+EN je 13 S.)** — Textkritik. Was Landauer 1961 beweist, ist eine untere Schranke für **Träger-Operationen** an einem thermischen Gleichgewichts-Ensemble, keine universelle Aussage über abstrakte Information. Satz 1 (Mehrfachrealisierung): einem Informationsbit kann keine Energie zugeordnet werden, nur seinem Träger. Satz 2: eine rein interpretative Löschung verkleinert den Träger-Zustandsraum nicht. Ausdrücklich als Zuständigkeitsbefund gefasst, nicht als Widerlegung — der Ertrag ist, dass die beiden Vorgänge auseinanderfallen und nur der zweite unter die Schranke fällt. Landauers eigener Ensemble-Vorbehalt aus der Originalarbeit dokumentiert; Rezeptionsgeschichte der Verallgemeinerung (Lairez, Norton, Earman/Norton, Hemmo/Shenker); Sprachkritik der Digitaltechnik (Tabelle Träger vs. Information); Hypostasierung als Deutungsrahmen [S]. Rückkopplungsschranke Q_min = kT(ln2 − I) mit I dimensionslos in nat; das Wissen I ist selbst trägergebunden, der Preis wird verschoben, nicht vermieden (Bennett). Verbindliches **Wörterbuch A271 ↔ A272**: Gebiet = Träger, Beschreibung = Information, Gebietsreduktion = Träger-Operation, Nicht-Bijektivität = Verkleinerung des Träger-Zustandsraums.

**A273 „Die Rechenkugel" (DE 11 / EN 10 S.) + Prüfskript a273_rechenkugel.py (Checks 1–14, 16/16 bestanden)** — Token-Rechnen (Abakus, Muscheln, Münzen) als Grenzfall, an dem Landauers Argument in zwei unabhängige Hälften zerfällt. Die **Buchhaltung** gilt exakt und ist sichtbar: der Markenvorrat ist ein Bad, auf das man zeigen kann; Marken bleiben erhalten (Liouville-Analogon, abzählbar); ΔS/k_B = N·ln2 trägerunabhängig. Die **thermische Umrechnung** ΔS → Q = T·ΔS gilt dort nicht: Kugelverschiebung 1,47·10⁻⁵ J = 5,1·10¹⁵ × Landauer; Positions-Bit trägt 3,8·10⁻²³ der Eigenentropie der Kugel (1,8·10²² k_B); Positionsbarriere 3,6·10¹⁵ k_B·T. Der Token-Rechner fällt damit unter Landauers eigenen Ensemble-Vorbehalt, doppelt: kein thermisches Ensemble, und der Rechner kennt die Konfiguration (I = ln2 ⇒ Q_min = 0). Zwei Böden: der thermische k_B·T und der quantengeometrische ħc/L, maßgeblich ist der größere — für massive mechanische Träger ist ħ²/(2mL²) einschlägig und irrelevant (Kugel 2,7·10⁻⁴¹ k_B·T, Kolloid 1,6·10⁻²² k_B·T), bei 300 K schneiden sich beide bei 7,6 µm, beim Qubit führt der quantengeometrische (hf/k_B·T = 24 bei 5 GHz und 10 mK). Daraus die Ordnung: **Sichtbarkeit der Struktur und Bindekraft der Zahl laufen gegenläufig** — je primitiver der Träger, desto klarer die Buchhaltung und desto irrelevanter die Schranke. Grenzübergang ausrechenbar: kritische Markenmasse k_B·T/(μ·g·d) = 1,4·10⁻¹⁹ kg; Béruts Kolloid hält seine Position durch eine optische Falle mit auf wenige k_B·T einstellbarer Barriere. Zusätzlich der Markenvorrat als eigene Kostenkategorie: eine Materialschranke ohne Untergrenze in k_B·T, stehender Bestand statt laufendem Strom; beim Halbleiter aus dem Blick, weil der Vorrat in Silizium eingegossen ist [S]. Offen [H]: gemeinsame Bilanz von Bestand und Strom.

## 16. Juli 2026 — Dok. 307: Zeit im Zustandsraum oder daneben — Verortung der Zeit und Herkunft der Massen-Moden (DE+EN, A4-Standalone mit Quellen und Interlinks)

Neues Korpus-Dokument (DE 17 / EN 14 S., 0 undefinierte Zitate, 0 fehlende Glyphen; A4-Standalone mit Titelseite, vollständiger Bibliographie und klickbaren Cite-Interlinks, Inter + Libertinus Math; zusätzlich ch-Fassung für Buch-Builds). Trägt eine methodische Gabelung durch ihre Konsequenzen: ob die Zeit eine Richtung IM Zustandsraum ist oder ein Parameter DANEBEN. Beide Lesarten benutzen denselben Operator-Formalismus (selbstadjungierter Operator, Spektralsektoren) — der Unterschied ist nicht mathematisch, sondern die Verortung der Zeit. Ausgerollt: Zeit bleibt äußerer Parameter, Massen müssen angeheftet werden; eingerollt: Zeit ist kompakte Dimension, Massen sind Eigenwerte einer Modenstruktur (FFGFT-Ausführung T̃·m=1 auf L²(T⁴)⊗ℂ³, Dok 230/231/232, 306).

MASSENSEKTOR korpuskonsolidiert: die Leptonmassen in DREI ineinander übersetzbaren Darstellungen — (1) grundlegend, Quantenzahlen (n,l,j) + fraktale Korrektur K_frak=1−100ξ (direkte geometrische Methode, Dok 006: ξ_i=ξ_0·f(n,l,j), E_i=1/ξ_i); (2) Yukawa-/Leiter-Form m=r·ξ^π·v (Dok 006/046, π=3/2,1,2/3); (3) Z₃-Zirkulant/Koide √m_k=M(1+√2·cos(2/9+2πk/3)) mit Q=2/3, θ=2/9 als Ausgabe der Diagonalisierung (Dok 282/292). Kernaussage (P40): die dimensionslosen Verhältnisse sind exakt; Abweichungen entstehen erst bei der SI-Umrechnung in absolute Werte, aus mehreren Gründen (SI-Umrechnung selbst — ħ,c,G Konventionsfaktoren; Brückenkonstanten v/E₀; K_frak; Messgenauigkeit). N₀ NICHT in der Abweichungsliste (N₀≈38,6 ist leiter-intern, offen, keine Grundeinheit — Klarstellung ggü. Dok 292).

§8.1 (Ontologie) korpuskonform an Dok 306: die Zeit ist diskret (minimales Inkrement d₁=100ξ=1/75, Dok 306); da die Moden über die feste ξ-Geometrie stets in exakter Relation stehen, existiert ein gemeinsamer GRUNDTAKT — die einzelnen Zyklen T=ħ/mc² sind kommensurable Vielfache eines ξ-fixierten Inkrements (Harmonische eines Grundtakts), kein Kontinuum freier Uhren und kein von außen aufgeprägter Weltentakt. Kausalität als adressiert (Torus π₁≠0, Bell topologisch ~ξ, Dok 230/022; dekompaktifizierter Lorentz-Sektor Dok 270/306). Quantengravitation als Hilbertraum-Konstruktion (L²(T⁴)⊗ℂ³, θ=2/9 aus Z₃-Zirkulante, Dok 230/231/232, settled). KOSMOLOGISCHER SEKTOR bewusst NICHT im Dokument (H₀/Faktor 41/4 gehören nicht hierher). Framework-Observable: Mass-reading, CHSH~ξ, D_f, L₀. Epistemik-Ledger (proven/restricted/offen) am Schluss. Externe Quellen als Prosa-Nennungen + volle Bibliographie (Pauli, Wigner, Kaluza-Klein, Page-Wootters, Wheeler-DeWitt, Rovelli u.a.); interne Dok-Verweise durchgehend. Register-Bezug: Dok 190 R54 (N_0-Status + Grundtakt-Lesart von 292/306).
...
sechs Begleitskripte zu Dok. 263 im Ordner `python/Dok263_Skripte/`; README und dieser
...
- **python/Dok267_268_Skripte/** (neu): 9 Python-Skripte zu 267/268
...
### Skripte (python/Dok267_268_Skripte/)
...
## 27. Update (9. Juni 2026) — Skript-Ordner python/Dok271_274_Skripte/

Neuer Ordner **python/Dok271_274_Skripte/** (analog Dok263_Skripte / Dok267_268_Skripte): der reproduzierbare FFGFT-Spektral-Diskriminator zur Substrat-Achse von Dok. 271/274.
...
- `python/Dok271_274_Skripte/`: + `hlv_glattice_reproduction.py` (unabhängige HLV-G-Gitter-Reproduktion aus Krügers ℤ⁶-Projektion + k-NN; identische analyze_spectrum-Pipeline; erstes Ergebnis = Teilnegativ auf ⟨r⟩, schwache Signatur in Lücken/Tiefsektor; d_s≈2,7 vs. berichtete 2,49). README erweitert.
- `python/Dok023_230_Skripte/` (neu): `bell_xi_differential.py` (ξ-Skalen-Bell/CHSH; uniforme (1−ξ)-Dämpfung = entartet mit Visibilität, nicht beobachtbar; beobachtbar ist die Winkelabhängigkeit des Defizits, Differenz an θ≈π vs θ≈0; Signal ξ/D_f…ξ; N≈6×10⁷–6×10⁸ Koinzidenzen).
...
**Neues Dok. 275 (Von ξ zu φ — rekursive Skalenhierarchie, DE+EN):** 1/φ als Durchgangspunkt der ξ-Dämpfungsrekursion r(k+1)=r(k)·(1−ξ) bei k* = log(φ)/ξ ≈ 3609 Skalenebenen (q=2/3 intern konvergent, kein RG-Faktor 2; einziger Fixpunkt: 0). Skripte in python/Dok275_Skripte/.
...
- **python/Dok280_Skripte/** (Rotverschiebung, z→Zeit, SFRD): `z_time_ffgft.py` (erzeugt die in Dok. 280 eingebettete Grafik Sources/fig/280_z_time_ffgft.png), `z_time_mapping.py` (ΛCDM vs. generischer statischer Benchmark), `lilly_madau_v4.py` (Lilly–Madau-SFRD auf der ΛCDM-Zeitachse, für J. Nicholson/IPI).
- **python/Dok282_Skripte/** (im 282-Text namentlich genannt): `ffgft_mass_operator_C3.py` (Z₃-Zirkulant-Massenoperator auf C³), `ffgft_t4_mass_operator.py` (Vorwärts-Test KK vs. Z₃-Kreis, Koide forward), `ffgft_t4_cp_divisibility.py` (CP-Teilbarkeit/Nicht-Markovianität, Zeit als Prozess).
- **python/Dok271_HICE_Holonomie_Skripte/** (Holonomie-Zweig des FFGFT↔HLV-Vergleichs Dok. 271, ergänzend zum Spektral-Diskriminator in python/Dok271_274_Skripte/): `ffgft_t4_holonomy_witness.py`, `ffgft_t4_context_content_witness.py` (De Jesus W_psi), `ffgft_t4_dynamical_u3.py` (Krüger Sec. 13.5), `ffgft_t4_coherence_observables.py` (HICE-MEM0), `ffgft_hlv_homology_check_v3.py` (HLV-Homologie-Falsifikation, vgl. Dok. 276), `hice_pilot.py` (HICE7-Pilot, vgl. 35. Update), `ffgft_phi3_pairwise_audit.py` (symmetrischer PHI3-Audit, stützt Dok. 281/275; **Eingabe `feature_table.csv` jetzt beigelegt** — Krügers Run-PHI3-NATIVE6D-Output aus der IPI-Korrespondenz/Zenodo 20692350, 320 Zeilen × 8 Ensembles; Audit läuft damit out-of-the-box: AUC-Matrix durchweg 1,0, φ kein Ausreißer). Konservativer Maximal-Status durchweg „candidate carrier", keine HLV-Verbindung behauptet.
- **python/Werkzeuge_Skripte/** (kein Physik-Dokument): `ffgft_tts.py` (Batch-Vertonung der Slide-Chunks mit Chatterbox).
...
- Build: LuaLaTeX je 3 Durchläufe (TOC); 303 De/En, 304 De 12 / En 11 S., 305 De/En je 4 S., 190 De 39 / En 34 S.; 0 fehlende Glyphen. PDFs in pdf/ und Sources/wr_standalone_A4/, Quellen in Sources/ch/, Skripte in python/Dok304_Skripte/ und python/Dok305_Skripte/.
...
## 20. August 2026 — v1.3.0: Dok. 317, Dok. 318, R76–R78, R75-Nachträge

### Dok. 317 — Topologischer Ursprung der Leptonen-Generationen: KSAU und FFGFT (DE+EN, je 7 S.)

Vergleichs- und Synthesedokument zwischen der KSAU-Theorie (Yui, Zenodo 2026, kein Peer-Review) und FFGFT.

**FFGFT-Quantenzahlen [K]:**

| Lepton | Gen. | $n_\theta$ | $n_\phi$ | $r_i$ | $p_i$ | Knoten | Genus |
|---|---|---|---|---|---|---|---|
| $e$ | 1 | 3 | 2 | 4/3 | 3/2 | $3_1$ | 1 |
| $\mu$ | 2 | 5 | 4 | 16/5 | 1 | $6_3$ | 2 |
| $\tau$ | 3 | 9 | 5 | 25/9 | 2/3 | $7_1$ | 3 |

Massenverhältnisse: $m_\mu/m_e = 12/5 \cdot \xi^{-1/2} \approx 207{,}85$ (+0,52%), $m_\tau/m_\mu = 125/144 \cdot \xi^{-1/3} \approx 16{,}992$ (+1,04%).

Literaturpräzisierungen:
- Avrin (2012): *Symmetry* (MDPI) **4**(1), 39–115, DOI 10.3390/sym4010039 — peer-reviewed (war fälschlich als Zenodo angegeben)
- Blatt et al. (2025, arXiv:2512.02998): Möbius-Energie, kritische Punkte in Torus-Knoten-Klassen $T(a,b)$ bewiesen [K]
- Jeon et al. (2024, arXiv:2407.11731): Knotensolitonen für Baryon-Asymmetrie — kein Bezug zu Leptonenmassen [K]
- Khanna et al. (2014, arXiv:1409.1245): Torus-QFT (thermische Feldtheorie, Casimir, Hadronen) — kein Bezug zum Generationenproblem [K]

$6_3$ ist kein Torusknoten (amphicheiral) — Blatt et al. dort nicht direkt anwendbar. Exakte analytische $E(K)$-Werte für $3_1$, $6_3$, $7_1$ nicht bekannt. KSAU-Massenformel hat Status [S].

**Dok. 006 DE+EN** ergänzt: Unterabschnitt „Wicklungszahlen und topologische Zuordnung" mit vollständiger Tabelle für alle sechs Leptonen, Verweis auf Dok. 317.

---

### Dok. 318 — Geltungsbereich der Masseableitungen in FFGFT (DE+EN, je 8 S.)

Explizite Grenzziehung des $\xi$-Ableitungsrahmens.

**Kernaussage:** FFGFT leitet Ruhemassen (Leptonen, Quark-Yukawa) aus $\xi$ ab. Hadronmassen haben dominanten QCD-Beitrag (Gluonen-Bewegungsenergie ~99% der Protonmasse): offene Brücke.

**Eingerollt/ausgerollt (Dok. 311):** Quark-Ruhemassen = eingerollte Moden (Yukawa, $\xi$-ableitbar). Gluonenenergie = ausgerollte Moden (QCD-Dynamik). Das Proton hat Beiträge aus beiden Regimen — struktureller Grund warum eine einheitliche $\xi$-Ableitung nicht direkt greift.

**$K_\text{frak}$ als Interface-Faktor:** tritt beim Übergang $m^\text{bare} \to m^\text{SI}$ auf. Kürzt sich in Massenverhältnissen heraus (Dok. 012). Kein direkter Bezug zum QCD-Sektor.

**Geltungsbereichstabelle:**

| Teilchen | Status |
|---|---|
| $e, \mu, \tau$ | **[K]** Ruhemassen aus Higgs-Yukawa |
| $\nu_e, \nu_\mu, \nu_\tau$ | **[S]** doppelte $\xi$-Unterdrückung (Dok. 007) |
| $u, d, s, c, b, t$ (Ruhe) | **[S]** offen (Dok. 006) |
| $p, n$ (gesamt) | offene Brücke (QCD + Higgs-Yukawa) |
| $m_p/m_e$ | nicht beansprucht |

**$\alpha_s$-Klarstellung:**
- Dok. 041: $\alpha_s = \xi^{-1/3} = 9{,}65$ in natürlichen Einheiten — Strukturskizze [S], keine SI-Ableitung
- Dok. 160: $\alpha_s(m_\tau) = 3\xi^{1/4} \approx 0{,}322$ bei Skala $m_\tau$ — Präzisionsableitung [K]
- $\alpha_s$ läuft mit der Energie; $\alpha_s(m_\tau) \approx 0{,}33$ und $\alpha_s(M_Z) \approx 0{,}118$ ($M_Z = 91{,}19$ GeV, $Z$-Boson) sind verschiedene Werte derselben Konstante
- RGE-Brücke (Renormierungsgruppengleichung) innerhalb FFGFT offen [S]

Zeichenerklärung am Dokumentanfang für alle verwendeten Symbole.

---

### R76 — Geltungsbereich der Masseableitungen (20. August 2026)

Dok. 318 begrenzt den Geltungsbereich der $\xi$-Masseableitungen explizit. Leptonen-Ruhemassen [K]. $m_p/m_e$ kein Ableitungsziel. Drei Szenarien für die QCD-Brücke als Forschungsfragen.

### R77 — Einordnung früher Kopplungskonstanten-Formeln (20. August 2026)

Die Formeln in Dok. 041 ($\alpha_s = \xi^{-1/3}$, $\alpha_W = \xi^{1/2}$, $\alpha_G = \xi^2$, $\Lambda_\text{QCD} = v\cdot\xi^{1/3}$) sind **Strukturskizzen in natürlichen Einheiten**, keine SI-Präzisionsableitungen. $\xi^{-1/3} = 9{,}65$ (nat. Einh.) ≠ $\alpha_s(M_Z) = 0{,}118$ (SI). Status: [S].

### R78 — $\alpha_s$ und laufende Kopplung (20. August 2026)

$\alpha_s$ ist eine laufende Kopplung. $\alpha_s(m_\tau) \approx 0{,}33$ und $\alpha_s(M_Z) \approx 0{,}118$ sind verschiedene Werte derselben Konstanten. Dok. 160 leitet $\alpha_s(m_\tau) = 3\xi^{1/4}$ geometrisch ab [K]. RGE-Brücke zu $\alpha_s(M_Z)$ innerhalb FFGFT offen [S].

---

### R75-Nachträge (18.–20. August 2026)

- **Dok. 075 DE+EN** (je 10 S.): vereinigt — Teil I RSA-Grundlagen, Teil II Periodenfindung. Dateiname `075_RSA_De/En_ch.tex` (eine Fassung, zwei Sprachen).
- **Dok. 076 DE+EN:** 95%/5%-Gatterkosten nachgetragen.
- **Dok. 147 DE+EN:** 95%/5% ergänzt; `requirements_147.txt` (numpy, scipy, matplotlib, pandas, ephem).
- **Dok. 173 EN:** Kurzbeschreibung von Dok. 176 auf neuen Inhalt angepasst.
- **Dok. 190 DE+EN:** Nachtragseintrag R75-Folgen; Bereinigung Nummernproblem 075.
- **Dok. 006 DE+EN:** Wicklungszahlen-Tabelle mit KSAU-Knotenverweisen ergänzt.
- **HTML-Simulator** `t0_Shore_simulator.html`: T0 → FFGFT in allen sichtbaren Bezeichnungen; $\xi \to \sigma$ in Formeln und Ausgabetexten; Weyl-Aussage universell; $M_Z$-Erklärung inline.


### Dok. 319 — Das Proton als schwingender Torus (21. August 2026, DE+EN, je 6 S.)

Geometrische Beschreibung des Protons in der FFGFT. Sorgfältige
Diskussion und Statusmarkierung aller Aussagen vor Fertigstellung.

**Kernaussagen [K]** (aus Korpus belegt):
- D4-Trialität liefert halbzahlige Darstellungen → Fermion-Statistik (Dok. 314)
- $T^4/\mathbb{Z}_3$ mit genau 9 Fixpunkten folgt aus D4-Geometrie (Dok. 314)
- Diskretes, massetragendes Spektrum sitzt auf der kompakten $\mathbb{Z}_3$-Faser,
  nicht auf der ausgerollten Achse (Dok. 285)
- Wir beschreiben immer von innen, nie von außen (Dok. 248)
- Ausrollen ist ein Messvorgang des eingebetteten Beobachters (Dok. 270)
- Für $m=0$ ist $\tilde{T}\cdot m=1$ nicht definiert: $d\tau=0$ exakt,
  kein Ruhesystem (Dok. 312). Lokal gilt immer $E=pc$ — reine Energie.
- Photon und Gluon sind beide masselose Feldmoden, keine Teilchen (Dok. 049)

**Präzisierung Photon/Gluon [K]/[S]:**
Einschluss ist relational, nicht intrinsisch. Photon und Gluon tragen
beide Randbedingungen; lokal gilt für beide $E=pc$. Der Unterschied liegt
in der globalen topologischen Einbettung:
- Photon: $U(1)$-Feldmode, wir im selben $T^4$-System → erscheint frei
- Gluon: $\mathbb{Z}_3/SU(3)$-Feldmode, stehende Welle im Proton-Torus →
  erscheint gebunden, weil wir diesem Untersektor von außen gegenüberstehen [S]
- Gluonfeld nicht lokalisierbar: nicht-Abelsche $SU(3)$-Feldmode,
  Selbstwechselwirkung, kein abgrenzbares Objekt (Dok. 145, [S])
- 8 Gluonmoden = 8 Verschlingungszustände = 8 $SU(3)_c$-Generatoren (Dok. 145, [S])

**Fünf offene Fragen [S]:** $SU(3)_c$-Emergenz aus $\mathbb{Z}_3$-Trialität,
warum Photon/Gluon verschiedene Sektoren, $\Lambda_\text{QCD}$-Ableitung,
RGE-Brücke $\alpha_s(m_\tau)\to\alpha_s(M_Z)$, formale Randbedingungen auf $T^4/\mathbb{Z}_3$.
