...
## 3. August 2026 — Dok. 312 „Die Abschlussskala" + Dok. 313 „Kein Anfang" (DE+EN) + R68–R73
...
**R68–R73 in Dok. 190 (DE+EN, je +6 Einträge, Register jetzt bis R73 + K7):** R68 Abschlussskala/Λ-Träger/volle Übernahme der Feldgleichungen/10¹²³→P20 (A272, 279, 308). R69 a₀-Vereinheitlichung über die kompakte Zeitrichtung, neue Pflicht D(i)/D(ii) (308). **R70 fraktale Wegkorrektur** — die χ(z)/η₀-Integrale liefen mit glatter Metrik; Zuordnungsregel aus A040 [B] + Dok 311 (eingerollt/ausgerollt): K_frak greift bei Weg-durch-Struktur, kürzt bei Weg-durch-Weg und Winkeln, Kontrolltest χ_rec/η₀ = 0,98024 invariant bestanden; Wirkung: Horizont 1,012 → 0,9986 (Faktor 9 ohne Anpassung), Streuwand schwächer, Topologieschranke 1,008 → 1,022 ABER Matched-Circle-Signatur entfällt; neue Trennung τ_topologisch 91,9 vs. τ_Licht 93,2 Gyr (KMS nutzt die Feldperiodizität → T_GH, ħH₀, a=cH₀ unverändert). R71 Antipode/Ω_m-Kette/Überbestimmung/κ-Kandidat/drei Erbschaftsebenen (313). **R72 T₀-Skalenlücke** — A085 erlaubt nur EINE Kalibrierung (A080/A130: E₀ = √(mₑm_μ) = 7,348 MeV, überbestimmt); Dok 061 verwendet stattdessen „1 eV" (verlangt U = 0,9908 eV, log_ξ(U/E₀) = 1,77, keine ganze Potenz); die CMB-Temperatur ist die EINZIGE Korpus-Größe ohne Kammerton-Bezug (log_ξ = 2,41); systematische Suche liefert nur Zufallsdichte (R61-Kontrolle wie 74/75 in R67) → Aufgabe ist Vorwärtsherleitung, nicht Suche; dazu Notationskollision T₀ (Kalibrierungstemperatur 8,53×10¹⁰ K in A085 vs. CMB-Monopol 2,7255 K, Faktor 3×10¹⁰ unter demselben Symbol) und die falsche Präzisionsangabe in 061 („0,0002 %" in der Zusammenfassung vs. „1 %" in der eigenen Detailrechnung, korrekt 0,92 %). **R73 Verschärfung von Dok 309** — es gibt keinen SI-verankerten H₀-Wert (Planck 67,4 = Fit-Output, SH0ES 73,0 = Entfernungsleiter, 8,3 % / 5–6σ ungelöst); die FFGFT erbt nicht nur eine Zahl, sondern die SEITENWAHL in der Hubble-Spannung, bisher nicht als Setzung gebucht (SH0ES verlangte Vorfaktor 1,716 statt π/2 = 1,571); die theoretische Aussage selbst ist SI-frei (ħH₀/(mₑc²) = (π/2)ξ¹⁰); neuer offener Punkt: der Beweiswert hängt am VORFAKTOR — Zufallschance eines 1-%-Treffers auf der groben ξ-Leiter (Stufenabstand 3,875 Dekaden) ist 0,22 %, aber ein im Bereich 0,5–2 freier Vorfaktor deckt 16 % der Stufe ab → **ist π/2 hergeleitet oder gesetzt?** Bis zur Klärung ist der 0,86-%-Treffer ein bedingter Befund. Quelldokumente durchgehend unverändert (append-only).
