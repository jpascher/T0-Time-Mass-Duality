...
% Geometry setup (FIXED: removed duplicates, kept only one)
\geometry{a4paper, margin=2.5cm}

% Hyperref setup (FIXED: single, complete configuration)
\hypersetup{
	colorlinks=true,
	linkcolor=blue,
	citecolor=blue,
	urlcolor=blue,
	pdftitle={137 De - Das verborgene Geheimnis von 1/137},
...
% Custom commands and definitions (FIXED: removed duplicates and fixed syntax)
\newcommand{\Bzero}{B_0}
...
% Theorem environments (FIXED: removed duplicates)
...
% Unicode character definitions (FIXED: removed duplicates)
...
\title{137 De - Das verborgene Geheimnis von 1/137}
