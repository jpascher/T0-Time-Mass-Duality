...
\end{theorem}
	...
	\begin{itemize}
		\item Modifiziertes Gravitationspotential: \( \Phi(r) = -\frac{M}{r} + \kappa r \) in natürlichen Einheiten mit \( G = 1 \) (empirischer SI-Wert: \( \kappa \approx \SI{4.8e-11}{\meter\per\second\squared} \))
		\item Kosmische Rotverschiebung: \( 1 + z = e^{\alpha d} \), \( \alpha \approx 1 \) in natürlichen Einheiten (empirischer SI-Wert: \( \alpha \approx \SI{2.3e-18}{\per\meter} \))
		\item Wellenlängenabhängigkeit: \( z(\lambda) = z_0 (1 + \ln(\lambda/\lambda_0)) \) in natürlichen Einheiten mit \( \beta_T = 1 \) (empirischer SI-Wert: \( \beta_T \approx 0.008 \))
	\end{itemize}
	%----
