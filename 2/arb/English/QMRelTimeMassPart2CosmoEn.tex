...
\end{equation}
in natural units, versus \(\Lambda\)CDM’s \(3000 \, \text{K}\), a factor of 8 difference due to \(\Tfield\)’s logarithmic enhancement (Equation \ref{eq:temperature_redshift_simplified}).
%---	
