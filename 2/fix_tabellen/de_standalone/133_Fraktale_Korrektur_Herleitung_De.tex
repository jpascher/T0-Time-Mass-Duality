...
% Standardized preamble - 133_Fraktale_Korrektur_Herleitung_De.tex
\input{../../../T0_preamble_shared_De}

\title{\textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Die Fraktale Korrektur $K_{\text{frak}}$}\\[0.5cm]
...
\begin{document}
	...
	In der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) emergiert Masse nicht als fundamentale Eigenschaft, sondern als Manifestation geometrischer Strukturen in einer leicht fraktalen Raumzeit. Der fundamentale Parameter $\xi = \frac{4}{30000} \approx 1.333 \times 10^{-4}$ definiert die Abweichung von perfekter Dreidimensionalität:
...
\end{document}
	...
	\begin{itemize}
		\item Gibt es höhere Ordnungen $K_{\text{frak}}^{(2)} \sim \xi^2$?
		\item Wie verhält sich $K_{\text{frak}}$ bei Quantengravitations-Energien?
		\item Kann man $K_{\text{frak}}$ direkt messen (z.B. über fraktale Streuquerschnitte)?
	\end{itemize}
	
	\section{Rundungsfehler und numerische Genauigkeit}
	
	\subsection{Herkunft kleiner Abweichungen zwischen Berechnungsvarianten}
	
	Beim Vergleich verschiedener Berechnungswege für physikalische Größen wie $\alpha$ beobachtet man kleine Abweichungen von typischerweise $\sim 0.1\% - 1\%$. Diese haben \textbf{zwei verschiedene Ursprünge}:
	
	\begin{tcolorbox}[colback=yellow!5!white,colframe=orange!75!black,title={Doppelte Quelle der Abweichungen}]
		\textbf{1. Fundamentaler Ursprung} (Haupteffekt $\sim 1.3\%$):
		\begin{itemize}
	...
	Die Beziehung zwischen $\xi$ und der Euler'schen Zahl $e = 2.71828...$ ist fundamental für die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie):
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) vereint die drei wichtigsten mathematischen Konstanten:
	...
	\begin{thebibliography}{99}
		...
		Pascher, J., \emph{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Die Feinstrukturkonstante}, Dokument 011, 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/011_T0_Feinstruktur_De.pdf}
		
		\bibitem{T0_xi_ursprung}
		Pascher, J., \emph{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Der Ursprung von $\xi$}, Dokument 009,
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/009_T0_xi_ursprung_De.pdf}
		
		\bibitem{T0_xi_und_e}
		Pascher, J., \emph{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): $\xi$ und $e$}, Dokument 008,
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/008_T0_xi-und-e_De.pdf}
		
		\bibitem{T0_Teilchenmassen}
		Pascher, J., \emph{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Teilchenmassen}, Dokument 006,
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/006_T0_Teilchenmassen_De.pdf}
	\end{thebibliography}
