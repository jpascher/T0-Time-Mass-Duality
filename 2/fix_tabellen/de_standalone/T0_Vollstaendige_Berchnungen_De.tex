...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): v3.2}
\fancyhead[R]{\today}
\fancyfoot[C]{\thepage}

\title{\textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Berechnung von Teilchenmassen und physikalischen Konstanten}\\
...
\begin{document}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) basiert auf der fundamentalen Hypothese einer geometrischen Konstante $\xi$, die alle physikalischen Phänomene auf makroskopischen und mikroskopischen Skalen vereint. Im Gegensatz zu Standardansätzen, die auf empirischen Anpassungen basieren, leitet T0 alle Parameter aus exakten mathematischen Beziehungen ab.
	...
	Die zentrale Erkenntnis der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) ist die Beziehung:
	\begin{equation}
...
\begin{itemize}
	\item \textbf{Faktor 2:} Fundamentale Dualität der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)
...
\end{align}
	...
	\subsection{Yukawa-Methode der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) sagt spezifische Korrekturen zu den magnetischen Momenten der Leptonen vorher. Die anomalen magnetischen Momente werden durch die Kombination von Standardmodell-Beiträgen und T0-Korrekturen beschrieben:
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) berechnet über 40 fundamentale physikalische Konstanten in einer hierarchischen 8-Level-Struktur. Diese Sektion dokumentiert alle berechneten Werte mit ihren Einheiten und Abweichungen von experimentellen Referenzwerten.
	...
	Ein bemerkenswertes Merkmal der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) ist die ausschließliche Verwendung \textbf{exakter mathematischer Konstanten}:
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) macht spezifische, testbare Vorhersagen:
	...
	\subsection{Vorteile der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) Version 3.2 stellt einen paradigmatischen Wandel in der theoretischen Physik dar:
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) adressiert fundamentale offene Fragen der modernen Physik:
