...
\hypersetup{
	...
	citecolor=blue,
	urlcolor=blue,
	pdftitle={Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Erweiterung auf Bell-Tests – ML-Simulationen (November 2025)},
	pdfauthor={Johann Pascher},
	pdfsubject={Theoretische Physik, Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie), Bell-Tests, Quantenverschränkung}
}
...
\fancyhead[R]{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Erweiterung auf Bell-Tests}
\fancyfoot[C]{\thepage}
...
\title{\textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Erweiterung auf Bell-Tests}\\[0.5cm]
...
\begin{document}
	...
	\begin{center}
		...
		\vspace{0.5cm}
		\textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Bell-Tests als Test für Lokale Realität}\\
