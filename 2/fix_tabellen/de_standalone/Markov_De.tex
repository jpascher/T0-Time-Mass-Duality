...
\hypersetup{
	...
	citecolor=blue,
	urlcolor=blue,
	pdftitle={Markov-Ketten im Kontext der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Deterministisch oder stochastisch? Ein Traktat zu Mustern, Voraussetzungen und Unsicherheit},
	pdfauthor={Johann Pascher},
	pdfsubject={Stochastische Prozesse, Markov-Ketten, Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie), Determinismus vs. Stochastik}
}

\title{Markov-Ketten im Kontext der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie):\\Deterministisch oder stochastisch?\\Ein Traktat zu Mustern, Voraussetzungen und Unsicherheit}
...
\begin{document}
	...
	\begin{center}
		...
		\vspace{0.3cm}
		\href{https://github.com/jpascher/T0-Time-Mass-Duality}{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Zeit-Masse-Dualitätsrahmen}
		\vspace{0.3cm}
	\end{center}
