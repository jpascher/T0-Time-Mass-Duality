...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Kosmische Beziehungen}
\fancyhead[R]{\thepage}
...
\hypersetup{
	...
	citecolor=blue,
	urlcolor=blue,
	pdftitle={Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Kosmische Beziehungen und universelle $\xi$-Konstante},
	pdfauthor={Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) Projekt},
...
\title{\Huge\textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Kosmische Beziehungen}\\
...
\subsection{Grundlagen der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}

\begin{important}
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) basiert auf der universellen dimensionslosen Konstante $\xi = \frac{4}{3} \times 10^{-4}$, die alle physikalischen Phänomene vom subatomaren bis zum kosmischen Bereich bestimmt.
\end{important}

Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) revolutioniert unser Verständnis des Universums durch die Einführung einer einzigen fundamentalen Konstante. Diese Konstante bildet die Grundlage für alle physikalischen Berechnungen und Vorhersagen der Theorie:
...
\end{tcolorbox}
	...
	Die Heisenbergsche Unschärferelation zwischen Energie und Zeit stellt das fundamentale Prinzip der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) dar:
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) erklärt die CMB durch $\xi$-Feld-Quantenfluktuationen:
	...
	\begin{important}
		Fundamentale Erkenntnis der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie):
		\begin{itemize}
	...
	\begin{revolutionary}
		Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) bietet eine mathematisch konsistente, in natürlichen Einheiten formulierte Alternative zur expansionsbasierten Kosmologie und erklärt alle kosmischen Phänomene mit einer einzigen fundamentalen Konstante in einem statischen, ewig existierenden Universum.
	\end{revolutionary}
	
	Die Übereinstimmungen zwischen theoretischen Vorhersagen und experimentellen Beobachtungen - von der exakten Gravitationskonstante über die CMB-Temperatur bis zum Casimir-CMB-Verhältnis - demonstrieren die innere Konsistenz und prädiktive Kraft der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie).
	...
	\begin{thebibliography}{20}
		...
		Pascher, Johann (2025). 
		\textit{Vereinfachte Lagrange-Dichte und Zeit-Massen-Dualit\"at in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}. 
		Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) Projekt. 
		...
		\bibitem{t0_cmb_de}
		Pascher, Johann (2025). 
		\textit{Temperatureinheiten in nat\"urlichen Einheiten: Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) und statisches Universum}. 
		Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) Projekt. 
		...
		Pascher, Johann (2025). 
		\textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Wellenlängenabhängige Rotverschiebung ohne Distanzannahmen}. 
		Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) Projekt. 
		\url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/redshift_deflection_De.pdf}
		
		\bibitem{t0_redshift_en}
		Pascher, Johann (2025). 
		\textit{FFGFT: Wavelength-Dependent Redshift without Distance Assumptions}. 
		T0-Theory Project. 
