...
\fancyhead[R]{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Der Terrell-Penrose-Effekt und Massenvariation}
\fancyfoot[C]{\thepage}
...
\hypersetup{
	...
	citecolor=blue,
	urlcolor=blue,
	pdftitle={Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Der Terrell-Penrose-Effekt und Massenvariation},
	pdfauthor={Johann Pascher}
}
% Fix for Unicode ξ in text mode
\DeclareUnicodeCharacter{03BE}{$\xi$}
\DeclareUnicodeCharacter{03B1}{$\alpha$}
\title{\textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Der Terrell-Penrose-Effekt und Massenvariation}\\
