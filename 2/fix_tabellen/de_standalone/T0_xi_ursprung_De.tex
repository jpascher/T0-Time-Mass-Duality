...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Der Massenskalierungsexponent $\kappa$}
...
\hypersetup{
	...
	citecolor=blue,
	urlcolor=blue,
	pdftitle={Der Massenskalierungsexponent κ in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)},
	pdfauthor={Johann Pascher},
	pdfsubject={Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie), Massenhierarchie, Fundamentale Konstanten}
}
...
\begin{document}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{p{3cm}p{8cm}p{3cm}}
			...
			\bottomrule
		\end{tabular}
		\caption{Fundamentale Parameter der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}
	\end{table}
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025). \textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Grundlagen und Erweiterungen}.
