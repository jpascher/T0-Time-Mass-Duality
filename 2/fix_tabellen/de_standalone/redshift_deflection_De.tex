...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Rotverschiebungsmechanismus}
\fancyhead[R]{\thepage}
...
\author{Basierend auf dem Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)-Rahmenwerk\\
...
\begin{document}
	...
	\begin{important}
		...
		\begin{itemize}
			...
			\item Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): $z$ variiert mit der Wellenl\"ange - testbare Vorhersage!
		\end{itemize}
