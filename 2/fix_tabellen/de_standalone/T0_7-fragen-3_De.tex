...
\fancyhead[R]{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Die sieben Rätsel}
\fancyfoot[C]{\thepage}
...
\hypersetup{
	...
	citecolor=blue,
	urlcolor=blue,
	pdftitle={Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Die sieben Rätsel},
	pdfauthor={Johann Pascher}
}
% Fix for Unicode ξ in text mode
\DeclareUnicodeCharacter{03BE}{$\xi$}
\title{\textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Die sieben Rätsel der Physik}\\[0.5cm]
...
\begin{document}
	...
	Die folgenden Symbole werden in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) verwendet. Eine detaillierte Nomenklatur ist wie folgt (erweitert um kosmologische Aspekte):
	\begin{table}[htbp]
		\centering
		\begin{tabular}{ll}
			\toprule
			...
			\bottomrule
		\end{tabular}
		\caption{Erklärung der wichtigsten Symbole in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) – erweitert um kosmologische Komponenten}
	\end{table}
