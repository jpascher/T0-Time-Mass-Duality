...
\fancyhead[R]{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Fraktaldimension $D_f$ aus Lepton-Massenverhältnis}
\fancyfoot[C]{\thepage}
...
\hypersetup{
	...
	citecolor=blue,
	urlcolor=blue,
	pdftitle={Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Fraktaldimension aus Lepton-Massenverhältnis},
	pdfauthor={Johann Pascher},
	pdfsubject={Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie), Fraktaldimension, Lepton-Massen, Geometrische Ableitung},
...
\begin{document}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) bietet mehrere mathematisch äquivalente Methoden zur Massenberechnung. In diesem Dokument verwenden wir die \textbf{direkte geometrische Methode} speziell zur Validierung der Fraktaldimension.
	...
	\begin{table}[H]
		...
		\begin{tabular}{lccc}
			...
			\bottomrule
		\end{tabular}
		\caption{Konsistenz der Massenberechnungsmethoden in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}
	...
	\begin{table}[H]
		...
		\begin{tabular}{p{6cm}p{6cm}}
			...
			\bottomrule
		\end{tabular}
		\caption{Komplementäre Rollen der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)-Dokumente}
