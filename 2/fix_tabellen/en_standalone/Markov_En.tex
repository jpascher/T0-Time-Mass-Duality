...
\hypersetup{
	...
	citecolor=blue,
	urlcolor=blue,
	pdftitle={Markov Chains in the Context of FFGFT: Deterministic or Stochastic? A Treatise on Patterns, Preconditions, and Uncertainty},
	pdfauthor={Johann Pascher},
	pdfsubject={Stochastic Processes, Markov Chains, T0 Theory, Determinism vs. Stochastics}
}

\title{Markov Chains in the Context of FFGFT:\\Deterministic or Stochastic?\\A Treatise on Patterns, Preconditions, and Uncertainty}
...
\begin{document}
	...
	\begin{center}
		...
		\vspace{0.3cm}
		\href{https://github.com/jpascher/T0-Time-Mass-Duality}{FFGFT: Time-Mass Duality Framework}
		\vspace{0.3cm}
	\end{center}
