...
\hypersetup{
	...
	citecolor=blue,
	urlcolor=blue,
	pdftitle={FFGFT: Extension to Bell Tests – ML Simulations (November 2025)},
...
\fancyhead[R]{FFGFT: Extension to Bell Tests}
\fancyfoot[C]{\thepage}
...
\title{\textbf{FFGFT: Extension to Bell Tests}\\[0.5cm]
...
\begin{document}
	...
	\begin{center}
		...
		\vspace{0.5cm}
		\textit{FFGFT: Bell Tests as Test for Local Reality}\\
