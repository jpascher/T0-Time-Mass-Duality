...
\hypersetup{
	...
	citecolor=blue,
	urlcolor=blue,
	pdftitle={FFGFT: Complete Derivation of All Parameters Without Circularity},
	pdfauthor={Johann Pascher},
	pdfsubject={T0-Theory, Geometric Derivation, Fine Structure Constant}
}
\title{The $\xi$ Parameter and Particle Differentiation in FFGFT:\\
...
%			\newpage
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025). \textit{Simplified Dirac Equation in FFGFT: From Complex 4$\mytimes$4 Matrices to Simple Field Node Dynamics}. \\
