...
\hypersetup{
	...
	citecolor=blue,
	urlcolor=blue,
	pdftitle={FFGFT: Final Fractal Mass Formulas (November 2025)},
...
\fancyhead[R]{FFGFT: Final Fractal Mass Formulas}
\fancyfoot[C]{\thepage}
...
\title{\textbf{FFGFT: Final Fractal Mass Formulas (November 2025, $<$3\% $\Delta$)}\\[0.5cm]
...
\begin{document}
	...
	\section{Calculation of Electron and Muon Masses in the FFGFT: The Fundamental Basis}
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2024). 
		\textit{FFGFT: Foundations of Time-Mass Duality}. 
		...
		Pascher, J. (2024). 
		\textit{FFGFT: Neutrino Masses and PMNS Mixing}. 
		Unpublished manuscript, HTL Leonding.
