...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textsc{FFGFT: Document Overview}}
...
\hypersetup{
	...
	citecolor=t0blue,
	urlcolor=t0blue,
	pdftitle={FFGFT: Complete Document Overview},
...
\title{\textbf{FFGFT: Document Series Overview}\\[0.5cm]
...
\begin{document}
	...
	\begin{overview}
		...
		\begin{itemize}
			...
			\item \textbf{FFGFT:} 1 geometric parameter
	...
	\begin{achievement}
		\textbf{Experimental Confirmations of the FFGFT:}
	...
	\begin{foundation}
		\textbf{Fundamental Breakthroughs of the FFGFT:}
	...
	\begin{foundation}
		\textbf{Paradigm Shift through the FFGFT:}
