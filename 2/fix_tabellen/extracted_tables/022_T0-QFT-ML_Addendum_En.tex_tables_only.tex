...
\title{Tabellen aus 022\_T0-QFT-ML\_Addendum\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 022\_T0-QFT-ML\_Addendum\_En.tex}
...
\section*{Tabelle 2 aus 022\_T0-QFT-ML\_Addendum\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 3 aus 022\_T0-QFT-ML\_Addendum\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 4 aus 022\_T0-QFT-ML\_Addendum\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 5 aus 022\_T0-QFT-ML\_Addendum\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 6 aus 022\_T0-QFT-ML\_Addendum\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 7 aus 022\_T0-QFT-ML\_Addendum\_En.tex}
...
\section*{Tabelle 8 aus 022\_T0-QFT-ML\_Addendum\_En.tex}
...
\section*{Tabelle 9 aus 022\_T0-QFT-ML\_Addendum\_En.tex}
...
\section*{Tabelle 10 aus 022\_T0-QFT-ML\_Addendum\_En.tex}
