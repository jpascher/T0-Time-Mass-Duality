...
\title{Tabellen aus 033_T0-Theory-vs-Synergetics_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 033_T0-Theory-vs-Synergetics_De.tex}
...
\section*{Tabelle 2 aus 033_T0-Theory-vs-Synergetics_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus 033_T0-Theory-vs-Synergetics_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 4 aus 033_T0-Theory-vs-Synergetics_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus 033_T0-Theory-vs-Synergetics_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
				\toprule
...
\section*{Tabelle 6 aus 033_T0-Theory-vs-Synergetics_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
