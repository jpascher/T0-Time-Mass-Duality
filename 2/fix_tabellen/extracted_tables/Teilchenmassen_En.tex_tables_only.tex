...
\title{Tabellen aus Teilchenmassen\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus Teilchenmassen\_En.tex}
...
\section*{Tabelle 2 aus Teilchenmassen\_En.tex}
...
\section*{Tabelle 3 aus Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 4 aus Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 6 aus Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 7 aus Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 8 aus Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 9 aus Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccccc}
			\toprule
