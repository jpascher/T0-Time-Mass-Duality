...
\title{Tabellen aus musical-spiral-137-De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus musical-spiral-137-De.tex}
...
\section*{Tabelle 2 aus musical-spiral-137-De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lc}
			\toprule
			Skala & Größenordnung\\
...
\section*{Tabelle 3 aus musical-spiral-137-De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
