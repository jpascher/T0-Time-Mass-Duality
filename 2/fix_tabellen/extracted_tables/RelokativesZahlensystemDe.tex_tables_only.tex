...
\title{Tabellen aus RelokativesZahlensystemDe.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus RelokativesZahlensystemDe.tex}
...
\section*{Tabelle 2 aus RelokativesZahlensystemDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
				\toprule
...
\section*{Tabelle 3 aus RelokativesZahlensystemDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
				\toprule
...
\section*{Tabelle 4 aus RelokativesZahlensystemDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
				\toprule
...
\section*{Tabelle 5 aus RelokativesZahlensystemDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{llll}
				\toprule
...
\section*{Tabelle 6 aus RelokativesZahlensystemDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
				\toprule
