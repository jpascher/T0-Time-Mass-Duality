...
\title{Tabellen aus NatEinheitenSystematikEn.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus NatEinheitenSystematikEn.tex}
...
\section*{Tabelle 2 aus NatEinheitenSystematikEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lllll}
				\toprule
...
\section*{Tabelle 3 aus NatEinheitenSystematikEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
				\toprule
...
\section*{Tabelle 4 aus NatEinheitenSystematikEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
				\toprule
...
\section*{Tabelle 5 aus NatEinheitenSystematikEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
				\toprule
...
\section*{Tabelle 6 aus NatEinheitenSystematikEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
				\toprule
...
\section*{Tabelle 7 aus NatEinheitenSystematikEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{llll}
				\toprule
...
\section*{Tabelle 8 aus NatEinheitenSystematikEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
				\toprule
