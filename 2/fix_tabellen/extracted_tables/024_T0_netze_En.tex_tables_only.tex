...
\title{Tabellen aus 024\_T0\_netze\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 024\_T0\_netze\_En.tex}
...
\section*{Tabelle 2 aus 024\_T0\_netze\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{cccc}
			\toprule
...
\section*{Tabelle 3 aus 024\_T0\_netze\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus 024\_T0\_netze\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{cccc}
			\toprule
...
\section*{Tabelle 5 aus 024\_T0\_netze\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lp{8cm}}
			\toprule
...
\section*{Tabelle 6 aus 024\_T0\_netze\_En.tex}
...
\section*{Tabelle 7 aus 024\_T0\_netze\_En.tex}
