...
\title{Tabellen aus RelokativesZahlensystemEn.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus RelokativesZahlensystemEn.tex}
...
\section*{Tabelle 2 aus RelokativesZahlensystemEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
				\toprule
...
\section*{Tabelle 3 aus RelokativesZahlensystemEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
				\toprule
...
\section*{Tabelle 4 aus RelokativesZahlensystemEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
				\toprule
...
\section*{Tabelle 5 aus RelokativesZahlensystemEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{llll}
				\toprule
...
\section*{Tabelle 6 aus RelokativesZahlensystemEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
				\toprule
