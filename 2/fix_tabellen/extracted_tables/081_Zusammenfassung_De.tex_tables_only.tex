...
\title{Tabellen aus 081_Zusammenfassung_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 081_Zusammenfassung_De.tex}
...
\section*{Tabelle 2 aus 081_Zusammenfassung_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus 081_Zusammenfassung_De.tex}
\begin{adjustbox}{max width=\textwidth}
