...
\title{Tabellen aus Mathematische_struktur_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus Mathematische_struktur_De.tex}
...
\section*{Tabelle 2 aus Mathematische_struktur_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
...
\section*{Tabelle 3 aus Mathematische_struktur_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
		\toprule
...
\section*{Tabelle 4 aus Mathematische_struktur_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
...
\section*{Tabelle 5 aus Mathematische_struktur_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus Mathematische_struktur_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{0.45\textwidth}p{0.45\textwidth}}
...
\section*{Tabelle 7 aus Mathematische_struktur_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 8 aus Mathematische_struktur_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 9 aus Mathematische_struktur_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black]
