...
\title{Tabellen aus 076_RSAtest_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 076_RSAtest_De.tex}
...
\section*{Tabelle 2 aus 076_RSAtest_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
			\toprule
...
\section*{Tabelle 3 aus 076_RSAtest_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lrr}
			\toprule
...
\section*{Tabelle 4 aus 076_RSAtest_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{llll}
			\toprule
...
\section*{Tabelle 5 aus 076_RSAtest_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
...
\section*{Tabelle 6 aus 076_RSAtest_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
...
\section*{Tabelle 7 aus 076_RSAtest_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
			\textbf{Parameter} & \textbf{Wert} \\
...
\section*{Tabelle 8 aus 076_RSAtest_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
			\toprule
