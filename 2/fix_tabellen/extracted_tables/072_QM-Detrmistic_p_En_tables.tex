...
\title{Tabellen aus 072_QM-Detrmistic_p_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 072_QM-Detrmistic_p_En.tex}
...
\section*{Tabelle 2 aus 072_QM-Detrmistic_p_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus 072_QM-Detrmistic_p_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus 072_QM-Detrmistic_p_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Central Insight]
	The T0 modification of quantum mechanics arises naturally from the fundamental duality:
	$$T_{\text{field}}(x,t) \cdot E_{\text{field}}(x,t) = 1$$
