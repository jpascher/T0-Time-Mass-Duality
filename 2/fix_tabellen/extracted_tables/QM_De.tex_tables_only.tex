...
\title{Tabellen aus QM_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus QM_De.tex}
...
\section*{Tabelle 2 aus QM_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 3 aus QM_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 4 aus QM_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 5 aus QM_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus QM_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 7 aus QM_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 8 aus QM_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 9 aus QM_De.tex}
\begin{adjustbox}{max width=\textwidth}
