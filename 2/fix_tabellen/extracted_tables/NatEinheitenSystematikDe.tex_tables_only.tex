...
\title{Tabellen aus NatEinheitenSystematikDe.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus NatEinheitenSystematikDe.tex}
...
\section*{Tabelle 2 aus NatEinheitenSystematikDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lllll}
				\toprule
...
\section*{Tabelle 3 aus NatEinheitenSystematikDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
				\toprule
...
\section*{Tabelle 4 aus NatEinheitenSystematikDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
				\toprule
...
\section*{Tabelle 5 aus NatEinheitenSystematikDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
				\toprule
...
\section*{Tabelle 6 aus NatEinheitenSystematikDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
				\toprule
...
\section*{Tabelle 7 aus NatEinheitenSystematikDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{llll}
				\toprule
...
\section*{Tabelle 8 aus NatEinheitenSystematikDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
				\toprule
