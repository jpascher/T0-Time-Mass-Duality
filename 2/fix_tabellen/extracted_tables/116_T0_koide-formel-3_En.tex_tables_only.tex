...
\title{Tabellen aus 116\_T0\_koide-formel-3\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 116\_T0\_koide-formel-3\_En.tex}
...
\section*{Tabelle 2 aus 116\_T0\_koide-formel-3\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus 116\_T0\_koide-formel-3\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
