...
\title{Tabellen aus T0vsESM\_ConceptualAnalysis\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0vsESM\_ConceptualAnalysis\_En.tex}
...
\section*{Tabelle 2 aus T0vsESM\_ConceptualAnalysis\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus T0vsESM\_ConceptualAnalysis\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{0.45\textwidth}|p{0.45\textwidth}}
			\hline
...
\section*{Tabelle 4 aus T0vsESM\_ConceptualAnalysis\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{0.45\textwidth}|p{0.45\textwidth}}
			\hline
...
\section*{Tabelle 5 aus T0vsESM\_ConceptualAnalysis\_En.tex}
\begin{adjustbox}{max width=\textwidth}
