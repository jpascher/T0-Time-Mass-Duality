...
\title{Tabellen aus 091_Casimir_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 091_Casimir_En.tex}
...
\section*{Tabelle 2 aus 091_Casimir_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus 091_Casimir_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{r c c}
			\toprule
...
\section*{Tabelle 4 aus 091_Casimir_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus 091_Casimir_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.0cm} p{8.0cm} p{2.4cm}}
		\toprule
		\textbf{Symbol} & \textbf{Meaning} & \textbf{Value/Unit} \\
...
\section*{Tabelle 6 aus 091_Casimir_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.0cm} p{8.0cm} p{2.4cm}}
		\toprule
		\textbf{Symbol} & \textbf{Meaning} & \textbf{Value/Unit} \\
...
\section*{Tabelle 7 aus 091_Casimir_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.0cm} p{8.0cm} p{2.4cm}}
		\toprule
		\textbf{Symbol} & \textbf{Meaning} & \textbf{Value/Unit} \\
...
\section*{Tabelle 8 aus 091_Casimir_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.0cm} p{8.0cm} p{2.4cm}}
		\toprule
...
\section*{Tabelle 9 aus 091_Casimir_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.0cm} p{8.0cm} p{2.4cm}}
		\toprule
...
\section*{Tabelle 10 aus 091_Casimir_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.0cm} p{8.0cm} p{2.4cm}}
		\toprule
		\textbf{Symbol} & \textbf{Meaning} & \textbf{Remark} \\
...
\section*{Tabelle 11 aus 091_Casimir_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.0cm} p{8.0cm} p{2.4cm}}
		\toprule
...
\section*{Tabelle 12 aus 091_Casimir_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.0cm} p{8.0cm} p{2.4cm}}
		\toprule
		\textbf{Symbol} & \textbf{Meaning} & \textbf{Remark} \\
...
\section*{Tabelle 13 aus 091_Casimir_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.0cm} p{8.0cm} p{2.4cm}}
		\toprule
...
\section*{Tabelle 14 aus 091_Casimir_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.0cm} p{8.0cm} p{2.4cm}}
		\toprule
