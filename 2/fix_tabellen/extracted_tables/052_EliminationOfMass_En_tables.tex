...
\title{Tabellen aus 052_EliminationOfMass_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 052_EliminationOfMass_En.tex}
...
\section*{Tabelle 2 aus 052_EliminationOfMass_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccl}
			\toprule
...
\section*{Tabelle 3 aus 052_EliminationOfMass_En.tex}
\begin{adjustbox}{max width=\textwidth}
