...
\title{Tabellen aus 014\_T0\_nat-si\_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 014\_T0\_nat-si\_De.tex}
...
\section*{Tabelle 2 aus 014\_T0\_nat-si\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus 014\_T0\_nat-si\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus 014\_T0\_nat-si\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus 014\_T0\_nat-si\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus 014\_T0\_nat-si\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
			\toprule
