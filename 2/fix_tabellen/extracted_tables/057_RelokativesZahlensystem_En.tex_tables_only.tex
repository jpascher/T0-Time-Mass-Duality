...
\title{Tabellen aus 057_RelokativesZahlensystem_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 057_RelokativesZahlensystem_En.tex}
...
\section*{Tabelle 2 aus 057_RelokativesZahlensystem_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
				\toprule
...
\section*{Tabelle 3 aus 057_RelokativesZahlensystem_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
				\toprule
...
\section*{Tabelle 4 aus 057_RelokativesZahlensystem_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
				\toprule
...
\section*{Tabelle 5 aus 057_RelokativesZahlensystem_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{llll}
				\toprule
...
\section*{Tabelle 6 aus 057_RelokativesZahlensystem_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
				\toprule
