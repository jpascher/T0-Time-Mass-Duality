...
\title{Tabellen aus Zusammenfassung\_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus Zusammenfassung\_De.tex}
...
\section*{Tabelle 2 aus Zusammenfassung\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus Zusammenfassung\_De.tex}
\begin{adjustbox}{max width=\textwidth}
