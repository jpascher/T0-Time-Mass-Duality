...
\title{Tabellen aus 068\_T0vsESM\_ConceptualAnalysis\_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 068\_T0vsESM\_ConceptualAnalysis\_De.tex}
...
\section*{Tabelle 2 aus 068\_T0vsESM\_ConceptualAnalysis\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus 068\_T0vsESM\_ConceptualAnalysis\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{0.45\textwidth}|p{0.45\textwidth}}
			\hline
...
\section*{Tabelle 4 aus 068\_T0vsESM\_ConceptualAnalysis\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{0.45\textwidth}|p{0.45\textwidth}}
			\hline
...
\section*{Tabelle 5 aus 068\_T0vsESM\_ConceptualAnalysis\_De.tex}
\begin{adjustbox}{max width=\textwidth}
