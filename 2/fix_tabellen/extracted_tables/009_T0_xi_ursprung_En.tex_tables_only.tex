...
\title{Tabellen aus 009\_T0\_xi\_ursprung\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 009\_T0\_xi\_ursprung\_En.tex}
...
\section*{Tabelle 2 aus 009\_T0\_xi\_ursprung\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus 009\_T0\_xi\_ursprung\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 4 aus 009\_T0\_xi\_ursprung\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus 009\_T0\_xi\_ursprung\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus 009\_T0\_xi\_ursprung\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{3cm}p{9cm}}
			\toprule
			\textbf{Symbol} & \textbf{Meaning} \\
...
\section*{Tabelle 7 aus 009\_T0\_xi\_ursprung\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{3cm}p{9cm}}
			\toprule
			\textbf{Symbol} & \textbf{Meaning} \\
...
\section*{Tabelle 8 aus 009\_T0\_xi\_ursprung\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{3cm}p{9cm}}
			\toprule
...
\section*{Tabelle 9 aus 009\_T0\_xi\_ursprung\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 10 aus 009\_T0\_xi\_ursprung\_En.tex}
...
\section*{Tabelle 11 aus 009\_T0\_xi\_ursprung\_En.tex}
