...
\title{Tabellen aus 060\_musical-spiral-137-\_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 060\_musical-spiral-137-\_De.tex}
...
\section*{Tabelle 2 aus 060\_musical-spiral-137-\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lc}
			\toprule
			Skala & Größenordnung\\
...
\section*{Tabelle 3 aus 060\_musical-spiral-137-\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
