...
\title{Tabellen aus 006_T0_Teilchenmassen_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 006_T0_Teilchenmassen_De.tex}
...
\section*{Tabelle 2 aus 006_T0_Teilchenmassen_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus 006_T0_Teilchenmassen_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus 006_T0_Teilchenmassen_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus 006_T0_Teilchenmassen_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{lcccc}
...
\section*{Tabelle 6 aus 006_T0_Teilchenmassen_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
