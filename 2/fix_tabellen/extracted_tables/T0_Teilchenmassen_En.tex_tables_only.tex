...
\title{Tabellen aus T0\_Teilchenmassen\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0\_Teilchenmassen\_En.tex}
...
\section*{Tabelle 2 aus T0\_Teilchenmassen\_En.tex}
...
\section*{Tabelle 3 aus T0\_Teilchenmassen\_En.tex}
...
\section*{Tabelle 4 aus T0\_Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus T0\_Teilchenmassen\_En.tex}
\begin{longtable}{lcccc}
...
\section*{Tabelle 6 aus T0\_Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
