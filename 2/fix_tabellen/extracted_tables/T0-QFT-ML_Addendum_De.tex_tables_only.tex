...
\title{Tabellen aus T0-QFT-ML\_Addendum\_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0-QFT-ML\_Addendum\_De.tex}
...
\section*{Tabelle 2 aus T0-QFT-ML\_Addendum\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 3 aus T0-QFT-ML\_Addendum\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 4 aus T0-QFT-ML\_Addendum\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 5 aus T0-QFT-ML\_Addendum\_De.tex}
...
\section*{Tabelle 6 aus T0-QFT-ML\_Addendum\_De.tex}
...
\section*{Tabelle 7 aus T0-QFT-ML\_Addendum\_De.tex}
