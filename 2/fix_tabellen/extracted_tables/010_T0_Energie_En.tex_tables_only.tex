...
\title{Tabellen aus 010\_T0\_Energie\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 010\_T0\_Energie\_En.tex}
...
\section*{Tabelle 2 aus 010\_T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 3 aus 010\_T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
		\toprule
...
\section*{Tabelle 4 aus 010\_T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
		\toprule
...
\section*{Tabelle 5 aus 010\_T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}lccc@{}}
		\toprule
...
\section*{Tabelle 6 aus 010\_T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 7 aus 010\_T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
		\toprule
		\textbf{Scale} & \textbf{Energy (GeV)} & \textbf{Physics} \\
...
\section*{Tabelle 8 aus 010\_T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
		\toprule
...
\section*{Tabelle 9 aus 010\_T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
		\toprule
...
\section*{Tabelle 10 aus 010\_T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
		\toprule
...
\section*{Tabelle 11 aus 010\_T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 12 aus 010\_T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
		\toprule
...
\section*{Tabelle 13 aus 010\_T0\_Energie\_En.tex}
...
\section*{Tabelle 14 aus 010\_T0\_Energie\_En.tex}
\begin{longtable}{|l|l|}
	\hline
...
\section*{Tabelle 15 aus 010\_T0\_Energie\_En.tex}
...
\section*{Tabelle 16 aus 010\_T0\_Energie\_En.tex}
...
This represents a fundamental transformation in our understanding of particle physics, revealing the deep geometric principles underlying the apparent complexity of the particle spectrum.	
	...
	\title{The Muon g-2 as Decisive Experimental Proof}
\maketitle
\label{chap:muon_g2}
...
\section*{Tabelle 17 aus 010\_T0\_Energie\_En.tex}
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Standard QM Problems]
	...
	\title{The $\xi$-Fixed Point: The End of Free Parameters}
\maketitle
...
\section*{Tabelle 18 aus 010\_T0\_Energie\_En.tex}
...
\title{The Simplification of the Dirac Equation}
\maketitle
...
\title{Geometric Foundations and 3D Space Connections}
\maketitle
...
\title{Conclusion: A New Physics Paradigm}
\maketitle
