...
\title{Tabellen aus 046\_Teilchenmassen\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 046\_Teilchenmassen\_En.tex}
...
\section*{Tabelle 2 aus 046\_Teilchenmassen\_En.tex}
...
\section*{Tabelle 3 aus 046\_Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 4 aus 046\_Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus 046\_Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 6 aus 046\_Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 7 aus 046\_Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 8 aus 046\_Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 9 aus 046\_Teilchenmassen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccccc}
			\toprule
