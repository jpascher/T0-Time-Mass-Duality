...
\title{Tabellen aus DerivationVonBetaDe.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus DerivationVonBetaDe.tex}
...
\section*{Tabelle 2 aus DerivationVonBetaDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus DerivationVonBetaDe.tex}
\begin{adjustbox}{max width=\textwidth}
