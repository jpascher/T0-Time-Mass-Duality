...
\title{Tabellen aus Casimir_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus Casimir_De.tex}
...
\section*{Tabelle 2 aus Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{r c c}
			\toprule
...
\section*{Tabelle 4 aus Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Wert/Einheit} \\
...
\section*{Tabelle 6 aus Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Wert/Einheit} \\
...
\section*{Tabelle 7 aus Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Wert/Einheit} \\
...
\section*{Tabelle 8 aus Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
...
\section*{Tabelle 9 aus Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
...
\section*{Tabelle 10 aus Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Anmerkung} \\
...
\section*{Tabelle 11 aus Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
...
\section*{Tabelle 12 aus Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Anmerkung} \\
...
\section*{Tabelle 13 aus Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
...
\section*{Tabelle 14 aus Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
