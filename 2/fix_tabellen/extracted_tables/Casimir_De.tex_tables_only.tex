...
\title{Tabellen aus Casimir\_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus Casimir\_De.tex}
...
\section*{Tabelle 2 aus Casimir\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus Casimir\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{r c c}
			\toprule
...
\section*{Tabelle 4 aus Casimir\_De.tex}
...
\section*{Tabelle 5 aus Casimir\_De.tex}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Wert/Einheit} \\
		\midrule
...
\section*{Tabelle 6 aus Casimir\_De.tex}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Wert/Einheit} \\
		\midrule
...
\section*{Tabelle 7 aus Casimir\_De.tex}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Wert/Einheit} \\
		\midrule
...
\section*{Tabelle 8 aus Casimir\_De.tex}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
...
\section*{Tabelle 9 aus Casimir\_De.tex}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
...
\section*{Tabelle 10 aus Casimir\_De.tex}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Anmerkung} \\
		\midrule
...
\section*{Tabelle 11 aus Casimir\_De.tex}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
...
\section*{Tabelle 12 aus Casimir\_De.tex}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Anmerkung} \\
		\midrule
...
\section*{Tabelle 13 aus Casimir\_De.tex}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
...
\section*{Tabelle 14 aus Casimir\_De.tex}
\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
