...
\title{Tabellen aus lagrandian-einfachEn.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus lagrandian-einfachEn.tex}
...
\section*{Tabelle 2 aus lagrandian-einfachEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus lagrandian-einfachEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 4 aus lagrandian-einfachEn.tex}
