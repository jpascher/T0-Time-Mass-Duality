...
\title{Tabellen aus LagrandianVergleichEn.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus LagrandianVergleichEn.tex}
...
\section*{Tabelle 2 aus LagrandianVergleichEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus LagrandianVergleichEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 4 aus LagrandianVergleichEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 5 aus LagrandianVergleichEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 6 aus LagrandianVergleichEn.tex}
...
\section*{Tabelle 7 aus LagrandianVergleichEn.tex}
