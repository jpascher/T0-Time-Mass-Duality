...
\title{Tabellen aus ParameterSystemdipendentDe.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus ParameterSystemdipendentDe.tex}
...
\section*{Tabelle 2 aus ParameterSystemdipendentDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus ParameterSystemdipendentDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 4 aus ParameterSystemdipendentDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lc}
			\toprule
...
\section*{Tabelle 5 aus ParameterSystemdipendentDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
