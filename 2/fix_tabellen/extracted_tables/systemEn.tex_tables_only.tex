...
\title{Tabellen aus systemEn.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus systemEn.tex}
...
\section*{Tabelle 2 aus systemEn.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus systemEn.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus systemEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{|l|c|c|}
			\hline
...
\section*{Tabelle 5 aus systemEn.tex}
\begin{adjustbox}{max width=\textwidth}
