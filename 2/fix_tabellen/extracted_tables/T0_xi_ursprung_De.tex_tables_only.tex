...
\title{Tabellen aus T0_xi_ursprung_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0_xi_ursprung_De.tex}
...
\section*{Tabelle 2 aus T0_xi_ursprung_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus T0_xi_ursprung_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 4 aus T0_xi_ursprung_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus T0_xi_ursprung_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus T0_xi_ursprung_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{3cm}p{9cm}}
			\toprule
			\textbf{Symbol} & \textbf{Bedeutung} \\
...
\section*{Tabelle 7 aus T0_xi_ursprung_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{3cm}p{9cm}}
			\toprule
			\textbf{Symbol} & \textbf{Bedeutung} \\
...
\section*{Tabelle 8 aus T0_xi_ursprung_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{3cm}p{9cm}}
			\toprule
...
\section*{Tabelle 9 aus T0_xi_ursprung_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 10 aus T0_xi_ursprung_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 11 aus T0_xi_ursprung_De.tex}
\begin{adjustbox}{max width=\textwidth}
