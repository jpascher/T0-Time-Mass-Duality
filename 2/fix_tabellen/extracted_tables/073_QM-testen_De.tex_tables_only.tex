...
\title{Tabellen aus 073_QM-testen_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 073_QM-testen_De.tex}
...
\section*{Tabelle 2 aus 073_QM-testen_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 3 aus 073_QM-testen_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 4 aus 073_QM-testen_De.tex}
\begin{adjustbox}{max width=\textwidth}
