...
\title{Tabellen aus 129\_lagrandian-einfach\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 129\_lagrandian-einfach\_En.tex}
...
\section*{Tabelle 2 aus 129\_lagrandian-einfach\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus 129\_lagrandian-einfach\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 4 aus 129\_lagrandian-einfach\_En.tex}
