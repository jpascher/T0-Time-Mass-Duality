...
\title{Tabellen aus 127_gravitationskonstnte_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 127_gravitationskonstnte_De.tex}
...
\section*{Tabelle 2 aus 127_gravitationskonstnte_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
