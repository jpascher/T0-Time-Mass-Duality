...
\title{Tabellen aus 127\_gravitationskonstnte\_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 127\_gravitationskonstnte\_De.tex}
...
\section*{Tabelle 2 aus 127\_gravitationskonstnte\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
