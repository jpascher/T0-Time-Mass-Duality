...
\title{Tabellen aus 133\_Fraktale\_Korrektur\_Herleitung\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 133\_Fraktale\_Korrektur\_Herleitung\_En.tex}
...
\section*{Tabelle 2 aus 133\_Fraktale\_Korrektur\_Herleitung\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lc}
			\toprule
...
\section*{Tabelle 3 aus 133\_Fraktale\_Korrektur\_Herleitung\_En.tex}
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title={Unique Determination of $K\_{\text{frak}}$ and $D\_f$}]
	...
	\section{Multiple Perspectives on $K\_{\text{frak}}$}
	...
	\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title={When is $K\_{\text{frak}}$ needed?}]
