...
\title{Tabellen aus 061\_TempEinheitenCMB\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 061\_TempEinheitenCMB\_En.tex}
...
\section*{Tabelle 2 aus 061\_TempEinheitenCMB\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 3 aus 061\_TempEinheitenCMB\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 4 aus 061\_TempEinheitenCMB\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus 061\_TempEinheitenCMB\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{l l l l}
			\toprule
