...
\title{Tabellen aus T0_netze_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0_netze_De.tex}
...
\section*{Tabelle 2 aus T0_netze_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{cccc}
			\toprule
...
\section*{Tabelle 3 aus T0_netze_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus T0_netze_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{cccc}
			\toprule
...
\section*{Tabelle 5 aus T0_netze_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lp{8cm}}
			\toprule
