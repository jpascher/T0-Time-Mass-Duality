...
\title{Tabellen aus 103_T0_Anomale-g2-6_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 103_T0_Anomale-g2-6_De.tex}
...
\section*{Tabelle 2 aus 103_T0_Anomale-g2-6_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}lcccc@{}}
			\toprule
...
\section*{Tabelle 3 aus 103_T0_Anomale-g2-6_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus 103_T0_Anomale-g2-6_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus 103_T0_Anomale-g2-6_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus 103_T0_Anomale-g2-6_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}lcccccc@{}}
			\toprule
...
\section*{Tabelle 7 aus 103_T0_Anomale-g2-6_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}lccc@{}}
			\toprule
...
\section*{Tabelle 8 aus 103_T0_Anomale-g2-6_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}lcccccc@{}}
			\toprule
...
\section*{Tabelle 9 aus 103_T0_Anomale-g2-6_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}llcl@{}}
			\toprule
...
\section*{Tabelle 10 aus 103_T0_Anomale-g2-6_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}llcl@{}}
			\toprule
