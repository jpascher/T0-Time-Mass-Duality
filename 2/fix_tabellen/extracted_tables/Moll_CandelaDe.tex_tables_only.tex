...
\title{Tabellen aus Moll_CandelaDe.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus Moll_CandelaDe.tex}
...
\section*{Tabelle 2 aus Moll_CandelaDe.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus Moll_CandelaDe.tex}
\begin{adjustbox}{max width=\textwidth}
