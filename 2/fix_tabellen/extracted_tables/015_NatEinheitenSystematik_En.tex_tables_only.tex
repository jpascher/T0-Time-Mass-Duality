...
\title{Tabellen aus 015\_NatEinheitenSystematik\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 015\_NatEinheitenSystematik\_En.tex}
...
\section*{Tabelle 2 aus 015\_NatEinheitenSystematik\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lllll}
				\toprule
...
\section*{Tabelle 3 aus 015\_NatEinheitenSystematik\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
				\toprule
...
\section*{Tabelle 4 aus 015\_NatEinheitenSystematik\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
				\toprule
...
\section*{Tabelle 5 aus 015\_NatEinheitenSystematik\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
				\toprule
...
\section*{Tabelle 6 aus 015\_NatEinheitenSystematik\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
				\toprule
...
\section*{Tabelle 7 aus 015\_NatEinheitenSystematik\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{llll}
				\toprule
...
\section*{Tabelle 8 aus 015\_NatEinheitenSystematik\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
				\toprule
