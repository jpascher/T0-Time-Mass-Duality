...
\title{Tabellen aus Elimination_Of_Mass_Dirac_TabelleDe.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus Elimination_Of_Mass_Dirac_TabelleDe.tex}
...
\section*{Tabelle 2 aus Elimination_Of_Mass_Dirac_TabelleDe.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus Elimination_Of_Mass_Dirac_TabelleDe.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus Elimination_Of_Mass_Dirac_TabelleDe.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus Elimination_Of_Mass_Dirac_TabelleDe.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus Elimination_Of_Mass_Dirac_TabelleDe.tex}
\begin{adjustbox}{max width=\textwidth}
