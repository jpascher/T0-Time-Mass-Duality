...
\title{Tabellen aus ParameterSystemdipendentEn.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus ParameterSystemdipendentEn.tex}
...
\section*{Tabelle 2 aus ParameterSystemdipendentEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus ParameterSystemdipendentEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 4 aus ParameterSystemdipendentEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lc}
			\toprule
...
\section*{Tabelle 5 aus ParameterSystemdipendentEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
