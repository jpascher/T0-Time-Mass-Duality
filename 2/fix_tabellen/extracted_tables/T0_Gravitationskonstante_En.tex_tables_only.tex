...
\title{Tabellen aus T0_Gravitationskonstante_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0_Gravitationskonstante_En.tex}
...
\section*{Tabelle 2 aus T0_Gravitationskonstante_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
