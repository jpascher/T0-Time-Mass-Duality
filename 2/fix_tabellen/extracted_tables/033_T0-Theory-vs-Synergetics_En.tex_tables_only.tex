...
\title{Tabellen aus 033\_T0-Theory-vs-Synergetics\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 033\_T0-Theory-vs-Synergetics\_En.tex}
...
\section*{Tabelle 2 aus 033\_T0-Theory-vs-Synergetics\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
				\toprule
...
\section*{Tabelle 3 aus 033\_T0-Theory-vs-Synergetics\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
				\toprule
...
\section*{Tabelle 4 aus 033\_T0-Theory-vs-Synergetics\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus 033\_T0-Theory-vs-Synergetics\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lc}
					\toprule
					\textbf{From} & \textbf{To} \\
...
\section*{Tabelle 6 aus 033\_T0-Theory-vs-Synergetics\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
				\toprule
