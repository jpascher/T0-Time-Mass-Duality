...
\title{Tabellen aus 133\_Fraktale\_Korrektur\_Herleitung\_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 133\_Fraktale\_Korrektur\_Herleitung\_De.tex}
...
\section*{Tabelle 2 aus 133\_Fraktale\_Korrektur\_Herleitung\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lc}
			\toprule
...
\section*{Tabelle 3 aus 133\_Fraktale\_Korrektur\_Herleitung\_De.tex}
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title={Eindeutige Bestimmung von $K\_{\text{frak}}$ und $D\_f$}]
	...
	\section{Multiple Perspektiven auf $K\_{\text{frak}}$}
	...
	\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title={Wann benötigt man $K\_{\text{frak}}$?}]
