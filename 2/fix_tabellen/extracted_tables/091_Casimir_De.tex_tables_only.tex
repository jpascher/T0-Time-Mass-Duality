...
\title{Tabellen aus 091_Casimir_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 091_Casimir_De.tex}
...
\section*{Tabelle 2 aus 091_Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus 091_Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{r c c}
			\toprule
...
\section*{Tabelle 4 aus 091_Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus 091_Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2cm} p{9cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Wert/Einheit} \\
...
\section*{Tabelle 6 aus 091_Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2cm} p{9cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Wert/Einheit} \\
...
\section*{Tabelle 7 aus 091_Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 8 aus 091_Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2cm} p{9cm} p{3cm}}
		\toprule
...
\section*{Tabelle 9 aus 091_Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2cm} p{9cm} p{3cm}}
		\toprule
...
\section*{Tabelle 10 aus 091_Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2cm} p{9cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Anmerkung} \\
...
\section*{Tabelle 11 aus 091_Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2cm} p{9cm} p{3cm}}
		\toprule
...
\section*{Tabelle 12 aus 091_Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2cm} p{9cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Anmerkung} \\
...
\section*{Tabelle 13 aus 091_Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 14 aus 091_Casimir_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{2cm} p{8cm} p{3cm}}
		\toprule
