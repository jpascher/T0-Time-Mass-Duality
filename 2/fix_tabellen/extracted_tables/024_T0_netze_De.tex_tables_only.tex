...
\title{Tabellen aus 024\_T0\_netze\_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 024\_T0\_netze\_De.tex}
...
\section*{Tabelle 2 aus 024\_T0\_netze\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{cccc}
			\toprule
...
\section*{Tabelle 3 aus 024\_T0\_netze\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus 024\_T0\_netze\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{cccc}
			\toprule
...
\section*{Tabelle 5 aus 024\_T0\_netze\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lp{8cm}}
		\toprule
