...
\title{Tabellen aus 010_T0_Energie_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 010_T0_Energie_En.tex}
...
\section*{Tabelle 2 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 3 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
		\toprule
...
\section*{Tabelle 4 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
		\toprule
...
\section*{Tabelle 5 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}lccc@{}}
		\toprule
...
\section*{Tabelle 6 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 7 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
		\toprule
		\textbf{Scale} & \textbf{Energy (GeV)} & \textbf{Physics} \\
...
\section*{Tabelle 8 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
		\toprule
...
\section*{Tabelle 9 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
		\toprule
...
\section*{Tabelle 10 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
		\toprule
...
\section*{Tabelle 11 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 12 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
		\toprule
...
\section*{Tabelle 13 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 14 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{|l|l|}
	\hline
...
\section*{Tabelle 15 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 16 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 17 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 18 aus 010_T0_Energie_En.tex}
\begin{adjustbox}{max width=\textwidth}
