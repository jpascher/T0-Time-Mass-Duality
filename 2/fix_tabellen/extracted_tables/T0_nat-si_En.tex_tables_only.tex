...
\title{Tabellen aus T0_nat-si_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0_nat-si_En.tex}
...
\section*{Tabelle 2 aus T0_nat-si_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus T0_nat-si_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus T0_nat-si_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus T0_nat-si_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus T0_nat-si_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
			\toprule
