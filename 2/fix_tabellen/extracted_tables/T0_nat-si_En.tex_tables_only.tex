...
\title{Tabellen aus T0\_nat-si\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0\_nat-si\_En.tex}
...
\section*{Tabelle 2 aus T0\_nat-si\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus T0\_nat-si\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus T0\_nat-si\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus T0\_nat-si\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus T0\_nat-si\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
			\toprule
