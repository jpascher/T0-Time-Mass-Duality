...
\title{Tabellen aus T0-QFT-ML_Addendum_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0-QFT-ML_Addendum_En.tex}
...
\section*{Tabelle 2 aus T0-QFT-ML_Addendum_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 3 aus T0-QFT-ML_Addendum_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 4 aus T0-QFT-ML_Addendum_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 5 aus T0-QFT-ML_Addendum_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 6 aus T0-QFT-ML_Addendum_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 7 aus T0-QFT-ML_Addendum_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 8 aus T0-QFT-ML_Addendum_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 9 aus T0-QFT-ML_Addendum_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 10 aus T0-QFT-ML_Addendum_En.tex}
\begin{adjustbox}{max width=\textwidth}
