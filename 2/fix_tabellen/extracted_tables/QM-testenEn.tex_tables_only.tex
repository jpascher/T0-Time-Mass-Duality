...
\title{Tabellen aus QM-testenEn.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus QM-testenEn.tex}
...
\section*{Tabelle 2 aus QM-testenEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 3 aus QM-testenEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 4 aus QM-testenEn.tex}
