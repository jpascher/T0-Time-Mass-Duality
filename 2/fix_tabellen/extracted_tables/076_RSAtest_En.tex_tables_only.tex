...
\title{Tabellen aus 076\_RSAtest\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 076\_RSAtest\_En.tex}
...
\section*{Tabelle 2 aus 076\_RSAtest\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
			\toprule
...
\section*{Tabelle 3 aus 076\_RSAtest\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lrr}
			\toprule
...
\section*{Tabelle 4 aus 076\_RSAtest\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{llll}
			\toprule
...
\section*{Tabelle 5 aus 076\_RSAtest\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
