...
\title{Tabellen aus T0\_tm-erweiterung-x6\_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0\_tm-erweiterung-x6\_De.tex}
...
\section*{Tabelle 2 aus T0\_tm-erweiterung-x6\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus T0\_tm-erweiterung-x6\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
			\toprule
...
\section*{Tabelle 4 aus T0\_tm-erweiterung-x6\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccl}
			\toprule
...
\section*{Tabelle 5 aus T0\_tm-erweiterung-x6\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus T0\_tm-erweiterung-x6\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 7 aus T0\_tm-erweiterung-x6\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 8 aus T0\_tm-erweiterung-x6\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccccc}
			\toprule
...
\section*{Tabelle 9 aus T0\_tm-erweiterung-x6\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 10 aus T0\_tm-erweiterung-x6\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 11 aus T0\_tm-erweiterung-x6\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 12 aus T0\_tm-erweiterung-x6\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 13 aus T0\_tm-erweiterung-x6\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{|c|c|}
		\hline
...
\section*{Tabelle 14 aus T0\_tm-erweiterung-x6\_De.tex}
\begin{adjustbox}{max width=\textwidth}
