...
\title{Tabellen aus Mathematische\_struktur\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus Mathematische\_struktur\_En.tex}
...
\section*{Tabelle 2 aus Mathematische\_struktur\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
...
\section*{Tabelle 3 aus Mathematische\_struktur\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
		\toprule
...
\section*{Tabelle 4 aus Mathematische\_struktur\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
...
\section*{Tabelle 5 aus Mathematische\_struktur\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus Mathematische\_struktur\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{0.45\textwidth}p{0.45\textwidth}}
...
\section*{Tabelle 7 aus Mathematische\_struktur\_En.tex}
...
\section*{Tabelle 8 aus Mathematische\_struktur\_En.tex}
...
\section*{Tabelle 9 aus Mathematische\_struktur\_En.tex}
\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black]
