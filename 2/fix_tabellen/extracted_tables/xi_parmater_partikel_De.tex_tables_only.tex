...
\title{Tabellen aus xi_parmater_partikel_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus xi_parmater_partikel_De.tex}
...
\section*{Tabelle 2 aus xi_parmater_partikel_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 3 aus xi_parmater_partikel_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
...
\section*{Tabelle 4 aus xi_parmater_partikel_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 5 aus xi_parmater_partikel_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 6 aus xi_parmater_partikel_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 7 aus xi_parmater_partikel_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
...
\section*{Tabelle 8 aus xi_parmater_partikel_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 9 aus xi_parmater_partikel_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 10 aus xi_parmater_partikel_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
...
\section*{Tabelle 11 aus xi_parmater_partikel_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 12 aus xi_parmater_partikel_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 13 aus xi_parmater_partikel_De.tex}
\begin{adjustbox}{max width=\textwidth}
