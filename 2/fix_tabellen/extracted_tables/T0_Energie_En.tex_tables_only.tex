...
\title{Tabellen aus T0\_Energie\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0\_Energie\_En.tex}
...
\section*{Tabelle 2 aus T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 3 aus T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
		\toprule
...
\section*{Tabelle 4 aus T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
		\toprule
...
\section*{Tabelle 5 aus T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}lccc@{}}
		\toprule
...
\section*{Tabelle 6 aus T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 7 aus T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
		\toprule
		\textbf{Scale} & \textbf{Energy (GeV)} & \textbf{Physics} \\
...
\section*{Tabelle 8 aus T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
		\toprule
...
\section*{Tabelle 9 aus T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
		\toprule
...
\section*{Tabelle 10 aus T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
		\toprule
...
\section*{Tabelle 11 aus T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 12 aus T0\_Energie\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
		\toprule
...
\section*{Tabelle 13 aus T0\_Energie\_En.tex}
...
\section*{Tabelle 14 aus T0\_Energie\_En.tex}
\begin{longtable}{|l|l|}
	\hline
...
\section*{Tabelle 15 aus T0\_Energie\_En.tex}
...
\section*{Tabelle 16 aus T0\_Energie\_En.tex}
...
\section*{Tabelle 17 aus T0\_Energie\_En.tex}
...
\section*{Tabelle 18 aus T0\_Energie\_En.tex}
