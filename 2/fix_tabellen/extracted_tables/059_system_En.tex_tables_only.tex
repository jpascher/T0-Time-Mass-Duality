...
\title{Tabellen aus 059_system_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 059_system_En.tex}
...
\section*{Tabelle 2 aus 059_system_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus 059_system_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus 059_system_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{|l|c|c|}
			\hline
...
\section*{Tabelle 5 aus 059_system_En.tex}
\begin{adjustbox}{max width=\textwidth}
