...
\title{Tabellen aus universale-ableitung_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus universale-ableitung_En.tex}
...
\section*{Tabelle 2 aus universale-ableitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}lcc@{}}
			\toprule
...
\section*{Tabelle 3 aus universale-ableitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}lcc@{}}
			\toprule
...
\section*{Tabelle 4 aus universale-ableitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{|l|l|l|}
			\hline
...
\section*{Tabelle 5 aus universale-ableitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus universale-ableitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 7 aus universale-ableitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 8 aus universale-ableitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
