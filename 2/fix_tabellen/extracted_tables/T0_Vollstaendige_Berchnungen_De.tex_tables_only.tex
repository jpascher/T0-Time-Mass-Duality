...
\title{Tabellen aus T0_Vollstaendige_Berchnungen_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0_Vollstaendige_Berchnungen_De.tex}
...
\section*{Tabelle 2 aus T0_Vollstaendige_Berchnungen_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus T0_Vollstaendige_Berchnungen_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{>{\raggedright}p{4cm}ccccc}
			\toprule
...
\section*{Tabelle 4 aus T0_Vollstaendige_Berchnungen_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus T0_Vollstaendige_Berchnungen_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
...
\section*{Tabelle 6 aus T0_Vollstaendige_Berchnungen_De.tex}
\begin{adjustbox}{max width=\textwidth}
