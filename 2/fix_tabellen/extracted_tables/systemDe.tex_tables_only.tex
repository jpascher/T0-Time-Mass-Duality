...
\title{Tabellen aus systemDe.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus systemDe.tex}
...
\section*{Tabelle 2 aus systemDe.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus systemDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{|c|c|c|c|}
			\hline
...
\section*{Tabelle 4 aus systemDe.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus systemDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{|l|c|c|}
			\hline
...
\section*{Tabelle 6 aus systemDe.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 7 aus systemDe.tex}
\begin{adjustbox}{max width=\textwidth}
