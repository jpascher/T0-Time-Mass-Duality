...
\title{Tabellen aus 012\_T0\_Gravitationskonstante\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 012\_T0\_Gravitationskonstante\_En.tex}
...
\section*{Tabelle 2 aus 012\_T0\_Gravitationskonstante\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
