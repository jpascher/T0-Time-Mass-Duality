...
\title{Tabellen aus parameterherleitung\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus parameterherleitung\_En.tex}
...
\section*{Tabelle 2 aus parameterherleitung\_En.tex}
...
\section*{Tabelle 3 aus parameterherleitung\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
		\toprule
...
\section*{Tabelle 4 aus parameterherleitung\_En.tex}
\begin{longtable}{p{5cm}p{4cm}p{3.5cm}p{3.5cm}}
...
\section*{Tabelle 5 aus parameterherleitung\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus parameterherleitung\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
		\toprule
...
\section*{Tabelle 7 aus parameterherleitung\_En.tex}
\begin{longtable}{lll}
	\toprule
...
\section*{Tabelle 8 aus parameterherleitung\_En.tex}
\begin{longtable}{lll}
	\toprule
...
\section*{Tabelle 9 aus parameterherleitung\_En.tex}
\begin{longtable}{lll}
	\toprule
...
\section*{Tabelle 10 aus parameterherleitung\_En.tex}
\begin{longtable}{lll}
	\toprule
	\textbf{Symbol} & \textbf{Meaning} & \textbf{Value/Formula} \\
	\midrule
...
\section*{Tabelle 11 aus parameterherleitung\_En.tex}
\begin{longtable}{lll}
	\toprule
	\textbf{Symbol} & \textbf{Meaning} & \textbf{Value/Formula} \\
	\midrule
...
\section*{Tabelle 12 aus parameterherleitung\_En.tex}
\begin{longtable}{lll}
	\toprule
...
\section*{Tabelle 13 aus parameterherleitung\_En.tex}
\begin{longtable}{lll}
	\toprule
...
\section*{Tabelle 14 aus parameterherleitung\_En.tex}
