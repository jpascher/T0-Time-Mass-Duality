...
\title{Tabellen aus parameterherleitung_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus parameterherleitung_En.tex}
...
\section*{Tabelle 2 aus parameterherleitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus parameterherleitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
		\toprule
...
\section*{Tabelle 4 aus parameterherleitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{p{5cm}p{4cm}p{3.5cm}p{3.5cm}}
...
\section*{Tabelle 5 aus parameterherleitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus parameterherleitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
		\toprule
...
\section*{Tabelle 7 aus parameterherleitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{lll}
	\toprule
...
\section*{Tabelle 8 aus parameterherleitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{lll}
	\toprule
...
\section*{Tabelle 9 aus parameterherleitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{lll}
	\toprule
...
\section*{Tabelle 10 aus parameterherleitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{lll}
	\toprule
	\textbf{Symbol} & \textbf{Meaning} & \textbf{Value/Formula} \\
...
\section*{Tabelle 11 aus parameterherleitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{lll}
	\toprule
	\textbf{Symbol} & \textbf{Meaning} & \textbf{Value/Formula} \\
...
\section*{Tabelle 12 aus parameterherleitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{lll}
	\toprule
...
\section*{Tabelle 13 aus parameterherleitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{longtable}{lll}
	\toprule
...
\section*{Tabelle 14 aus parameterherleitung_En.tex}
\begin{adjustbox}{max width=\textwidth}
