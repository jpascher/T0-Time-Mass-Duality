...
\title{Tabellen aus T0\_koide-formel-3\_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0\_koide-formel-3\_De.tex}
...
\section*{Tabelle 2 aus T0\_koide-formel-3\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus T0\_koide-formel-3\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
