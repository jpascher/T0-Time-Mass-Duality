...
\title{Tabellen aus 035\_QM\_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 035\_QM\_De.tex}
...
\section*{Tabelle 2 aus 035\_QM\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 3 aus 035\_QM\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 4 aus 035\_QM\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 5 aus 035\_QM\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus 035\_QM\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 7 aus 035\_QM\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 8 aus 035\_QM\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 9 aus 035\_QM\_De.tex}
\begin{adjustbox}{max width=\textwidth}
