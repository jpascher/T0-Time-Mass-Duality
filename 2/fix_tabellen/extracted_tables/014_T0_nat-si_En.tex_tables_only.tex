...
\title{Tabellen aus 014_T0_nat-si_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 014_T0_nat-si_En.tex}
...
\section*{Tabelle 2 aus 014_T0_nat-si_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 3 aus 014_T0_nat-si_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus 014_T0_nat-si_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus 014_T0_nat-si_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus 014_T0_nat-si_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
			\toprule
