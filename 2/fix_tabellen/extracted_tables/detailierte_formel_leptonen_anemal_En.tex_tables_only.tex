...
\title{Tabellen aus detailierte_formel_leptonen_anemal_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus detailierte_formel_leptonen_anemal_En.tex}
...
\section*{Tabelle 2 aus detailierte_formel_leptonen_anemal_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
