...
\title{Tabellen aus detailierte\_formel\_leptonen\_anemal\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus detailierte\_formel\_leptonen\_anemal\_En.tex}
...
\section*{Tabelle 2 aus detailierte\_formel\_leptonen\_anemal\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
