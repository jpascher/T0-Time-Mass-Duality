...
\title{Tabellen aus 066_ParameterSystemdipendent_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 066_ParameterSystemdipendent_En.tex}
...
\section*{Tabelle 2 aus 066_ParameterSystemdipendent_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus 066_ParameterSystemdipendent_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcccc}
			\toprule
...
\section*{Tabelle 4 aus 066_ParameterSystemdipendent_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lc}
			\toprule
...
\section*{Tabelle 5 aus 066_ParameterSystemdipendent_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
