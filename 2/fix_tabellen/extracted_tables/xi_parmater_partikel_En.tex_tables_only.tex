...
\title{Tabellen aus xi\_parmater\_partikel\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus xi\_parmater\_partikel\_En.tex}
...
\section*{Tabelle 2 aus xi\_parmater\_partikel\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 3 aus xi\_parmater\_partikel\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
...
\section*{Tabelle 4 aus xi\_parmater\_partikel\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 5 aus xi\_parmater\_partikel\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 6 aus xi\_parmater\_partikel\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 7 aus xi\_parmater\_partikel\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
...
\section*{Tabelle 8 aus xi\_parmater\_partikel\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 9 aus xi\_parmater\_partikel\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 10 aus xi\_parmater\_partikel\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
...
\section*{Tabelle 11 aus xi\_parmater\_partikel\_En.tex}
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Central T0 Principle]
				...
				\begin{equation}
					\boxed{\text{Reality} = \Delta m(x,t) \text{ dancing in } \xipar \text{-characterized spacetime}}
...
\section*{Tabelle 12 aus xi\_parmater\_partikel\_En.tex}
...
\section*{Tabelle 13 aus xi\_parmater\_partikel\_En.tex}
\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=T0 Unification Achievement]
	...
	\begin{tcolorbox}[colback=yellow!10!white,colframe=orange!75!black,title=T0 Theory Revolutionary Achievements]
		\begin{itemize}
			...
			\item \textbf{Geometric foundation}: Arbitrary physics $\rightarrow$ 3D space geometry
