...
\title{Tabellen aus 049_LagrandianVergleich_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 049_LagrandianVergleich_En.tex}
...
\section*{Tabelle 2 aus 049_LagrandianVergleich_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus 049_LagrandianVergleich_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 4 aus 049_LagrandianVergleich_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 5 aus 049_LagrandianVergleich_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 6 aus 049_LagrandianVergleich_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 7 aus 049_LagrandianVergleich_En.tex}
\begin{adjustbox}{max width=\textwidth}
