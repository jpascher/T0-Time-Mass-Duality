...
\title{Tabellen aus 018\_T0\_Anomale-g2-9\_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 018\_T0\_Anomale-g2-9\_De.tex}
...
\section*{Tabelle 2 aus 018\_T0\_Anomale-g2-9\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}lcccc@{}}
			\toprule
...
\section*{Tabelle 3 aus 018\_T0\_Anomale-g2-9\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus 018\_T0\_Anomale-g2-9\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus 018\_T0\_Anomale-g2-9\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus 018\_T0\_Anomale-g2-9\_De.tex}
...
\section*{Tabelle 7 aus 018\_T0\_Anomale-g2-9\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 8 aus 018\_T0\_Anomale-g2-9\_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 9 aus 018\_T0\_Anomale-g2-9\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}llcl@{}}
				\toprule
...
\section*{Tabelle 10 aus 018\_T0\_Anomale-g2-9\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}llcl@{}}
				\toprule
