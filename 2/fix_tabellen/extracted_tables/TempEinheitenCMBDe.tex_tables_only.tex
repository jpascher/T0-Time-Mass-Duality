...
\title{Tabellen aus TempEinheitenCMBDe.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus TempEinheitenCMBDe.tex}
...
\section*{Tabelle 2 aus TempEinheitenCMBDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 3 aus TempEinheitenCMBDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 4 aus TempEinheitenCMBDe.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus TempEinheitenCMBDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 6 aus TempEinheitenCMBDe.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{l l l l}
			\toprule
