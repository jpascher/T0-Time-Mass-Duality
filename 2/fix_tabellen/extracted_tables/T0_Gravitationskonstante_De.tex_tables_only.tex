...
\title{Tabellen aus T0\_Gravitationskonstante\_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0\_Gravitationskonstante\_De.tex}
...
\section*{Tabelle 2 aus T0\_Gravitationskonstante\_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
