...
\title{Tabellen aus T0_Gravitationskonstante_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0_Gravitationskonstante_De.tex}
...
\section*{Tabelle 2 aus T0_Gravitationskonstante_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
