...
\title{Tabellen aus 073\_QM-testen\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 073\_QM-testen\_En.tex}
...
\section*{Tabelle 2 aus 073\_QM-testen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 3 aus 073\_QM-testen\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 4 aus 073\_QM-testen\_En.tex}
