...
\title{Tabellen aus DerivationVonBetaEn.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus DerivationVonBetaEn.tex}
...
\section*{Tabelle 2 aus DerivationVonBetaEn.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lcc}
			\toprule
...
\section*{Tabelle 3 aus DerivationVonBetaEn.tex}
\begin{adjustbox}{max width=\textwidth}
