...
\title{Tabellen aus 022_T0-QFT-ML_Addendum_De.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 022_T0-QFT-ML_Addendum_De.tex}
...
\section*{Tabelle 2 aus 022_T0-QFT-ML_Addendum_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 3 aus 022_T0-QFT-ML_Addendum_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 4 aus 022_T0-QFT-ML_Addendum_De.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lccc}
			\toprule
...
\section*{Tabelle 5 aus 022_T0-QFT-ML_Addendum_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus 022_T0-QFT-ML_Addendum_De.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 7 aus 022_T0-QFT-ML_Addendum_De.tex}
\begin{adjustbox}{max width=\textwidth}
