...
\title{Tabellen aus 070\_Mathematische\_struktur\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 070\_Mathematische\_struktur\_En.tex}
...
\section*{Tabelle 2 aus 070\_Mathematische\_struktur\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
...
\section*{Tabelle 3 aus 070\_Mathematische\_struktur\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
		\toprule
...
\section*{Tabelle 4 aus 070\_Mathematische\_struktur\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
...
\section*{Tabelle 5 aus 070\_Mathematische\_struktur\_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus 070\_Mathematische\_struktur\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{0.45\textwidth}p{0.45\textwidth}}
...
\section*{Tabelle 7 aus 070\_Mathematische\_struktur\_En.tex}
...
\section*{Tabelle 8 aus 070\_Mathematische\_struktur\_En.tex}
...
\section{Derivation of the Coefficients $c\_e$ and $c\_\mu$}
...
\section{FFGFT: Exact Formulas and Values}
...
\begin{align*}
	...
	\text{FFGFT:} &\quad m_e = \frac{3\sqrt{3}}{2\pi\alpha^{1/2}} \cdot \xi^{5/2}
\end{align*}
...
\begin{align*}
	...
	\text{FFGFT:} &\quad m_\mu = \frac{9}{4\pi\alpha} \cdot \xi^2
\end{align*}
...
\section*{Tabelle 9 aus 070\_Mathematische\_struktur\_En.tex}
\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black]
