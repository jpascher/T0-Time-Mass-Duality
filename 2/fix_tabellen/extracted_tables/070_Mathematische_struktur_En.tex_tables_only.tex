...
\title{Tabellen aus 070_Mathematische_struktur_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus 070_Mathematische_struktur_En.tex}
...
\section*{Tabelle 2 aus 070_Mathematische_struktur_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
...
\section*{Tabelle 3 aus 070_Mathematische_struktur_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
		\toprule
...
\section*{Tabelle 4 aus 070_Mathematische_struktur_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
...
\section*{Tabelle 5 aus 070_Mathematische_struktur_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus 070_Mathematische_struktur_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{0.45\textwidth}p{0.45\textwidth}}
...
\section*{Tabelle 7 aus 070_Mathematische_struktur_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 8 aus 070_Mathematische_struktur_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 9 aus 070_Mathematische_struktur_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black]
