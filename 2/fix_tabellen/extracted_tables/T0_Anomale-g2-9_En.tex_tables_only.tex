...
\title{Tabellen aus T0_Anomale-g2-9_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus T0_Anomale-g2-9_En.tex}
...
\section*{Tabelle 2 aus T0_Anomale-g2-9_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}lcccc@{}}
				\toprule
...
\section*{Tabelle 3 aus T0_Anomale-g2-9_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 4 aus T0_Anomale-g2-9_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 5 aus T0_Anomale-g2-9_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 6 aus T0_Anomale-g2-9_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 7 aus T0_Anomale-g2-9_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}lcccr@{}}
				\toprule
...
\section*{Tabelle 8 aus T0_Anomale-g2-9_En.tex}
\begin{adjustbox}{max width=\textwidth}
...
\section*{Tabelle 9 aus T0_Anomale-g2-9_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}llcl@{}}
				\toprule
...
\section*{Tabelle 10 aus T0_Anomale-g2-9_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}llcl@{}}
				\toprule
