...
\title{Tabellen aus RSAtest\_En.tex}
\maketitle

\tableofcontents
\newpage

\section*{Tabelle 1 aus RSAtest\_En.tex}
...
\section*{Tabelle 2 aus RSAtest\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lll}
			\toprule
...
\section*{Tabelle 3 aus RSAtest\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{lrr}
			\toprule
...
\section*{Tabelle 4 aus RSAtest\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{llll}
			\toprule
...
\section*{Tabelle 5 aus RSAtest\_En.tex}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{ll}
			\toprule
