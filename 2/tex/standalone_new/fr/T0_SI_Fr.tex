...
\chapter{SI Units}
	...
	Solving equation \eqref{T0_SI:eq:t0_fundamental} for $G$:
	...
	\begin{derivation}
		...
		Checking equation \eqref{T0_SI:eq:g_fundamental}:
		\begin{equation}
	...
	\begin{keyresult}
		...
		Since $G$ is derived from $\xi$ via equation \eqref{T0_SI:eq:g_fundamental}:
		\begin{equation}
			G = \frac{\xi^2}{4 m_e}
		\end{equation}
