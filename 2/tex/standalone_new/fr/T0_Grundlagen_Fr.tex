...
% end box foundation
	...
	\begin{itemize}
		\item \textbf{T0\_FineStructure\_Fr.tex}: Mathematical Derivation of the Fine Structure Constant
		\item \textbf{T0\_GravitationalConstant\_Fr.tex}: Detailed Calculation of Gravity
		\item \textbf{T0\_ParticleMasses\_Fr.tex}: Systematic Mass Calculation of All Fermions
		\item \textbf{T0\_Neutrinos\_Fr.tex}: Special Treatment of Neutrino Physics
		\item \textbf{T0\_AnomalousMagneticMoments\_Fr.tex}: Solution to the Muon g-2 Anomaly
		\item \textbf{T0\_Cosmology\_Fr.tex}: Cosmological Applications of the T0-Theory
		\item \textbf{T0\_QM-QFT-RT\_Fr.tex}: Complete Quantum Field Theory in the T0 Framework with Quantum Mechanics and Quantum Computing Applications
	\end{itemize}
