...
\begin{tabular}{lp{10cm}}
			...
			\midrule
			T0\_Fundamentals\_Fr.tex & Fundamental $\xi_0$ geometry and fractal spacetime structure \\
			T0\_FineStructure\_Fr.tex & Electromagnetic coupling constant $\alpha$ in $D_{\text{lepton}}$ \\
			T0\_GravitationalConstant\_Fr.tex & Gravitational analog to mass hierarchy \\
			T0\_Neutrinos\_Fr.tex & Detailed treatment of neutrino masses and PMNS mixing \\
			T0\_Anomalies\_Fr.tex & Connection to g-2 predictions via mass scaling \\
			\bottomrule
		\end{tabular}}
