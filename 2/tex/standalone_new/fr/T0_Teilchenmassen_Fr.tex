...
\begin{tabular}{lccccc}
		...
		\textbf{*Neutrinos:} Require separate analysis (see T0\_Neutrinos\_Fr.tex)
	\end{experimental}
	...
	\begin{warning}
		...
		\textbf{Reference:} Complete neutrino analysis in Document T0\_Neutrinos\_Fr.tex
	\end{warning}
...
\begin{tabular}{lcc}
	...
	\begin{itemize}
		\item \textbf{T0\_Foundations\_Fr.tex:} Fundamental $\xi_0$-geometry
		\item \textbf{T0\_FineStructure\_Fr.tex:} Electromagnetic coupling constant
		\item \textbf{T0\_GravitationalConstant\_Fr.tex:} Gravitational analog to masses
		\item \textbf{T0\_Neutrinos\_Fr.tex:} Special case of neutrino physics
	\end{itemize}
