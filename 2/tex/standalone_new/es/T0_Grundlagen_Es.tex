...
% end box foundation
	...
	\begin{itemize}
		\item \textbf{T0\_FineStructure\_Es.tex}: Mathematical Derivation of the Fine Structure Constant
		\item \textbf{T0\_GravitationalConstant\_Es.tex}: Detailed Calculation of Gravity
		\item \textbf{T0\_ParticleMasses\_Es.tex}: Systematic Mass Calculation of All Fermions
		\item \textbf{T0\_Neutrinos\_Es.tex}: Special Treatment of Neutrino Physics
		\item \textbf{T0\_AnomalousMagneticMoments\_Es.tex}: Solution to the Muon g-2 Anomaly
		\item \textbf{T0\_Cosmology\_Es.tex}: Cosmological Applications of the T0-Theory
		\item \textbf{T0\_QM-QFT-RT\_Es.tex}: Complete Quantum Field Theory in the T0 Framework with Quantum Mechanics and Quantum Computing Applications
	\end{itemize}
