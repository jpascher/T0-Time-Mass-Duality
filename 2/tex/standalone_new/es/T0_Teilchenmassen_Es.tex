...
\begin{tabular}{lccccc}
		...
		\textbf{*Neutrinos:} Require separate analysis (see T0\_Neutrinos\_Es.tex)
	\end{experimental}
	...
	\begin{warning}
		...
		\textbf{Reference:} Complete neutrino analysis in Document T0\_Neutrinos\_Es.tex
	\end{warning}
...
\begin{tabular}{lcc}
	...
	\begin{itemize}
		\item \textbf{T0\_Foundations\_Es.tex:} Fundamental $\xi_0$-geometry
		\item \textbf{T0\_FineStructure\_Es.tex:} Electromagnetic coupling constant
		\item \textbf{T0\_GravitationalConstant\_Es.tex:} Gravitational analog to masses
		\item \textbf{T0\_Neutrinos\_Es.tex:} Special case of neutrino physics
	\end{itemize}
