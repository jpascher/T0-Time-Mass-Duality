...
\chapter{Energy in T0 Theory}
	...
	\subsection{Field Equation for the Energy Field}\label{T0_Energie:subsec:field_equation}
...
\begin{tabular}{lccc}
	...
	\section{Experimental Consequences}\label{T0_Energie:sec:experimental_consequences}
