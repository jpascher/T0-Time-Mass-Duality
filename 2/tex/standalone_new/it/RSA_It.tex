...
\chapter{RSA Analysis}
	...
	The time-mass duality (Eq.~\ref{RSA:eq:duality}) defines a hyperbolic metric in the $(T,m)$ parameter space:
	...
	For the field equation (\ref{RSA:eq:field}), existence and uniqueness follow from standard PDE theory for elliptic equations with appropriate boundary conditions.
