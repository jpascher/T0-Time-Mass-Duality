...
\begin{tabular}{lccccc}
		...
		\textbf{*Neutrinos:} Require separate analysis (see T0\_Neutrinos\_It.tex)
	\end{experimental}
	...
	\begin{warning}
		...
		\textbf{Reference:} Complete neutrino analysis in Document T0\_Neutrinos\_It.tex
	\end{warning}
...
\begin{tabular}{lcc}
	...
	\begin{itemize}
		\item \textbf{T0\_Foundations\_It.tex:} Fundamental $\xi_0$-geometry
		\item \textbf{T0\_FineStructure\_It.tex:} Electromagnetic coupling constant
		\item \textbf{T0\_GravitationalConstant\_It.tex:} Gravitational analog to masses
		\item \textbf{T0\_Neutrinos\_It.tex:} Special case of neutrino physics
	\end{itemize}
