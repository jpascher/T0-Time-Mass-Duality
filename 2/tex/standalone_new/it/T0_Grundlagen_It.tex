...
\title{Introduction to the T0-Theory}
...
\chapter[T0-Theory: Fundamental Principles]{T0-Theory: Fundamental Principles}
...
% end box foundation
	...
	\begin{itemize}
		\item \textbf{T0\_FineStructure\_It.tex}: Mathematical Derivation of the Fine Structure Constant
		\item \textbf{T0\_GravitationalConstant\_It.tex}: Detailed Calculation of Gravity
		\item \textbf{T0\_ParticleMasses\_It.tex}: Systematic Mass Calculation of All Fermions
		\item \textbf{T0\_Neutrinos\_It.tex}: Special Treatment of Neutrino Physics
		\item \textbf{T0\_AnomalousMagneticMoments\_It.tex}: Solution to the Muon g-2 Anomaly
		\item \textbf{T0\_Cosmology\_It.tex}: Cosmological Applications of the T0-Theory
		\item \textbf{T0\_QM-QFT-RT\_It.tex}: Complete Quantum Field Theory in the T0 Framework with Quantum Mechanics and Quantum Computing Applications
	\end{itemize}
