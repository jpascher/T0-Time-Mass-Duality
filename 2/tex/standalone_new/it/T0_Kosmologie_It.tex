...
\chapter{Cosmology}
	...
	\begin{itemize}
		\item \textbf{T0\_Basics\_It.tex:} Geometric parameter $\xipar$ and fractal spacetime structure
		\item \textbf{T0\_FineStructure\_It.tex:} Electromagnetic interactions in the $\xi$-field
		\item \textbf{T0\_GravitationalConstant\_It.tex:} Gravitation theory from $\xi$-geometry
		\item \textbf{T0\_ParticleMasses\_It.tex:} Mass spectrum as the basis for cosmic structure formation
		\item \textbf{T0\_Neutrinos\_It.tex:} Neutrino oscillations in cosmic dimensions
	\end{itemize}
