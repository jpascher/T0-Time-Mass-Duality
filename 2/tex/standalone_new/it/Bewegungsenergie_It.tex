...
\chapter{Kinetic Energy}
	...
	- **Photons**: Their frequencies directly determine their energy, with different frequencies corresponding to distinct electromagnetic modes. The field equation \eqref{Bewegungsenergie:eq:energy_field_equation} governs the propagation of these modes.
