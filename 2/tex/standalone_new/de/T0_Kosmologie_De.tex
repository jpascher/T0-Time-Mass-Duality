...
\chapter{Cosmology}
	...
	\begin{itemize}
		\item \textbf{T0\_Basics\_De.tex:} Geometric parameter $\xipar$ and fractal spacetime structure
		\item \textbf{T0\_FineStructure\_De.tex:} Electromagnetic interactions in the $\xi$-field
		\item \textbf{T0\_GravitationalConstant\_De.tex:} Gravitation theory from $\xi$-geometry
		\item \textbf{T0\_ParticleMasses\_De.tex:} Mass spectrum as the basis for cosmic structure formation
		\item \textbf{T0\_Neutrinos\_De.tex:} Neutrino oscillations in cosmic dimensions
	\end{itemize}
