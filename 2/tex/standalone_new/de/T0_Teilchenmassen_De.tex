...
\begin{tabular}{lccccc}
		...
		\textbf{*Neutrinos:} Require separate analysis (see T0\_Neutrinos\_De.tex)
	\end{experimental}
	...
	\begin{warning}
		...
		\textbf{Reference:} Complete neutrino analysis in Document T0\_Neutrinos\_De.tex
	\end{warning}
...
\begin{tabular}{lcc}
	...
	\begin{itemize}
		\item \textbf{T0\_Foundations\_De.tex:} Fundamental $\xi_0$-geometry
		\item \textbf{T0\_FineStructure\_De.tex:} Electromagnetic coupling constant
