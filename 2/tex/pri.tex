...
% Define COMMENT for algorithmic (alternative syntax)
\providecommand{\COMMENT}[1]{\Comment{#1}}
\providecommand{\Comment}[1]{\hfill\texttt{// #1}}
\usepackage{truncate}
...
% Additional T0-specific macros
\newcommand{\xiconst}{\xi}                % Xi constant
\newcommand{\kfrac}{\kappa}               % Kappa fraction
\newcommand{\mfield}{m_f}                 % Mass field
\newcommand{\betaT}{\beta_T}              % Beta-T coupling
\newcommand{\alphaEM}{\alpha_{\text{EM}}} % Electromagnetic alpha
\newcommand{\primrel}{\mathcal{P}}        % Primary relation
\newcommand{\vect}[1]{\mathbf{#1}}        % Vector notation
\newcommand{\xicoupling}{\xi_c}           % Xi coupling
\newcommand{\checked}{\checkmark}         % Checkmark symbol
\newcommand{\etavis}{\eta_{\text{vis}}}   % Visible efficiency
\newcommand{\rhoE}{\rho_E}                % Energy density
\newcommand{\lambdazero}{\lambda_0}       % Initial wavelength
\newcommand{\nuzero}{\nu_0}               % Initial frequency
