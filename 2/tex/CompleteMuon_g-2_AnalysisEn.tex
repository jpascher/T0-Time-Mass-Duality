...
\begin{document}
	...
	\begin{center}
		\fbox{\begin{minipage}{0.9\textwidth}
				\textbf{\textcolor{red}{IMPORTANT NOTE: Correct T0 Interpretation}}
				
				\textcolor{red}{\textbf{Critical Point:}} The parameter $\epsilonT$ in T0-theory is \textbf{NOT} set to 1. Instead:
				
				\textbf{T0-theory:} $\epsilonT = \xipar \cdot \Eo^2 = 7.297 \times 10^{-3}$ (geometrically calculated)
				
				\textbf{SI equivalence:} $\epsilonT \equiv \alphaSI = 1/137.036$ (experimental equivalence)
				
				\textbf{Physical meaning:} The same physical coupling strength is described by:
				\begin{itemize}
					\item Geometric parameters in T0 natural units
