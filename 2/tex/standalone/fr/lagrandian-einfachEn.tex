...
\begin{document}
	...
	\begin{itemize}
		...
		\item $\varepsilon$ determines the \og{}inertia\fg{} of the field
	...
	\begin{thebibliography}{99}
		...
		\bibitem{occam_1320}
		William of Ockham (c. 1320). \textit{Summa Logicae}. \og{}Plurality should not be posited without necessity.\fg{}
