...
\begin{document}
	...
	\begin{abstract}
		This work reveals the central point of Einstein's relativity theory: E=mc² is mathematically identical to E=m. The only difference lies in Einstein's treatment of c as a \og{}constant\fg{} instead of a dynamic ratio. By fixing c = 299,792,458 m/s, the natural time-mass duality T·m = 1 is artificially \og{}frozen,\fg{} leading to apparent complexity. The T0 theory shows: c is not a fundamental law of nature, but only a ratio that must be variable if time is variable. Einstein's error was not E=mc² itself, but the constant-setting of c.
	\end{abstract}
	...
	\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=The Fundamental Recognition]
		...
		The only difference: Einstein treats c as a \og{}constant,\fg{} although c is a dynamic ratio.
	...
	\textbf{Step 2}: Time becomes \og{}frozen\fg{} by this
	\begin{equation}
		T = \frac{L}{c} = \frac{L}{\text{constant}} = \text{apparently determined}
	\end{equation}
	
	\textbf{Step 3}: Time dilation becomes \og{}mysterious effect\fg{}
	\begin{equation}
	...
	\textbf{Einstein's constant-setting} \og{}freezes\fg{} this natural variability artificially
	
	\textbf{Result}: One needs complicated theory to repair the \og{}frozen\fg{} dynamics
	...
	\begin{itemize}
		...
		\item Artificial \og{}freezing\fg{} of time dynamics
	...
	Einstein \og{}solves\fg{} the contradiction through:
	\begin{itemize}
	...
	\textbf{If one defines $c^2$ as \og{}conversion factor\fg{}}:
	\begin{equation}
		E = mc^2
	\end{equation}
	...
	\begin{tcolorbox}[colback=orange!5!white,colframe=orange!75!black,title=The Fundamental Choice Option]
		\textbf{One can choose what should be \og{}constant\fg{}!}
	...
	\begin{itemize}
		\item \og{}Speed of light is universally constant\fg{}
		\item \og{}Time dilates in strong gravitational fields\fg{}
		\item \og{}Clocks run slower at high velocities\fg{}
	\end{itemize}
	...
	\begin{itemize}
		\item \og{}Time flows equally everywhere\fg{}
		\item \og{}Speed of light varies with location\fg{}
		\item \og{}Light becomes slower in strong gravitational fields\fg{}
	\end{itemize}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{|l|c|c|}
			...
			GPS correction & \og{}Clocks run differently\fg{} & \og{}c is different\fg{} \\
	...
	\begin{itemize}
		...
		\item \textbf{Aesthetics}: \og{}Universal constant\fg{} sounded elegant
	...
	\textbf{T0 insight}:
	\begin{itemize}
		\item \textbf{Neither} c nor time are \og{}really\fg{} constant
	...
	\section{When Something Becomes \og{}Constant\fg{}}
	...
	\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=The Reference Point Illusion]
		\textbf{Something only becomes \og{}constant\fg{} when we define a reference point!}
		
		\textbf{Without reference point}: All ratios are relative and dynamic
		
		\textbf{With reference point}: One ratio becomes artificially \og{}fixed\fg{}
	...
	\textbf{All c-values are relative to each other}. None is \og{}constant\fg{}.
	
	\subsection{The Moment of Reference Point Setting}
	
	\textbf{Einstein's fatal step}:
	\begin{equation}
		\text{\og{}I define: } c = 299,792,458 \text{ m/s = reference point\fg{}}
	\end{equation}
	...
	\begin{itemize}
		...
		\item The \textbf{dynamic ratio} becomes a \og{}constant\fg{}
		\item The \textbf{natural relativity} is artificially \og{}frozen\fg{}
	\end{itemize}
	...
	\begin{itemize}
		...
		\item There is \textbf{no \og{}natural\fg{} length unit} - only human agreements
		\item \textbf{Humans make c \og{}constant\fg{} by definition} - not nature!
	\end{itemize}
	
	\subsection{The Circular Error: Humans Define Their Own \og{}Constants\fg{}}
	...
	\textbf{This makes c automatically \og{}constant\fg{}} - through human definition, not through natural law:
	\begin{equation}
		c = \frac{299,792,458 \text{ meters}}{1 \text{ second}} = 299,792,458 \text{ m/s}
	\end{equation}
	
	\textbf{Circular reasoning}: Humans define c as constant and then \og{}measure\fg{} a constant!
	...
	\textbf{One cannot \og{}prove\fg{} what one has defined!}
	...
	\textbf{Einstein's \og{}c-constancy\fg{} was belief, not proof!}
	...
	\textbf{What is \og{}really\fg{} real?}
	\begin{itemize}
	...
	\subsection{Why T0 is Still \og{}Better\fg{}}
	
	\textbf{Not because of \og{}absolute truth,\fg{} but because of}:
	...
	\textbf{T0 does NOT claim to be \og{}absolute truth.\fg{}}
	
	\textbf{T0 only says}:
	\begin{itemize}
		\item \og{}Here is a \textbf{simpler} construct\fg{}
		\item \og{}With \textbf{fewer} arbitrary assumptions\fg{}
		\item \og{}That is \textbf{more consistent} than Einstein's construct\fg{}
		\item \og{}And makes \textbf{more testable} predictions\fg{}
	\end{itemize}
	...
	\textbf{By all these criteria T0 is \og{}better\fg{} than Einstein - but not \og{}absolutely true\fg{}.}
	...
	\subsection{Why E=mc² \og{}Works\fg{}}
	
	\textbf{E=mc² works because}:
	\begin{itemize}
		\item It is mathematically identical to $E = m$
		\item $c^2$ compensates the \og{}frozen\fg{} time dynamics
	...
	\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=The Fundamental Truth]
		...
		Einstein's \og{}constant\fg{} c is in truth a variable ratio.
