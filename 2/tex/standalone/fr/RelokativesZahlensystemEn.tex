...
\begin{document}
	...
	The relational number system represents a paradigm shift: from \og{}How much?\fg{} to \og{}How does it relate?\fg{}. 
	...
	\begin{verbatim}
		def adaptive_xi_for_hardware(self, hardware_type: str = \og{}standard\fg{}) -> float:
		...
		hardware_factor = {\og{}standard\fg{}: 1.0, \og{}gpu\fg{}: 1.2, \og{}quantum\fg{}: 0.5}
