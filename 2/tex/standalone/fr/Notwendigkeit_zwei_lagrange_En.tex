...
\begin{document}
	...
	\begin{tcolorbox}[colback=purple!5!white,colframe=purple!75!black,title=Mathematics as Universal Language]
		...
		The T0 equation $\mathcal{L} = \varepsilon \cdot (\partial\delta E)^2$ may be alien to our experience, but it describes the same reality we experience as \og{}matter\fg{} and \og{}forces.\fg{}
	\end{tcolorbox}
	...
	\begin{tcolorbox}[colback=purple!5!white,colframe=purple!75!black,title=Core Message]
		...
		\begin{itemize}
			...
			\item The \og{}true\fg{} nature of reality may be completely different from what our senses suggest
			\item A universal energy field may be closer to reality than our perception of \og{}solid\fg{} objects
		\end{itemize}
