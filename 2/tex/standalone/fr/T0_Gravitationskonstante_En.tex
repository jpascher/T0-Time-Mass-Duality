...
\begin{document}
	...
	\begin{derivation}
		...
		The factor 68 corresponds to the tetrahedral symmetry of the T0 space structure. The fractal dimension $D_f = 2.94$ describes the \og{}porosity\fg{} of spacetime due to quantum fluctuations.
