...
\noindent \textbf{11.7.1} The documents show various \og{}derivations\fg{} of E0:
...
The seemingly \og{}random\fg{} coefficients contain deeper mathematical constants (e, $\pi$, $\alpha$), pointing to a fundamental geometric structure.
