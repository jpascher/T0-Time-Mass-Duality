...
\begin{document}
	...
	T0 implements a form of \og{}superdeterminism\fg{}:
	...
	\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=T0 Superdeterminism]
		...
		\begin{itemize}
			\item Experimenter's \og{}choice\fg{} of measurement direction
	...
	\begin{enumerate}
		\item \textbf{Measurement direction correlations}: Statistical bias in \og{}random\fg{} measurement choices
	...
	\begin{itemize}
		...
		\item \og{}Hidden variables\fg{} are the complete energy field configuration $\{\Efield(x,t)\}$
	\end{itemize}
	...
	\begin{itemize}
		...
		\item \og{}Random\fg{} number generators exhibit systematic patterns
		\item Bell test \og{}loopholes\fg{} become fundamental features rather than flaws
	\end{itemize}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\item **T0 prediction**: Subtle statistical biases in \og{}random\fg{} choices
