...
% Fallback for algorithm commands
\providecommand{\STATE}{\par\noindent}
\providecommand{\COMMENT}[1]{\hfill\textit{// #1}}
\providecommand{\IF}[1]{\textbf{if} #1 \textbf{then}}
\providecommand{\ENDIF}{\textbf{end if}}
\providecommand{\ELSE}{\textbf{else}}
\providecommand{\ELSIF}[1]{\textbf{else if} #1 \textbf{then}}
\providecommand{\RETURN}[1]{\textbf{return} #1}
