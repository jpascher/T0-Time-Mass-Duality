...
\begin{document}
	...
	The relational number system represents a paradigm shift: from \glqq{}How much?\grqq{} to \glqq{}How does it relate?\grqq{}. 
	...
	\begin{verbatim}
		def adaptive_xi_for_hardware(self, hardware_type: str = \glqq{}standard\grqq{}) -> float:
		...
		hardware_factor = {\glqq{}standard\grqq{}: 1.0, \glqq{}gpu\grqq{}: 1.2, \glqq{}quantum\grqq{}: 0.5}
