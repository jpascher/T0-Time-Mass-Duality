...
\begin{document}
	...
	\begin{vorteil}
		...
		\textbf{Erweiterung:} Dies entspricht dem Prinzip der Minimalismus in der Physik, wie von Dirac formuliert \cite{dirac_principles}: \glqq{}The underlying physical laws necessary for the mathematical theory of a large part of physics... are thus completely known.\grqq{} T0 erweitert dies auf die Geometrie.
	\end{vorteil}
	...
	\begin{gemeinsam}
		...
		\textbf{Erweiterung:} Die Konvergenz unterstreicht eine \glqq{}geometrische Konvergenztheorie\grqq{}: Unabhängige Wege führen zur selben Wahrheit, ähnlich wie Newton und Leibniz zum Kalkül kamen. Dies stärkt die Glaubwürdigkeit und lädt zu kollaborativen Erweiterungen ein, z.\,B. gemeinsame GitHub-Repos.
	\end{gemeinsam}
	...
	\textbf{Erweiterung:} Zukünftige Arbeit könnte eine \glqq{}T0-Synergetics-Allianz\grqq{} bilden, mit gemeinsamen Publikationen und Experimenten, z.\,B. Casimir-Messungen bei $\xipar$-Längen. Dies könnte die Physik revolutionieren, ähnlich wie die Quantenmechanik 1925.
