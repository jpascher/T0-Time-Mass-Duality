...
\begin{tcolorbox}[colback=yellow!10!white,colframe=yellow!50!black,title=Note on Derivation]
	For the detailed derivation and physical justification of this fundamental constant, see the document \glqq{}Parameter Derivation\grqq{} (available at: \url{https://github.com/jpascher/T0-Time-Mass-Duality/2/pdf/parameterherleitung_En.pdf}).
\end{tcolorbox}
	...
	\begin{thebibliography}{20}
		...
		Pascher, Johann (2025). 
		\textit{T0-Theorie: Wellenl\\glqq{}angenabh\\grqq{}angige Rotverschiebung ohne Distanzannahmen}. 
		T0-Theory Project. 
