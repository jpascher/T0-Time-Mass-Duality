...
\begin{document}
	...
	\begin{itemize}
		...
		\item \textbf{Historical precedent}: Similar \glqq{}coincidences\grqq{} in physics often indicated real effects masked by complications (e.g., solar neutrino problem)
	...
	\begin{experiment}[title=Testing the Coincidence]
		...
		\begin{enumerate}
			...
			\item Look for systematic trends in \glqq{}non-detections\grqq{} near the threshold
