...
\begin{document}
	...
	T0 implements a form of \glqq{}superdeterminism\grqq{}:
	...
	\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=T0 Superdeterminism]
		...
		\begin{itemize}
			\item Experimenter's \glqq{}choice\grqq{} of measurement direction
	...
	\begin{enumerate}
		\item \textbf{Measurement direction correlations}: Statistical bias in \glqq{}random\grqq{} measurement choices
	...
	\begin{itemize}
		...
		\item \glqq{}Hidden variables\grqq{} are the complete energy field configuration $\{\Efield(x,t)\}$
	\end{itemize}
	...
	\begin{itemize}
		...
		\item \glqq{}Random\grqq{} number generators exhibit systematic patterns
		\item Bell test \glqq{}loopholes\grqq{} become fundamental features rather than flaws
	\end{itemize}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\item **T0 prediction**: Subtle statistical biases in \glqq{}random\grqq{} choices
