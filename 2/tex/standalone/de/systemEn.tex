...
\begin{document}
	...
	\textbf{Physical interpretation}: Neutrinos are \glqq{}ghostly\grqq{} because their field excitations are so weak that they barely interact with matter. They represent the boundary between detectable particles and the vacuum state.
