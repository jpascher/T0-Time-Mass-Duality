...
Sommerfeld did not merely discover the value $\alpha_{EM}^{-1} \approx 137$ through neutral measurement, but actively sought **harmonic relationships** in atomic spectra. His approach was guided by the philosophical conviction that nature follows musical principles, as he expressed: \textit{\glqq{}The spectral lines follow harmonic laws, like the strings of an instrument\grqq{}} \cite{Sommerfeld1916}.
...
This historical context reveals that the apparent \glqq{}harmony\grqq{} in $\alpha_{EM}^{-1} = 137 \approx (6/5)^{27}$ (kleine Terz to the 27th power) is **not a cosmic discovery** but rather the result of Sommerfeld's harmonic expectations being embedded in the unit system definition.
...
What has been considered a \glqq{}fundamental natural constant\grqq{} for over a century is partially the product of:
\begin{itemize}
...
This recognition calls for a **critical reexamination** of which physical relationships represent fundamental natural laws versus artifacts of our measurement and definition history \cite{Weinberg1995, Parker2018}.
	...
	The current value of the fine structure constant $\alpha_{EM} \approx \frac{1}{137}$ is not \glqq{}wrong\grqq{}, but a consequence of our historical definitions of units. One could have originally defined the electromagnetic unit system so that $\alpha_{EM} = 1$ holds.
	...
	With natural units, all human-made units of measurement disappear, and physics looks \glqq{}simpler\grqq{}. The laws of nature themselves have no preferred units – those only come from us!
	...
	Such a theory would possibly revolutionize our understanding of nature and bring us closer to a \glqq{}theory of everything\grqq{} that derives the entire universe from a single fundamental principle.
