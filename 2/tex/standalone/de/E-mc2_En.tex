...
\begin{document}
	...
	\begin{abstract}
		This work reveals the central point of Einstein's relativity theory: E=mc² is mathematically identical to E=m. The only difference lies in Einstein's treatment of c as a \glqq{}constant\grqq{} instead of a dynamic ratio. By fixing c = 299,792,458 m/s, the natural time-mass duality T·m = 1 is artificially \glqq{}frozen,\grqq{} leading to apparent complexity. The T0 theory shows: c is not a fundamental law of nature, but only a ratio that must be variable if time is variable. Einstein's error was not E=mc² itself, but the constant-setting of c.
	\end{abstract}
	...
	\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=The Fundamental Recognition]
		...
		The only difference: Einstein treats c as a \glqq{}constant,\grqq{} although c is a dynamic ratio.
	...
	\textbf{Step 2}: Time becomes \glqq{}frozen\grqq{} by this
	\begin{equation}
		T = \frac{L}{c} = \frac{L}{\text{constant}} = \text{apparently determined}
	\end{equation}
	
	\textbf{Step 3}: Time dilation becomes \glqq{}mysterious effect\grqq{}
	\begin{equation}
	...
	\textbf{Einstein's constant-setting} \glqq{}freezes\grqq{} this natural variability artificially
	
	\textbf{Result}: One needs complicated theory to repair the \glqq{}frozen\grqq{} dynamics
	...
	\begin{itemize}
		...
		\item Artificial \glqq{}freezing\grqq{} of time dynamics
	...
	Einstein \glqq{}solves\grqq{} the contradiction through:
	\begin{itemize}
	...
	\textbf{If one defines $c^2$ as \glqq{}conversion factor\grqq{}}:
	\begin{equation}
		E = mc^2
	\end{equation}
	...
	\begin{tcolorbox}[colback=orange!5!white,colframe=orange!75!black,title=The Fundamental Choice Option]
		\textbf{One can choose what should be \glqq{}constant\grqq{}!}
	...
	\begin{itemize}
		\item \glqq{}Speed of light is universally constant\grqq{}
		\item \glqq{}Time dilates in strong gravitational fields\grqq{}
		\item \glqq{}Clocks run slower at high velocities\grqq{}
	\end{itemize}
	...
	\begin{itemize}
		\item \glqq{}Time flows equally everywhere\grqq{}
		\item \glqq{}Speed of light varies with location\grqq{}
		\item \glqq{}Light becomes slower in strong gravitational fields\grqq{}
	\end{itemize}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{|l|c|c|}
			...
			GPS correction & \glqq{}Clocks run differently\grqq{} & \glqq{}c is different\grqq{} \\
	...
	\begin{itemize}
		...
		\item \textbf{Aesthetics}: \glqq{}Universal constant\grqq{} sounded elegant
	...
	\textbf{T0 insight}:
	\begin{itemize}
		\item \textbf{Neither} c nor time are \glqq{}really\grqq{} constant
	...
	\section{When Something Becomes \glqq{}Constant\grqq{}}
	...
	\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=The Reference Point Illusion]
		\textbf{Something only becomes \glqq{}constant\grqq{} when we define a reference point!}
		
		\textbf{Without reference point}: All ratios are relative and dynamic
		
		\textbf{With reference point}: One ratio becomes artificially \glqq{}fixed\grqq{}
	...
	\textbf{All c-values are relative to each other}. None is \glqq{}constant\grqq{}.
	
	\subsection{The Moment of Reference Point Setting}
	
	\textbf{Einstein's fatal step}:
	\begin{equation}
		\text{\glqq{}I define: } c = 299,792,458 \text{ m/s = reference point\grqq{}}
	\end{equation}
	...
	\begin{itemize}
		...
		\item The \textbf{dynamic ratio} becomes a \glqq{}constant\grqq{}
		\item The \textbf{natural relativity} is artificially \glqq{}frozen\grqq{}
	\end{itemize}
	...
	\begin{itemize}
		...
		\item There is \textbf{no \glqq{}natural\grqq{} length unit} - only human agreements
		\item \textbf{Humans make c \glqq{}constant\grqq{} by definition} - not nature!
	\end{itemize}
	
	\subsection{The Circular Error: Humans Define Their Own \glqq{}Constants\grqq{}}
	...
	\textbf{This makes c automatically \glqq{}constant\grqq{}} - through human definition, not through natural law:
	\begin{equation}
		c = \frac{299,792,458 \text{ meters}}{1 \text{ second}} = 299,792,458 \text{ m/s}
	\end{equation}
	
	\textbf{Circular reasoning}: Humans define c as constant and then \glqq{}measure\grqq{} a constant!
	...
	\textbf{One cannot \glqq{}prove\grqq{} what one has defined!}
	...
	\textbf{Einstein's \glqq{}c-constancy\grqq{} was belief, not proof!}
	...
	\textbf{What is \glqq{}really\grqq{} real?}
	\begin{itemize}
	...
	\subsection{Why T0 is Still \glqq{}Better\grqq{}}
	
	\textbf{Not because of \glqq{}absolute truth,\grqq{} but because of}:
	...
	\textbf{T0 does NOT claim to be \glqq{}absolute truth.\grqq{}}
	
	\textbf{T0 only says}:
	\begin{itemize}
		\item \glqq{}Here is a \textbf{simpler} construct\grqq{}
		\item \glqq{}With \textbf{fewer} arbitrary assumptions\grqq{}
		\item \glqq{}That is \textbf{more consistent} than Einstein's construct\grqq{}
		\item \glqq{}And makes \textbf{more testable} predictions\grqq{}
	\end{itemize}
	...
	\textbf{By all these criteria T0 is \glqq{}better\grqq{} than Einstein - but not \glqq{}absolutely true\grqq{}.}
	...
	\subsection{Why E=mc² \glqq{}Works\grqq{}}
	
	\textbf{E=mc² works because}:
	\begin{itemize}
		\item It is mathematically identical to $E = m$
		\item $c^2$ compensates the \glqq{}frozen\grqq{} time dynamics
	...
	\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=The Fundamental Truth]
		...
		Einstein's \glqq{}constant\grqq{} c is in truth a variable ratio.
