% Chapter content extracted from Teilchenmassen_De.tex
...
\begin{abstract}
	...
	\subsubsection{Das Parameter-Problem des Standardmodells}
	...
	\subsubsection{Methodische Klarstellung: Etablierung vs. Vorhersage}
	...
	\subsubsection{Zwei-Phasen-Entwicklung}
	...
	\subsubsection{Historische Präzedenz erfolgreicher Muster-Physik}
	...
	\subsubsection{Die fundamentale Herausforderung}
	...
	\subsubsection{Quantenfeldtheoretische Herleitung der $\xi$-Konstante}
	\label{sec:qft_herleitung}
	
	\subsubsection{EFT-Matching und Yukawa-Kopplung nach EWSB}
	...
	\subsubsection{T0-Operatoren in der effektiven Feldtheorie}
	...
	\subsubsection{1-Loop-Matching-Rechnung}
	...
	\subsubsection{Finale $\xi$-Formel aus Higgs-Physik}
	...
	\subsubsection{Universelle Teilchenmassen-Systematik}
	\label{sec:universal_masses}
	
	\subsubsection{Überarbeitete Universaltabelle der Fermionen}
	...
	\subsubsection{Vollständige numerische Rekonstruktion}
	...
	\subsubsection{Grundlagen und experimentelle Eingangsdaten}
	...
	\subsubsection{Geladene Leptonen: Detaillierte Berechnungen}
	...
	\subsubsection{Vollständige Neutrino-Behandlung}
	...
	\subsubsection{Neutrino-Quantenzahlen}
	...
	\subsubsection{Doppelte $\xi$-Unterdrückungsmechanismus}
	...
	\subsubsection{Vollständige Quark-Analyse mit beiden Methoden}
	\label{sec:quark_analyse}
	
	\subsubsection{Explizite Berechnungen der Quarkmassen}
	...
	\subsubsection{Korrektur für das Charm-Quark}
	...
	\subsubsection{Umfassende experimentelle Validierung}
	\label{sec:comprehensive_validation}
	
	\subsubsection{Vollständige Genauigkeitsanalyse}
	...
	\subsubsection{Vorhersagekraft des etablierten Systems}
	\label{sec:vorhersagekraft}
	
	\subsubsection{Neue Teilchen-Generationen}
	...
	\subsubsection{Quark-Sektor Extrapolation}
	...
	\subsubsection{Korrigierte Interpretation der mathematischen Äquivalenz}
	...
	\subsubsection{Transformationsbeziehung als Brücke}
	...
	\subsubsection{Experimentelle Vorhersagen und Präzisionstests}
	\label{sec:experimentelle_vorhersagen}
	
	
	\subsubsection{Modifizierte QED-Vertex-Korrekturen}
	...
	\subsubsection{Neutrino-Validierung}
	...
	\subsubsection{Wissenschaftliche Legitimität und methodische Fundierung}
	\label{sec:wissenschaftliche_legitimitaet}
	
	\subsubsection{Umkehrbarkeit des etablierten Systems}
	...
	\subsubsection{Experimentelle Testbarkeit}
	...
	\subsubsection{Parameterfreie Natur und universelle Struktur}
	...
	\subsubsection{Universelle Quantenzahlen-Tabelle}
	...
	\subsubsection{Kritische Bewertung und Limitationen}
	...
	\subsubsection{Abschließende Bewertung}
	\label{sec:abschliessende_bewertung}
	
	\subsubsection{Wissenschaftlicher Status}
	...
	\subsubsection{Bedeutung für die fundamentale Physik}
