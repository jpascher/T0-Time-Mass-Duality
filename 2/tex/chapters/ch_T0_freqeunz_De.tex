% Chapter content extracted from T0_freqeunz_De.tex
...
\begin{abstract}
	...
	\subsubsection{Theoretische Grundlage in T0: Warum unabhängig?}
	...
	\subsubsection{Non-Perturbative Lösung der T0-Feldgleichung}
	...
	\subsubsection{Ausführliche Nachrechnung: Non-Perturbative Code-Simulation}
	...
	\subsubsection{Vergleich: Perturbativ vs. Non-Perturbativ}
	...
	\subsubsection{Praktische Implikationen für T0-Berechnungen}
	...
	\subsubsection{Fazit: Konsistenz durch Non-Perturbative Methoden bestätigt}
	...
	\subsubsection{Was bedeutet es de facto, dass keine Frequenzabhängigkeit der Rotverschiebung nachweisbar ist?}
	...
	\subsubsection{Grundlagen: Was ist Frequenzabhängigkeit der Rotverschiebung?}
	...
	\subsubsection{Ist sie de facto nachweisbar? – Die Evidenz sagt: Nein, sie existiert nicht (im Standard-Sinn)}
	...
	\subsubsection{Implikationen für T0 und Alternativmodelle}
