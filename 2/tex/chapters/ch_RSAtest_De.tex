% Chapter content extracted from RSAtest_De.tex
...
\begin{abstract}
	...
	\subsubsection{Getestete Algorithmen}
	...
	\subsubsection{Testkonfiguration}
	...
	\subsubsection{T0-Framework Machbarkeitsdemonstation}
	
	\subsubsection{Zweck der Implementierung}
	...
	\subsubsection{Implementierungskomponenten}
	...
	\subsubsection{Adaptive $\xi$-Strategien}
	...
	\subsubsection{Resonanzberechnung}
	...
	\subsubsection{Experimentelle Ergebnisse: Machbarkeitsnachweis}
	...
	\subsubsection{Erfolgsraten nach Algorithmus}
	...
	\subsubsection{Periodenbasierte Faktorisierung: T0, Pollard Rho und Shors Algorithmus}
	
	\subsubsection{Vergleich der Periodenfindungsansätze}
	...
	\subsubsection{Gemeinsames Periodenfindungsprinzip}
	...
	\subsubsection{Theoretische Komplexitätsanalyse}
	...
	\subsubsection{Der gemeinsame polynomiale Vorteil}
	...
	\subsubsection{Das Implementierungsparadoxon}
	...
	\subsubsection{Philosophische Implikationen: Information und Determinismus}
	
	\subsubsection{Intrinsische mathematische Information}
	...
	\subsubsection{Vibrationsmodi und prädiktive Muster}
	...
	\subsubsection{Das begrenzte Universum der Schwingungen}
	...
	\subsubsection{Neuronale Netzwerk-Implikationen: Lernen mathematischer Muster}
	
	\subsubsection{Maschinelles Lernpotenzial}
	...
	\subsubsection{Trainingsdatenstruktur}
	...
	\subsubsection{Lernen mathematischer Invarianten}
	...
	\subsubsection{Verfügbare Methoden}
	...
	\subsubsection{Testprogramm-Suite}
	
	\subsubsection{easy\_test\_cases.py}
	...
	\subsubsection{borderline\_test\_cases.py}
	...
	\subsubsection{impossible\_test\_cases.py}
	...
	\subsubsection{automatic\_xi\_optimizer.py}
	...
	\subsubsection{focused\_xi\_tester.py}
	...
	\subsubsection{t0\_uniqueness\_test.py}
	...
	\subsubsection{xi\_strategy\_debug.py}
	...
	\subsubsection{updated\_impossible\_tests.py}
	...
	\subsubsection{Interaktive Werkzeuge}
	
	\subsubsection{xi\_explorer\_tool.html}
	...
	\subsubsection{Experimentelles Protokoll}
	
	\subsubsection{Standard-Testkonfiguration}
	...
	\subsubsection{Kernforschungsergebnisse}
	
	\subsubsection{Revolutionäre $\xi$-Optimierungsergebnisse}
	...
	\subsubsection{Algorithmische Grenzen}
	...
	\subsubsection{Akademische Forschung}
	\begin{itemize}
	...
	\subsubsection{Kryptographische Analyse}
	\begin{itemize}
	...
	\subsubsection{Bildungsdemonstration}
	\begin{itemize}
	...
	\subsubsection{Neuronale Netzwerkintegration}
	...
	\subsubsection{Quantenalgorithmussimulation}
