% Chapter content extracted from Markov_De.tex
...
\begin{abstract}
	...
	\subsubsection{Einführung: Die Illusion des Determinismus in diskreten Welten}
	\label{sec:intro}
	...
	\subsubsection{Diskrete Zustände: Die Grundlage des scheinbaren Determinismus}
	\label{sec:discrete}
	
	\subsubsection{Quantisierte Voraussetzungen}
	...
	\subsubsection{Probabilistische Übergänge: Der stochastische Kern}
	\label{sec:probabilistic}
	
	\subsubsection{Epistemische vs. ontische Zufälligkeit}
	...
	\subsubsection{Übergangsmatrix als Mustervorlage}
	...
	\subsubsection{Mustergenerkennung: Vom Chaos zur Ordnung}
	\label{sec:patterns}
	
	\subsubsection{Extrahieren von Vorlagen}
	...
	\subsubsection{Grenzen der Muster}
	Sogar starke Muster scheitern bei Neuheit (z. B. Schwarze Schwäne). Voraussetzungen evolieren; Stochastik puffert dies.
	
	\subsubsection{Verbindungen zur T0-Theorie: Fraktale Muster und deterministische Dualität}
	...
	\subsubsection{Diskrete Zustände als quantisierte Feldknoten}
	...
	\subsubsection{Muster als geometrische Vorlagen in $\xi$-Dualität}
	...
	\subsubsection{Von epistemischer Stochastik zu ontischem Determinismus}
	...
	\subsubsection{Schluss: Deterministisches Herz, stochastisches Schleier}
	...
	\appendix
	\subsubsection{Beispiel: Simulation einer einfachen Markov-Kette}
