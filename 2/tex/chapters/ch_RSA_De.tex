% Chapter content extracted from RSA_De.tex
...
\begin{abstract}
	...
	\subsubsection{Theoretisches Framework}
	...
	\subsubsection{Wellenartiges Verhalten von T0-Feldern}
	...
	\subsubsection{Mediumabhängige Eigenschaften}
	...
	\subsubsection{Randbedingungen und Reflexionen}
	...
	\subsubsection{Hyperbolische Geometrie im Dualitätsraum}
	...
	\subsubsection{Atomskalige T0-Feld-Parameter}
	...
	\subsubsection{T0-Shor Algorithmus-Formulierung}
	
	\subsubsection{Geometrisches Hohlraum-Design für Periodenfindung}
	...
	\subsubsection{Multi-Moden-Resonanzanalyse}
	...
	\subsubsection{Selbstverstärkende $\xipar$-Optimierung: Die Fehlerreduktions-Rückkopplungsschleife}
	
	\subsubsection{Die fundamentale Entdeckung: Rechenfehler verschlechtern $\xipar$}
	...
	\subsubsection{Mathematisches Modell der Rückkopplungsschleife}
	...
	\subsubsection{Vakuum-abgeleitete Atomparameter: Keine freien Parameter}
	
	\subsubsection{Fundamentale Parameter-Ableitung}
	...
	\subsubsection{$\xipar$ als multifunktionaler Parameter: Jenseits einfacher Kopplung}
	
	\subsubsection{Multiple versteckte Funktionen von $\xipar$}
	...
	\subsubsection{$\xipar$-induzierte Berechnungsasymmetrien}
	...
	\subsubsection{$\xipar$-Gedächtnis und Geschichtsabhängigkeit}
	...
	\subsubsection{Dimensionale Skalierung: Fundamentale Unterschiede zwischen 2D und 3D}
	
	\subsubsection{Wellenausbreitungs-Skalierungsgesetze}
	...
	\subsubsection{Kritische Dimensionsschwellenwerte}
	...
	\subsubsection{Algorithmische Leistungsskalierung}
	...
	\subsubsection{Die fundamentale Natur von Zahlen und Primstruktur}
	
	\subsubsection{Primzahlen als das Gerüst der Mathematik}
	...
	\subsubsection{Kritische Bewertung: Warum T0-Shor nur für kleine Zahlen funktioniert}
	
	\subsubsection{Die Präzisionsbarriere}
	...
	\subsubsection{Die Präzisionsbarriere und Skalierungslimitationen}
	...
	\subsubsection{Vergleich mit bestehenden Methoden}
