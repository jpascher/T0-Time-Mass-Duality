% Chapter content extracted from T0_Geometrische_Kosmologie_De.tex
...
\thispagestyle{fancy}
	...
	\subsubsection{Einleitung: Das Problem der Rotverschiebung neu gestellt}
	...
	\subsubsection{Geodätische Pfade und Ray-Tracing}
	...
	\subsubsection{Ergebnisse: Rotverschiebung als geometrische Pfadstreckung}
	
	\subsubsection{Die effektive Pfadlänge}
	...
	\subsubsection{Frequenzunabhängigkeit als Beweis der Geometrie}
	...
	\subsubsection{Quantitative Herleitung der Hubble-Konstante}
	...
	\subsubsection{Schlussfolgerung: Eine neue Kosmologie}
	...
	\newpage
	\subsubsection*{Anhang: Python-Code der Simulation}
