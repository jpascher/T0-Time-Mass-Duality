% Chapter content extracted from T0_Neutrinos_De.tex
...
\subsubsection{Preamble: Scientific Honesty}
...
\subsubsection{Neutrinos as ``Almost Massless Photons'': The T0 Photon Analogy}
...
\subsubsection{Photon-Neutrino Correspondence}
...
\subsubsection{The Double $\xi_0$-Suppression}
...
\subsubsection{Physical Justification of the Photon Analogy}
...
\subsubsection{The Standard Model Problem}
...
\subsubsection{Geometric Phases as Oscillation Mechanism}
...
\subsubsection{Quantum Number Assignment for Neutrinos}
...
\subsubsection{Integration der Koide-Relation: Eine schwache Hierarchie}
...
\subsubsection{Direct Mass Determination}
...
\subsubsection{Target Value Estimation}
...
\subsubsection{Structure Formation and Big Bang Nucleosynthesis}
...
\subsubsection{Summary and Critical Evaluation}

\subsubsection{The Central T0 Neutrino Hypotheses}
...
\subsubsection{Comparison with Established T0 Predictions}
...
\subsubsection{Experimental Tests and Falsification}
...
\subsubsection{Limits and Open Questions}

\subsubsection{Fundamental Theoretical Problems}
...
\subsubsection{Methodological Reflection}

\subsubsection{Scientific Integrity vs. Theoretical Speculation}
...
\subsubsection{Significance for the T0 Series}
