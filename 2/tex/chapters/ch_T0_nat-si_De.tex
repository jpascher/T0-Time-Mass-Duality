% Chapter content extracted from T0_nat-si_De.tex
...
\begin{abstract}
	...
	\subsubsection{Grundprinzip der natürlichen Einheiten}
	\label{sec:grundprinzip}
	
	\subsubsection{Das Prinzip der Dimensionsreduktion}
	...
	\subsubsection{Mathematische Konsequenz}
	...
	\subsubsection{Vorteile für Berechnungen}
	
	\subsubsection{Vereinfachte Formeln}
	...
	\subsubsection{Dimensionsanalyse wird transparent}
	...
	\subsubsection{In der T0-Theorie besonders relevant}
	
	\subsubsection{Geometrische Natur der Konstanten}
	...
	\subsubsection{Der $\xi$-Parameter als fundamentaler Geometriefaktor}
	Die Herleitung:
	\begin{equation}
	...
	\subsubsection{Herleitung des fundamentalen Skalierungsfaktors $S_{T0}$}
	\label{sec:scaling-derivation}
	
	\subsubsection{Die fundamentale Vorhersage der T0-Theorie}
	...
	\subsubsection{Explizite Demonstration: Herleitung vs. Rückrechnung}
	...
	\subsubsection{Warum dies keine Zirkelschluss ist}
	...
	\subsubsection{Der Zufall, der keiner ist}
	...
	\subsubsection{Die tiefgreifende Implikation}
	...
	\subsubsection{Unabhängige Verifikation}
	...
	\subsubsection{Quantisierte Massenberechnung in der T0-Theorie}
	
	\subsubsection{Fundamentales Massenquantisierungsprinzip}
	...
	\subsubsection{Elektronenmasse als Referenz}
	...
	\subsubsection{Vollständiges Teilchenmassenspektrum}
	...
	\subsubsection{Wichtig: Explizite SI-Einheiten sind notwendig bei\dots}
	\label{sec:si-notwendig}
	
	\subsubsection{1. Experimenteller Überprüfung}
	...
	\subsubsection{2. Technologische Anwendungen}
	\begin{itemize}
	...
	\subsubsection{3. Interdisziplinäre Kommunikation}
	\begin{itemize}
	...
	\subsubsection{Konkrete Umrechnung in der T0-Theorie}
	\label{sec:umrechnung}
	
	\subsubsection{Beispiel: Elektronenmasse}
	...
	\subsubsection{Die fundamentale Skalierungsbeziehung}
	...
	\subsubsection{Korrekte Energie-Skala für die Feinstrukturkonstante}
	...
	\subsubsection{Integration der fraktalen Renormierung in natürliche Einheiten}
	...
	\subsubsection{Warum passen die Formeln in natürlichen Einheiten ohne fraktale Renormierung?}
	...
	\subsubsection{Warum ist fraktale Renormierung für exakte SI-Umrechnungen notwendig?}
	...
	\subsubsection{Mathematische Spezifikation der fraktalen Renormierung}
	...
	\subsubsection{Vergleich: Approximation vs. Exaktheit}
	...
	\subsubsection{Fazit: Die Dualität von geometrischer Idealisierung und physikalischer Messung}
	...
	\subsubsection{Wichtige konzeptionelle Klarstellungen}
	...
	\subsubsection{Besondere Bedeutung für die T0-Theorie}
	
	\subsubsection{Die tiefere Einsicht}
	...
	\appendix
	\subsubsection{Formelzeichen und Symbole}
	...
	\subsubsection{Fundamentale Zusammenhänge}
	...
	\subsubsection{Umrechnungsfaktoren}
