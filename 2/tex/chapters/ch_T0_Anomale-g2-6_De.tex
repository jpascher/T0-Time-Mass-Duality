% Chapter content extracted from T0_Anomale-g2-6_De.tex
...
\thispagestyle{fancy}
	...
	\subsubsection*{Symboleverzeichnis}
	...
	\subsubsection{Geometrische Ableitung der Torsionsmediator-Masse $m_T$}
	...
	\subsubsection{Feynman-Schleifenintegral -- Vollständige Entwicklung (Vektoriell)}
	...
	\subsubsection{Generalisierte Formel}
	Substitution ergibt:
	\begin{equation}
	...
	\subsubsection{Numerische Berechnung (für Myon)}
	...
	\subsubsection{Ergebnisse für alle Leptonen}
	...
	\subsubsection{Einbettung für Myon g-2 und Vergleich mit String-Theorie}
	\subsubsection{Ableitung der Einbettung für Myon g-2}
	...
	\appendix
	\subsubsection{Anhang: Umfassende Analyse der anomalen magnetischen Momente von Leptonen in der T0-Theorie}
	...
	\subsubsection{Erweiterte Vergleichstabelle: T0 in zwei Perspektiven (e, $\mu$, $\tau$)}
	...
	\subsubsection{Unsicherheiten: Warum SM Bereiche hat, T0 exakt?}
	...
	\subsubsection{Warum Hybrid Pre-2025 für Myon funktionierte, aber Reine für Elektron inkonsistent schien?}
	...
	\subsubsection{Einbettungsmechanismus: Auflösung der Elektron-Inkonsistenz}
	...
	\subsubsection{Prototyp-Vergleich: Sept. 2025 vs. Aktuell}
