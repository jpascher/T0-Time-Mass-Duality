% Chapter content extracted from T0_7-fragen-3_De.tex
...
\begin{abstract}
	...
	\end{abstract}
	\newpage
	\subsubsection{Die fundamentalen T0-Parameter}
	\subsubsection{Definition der Basisgrößen}
	...
	\end{equation}
	\subsubsection{Rätsel 2: Die Koide-Formel}
	...
	\end{align}
	\subsubsection{Exakte Koide-Relation}
	\textbf{Koide-Formel:}
	\begin{align}
	...
	\subsubsection{Rätsel 1: Proton-Elektron-Massenverhältnis}
	\subsubsection{Quark-Parameter der T0-Theorie}
	...
	\end{align}
	\subsubsection{Proton-Massenverhältnis}
	...
	\subsubsection{Rätsel 3: Planck-Masse und kosmologische Konstante}
	\subsubsection{Gravitationskonstante aus $\xi$}
	...
	\subsubsection{Rätsel 4: MOND-Beschleunigungsskala}
	\subsubsection{Herleitung aus $\xi$}
	...
	\subsubsection{Rätsel 5: Dunkle Energie und Dunkle Materie}
	\subsubsection{Energiedichte-Verhältnis}
	...
	\subsubsection{Abgeleitete Natur in der T0-Theorie}
	...
	\subsubsection{Rätsel 6: Das Flachheitsproblem}
	\subsubsection{Lösung im $\xi$-Universum}
	...
	\subsubsection{Rätsel 7: Vakuum-Metastabilität}
	...
	\subsubsection{Zusammenfassung der exakten Vorhersagen}
	\begin{table}[htbp]
		\centering
	...
	\end{table}
	\subsubsection{Die universelle $\xi$-Geometrie}
	\subsubsection{Fundamentale Einsicht}
	...
	\end{align}
	\subsubsection{Die Hierarchie der $\xi$-Kopplung}
	...
	\end{itemize}
	\subsubsection{Erklärung der Symbole}
	...
	\appendix
	\subsubsection{Herleitung von $v$, $G_F$ und $\alpha$ in der T0-Theorie}
	\subsubsection{Die Herleitung des Higgs-Vakuumerwartungswerts $v$}
	...
	\subsubsection{Die Herleitung der Fermi-Kopplungskonstante $G_F$}
	...
	\subsubsection{Die Herleitung der Feinstrukturkonstante $\alpha$}
	...
	\subsubsection{Zusammenhang zwischen $v$, $G_F$ und $\alpha$}
