% Chapter content extracted from cosmic_De.tex
...
\begin{abstract}
	...
	\subsubsection{Einf\"uhrung: Die universelle $\xi$-Konstante}
	
\subsubsection{Grundlagen der T0-Theorie}
...
\end{tcolorbox}
	...
	\subsubsection{Zeit-Energie-Dualität als Fundament}
	...
	\subsubsection{Kosmische Mikrowellenhintergrundstrahlung (CMB)}
	
	\subsubsection{CMB ohne Urknall: $\xi$-Feld-Mechanismen}
	...
	\subsubsection{CMB-Energiedichte und $\xi$-Längenskala}
	...
	\subsubsection{Kosmische Rotverschiebung ohne Expansion}
	
	\subsubsection{$\xi$-Feld-Energieverlust-Mechanismus}
	...
	\subsubsection{Präzisionsmessungen der Gravitationskonstante}
	...
	\subsubsection{Casimir-Kraft-Anomalien}
	...
	\subsubsection{Elektromagnetische Resonanz}
	...
	\subsubsection{Parameterreduktion}
	...
	\subsubsection{Das Vakuum ist das $\xi$-Feld}
