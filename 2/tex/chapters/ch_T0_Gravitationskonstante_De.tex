% Chapter content extracted from T0_Gravitationskonstante_De.tex
...
\begin{abstract}
	...
	\subsubsection{Einleitung: Gravitation in der T0-Theorie}
	
	\subsubsection{Das Problem der Gravitationskonstanten}
	...
	\subsubsection{Überblick der Herleitung}
	...
	\subsubsection{Die fundamentale T0-Beziehung}
	...
	\subsubsection{Auflösung nach der Gravitationskonstante}
	...
	\subsubsection{Wahl der charakteristischen Masse}
	...
	\subsubsection{Dimensionsanalyse in natürlichen Einheiten}
	
	\subsubsection{Einheitensystem der T0-Theorie}
	...
	\subsubsection{Dimensionale Konsistenz der Grundformel}
	...
	\subsubsection{Der erste Umrechnungsfaktor: Dimensionskorrektur}
	
	\subsubsection{Ursprung des Korrekturfaktors}
	...
	\subsubsection{Physikalische Bedeutung von $E_{\text{char}}$}
	...
	\subsubsection{Herleitung der charakteristischen Energieskala}
	...
	\subsubsection{Stufe 1: Fundamentale Referenzenergie}
	...
	\subsubsection{Stufe 2: Fraktales Skalenverhältnis}
	...
	\subsubsection{Stufe 3: Erste Resonanzstufe}
	...
	\subsubsection{Stufe 4: Geometrischer Korrekturfaktor}
	...
	\subsubsection{Stufe 5: Vorläufiger Wert}
	...
	\subsubsection{Stufe 6: Fraktale Renormierung}
	...
	\subsubsection{Stufe 7: Endgültiger Wert}
	...
	\subsubsection{Konsistenz mit der Gravitationskonstanten}
	...
	\subsubsection{Fraktale Korrekturen}
	
	\subsubsection{Die fraktale Raumzeitdimension}
	...
	\subsubsection{Auswirkung auf die Gravitationskonstante}
	...
	\subsubsection{Der zweite Umrechnungsfaktor: SI-Konversion}
	
	\subsubsection{Von natürlichen zu SI-Einheiten}
	...
	\subsubsection{Physikalische Bedeutung des Konversionsfaktors}
	...
	\subsubsection{Zusammenfassung aller Komponenten}
	
	\subsubsection{Vollständige T0-Formel}
	...
	\subsubsection{Vereinfachte Darstellung}
	...
	\subsubsection{Schritt-für-Schritt-Berechnung}
	...
	\subsubsection{Experimenteller Vergleich}
	...
	\subsubsection{Konsistenzprüfung der fraktalen Korrektur}
	
	\subsubsection{Unabhängigkeit der Massenverhältnisse}
	...
	\subsubsection{Konsequenzen für die Theorie}
	...
	\subsubsection{Bedeutung der Formelstruktur}
	...
	\subsubsection{Vergleich mit Einstein'scher Gravitation}
	...
	\subsubsection{Theoretische Konsequenzen}
	
	\subsubsection{Modifikationen der Newton'schen Gravitation}
	...
	\subsubsection{Wichtigkeit expliziter Umrechnungsfaktoren}
	...
	\subsubsection{Bedeutung für die theoretische Physik}
