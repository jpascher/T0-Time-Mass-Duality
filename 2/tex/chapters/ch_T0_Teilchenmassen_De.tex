% Chapter content extracted from T0_Teilchenmassen_De.tex
...
\begin{abstract}
	...
	\subsubsection{Einleitung: Das Massenproblem des Standardmodells}
	
	\subsubsection{Die Willkürlichkeit der Standardmodell-Massen}
	...
	\subsubsection{Die T0-Revolution}
	...
	\subsubsection{Die beiden T0-Berechnungsmethoden}
	
	\subsubsection{Konzeptuelle Unterschiede}
	...
	\subsubsection{Mathematische Äquivalenz}
	...
	\subsubsection{Quantenzahlen-Zuordnung}
	
	\subsubsection{Die universelle T0-Quantenzahl-Struktur}
	...
	\subsubsection{Vollständige Quantenzahl-Tabelle}
	...
	\subsubsection{Methode 1: Direkte geometrische Berechnung}
	
	\subsubsection{Die fundamentale Massenformel}
	...
	\subsubsection{Beispielrechnungen: Geladene Leptonen}
	...
	\subsubsection{Methode 2: Erweiterte Yukawa-Kopplungen}
	
	\subsubsection{T0-Higgs-Mechanismus}
	...
	\subsubsection{Geometrische Yukawa-Kopplungen}
	...
	\subsubsection{Äquivalenz-Verifikation}
	
	\subsubsection{Mathematischer Beweis der Äquivalenz}
	...
	\subsubsection{Physikalische Bedeutung der Äquivalenz}
	...
	\subsubsection{Genauigkeitsanalyse für etablierte Teilchen}
	...
	\subsubsection{Detaillierte Teilchen-für-Teilchen Vergleiche}
	...
	\subsubsection{Besonderheit: Neutrino-Massen}
	
	\subsubsection{Warum Neutrinos eine Spezialbehandlung benötigen}
	...
	\subsubsection{Systematische Fehleranalyse}
	
	\subsubsection{Quellen der Abweichungen}
	...
	\subsubsection{Fundamentale Unterschiede}
	...
	\subsubsection{Vorteile der T0-Massentheorie}
	...
	\subsubsection{Theoretische Konsequenzen und Ausblick}
	
	\subsubsection{Implikationen für die Teilchenphysik}
	...
	\subsubsection{Die zentralen Erkenntnisse}
