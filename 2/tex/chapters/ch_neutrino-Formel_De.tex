% Chapter content extracted from neutrino-Formel_De.tex
...
\begin{abstract}
	...
	\subsubsection{Präambel: Wissenschaftliche Ehrlichkeit}
	...
	\subsubsection{Neutrinos als ''fast-masselose Photonen'': Die T0-Photon-Analogie}
	...
	\subsubsection{Photon-Neutrino-Korrespondenz}
	...
	\subsubsection{Doppelte \(\xipar\)-Suppression aus Photon-Analogie}
	...
	\subsubsection{Neutrino-Oszillationen}
	...
	\subsubsection{Geometrische Phasen als Oszillationsmechanismus}
	...
	\subsubsection{Fundamentale Konstanten und Einheiten}
	
	\subsubsection{Basis-Parameter}
	...
	\subsubsection{Einheiten-Konventionen}
	...
	\subsubsection{Geladene Lepton-Referenzmassen}
	
	\subsubsection{Präzise experimentelle Werte (PDG 2024)}
	...
	\subsubsection{Neutrino-Quantenzahlen (T0-Hypothese)}
	
	\subsubsection{Postulierte Quantenzahl-Zuordnung}
	...
	\subsubsection{Geometrische Faktoren}
	...
	\subsubsection{Neutrino-Masse-Formel}
	
	\subsubsection{T0-Hypothese: Gleiche Massen mit Geometrischen Phasen}
	...
	\subsubsection{Plausibler Zielwert basierend auf empirischen Daten}
	
	\subsubsection{Ableitung aus Messdaten}
	...
	\subsubsection{Experimentelle Vergleichsgrößen}
	
	\subsubsection{Aktuelle experimentelle Obergrenzen (2025)}
	...
	\subsubsection{Sicherheitsmargen für T0-Hypothese}
	...
	\subsubsection{Konsistenz-Checks und Validierung}
	
	\subsubsection{Dimensionale Analyse}
