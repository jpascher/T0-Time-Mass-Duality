% Chapter content extracted from Zusammenfassung_De.tex
...
\begin{abstract}
	...
	\subsubsection{Einführung: Die Vision einer vereinheitlichten Physik}
	...
	\subsubsection{Die geometrische Konstante $\xipar$: Das Fundament der Realität}
	
	\subsubsection{Was ist diese mysteriöse Zahl?}
	...
	\subsubsection{Warum ist diese Zahl so wichtig?}
	...
	\subsubsection{Das universale Energiefeld: Die einzige fundamentale Entität}
	
	\subsubsection{Alles ist Energie -- aber anders als Sie denken}
	...
	\subsubsection{Wie wird aus Energie ein Elektron?}
	...
	\subsubsection{Quantenmechanik neu interpretiert: Determinismus statt Wahrscheinlichkeit}
	
	\subsubsection{Das Ende des Zufalls?}
	...
	\subsubsection{Die Unschärferelation -- neu verstanden}
	...
	\subsubsection{Schrödingers Katze lebt -- und ist tot}
	...
	\subsubsection{Quantencomputing-Äquivalenz}
	...
	\subsubsection{Von 4×4-Matrizen zu geometrischen Mustern}
	...
	\subsubsection{Teilchen und Antiteilchen}
	...
	\subsubsection{Die Lösung des Hierarchieproblems}
	...
	\subsubsection{Renormierung und Divergenzen}
	...
	\subsubsection{CPT-Theorem und Symmetrien}
	...
	\subsubsection{Der Ursprung der Naturkonstanten}
	...
	\subsubsection{Experimentelle Bestätigungen und Vorhersagen}
	
	\subsubsection{Der spektakuläre Erfolg beim Myon}
	...
	\subsubsection{Was wir noch testen können}
	...
	\subsubsection{Warum diese Tests wichtig sind}
	...
	\subsubsection{Die vollständige Parameterableitung}
	
	\subsubsection{Hierarchisches Ableitungssystem}
	...
	\subsubsection{Die mathematische Struktur der Vereinheitlichung}
	
	\subsubsection{Von drei Theorien zu einer}
	...
	\subsubsection{Emergenz der Quanteneigenschaften}
	...
	\subsubsection{Die Hierarchie der Energieskalen}
	...
	\subsubsection{Kosmologische Implikationen: Ein ewiges Universum}
	
	\subsubsection{Kein Urknall -- kein Ende}
	...
	\subsubsection{Die kosmische Hintergrundstrahlung -- anders erklärt}
	...
	\subsubsection{Dunkle Materie und Dunkle Energie -- überflüssig}
	...
	\subsubsection{Ein zyklisches Universum}
	...
	\subsubsection{Die Vereinheitlichung von Quantenmechanik, Quantenfeldtheorie und Relativität}
	
	\subsubsection{Das große Puzzle der modernen Physik}
	...
	\subsubsection{Ein Feld für alles}
	...
	\subsubsection{Gravitation ohne Gravitonen}
	...
	\subsubsection{Warum passen plötzlich alle Puzzleteile zusammen?}
	...
	\subsubsection{Quantengravitation -- das gelöste Problem}
	...
	\subsubsection{Philosophische und konzeptuelle Bedeutung}
	
	\subsubsection{Die Rückkehr zum Determinismus}
	...
	\subsubsection{Die Natur der Realität}
	...
	\subsubsection{Einfachheit als fundamentales Prinzip}
	...
	\subsubsection{Vergleich mit dem Standardmodell}
	...
	\subsubsection{Kritische Würdigung und offene Fragen}
	
	\subsubsection{Stärken des Modells}
	...
	\subsubsection{Zusammenfassung: Eine neue Sicht auf die Realität}
	
	\subsubsection{Was das T0-Modell leistet}
	...
	\subsubsection{Eine neue Philosophie der Natur}
	...
	\subsubsection{Der Weg nach vorn}
