% Chapter content extracted from universale-ableitung_De.tex
...
\begin{abstract}
	...
	\subsubsection{Einf\"uhrung und Grundprinzip}
	
	\subsubsection{Das Minimalprinzip der Physik}
	...
	\subsubsection{SI-Basisdefinitionen}
	...
	\subsubsection{Herleitung der fundamentalen Konstanten}
	...
	\subsubsection{Vakuum-Permittivit\"at $\varepsilon_0$}
	...
	\subsubsection{Vollst\"andige Planck-Einheiten}
	...
	\subsubsection{Compton-Wellenl\"ange des Elektrons}
	...
	\subsubsection{Konsistenzpr\"ufung der Gravitationskonstante}
	...
	\subsubsection{Konsistenzpr\"ufung von $\hbar$}
	...
	\subsubsection{Die charakteristische Energie E\_0 und T0-Theorie}
	
	\subsubsection{Definition der charakteristischen Energie}
	...
	\subsubsection{Numerische Auswertung mit verschiedenen Pr\"azisionsstufen}
	...
	\subsubsection{Pr\"azise Feinstrukturkonstanten-Berechnung}
	...
	\subsubsection{Vergleich der Berechnungsgenauigkeit}
	...
	\subsubsection{Detaillierte Berechnung mit E\_0 = \SI{7.398}{\MeV}}
	...
	\subsubsection{Erkl\"arung der optimalen Pr\"azision}
	
	\subsubsection{Warum E\_0 = \SI{7.398}{\MeV} optimal funktioniert}
	...
	\subsubsection{Die mathematische Begr\"undung}
	...
	\subsubsection{Vergleich mit alternativen Ans\"atzen}
	
	\subsubsection{Sch\"atzung mit T0-berechneten Massen}
	...
	\subsubsection{Korrekte Interpretation}
	...
	\subsubsection{Dimensionale Konsistenz der E\_0-Formel}
	
	\subsubsection{Korrekte dimensionslose Formulierung}
	...
	\subsubsection{Alternative Schreibweise}
	...
	\subsubsection{Fazit der E\_0-Klarstellung}
	...
	\subsubsection{Das Kernprinzip der Verh\"altnisse}
	...
	\subsubsection{Was KEINE Korrektur ben\"otigt}
	...
	\subsubsection{Was Korrektur ben\"otigt}
	...
	\subsubsection{Entkr\"aftung der Zirkularit\"ats-Einw\"ande}
	
	\subsubsection{Die scheinbaren Zirkularit\"ats-Einw\"ande}
	...
	\subsubsection{Aufl\"osung der scheinbaren Zirkularit\"at}
	...
	\subsubsection{Die wahre Hierarchie}
	...
	\subsubsection{Experimentelle Best\"atigung der Nicht-Zirkularit\"at}
	...
	\subsubsection{Mathematischer Nachweis der Nicht-Zirkularit\"at}
	...
	\subsubsection{Das philosophische Argument}
	...
	\subsubsection{Zusammenfassung: Warum der Zirkularit\"ats-Einwand nicht zutrifft}
	...
	\subsubsection{Zusammenfassung und Ergebnisse}
	
	\subsubsection{Die fundamentale Hierarchie}
	...
	\subsubsection{Kernerkenntnisse}
	...
	\subsubsection{Weiterf\"uhrende \"Uberlegungen}
	...
	\subsubsection{Gesamtfazit: Vollst\"andige Integration}
