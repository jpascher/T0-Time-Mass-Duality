% Chapter content extracted from parameterherleitung_De.tex
...
\subsubsection{Herleitung aus fundamentaler Geometrie}
...
Der $10^{-4}$-Faktor entsteht aus: **QFT-Loop-Suppression** ($\sim 10^{-3}$) **×** **T0-Higgs-Sektor-Suppression** ($\sim 10^{-1}$) **=** $10^{-4}$.
	\subsubsection{Der Massenskalierungsexponent $\kappa$}
	...
	\subsubsection{Leptonen-Massen aus Quantenzahlen}
	...
	\subsubsection{Alternative Herleitung von $E_0$ aus Massenverh\"altnissen}
	
	\subsubsection{Das geometrische Mittel der Lepton-Energien}
	...
	\subsubsection{Vergleich mit der gravitativen Herleitung}
	...
	\subsubsection{Pr\"azisionskorrektur}
	...
	\subsubsection{Verifikation der Feinstrukturkonstante}
	...
	%-----
	\subsubsection{Zwei geometrische Wege zu $E_0$: Beweis der Konsistenz}
	
	\subsubsection{\"Ubersicht der beiden geometrischen Herleitungen}
	...
	\subsubsection{Mathematische Konsistenz-Pr\"ufung}
	...
	\subsubsection{Geometrische Interpretation der Dualit\"at}
	...
	\subsubsection{Physikalische Bedeutung der Dualit\"at}
	...
	\subsubsection{Der T0-Kopplungsparameter $\varepsilon$}
	...
	\subsubsection*{Die einfachste Formel für die Feinstrukturkonstante}
...
\end{tcolorbox}	
	\subsubsection{Alternative Herleitung durch fraktale Renormierung}
	...
	\subsubsection{Kl\"arung: Die zwei verschiedenen $\kappa$-Parameter}
	
	\subsubsection{Wichtige Unterscheidung}
	...
	\subsubsection{Der Massenskalierungsexponent $\kappa_{\text{mass}}$}
	...
	\subsubsection{Der Gravitationsfeldparameter $\kappa_{\text{grav}}$}
	...
	\subsubsection{Beziehung zwischen $\kappa_{\text{grav}}$ und fundamentalen Parametern}
	...
	\subsubsection{Numerischer Wert und physikalische Bedeutung}
	...
	\subsubsection{Zusammenfassung der $\kappa$-Parameter}
...
\subsubsection{Vollständige Zuordnung: Standardmodell-Parameter zu T0-Entsprechungen}
\label{sec:sm_t0_mapping}

\subsubsection{Übersicht der Parameterreduktion}
...
\subsubsection{Hierarchisch geordnete Parameter-Zuordnungstabelle}
...
\subsubsection{Zusammenfassung der Parameterreduktion}
...
\subsubsection{Die hierarchische Ableitungsstruktur}
...
\subsubsection{Kosmologische Parameter: Standardkosmologie ($\Lambda$CDM) vs T0-System}
...
\subsubsection{Hierarchisch geordnete kosmologische Parameter}
...
\subsubsection{Kritische Unterschiede und Testmöglichkeiten}
...
\subsubsection{Zusammenfassung: Von 6+ zu 0 Parameter}
...
\subsubsection{Kritische Anmerkungen zur Testbarkeit}
...
\subsubsection{Anhang: Rein theoretische Ableitung des Higgs-VEV aus Quantenzahlen}
...
\subsubsection{Fundamentale theoretische Grundlagen}
...
\subsubsection{Theoretische Berechnung der geometrischen Faktoren}
...
\subsubsection{Ableitung der Massenverh{\"a}ltnisse}
...
\subsubsection{Ableitung des Higgs-VEV}
...
\subsubsection{Alternative direkte Berechnung}
...
\subsubsection{Finale theoretische Vorhersage}
...
\subsubsection{Verbesserung durch Quantenkorrekturen}
...
\subsubsection{Konsistenzpr{\"u}fung}
...
\subsubsection{Validierung der T0-Methodik}
...
\appendix
\subsubsection{Verzeichnis der verwendeten Formelzeichen}
...
\subsubsection{Kopplungskonstanten}
\begin{longtable}{lll}
	\toprule
...
\subsubsection{Kosmologische Parameter}
\begin{longtable}{lll}
	\toprule
	\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Wert/Formel} \\
	\midrule
...
\subsubsection{Mischungsmatrizen}
\begin{longtable}{lll}
	\toprule
...
\subsubsection{Sonstige Symbole}
\begin{longtable}{lll}
	\toprule
