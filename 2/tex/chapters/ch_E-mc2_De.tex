% Chapter content extracted from E-mc2_De.tex
...
\title{E=mc² = E=m: Die Konstanten-Illusion entlarvt \\
	...
	\subsubsection{Die zentrale These: E=mc² = E=m}
	...
	\subsubsection{Die mathematische Identität}
	...
	\subsubsection{Was ist c wirklich?}
	...
	\subsubsection{Einsteins fundamentaler Fehler: Die Konstant-Setzung}
	
	\subsubsection{Der Akt der Konstant-Setzung}
	...
	\subsubsection{Das Problem der Zeitvariabilität}
	...
	\subsubsection{Die T0-Auflösung}
	...
	\subsubsection{Die Konstanten-Illusion: Wie sie funktioniert}
	
	\subsubsection{Der Mechanismus der Illusion}
	...
	\subsubsection{Was wirklich passiert (T0-Sicht)}
	...
	\subsubsection{c als Verhältnis vs. c als Konstante}
	
	\subsubsection{c als natürliches Verhältnis (T0)}
	...
	\subsubsection{c als künstliche Konstante (Einstein)}
	...
	\subsubsection{Das Zeitdilatations-Paradox}
	
	\subsubsection{Einsteins Widerspruch entlarvt}
	...
	\subsubsection{Einsteins versteckte Lösung}
	...
	\subsubsection{T0s natürliche Lösung}
	...
	\subsubsection{Die mathematische Demonstration}
	
	\subsubsection{Von E=mc² zu E=m}
	...
	\subsubsection{Die Umkehrrichtung: Von E=m zu E=mc²}
	...
	\subsubsection{Die Beliebigkeit der Konstanten-Wahl: c oder Zeit?}
	
	\subsubsection{Einsteins willkürliche Entscheidung}
	...
	\subsubsection{Option 1: Einsteins c-Konstante}
	...
	\subsubsection{Option 2: Zeit-Konstante (Einstein hätte wählen können)}
	...
	\subsubsection{Mathematische Äquivalenz beider Optionen}
	...
	\subsubsection{Warum Einstein Option 1 wählte}
	...
	\subsubsection{T0s Überwindung beider Optionen}
	...
	\subsubsection{Befreiung vom Konstanten-Zwang}
	...
	\subsubsection{Die Bezugspunkt-Revolution: Erde → Sonne → Natur}
	
	\subsubsection{Die Bezugspunkt-Analogie: Geozentrisch → Heliozentrisch → T0}
	...
	\subsubsection{Warum wir Bezugspunkte brauchen}
	...
	\subsubsection{Der richtige vs. falsche Bezugspunkt}
	...
	\subsubsection{Wenn etwas konstant wird}
	
	\subsubsection{Das fundamentale Bezugspunkt-Problem}
	...
	\subsubsection{Die natürliche Bühne: Alles ist relativ}
	...
	\subsubsection{Der Moment der Bezugspunkt-Setzung}
	...
	\subsubsection{Die Bezugspunkt-Problematik}
	...
	\subsubsection{T0s bezugspunkt-freie Physik}
	...
	\subsubsection{Beispiel: Die Meter-Definition}
	...
	\subsubsection{Der Zirkelschluss: Menschen definieren ihre eigenen Konstanten}
	...
	\subsubsection{T0s Auflösung der Bezugspunkt-Illusion}
	...
	\subsubsection{Warum c-Konstanz nicht beweisbar ist}
	
	\subsubsection{Das fundamentale Messproblem}
	...
	\subsubsection{Das Eichdefinitions-Problem}
	...
	\subsubsection{Das systematische Kompensations-Problem}
	...
	\subsubsection{Das Beweislast-Problem}
	...
	\subsubsection{T0-Vorhersage für präzise Messungen}
	...
	\subsubsection{Ontologische Betrachtung: Rechnungen als Konstrukte}
	
	\subsubsection{Die fundamentale erkenntnistheoretische Grenze}
	...
	\subsubsection{Einsteins Konstrukt vs. T0s Konstrukt}
	...
	\subsubsection{Die ontologische Relativität}
	...
	\subsubsection{Warum T0 trotzdem besser ist}
	...
	\subsubsection{Die erkenntnistheoretische Bescheidenheit}
	...
	\subsubsection{Die pragmatische Konsequenz}
	...
	\subsubsection{Die ontologische Bescheidenheit}
	...
	\subsubsection{Die praktischen Konsequenzen}
	
	\subsubsection{Warum E=mc² funktioniert}
	...
	\subsubsection{Wann E=mc² versagt}
	...
	\subsubsection{T0s universelle Gültigkeit}
	...
	\subsubsection{Die Korrektur der Physikgeschichte}
	
	\subsubsection{Einsteins wahre Leistung}
	...
	\subsubsection{Die historische Ironie}
	...
	\subsubsection{Die T0-Perspektive: c als lebendiges Verhältnis}
	
	\subsubsection{c als Ausdruck der Zeit-Masse-Dualität}
	...
	\subsubsection{Die dynamische Lichtgeschwindigkeit}
	...
	\subsubsection{Experimentelle Tests der c-Variabilität}
	...
	\subsubsection{Physik nach der Konstanten-Illusion}
	...
	\subsubsection{Einsteins korrigiertes Vermächtnis}
