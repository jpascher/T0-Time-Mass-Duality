% Chapter content extracted from QFT_De.tex
...
\begin{abstract}
	...
	\subsubsection{Higgs-Potential und Massenberechnung}
	
	\subsubsection{Das fundamentale Higgs-Potential}
	...
	\subsubsection{Spontane Symmetriebrechung und Vakuumerwartungswert}
	...
	\subsubsection{Higgs-Massenberechnung}
	...
	\subsubsection{Rückrechnung der Selbstkopplung}
	...
	\subsubsection{Herleitung der $\xi$-Formel durch EFT-Matching}
	
	\subsubsection{Ausgangspunkt: Yukawa-Kopplung nach EWSB}
	...
	\subsubsection{EFT-Operator und Matching-Vorbereitung}
	...
	\subsubsection{Vollständige 1-Loop-Matching-Rechnung}
	
	\subsubsection{Setup und Feynman-Diagramm}
	...
	\subsubsection{1-Loop-Amplitude vor PV-Reduktion}
	...
	\subsubsection{Spurformel vor PV-Reduktion}
	...
	\subsubsection{Integration und Symmetrie-Eigenschaften}
	...
	\subsubsection{Schritt-für-Schritt Passarino-Veltman-Zerlegung}
	
	\subsubsection{Definition der PV-Bausteine}
	...
	\subsubsection{Geschlossene Form von $C_0$}
	...
	\subsubsection{Finale $\xi$-Formel}
	...
	\subsubsection{Numerische Auswertung für alle Fermionen}
	
	\subsubsection{Projektor auf $\gamma^\mu q_\mu$}
	...
	\subsubsection{Von $F_V(0)$ zur $\xi$-Definition}
	...
	\subsubsection{NDA-Reskalierung zur Standard-$\xi$-Definition}
	...
	\subsubsection{Detaillierte numerische Auswertung}
	...
	\subsubsection{Mathematische Rigorosität}
	\begin{enumerate}
