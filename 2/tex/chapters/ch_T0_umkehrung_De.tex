% Chapter content extracted from T0_umkehrung_De.tex
...
\begin{abstract}
	...
	\subsubsection{Parameter und Grundformeln}
	\label{sec:parameter}
	
	Die Theorie basiert auf der Zeit-Energie-Dualität und fraktaler Raumzeit-Struktur.
	
	\subsubsection{Exakte geometrische Parameter}
	...
	\subsubsection{Geometrische Ableitung der Massen - Direkte Methode}
	...
	\subsubsection{Elektron-Masse $m_e$ - Direkte geometrische Methode}
	...
	\subsubsection{Konsistenz-Check mit Hauptdokument}
	...
	\subsubsection{Effektive Torsions-Masse $m_T$}
	...
	\subsubsection{Myon-Masse $m_{\mu}$}
	...
	\subsubsection{Rückwärts-Validierung: $D_f$ aus $r$ und Nambu-Formel}
	...
	\subsubsection{Optimierung für $D_f$}
	...
	\subsubsection{Anwendung: Anomaler magnetischer Moment $a_{\mu}^{\text{T0}}$}
	...
	\subsubsection{Python-Implementierung und Reproduzierbarkeit}
	...
	\subsubsection{Zusammenfassung und wissenschaftliche Bedeutung}
	\label{sec:zusammenfassung}
	
	\subsubsection{Theoretische Bedeutung der Validierung}
	...
	\subsubsection{Komplementäre Dokumenten-Struktur}
