% Chapter content extracted from Unit Charge_De.tex
...
\begin{abstract}
	...
	\subsubsection{Einführung: Das Problem der Punkt-Singularitäten}
	\label{sec:intro}
	...
	\subsubsection{Alternative Darstellungen der Ladung}
	\label{sec:alternativen}
	
	\subsubsection{Nichtlineare Elektrodynamik}
	...
	\subsubsection{Soliton- und Vortex-Modelle}
	...
	\subsubsection{Topologische Defekte}
	...
	\subsubsection{Die Elektronenladung in der T0-Theorie}
	\label{sec:t0-ladung}
	
	\subsubsection{Zeit-Masse-Dualität und Emergenz}
	...
	\subsubsection{Finite Selbstenergie und Quantisierung}
	...
	\subsubsection{Implikationen für die Electromagnetic Mechanics}
	\label{sec:emm}
