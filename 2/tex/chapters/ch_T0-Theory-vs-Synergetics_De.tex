% Chapter content extracted from T0-Theory-vs-Synergetics_De.tex
...
\begin{abstract}
	...
	\subsubsection{Einleitung: Zwei Wege, ein Ziel}
	...
	\subsubsection{Die fundamentalen Unterschiede}
	
	\subsubsection{Korrespondenz der Parameter}
	...
	\subsubsection{Einheitensysteme: Der entscheidende Unterschied}
	...
	\subsubsection{Beispiel: Gravitationskonstante}
	...
	\subsubsection{Warum natürliche Einheiten alles vereinfachen}
	
	\subsubsection{Das Grundprinzip}
	...
	\subsubsection{Konkrete Vereinfachungen}
	...
	\subsubsection{Die Zeit-Masse-Dualität: Das fehlende Puzzlestück}
	...
	\subsubsection{Frequenz, Wellenlänge und Masse: Die geometrische Einheit}
	
	\subsubsection{Das Straßenkarten-Beispiel aus dem Video}
	...
	\subsubsection{Photonen vs. Massive Teilchen}
	...
	\subsubsection{Der 137-Marker: Geometrische vs. dimensionale Analyse}
	
	\subsubsection{Video-Ansatz: Tetraeder-Frequenzen}
	...
	\subsubsection{Die Bedeutung von 137}
	...
	\subsubsection{Planck-Konstante und Winkelmoment}
	
	\subsubsection{Video-Ansatz: Periodische Verdopplungen}
	...
	\subsubsection{Gravitation: Der dramatischste Unterschied}
	
	\subsubsection{Die Komplexität des Video-Ansatzes}
	...
	\subsubsection{Kosmologie: Statisches Universum}
	...
	\subsubsection{Neutrinos: Das spekulative Gebiet}
	...
	\subsubsection{Das Muon g-2 Anomalie}
	...
	\subsubsection{Mathematische Eleganz: Direkte Vergleiche}
	...
	\subsubsection{Warum T0 die fehlenden Puzzlestücke liefert}
	
	\subsubsection{1. Vereinheitlichung durch natürliche Einheiten}
	...
	\subsubsection{2. Zeit-Masse-Dualität als Fundament}
	...
	\subsubsection{3. Direkte Ableitungen ohne empirische Faktoren}
	...
	\subsubsection{4. Testbare Vorhersagen}
	...
	\subsubsection{Die Stärken beider Ansätze}
	
	\subsubsection{Was Synergetics besser macht}
	...
	\subsubsection{Was T0 besser macht}
	...
	\subsubsection{Synthese: Die optimale Kombination}
	...
	\subsubsection{Praktischer Vergleich: Beispielrechnungen}
	...
	\subsubsection{Berechnung der Gravitationskonstante}
	...
	\subsubsection{Die fundamentale Einsicht: Warum T0 einfacher ist}
	...
	\subsubsection{Tabelle: Vollständiger Feature-Vergleich}
	...
	\subsubsection{Die fehlenden Puzzlestücke: Was T0 hinzufügt}
	
	\subsubsection{1. Das Zeitfeld}
	...
	\subsubsection{2. Quantitative Kosmologie}
	...
	\subsubsection{3. Systematische Teilchenphysik}
	...
	\subsubsection{4. Renormalisierung}
	...
	\subsubsection{Konkrete Anwendung: Schritt-für-Schritt}
	
	\subsubsection{Aufgabe: Berechne die Myonmasse}
	...
	\subsubsection{Numerische Präzision: Detaillierter Vergleich}
	...
	\subsubsection{Erklärung der Verbesserung}
	...
	\subsubsection{Experimentelle Unterscheidung}
	
	\subsubsection{Wo beide Theorien gleiche Vorhersagen machen}
	...
	\subsubsection{Wo T0 unterscheidbare Vorhersagen macht}
	...
	\subsubsection{Pädagogische Überlegungen}
	
	\subsubsection{Synergetics-Stärken}
	...
	\subsubsection{Ideale Lehrmethode}
	...
	\subsubsection{Für Synergetics-Ansatz}
	...
	\subsubsection{Gemeinsame Zukunft}
	...
	\subsubsection{Zusammenfassung: Warum T0 einfacher ist}
	...
	\subsubsection{Die ultimative Wahrheit}
