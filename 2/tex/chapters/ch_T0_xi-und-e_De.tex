% Chapter content extracted from T0_xi-und-e_De.tex
...
\begin{abstract}
	...
	\subsubsection{Einleitung: Die geometrische Basis der T0-Theorie}
	
	\subsubsection{Historische und konzeptionelle Grundlagen}
	...
	\subsubsection{Die tetraedrische Herkunft von $\xi$}
	...
	\subsubsection{Die fraktale Raumzeit-Dimension}
	...
	\subsubsection{Die Euler'sche Zahl als dynamischer Operator}
	
	\subsubsection{Mathematische Grundlagen von $e$}
	...
	\subsubsection{Zeit-Masse-Dualität als fundamentales Prinzip}
	...
	\subsubsection{Detaillierte Analyse der Leptonenmassen}
	
	\subsubsection{Die exponentielle Massenhierarchie}
	...
	\subsubsection{Logarithmische Symmetrie und ihre Konsequenzen}
	...
	\subsubsection{Fraktale Raumzeit und Quantenfeldtheorie}
	
	\subsubsection{Das Renormierungsproblem und seine Lösung}
	...
	\subsubsection{Modifizierte Renormierungsgruppengleichungen}
	...
	\subsubsection{Kosmologische Anwendungen und Vorhersagen}
	
	\subsubsection{Urknall und CMB-Temperatur}
	...
	\subsubsection{Dunkle Energie und kosmologische Konstante}
	...
	\subsubsection{Experimentelle Tests und Vorhersagen}
	
	\subsubsection{Präzisionstests in der Teilchenphysik}
	...
	\subsubsection{Mathematische Vertiefung}
	
	\subsubsection{Die $\pi$-$e$-$\xi$ Trinität}
	...
	\subsubsection{Gruppentheoretische Interpretation}
	...
	\subsubsection{Präzisionsvorhersagen}
