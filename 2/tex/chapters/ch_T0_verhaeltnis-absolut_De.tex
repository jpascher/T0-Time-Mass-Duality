% Chapter content extracted from T0_verhaeltnis-absolut_De.tex
...
\begin{abstract}
	...
	\subsubsection*{Die tiefere Implikation:}
	...
	\subsubsection{Warum KEINE $K_{\text{frak}}$?}
	...
	\subsubsection{Absolute Berechnungen (MIT $K_{\text{frak}}$)}
	...
	\subsubsection{Warum $K_{\text{frak}}$ notwendig?}
	...
	\subsubsection{Die fundamentale Implikation: $\alpha$ und $G$ als abgeleitete Größen}
	
	\subsubsection{Die interne Feinstrukturkonstante $\alpha_{\text{T0}}$}
	...
	\subsubsection{Die interne Gravitationskonstante $G_{\text{T0}}$}
	...
	\subsubsection{Die revolutionäre Konsequenz}
	...
	\subsubsection{Konkrete Beispiele}
	
	\subsubsection{Beispiel 1: Massenverhältnis (verhältnisbasiert)}
	...
	\subsubsection{Beispiel 2: Absolute Elektronmasse}
	...
	\subsubsection{Beispiel 3: Feinstrukturkonstante als Brückenfall}
	...
	\subsubsection{Die mathematische Struktur}
	
	\subsubsection{Verhältnisbasierte Formel (allgemein)}
	\begin{align*}
	...
	\subsubsection{Absolute Formel (allgemein)}
	\begin{align*}
	...
	\subsubsection{Die Zwei-Regime-Tabelle mit fundamentalen Konstanten}
	...
	\subsubsection{Die philosophische Bedeutung}
	...
	\subsubsection{Die Eliminierung freier Parameter}
	...
	\subsubsection{Zusammenfassung der erweiterten Erkenntnis}
	
	\subsubsection{Die zentrale Regel}
	...
	\subsubsection{Warum das revolutionär ist}
