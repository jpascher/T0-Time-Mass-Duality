% Chapter content extracted from T0_Anomale-g2-9_De.tex
...
\thispagestyle{fancy}
	...
	\subsubsection*{Liste der Symbole}
	...
	\subsubsection{Einführung und Klärung der Konsistenz}
	...
	\subsubsection{Grundprinzipien des T0-Modells}
	...
	\subsubsection{Fraktale Geometrie und Korrekturfaktoren}
	...
	\subsubsection{Detaillierte Ableitung der Lagrangedichte mit Torsion}
	...
	\subsubsection{Geometrische Ableitung der Torsions-Mediator-Masse $m_T$}
	...
	\subsubsection{Transparente Ableitung des anomalen Moments $a_\ell^{T0}$}
	...
	\subsubsection{Feynman-Schleifenintegral -- Vollständige Entwicklung (Vektoriel)}
	...
	\subsubsection{Teilbruchzerlegung -- Korrigiert}
	...
	\subsubsection{Generalisierte Formel (Rev. 9: RG-Dualitätskorrektur)}
	Substitution ergibt:
	\begin{equation}
	...
	\subsubsection{Numerische Berechnung (für Myon) (Rev. 9: Exaktes Integral mit Korrektur)}
	...
	\subsubsection{Ergebnisse für alle Leptonen (Rev. 9: Korrigierte Skalierungen)}
	...
	\subsubsection{Inbettung für Myon g-2 und Vergleich mit String-Theorie}
	\subsubsection{Ableitung der Inbettung für Myon g-2}
	...
	\subsubsection{Vergleich: T0-Theorie vs. String-Theorie}
	...
	\appendix
	\subsubsection{Anhang: Umfassende Analyse der Leptonen-anomalen magnetischen Momente in der T0-Theorie (Rev. 9 -- Überarbeitet)}
	...
	\subsubsection{Übersicht der Diskussion}
	...
	\subsubsection{Erweiterte Vergleichstabelle: T0 in zwei Perspektiven (e, $\mu$, $\tau$) (Rev. 9)}
	...
	\subsubsection{Pre-2025-Messdaten: Experiment vs. SM}
	...
	\subsubsection{Vergleich: SM + T0 (Hybrid) vs. Reine T0 (mit Pre-2025-Daten)}
	...
	\subsubsection{Unsicherheiten: Warum hat SM Bereiche, T0 exakt?}
	...
	\subsubsection{Warum Hybrid Pre-2025 für Myon gut funktionierte, aber Reine T0 für Elektron inkonsistent schien?}
	...
	\subsubsection{Inbettungsmechanismus: Auflösung der Elektron-Inkonsistenz}
	...
	\subsubsection{SymPy-abgeleitete Schleifenintegrale (Exakte Verifikation)}
	...
	\subsubsection{Prototyp-Vergleich: Sept. 2025 vs. Aktuell (Integriert aus Original-Doc)}
	...
	\subsubsection{GitHub-Validierung: Konsistenz mit T0-Repo}
