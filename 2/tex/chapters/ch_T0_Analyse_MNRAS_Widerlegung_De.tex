% Chapter content extracted from T0_Analyse_MNRAS_Widerlegung_De.tex
...
\subsubsection{Zusammenfassung des MNRAS-Papiers}
...
\subsubsection{Die Implikationen für die T0-Theorie}
...
\subsubsection{Die T0-Theorie modifiziert nicht die Gravitation}
...
\subsubsection{Rotverschiebung als geometrischer Effekt}
...
\subsubsection{Konsistenz mit den Daten des Sonnensystems}
