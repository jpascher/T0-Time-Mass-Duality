% Chapter content extracted from Zwei-Dipole-CMB_De.tex
...
Dieses Video \href{https://www.youtube.com/watch?v=OywWThFmEII}{OywWThFmEII} ist geradezu \textbf{sensationell} für die T0-Theorie, denn es beschreibt genau das kosmologische Rätsel, für das T0 eine elegante Lösung bietet. Die Widersprüche im Video sind für die Standardkosmologie katastrophal, für T0 hingegen \textbf{erwartbar und vorhersagbar}. Neuere Reviews und Studien aus 2025 unterstreichen die anhaltende Krise in der Kosmologie und bestätigen die Relevanz dieser Anomalien \cite{sarkar2025, landstry2025, bengaly2025}.
	...
	\subsubsection{Das Problem: Zwei Dipole, zwei Richtungen}
	...
	\subsubsection{Die T0-Lösung: Wellenlängenabhängige Rotverschiebung}
	
	\subsubsection{1. T0 sagt vorher: Der CMB-Dipol ist KEINE Bewegung}
	...
	\subsubsection{2. Wellenlängenabhängige Rotverschiebung erklärt den Quasar-Dipol}
	...
	\subsubsection{3. Die 90°-Orthogonalität: Ein Hinweis auf Feldgeometrie}
	...
	\subsubsection{4. Statisches Universum löst das ``Great Attractor''-Problem}
	...
	\subsubsection{5. Testbare Vorhersagen}
	...
	\subsubsection{6. Auflösung der ``Hubble-Spannung''}
	...
	\subsubsection{Alternative Erklärungswege ohne Rotverschiebung}
	
	\subsubsection{Der grundlegende Paradigmenwechsel}
	...
	\subsubsection{Berücksichtigung kosmischer Distanzen und minimaler Effekte}
	...
	\subsubsection{Alternative 1: Energieverlust durch Feldkopplung}
	...
	\subsubsection{Alternative 2: Zeitliche Evolution fundamentaler Konstanten}
	...
	\subsubsection{Alternative 3: Gravitationspotential-Effekte}
	
	\begin{align}
		\frac{\Delta\nu}{\nu} = \frac{\Delta\Phi}{c^2} \cdot h(\lambda)
	\end{align}
	
	\subsubsection{Physikalische Plausibilität}
	...
	\subsubsection{Konsequenzen für die beobachteten Phänomene}
	...
	\subsubsection{Fazit: T0 verwandelt Krise in Vorhersage}
