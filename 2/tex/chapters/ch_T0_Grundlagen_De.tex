% Chapter content extracted from T0_Grundlagen_De.tex
...
\begin{abstract}
	...
	\subsubsection{Einführung in die T0-Theorie}
		\subsubsection{Zeit-Masse-Dualitaet}
	...
	\subsubsection{Die zentrale Hypothese}
	...
	\subsubsection{Paradigmenwechsel gegenüber dem Standardmodell}
	...
	\subsubsection{Die harmonisch-geometrische Komponente: 4/3}
	...
	\subsubsection{Die Skalenhierarchie: $10^{-4}$}
	...
	\subsubsection{Fraktale Raumzeitstruktur}
	
	\subsubsection{Quantenraumzeit-Effekte}
	...
	\subsubsection{Ursprung der Konstante 68}
...
Diese Dualitaet ist nicht nur eine mathematische Beziehung, sondern spiegelt eine fundamentale Eigenschaft der Raumzeit wider. Sie erklaert, warum schwere Teilchen staerker an die temporale Struktur der Raumzeit koppeln.
	...
	\subsubsection{Charakteristische Energieskalen}
	
	\subsubsection{Die T0-Energiehierarchie}
	...
	\subsubsection{Die charakteristische elektromagnetische Energie}
	...
	\subsubsection{Dimensionsanalytische Grundlagen}
	...
	\subsubsection{Die universelle T0-Formelstruktur}
	
	\subsubsection{Grundmuster der T0-Beziehungen}
	...
	\subsubsection{Beispiele der universellen Struktur}
	...
	\subsubsection{Verschiedene Interpretationsebenen}
	
	\subsubsection{Hierarchie der Verständnisebenen}
	...
	\subsubsection{Komplementäre Sichtweisen}
	...
	\subsubsection{Grundlegende Berechnungsmethoden}

\subsubsection{Direkte geometrische Methode}
...
\subsubsection{Erweiterte Yukawa-Methode}
...
Die Parameter $r_i$ und $p_i$ sind exakte rationale Zahlen, die aus der Quantenzahlen-Zuordnung der T0-Geometrie folgen.
	...
	\subsubsection{Das Problem der Natürlichkeit}
	...
	\subsubsection{Das anthropische Prinzip}
	...
	\subsubsection{Experimentelle Bestaetigung}

\subsubsection{Erfolgreiche Vorhersagen}
...
\end{keyresult}
	...
	\subsubsection{Die nächsten Schritte}
	...
	\subsubsection{Struktur der T0-Dokumentenserie}
...
\end{itemize}
	...
	\subsubsection{Grundlegende T0-Dokumente}
