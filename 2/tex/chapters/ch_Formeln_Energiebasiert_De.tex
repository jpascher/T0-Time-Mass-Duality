% Chapter content extracted from Formeln_Energiebasiert_De.tex
...
\title{T0-Modell: Energiebasierte Formelsammlung \\
	...
	\subsubsection{Universeller geometrischer Parameter}
	\begin{itemize}
	...
	\subsubsection{Abgeleitete Konstanten}
	\begin{itemize}
		\item T0-Energie:
	...
	\subsubsection{Universelle Skalierungsgesetze}
	\begin{itemize}
	...
	\subsubsection{ELEKTROMAGNETISMUS UND KOPPLUNG}
	...
	\subsubsection{Elektromagnetische Lagrange-Dichte}
	\begin{itemize}
	...
	\subsubsection{ANOMALES MAGNETISCHES MOMENT}
	...
	\subsubsection{Alternative vereinfachte Form}
	...
	\subsubsection{Berechnung für das Myon}
	...
	\subsubsection{Experimentelle Vergleiche}
	...
	\subsubsection{PHYSIKALISCHE BEGRÜNDUNG DER QUADRATISCHEN SKALIERUNG}
	
	\subsubsection{Standard-QFT-Herleitung}
	...
	\subsubsection{ENERGIESKALEN UND HIERARCHIEN}
	
	\subsubsection{T0-Energiehierarchie}
	\begin{itemize}
	...
	\subsubsection{Kopplungsstärken-Hierarchie}
	\begin{align}
	...
	\subsubsection{KOSMOLOGISCHE ANWENDUNGEN}
	
	\subsubsection{Vakuumenergie-Dichte}
	\begin{itemize}
	...
	\subsubsection{TEILCHENMASSEN UND -HIERARCHIEN}
	
	\subsubsection{Lepton-Massen aus $\xi$-Skalierung}
	\begin{align}
	...
	\subsubsection{Quark-Massen (parameterfrei)}
	\begin{align}
