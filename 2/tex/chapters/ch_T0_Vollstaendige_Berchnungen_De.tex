% Chapter content extracted from T0_Vollstaendige_Berchnungen_De.tex
...
\begin{abstract}
	...
	\subsubsection{Fundamentale Parameter}
	...
	\subsubsection{T0-Fundamentalformel für die Gravitationskonstante}
	...
	\subsubsection{Herkunft des Faktors 1 ($3{,}521 \times 10^{-2}$)}
...
\subsubsection{Verifikation des charakteristischen T0-Faktors}
...
\subsubsection{Herkunft des Faktors 2 ($2{,}843 \times 10^{-5}$)}
...
\end{align}
	...
	\subsubsection{Teilchenmassen-Berechnungen}
	
	\subsubsection{Yukawa-Methode der T0-Theorie}
	...
	\subsubsection{Detaillierte Massenberechnungen}
	...
	\subsubsection{Beispielberechnung: Elektron}
	...
	\subsubsection{Magnetische Momente und g-2 Anomalien}
	
	\subsubsection{Standardmodell + T0-Korrekturen}
	...
	\subsubsection{Vollständige Liste physikalischer Konstanten}
	...
	\subsubsection{Kategorienbasierte Konstantenübersicht}
	...
	\subsubsection{Detaillierte Konstantenliste}
	...
	\subsubsection{Mathematische Eleganz und Theoretische Bedeutung}
	
	\subsubsection{Exakte Bruchverhältnisse}
	...
	\subsubsection{Dimensionsbasierte Hierarchie}
	...
	\subsubsection{Fundamentale Bedeutung der Umrechnungsfaktoren}
	...
	\subsubsection{Methodische Aspekte und Implementierung}
	
	\subsubsection{Numerische Präzision}
	...
	\subsubsection{Kategorienbasierte Analyse}
	...
	\subsubsection{Beste und schlechteste Vorhersagen}
	...
	\subsubsection{Vergleich mit Standardans\"{a}tzen}
	
	\subsubsection{Vorteile der T0-Theorie}
	...
	\subsubsection{Technische Details der Implementierung}
	
	\subsubsection{Python-Code-Struktur}
	...
	\subsubsection{Fazit und wissenschaftliche Einordnung}
	
	\subsubsection{Revolutionäre Aspekte}
	...
	\subsubsection{Wissenschaftlicher Impact}
	...
	\textcolor{t0green}{\textbf{Die T0-Antwort:}} Alle diese scheinbar unabhängigen Probleme sind Manifestationen der einzigen geometrischen Konstante $\xi = \frac{4}{3} \times 10^{-4}$.
		...
		\subsubsection{Anhang: Vollständige Datenreferenzen}
	
	\subsubsection{Experimentelle Referenzwerte}
	...
	\subsubsection{Software und Berechnungsdetails}
