% Chapter content extracted from 137_De.tex
...
\thispagestyle{empty}
	...
	\subsubsection{Das jahrhundertealte Rätsel}
	
	\subsubsection{Was alle wussten}
	...
	\subsubsection{Die traditionelle Perspektive}
	...
	\subsubsection{Die neue Umkehrung}
	
	\subsubsection{Die T0-Entdeckung}
	...
	\subsubsection{Der fundamentale Parameter}
	...
	\subsubsection{Der verborgene Code}
	
	\subsubsection{Was die ganze Zeit sichtbar war}
	...
	\subsubsection{Entschlüsselung der Struktur}
	...
	\subsubsection{Die vollständige Hierarchie}
	
	\subsubsection{Von einer Zahl zu allem}
	...
	\subsubsection{Warum niemand es sah}
	
	\subsubsection{Das Einfachheitsparadoxon}
	...
	\subsubsection{Die kognitive Umkehrung}
	...
	\subsubsection{Die geometrische Ableitung}
	...
	\subsubsection{Die Energieskala}
	...
	\subsubsection{Vorhersagen ohne Parameter}
	...
	\subsubsection{Vergleich aller Berechnungsmethoden zu 1/137}
	...
	\subsubsection{Der ultimative Test}
	...
	\subsubsection{Die tiefgreifenden Implikationen}
	
	\subsubsection{Philosophische Perspektive}
	...
	\subsubsection{Die kosmische Einsicht}
	...
	\newpage
	\subsubsection{Anhang: Formelsammlung}
	...
	\subsubsection{Geometrische Quantenfunktion}
	...
	\subsubsection{Die vollständige Reduktion}
	...
	\subsubsection*{Die fundamentale Beziehung}
	
	\[
	\boxed{\alpha = \xi \cdot \left(\frac{E_0}{1 \text{ MeV}}\right)^2}
	\]
	
	\subsubsection*{Werte der Parameter}
	...
	\subsubsection*{Die umgestellte Formel}
	
	\subsubsection*{Korrekte Form mit expliziter Normierung}
	...
	\subsubsection*{Warum die Normierung essentiell ist}
	
	\subsubsection*{Problem ohne Normierung}
	...
	\subsubsection*{Lösung mit Normierung}
