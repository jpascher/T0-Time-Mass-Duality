% Chapter content extracted from T0_koide-formel-3_De.tex
...
\newpage
	...
	\subsubsection{Die Koide-Formel}
	...
	\subsubsection{T0-Yukawa-Formel}
	...
	\subsubsection{Beweis durch Massenverhältnisse}
	
	\subsubsection{Elektron zu Myon}
	...
	\subsubsection{Direkte Herleitung der Koide-Relation}
	
	\subsubsection{Geometrische Struktur der Exponenten}
	...
	\subsubsection{Schlüsselerkenntnis}
	...
	\subsubsection{Vergleich: Empirische vs. T0-Herleitung}
	...
	\subsubsection{Mathematische Bedeutung}
	...
	\subsubsection{Feinstrukturkonstante aus Massenverhältnissen}
	
	\subsubsection{Direkte T0-Ableitung}
	...
	\subsubsection{Rekonstruktion aus Leptonmassen}
	...
	\subsubsection{Hierarchie der $\xi$-Manifestationen}
	
	Die drei fundamentalen Konstanten entstehen aus $\xi$ auf verschiedenen "Reinheits-Ebenen":
	
	\subsubsection{Ebene 1: Massenverhältnisse (Koide-Formel)}
	...
	\subsubsection{Ebene 2: Feinstrukturkonstante}
	...
	\subsubsection{Ebene 3: Gravitationskonstante}
	...
	\subsubsection{Warum keine fraktalen Korrekturen?}
	
	\subsubsection{Verhältnis-Geometrie vs. Absolute Skalen}
	...
	\subsubsection{Fraktale Korrekturen nur bei absoluten Skalen}
	...
	\subsubsection{Vereinigte Theorie der Fundamentalkonstanten}
