% Chapter content extracted from detailierte_formel_leptonen_anemal_De.tex
...
\title{T0-Modell: Detaillierte Formeln für leptonische Anomalien \\
	...
	\subsubsection{Fundamentale T0-Formel}
	...
	\subsubsection{Vakuumfluktuationen als Quelle der g-2-Anomalien}
	...
	\subsubsection{Herleitung: Standard-QFT Dimensionsanalyse}
	
	\subsubsection{Grundlagen der QFT-Skalierung}
	...
	\subsubsection{Schritt 1: QFT One-Loop Struktur}
	...
	\subsubsection{Schritt 2: Yukawa-Kopplung einsetzen}
	...
	\subsubsection{Schritt 3: Normierung auf das Myon}
	...
	\subsubsection{Der Casimir-Effekt in der T0-Theorie}
	...
	\subsubsection{Experimentelle Vorhersagen mit quadratischer Skalierung}
	
	\subsubsection{Myon-Anomalie}
	...
	\subsubsection{Elektron-Anomalie}
	...
	\subsubsection{Warum quadratische Skalierung physikalisch korrekt ist}
	
	Die quadratische Massenskalierung $a_\ell \propto (m_\ell/m_\mu)^2$ hat folgende physikalische Begründungen:
	
	\subsubsection{Standard-QFT-Fundament}
	\begin{itemize}
	...
	\subsubsection{Renormierungsgruppen-Stabilität}
	\begin{itemize}
