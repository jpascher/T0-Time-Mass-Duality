% Chapter content extracted from T0_Feinstruktur_De.tex
...
\begin{abstract}
	...
	\subsubsection{Die Feinstrukturkonstante in der Physik}
	...
	\subsubsection{T0-Ansatz zur $\alpha$-Herleitung}
	...
	\subsubsection{Physikalische Bedeutung von $\Ezero$}
	...
	\subsubsection{Alternative Herleitung von $\Ezero$}
	...
	\subsubsection{Herleitung der Hauptformel}
	...
	\subsubsection{Dimensionsanalytische Herleitung}
	...
	\subsubsection{Verschiedene Herleitungswege}
	...
	\subsubsection{Über Massenbeziehungen}
	...
	\subsubsection{Die Essenz der T0-Theorie}
	...
	\subsubsection{Komplexere T0-Formeln}
	
	\subsubsection{Die fundamentale Abhängigkeit: $\alpha \sim \xipar^{11/2}$}
	...
	\subsubsection{Berechnung von $\Ezero$}
	...
	\subsubsection{Massenverhältnisse und charakteristische Energie}
	...
	\subsubsection{Beziehung zur charakteristischen Energie}
	...
	\subsubsection{Experimentelle Verifikation}
	
	\subsubsection{Vergleich mit Präzisionsmessungen}
	...
	\subsubsection{Konsistenz der Beziehungen}
	...
	\subsubsection{Warum Zahlenverhältnisse nicht gekürzt werden dürfen}
	
	\subsubsection{Das Kürzungs-Problem}
	...
	\subsubsection{Fundamentale Abhängigkeit}
	...
	\subsubsection{Geometrische Notwendigkeit}
	...
	\subsubsection{Einheitenprüfungen offenbaren falsche Kürzungen}
	...
	\subsubsection{Warum keine fraktale Korrektur für Massenverhältnisse benötigt wird}
	...
	\subsubsection{Massenverhältnisse sind korrekturfrei}
	...
	\subsubsection{Konsistente Behandlung}
	...
	\subsubsection{Erweiterte mathematische Struktur}
	
	\subsubsection{Vollständige Hierarchie}
	...
	\subsubsection{Verifikation der Ableitungskette}
	...
	\subsubsection{Die Bedeutung der Zahl $\frac{4}{3}$}
	...
	\subsubsection{Universelle Bedeutung}
	...
	\subsubsection{Verbindung zu anomalen magnetischen Momenten}
	
	\subsubsection{Grundlegende Kopplung}
	...
	\subsubsection{Skalierung mit Teilchenmassen}
	...
	\subsubsection{Glossar der verwendeten Symbole und Zeichen}
