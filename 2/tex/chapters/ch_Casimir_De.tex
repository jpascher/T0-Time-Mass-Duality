% Chapter content extracted from Casimir_De.tex
...
\title{Vereinheitlichung von Casimir-Effekt und kosmischer Hintergrundstrahlung: Eine fundamentale Vakuum-Theorie}
	...
	\subsubsection{Fundamentale Längenskalen}
	...
	\subsubsection{Die Kopplungskonstante \( \xi \)}
	...
	\subsubsection{Die CMB-Vakuum-Beziehung}
	...
	\subsubsection{Numerische Bestimmung von \( L_\xi \)}
	...
	\subsubsection{Modifizierte Casimir-Theorie}
	
	\subsubsection{Erweiterte Casimir-Formel}
	...
	\subsubsection{Konsistenz mit der Standard-Casimir-Formel}
	...
	\subsubsection{Vergleichsrechnungen}
	...
	\subsubsection{Charakteristische Längenskalen-Hierarchie}
	...
	\subsubsection{Multi-skaliges Vakuum-Modell}
	...
	\subsubsection{Granulation der Raumzeit bei \( L_0 \)}
	...
	\subsubsection{Kopplungskonstante \( \xi \) als Raumparameter}
	...
	\subsubsection{Emergente Gravitation}
	...
	\subsubsection{Kritische Abstände}
	...
	\subsubsection{Experimentelle Messdaten}
	...
	\subsubsection{Geometrie-Abhängigkeit}
	...
	\subsubsection{Frequenz-Abhängigkeit}
	...
	\subsubsection{Vakuum-Energiedichte und scheinbare kosmische Expansion}
	...
	\subsubsection{Frühes Universum}
	...
	\subsubsection{Stärken der Theorie}
	...
	\subsubsection{Zukünftige Experimente}
	...
	\subsubsection{Moduszählung und Nullpunktsenergie bei fraktaler Raumdimension}
	...
	\subsubsection{Numerische Sensitivität}
	Die numerische Sensitivitätskurve für $\xi(A_d)$ bei $d=3+\delta$.
	
	\subsubsection{Regularisierung: Zeta-Funktion (Skizze)}
	...
	\subsubsection{RG-Skizze und Modelle für $\gamma$}
	...
	\subsubsection{Implizite Kopplungsmodelle}
	...
	\subsubsection{Implikationen und Zusammenhänge}
	...
	\appendix
	\subsubsection{Vollständige Zeta-Regularisierung: Details}
	\label{app:zeta_full}
	...
	\subsubsection{Numerische Daten}
	...
	\subsubsection{Moduszählung mit hartem Cutoff}
	...
	\subsubsection{Matching an das T0-Modell}
	...
	\subsubsection{Numerische Sensitivität nahe \(d=3\)}
	...
	\subsubsection{Regularisierung: Zeta-Funktion (Anhang)}
	\label{app:zeta}
	...
	\subsubsection{RG-Skizze und Ableitung von \(\gamma\)}
	\label{sec:rg_gamma}
	...
	\subsubsection{Matching an Beobachtungen und Fehlerabschätzung}
	...
	\subsubsection{Charakteristische Längenskalen}
	\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Wert/Einheit} \\
		\midrule
	...
	\subsubsection{Kopplungsparameter und dimensionslose Größen}
	\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Wert/Einheit} \\
		\midrule
	...
	\subsubsection{Energiedichten und Temperaturen}
	\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Wert/Einheit} \\
		\midrule
	...
	\subsubsection{Mathematische Funktionen und Operatoren}
	\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
	...
	\subsubsection{Felder und Wellenvektoren}
	\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
	...
	\subsubsection{Geometrische und topologische Parameter}
	\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Anmerkung} \\
		\midrule
	...
	\subsubsection{Experimentelle Parameter}
	\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
	...
	\subsubsection{Verhältnisgrößen und Skalierungen}
	\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Anmerkung} \\
		\midrule
	...
	\subsubsection{Abkürzungen und Indizes}
	\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
	...
	\subsubsection{Konstanten in numerischen Formeln}
	\begin{longtable}{p{2.5cm} p{10cm} p{3cm}}
		\toprule
