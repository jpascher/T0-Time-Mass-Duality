% Chapter content extracted from Zeit_De.tex
...
\begin{abstract}
	...
	\subsubsection{Granulation als Grundprinzip der Realitaet}
	
	\subsubsection{Minimale Laengenskala $\Lzero$}
	...
	\subsubsection{Casimir-Skala als Nachweis der Granulation}
	...
	\subsubsection{Limit-Systeme und Skalenhierarchien}
	
	\subsubsection{Drei-Skalen-Hierarchie}
	...
	\subsubsection{Relationales Zahlensystem}
	...
	\subsubsection{CP-Verletzung aus universeller Asymmetrie}
	...
	\subsubsection{Fundamentale Asymmetrie als Bewegungsprinzip}
	
	\subsubsection{Die universelle $\xipar$-Konstante}
	...
	\subsubsection{Ewiges Universum ohne Urknall}
	...
	\subsubsection{Zeit existiert erst nach Feld-Asymmetrie-Anregung}
	...
	\subsubsection{Hierarchische Struktur: Universum > Feld > Raum}
	
	\subsubsection{Die fundamentale Ordnungshierarchie}
	...
	\subsubsection{Kausale Abwaertskopplung}
	...
	\subsubsection{Kontinuierliche Zeit ab bestimmten Skalen}
	
	\subsubsection{Die entscheidende Skalenhierarchie der Zeit}
	...
	\subsubsection{Quantitative Skalierung der Zeit-Kontinuitaet}
	...
	\subsubsection{Thermodynamischer Zeitpfeil}
	...
	\subsubsection{Praktische vs. Fundamentale Physik}
	
	\subsubsection{Zeit wird praktisch konstant erfahren}
	...
	\subsubsection{Lichtgeschwindigkeit als eindeutige Obergrenze}
	...
	\subsubsection{Aufloesung des scheinbaren Widerspruchs}
	...
	\subsubsection{Gravitation: Masse-Variation vs. Raumkruemmung}
	
	\subsubsection{Zwei aequivalente Interpretationen}
	...
	\subsubsection{Wichtige Erkenntnis: Wir wissen es nicht!}
	...
	\subsubsection{Mathematische Vollstaendigkeit: Beide Felder gekoppelt variabel}
	
	\subsubsection{Die korrekte mathematische Formulierung}
	...
	\subsubsection{Verifikation der mathematischen Konsistenz}
	...
	\subsubsection{Warum beide Felder variabel sein muessen}
	...
	\subsubsection{Einsteins willkuerliche Konstant-Setzung}
	...
	\subsubsection{Parameter-Eleganz}
	...
	\subsubsection{Pragmatische Praeferenz: Variable Masse bei konstanter Zeit}
	
	\subsubsection{Die pragmatische Alternative fuer unseren Erfahrungsraum}
	...
	\subsubsection{Praktische Vorteile der konstanten Zeit}
	...
	\subsubsection{Variable Masse als anschauliches Konzept}
	...
	\subsubsection{Wissenschaftliche Legitimitaet der Praeferenz}
	...
	\subsubsection{Die ewige philosophische Grenze}
	
	\subsubsection{Was das T0-Modell erklaert}
	...
	\subsubsection{Was das T0-Modell NICHT erklaeren kann}
	...
	\subsubsection{Wissenschaftliche Demut}
	...
	\subsubsection{Casimir-Effekt-Modifikationen}
	...
	\subsubsection{Atominterferometrie}
	...
	\subsubsection{Fazit: Asymmetrie als Motor der Realitaet}
...
\subsubsection{Mathematischer Beweis: Die Formel $T \cdot m = 1$ schließt Singularitäten aus}

\subsubsection{Wichtige Klarstellung: $T$ als Schwingungsdauer}
...
\subsubsection{Die fundamentale Ausschluss-Eigenschaft}
...
\subsubsection{Beweis 1: Ausschluss unendlicher Masse}
...
\subsubsection{Beweis 2: Ausschluss unendlicher Zeit}
...
\subsubsection{Beweis 3: Ausschluss von Null-Werten}
...
\subsubsection{Beweis 4: Ausschluss mathematischer Singularitäten}
...
\subsubsection{Die algebraische Schutzfunktion}
...
\subsubsection{Beweis 5: Positive Definitheit}
...
\subsubsection{Die fundamentale Erkenntnis über Zeit und Kontinuität}
...
\subsubsection{Fazit: Mathematische Gewissheit}
