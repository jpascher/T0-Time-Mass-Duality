% Chapter content extracted from T0_xi_ursprung_De.tex
...
\begin{abstract}
	...
	\subsubsection{Das Zirkularitätsproblem: Eine ehrliche Analyse}
	
	\subsubsection{Die berechtigte Kritik}
	...
	\subsubsection{Die Lösung: $\kappa$ emergiert aus dem e-p-$\mu$-System}
	...
	\subsubsection{Das e-p-$\mu$-System als Beweis}
	
	\subsubsection{Die drei fundamentalen Verhältnisse}
	...
	\subsubsection{Die konsistente Bedingung}
	...
	\subsubsection{Test verschiedener Exponenten $\kappa$}
	...
	\subsubsection{Die fundamentale Herleitung von $\kappa = 7$}
	
	\subsubsection{Aus der fraktalen Raumzeit-Struktur}
	...
	\subsubsection{Die fundamentale Begründung für $10^{-4}$}
	
	\subsubsection{Warum gerade $10^{-4}$?}
	...
	\subsubsection{Geometrische Interpretation der Faktoren}
	...
	\subsubsection{Herleitung aus der fraktalen Dimension}
	...
	\subsubsection{Raumzeit-Dimensionalität und $10^{-4}$}
	...
	\subsubsection{Emergenz aus fundamentalen Längenverhältnissen}
	...
	\subsubsection{Warum $K = 245$ fundamental ist}
	...
	\subsubsection{Der Casimir-Effekt als unabhängige Bestätigung}
	
	\subsubsection{4/3 aus der QFT}
	...
	\subsubsection{Warum nur 4/3 funktioniert}
	...
	\subsubsection{Zusammenfassung der fundamentalen Begründung}
	
	\subsubsection{Die drei Säulen der Herleitung}
	...
	\subsubsection{Die Primfaktor-Zerlegung als Beweis}
	...
	\subsubsection{Das vollständige System}
	
	\subsubsection{Konsistenz über alle Massenverhältnisse}
	...
	\subsubsection{$\kappa = 7$ ist nicht angepasst}
	...
	\subsubsection{Die echte Herleitung}
	...
	\subsubsection{Fundamentale Konstanten und Parameter}
	...
	\subsubsection{Teilchenmassen und Verhältnisse}
	...
	\subsubsection{Physikalische Konstanten und Längen}
	...
	\subsubsection{Mathematische Symbole und Operatoren}
	...
	\subsubsection{Musikalische und geometrische Konzepte}
	...
	\subsubsection{Wichtige Formeln und Beziehungen}
