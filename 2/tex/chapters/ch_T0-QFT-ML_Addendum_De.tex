% Chapter content extracted from T0-QFT-ML_Addendum_De.tex
...
\begin{abstract}
	...
	\subsubsection{Einleitung: Von Grundlagen zu ML-verbesserten Vorhersagen}
	...
	\subsubsection{Umfang und Struktur}
	...
	\subsubsection{ML-abgeleitete Bell-Test-Erweiterungen}
	
	\subsubsection{Motivation: Loophole-freie 2025-Tests}
	...
	\subsubsection{ML-trainierte Bell-Korrelationen}
	...
	\subsubsection{$\xi$-Anpassung aus 73-Qubit-Daten}
	...
	\subsubsection{ML-abgeleitete Quantenmechanik-Korrekturen}
	
	\subsubsection{Wasserstoff-Spektroskopie: Hoch-$n$-Divergenzen}
	...
	\subsubsection{Dirac-Gleichung: Spin-abhängige Korrekturen}
	...
	\subsubsection{ML-abgeleitete Neutrino-Physik}
	
	\subsubsection{$\xi^2$-Unterdrückungsmechanismus}
	...
	\subsubsection{DUNE-Vorhersagen (Integrierte $\xi$-Anpassung)}
	...
	\subsubsection{Vereinheitlichtes fraktales Framework über Skalen}
	
	\subsubsection{Universelles Dämpfungsmuster}
	...
	\subsubsection{Emergente nicht-störungstheoretische Struktur}
	...
	\subsubsection{$\phi$-Skalierungsdominanz}
	...
	\subsubsection{Unmittelbare Tests}
	...
	\subsubsection{Mittelfristige Tests}
	...
	\subsubsection{Kritische Bewertung und philosophische Implikationen}
	
	\subsubsection{ML-Rolle: Kalibrierung vs.~Entdeckung}
	...
	\subsubsection{Determinismus vs.~praktische Unvorhersagbarkeit}
	...
	\subsubsection{Synthese: Das T0-ML-vereinheitlichte Bild}
	
	\subsubsection{Drei-Ebenen-Hierarchie der T0-Theorie}
	...
	\subsubsection{Vorhersagekraft-Vergleich}
	...
	\subsubsection*{Zusammenfassung: ML als T0's Präzisionsinstrument}
	
	\subsubsection{Zusammenfassung der Hauptergebnisse}
	...
	\subsubsection{Technische Details: ML-Simulationsprotokolle}
	
	\subsubsection{Neuronale Netzwerk-Architekturen}
	...
	\subsubsection{Glossar der Schlüsselbegriffe}
