% Chapter content extracted from Hannah_De.tex
...
\begin{abstract}
	...
	\subsubsection{Einführung in Cairos Gegenbeispiel}
	...
	\subsubsection{Übersicht über die T0-Zeit-Masse-Dualitätstheorie}
	...
	\subsubsection{Konzeptionelle Verbindungen}
	
	\subsubsection{Fraktale Geometrie und Kontinuum-Verluste}
	...
	\subsubsection{Dispersive Wellen im $T(x,t)$-Feld}
	...
	\subsubsection{Vereinheitlichungsimplikationen}
	...
	\subsubsection{Auflösung der Stein-Vermutung in T0}
	...
	\subsubsection{Experimentelle Konsequenzen für die Quantenphysik}
	
	\subsubsection{Wellenausbreitung in fraktalen Medien}
	...
	\subsubsection{Beobachtbare Vorhersagen}
	...
	\subsubsection{T0-Modellierung Schrödinger-ähnlicher PDEs: Effekte fraktaler Korrekturen}
	
	\subsubsection{Modifizierte Schrödinger-Gleichung in T0}
	...
	\subsubsection{Effekte auf Lösungsstruktur und Spektrum}
