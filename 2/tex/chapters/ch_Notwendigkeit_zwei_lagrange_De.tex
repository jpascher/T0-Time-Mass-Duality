% Chapter content extracted from Notwendigkeit_zwei_lagrange_De.tex
% For book integration

\subsubsection{Einleitung: Mathematische Modelle und ontologische Realität}
	
	\subsubsection{Die Natur physikalischer Theorien}
	...
	\subsubsection{Das Paradox der fundamentalen Einfachheit}
	...
	\subsubsection{Zwei komplementäre Modellierungsansätze}
	...
	\subsubsection{Die zwei Varianten der Lagrange-Dichte}
	
	\subsubsection{Vereinfachte T0-Lagrange-Dichte}
	...
	\subsubsection{Erweiterte Standard-Modell Lagrange-Dichte mit T0-Korrekturen}
	...
	\subsubsection{Parallelität zu den Wellengleichungen}
	
	\subsubsection{Vereinfachte Dirac-Gleichung (T0-Version)}
	...
	\subsubsection{Erweiterte Schrödinger-Gleichung (T0-modifiziert)}
	...
	\subsubsection{T0-Erweiterungen: Vereinigung von RT, SM und QFT}
	
	\subsubsection{Die minimalen T0-Korrekturen}
	...
	\subsubsection{Warum funktioniert das SM so gut?}
	...
	\subsubsection{Das Zeitfeld als Brücke}
	...
	\subsubsection{Praktische Anwendungen und Vorhersagen}
	
	\subsubsection{Experimentell verifizierbare T0-Effekte}
	...
	\subsubsection{Konzeptuelle Verbesserungen}
	...
	\subsubsection{Warum brauchen wir beide Ansätze?}
	
	\subsubsection{Komplementarität der Beschreibungen}
	...
	\subsubsection{Philosophische Perspektive: Von der Erfahrung zur Abstraktion}
	
	\subsubsection{Die Hierarchie der Beschreibungsebenen}
	...
	\subsubsection{Das Entfremdungsparadox}
	...
	\subsubsection{Warum verschiedene Beschreibungsebenen notwendig sind}
	...
	\subsubsection{Die Rolle der Mathematik als Vermittler}
	...
	\subsubsection{Fazit: Die unvermeidliche Spannung zwischen Fundamentalität und Erfahrung}
