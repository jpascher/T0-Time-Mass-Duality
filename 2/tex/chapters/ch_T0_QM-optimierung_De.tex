% Chapter content extracted from T0_QM-optimierung_De.tex
...
\thispagestyle{fancy}
	...
	\subsubsection{Einleitung: Vom Hilbertraum zum physikalischen Raum}
	...
	\subsubsection{Der geometrische Formalismus der T0-Quantenmechanik}
	
	\subsubsection{Qubit-Zustand als Punkt im zylindrischen Phasenraum}
	...
	\subsubsection{Einzel-Qubit-Gatter als geometrische Transformationen}
	...
	\subsubsection{Zwei-Qubit-Gatter: Das geometrische CNOT}
	...
	\subsubsection{System-Level-Optimierungen aus dem Formalismus}
	...
	\subsubsection{T0-Topologie-Compiler: Die Geometrie der Verschränkung}
	...
	\subsubsection{Harmonische Resonanz: Qubits im Einklang mit dem Universum}
	...
	\subsubsection{Aktive Kohärenzerhaltung durch Zeitfeld-Modulation}
	...
	\subsubsection{Synthese: Der T0-kompilierte Quantencomputer}
