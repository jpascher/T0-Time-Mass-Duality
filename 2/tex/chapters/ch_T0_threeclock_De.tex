% Chapter content extracted from T0_threeclock_De.tex
...
\subsubsection{Zeitstandard und Grundannahmen des Artikels}

\subsubsection{Ein einzelner Zeitstandard}
...
\subsubsection{Relativistischer Rahmen}
...
\subsubsection{Längenmessung aus Zeit: Drei-Uhren-Konstruktion}

\subsubsection{Prinzip des Verfahrens}
...
\subsubsection{Operationale Interpretation}
...
\subsubsection{Massenbestimmung aus Frequenzen und Zeit}
\label{sec:massenbestimmung}

\subsubsection{Elementarteilchen: Compton-Beziehung}
...
\subsubsection{Makroskopische Massen: Kibble-Balance}
...
\subsubsection{Zusammenhang mit den T0-Dokumenten}
\label{sec:t0_zusammenhang}

\subsubsection{T0\_SI\_De: Von $\xi$ zu SI-Konstanten}
...
\subsubsection{T0\_xi\_ursprung\_De: Massenskalierung und $\xi$}
...
\subsubsection{T0\_xi-und-e\_De: Zeit-Masse-Dualität}
...
\subsubsection{Quantengravitation und Gültigkeitsbereich}
