% Chapter content extracted from T0_g2-erweiterung-4_De.tex
...
\begin{abstract}
	...
	\subsubsection{Grundparameter der T0-Theorie}
	\label{sec:parameter}
	
	\subsubsection{Etablierte Parameter}
	...
	\subsubsection{Validierte Leptonen-Formel}
	...
	\subsubsection{Finale Hadronen-Formel}
	\label{sec:hadronen_formel}
	
	\subsubsection{Universeller QCD-Faktor}
	...
	\subsubsection{Physikalisch abgeleitete Korrekturfaktoren}
	...
	\subsubsection{Numerische Ergebnisse und Validierung}
	\label{sec:ergebnisse}
	
	\subsubsection{Experimentelle Referenzdaten}
	\label{subsec:daten}
	...
	\subsubsection{Finale Berechnungsergebnisse}
	...
	\subsubsection{Fraktale QCD-Erweiterung}
	...
	\subsubsection{Universalität der m²-Skalierung}
	...
	\subsubsection{Erreichte Ergebnisse}
	...
	\appendix
	\subsubsection{Anhang: Python Implementierung}
	\label{sec:anhang}
