% Chapter content extracted from T0_tm-erweiterung-x6_De.tex
...
\begin{abstract}
	...
	\subsubsection{Berechnung der Elektron- und Myon-Massen in der T0-Theorie: Die Fundamentale Basis}
	...
	\subsubsection{Historische Entwicklung: Zwei komplementäre Ansätze}
	...
	\subsubsection{Methode 1: Direkte geometrische Resonanz (Leptonenbasis)}
	...
	\subsubsection{Methode 2: Erweiterte fraktale Formel mit QCD-Integration}
	...
	\subsubsection{Erweiterungen der T0-Theorie}
	...
	\subsubsection{Theoretische Konsistenz und Renormierung}
	...
	\subsubsection{ML-Optimierung der T0-Massenformeln: Finale Iteration mit Physik-Constraints (Stand Nov 2025)}
	...
	\subsubsection{Verbindung zu anderen T0-Dokumenten}
	...
	\subsubsection{Detaillierte Erklärung der Fraktalen Massenformel}
	...
	\subsubsection{Physikalische Interpretation der Erweiterungen}
	\begin{itemize}
	...
	\subsubsection{Vergleich zum Standardmodell und Ausblick}
	...
	\subsubsection{Neutrino-Mixing: Eine detaillierte Erklärung (aktualisiert mit PDG 2024)}
	\label{app:neutrino}
	...
	\subsubsection{Historischer Kontext: Vom ``Solar Neutrino Problem'' zur Entdeckung}
	...
	\subsubsection{Theoretische Grundlagen: Die PMNS-Matrix}
	...
	\subsubsection{Neutrino-Oszillationen: Die Physik dahinter}
	...
	\subsubsection{Experimentelle Evidenz}
	...
	\subsubsection{Offene Fragen und Ausblick}
	...
	\subsubsection{Vollständige Massentabelle (calc\_De.py v3.2)}
	...
	\subsubsection{Mathematische Ableitungen}
	\label{app:mathematics}
	
	\subsubsection{Herleitung der erweiterten T0-Massenformel}
	...
	\subsubsection{Renormierungsgruppen-Behandlung und Dynamik-Faktoren}
	...
	\subsubsection{ML-Integration und Constraints}
	...
	\subsubsection{Dimensionsanalyse und Konsistenzprüfung}
	...
	\newpage	
	\subsubsection{Numerische Tabellen}
	\label{app:tables}
	
	\subsubsection{Vollständige Quantenzahlen-Tabelle}
	...
	\subsubsection{Notation und Symbole}
	\label{app:notation}
	...
	\end{table}
	\newpage		
	\subsubsection{Python Implementierung zur Nachrechnung}
	...
	\subsubsection*{Autorenbeitrag und Datenverfügbarkeit}
	...
	\subsubsection*{Anhang: Optimierte T0-ML-Simulation: Finale Iteration und Lernergebnisse (Stand: 03. November 2025)}
	...
	\subsubsection*{Finaler Trainingsverlauf (Ausgaben alle 1000 Epochen, bester Lauf)}
	\begin{tabular}{|c|c|}
		\hline
	...
	\subsubsection*{Finale Vorhersagen vs. Experimentelle Werte (GeV, post-hoc K\_corr)}
	...
	\subsubsection*{Was wir gelernt haben: Lernergebnisse aus der Iteration}
	...
	\subsubsection*{Finale Formeln der T0-Massentheorie (nach ML-Optimierung)}
