% Chapter content extracted from redshift_deflection_De.tex
...
\begin{abstract}
	...
	\subsubsection{Fundamentaler $\xi$-Feld-Energieverlust}
	\label{sec:xi_field}
	
	\subsubsection{Grundmechanismus}
	...
	\subsubsection{Energie-zu-Wellenl\"ange-Umwandlung}
	...
	\subsubsection{Rotverschiebungsformel-Ableitung}
	
	\subsubsection{Integration f\"ur kleine $\xi$-Effekte}
	...
	\subsubsection{Rotverschiebungsdefinition und Formel}
	...
	\subsubsection{Konsistenz mit beobachteten Rotverschiebungen}
	...
	\subsubsection{Frequenzbasierte Formulierung}
	
	\subsubsection{Frequenz-Energieverlust}
	...
	\subsubsection{Frequenz-Rotverschiebungsformel}
	...
	\subsubsection{Beobachtbare Vorhersagen ohne Entfernungsannahmen}
	
	\subsubsection{Spektrallinienverh\"altnisse}
	...
	\subsubsection{Frequenzabh\"angige Effekte}
	...
	\subsubsection{Experimentelle Tests mittels Spektroskopie}
	\label{sec:experimental_tests}
	
	\subsubsection{Multiwellenl\"angen-Beobachtungen}
	...
	\subsubsection{Radio vs. optische Rotverschiebung}
	...
	\subsubsection{Vorteile gegen\"uber der Standardkosmologie}
	
	\subsubsection{Modellunabh\"angiger Ansatz}
	...
	\subsubsection{Vereinheitlichte Erkl\"arungen}
	...
	\subsubsection{Kritische Bewertung: Wellenl\"angenabh\"angigkeit an der Nachweisschwelle}
	\label{sec:wavelength_assessment}
	
	\subsubsection{Aktueller experimenteller Status und Messbegrenzungen}
	...
	\subsubsection{Zuk\"unftige experimentelle Ergebnisse und ihre Implikationen}
	...
	\subsubsection{Unter-Szenario B1: Fundamentaler T0-Mechanismus inkorrekt}
	...
	\subsubsection{Unter-Szenario B2: Wellenl\"angenabh\"angigkeit existiert, ist aber KOMPENSIERT}
	...
	\subsubsection{Die verd\"achtige Koinzidenz}
	...
	\subsubsection{Entscheidungsbaum f\"ur zuk\"unftige Beobachtungen}
	...
	\subsubsection{Fazit: Eine Theorie am Scheideweg}
	...
	\subsubsection{Statistische Analysemethode}
	
	\subsubsection{Multi-Linien-Regression}
	...
	\subsubsection{Erforderliche Pr\"azision}
	...
	\subsubsection{Mathematische \"Aquivalenz von Raumdehnung, Energieverlust und Beugung}
	\label{sec:equivalence}
	
	\subsubsection{Formale \"Aquivalenzbeweise}
	...
	\subsubsection{Energieerhaltung und Thermodynamik}
	...
	\subsubsection{Implikationen f\"ur die Kosmologie}
	
	\subsubsection{Statisches Universumsmodell}
	...
	\subsubsection{Aufl\"osung kosmologischer Spannungen}
	...
	\subsubsection{Robustheit der T0-Kernvorhersagen}
	
	\subsubsection{Unabh\"angig vom Rotverschiebungsmechanismus}
	...
	\subsubsection{Adaptivit\"at der theoretischen Struktur}
