% Chapter content from: 039_T0_Anomale-g2-6_En.tex
...
\section*{List of Symbols}
	...
	\scriptsize
	\begin{longtable}{p{1.2cm}p{1.5cm}p{1.1cm}p{2.5cm}p{2.5cm}p{1.2cm}p{2cm}}
	...
	\scriptsize
	\begin{longtable}{p{1cm}p{1.5cm}p{0.8cm}p{2.8cm}p{2.5cm}p{1.4cm}p{2.2cm}}
