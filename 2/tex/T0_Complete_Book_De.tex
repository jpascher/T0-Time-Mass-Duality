...
\input{completed/MathZeitMasseLagrangeDe}

\chapter{g-2 Erweiterung}
\input{completed/T0_g2-erweiterung-4_De}

\chapter{Ampère bei niedrigen Frequenzen}
\input{completed/Amper_Low_De}

\chapter{Ableitung von Beta}
\input{completed/DerivationVonBetaDe}

\chapter{Frequenzunabhängigkeit}
\input{completed/T0_freqeunz_De}

\chapter{Universale Ableitung}
\input{completed/universale-ableitung_De}

\chapter{T0-Umkehrung}
\input{completed/T0_umkehrung_De}

\chapter{Dynamische Masse von Photonen}
\input{completed/DynMassePhotonenNichtlokalDe}

\chapter{Zeit-Konstanten}
\input{completed/Zeit-konstant_De}

\chapter{Zeit in der T0-Theorie}
\input{completed/Zeit_De}

\chapter{Zusammenfassung}
\input{completed/Zusammenfassung_De}
