\chapter[Mole and Candela in T0 Theory]{Mole and Candela in T0 Theory}
...
\textbf{T0 result:}
	...
	\begin{equation}
		...
		\label{Moll_CandelaEn_:L-Moll_CandelaEn-1076_2}
	\end{equation}
...
\begin{enumerate}
	...
	\item \textbf{T0 calculation:} Compute $n_{\text{T0}}$ using Eq.~\ref{Moll_CandelaEn_:L-Moll_CandelaEn-1047}
...
\begin{enumerate}
	...
	\item \textbf{T0 calculation:} Apply T0 visual efficiency function Eq.~\ref{Moll_CandelaEn_:L-Moll_CandelaEn-1074}
	\item \textbf{Intensity calculation:} Compute $I_{\text{T0}}$ using Eq.~\ref{Moll_CandelaEn_:L-Moll_CandelaEn-1066}
