...
\chapter{Conceptual Comparison of Unified Natural Units and Extended Standard Model: \\}
	...
	\begin{itemize}
		...
		\item All quantum electrodynamic precision tests \cite{068_pascher_muon_g2_2025}
	\end{itemize}
	...
	\begin{itemize}
		...
		\item The gravitational mechanism for redshift through energy attenuation rather than cosmic expansion \cite{068_Adams1925,068_Pound1960}
		\item The ontological status and physical interpretation of the respective fields
		\item The mathematical formulation of gravitational interactions within unified natural units \cite{068_pascher_lagrangian_2025}
	...
	These unity values are not imposed arbitrarily but derived from the requirement that the theoretical framework be internally consistent and dimensionally natural \cite{068_pascher_beta_derivation_2025}. The key insight is that when this principle is applied rigorously, both $\alphaEM$ and $\betaT$ naturally assume unity values through self-consistency requirements rather than empirical adjustment.
	
	\subsection{Transformation Between Frameworks}
	\label{068_subsec:transformation}
	...
	while ESM-2 introduces $\Theta$ to reproduce unified system results without independent physical foundation \cite{068_pascher_lagrangian_2025}.
	
	\subsection{Gravitational Potential in Both Frameworks}
	\label{068_subsec:gravitational_potential}
	...
	\end{equation}
	where $\xipar = 2\sqrt{G} \cdot m$ is the scale parameter connecting Planck and particle scales \cite{068_pascher_beta_derivation_2025}.
	...
	\label{068_subsec:equivalence_vs_independence}
	...
	\begin{itemize}
		...
		\item \textbf{Ontological Indistinguishability}: No experimental test can determine which description represents "true" reality \cite{068_vanFraassen1980}
		\item \textbf{Different Conceptual Basis}: Unity through natural units vs. scalar field modifications
	\end{itemize}
	
	This is fundamentally different from the Standard Model, which makes completely different predictions (expanding universe, wavelength-independent redshift, dark matter/energy requirements, etc.) \cite{068_Riess1998,068_McGaugh2016}.
	
	\subsection{Field Equations in Unified Context}
	\label{068_subsec:field_equations_unified}
	...
	The self-consistency condition requires that electromagnetic interactions ($\alphaEM = 1$) and time field interactions ($\betaT = 1$) have the same natural strength, eliminating arbitrary numerical factors \cite{068_pascher_beta_derivation_2025}.
	
	\subsection{Dimensional Structure in Natural Units}
	\label{068_subsec:dimensional_structure}
	...
	This dimensional structure ensures that the intrinsic time field has the correct dimensions and couples naturally to both electromagnetic and gravitational phenomena \cite{068_pascher_lagrangian_2025}.
	
	\subsection{Field-Theoretic Nature with Self-Consistent Coupling}
	\label{068_subsec:field_theoretic_self_consistent}
	...
	The self-consistent nature of this formulation means that no arbitrary parameters are introduced—all coupling strengths emerge from the requirement of theoretical consistency \cite{068_pascher_unified_2025}.
	
	\subsection{Connection to Fundamental Scale Parameters}
	\label{068_subsec:fundamental_scales}
	...
	demonstrating that the small hierarchy between different energy scales emerges naturally from the structure of the theory rather than requiring fine-tuning \cite{068_pascher_beta_derivation_2025}.
	
	\subsection{Gravitational Emergence from Unified Principles}
	\label{068_subsec:gravitational_emergence_unified}
	...
	The linear term $\kappa r$ emerges naturally from the self-consistent field dynamics, providing unified explanations for both galactic rotation curves and cosmic acceleration without requiring separate dark matter or dark energy components \cite{068_McGaugh2016}.
	
	\section{The Extended Standard Model's Scalar Field}
	\label{068_sec:esm_scalar_field}
	...
	\label{068_subsec:two_operational_modes}
	...
	\label{068_subsubsec:mode1_sm_extension}
	...
	\begin{itemize}
		\item $\alphaEM \approx 1/137$ (conventional fine-structure constant) \cite{068_PDG2020}
	...
	\label{068_par:practical_implementation}
	...
	\begin{enumerate}
		...
		\item Maintain compatibility with existing experimental data and theoretical frameworks \cite{068_Peskin1995}
	...
	\label{068_subsubsec:mode2_unified_reproduction}
	...
	\label{068_par:practical_advantages_mode1}
	...
	\label{068_subsec:parameter_adoption}
	...
	\begin{itemize}
		...
		\item $\xipar = 1.33 \times 10^{-4}$ (from Higgs sector analysis \cite{068_pascher_beta_derivation_2025})
	...
	\label{068_subsec:mathematical_equivalence_parameters}
	...
	\begin{itemize}
		...
		\item \textbf{Ontological Indistinguishability}: No experimental method exists to determine which mathematical description represents the "true" nature of reality \cite{068_Duhem1906,068_Poincare1905}
	\end{itemize}
	
	This complete mathematical equivalence between ESM-2 and the unified system means that both frameworks make identical predictions for all measurable quantities. The choice between them becomes a matter of conceptual preference rather than empirical decidability—a fundamental limitation in distinguishing between mathematically equivalent theories \cite{068_vanFraassen1980}.
	
	This approach contrasts with both the Standard Model (which has its own independent parameter values and makes different predictions \cite{068_Weinberg1989}) and Mode 1 ESM operation (which extends SM calculations with additional scalar field effects).
	
	\subsection{Gravitational Energy Attenuation Mechanism}
	\label{068_subsec:gravitational_energy_attenuation}
	...
	\begin{itemize}
		...
		\item Connects to established laboratory observations of gravitational redshift \cite{068_Pound1960,068_Bertotti2003}
	\end{itemize}
	...
	\label{068_subsec:geometrical_challenges}
	
	One potential interpretation of the scalar field $\Theta$ involves higher-dimensional geometry, drawing parallels to:
	
	\begin{itemize}
		\item Kaluza-Klein theory's fifth dimension \cite{068_Kaluza1921,068_Klein1926}
		\item Brane models in string theory \cite{068_Randall1999}
		\item Scalar-tensor theories of gravity \cite{068_Brans1961}
	\end{itemize}
	...
	\label{068_subsec:gravitational_modification_esm}
	...
	\begin{itemize}
		...
		\item Both frameworks explain redshift through gravitational energy attenuation rather than cosmic expansion, connecting to established gravitational redshift observations \cite{068_Adams1925,068_Shapiro1971}
	\end{itemize}
	
	\section{Conceptual Comparison: Four Theoretical Approaches}
	\label{068_sec:four_framework_comparison}
	...
	\label{068_subsec:four_way_comparison}
	
	\begin{table}[ht]
		\centering
		\caption{Four-way theoretical framework comparison}
		\label{068_tab:four_framework_comparison}
		\resizebox{\textwidth}{!}{
\begin{tabular}{p{0.2\textwidth}|p{0.18\textwidth}|p{0.18\textwidth}|p{0.18\textwidth}|p{0.18\textwidth}}
			...
			\hline
			Cosmic evolution & Expanding universe \cite{068_Riess1998} & Flexible (scalar dependent) & Static universe & Static universe \\
			\hline
			Redshift mechanism & Doppler expansion & SM + scalar corrections & Gravitational energy loss & Gravitational energy loss \\
			\hline
			Dark matter/energy & Required \cite{068_Planck2020} & Scalar explanations & Eliminated & Naturally eliminated \\
			\hline
	...
	\label{068_subsec:esm_reformulation_vs_extension}
	...
	\begin{table}[ht]
		...
		\label{068_tab:esm_modes_comparison}
		\begin{tabular}{p{0.45\textwidth}|p{0.45\textwidth}}
			...
			\hline
			Ontologically distinguishable from other approaches & Ontologically indistinguishable from unified system \cite{068_Duhem1906} \\
			\hline
		\end{tabular}
	\end{table}
	
	Mode 1 represents the ESM's most practical contribution to theoretical physics, allowing researchers to maintain computational familiarity while exploring scalar field extensions. This approach can potentially resolve anomalies like the muon g-2 discrepancy \cite{068_pascher_muon_g2_2025} through additional scalar field terms while preserving the entire infrastructure of Standard Model calculations.
	
	\subsection{Self-Consistency vs. Phenomenological Adjustment}
	\label{068_subsec:self_consistency_comparison}
	
	\begin{table}[ht]
		\centering
		\caption{Comparison of theoretical foundations}
		\label{068_tab:theoretical_foundations}
		\begin{tabular}{p{0.45\textwidth}|p{0.45\textwidth}}
			\hline
			\textbf{Unified Natural Units ($\alphaEM = \betaT = 1$)} & \textbf{Extended Standard Model Mode 2} \\
			\hline
			Self-consistent derivation from theoretical principles \cite{068_pascher_unified_2025} & Phenomenological scalar field calibrated to reproduce unified results \\
			\hline
			...
			\hline
			Natural hierarchy through $\xipar$ parameter \cite{068_pascher_beta_derivation_2025} & Hierarchy reproduced but not independently derived \\
			\hline
	...
	\begin{table}[ht]
		...
		\begin{tabular}{p{0.45\textwidth}|p{0.45\textwidth}}
			...
			\hline
			Ontologically distinct from ESM-1 but indistinguishable from ESM-2 \cite{068_vanFraassen1980} & Ontologically indistinguishable from unified system \\
			\hline
		\end{tabular}
	\end{table}
	
	The unified system assigns a clear ontological status to the intrinsic time field as a fundamental property of reality that emerges from the time-mass duality principle. The field has direct physical meaning and provides intuitive explanations for a wide range of phenomena \cite{068_pascher_pragmatic_2025}. However, the mathematical equivalence between the unified system and ESM-2 means that no experimental test can determine which ontological interpretation represents the true nature of reality \cite{068_Poincare1905}.
	
	\subsection{Mathematical Elegance and Complexity}
	\label{068_subsec:mathematical_elegance}
	...
	\label{068_subsubsec:dimensional_simplification}
	...
	\label{068_subsubsec:unified_field_equations}
	...
	provides a natural coupling between matter and the temporal structure of spacetime \cite{068_pascher_lagrangian_2025}.
	
	\subsubsection{Parameter Relationships}
	\label{068_subsubsec:parameter_relationships}
	...
	These relationships emerge naturally from the theory's structure rather than being imposed externally \cite{068_pascher_beta_derivation_2025}.
	
	\subsection{Conceptual Unification vs. Fragmentation}
	\label{068_subsec:unification_fragmentation}
	...
	\begin{itemize}
		...
		\item \textbf{Redshift Mechanism Unity}: Both local gravitational redshift and cosmological redshift arise from the same energy attenuation mechanism \cite{068_Pound1960}
	\end{itemize}
	...
	\label{068_sec:experimental_predictions}
	...
	\label{068_subsec:wavelength_dependent_redshift}
	...
	This logarithmic dependence is a direct consequence of the self-consistent coupling strength and provides a natural explanation for the observed wavelength dependence in cosmological redshift \cite{068_pascher_unified_2025}.
	...
	\label{068_subsec:cmb_evolution}
	...
	\label{068_subsec:coupling_variations}
	...
	where the natural value $\alphaEM = 1$ is modified by local gravitational conditions. This provides a testable prediction that distinguishes the unified framework from conventional approaches \cite{068_Will2014,068_Webb2001}.
	
	\subsection{Hierarchy Relationships}
	\label{068_subsec:hierarchy_relationships}
	...
	This ratio emerges from the theoretical structure rather than requiring fine-tuning, providing a natural solution to the hierarchy problem \cite{068_pascher_beta_derivation_2025}.
	
	\subsection{Laboratory Tests of Gravitational Energy Attenuation}
	\label{068_subsec:laboratory_tests}
	...
	\begin{itemize}
		\item Pound-Rebka gravitational redshift experiments \cite{068_Pound1960}
		\item GPS satellite clock corrections \cite{068_Ashby2003}
		\item Atomic clock comparisons in gravitational fields \cite{068_Ludlow2015}
		\item Solar system tests of general relativity \cite{068_Bertotti2003}
	\end{itemize}
	...
	\label{068_subsec:quantum_gravity_unification}
	...
	\begin{itemize}
		...
		\item \textbf{Dimensional Consistency}: All quantum field theory calculations maintain natural dimensions \cite{068_pascher_lagrangian_2025}
	\end{itemize}
	...
	\label{068_subsec:cosmological_framework}
	...
	\label{068_subsubsec:unified_cosmology}
	...
	\label{068_subsubsec:esm_cosmology}
	...
	\label{068_subsec:solar_system_observations}
	
	All frameworks connect to established observations of electromagnetic wave deflection and energy loss near massive bodies \cite{068_Adams1925,068_Pound1960,068_Bertotti2003,068_Shapiro1971}, but they provide different explanations:
	...
	Recent precision measurements of gravitational lensing and solar system tests \cite{068_Bolton2008,068_Suyu2017} provide opportunities to distinguish between the unified approach's natural parameter relationships and conventional approaches, while highlighting the mathematical equivalence between unified natural units and ESM-2.
	
	\section{Philosophical and Methodological Considerations}
	\label{068_sec:philosophical_considerations}
	...
	\label{068_subsec:theoretical_virtues}
	...
	\begin{table}[ht]
		...
		\label{068_tab:theoretical_virtues}
		\resizebox{\textwidth}{!}{
\begin{tabular}{p{0.25\textwidth}|p{0.22\textwidth}|p{0.22\textwidth}|p{0.22\textwidth}}
	...
	\label{068_subsec:ontological_underdetermination}
	
	The mathematical equivalence between the unified natural unit system and ESM-2 illustrates a fundamental problem in philosophy of science: ontological underdetermination \cite{068_Duhem1906,068_Quine1951}. When two theories make identical predictions for all possible observations, there exists no empirical method to determine which theory correctly describes the nature of reality.
	...
	\begin{itemize}
		...
		\item \textbf{Theoretical Virtues}: Should theoretical elegance, conceptual clarity, and explanatory power guide theory choice when empirical criteria fail to discriminate? \cite{068_Kuhn1977}
		...
		\item \textbf{Historical Precedent}: How have similar situations been resolved in the history of physics? \cite{068_Poincare1905}
	\end{itemize}
	
	The case of electromagnetic theory provides historical precedent: Maxwell's field-theoretic formulation and various action-at-a-distance formulations were empirically equivalent, yet the field-theoretic approach was ultimately preferred for its conceptual elegance and unifying power \cite{068_Maxwell1873}.
	
	\subsection{The Role of Natural Units in Physical Understanding}
	\label{068_subsec:natural_units_understanding}
	
	The unified natural unit system demonstrates that choice of units is not merely a matter of convenience but can reveal fundamental physical relationships. When Einstein set $c = 1$ in relativity or when quantum theorists set $\hbar = 1$, they uncovered natural relationships that simplified both mathematics and physical insight \cite{068_Einstein1905,068_Dirac1927}.
	
	The extension to $\alphaEM = \betaT = 1$ represents the logical completion of this program, revealing that dimensionless coupling constants should also achieve natural values when the theory is formulated in its most fundamental form \cite{068_pascher_unified_2025}. This suggests that:
	...
	\label{068_subsec:emergence_imposition}
	...
	This emergence provides theoretical understanding of why these parameters have their observed values \cite{068_pascher_beta_derivation_2025}.
	...
	The philosophical question becomes: Should theoretical understanding prioritize parameter emergence from first principles (unified approach) or empirical adequacy through flexible parametrization (ESM approaches)? \cite{068_vanFraassen1980}
	
	\subsection{Computational Pragmatism vs. Conceptual Elegance}
	\label{068_subsec:pragmatism_vs_elegance}
	...
	\label{068_subsec:precision_tests}
	...
	\begin{itemize}
		...
		\item Laboratory searches for time field gradients using atomic clock networks \cite{068_Ludlow2015}
		\item Precision tests of the muon g-2 anomaly prediction \cite{068_pascher_muon_g2_2025}
		\item Gravitational coupling constant measurements in laboratory settings \cite{068_Quinn2013}
	...
	\label{068_subsubsec:esm_development}
	...
	\begin{itemize}
		...
		\item Connection to effective field theory approaches \cite{068_Weinberg1979}
	\end{itemize}
	...
	\label{068_subsec:experimental_programs}
	
	\subsubsection{Cosmological Tests}
	\label{068_subsubsec:cosmological_tests}
	...
	\begin{itemize}
		...
		\item \textbf{Dark Matter Alternatives}: Tests of modified gravity predictions for galactic rotation curves and cluster dynamics \cite{068_McGaugh2016}
	\end{itemize}
	
	\subsubsection{Laboratory Tests}
	\label{068_subsubsec:laboratory_tests}
	
	\begin{itemize}
		\item \textbf{Precision Electrodynamics}: High-precision tests of QED predictions in the unified framework \cite{068_pascher_muon_g2_2025}
		\item \textbf{Gravitational Redshift}: Enhanced precision measurements of photon energy loss in gravitational fields \cite{068_Pound1960,068_Ludlow2015}
		...
		\item \textbf{Coupling Constant Variation}: Tests for apparent fine-structure constant variations in different gravitational environments \cite{068_Webb2001}
	\end{itemize}
	
	\subsection{Technological Applications}
	\label{068_subsec:technological_applications}
	
	The unified understanding of electromagnetic and gravitational interactions may lead to technological applications:
	
	\begin{itemize}
		\item \textbf{Precision Navigation}: Enhanced GPS and navigation systems based on time field gradient mapping \cite{068_Ashby2003}
	...
	\label{068_subsec:interdisciplinary_connections}
	
	\subsubsection{Mathematics and Geometry}
	\label{068_subsubsec:mathematics_geometry}
	...
	\label{068_subsubsec:philosophy_science}
	
	\begin{itemize}
		\item Studies of ontological underdetermination in mathematically equivalent theories \cite{068_Duhem1906,068_Quine1951}
		\item Investigation of the role of theoretical virtues in theory selection \cite{068_Kuhn1977}
		\item Analysis of the relationship between mathematical elegance and physical understanding
		\item Examination of the pragmatic vs. realist approaches to theoretical physics \cite{068_vanFraassen1980}
	\end{itemize}
	
	\subsubsection{Computational Science}
	\label{068_subsubsec:computational_science}
	...
	\label{068_subsec:key_findings}
	
	The unified natural unit system offers several decisive advantages:
	
	\begin{enumerate}
		\item \textbf{Self-Consistent Derivation}: Both $\alphaEM = 1$ and $\betaT = 1$ emerge from theoretical consistency requirements rather than empirical fitting \cite{068_pascher_unified_2025}
		...
		\item \textbf{Natural Parameter Emergence}: The hierarchy parameter $\xipar \approx 1.33 \times 10^{-4}$ emerges from Higgs sector physics without fine-tuning \cite{068_pascher_beta_derivation_2025}
		...
		\item \textbf{Predictive Power}: The framework makes parameter-free predictions for phenomena ranging from quantum electrodynamics to cosmology \cite{068_pascher_muon_g2_2025}
		...
		\item \textbf{Quantum Gravity Path}: Natural incorporation of quantum gravitational effects through the intrinsic time field \cite{068_pascher_lagrangian_2025}
	\end{enumerate}
	...
	\label{068_subsec:theoretical_significance}
	...
	The self-consistent derivation of $\alphaEM = \betaT = 1$ demonstrates that what appear to be separate physical constants may be different aspects of a more fundamental unified interaction. This insight has profound implications for our understanding of the structure of physical law \cite{068_pascher_unified_2025}.
	
	The mathematical equivalence between the unified system and ESM Mode 2 illustrates the philosophical problem of ontological underdetermination—when theories make identical predictions, empirical methods cannot determine which represents the true nature of reality \cite{068_Duhem1906}. This highlights the importance of theoretical virtues such as elegance, simplicity, and explanatory power in scientific theory selection.
	
	\subsection{Experimental and Observational Implications}
	\label{068_subsec:experimental_implications}
	...
	\begin{itemize}
		...
		\item Natural explanation of galactic rotation curves without dark matter \cite{068_McGaugh2016}
		\item Cosmic acceleration through linear gravitational potential term
		\item Connection between local gravitational redshift and cosmological redshift \cite{068_Pound1960}
	\end{itemize}
	...
	\label{068_subsec:philosophical_implications}
	...
	\begin{itemize}
		...
		\item \textbf{Ontological Underdetermination}: When theories make identical predictions, theoretical virtues rather than empirical criteria must guide theory selection \cite{068_vanFraassen1980}
		\item \textbf{Natural Units Revelation}: Choice of units can reveal rather than obscure fundamental physical relationships \cite{068_Dirac1927}
	...
	The unified natural unit system's field-theoretic approach represents not merely an alternative mathematical formulation but a fundamentally different and potentially more illuminating way of understanding the deepest structures of physical reality. The self-consistent emergence of fundamental parameters provides genuine theoretical understanding rather than mere empirical description \cite{068_pascher_pragmatic_2025}.
	
	\subsection{Future Outlook}
	\label{068_subsec:future_outlook}
	...
	\begin{thebibliography}{99}
		...
		\bibitem{068_pascher_unified_2025} 
		...
		\bibitem{068_pascher_beta_derivation_2025} 
		...
		\bibitem{068_pascher_lagrangian_2025} 
		...
		\bibitem{068_pascher_muon_g2_2025} 
		...
		\bibitem{068_pascher_pragmatic_2025} 
		...
		\bibitem{068_pascher_dirac_2025} 
		...
		\bibitem{068_pascher_dynamic_mass_2025} 
		...
		\bibitem{068_pascher_systematik_2025} 
		...
		\bibitem{068_pascher_cmb_temperature_2025} 
		...
		\bibitem{068_Will2014} C. M. Will, \textit{The Confrontation between General Relativity and Experiment}, Living Rev. Rel. \textbf{17}, 4 (2014).
		
		\bibitem{068_Adams1925} W. S. Adams, \textit{The Relativity Displacement of the Spectral Lines in the Companion of Sirius}, Proc. Natl. Acad. Sci. \textbf{11}, 382-387 (1925).
		
		\bibitem{068_Pound1960} R. V. Pound and G. A. Rebka Jr., \textit{Apparent Weight of Photons}, Phys. Rev. Lett. \textbf{4}, 337-341 (1960).
		
		\bibitem{068_Bertotti2003} B. Bertotti, L. Iess, and P. Tortora, \textit{A test of general relativity using radio links with the Cassini spacecraft}, Nature \textbf{425}, 374-376 (2003).
		
		\bibitem{068_Shapiro1971} I. I. Shapiro, M. E. Ash, R. P. Ingalls, W. B. Smith, D. B. Campbell, R. B. Dyce, R. F. Jurgens, and G. H. Pettengill, \textit{Fourth Test of General Relativity: New Radar Result}, Phys. Rev. Lett. \textbf{26}, 1132-1135 (1971).
		
		\bibitem{068_Webb2001} J. K. Webb, M. T. Murphy, V. V. Flambaum, V. A. Dzuba, J. D. Barrow, C. W. Churchill, J. X. Prochaska, and A. M. Wolfe, \textit{Further Evidence for Cosmological Evolution of the Fine Structure Constant}, Phys. Rev. Lett. \textbf{87}, 091301 (2001).
		
		\bibitem{068_Ludlow2015} A. D. Ludlow, M. M. Boyd, J. Ye, E. Peik, and P. O. Schmidt, \textit{Optical atomic clocks}, Rev. Mod. Phys. \textbf{87}, 637-701 (2015).
		
		\bibitem{068_Quinn2013} T. Quinn, H. Parks, C. Speake, and R. Davis, \textit{Improved Determination of G Using Two Methods}, Phys. Rev. Lett. \textbf{111}, 101102 (2013).
		
		\bibitem{068_Ashby2003} N. Ashby, \textit{Relativity in the Global Positioning System}, Living Rev. Rel. \textbf{6}, 1 (2003).
		
		% Kosmologie und Astrophysik
		\bibitem{068_Riess1998} A. G. Riess et al., \textit{Observational Evidence from Supernovae for an Accelerating Universe and a Cosmological Constant}, Astron. J. \textbf{116}, 1009 (1998).
		
		\bibitem{068_McGaugh2016} S. S. McGaugh, F. Lelli, and J. M. Schombert, \textit{Radial Acceleration Relation in Rotationally Supported Galaxies}, Phys. Rev. Lett. \textbf{117}, 201101 (2016).
		
		\bibitem{068_Bolton2008} A. S. Bolton, S. Burles, L. V. E. Koopmans, T. Treu, and L. A. Moustakas, \textit{The Sloan Lens ACS Survey. V. The Full ACS Strong-Lens Sample}, Astrophys. J. \textbf{682}, 964-984 (2008).
		
		\bibitem{068_Suyu2017} S. H. Suyu, V. Bonvin, F. Courbin, et al., \textit{H0LiCOW - I. H0 Lenses in COSMOGRAIL's Wellspring: program overview}, Mon. Not. Roy. Astron. Soc. \textbf{468}, 2590-2604 (2017).
		
		\bibitem{068_Planck2020} N. Aghanim et al. (Planck Collaboration), \textit{Planck 2018 results. VI. Cosmological parameters}, Astron. Astrophys. \textbf{641}, A6 (2020).
		
		% Theoretische Physik Referenzen
		\bibitem{068_Weinberg1989} S. Weinberg, \textit{The Cosmological Constant Problem}, Rev. Mod. Phys. \textbf{61}, 1 (1989).
		
		\bibitem{068_Weinberg1979} S. Weinberg, \textit{Phenomenological Lagrangians}, Physica A \textbf{96}, 327-340 (1979).
		
		\bibitem{068_Peskin1995} M. E. Peskin and D. V. Schroeder, \textit{An Introduction to Quantum Field Theory}, Addison-Wesley, Reading (1995).
		
		\bibitem{068_PDG2020} P. A. Zyla et al. (Particle Data Group), \textit{Review of Particle Physics}, Prog. Theor. Exp. Phys. \textbf{2020}, 083C01 (2020).
		
		% Foundational Papers
		\bibitem{068_Einstein1905} A. Einstein, \textit{Zur Elektrodynamik bewegter Körper}, Ann. Phys. \textbf{17}, 891-921 (1905).
		
		\bibitem{068_Dirac1927} P. A. M. Dirac, \textit{The Quantum Theory of the Emission and Absorption of Radiation}, Proc. Roy. Soc. A \textbf{114}, 243-265 (1927).
		
		\bibitem{068_Maxwell1873} J. C. Maxwell, \textit{A Treatise on Electricity and Magnetism}, Clarendon Press, Oxford (1873).
		
		% Kaluza-Klein und String Theory
		\bibitem{068_Kaluza1921} T. Kaluza, \textit{Zum Unitätsproblem der Physik}, Sitzungsber. Preuss. Akad. Wiss. Berlin. (Math. Phys.) \textbf{1921}, 966–972 (1921).
		
		\bibitem{068_Klein1926} O. Klein, \textit{Quantentheorie und fünfdimensionale Relativitätstheorie}, Z. Phys. \textbf{37}, 895–906 (1926).
		
		\bibitem{068_Randall1999} L. Randall and R. Sundrum, \textit{Large Mass Hierarchy from a Small Extra Dimension}, Phys. Rev. Lett. \textbf{83}, 3370-3373 (1999).
		
		\bibitem{068_Brans1961} C. Brans and R. H. Dicke, \textit{Mach's Principle and a Relativistic Theory of Gravitation}, Phys. Rev. \textbf{124}, 925 (1961).
		
		% Philosophie der Wissenschaft
		\bibitem{068_Duhem1906} P. Duhem, \textit{The Aim and Structure of Physical Theory}, Princeton University Press, Princeton (1954). [Originally published in French, 1906]
		
		\bibitem{068_Quine1951} W. V. O. Quine, \textit{Two Dogmas of Empiricism}, Philos. Rev. \textbf{60}, 20-43 (1951).
		
		\bibitem{068_vanFraassen1980} B. C. van Fraassen, \textit{The Scientific Image}, Oxford University Press, Oxford (1980).
		
		\bibitem{068_Kuhn1962} T. S. Kuhn, \textit{The Structure of Scientific Revolutions}, University of Chicago Press, Chicago (1962).
		
		\bibitem{068_Kuhn1977} T. S. Kuhn, \textit{The Essential Tension: Selected Studies in Scientific Tradition and Change}, University of Chicago Press, Chicago (1977).
		
		\bibitem{068_Poincare1905} H. Poincaré, \textit{Science and Hypothesis}, Walter Scott Publishing, London (1905).
	\end{thebibliography}
