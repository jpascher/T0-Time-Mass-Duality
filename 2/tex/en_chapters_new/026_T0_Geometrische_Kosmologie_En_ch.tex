% Chapter file: 026_T0_Geometrische_Kosmologie_En_ch.tex
% Source: 026_T0_Geometrische_Kosmologie_En.tex
% No preamble, no headers/footers, no page numbers

\chapter{\textbf{T0 Cosmology: Redshift as a Geometric Path Effect in a Static Universe}}
...
\thispagestyle{fancy}
	...
	The Standard Model of Cosmology explains the observed redshift of distant galaxies through the expansion of the universe \cite{026_planck2018}. This model, however, requires the existence of Dark Energy, a mysterious component responsible for the accelerated expansion. The T0-Theory postulates a fundamentally different approach: the universe is static and flat \cite{026_pascher:t0_foundations}. Consequently, redshift cannot be a Doppler effect.
	...
	Comparing this with the Hubble-Lemaître law in the form $c \cdot z = \Hubble \cdot d$, we can cancel the distance $d$ to obtain a fundamental relationship \cite{026_pascher:geometric_formalism}:
	\begin{equation}
	...
	\end{align*}
	This value is within the range of experimentally measured values \cite{026_riess2019} and offers a natural explanation for the "Hubble tension," as slight variations in the mesh geometry in different directions could lead to different measured values.
