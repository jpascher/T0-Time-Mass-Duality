% Chapter file: 014_T0_nat-si_En_ch.tex
% Source: 014_T0_nat-si_En.tex
% Generated from standalone document

\chapter{014 T0 nat-si En}
...
\section*{Abstract}
	...
	\end{equation}
	where $S_{\text{T0}} = 1.782662 \times 10^{-30}$ is the fundamental scaling factor \textbf{derived} in Section~\ref{014_sec:scaling-derivation}, not defined.
	...
	In natural units, physics is reduced to a geometric, dimensionless basis (cf. Section~\ref{014_sec:grundprinzip}). The fundamental constants serve only as a scale, and the core formulas hold approximately without additional corrections because:
