...
\chapter{015 NatEinheitenSystematik En}
...
\begin{tabular}{lllll}
	...
	The Planck units were proposed by Max Planck in 1899 \cite{015_planck1900, 015_planck1906} and are based on the fundamental natural constants:
	\begin{align}
	...
	Planck recognized that these units \textit{``retain their meaning for all times and for all, including extraterrestrial and non-human cultures necessarily''} \cite{015_planck1900}.
	
	\subsection{Atomic Units}
	
	The atomic units, introduced by Hartree in 1927 \cite{015_hartree1957}, set:
	\begin{align}
	...
	In natural units, all physical quantities have dimensions that can be expressed as powers of energy $[E]$ \cite{015_weinberg1995, 015_peskin1995}:
...
\begin{tabular}{lccc}
		...
		\label{015_tab:energy_dimensions}
	\end{table}
...
\begin{tabular}{lccc}
	...
	\begin{table}[htbp]
		...
		\label{015_tab:planck_conversions}
	\end{table}
