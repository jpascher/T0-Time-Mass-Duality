% Chapter file: 032_T0_umkehrung_En_ch.tex
% Source: 032_T0_umkehrung_En.tex
% Generated from standalone document

\chapter{032 T0 umkehrung En}
...
\section*{Abstract}
	...
	\begin{align}
		...
		K_{\text{frac}} &= 1 - 100 \xi \approx 0.9867, \label{032_eq:K} \\
		g_{T0}^2 &= \alpha K_{\text{frac}}, \label{032_eq:gT0} \\
	...
	\label{032_sec:geometric_derivation}
	...
	\label{032_subsec:electron_mass}
	...
	\label{032_subsec:consistency_check}
...
\begin{tabular}{lccc}
		...
		\label{032_tab:method_consistency}
	\end{table}
	...
	\label{032_subsec:torsion_mass}
	
	\begin{align}
		R_f &= \frac{\Gamma(D_f)}{\Gamma(3)} \sqrt{\frac{E_0}{m_e}}, \label{032_eq:Rf} \\
		m_T &= \frac{m_e}{\xi} \sin(\pi \xi) \, \pi^2 \sqrt{\frac{\alpha}{K_{\text{frac}}}} \, R_f \approx \SI{5.220}{\giga\electronvolt}. \label{032_eq:mT}
	\end{align}
	
	\subsection{Muon Mass $m_{\mu}$}
	\label{032_subsec:muon_mass}
	...
	\label{032_subsec:optimization_df}
	
	Define $m_T(D_f)$ according to Equation~\ref{032_eq:mT} and solve:
	\begin{align}
	...
	\label{032_sec:application_g2}
	
	With the derived fractal dimension $D_f$ and geometric masses:
	\begin{align}
		F_2^{\text{T0}}(0) &= \frac{g_{T0}^2}{8 \pi^2} I_{\mu} K_{\text{frac}}, \label{032_eq:F2} \\
	...
	\label{032_sec:python_implementation}
	...
	\label{032_sec:summary}
	
	\subsection{Theoretical Significance of Validation}
	\label{032_subsec:theoretical_significance}
	...
	\label{032_subsec:document_structure}
	...
	\begin{table}[H]
		...
		\label{032_tab:document_complementarity}
	\end{table}
