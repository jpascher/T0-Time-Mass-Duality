...
\chapter{129 lagrandian-einfach En}
...
\section*{Abstract}
	...
	The simplest Lagrangian density that respects the fundamental law \eqref{129_eq:fundamental_law}:
...
\begin{tabular}{lccc}
		...
		\label{129_tab:lepton_parameters}
	\end{table}
	...
	From the simplified Lagrangian density \eqref{129_eq:particle_lagrangian}, variation gives:
	...
	\begin{equation}
		...
		\label{129_eq:interaction_lagrangian}
	\end{equation}
	...
	\begin{table}[htbp]
		...
		\label{129_tab:complexity_comparison}
	\end{table}
	...
	\begin{equation}
		...
		\label{129_eq:simplified_hamiltonian}
	\end{equation}
	...
	\begin{equation}
		...
		\label{129_eq:standard_schrodinger_t0}
	\end{equation}
	...
	\begin{equation}
		...
		\label{129_eq:t0_schrodinger_mass}
	\end{equation}
	
	Or rearranged:
	\begin{equation}
		i \frac{\partial\psi}{\partial t} = -\varepsilon \cdot m(x,t) \cdot \nabla^2 \psi
		\label{129_eq:t0_schrodinger_rearranged}
	\end{equation}
	...
	\begin{table}[htbp]
		...
		\label{129_tab:standard_connection}
	\end{table}
