...
\chapter{093 DerivationVonBeta En}
...
\section{Introduction and Motivation}
	...
	The T0 model employs the system of natural units established in modern quantum field theory \citep{093_peskin1995, 093_weinberg1995}:
	...
	This system reduces all physical quantities to energy dimensions and follows the tradition established by Dirac \citep{093_dirac1958}.
	...
	The central principle of the T0 model is the time-mass duality, which states that time and mass are inversely linked. This relationship differs fundamentally from the conventional treatment in general relativity \citep{093_einstein1915, 093_misner1973}.
...
\begin{tabular}{|l|c|c|c|}
			...
			\hline
			Einstein GR & $dt' = \sqrt{g_{00}} dt$ & $m_0 = \text{const}$ & \citep{093_einstein1915, 093_misner1973} \\
			Special Relativity & $t' = \gamma t$ & $m_0 = \text{const}$ & \citep{093_einstein1905} \\
	...
	The fundamental field equation of the T0 model is derived from variational principles, analogous to the approach for scalar field theories \citep{093_weinberg1995}:
	...
	This equation shows structural similarity to the Poisson equation of gravitation $\nabla^2 \phi = 4\pi G \rho$ \citep{093_jackson1998}, but is nonlinear due to the factor $m(x)$ on the right-hand side.
	...
	For a point mass source, we use the established methodology for solving Einstein's field equations \citep{093_schwarzschild1916, 093_misner1973}. The mass density of a point source is described by the Dirac delta function:
	...
	The spherically symmetric Laplace operator \citep{093_jackson1998, 093_griffiths1999} yields:
	...
	\textbf{Behavior at the origin}: Using Gauss's theorem \citep{093_griffiths1999, 093_jackson1998} for a small sphere around the origin:
	\begin{equation}
	...
	This scale is proportional to half the Schwarzschild radius $r_s = 2GM/c^2 = 2Gm$ in geometric units \citep{093_misner1973, 093_carroll2004}.
