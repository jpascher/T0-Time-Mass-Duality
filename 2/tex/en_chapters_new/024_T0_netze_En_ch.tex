...
\chapter{\Huge\textbf{T0-Theory: Network Representation and Dimensional Analysis}}
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title={Unified T0 Mathematical Framework},width=\textwidth]
	\begin{equation}
		\boxed{\text{All Reality} = \deltafield(x,t) \text{ in } G_d\text{-characterized }d\text{-dim Spacetime}}
	\end{equation}
	...
	\begin{equation}
		\boxed{
			\begin{aligned}
				...
				&\quad + \text{Field Dynamics ($\partial^2 \deltafield = 0$)} \\
