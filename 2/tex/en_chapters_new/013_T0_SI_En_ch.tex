% Chapter file: 013_T0_SI_En_ch.tex
% Source: 013_T0_SI_En.tex
% No preamble, no headers/footers, no page numbers

\chapter{\textbf{The Complete Closure of T0-Theory}}
...
\begin{abstract}
	...
	Solving equation \eqref{013_eq:t0_fundamental} for $G$:
	...
	\begin{derivation}
		...
		Checking equation \eqref{013_eq:g_fundamental}:
		\begin{equation}
	...
	\begin{keyresult}
		...
		Since $G$ is derived from $\xi$ via equation \eqref{013_eq:g_fundamental}:
		\begin{equation}
			G = \frac{\xi^2}{4 m_e}
		\end{equation}
