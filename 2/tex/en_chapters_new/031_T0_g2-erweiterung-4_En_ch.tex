...
\begin{abstract}
	...
	\label{031_sec:hadron_formula}
	
	\subsection{Universal QCD Factor}
	\label{031_subsec:universal_factor}
	...
	\label{031_subsec:final_formula}
	...
	\label{031_subsec:correction_factors}
	
	\begin{align}
		K_{\text{Proton}} &= 1.000 \quad \text{(Reference)} \label{031_eq:K_proton} \\
		K_{\text{Neutron}} &= 1.067 \quad \text{(Spin structure)} \label{031_eq:K_neutron} \\
		K_{\text{Strange}} &= 0.054 \quad \text{(Confinement)} \label{031_eq:K_strange} \\
		K_{\text{Up}} &= 1.2 \times 10^{-4} \quad \text{(Strong suppression)} \label{031_eq:K_up} \\
		K_{\text{Down}} &= 5.0 \times 10^{-4} \quad \text{(Strong suppression)} \label{031_eq:K_down}
	\end{align}
	...
	\label{031_sec:results}
	
	\subsection{Experimental Reference Data}
	\label{031_subsec:data}
...
\begin{tabular}{@{}lcccc@{}}
		...
		\label{031_tab:results}
	\end{table}
	
	\subsection{Sample Calculations}
	\label{031_subsec:examples}
	...
	\label{031_sec:summary}
	
	\subsection{Achieved Results}
	\label{031_subsec:achievements}
