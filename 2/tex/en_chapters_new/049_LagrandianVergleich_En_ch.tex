% Chapter file: 049_LagrandianVergleich_En_ch.tex
% Source: 049_LagrandianVergleich_En.tex
% No preamble, no headers/footers, no page numbers

\chapter{Simple Lagrangian Revolution: \\}
...
\begin{tabular}{lccc}
		...
		\label{049_tab:sm_force_complexity}
	\end{table}
	...
	\begin{equation}
		...
		\label{049_eq:revolutionary_lagrangian}
	\end{equation}
	...
	**The "dual" nature disappears** when seen as node interactions:
	...
	\begin{table}[htbp]
		...
		\label{049_tab:force_unification}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\label{049_tab:sm_simple_comparison}
	\end{table}
	...
	\begin{equation}
		...
		\label{049_eq:antiparticle_solution}
	\end{equation}
	...
	\begin{equation}
		...
		\label{049_eq:universal_parameter}
	\end{equation}
	...
	\begin{table}[htbp]
		...
		\label{049_tab:node_theory_comparison}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\label{049_tab:experimental_signatures}
	\end{table}
	...
	\begin{thebibliography}{99}
		\bibitem{049_muong2_experiment_2021}
		...
		\bibitem{049_higgs_discovery_cms}
