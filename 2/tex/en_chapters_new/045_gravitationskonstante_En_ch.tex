% Chapter file: 045_gravitationskonstante_En_ch.tex
% Source: 045_gravitationskonstante_En.tex
% No preamble, no headers/footers, no page numbers

\chapter{\textbf{T0-Theory: Derivation of the Gravitational Constant}}
...
\begin{abstract}
	...
	Solving Equation \eqref{045_eq:t0_fundamental} for $G$ yields:
	...
	Verification of Equation \eqref{045_eq:g_fundamental}:
	...
	The formula \eqref{045_eq:g_natural} yields $G$ in natural units (dimension $[E^{-1}]$). For experimental verification, we need $G$ in SI units with dimension $[\text{m}^3 \text{kg}^{-1} \text{s}^{-2}]$.
	...
	The T0-formula \eqref{045_eq:g_complete} shows:
