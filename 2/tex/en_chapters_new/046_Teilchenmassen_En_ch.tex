% Chapter file generated from 046_Teilchenmassen_En.tex
...
\section*{Abstract}
	...
	\label{046_sec:methodological_clarification}
	...
	\label{046_subsec:historical_precedent}
...
\begin{tabular}{p{3cm}p{4cm}p{4cm}p{3cm}}
		...
		\label{046_tab:historical_precedent}
	\end{table}
	...
	\label{046_subsec:final_xi_formula}
...
\normalsize
	...
	\label{046_sec:complete_reconstruction}
...
\begin{tabular}{lcccc}
	...
	\label{046_sec:experimental_predictions}
...
\begin{tabular}{lccc}
	...
	\label{046_sec:predictive_power}
	
	\subsection{New Particle Generations}
	\label{046_subsec:new_generations}
...
\begin{tabular}{lcccc}
		...
		\label{046_tab:quark_predictions}
	\end{table}
	
	\section{Corrected Interpretation of Mathematical Equivalence}
	\label{046_sec:corrected_interpretation}
	...
	\label{046_subsec:transformation_relationship}
...
\begin{tabular}{lcccc}
		...
		\label{046_tab:numerical_equivalence_complete}
	\end{table}
	
	\section{Scientific Legitimacy and Methodological Foundation}
	\label{046_sec:scientific_legitimacy}
	
	\subsection{Reversibility of the Established System}
	\label{046_subsec:reversibility}
	...
	\label{046_subsec:experimental_testability}
	...
	\label{046_sec:parameter_free_nature}
...
\begin{tabular}{lcccccc}
	...
	\label{046_sec:critical_assessment}
	

	\subsection{Theoretical Open Questions}
	\label{046_subsec:open_questions}
	...
	\label{046_sec:summary_conclusions}
	

	\subsection{Final Assessment}
	\label{046_subsec:final_assessment}
	
	\subsection{Scientific Status}
	\label{046_subsec:scientific_status}
