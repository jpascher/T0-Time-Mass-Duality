...
\chapter{\Huge\textbf{T0-Theorie: Rotverschiebungsmechanismus}\\
	...
	\begin{important}
		...
		\begin{itemize}
			...
			\item T0-Theorie: $z$ variiert mit der Wellenl\"ange -- $z \propto 1/\lambda_0$ (gr\"o\ss{}ere $z$ f\"ur k\"urzere $\lambda_0$) - testbare Vorhersage!
		\end{itemize}
	...
	\label{065_sec:experimental_tests}
	...
	\label{065_sec:wavelength_assessment}
	...
	\label{065_subsubsec:not_detected}
	...
	\label{065_sec:equivalence}
	
	\subsection{Formale \"Aquivalenzbeweise}
	\label{065_subsec:equivalence_proofs}
	...
	\label{065_subsec:energy_conservation}
