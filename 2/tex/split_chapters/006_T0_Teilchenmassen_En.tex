...
%\begin{document}
	...
	\begin{experimental}
		...
		\textbf{*Neutrinos:} Erfordern separate Analyse (siehe T0\_Neutrinos\_En.tex)
	\end{experimental}
	...
	\begin{warning}
		...
		\textbf{Verweis:} Vollständige Neutrino-Analyse in Dokument T0\_Neutrinos\_En.tex
	\end{warning}
	...
	\begin{itemize}
		\item \textbf{T0\_Grundlagen\_En.tex:} Fundamentale $\xi_0$-Geometrie
		\item \textbf{T0\_Feinstruktur\_En.tex:} Elektromagnetische Kopplungskonstante
		\item \textbf{T0\_Gravitationskonstante\_En.tex:} Gravitatives Analogon zu Massen
		\item \textbf{T0\_Neutrinos\_En.tex:} Spezialfall der Neutrino-Physik
	\end{itemize}
...
% Standardized preamble - T0_Neutrinos_En.tex
%\input{T0_preamble_En}
\
% \end{document}
