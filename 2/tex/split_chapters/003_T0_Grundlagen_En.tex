...
%	
	...
	\begin{itemize}
		\item \textbf{T0\_Feinstruktur\_En.tex}: Mathematische Herleitung der Feinstrukturkonstante
		\item \textbf{T0\_Gravitationskonstante\_En.tex}: Detaillierte Berechnung der Gravitation
		\item \textbf{T0\_Teilchenmassen\_En.tex}: Systematische Massenberechnung aller Fermionen
		\item \textbf{T0\_Neutrinos\_En.tex}: Spezialbehandlung der Neutrino-Physik
		\item \textbf{T0\_Anomale\_Magnetische\_Momente\_En.tex}: Loesung der Myon g-2 Anomalie
		\item \textbf{T0\_Kosmologie\_En.tex}: Kosmologische Anwendungen der T0-Theorie
	\end{itemize}
...
% Standardized preamble - T0_Modell_Uebersicht_En.tex
%\input{T0_preamble_En}
%\newpage
% \end{document}
