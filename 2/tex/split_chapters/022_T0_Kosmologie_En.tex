...
%\begin{document}
	...
	\begin{itemize}
		\item \textbf{T0\_Grundlagen\_En.tex:} Geometrischer Parameter $\xipar$ und fraktale Raumzeitstruktur
		\item \textbf{T0\_Feinstruktur\_En.tex:} Elektromagnetische Wechselwirkungen im $\xi$-Feld
		\item \textbf{T0\_Gravitationskonstante\_En.tex:} Gravitationstheorie aus $\xi$-Geometrie
		\item \textbf{T0\_Teilchenmassen\_En.tex:} Massenspektrum als Grundlage kosmischer Strukturbildung
		\item \textbf{T0\_Neutrinos\_En.tex:} Neutrino-Oszillationen in kosmischen Dimensionen
	\end{itemize}
