...
%\begin{document}
	...
	\begin{table}[h]
		...
		\begin{tabular}{lp{10cm}}
			...
			\midrule
			T0\_Grundlagen\_En.tex & Fundamentale $\xi_0$-Geometrie und fraktale Raumzeitstruktur \\
			T0\_Feinstruktur\_En.tex & Elektromagnetische Kopplungskonstante $\alpha$ in $D_{\text{lepton}}$ \\
			T0\_Gravitationskonstante\_En.tex & Gravitatives Analogon zur Massenhierarchie \\
			T0\_Neutrinos\_En.tex & Detaillierte Behandlung der Neutrino-Massen und PMNS-Mixing \\
			T0\_Anomalien\_En.tex & Verbindung zu g-2-Vorhersagen via Massenskalierung \\
			\bottomrule
		\end{tabular}}
...
% Standardized preamble - T0_Teilchenmassen_En.tex
%\input{T0_preamble_En}
%\newpage
% \end{document}
