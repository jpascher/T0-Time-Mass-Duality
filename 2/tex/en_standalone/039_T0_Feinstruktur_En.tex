...
% hypersetup (NOW AFTER colors - FIXED)
\hypersetup{
	colorlinks=true,
	linkcolor=t0blue,
	citecolor=t0blue,
...
% Label uniquifier (suppress duplicates)
\makeatletter
\let\oldlabel\label
\renewcommand{\label}[1]{\oldlabel{#1-\thepage}}
\makeatother
...
\begin{document}
	...
	\section[T0 Feinstruktur (T0 Feinstruktur)]{T0 Feinstruktur (T0 Feinstruktur)}
	...
	\begin{equation}
		...
		\label{L-T0_Feinstruktur-0154}
	\end{equation}
	
	The characteristic coupling strength is given by $\xipar$, the normalization by $(\Ezero)^2$ in units of 1 MeV². This leads directly to Equation \eqref{L-T0_Feinstruktur-0151}.
