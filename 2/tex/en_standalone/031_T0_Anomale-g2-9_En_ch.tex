...
\title{Introduction and Clarification of Consistency}
...
\section[T0 Anomale G2 9 (T0 Anomale-g2-9)]{T0 Anomale G2 9 (T0 Anomale-g2-9)}
...
% end box result
	...
	\begin{longtable}{@{}p{1.5cm}p{2cm}p{1.4cm}p{3cm}p{3cm}p{1.5cm}p{2.5cm}@{}}
		\caption{Extended Table: T0 Formula in Hybrid and Pure Perspectives (2025 Update, Rev. 9)} \label{L-T0_Anomale-g2-9-0494}\\
		\toprule
	...
	\begin{longtable}{@{}p{1.3cm}p{2cm}p{1cm}p{3.5cm}p{3cm}p{1.8cm}p{2.8cm}@{}}
		\caption{Hybrid vs. Pure T0: Pre-2025 Data ($ \times 10^{-11}$; Tau Bound Scaled)} \label{L-T0_Anomale-g2-9-0496}\\
		\toprule
