...
\section[T0 Anomale Magnetische Momente (T0 Anomale Magnetische Momente)]{T0 Anomale Magnetische Momente (T0 Anomale Magnetische Momente)}
	...
	\begin{align}
		...
		\Delta a_\mu &= 251(59) \times 10^{-11} \quad (4.2\sigma) \label{L-T0_Anomale_Magnetische_Momente-0477}
	\end{align}
	...
	\begin{align}
		...
		\Delta a_\mu &= 37(64) \times 10^{-11} \quad (0.6\sigma) \label{L-T0_Anomale_Magnetische_Momente-0478}
	\end{align}
...
% end box explanation
	...
	\begin{align}
		\mathcal{L}_{\text{SM}} &= -\tfrac{1}{4} F_{\mu\nu}F^{\mu\nu} + \bar{\psi}(i\gamma^\mu D_\mu - m)\psi \label{L-T0_Anomale_Magnetische_Momente-0479}\\
		F_{\mu\nu} &= \partial_\mu A_\nu - \partial_\nu A_\mu \label{L-T0_Anomale_Magnetische_Momente-0480}\\
		D_\mu &= \partial_\mu + ieA_\mu \label{L-T0_Anomale_Magnetische_Momente-0481}
	\end{align}
	...
	\begin{align}
		\mathcal{L}_{\text{Interaction}} &= g_T^\ell \, \bar{\psi}_\ell \psi_\ell \, \Delta m \label{L-T0_Anomale_Magnetische_Momente-0483}\\
		g_T^\ell &= \xi \, m_\ell \label{L-T0_Anomale_Magnetische_Momente-0484}
	\end{align}
	
	The universal geometric parameter $\xi$ is fundamentally determined by:
	\begin{equation}
		\xi = \frac{4}{3} \times 10^{-4} = 1.333 \times 10^{-4}
		\label{L-T0_Anomale_Magnetische_Momente-0485}
	\end{equation}
	...
	\begin{align}
		...
		\label{L-T0_Anomale_Magnetische_Momente-0486}
	\end{align}
	...
	\begin{equation}
		...
		\label{L-T0_Anomale_Magnetische_Momente-0487}
	\end{equation}
	...
	\begin{align}
		\Delta a_\ell &\approx \frac{(g_T^\ell)^2}{8\pi^2 m_T^2} \int_0^1 dx \, (1-x)(1-x^2) \label{L-T0_Anomale_Magnetische_Momente-0488}\\
	...
	\begin{equation}
		...
		\label{L-T0_Anomale_Magnetische_Momente-0490}
	\end{equation}
...
% end box derivation
	...
	\begin{equation}
		...
		\label{L-T0_Anomale_Magnetische_Momente-0491}
	\end{equation}
