...
\section[T0vsesm Conceptualanalysis (T0vsESM ConceptualAnalysis)]{T0vsesm Conceptualanalysis (T0vsESM ConceptualAnalysis)}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0924}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0925}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0926}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0927}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0928}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0929}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0930}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0931}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0932}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0933}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0934}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0935}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0936}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0937}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0938}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0939}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0940}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0941}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0942}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0943}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0944}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0945}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0946}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0947}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0948}
	
	\begin{table}[ht]
		\centering
		\caption{Four-way theoretical framework comparison}
		\label{L-T0vsESM_ConceptualAnalysis-0949}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0950}
	...
	\begin{table}[ht]
		...
		\label{L-T0vsESM_ConceptualAnalysis-0951}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0952}
	
	\begin{table}[ht]
		\centering
		\caption{Comparison of theoretical foundations}
		\label{L-T0vsESM_ConceptualAnalysis-0953}
		\begin{tabular}{p{0.45\textwidth}|p{0.45\textwidth}}
			\hline
	...
	\label{L-T0vsESM_ConceptualAnalysis-0954}
	
	\begin{table}[ht]
		\centering
		\caption{Ontological comparison of the fundamental fields}
		\label{L-T0vsESM_ConceptualAnalysis-0955}
		\begin{tabular}{p{0.45\textwidth}|p{0.45\textwidth}}
			\hline
	...
	\label{L-T0vsESM_ConceptualAnalysis-0956}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0957}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0958}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0959}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0960}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0961}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0962}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0963}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0964}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0965}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0966}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0967}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0968}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0969}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0970}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0971}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0972}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0973}
	...
	\begin{table}[ht]
		...
		\label{L-T0vsESM_ConceptualAnalysis-0974}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0975}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0976}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0977}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0978}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0979}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0982}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0983}
	
	\subsubsection{Cosmological Tests}
	\label{L-T0vsESM_ConceptualAnalysis-0984}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0985}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0986}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0987}
	
	\subsubsection{Mathematics and Geometry}
	\label{L-T0vsESM_ConceptualAnalysis-0988}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0989}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0990}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0991}
	...
	\label{L-T0vsESM_ConceptualAnalysis-0992}
