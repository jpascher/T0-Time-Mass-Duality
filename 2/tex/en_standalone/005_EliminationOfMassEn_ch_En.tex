...
\section[Eliminationofmassen (EliminationOfMassEn)]{Eliminationofmassen (EliminationOfMassEn)}
	...
	\label{L-EliminationOfMassEn-1126}
	...
	\label{L-EliminationOfMassEn-1127}
	...
	\label{L-EliminationOfMassEn-1128}
	...
	\begin{equation}
		...
		\label{L-EliminationOfMassEn-1129}
	\end{equation}
...
\section*{Dimensional analysis:}
	...
	\begin{equation}
		...
		\label{L-EliminationOfMassEn-1130}
	\end{equation}
	...
	\begin{equation}
		...
		\label{L-EliminationOfMassEn-1133}
	\end{equation}
...
\section*{Dimensional verification:}
	...
	\label{L-EliminationOfMassEn-1134}
	...
	\begin{equation}
		...
		\label{L-EliminationOfMassEn-1135}
	\end{equation}
	...
	\begin{equation}
		...
		\label{L-EliminationOfMassEn-1136}
	\end{equation}
	...
	\begin{equation}
		...
		\label{L-EliminationOfMassEn-1137}
	\end{equation}
...
\section*{Physical interpretation:}
	...
	\begin{equation}
		...
		\label{L-EliminationOfMassEn-1140}
	\end{equation}
...
\section*{No specific particle masses required!}
	...
	\label{L-EliminationOfMassEn-1141}
	
	\subsection{Fundamental Equations}
	\label{L-EliminationOfMassEn-1142}
	...
	\label{L-EliminationOfMassEn-1143}
	...
	\label{L-EliminationOfMassEn-1144}
	...
	\label{L-EliminationOfMassEn-1145}
	...
	\begin{equation}
		...
		\label{L-EliminationOfMassEn-1146}
	\end{equation}
	...
	\label{L-EliminationOfMassEn-1149}
	...
	\begin{equation}
		...
		\label{L-EliminationOfMassEn-1150}
	\end{equation}
	...
	\begin{equation}
		...
		\label{L-EliminationOfMassEn-1151}
	\end{equation}
	...
	\label{L-EliminationOfMassEn-1152}
	
	\subsection{Source Geometry Analysis}
	\label{L-EliminationOfMassEn-1153}
	...
	\label{L-EliminationOfMassEn-1154}
	...
	\begin{equation}
		...
		\label{L-EliminationOfMassEn-1155}
	\end{equation}
	...
	\label{L-EliminationOfMassEn-1156}
	...
	\begin{equation}
		...
		\label{L-EliminationOfMassEn-1157}
	\end{equation}
...
\section*{Different "masses" for different contexts:}
	...
	\label{L-EliminationOfMassEn-1158}
	...
	\label{L-EliminationOfMassEn-1159}
	
	\subsection{Reductionism to Planck Scale}
	\label{L-EliminationOfMassEn-1160}
	...
	\label{L-EliminationOfMassEn-1161}
	...
	\label{L-EliminationOfMassEn-1162}
	...
	\label{L-EliminationOfMassEn-1163}
