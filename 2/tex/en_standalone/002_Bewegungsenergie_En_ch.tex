...
\section[Bewegungsenergie (Bewegungsenergie)]{Bewegungsenergie (Bewegungsenergie)}
	...
	\label{L-Bewegungsenergie-0914}
	
	\subsection{Geometric Resonance and Rest Energy}
	\label{L-Bewegungsenergie-0915}
...
% end box important
	...
	\label{L-Bewegungsenergie-0919}
	
	\subsection{Photons in the T0-Model}
	\label{L-Bewegungsenergie-0920}
...
% end box important
	...
	- **Photons**: Their frequencies directly determine their energy, with different frequencies corresponding to distinct electromagnetic modes. The field equation \eqref{L-T0_Energie-0172} governs the propagation of these modes.
