...
\title{Introduction: Ratio-Based vs. Parameter-Based Physics}
...
\section[Elimination Of Mass Dirac Tabelleen (Elimination Of Mass Dirac TabelleEn)]{Elimination Of Mass Dirac Tabelleen (Elimination Of Mass Dirac TabelleEn)}
...
\section*{Definition: $\xi$ Parameter Class}
	...
	\begin{table}[htbp]
		...
		\label{L-Elimination_Of_Mass_Dirac_TabelleEn-1170}
	\end{table}
