...
\title{Introduction: T0 Model Foundation for Photon Dynamics}
...
\section[Dynmassephotonennichtlokalen (DynMassePhotonenNichtlokalEn)]{Dynmassephotonennichtlokalen (DynMassePhotonenNichtlokalEn)}
	...
	\begin{equation}
		m_\gamma = \omega
		\label{L-DynMassePhotonenNichtlokalEn-1164}
	\end{equation}
...
\end{tcolorbox}	
	...
	\begin{equation}
		...
		\label{L-DynMassePhotonenNichtlokalEn-1165}
	\end{equation}
	...
	\begin{equation}
		...
		\label{L-DynMassePhotonenNichtlokalEn-1168}
	\end{equation}
	...
	\begin{equation}
		...
		\label{L-DynMassePhotonenNichtlokalEn-1169}
	\end{equation}
