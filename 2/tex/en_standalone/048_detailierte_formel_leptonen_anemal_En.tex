...
\title{T0 Model: Detailed Formulas for Leptonic Anomalies \\[0.5em]
	\large Quadratic Mass Scaling from Standard Quantum Field Theory}
\author{Johann Pascher \\[0.5em]
	Department of Communication Engineering \\[0.5em]
	HTL Leonding, Austria \\[0.5em]
...
\begin{document}
	...
	\chapter{T0 Model: Detailed Formulas for Leptonic Anomalies}
