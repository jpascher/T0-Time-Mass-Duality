...
\title{The Standard Model Crisis: Complexity Without Understanding}
...
\section[Lagrandianvergleichen (LagrandianVergleichEn)]{Lagrandianvergleichen (LagrandianVergleichEn)}
...
\section*{What is "Color" in particle physics?}
	...
	\begin{table}[htbp]
		...
		\label{L-LagrandianVergleichEn-0624}
	\end{table}
	...
	\begin{equation}
		...
		\label{L-LagrandianVergleichEn-0625}
	\end{equation}
...
\section*{This single equation describes ALL of particle physics!}
	...
	**The "dual" nature disappears** when seen as node interactions:
	...
	\begin{table}[htbp]
		...
		\label{L-LagrandianVergleichEn-0626}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\label{L-LagrandianVergleichEn-0627}
	\end{table}
	...
	\begin{equation}
		...
		\label{L-LagrandianVergleichEn-0628}
	\end{equation}
	...
	\begin{equation}
		...
		\label{L-LagrandianVergleichEn-0629}
	\end{equation}
	...
	\begin{equation}
		...
		\label{L-LagrandianVergleichEn-0630}
	\end{equation}
	...
	\begin{equation}
		...
		\label{L-LagrandianVergleichEn-0631}
	\end{equation}
...
\section*{One field, different vibrational modes -- that's all!}
	...
	\begin{table}[htbp]
		...
		\label{L-LagrandianVergleichEn-0632}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\label{L-LagrandianVergleichEn-0633}
	\end{table}
