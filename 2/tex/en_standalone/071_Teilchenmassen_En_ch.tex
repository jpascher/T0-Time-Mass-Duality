...
\section[Teilchenmassen (Teilchenmassen)]{Teilchenmassen (Teilchenmassen)}
...
\section*{Generation Hierarchy:}
	...
	\label{L-Teilchenmassen-0837}
	
	\subsection{EFT Matching and Yukawa Coupling after EWSB}
	\label{L-Teilchenmassen-0838}
	...
	\label{L-Teilchenmassen-0842}
	
	\subsection{Revised Universal Fermion Table}
	\label{L-Teilchenmassen-0843}
...
% end box neutrino
	...
	\begin{table}[H]
		...
		\label{L-Teilchenmassen-0849}
	\end{table}
	
	\subsection{Double Suppression Mechanism}
	\label{L-Teilchenmassen-0850}
...
\section*{Tau Neutrino:}
	...
	\label{L-Teilchenmassen-0852}
	
	\subsection{Explicit Quark Mass Calculations}
	\label{L-Teilchenmassen-0853}
	...
	\label{L-Teilchenmassen-0855}
	
	\subsection{Complete Accuracy Analysis}
	\label{L-Teilchenmassen-0856}
...
% end box important
	...
	\label{L-Teilchenmassen-0861}
	
	\subsection{New Particle Generations}
	\label{L-Teilchenmassen-0862}
...
% end box key
	...
	\label{L-Teilchenmassen-0866}
	
	The fundamental relation:
	\begin{equation}
		f_i = \frac{1}{r_i \, \xi^{\pi_i} \, v \, \xi_0}
		\label{L-Teilchenmassen-0867}
	\end{equation}
...
% end box important
	...
	\begin{table}[H]
		...
		\label{L-Teilchenmassen-0874}
	\end{table}
	

	\section{Critical Assessment and Limitations}
	\label{L-Teilchenmassen-0875}
	


	\subsection{Theoretical Open Questions}
	\label{L-Teilchenmassen-0876}
	...
	\label{L-Teilchenmassen-0877}
	


	\subsection{Final Assessment}
	\label{L-Teilchenmassen-0878}
	
	\subsection{Scientific Status}
	\label{L-Teilchenmassen-0879}
