...
\title{The Time-Energy Duality as Fundamental Principle}
...
% - Ensured unique labels by appending suffixes where duplicates occur (e.g., -2 for second instance).
% - Minor consistency: natural units explanations, dimensional checks.
% - Removed any placeholder "truncated" text.
% - Fixed mismatched braces in equation for \tzero: consolidated \text{} and inline math for $c=1$.
...
\section{The Time-Energy Duality as Fundamental Principle}
...
\label{subsec:localized spherical}
...
\label{subsec:localized non spherical}
...
\label{subsec:extended homogeneous}
