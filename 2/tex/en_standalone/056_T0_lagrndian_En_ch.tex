...
\section[T0 Lagrndian (T0 lagrndian)]{T0 Lagrndian (T0 lagrndian)}
...
% end box keyresult
	...
	\begin{align}
		\mathcal{L}_{\mathrm{Interaction}} &= g_T^\ell \, \bar{\psi}_\ell \psi_\ell \, \Delta m \label{L-T0_Anomale_Magnetische_Momente-0483}\\
