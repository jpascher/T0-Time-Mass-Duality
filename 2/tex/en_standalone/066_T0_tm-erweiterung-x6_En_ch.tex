...
\section[T0 Tm Erweiterung X6 (T0 tm-erweiterung-x6)]{T0 Tm Erweiterung X6 (T0 tm-erweiterung-x6)}
	...
	\begin{equation}
		...
		\label{L-T0_tm-erweiterung-x6-0009}
	\end{equation}
	...
	\begin{table}[h]
		...
		\label{L-T0_tm-erweiterung-x6-0010}
	\end{table}
...
\section*{Step 2: Mass Calculation (Direct Method)}
	...
	\begin{table}[h]
		...
		\label{L-T0_tm-erweiterung-x6-0011}
	\end{table}
	...
	\begin{equation}
		...
		\label{L-T0_tm-erweiterung-x6-0012}
	\end{equation}
	...
	\begin{table}[h]
		...
		\label{L-T0_tm-erweiterung-x6-0013}
	\end{table}
...
\section*{4. Dynamics Factor $D$ (particle-specific):}
	...
	\begin{table}[h]
		...
		\label{L-T0_tm-erweiterung-x6-0014}
	\end{table}
...
\section*{Total Calculation:}
	...
	\label{L-T0_tm-erweiterung-x6-0015}
...
\section*{Quantitative Results:}
	...
	\begin{table}[h]
		...
		\label{L-T0_tm-erweiterung-x6-0016}
	\end{table}
...
\section*{Philosophical Significance:}
	...
	\begin{table}[h]
		...
		\label{L-T0_tm-erweiterung-x6-0017}
	\end{table}
...
\section*{T0-Theory: Time-Mass Duality Framework}
	...
	\label{L-T0_tm-erweiterung-x6-0018}
	...
	\begin{table}[h]
		...
		\label{L-T0_tm-erweiterung-x6-0019}
	\end{table}
	...
	\begin{equation}
		...
		\label{L-T0_tm-erweiterung-x6-0020}
	\end{equation}
	...
	\begin{equation}
		...
		\label{L-T0_tm-erweiterung-x6-0021}
	\end{equation}
	...
	\begin{table}[h]
		...
		\label{L-T0_tm-erweiterung-x6-0022}
	\end{table}
	
	\section{Mathematical Derivations}
	\label{L-T0_tm-erweiterung-x6-0023}
...
\section*{Optimized Loss with Physics Constraints}
	...
	\begin{table}[h]
		...
		\label{L-T0_tm-erweiterung-x6-0024}
	\end{table}
...
\section*{Consistency Proof:}
	...
	\label{L-T0_tm-erweiterung-x6-0025}
	...
	\begin{table}[h]
		...
		\label{L-T0_tm-erweiterung-x6-0026}
	\end{table}
	
	\section{Fundamental Relations}
	\label{L-T0_tm-erweiterung-x6-0027}
	...
	\begin{table}[h]
		...
		\label{L-T0_tm-erweiterung-x6-0028}
	\end{table}
	
	\section{Notation and Symbols}
	\label{L-T0_tm-erweiterung-x6-0029}
	...
	\begin{table}[h]
		...
		\label{L-T0_tm-erweiterung-x6-0030}
	\end{table}
	\newpage		
	\section{Python Implementation for Reproduction}
	\label{L-T0_tm-erweiterung-x6-0031}
