...
\section[Nateinheitensystematiken (NatEinheitenSystematikEn)]{Nateinheitensystematiken (NatEinheitenSystematikEn)}
	...
	\begin{table}[htbp]
		...
		\label{L-NatEinheitenSystematikEn-0470}
	\end{table}
...
\section*{Force:}
	...
	\begin{table}[htbp]
		...
		\label{L-NatEinheitenSystematikEn-0471}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\label{L-NatEinheitenSystematikEn-0472}
	\end{table}
...
% end box definition
	...
	\begin{table}[htbp]
		...
		\label{L-NatEinheitenSystematikEn-0473}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\label{L-NatEinheitenSystematikEn-0474}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\label{L-NatEinheitenSystematikEn-0475}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\label{L-NatEinheitenSystematikEn-0476}
	\end{table}
