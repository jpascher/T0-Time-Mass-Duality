...
\title{Introduction: T0 Model Foundations}
...
\section[Diracen (diracEn)]{Diracen (diracEn)}
	...
	\label{L-diracEn-0661}
	
	The time field induces a metric through:
	\begin{equation}
		g_{\mu\nu} = \eta_{\mu\nu} + h_{\mu\nu}
		\label{L-diracEn-0662}
	\end{equation}
	...
	\label{L-diracEn-0684}
	
	\subsection{T0 QED Lagrangian}
	\label{L-diracEn-0685}
	...
	\label{L-diracEn-0693}
	
	\subsubsection{T0 Contribution to g-2}
	\label{L-diracEn-0694}
	...
	\label{L-diracEn-0704}
	
	\subsection{Complete Dimensional Analysis}
	\label{L-diracEn-0705}
	...
	\label{L-diracEn-0711}
	
	\subsection{T0-Higgs Coupling}
	\label{L-diracEn-0712}
