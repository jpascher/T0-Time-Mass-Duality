...
\title{Introduction: Network Interpretation of the T0 Model}
...
\section[T0 Netze (T0 netze)]{T0 Netze (T0 netze)}
	...
	\begin{table}[htbp]
		...
		\label{L-T0_netze-0512}
	\end{table}
	
	\subsection{Dimension-Dependent -Parameters}
	\label{L-T0_netze-0513}
...
% end box important
	...
	\label{L-T0_netze-0523}
	
	\subsection{Optimal Network Architectures}
	\label{L-T0_netze-0524}
	...
	\begin{table}[htbp]
		...
		\label{L-T0_netze-0525}
	\end{table}
	
	\subsection{Dimension-Adaptive Networks}
	\label{L-T0_netze-0526}
...
% end box formula
	...
	\label{L-T0_netze-0528}
	
	\subsection{Dimensional Scale Separation}
	\label{L-T0_netze-0529}
	...
	\label{L-T0_netze-0532}
	
	\subsection{Dual-Space Network Architecture}
	\label{L-T0_netze-0533}
...
% end box experiment
	...
	\label{L-T0_netze-0536}
	
	\subsection{Factorization Experiments}
	\label{L-T0_netze-0537}
	...
	\begin{table}[htbp]
		...
		\label{L-T0_netze-0538}
	\end{table}
	
	\subsection{Verification Methods}
	\label{L-T0_netze-0539}
