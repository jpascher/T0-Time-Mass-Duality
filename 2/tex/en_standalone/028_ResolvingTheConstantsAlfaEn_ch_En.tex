...
\section[Resolvingtheconstantsalfaen (ResolvingTheConstantsAlfaEn)]{Resolvingtheconstantsalfaen (ResolvingTheConstantsAlfaEn)}
...
\section*{Definition}
		...
		\begin{align}
			\text{Form 1:} \quad \alphaem &= \frac{e^2}{4\pi\varepsilon_0\hbar c} \label{L-ResolvingTheConstantsAlfaEn-1015}\\
			\text{Form 2:} \quad \alphaem &= \frac{e^2 \mu_0 c}{4\pi \hbar} \label{L-ResolvingTheConstantsAlfaEn-1016}
		\end{align}
% end box definition
...
\section*{Proof Step}
		...
		\begin{align}
			\text{Form 1:} \quad \alphaem &\propto \frac{1}{\varepsilon_0 c} \label{L-ResolvingTheConstantsAlfaEn-1017}\\
			\text{Form 2:} \quad \alphaem &\propto \mu_0 c \label{L-ResolvingTheConstantsAlfaEn-1018}
		\end{align}
% end box proof_step
...
\section*{Theorem}
		...
		\begin{equation}
			\frac{1}{\varepsilon_0 c} = \mu_0 c \label{L-RSA-1007}
		\end{equation}
% end box theorem
...
\section*{Theorem}
		...
		\begin{align}
			e_{\text{nat}}^2 &= 4\pi \label{L-ResolvingTheConstantsAlfaEn-1019}\\
			\varepsilon_{0,\text{nat}} &= 1 \label{L-ResolvingTheConstantsAlfaEn-1020}\\
			\mu_{0,\text{nat}} &= 1 \label{L-ResolvingTheConstantsAlfaEn-1021}
		\end{align}
% end box theorem
