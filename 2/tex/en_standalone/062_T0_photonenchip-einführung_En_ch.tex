...
\title{Basics: Photonic Chips in Communication Engineering}
...
\section[T0 Photonenchip Einführung (T0 photonenchip-einführung)]{T0 Photonenchip Einführung (T0 photonenchip-einführung)}
...
% end box formula
	...
	\begin{table}[htbp]
		...
		\label{L-T0_photonenchip-einführung-1239}
	\end{table}
