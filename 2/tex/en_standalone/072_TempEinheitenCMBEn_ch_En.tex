...
\title{Introduction: T0-Theory in Natural Units}
...
\section[Tempeinheitencmben (TempEinheitenCMBEn)]{Tempeinheitencmben (TempEinheitenCMBEn)}
...
\section*{Unit check of the uncertainty relation:}
	...
	\section{-Field and Characteristic Energy Scales}
	
	\subsection{-Field as Universal Energy Mediator}
...
\section*{Unit check for $T_\xi$:}
	...
	\section{CMB in T0-Theory: Static -Universe}
...
% end box sibox
	...
	\subsection{The Already Established -Geometry}
...
\section*{Gravitational constant derived from $\xi$:}
	...
	\begin{enumerate}
		...
		\begin{equation}
			...
			\label{L-TempEinheitenCMBEn-0720}
		\end{equation}
	\end{enumerate}
	
	\section{Power Spectra Calculations}
	\label{L-TempEinheitenCMBEn-0721}
	...
	\begin{equation}
		...
		\label{L-TempEinheitenCMBEn-0722}
	\end{equation}
	...
	\label{L-TempEinheitenCMBEn-0723}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{lcc}
			...
			\bottomrule
		\end{tabular}
		\label{L-TempEinheitenCMBEn-0724}
	\end{table}
	
	\section{Resolution of Cosmological Tensions}
	\label{L-TempEinheitenCMBEn-0725}
...
% end box theorem
	...
	\label{L-TempEinheitenCMBEn-0726}
	...
	\label{L-TempEinheitenCMBEn-0727}
	...
	\section{CMB-Casimir Connection and -Field Verification}
	\label{L-TempEinheitenCMBEn-0728}
...
% end box revolutionary
	...
	\subsection{The -Field as Universal Vacuum}
...
\section*{Prediction 3: Modified vacuum fluctuations}
	...
	\section{Structure Formation in the Static -Universe}
	...
	\subsection{-Supported Continuous Creation}
