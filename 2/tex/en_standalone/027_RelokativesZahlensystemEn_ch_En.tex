...
\title{List of Symbols and Notation}
...
\section[Relokativeszahlensystemen (RelokativesZahlensystemEn)]{Relokativeszahlensystemen (RelokativesZahlensystemEn)}
	...
	{\small
		\begin{table}[htbp]
			...
			\label{L-RelokativesZahlensystemEn-1022}
		\end{table}
	...
	\begin{table}[htbp]
		...
		\label{L-RelokativesZahlensystemEn-1023}
	\end{table}
...
% end box axiom
	...
	\begin{figure}[htbp]
		...
		\label{L-RelokativesZahlensystemEn-1024}
	\end{figure}
	...
	\begin{table}[htbp]
		...
		\label{L-RelokativesZahlensystemEn-1025}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\label{L-RelokativesZahlensystemEn-1026}
	\end{table}
...
\section*{Algorithm}
		...
		\label{L-RelokativesZahlensystemEn-1027}
\section*{Algorithmic}
...
% end box algorithm
	...
	\begin{table}[htbp]
		...
		\label{L-RelokativesZahlensystemEn-1028}
	\end{table}
...
\section*{Algorithm}
		...
		\label{L-RelokativesZahlensystemEn-1029}
\section*{Algorithmic}
...
\section*{Algorithm}
		...
		\label{L-RelokativesZahlensystemEn-1030}
\section*{Algorithmic}
...
% end box algorithm
	...
	\begin{table}[htbp]
		...
		\label{L-RelokativesZahlensystemEn-1031}
	\end{table}
