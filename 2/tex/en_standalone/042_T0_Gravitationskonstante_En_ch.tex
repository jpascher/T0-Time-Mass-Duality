...
\title{Introduction: Gravitation in T0 Theory}
...
\section[T0 Gravitationskonstante (T0 Gravitationskonstante)]{T0 Gravitationskonstante (T0 Gravitationskonstante)}
...
\section*{T0 Hypothesis for Gravitation:}
		...
		\begin{equation}
			...
			\label{L-T0_Gravitationskonstante-0165}
		\end{equation}
...
% end box derivation
	...
	\begin{equation}
		...
		\label{L-T0_Gravitationskonstante-0167}
	\end{equation}
	...
	\begin{equation}
		...
		\label{L-T0_Gravitationskonstante-0168}
	\end{equation}
...
\section*{Complete T0 Formula for the Gravitational Constant:}
		...
		\begin{equation}
			...
			\label{L-T0_Gravitationskonstante-0169}
		\end{equation}
