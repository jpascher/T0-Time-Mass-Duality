...
\title{Einleitung: Der photonische Quantenchip als Katalysator}
...
\section[T0 Photonenchip China (T0 photonenchip-china)]{T0 Photonenchip China (T0 photonenchip-china)}
	...
	**Die in diesem Abschnitt beschriebenen Ansätze sind theoretische Erweiterungen der T0-Theorie und stellen vorgeschlagene Optimierungsstrategien für die nächste Generation photonischer Chips dar. Sie sind KEINE Bestandteile des aktuellen CHIPX-Produkts.**
	...
	\subsection{-Aware Quantisierung (T0-QAT)}
	...
	\begin{table}[htbp]
		...
		\label{L-T0_photonenchip-china-1237}
	\end{table}
