...
\usepackage[english]{babel} % For correct hyphenation and quotation marks
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textbf{T0 Theory: Unified g-2 Calculation (Rev. 4)}}
...
\begin{document}
	...
	\begin{thebibliography}{99}
		...
		\bibitem[T0\_Grav(2025)]{T0_GravitationalConstant} J. Pascher, \textit{T0\_GravitationalConstant - Extended with Full Derivation Chain}, T0 Series, 2025. \\
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_GravitationalConstant_De.pdf}
		
		\bibitem[T0\_Fine(2025)]{T0_FineStructure} J. Pascher, \textit{The Fine Structure Constant Revolution}, T0 Series, 2025. \\
