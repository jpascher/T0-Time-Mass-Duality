...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{T0-Time-Mass-Duality}
\fancyhead[R]{Frequenzunabhängigkeit Analyse}
\fancyfoot[C]{\thepage}
...
\hypersetup{
	...
	citecolor=blue,
	urlcolor=blue,
	pdftitle={Frequenzunabhängigkeit in T0 - Ausführliche Nachrechnung},
	pdfauthor={T0 Analysis},
	pdfsubject={T0-Theorie und Frequenzunabhängigkeit}
}

\title{Ausführliche Nachrechnung und Erklärung: \\ Frequenzunabhängigkeit in T0}
\author{T0-Time-Mass-Duality Analyse}
\date{\today}
