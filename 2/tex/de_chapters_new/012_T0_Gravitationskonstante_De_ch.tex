...
\chapter{T0-Theorie: Die Gravitationskonstante - 
	Systematische Herleitung von $G$ aus geometrischen Prinzipien - 
	Dokument 3 der T0-Serie}
...
\begin{abstract}
	...
	Gleichung \eqref{012_eq:t0_fundamental} nach $G$ aufgelöst ergibt:
	
	\begin{equation}
		G = \frac{\xi^2}{4 m_{\text{char}}}
		\label{012_eq:g_fundamental}
	\end{equation}
	...
	\begin{equation}
		...
		\label{012_eq:characteristic_mass}
	\end{equation}
	...
	Prüfung von Gleichung \eqref{012_eq:g_fundamental}:
	...
	\begin{keyresult}
		...
		\begin{equation}
			...
			\label{012_eq:G_complete_detailed}
		\end{equation}
