...
\chapter{T0-Theorie: Finale Fraktale Massenformeln (November 2025, $<$3\% $\Delta$) - 
	Zwei komplementäre Methoden zur parameterfreien Massenberechnung - 
	Erweiterte Dokumentation der T0-Massentheorie}
...
\begin{abstract}
	...
	\begin{table}[h]
		...
		\label{005_tab:lepton_qn_direkt}
	\end{table}
	...
	\begin{table}[h]
		...
		\label{005_tab:lepton_comparison_direkt}
	\end{table}
	...
	\begin{equation}
		...
		\label{005_eq:flavorueberlagerung}
	\end{equation}
	...
	\begin{table}[h]
		...
		\label{005_tab:massen_v32}
	\end{table}
	
	\section{Mathematische Ableitungen}
	\label{005_app:mathematics}
	...
	\begin{table}[h]
		...
		\label{005_tab:all_quantum_numbers}
	\end{table}
	
	\section{Fundamentale Beziehungen}
	\label{005_app:beziehungen}
	...
	\begin{table}[h]
		...
		\label{005_tab:beziehungen}
	\end{table}
	
	\section{Notation und Symbole}
	\label{005_app:notation}
	...
	\begin{table}[h]
		...
		\label{005_tab:symbole}
	\end{table}
	\section{Python Implementierung zur Nachrechnung}
	\label{005_app:python_nachrechnung}
	...
	\begin{thebibliography}{99}
		...
		\bibitem{005_flag2024}
		Aoki, Y., et al. (FLAG Collaboration) (2024). 
		\textit{FLAG Review 2024 of Lattice Results for Low-Energy Constants}. 
		arXiv:2411.04268.
		\url{https://arxiv.org/abs/2411.04268}
		
		\bibitem{005_fermilab_muon_g2}
		Abi, B., et al. (Muon g-2 Collaboration) (2021). 
		\textit{Measurement of the Positive Muon Anomalous Magnetic Moment to 0.46 ppm}. 
		Physical Review Letters, 126, 141801.
		
		\bibitem{005_peskin_schroeder}
		Peskin, M. E., \& Schroeder, D. V. (1995). 
		\textit{An Introduction to Quantum Field Theory}. 
		Addison-Wesley.
		
		\bibitem{005_weinberg_qft}
		Weinberg, S. (1995). 
		\textit{The Quantum Theory of Fields, Vol. I--III}. 
		Cambridge University Press.
		
		\bibitem{005_griffiths_particle}
		Griffiths, D. (2008). 
		\textit{Introduction to Elementary Particles}. 
		Wiley-VCH.
		
		\bibitem{005_mandl_shaw}
		Mandl, F., \& Shaw, G. (2010). 
		\textit{Quantum Field Theory (2nd ed.)}. 
		Wiley.
		
		\bibitem{005_srednicki_qft}
		Srednicki, M. (2007). 
		\textit{Quantum Field Theory}. 
		Cambridge University Press.
		
		\bibitem{005_t0_grundlagen}
		Pascher, J. (2024). 
		\textit{T0-Theorie: Grundlagen der Zeit-Masse-Dualität}. 
		Unveröffentlichtes Manuskript, HTL Leonding.
		
		\bibitem{005_t0_feinstruktur}
		Pascher, J. (2024). 
		\textit{T0-Theorie: Die Feinstrukturkonstante}. 
		Unveröffentlichtes Manuskript, HTL Leonding.
		
		\bibitem{005_t0_neutrinos}
		Pascher, J. (2024). 
		\textit{T0-Theorie: Neutrino-Massen und PMNS-Mixing}. 
		Unveröffentlichtes Manuskript, HTL Leonding.
		
		\bibitem{005_t0_github}
		Pascher, J. (2024--2025). 
		\textit{T0-Time-Mass-Duality Repository}. 
		GitHub.
		\url{https://github.com/jpascher/T0-Time-Mass-Duality}
		
		\bibitem{005_lattice_qcd_review}
		Kronfeld, A. S. (2012). 
		\textit{Twenty-first Century Lattice Gauge Theory: Results from the QCD Lagrangian}. 
		Annual Review of Nuclear and Particle Science, 62, 265--284.
		
		\bibitem{005_neutrino_mixing_pdg}
		Particle Data Group Collaboration (2024). 
		\textit{Neutrino Masses, Mixing, and Oscillations}. 
		PDG Review 2024.
		\url{https://pdg.lbl.gov/2024/reviews/rpp2024-rev-neutrino-mixing.pdf}
		
		\bibitem{005_higgs_discovery}
