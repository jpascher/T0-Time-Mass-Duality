...
\chapter{Der vollst{\"andige Abschluss der T0-Theorie} - 
	Von $\xi$ zur SI-Reform 2019:\\
	Warum das moderne SI-System die fundamentale Geometrie des Universums widerspiegelt - 
	Dokument {\"u}ber die vollst{\"a}ndige Parameterfreiheit der T0-Reihe}
...
\begin{abstract}
	...
	Aufl{\"o}sen von Gleichung \eqref{013_eq:t0_fundamental} nach $G$:
	
	\begin{equation}
		\boxed{G = \frac{\xi^2}{4 m_{\text{char}}}}
		\label{013_eq:g_fundamental}
	\end{equation}
	...
	\begin{insight}
		...
		\begin{equation}
			...
			\label{013_eq:characteristic_mass}
		\end{equation}
	...
	\begin{derivation}
		...
		Pr{\"u}fung von Gleichung \eqref{013_eq:g_fundamental}:
		\begin{equation}
	...
	\begin{keyresult}
		...
		Da $G$ von $\xi$ {\"u}ber Gleichung \eqref{013_eq:g_fundamental} abgeleitet wird:
		\begin{equation}
			G = \frac{\xi^2}{4 m_e}
		\end{equation}
