...
\begin{abstract}
	...
	\begin{table}[htbp]
		...
		\label{015_tab:einheitensysteme}
	\end{table}
	...
	Die Planck-Einheiten wurden 1899 von Max Planck vorgeschlagen \cite{015_planck1900,015_planck1906} und basieren auf den fundamentalen Naturkonstanten:
	\begin{align}
	...
	Planck erkannte, dass diese Einheiten \textit{ihre Bedeutung für alle Zeiten und für alle, einschließlich außerirdischer und nicht-menschlicher Kulturen notwendigerweise behalten} \cite{015_planck1900}.
	
	\subsection{Atomare Einheiten}
	
	Die atomaren Einheiten, 1927 von Hartree eingeführt \cite{015_hartree1957}, setzen:
	\begin{align}
	...
	In natürlichen Einheiten haben alle physikalischen Größen Dimensionen, die als Potenzen der Energie $[E]$ ausgedrückt werden können \cite{015_weinberg1995,015_peskin1995}:
	...
	\begin{table}[htbp]
		...
		\label{015_tab:energiedimensionen}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\label{015_tab:planck_umwandlungen}
	\end{table}
