...
\chapter{Einleitung: Verhältnis-basierte vs. Parameter-basierte Physik}
	...
	% Kindle-freundliche Tabelle (ohne landscape)
		\footnotesize
		\resizebox{\textwidth}{!}{%
		\begin{longtable}{p{5.5cm}p{1.2cm}p{3.8cm}p{2.5cm}p{2.5cm}p{1.2cm}}
	...
	\footnotesize
	\resizebox{\textwidth}{!}{%
	\begin{longtable}{p{5cm}p{1.2cm}p{3.8cm}p{2.8cm}p{2.8cm}p{1cm}}
	...
	\footnotesize
	\resizebox{\textwidth}{!}{%
	\begin{longtable}{p{4.5cm}p{1.8cm}p{2.5cm}p{4cm}p{3cm}p{0.8cm}}
