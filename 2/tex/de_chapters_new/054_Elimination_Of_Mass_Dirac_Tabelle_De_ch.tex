% Chapter file: 054_Elimination_Of_Mass_Dirac_Tabelle_De_ch.tex
% Source: 054_Elimination_Of_Mass_Dirac_Tabelle_De.tex
...
\chapter{Einleitung: Verhältnis-basierte vs. Parameter-basierte Physik}
	...
	% Kindle-freundliche Tabelle (ohne landscape)
		\footnotesize
		\begin{longtable}{p{4.5cm}p{1cm}p{3.2cm}p{2.2cm}p{2.2cm}p{1cm}}
			...
			\multicolumn{6}{c}{{\bfseries \tablename\ \thetable{} -- Fortsetzung}} \\
			\toprule
			\textbf{Größe} & \textbf{Einheit} & \textbf{T0-Formel} & \textbf{T0-Wert} & \textbf{CODATA} & \textbf{Stat.} \\
			\midrule
			\endhead
	...
	\footnotesize
	\begin{longtable}{p{4.2cm}p{1cm}p{3.2cm}p{2.4cm}p{2.4cm}p{0.9cm}}
	...
	\footnotesize
	\begin{longtable}{p{3.8cm}p{1.5cm}p{2.2cm}p{3.2cm}p{2.5cm}p{0.7cm}}
