...
\maketitle
	...
	% Kindle-freundliche Tabelle (ohne landscape)
		\footnotesize
		\begin{longtable}{p{4.2cm}p{1.5cm}p{3cm}p{2.2cm}p{2.2cm}p{1cm}}
	...
	\footnotesize
	\begin{longtable}{p{4cm}p{1.5cm}p{3cm}p{2.3cm}p{2.3cm}p{0.9cm}}
	...
	\footnotesize
	\begin{longtable}{p{3.6cm}p{1.7cm}p{2.2cm}p{3cm}p{2.5cm}p{0.7cm}}
