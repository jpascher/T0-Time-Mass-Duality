% Chapter file: 066_ParameterSystemdipendent_De_ch.tex
% Source: 066_ParameterSystemdipendent_De.tex
...
\title{Parameter-Systemabhängigkeit im T0-Modell: \\
	...
	\section{Einleitung}
	\label{066_sec:einleitung}
	
	\subsection{Das Parameter-Übertragungsproblem}
	\label{066_subsec:parameter_problem}
...
\textbf{Entscheidend:} Der Parameter $\xipar$ skaliert mit der Masse des betrachteten Objekts gemäß $\xipar(m) = 2Gm/\lP$. Die Higgs-Masse definiert die fundamentale Referenzskala $\xipar_0 = 1.33 \times 10^{-4}$, auf die alle anderen Massen im T0-Modell normiert werden.
	...
	\label{066_subsec:xi_higgs_verbindung}
	...
	\begin{equation}
		...
		\label{066_eq:xi_higgs_fundamental}
	\end{equation}
	...
	\begin{table}[htbp]
		...
		\label{066_tab:xi_transformation}
	\end{table}
	
	\subsection{Invarianz der Verhältnisse}
	\label{066_subsec:xi_verhaeltnis_invarianz}
...
\label{066_sec:alpha_em}

\subsection{Die Mystifizierung von 1/137}
\label{066_subsec:alpha_mystification}
...
\label{066_subsec:electromagnetic_duality}
...
\begin{align}
	\alpha_{\text{EM}} &= \frac{e^2}{4\pi\varepsilon_0\hbar c} \quad \text{(Standardform)} \label{066_eq:alpha_standard}\\
	\alpha_{\text{EM}} &= \frac{e^2 \mu_0 c}{4\pi \hbar} \quad \text{(Duale Form)} \label{066_eq:alpha_dual}
\end{align}
...
\label{066_subsubsec:invariant_ratio}
...
\label{066_subsubsec:system_dependent}
...
\label{066_subsec:alpha_system_dependency}
...
\label{066_subsec:natural_units}
...
\label{066_subsec:mystery_resolution}
...
\label{066_subsec:anthropic_fallacy}
...
\label{066_subsec:sommerfeld_harmonic}
...
\label{066_subsec:physical_interpretation}
...
\label{066_subsec:eddington_warning}
...
\label{066_sec:beta_t}

\subsection{Die Parallele zur Feinstrukturkonstante}
\label{066_subsec:beta_parallel}
...
\label{066_subsec:beta_circularity}
...
\subsection{Physikalische Interpretation}
\label{066_subsec:beta_physical}
...
\label{066_subsec:common_lesson}
...
\section{Der $\beta_T$ Parameter -- Ein zweites Beispiel der Systemabhängigkeit}
\label{066_sec:beta_t_a}

\subsection{Die Parallele zur Feinstrukturkonstante}
\label{066_subsec:beta_parallel_a}
...
\subsection{Theoretische Grundlage aus der Feldtheorie}
\label{066_subsec:beta_field_theory_a}

Der $\beta_T$ Parameter wird im T0-Modell durch die fundamentale feldtheoretische Beziehung definiert:

\begin{equation}
	\beta_T = \frac{2Gm}{r}
	\label{066_eq:beta_definition_a}
\end{equation}
...
\subsection{Die Zirkularität in der SI-Bestimmung}
\label{066_subsec:beta_circularity_a}
...
\subsection{Physikalische Interpretation}
\label{066_subsec:beta_physical_a}
...
\subsection{Die gemeinsame Lektion}
\label{066_subsec:common_lesson_a}
...
Die scheinbare ``Feinabstimmung'' dieser Parameter verschwindet vollständig, wenn wir sie in ihren natürlichen Einheiten betrachten, wo beide den Wert 1 annehmen -- die einfachste und eleganteste mögliche Wahl.
	...
	\label{066_sec:beta_t_b}
	
	\subsection{Empirische vs. theoretische Werte}
	\label{066_subsec:beta_empirisch_theoretisch}
	...
	\subsection{Theoretische Grundlage aus der Feldtheorie}
	\label{066_subsec:beta_feldtheorie}
	...
	\begin{equation}
		...
		\label{066_eq:beta_t_feldtheorie}
	\end{equation}
	...
	\label{066_subsec:beta_zirkularitaet}
	...
	\label{066_sec:alpha_w}
	
	\subsection{Mathematische vs. konventionelle Werte}
	\label{066_subsec:wien_werte}
	...
	\label{066_sec:parameter_vergleich}
	...
	\begin{table}[htbp]
		...
		\label{066_tab:parameter_vergleich}
	\end{table}
	...
	\label{066_sec:yukawa_parameter}
	
	\subsection{Die Hierarchie der Yukawa-Kopplungen}
	\label{066_subsec:yukawa_hierarchie}
	...
	\begin{table}[htbp]
		...
		\label{066_tab:yukawa_hierarchie}
	\end{table}
	
	\subsection{Transformationsunsicherheit}
	\label{066_subsec:yukawa_transformation}
	...
	\label{066_subsec:yukawa_konsistenz}
	...
	\label{066_sec:universelle_warnung}
	
	\subsection{Das systematische Problem}
	\label{066_subsec:systematisches_problem}
	...
	\label{066_subsec:transformationsprotokoll}
	...
	\label{066_subsec:experimentelle_richtlinien}
	...
	\label{066_sec:zirkularitaets_aufloesung}
	
	\subsection{Scheinbare vs. reale Zirkularität}
	\label{066_subsec:scheinbare_reale_zirkularitaet}
	...
	\label{066_subsec:systemkonsistenz}
	...
	\label{066_sec:test_implikationen}
	
	\subsection{Systemspezifische Vorhersagen}
	\label{066_subsec:systemspezifische_vorhersagen}
	...
	\begin{table}[htbp]
		...
		\label{066_tab:system_vorhersagen}
	\end{table}
	
	\subsection{Transformations-Validierung}
	\label{066_subsec:transformations_validierung}
