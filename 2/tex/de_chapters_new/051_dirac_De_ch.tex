% Chapter file: 051_dirac_De_ch.tex
% Source: 051_dirac_De.tex
% Generated from standalone document

\chapter{Integration der Dirac-Gleichung im T0-Modell: \\Natürliche-Einheiten-Rahmenwerk mit geometrischen Grundlagen}
...
\title{Integration der Dirac-Gleichung im T0-Modell: \\Natürliche-Einheiten-Rahmenwerk mit geometrischen Grundlagen}
	...
	\label{051_subsec:t0_prinzipien}
	...
	\begin{equation}
		...
		\label{051_eq:zeitfeld_fundamental}
	\end{equation}
	...
	\label{051_subsec:drei_geometrien}
	...
	\label{051_sec:dirac_t0_rahmenwerk}
	
	\subsection{Modifizierte Dirac-Gleichung mit Zeitfeld}
	\label{051_subsec:modifizierte_dirac}
	...
	\begin{equation}
		...
		\label{051_eq:t0_dirac_gleichung}
	\end{equation}
	...
	\begin{equation}
		...
		\label{051_eq:zeitfeld_verbindung}
	\end{equation}
	...
	\label{051_subsec:feld_verbindung}
...
\label{051_sec:matrix_struktur_geometrisch}

\subsection{Zeitfeldgeometrie und Clifford-Algebra}
\label{051_subsec:zeitfeld_geometrie}
...
\label{051_subsubsec:induzierte_metrik}

Das Zeitfeld induziert eine Metrik durch:
\begin{equation}
	g_{\mu\nu} = \eta_{\mu\nu} + h_{\mu\nu}
	\label{051_eq:induzierte_metrik}
\end{equation}
...
\label{051_subsubsec:modifizierte_operatoren}
...
\begin{equation}
	...
	\label{051_eq:t0_feldoperatoren}
\end{equation}
...
\label{051_sec:praezision_qed_t0}

\subsection{T0-QED-Lagrangian}
\label{051_subsec:t0_qed_lagrangian}
...
\label{051_subsec:elektron_g2_berechnung}

\subsubsection{T0-Beitrag zu g-2}
\label{051_subsubsec:t0_g2_beitrag}
...
\label{051_subsubsec:schleifen_berechnung}
...
\label{051_subsubsec:experimenteller_vergleich}
...
\label{051_subsec:muon_g2_vorhersage}
...
\begin{equation}
	...
	\label{051_eq:muon_g2_vorhersage}
\end{equation}
...
\label{051_sec:dimensionskonsistenz}

\subsection{Vollständige Dimensionsanalyse}
\label{051_subsec:vollstaendige_dimensionsanalyse}
...
\label{051_sec:experimentelle_vorhersagen}

\subsection{Charakteristische T0-Vorhersagen}
\label{051_subsec:charakteristische_vorhersagen}
...
\label{051_sec:higgs_verbindung}

\subsection{T0-Higgs-Kopplung}
\label{051_subsec:t0_higgs_kopplung}
...
\label{051_subsec:em_grav_vereinheitlichung}
...
\label{051_sec:zusammenfassung}

\subsection{Zusammenfassung der Ergebnisse}
\label{051_subsec:zusammenfassung_ergebnisse}
...
\label{051_subsec:wesentliche_erkenntnisse}
