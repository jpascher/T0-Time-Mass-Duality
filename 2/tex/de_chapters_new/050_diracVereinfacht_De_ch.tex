...
\chapter{Vereinfachte Dirac-Gleichung in der T0-Theorie: Von komplexen 4×4-Matrizen zu einfacher...}
...
\section*{Abstract}
	...
	\begin{equation}
		...
		\label{050_eq:universal_lagrangian}
	\end{equation}
	...
	\begin{table}[htbp]
		...
		\label{050_tab:unified_particles}
	\end{table}
	...
	\begin{equation}
		...
		\label{050_eq:node_interactions}
	\end{equation}
	...
	\begin{equation}
		...
		\label{050_eq:electron_g2_simple}
	\end{equation}
	...
	\begin{table}[htbp]
		...
		\label{050_tab:dirac_comparison}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\label{050_tab:experimental_tests}
	\end{table}
