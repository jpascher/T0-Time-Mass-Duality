% Chapter file: 055_DynMassePhotonenNichtlokal_De_ch.tex
% Source: 055_DynMassePhotonenNichtlokal_De.tex
% Generated from standalone document

\chapter{Dynamische Masse von Photonen und ihre Implikationen für Nichtlokalität \\ im T0-Modell: Aktualisiertes Rahmenwerk mit \\ vollständigen geometrischen Grundlagen}
...
\begin{abstract}
	...
	\begin{equation}
		...
		\label{055_eq:intrinsic_time_field}
	\end{equation}
	...
	\begin{equation}
		m_\gamma = \omega
		\label{055_eq:photon_effective_mass}
	\end{equation}
	...
	\begin{equation}
		...
		\label{055_eq:photon_time_field}
	\end{equation}
	...
	\begin{equation}
		...
		\label{055_eq:time_field_difference}
	\end{equation}
	...
	\begin{equation}
		...
		\label{055_eq:correlation_time_delay}
	\end{equation}
