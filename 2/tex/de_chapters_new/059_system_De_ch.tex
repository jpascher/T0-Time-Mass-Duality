...
\chapter{Vollständiges Teilchenspektrum: \\
		Vom Standard-Modell zur T0-Universalfeld-Vereinheitlichung \\
		Umfassende Analyse aller bekannten und hypothetischen Teilchen}
...
\title{Vollständiges Teilchenspektrum: \\
	...
	\begin{table}[htbp]
		...
		\label{059_tab:hypothetical_particles}
	\end{table}
	...
	\begin{equation}
		...
		\label{059_eq:universal_particle_principle}
	\end{equation}
	...
	\begin{equation}
		...
		\end{aligned}
		\label{059_eq:neutrino_spectrum}
	\end{equation}
	...
	\begin{equation}
		...
		\label{059_eq:antiparticle_unification}
	\end{equation}
	...
	\begin{table}[htbp]
		...
		\label{059_tab:complexity_comparison}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\label{059_tab:explanatory_comparison}
	\end{table}
	...
	\begin{equation}
		...
		\label{059_eq:universal_lepton_correction}
	\end{equation}
	...
	\begin{equation}
		...
		\label{059_eq:neutrino_mass_ratios}
	\end{equation}
	...
	\begin{equation}
		...
		\label{059_eq:dark_matter_field}
	\end{equation}
	...
	\begin{equation}
		...
		\label{059_eq:nucleosynthesis_field}
	\end{equation}
	...
	\begin{equation}
		...
		\label{059_eq:black_hole_singularity}
	\end{equation}
	...
	\begin{equation}
		...
		\label{059_eq:final_truth}
	\end{equation}
	
	\begin{thebibliography}{99}
		\bibitem{059_pascher_simplified_dirac_2025}
		...
		\bibitem{059_pascher_universal_lagrangian_2025}
		...
		\bibitem{059_pascher_ratio_physics_2025}
		...
		\bibitem{059_pascher_verification_table_2025}
		...
		\bibitem{059_pascher_ho_energie_2025}
		...
		\bibitem{059_pascher_mass_elimination_2025}
		...
		\bibitem{059_pascher_lagrangian_simple_2025}
		...
		\bibitem{059_pascher_deterministic_qm_2025}
		...
		\bibitem{059_higgs_discovery_atlas}
		...
		\bibitem{059_planck_collaboration_2020}
