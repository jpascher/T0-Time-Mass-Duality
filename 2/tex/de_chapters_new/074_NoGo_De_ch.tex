...
\chapter{T0-Theorie vs Bells Theorem: Wie deterministische Energiefelder No-Go-Theoreme umgehen Eine...}
...
\end{enumerate}
			...
			\begin{thebibliography}{99}
				...
				\bibitem{074_greenberger_horne_zeilinger1989}
				...
				\bibitem{074_superdeterminismus_review}
