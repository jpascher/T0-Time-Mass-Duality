...
\chapter{Vereinheitlichte Berechnung des anomalen magnetischen Moments in der T0-Theorie}
...
\section*{Abstract}
	...
	\footnotesize
		\begin{longtable}{@{}p{1.5cm}p{1.8cm}p{0.9cm}p{2.8cm}p{3.8cm}p{1.5cm}p{3.5cm}@{}}
