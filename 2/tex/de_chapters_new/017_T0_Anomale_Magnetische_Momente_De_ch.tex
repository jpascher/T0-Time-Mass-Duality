% Chapter file generated from 017_T0_Anomale_Magnetische_Momente_De.tex
\chapter{\textbf{Erweiterte Lagrange-Dichte mit Zeitfeld zur Erklärung des Myon \(g-2\)-Anomalie}
