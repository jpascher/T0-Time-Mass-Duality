...
Das in \textit{Monthly Notices of the Royal Astronomical Society} (MNRAS) publizierte Paper von Nathan et al. \cite{027_nathan2024} verfolgt einen rigorosen Testansatz für diese Hypothese:
\begin{enumerate}
...
Das Paper von Nathan et al. \cite{027_nathan2024} leistet einen wichtigen Beitrag, indem es einen spekulativen und inkonsistenten Lösungsweg für die Hubble-Spannung schließt. Gleichzeitig unterstreicht es die Stärke eines fundamentaleren Ansatzes, wie ihn die T0-Theorie verfolgt.
...
\begin{thebibliography}{9}
    ...
    \bibitem{027_pascher:geometric_cosmology}
