% Chapter file: 043_ResolvingTheConstantsAlfa_De_ch.tex
% Source: 043_ResolvingTheConstantsAlfa_De.tex
% Generated from standalone document

\chapter{Mathematischer Beweis: Die Feinstrukturkonstante $\alpha = 1$ in natürlichen Einheiten}
...
\section*{Abstract}
	...
	\begin{definition}[Zwei äquivalente Formen von $\alpha$]
		...
		\begin{align}
			\text{Form 1:} \quad \alphaem &= \frac{e^2}{4\pi\varepsilon_0\hbar c} \label{043_eq:alpha_form1}\\
			\text{Form 2:} \quad \alphaem &= \frac{e^2 \mu_0 c}{4\pi \hbar} \label{043_eq:alpha_form2}
		\end{align}
	\end{definition}
	...
	\begin{proof_step}[Identifikation gemeinsamer Terme]
		Beide Formen \eqref{043_eq:alpha_form1} und \eqref{043_eq:alpha_form2} enthalten identische Terme:
		\begin{itemize}
	...
	\begin{proof_step}[Isolierung differenzieller Terme]
		...
		\begin{align}
			\text{Form 1:} \quad \alphaem &\propto \frac{1}{\varepsilon_0 c} \label{043_eq:diff1}\\
			\text{Form 2:} \quad \alphaem &\propto \mu_0 c \label{043_eq:diff2}
		\end{align}
	\end{proof_step}
	...
	\begin{theorem}[Elektromagnetische Dualitäts-Beziehung]
		...
		\begin{equation}
			\frac{1}{\varepsilon_0 c} = \mu_0 c \label{043_eq:dualitaet}
		\end{equation}
	\end{theorem}
	
	\begin{proof}
		Umformen von Gleichung \eqref{043_eq:dualitaet}:
		\begin{align}
	...
	\begin{theorem}[Natürliche Einheiten elektromagnetische Konstanten]
		...
		\begin{align}
			e_{\text{nat}}^2 &= 4\pi \label{043_eq:e_nat}\\
			\varepsilon_{0,\text{nat}} &= 1 \label{043_eq:eps_nat}\\
			\mu_{0,\text{nat}} &= 1 \label{043_eq:mu_nat}
		\end{align}
	\end{theorem}
	...
	\begin{thebibliography}{9}
		\bibitem{043_Jackson1999} Jackson, J. D. (1999). \textit{Klassische Elektrodynamik} (3. Aufl.). John Wiley \& Sons.
		
		\bibitem{043_Feynman1985} Feynman, R. P. (1985). \textit{QED: Die seltsame Theorie des Lichts und der Materie}. Princeton University Press.
		
		\bibitem{043_Weinberg1995} Weinberg, S. (1995). \textit{The Quantum Theory of Fields, Volume 1: Foundations}. Cambridge University Press.
		
		\bibitem{043_Planck1906} Planck, M. (1906). Vorlesungen über die Theorie der Wärmestrahlung. Leipzig: J.A. Barth.
		
		\bibitem{043_Maxwell1865} Maxwell, J. C. (1865). A Dynamical Theory of the Electromagnetic Field. \textit{Philosophical Transactions of the Royal Society}, 155, 459-512.
		
		\bibitem{043_CODATA2018} CODATA Task Group on Fundamental Constants (2019). CODATA Recommended Values of the Fundamental Physical Constants: 2018. \textit{Rev. Mod. Phys.}, 91, 025009.
	\end{thebibliography}
