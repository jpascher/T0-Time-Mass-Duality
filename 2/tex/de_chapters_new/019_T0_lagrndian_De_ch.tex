...
\chapter{T0-Theorie: Die T0-Zeit-Masse-Dualität - 
	Vollständige theoretische Formulierung und experimentelle Vorhersagen - 
	Dokument der T0-Serie}
...
\begin{abstract}
	...
	\begin{align}
		\mathcal{L}_{\mathrm{Wechselwirkung}} &= g_T^\ell \, \bar{\psi}_\ell \psi_\ell \, \Delta m \label{019_eq:interaction_lagrangian}\\
		g_T^\ell &= \xi \, m_\ell \label{019_eq:coupling_strength}
	\end{align}
	...
	\begin{keyresult}
		\begin{equation}
			...
			\label{019_eq:extended_lagrangian}
		\end{equation}
	\end{keyresult}
	...
	\begin{derivation}
		...
		\begin{equation}
			...
			\label{019_eq:t0_fundamental_formula}
		\end{equation}
	\end{derivation}
