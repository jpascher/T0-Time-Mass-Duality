...
\chapter{Quantenmechanik im T0-Modell: \\
Feldtheoretische Grundlagen \\
Von der Standard-QM zu dynamischen Zeit-Energie-Feldern}
...
\begin{equation}
	...
	\label{072_eq:wavefunction_field}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:probability_density}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:t0_schrodinger_general}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:measurement_interaction}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:measurement_probability}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:singlet_correlation}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:position_momentum_correlation}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:field_correlation_function}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:t0_bell_correction}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:extended_t0_correction}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:cnot_hamiltonian_detailed}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:spectroscopic_shift}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:phase_accumulation}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:deterministic_state}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:deterministic_measurement}
\end{equation}
...
\begin{equation}
	\boxed{|E(a,b) - E(a,c)| + |E(a',b) + E(a',c)| \leq 2 + \varepsilon_{T0}}
	\label{072_eq:modified_bell_deterministic}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:deterministic_bell_correction}
\end{equation}
...
\begin{equation}
	\boxed{\psi(x,t) = \sqrt{\frac{\deltaE(x,t)}{E_0 V_0}} \cdot e^{i\phi(x,t)}}
	\label{072_eq:wavefunction_field_a}
\end{equation}
...
\begin{equation}
	\rho(x,t) = |\psi(x,t)|^2 = \frac{\deltaE(x,t)}{E_0 V_0}
	\label{072_eq:probability_density_a}
\end{equation}
...
\begin{equation}
	\boxed{i \cdot T_{\text{field}}(x,t) \frac{\partial\psi}{\partial t} = \hat{H}_0 \psi + \hat{V}_{\text{T0}} \psi}
	\label{072_eq:t0_schrodinger_general_a}
\end{equation}
...
\begin{equation}
	\frac{d\psi}{dt_{\text{lokal}}} = \frac{1}{T_{\text{field}}(x,t)} \frac{d\psi}{dt_{\text{koordinate}}}
	\label{072_eq:local_time_flow_a}
\end{equation}
...
\begin{equation}
	\hat{H}_{\text{int}} = \frac{\xipar}{\EPlanck} \int \frac{E_{\text{System}}(x,t) \cdot E_{\text{Detektor}}(x,t)}{\ell_P^3} d^3x
	\label{072_eq:measurement_interaction_a}
\end{equation}
...
\begin{equation}
	P(i) = \frac{|E_i(x_{\text{Detektor}}, t_{\text{Messung}})|^2}{\sum_j |E_j(x_{\text{Detektor}}, t_{\text{Messung}})|^2}
	\label{072_eq:measurement_probability_a}
\end{equation}
...
\begin{equation}
	E_{12}(x_1,x_2,t) = E_1(x_1,t) + E_2(x_2,t) + E_{\text{corr}}(x_1,x_2,t)
	\label{072_eq:entangled_energy_a}
\end{equation}
...
\begin{equation}
	E_{\text{corr}}(x_1,x_2,t) = \frac{\xipar}{|\vec{x}_1 - \vec{x}_2|} \cos(\phi_1(t) - \phi_2(t) - \pi)
	\label{072_eq:singlet_correlation_a}
\end{equation}
...
\begin{equation}
	E_{\text{corr}}(x_1,x_2,t) = \xipar \int G(x_1,x_2,x',t) \delta(p_1(x',t) + p_2(x',t)) d^3x'
	\label{072_eq:position_momentum_correlation_a}
\end{equation}
...
\begin{equation}
	C(x_1,x_2) = \langle E(x_1,t) E(x_2,t) \rangle - \langle E(x_1,t) \rangle \langle E(x_2,t) \rangle
	\label{072_eq:field_correlation_function_a}
\end{equation}
...
\begin{equation}
	\boxed{|E(a,b) - E(a,c)| + |E(a',b) + E(a',c)| \leq 2 + \varepsilon_{T0}}
	\label{072_eq:modified_bell_a}
\end{equation}

Der T0-Korrekturterm ergibt sich aus den Energiefeldkorrelationen zwischen den Messapparaturen an den beiden Orten:
\begin{equation}
	\varepsilon_{T0} = \xipar \cdot \frac{2\langle E \rangle \ell_P}{r_{12}}
	\label{072_eq:t0_bell_correction_a}
\end{equation}
...
\begin{equation}
	\Delta E = \xipar \cdot E_n \cdot \frac{\langle \deltaE \rangle}{E_0}
	\label{072_eq:spectroscopic_shift_a}
\end{equation}
...
\begin{equation}
	\phi_{\text{gesamt}} = \phi_0 + \xipar \int_0^t \frac{E_{\text{field}}(x(t'), t')}{E_0} dt'
	\label{072_eq:phase_accumulation_a}
\end{equation}
...
\begin{equation}
	\boxed{\psi(x,t) = \sqrt{\frac{\deltaE(x,t)}{E_0 V_0}} \cdot e^{i\phi(x,t)}}
	\label{072_eq:wavefunction_field_b}
\end{equation}
...
\begin{equation}
	\rho(x,t) = |\psi(x,t)|^2 = \frac{\deltaE(x,t)}{E_0 V_0}
	\label{072_eq:probability_density_b}
\end{equation}
...
\begin{equation}
	\boxed{i \cdot T_{\text{field}}(x,t) \frac{\partial\psi}{\partial t} = \hat{H}_0 \psi + \hat{V}_{\text{T0}} \psi}
	\label{072_eq:t0_schrodinger_general_b}
\end{equation}
...
\begin{equation}
	\boxed{i \frac{\partial\psi}{\partial t} = E_{\text{field}}(x,t) \left[\hat{H}_0 \psi + \hat{V}_{\text{T0}} \psi\right]}
	\label{072_eq:t0_schrodinger_energy_b}
\end{equation}

Für freie Teilchen:
\begin{equation}
	\boxed{i \frac{\partial\psi}{\partial t} = -\frac{\hbar^2}{2m} \cdot E_{\text{field}}(x,t) \cdot \nabla^2 \psi}
	\label{072_eq:t0_schrodinger_free_b}
\end{equation}
...
\begin{equation}
	\frac{d\psi}{dt_{\text{lokal}}} = \frac{1}{T_{\text{field}}(x,t)} \frac{d\psi}{dt_{\text{koordinate}}}
	\label{072_eq:local_time_flow_b}
\end{equation}
...
\begin{equation}
	\psi(x,t) = A e^{i(kx - \omega t)}
	\label{072_eq:plane_wave_b}
\end{equation}

mit modifizierter Dispersionsrelation:
\begin{equation}
	\boxed{\omega = \frac{\hbar k^2}{2m} \cdot \langle E_{\text{field}} \rangle}
	\label{072_eq:modified_dispersion_b}
\end{equation}
...
\begin{equation}
	\hat{H}_{\text{int}} = \frac{\xipar}{\EPlanck} \int \frac{E_{\text{System}}(x,t) \cdot E_{\text{Detektor}}(x,t)}{\ell_P^3} d^3x
	\label{072_eq:measurement_interaction_b}
\end{equation}
...
\begin{equation}
	P(i) = \frac{|E_i(x_{\text{Detektor}}, t_{\text{Messung}})|^2}{\sum_j |E_j(x_{\text{Detektor}}, t_{\text{Messung}})|^2}
	\label{072_eq:measurement_probability_b}
\end{equation}
...
\begin{equation}
	E_{12}(x_1,x_2,t) = E_1(x_1,t) + E_2(x_2,t) + E_{\text{corr}}(x_1,x_2,t)
	\label{072_eq:entangled_energy_b}
\end{equation}
...
\begin{equation}
	E_{\text{corr}}(x_1,x_2,t) = \frac{\xipar}{|\vec{x}_1 - \vec{x}_2|} \cos(\phi_1(t) - \phi_2(t) - \pi)
	\label{072_eq:singlet_correlation_b}
\end{equation}
...
\begin{equation}
	E_{\text{corr}}(x_1,x_2,t) = \xipar \int G(x_1,x_2,x',t) \delta(p_1(x',t) + p_2(x',t)) d^3x'
	\label{072_eq:position_momentum_correlation_b}
\end{equation}
...
\begin{equation}
	C(x_1,x_2) = \langle E(x_1,t) E(x_2,t) \rangle - \langle E(x_1,t) \rangle \langle E(x_2,t) \rangle
	\label{072_eq:field_correlation_function_b}
\end{equation}
...
\begin{equation}
	\boxed{|E(a,b) - E(a,c)| + |E(a',b) + E(a',c)| \leq 2 + \varepsilon_{T0}}
	\label{072_eq:modified_bell_b}
\end{equation}

Der T0-Korrekturterm ergibt sich aus den Energiefeldkorrelationen zwischen den Messapparaturen an den beiden Orten:
\begin{equation}
	\varepsilon_{T0} = \xipar \cdot \frac{2\langle E \rangle \ell_P}{r_{12}}
	\label{072_eq:t0_bell_correction_b}
\end{equation}
...
\begin{equation}
	\Delta E = \xipar \cdot E_n \cdot \frac{\langle \deltaE \rangle}{E_0}
	\label{072_eq:spectroscopic_shift_b}
\end{equation}
...
\begin{equation}
	\phi_{\text{gesamt}} = \phi_0 + \xipar \int_0^t \frac{E_{\text{field}}(x(t'), t')}{E_0} dt'
	\label{072_eq:phase_accumulation_b}
\end{equation}
...
\begin{equation}
	\boxed{\psi(x,t) = \sqrt{\frac{\deltaE(x,t)}{E_0 V_0}} \cdot e^{i\phi(x,t)}}
	\label{072_eq:wavefunction_field_c}
\end{equation}
...
\begin{equation}
	\rho(x,t) = |\psi(x,t)|^2 = \frac{\deltaE(x,t)}{E_0 V_0}
	\label{072_eq:probability_density_c}
\end{equation}
...
\begin{equation}
	\boxed{i \cdot T_{\text{field}}(x,t) \frac{\partial\psi}{\partial t} = \hat{H}_0 \psi + \hat{V}_{\text{T0}} \psi}
	\label{072_eq:t0_schrodinger_general_c}
\end{equation}
...
\begin{equation}
	\boxed{i \frac{\partial\psi}{\partial t} = E_{\text{field}}(x,t) \left[\hat{H}_0 \psi + \hat{V}_{\text{T0}} \psi\right]}
	\label{072_eq:t0_schrodinger_energy_c}
\end{equation}

Für freie Teilchen:
\begin{equation}
	\boxed{i \frac{\partial\psi}{\partial t} = -\frac{\hbar^2}{2m} \cdot E_{\text{field}}(x,t) \cdot \nabla^2 \psi}
	\label{072_eq:t0_schrodinger_free_c}
\end{equation}
...
\begin{equation}
	\frac{d\psi}{dt_{\text{lokal}}} = \frac{1}{T_{\text{field}}(x,t)} \frac{d\psi}{dt_{\text{koordinate}}}
	\label{072_eq:local_time_flow_c}
\end{equation}
...
\begin{equation}
	\psi(x,t) = A e^{i(kx - \omega t)}
	\label{072_eq:plane_wave_c}
\end{equation}

mit modifizierter Dispersionsrelation:
\begin{equation}
	\boxed{\omega = \frac{\hbar k^2}{2m} \cdot \langle E_{\text{field}} \rangle}
	\label{072_eq:modified_dispersion_c}
\end{equation}
...
\begin{equation}
	\hat{H}_{\text{int}} = \frac{\xipar}{\EPlanck} \int \frac{E_{\text{System}}(x,t) \cdot E_{\text{Detektor}}(x,t)}{\ell_P^3} d^3x
	\label{072_eq:measurement_interaction_c}
\end{equation}
...
\begin{equation}
	P(i) = \frac{|E_i(x_{\text{Detektor}}, t_{\text{Messung}})|^2}{\sum_j |E_j(x_{\text{Detektor}}, t_{\text{Messung}})|^2}
	\label{072_eq:measurement_probability_c}
\end{equation}
...
\begin{equation}
	E_{12}(x_1,x_2,t) = E_1(x_1,t) + E_2(x_2,t) + E_{\text{corr}}(x_1,x_2,t)
	\label{072_eq:entangled_energy_c}
\end{equation}
...
\begin{equation}
	E_{\text{corr}}(x_1,x_2,t) = \frac{\xipar}{|\vec{x}_1 - \vec{x}_2|} \cos(\phi_1(t) - \phi_2(t) - \pi)
	\label{072_eq:singlet_correlation_c}
\end{equation}
...
\begin{equation}
	E_{\text{corr}}(x_1,x_2,t) = \xipar \int G(x_1,x_2,x',t) \delta(p_1(x',t) + p_2(x',t)) d^3x'
	\label{072_eq:position_momentum_correlation_c}
\end{equation}
...
\begin{equation}
	C(x_1,x_2) = \langle E(x_1,t) E(x_2,t) \rangle - \langle E(x_1,t) \rangle \langle E(x_2,t) \rangle
	\label{072_eq:field_correlation_function_c}
\end{equation}
...
\begin{equation}
	\boxed{|E(a,b) - E(a,c)| + |E(a',b) + E(a',c)| \leq 2 + \varepsilon_{T0}}
	\label{072_eq:modified_bell_c}
\end{equation}

Der T0-Korrekturterm ergibt sich aus den Energiefeldkorrelationen zwischen den Messapparaturen an den beiden Orten:
\begin{equation}
	\varepsilon_{T0} = \xipar \cdot \frac{2\langle E \rangle \ell_P}{r_{12}}
	\label{072_eq:t0_bell_correction_c}
\end{equation}
...
\begin{equation}
	\Delta E = \xipar \cdot E_n \cdot \frac{\langle \deltaE \rangle}{E_0}
	\label{072_eq:spectroscopic_shift_c}
\end{equation}
...
\begin{equation}
	\phi_{\text{gesamt}} = \phi_0 + \xipar \int_0^t \frac{E_{\text{field}}(x(t'), t')}{E_0} dt'
	\label{072_eq:phase_accumulation_c}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:modified_decoherence}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:adaptive_grover_iterations}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:adaptive_sensitivity}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:equivalence_class}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:entropy_decomposition}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:fundamental_dynamics}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:ensemble_equivalence}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:correlation_equivalence}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:interpolation_parameter}
\end{equation}
...
\begin{equation}
	...
	\label{072_eq:information_decomposition}
\end{equation}
...
\begin{thebibliography}{99}
	\bibitem{072_pascher_t0_simplified_2025} 
