...
\chapter{Vereinheitlichte Berechnung des anomalen magnetischen Moments in der T0-Theorie (Rev. 6) - 
	Vollständiger Beitrag von $\xi$ mit Torsion-Erweiterung -- Parameterfreie geometrische Lösung - 
	Erweiterte Ableitung mit SymPy-verifizierten Schleifenintegralen, Lagrangedichte und GitHub-Validierung (November 2025)}
