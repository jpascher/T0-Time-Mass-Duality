...
\chapter{Zur mathematischen Struktur der T0-Theorie: \ Warum Zahlenverhältnisse nicht direkt gekürzt werden dürfen - 
	Aufbau der physikalischen Realität aus reiner Geometrie - 
	Ohne empirische Eingaben}
...
\end{tcolorbox}
	...
	\begin{keyresult}
		\begin{equation}
			...
			\label{070_eq:epsilon_definition}
		\end{equation}
	\end{keyresult}
	...
	\begin{equation}
		...
		\label{070_eq:E0_geometric_mean}
	\end{equation}
	...
	\begin{align}
		...
		&= 7.297 \times 10^{-3} \\
		&= \frac{1}{137.036}
		\label{070_eq:epsilon_numerical}
	\end{align}
...
\begin{tcolorbox}[colback=yellow!10!white,colframe=red!75!black,title=Fundamentale Definition]
	...
	\begin{equation}
		...
		\label{070_eq:E0_fundamental}
	\end{equation}
	Dies bedeutet:
	\begin{equation}
		\log(\Ezero) = \frac{\log(m_e) + \log(m_\mu)}{2}
		\label{070_eq:E0_logarithmic}
	\end{equation}
\end{tcolorbox}
...
\begin{align}
	\Ezero^2 &= m_e \cdot m_\mu \label{070_eq:E0_squared} \\
	\frac{\Ezero}{m_e} &= \sqrt{\frac{m_\mu}{m_e}} \label{070_eq:E0_ratio1} \\
	\frac{m_\mu}{\Ezero} &= \sqrt{\frac{m_\mu}{m_e}} \label{070_eq:E0_ratio2} \\
	\frac{\Ezero}{m_e} \cdot \frac{m_\mu}{\Ezero} &= \frac{m_\mu}{m_e} \label{070_eq:E0_product}
\end{align}
