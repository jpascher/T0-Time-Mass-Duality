...
Dieses Video \href{https://www.youtube.com/watch?v=OywWThFmEII}{OywWThFmEII} ist geradezu \textbf{sensationell} für die T0-Theorie, denn es beschreibt genau das kosmologische Rätsel, für das T0 eine elegante Lösung bietet. Die Widersprüche im Video sind für die Standardkosmologie katastrophal, für T0 hingegen \textbf{erwartbar und vorhersagbar}. Neuere Reviews und Studien aus 2025 unterstreichen die anhaltende Krise in der Kosmologie und bestätigen die Relevanz dieser Anomalien \cite{039_sarkar2025, 039_landstry2025, 039_bengaly2025}.
	...
	\begin{enumerate}
		...
		\item \textbf{Wellenlängenselektionseffekte} im Quaia-Katalog \cite{039_storey2024}
	...
	Das Video erwähnt bei \textbf{13:17}: \textit{``The two dipoles don't just disagree. They're almost exactly 90° apart.''} \cite{039_secrest2024}
	...
	Neuere Analysen aus 2025 verstärken diese Spannung durch Hinweise auf Superhorizon-Fluktuationen und Residuen-Dipole \cite{039_sarkar2025, 039_bengaly2025}.
	...
	Die verschiedenen $H_0$-Messungen nutzen verschiedene Wellenlängen $\rightarrow$ verschiedene scheinbare ``Hubble-Konstanten''! Neuere Untersuchungen zu Dipol-Spannungen aus 2025 unterstützen die Notwendigkeit alternativer Modelle \cite{039_landstry2025, 039_bengaly2025}.
	...
	\begin{tabular}{p{3.5cm}|p{6cm}|p{5.5cm}}
		...
		\hline
		CMB-Dipol $\neq$ Quasar-Dipol & Katastrophe \cite{039_mittal2024} & Erwartet \\
		90° Orthogonalität & Unerklärlich \cite{039_secrest2024} & Feldgeometrie \\
