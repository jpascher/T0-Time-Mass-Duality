% Chapter file generated from 041_parameterherleitung_De.tex
...
\label{041_sec:sm_t0_mapping}

\subsection{Übersicht der Parameterreduktion}
\label{041_subsec:parameter_overview}
...
\label{041_subsec:hierarchical_mapping}
...
\begin{table}[htbp]
	\centering
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{p{3.5cm}p{3cm}p{2.7cm}p{2.7cm}}
			\toprule
...
\begin{table}[htbp]
	...
	\label{041_tab:sm-params-2}
\end{table}

\subsection{Zusammenfassung der Parameterreduktion}
\label{041_subsec:reduction_summary}
...
\label{041_subsec:hierarchical_structure}
...
\label{041_subsec:critical_notes}
...
\label{041_sec:cosmic_t0_mapping}

\subsection{Fundamentaler Paradigmenwechsel}
\label{041_subsec:paradigm_shift}
...
\label{041_subsec:cosmic_hierarchical_mapping}
...
\label{041_subsec:critical_differences}
...
\label{041_subsec:cosmic_summary}
...
\label{041_subsec:testability_notes}
...
\begin{equation}
	...
	\label{041_eq:direct_mass_formula}
\end{equation}

\textbf{Erweiterte Yukawa-Methode:}
\begin{equation}
	m_i = y_i \times v
	\label{041_eq:yukawa_mass_formula}
\end{equation}
