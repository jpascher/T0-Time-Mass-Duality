...
\chapter{T0-Modell: Vollständige parameterfreie Teilchenmassen-Berechnung \\
	Direkte geometrische Methode vs. Erweiterte Yukawa-Methode \\
	Mit vollständiger Neutrino-Quantenzahlen-Analyse und QFT-Herleitung}
...
\begin{abstract}
	...
	\label{046_subsec:parameter_problem}
	...
	\label{046_sec:methodische_klarstellung}
	...
	\label{046_subsec:historische_praezedenz}
	...
	\begin{table}[H]
		...
		\label{046_tab:historische_praezedenz}
	\end{table}
	
	\section{Von Energiefeldern zu Teilchenmassen}
	\label{046_sec:energy_fields_to_masses}
	
	\subsection{Die fundamentale Herausforderung}
	\label{046_subsec:fundamental_challenge}
	...
	\label{046_subsec:energy_based_mass}
	...
	\label{046_sec:two_calculation_methods}
	...
	\label{046_subsec:direct_geometric_method}
	...
	\begin{equation}
		...
		\label{046_eq:geometric_quantization}
	\end{equation}
	...
	\begin{equation}
		...
		\label{046_eq:resonance_frequencies}
	\end{equation}
	...
	\begin{equation}
		...
		\label{046_eq:energy_from_frequency}
	\end{equation}
	
	In natürlichen Einheiten ($\hbar = 1$):
	\begin{equation}
		\boxed{E_{\text{char},i} = \frac{1}{\xi_i}}
		\label{046_eq:characteristic_energy_direct}
	\end{equation}
	
	\subsection{Methode 2: Erweiterte Yukawa-Methode}
	\label{046_subsec:extended_yukawa_method}
	...
	\begin{equation}
		...
		\label{046_eq:yukawa_mass_formula}
	\end{equation}
	...
	\label{046_sec:qft_herleitung}
	
	\subsection{EFT-Matching und Yukawa-Kopplung nach EWSB}
	\label{046_subsec:eft_matching}
	...
	\label{046_subsec:one_loop_matching}
	...
	\label{046_subsec:finale_xi_formel}
	...
	\label{046_sec:universal_masses}
	
	\subsection{Überarbeitete Universaltabelle der Fermionen}
	\label{046_subsec:universal_table}
	...
	\label{046_sec:vollstaendige_rekonstruktion}
	...
	\label{046_subsec:charged_leptons_detailed}
	...
	\label{046_sec:complete_neutrino_treatment}
	...
	\label{046_subsec:neutrino_quantum_numbers}
	...
	\begin{table}[H]
		...
		\label{046_tab:neutrino_quantum_numbers}
	\end{table}
	
	\subsection{Doppelte $\xi$-Unterdrückungsmechanismus}
	\label{046_subsec:double_xi_suppression}
	...
	\begin{equation}
		...
		\label{046_eq:neutrino_suppression}
	\end{equation}
	...
	\label{046_sec:quark_analyse}
	
	\subsection{Explizite Berechnungen der Quarkmassen}
	\label{046_subsec:quark_calculations}
	...
	\label{046_subsec:charm_correction}
	...
	\label{046_sec:comprehensive_validation}
	
	\subsection{Vollständige Genauigkeitsanalyse}
	\label{046_subsec:complete_accuracy}
	...
	\begin{table}[H]
		...
		\label{046_tab:complete_validation}
	\end{table}
	...
	\label{046_sec:vorhersagekraft}
	
	\subsection{Neue Teilchen-Generationen}
	\label{046_subsec:neue_generationen}
	...
	\label{046_subsec:quark_extrapolation}
	...
	\begin{table}[H]
		...
		\label{046_tab:quark_vorhersagen}
	\end{table}
	
	\section{Korrigierte Interpretation der mathematischen Äquivalenz}
	\label{046_sec:korrigierte_interpretation}
	...
	\label{046_subsec:transformationsbeziehung}
	
	Die fundamentale Beziehung:
	\begin{equation}
		f_i = \frac{1}{r_i \, \xi^{\pi_i} \, v \, \xi_0}
		\label{046_eq:transformation_bridge}
	\end{equation}
	...
	\begin{table}[H]
		...
		\label{046_tab:numerische_aequivalenz_komplett}
	\end{table}
	
	\section{Experimentelle Vorhersagen und Präzisionstests}
	\label{046_sec:experimentelle_vorhersagen}
	
	
	\subsection{Modifizierte QED-Vertex-Korrekturen}
	\label{046_subsec:qed_corrections}
	...
	\label{046_subsec:neutrino_validation}
	...
	\begin{table}[H]
		...
		\label{046_tab:neutrino_validation}
	\end{table}
	...
	\label{046_sec:wissenschaftliche_legitimitaet}
	
	\subsection{Umkehrbarkeit des etablierten Systems}
	\label{046_subsec:umkehrbarkeit}
	...
	\label{046_subsec:experimentelle_testbarkeit}
	...
	\label{046_sec:parameterfreie_natur}
	...
	\label{046_subsec:universal_quantum_table}
	...
	\begin{table}[H]
		...
		\label{046_tab:universal_quantum_numbers}
	\end{table}
	
	

	\section{Kritische Bewertung und Limitationen}
	\label{046_sec:kritische_bewertung}
	
	
	\subsection{Theoretische Offene Fragen}
	\label{046_subsec:offene_fragen}
	...
	\label{046_sec:abschliessende_bewertung}
	
	\subsection{Wissenschaftlicher Status}
	\label{046_subsec:wissenschaftlicher_status}
	...
	\label{046_subsec:bedeutung_physik}
	...
	\begin{thebibliography}{99}
		\bibitem{046_pascher_t0_energie_2025}
		...
		\bibitem{046_pascher_derivation_2025}
