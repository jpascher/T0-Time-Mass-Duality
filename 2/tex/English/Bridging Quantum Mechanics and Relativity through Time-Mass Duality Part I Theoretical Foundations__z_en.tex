...
\begin{document}
	...
	Unlike Planck units, which retain empirical couplings (e.g., \(\alphaEM\)), or specialized systems fixing subsets (e.g., electrodynamic NE), T0 unifiesll constants theoretically, predicting empirical values with high precision (e.g., \(\alphaEM = 1\) vs. \(1/137.036\), deviation \(< 10^{-6}\)) \cite{Duff2002,pascher_alphabeta_2025}.
