\chapter[T0 Teilchenmassen (T0 Teilchenmassen)]{T0 Teilchenmassen (T0 Teilchenmassen)}
...
\bibitem{pascher2025T0_Teilchenmassen_En} J. Pascher, T0_Teilchenmassen_En Document,'' 2025.
\end{thebibliography}
