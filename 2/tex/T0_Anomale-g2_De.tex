...
\begin{document}
	...
	\begin{thebibliography}{99}
		\bibitem[T0-SI(2025)]{T0_SI} J. Pascher, \textit{T0\_SI}, T0-Serie, 2025. \url{https://github.com/jpascher/T0-Time-Mass-Duality}
		\bibitem[QFT(2025)]{QFT_T0} J. Pascher, \textit{QFT in T0}, T0-Serie, 2025.
		...
		\bibitem[T0-Grav(2025)]{T0_Gravitationskonstante} J. Pascher, \textit{T0\_Gravitationskonstante}, T0-Serie, 2025.
		\bibitem[T0-Fine(2025)]{T0_FineStructure} J. Pascher, \textit{Die Feinstrukturkonstante-Revolution}, T0-Serie, 2025.
		\bibitem[T0-Verh(2025)]{T0_verhaeltnis_absolut} J. Pascher, \textit{T0\_verhaeltnis-absolut}, T0-Serie, 2025.
		\bibitem[Hirachie(2025)]{hirachie} J. Pascher, \textit{hirachie – Hierarchieproblem-Lösungen}, T0-Serie, 2025.
		...
		\bibitem[bell-myon(2025)]{bell_myon} J. Pascher, \textit{bell-myon}, T0-Serie, 2025.
	\end{thebibliography}
\end{document}