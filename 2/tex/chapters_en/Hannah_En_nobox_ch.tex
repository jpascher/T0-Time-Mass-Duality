\chapter[Connections to Mizohata-Takeuchi Counterexample]{Connections to Mizohata-Takeuchi Counterexample}
	...
	\begin{align}
		G &= \frac{\xi^2}{m_e} K_\text{frak}, \quad K_\text{frak} = e^{-\xi} \approx 0.999867, \label{Hannah:L-Hannah-0614} \\
		\alpha &\approx \frac{1}{137} \quad (\text{derived from fractal spectrum}), \label{Hannah:L-T0_umkehrung-0585} \\
		l_p &= \sqrt{\xi} \cdot \frac{c}{\sqrt{G}}. \label{Hannah:L-Hannah-0615}
	\end{align}
