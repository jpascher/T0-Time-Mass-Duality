\chapter[T0 Photonenchip Umsetzung (T0 photonenchip-umsetzung)]{T0 Photonenchip Umsetzung (T0 photonenchip-umsetzung)}
...
% end box formula
	...
	\begin{table}[htbp]
		...
		\label{T0_photonenchip:L-T0_photonenchip-umsetzung-1238}
	\end{table}
