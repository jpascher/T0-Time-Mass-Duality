\chapter[Mathematische Struktur (Mathematische struktur)]{Mathematische Struktur (Mathematische struktur)}
	...
	\textbf{On the Mathematical Structure of the T0-Theory: Why Numerical Ratios Must Not Be Directly Simplified}
...
\textbf{\(\alpha\) and \(\xi\) are not independent of each other but are emergent properties of the fractal spacetime geometry.}
	...
	\label{Mathematische_s:L-Mathematische_struktur-0881}
...
\textbf{Key Result}
		\begin{equation}
			...
			\label{Mathematische_s:L-Mathematische_struktur-0882}
		\end{equation}
% end box keyresult
	...
	\begin{equation}
		...
		\label{Mathematische_s:L-Mathematische_struktur-0883}
	\end{equation}
	...
	\begin{equation}
		...
		\label{Mathematische_s:L-Mathematische_struktur-0884}
	\end{equation}
	...
	\begin{equation}
		...
		\label{Mathematische_s:L-Mathematische_struktur-0885}
	\end{equation}
	...
	\begin{align}
		...
		&= 7.297 \times 10^{-3} \\
		&= \frac{1}{137.036}
		\label{Mathematische_s:L-Mathematische_struktur-0886}
	\end{align}
...
------------------
	...
	\textbf{Why No Fractal Correction is Needed for Mass Ratios and Characteristic Energy}
...
\textbf{In summary:}
	...
	\textbf{Is This Indirect Proof That the Fractal Correction is Correct?}
