\chapter[Dynmassephotonennichtlokalen (DynMassePhotonenNichtlokalEn)]{Dynmassephotonennichtlokalen (DynMassePhotonenNichtlokalEn)}
	...
	\begin{equation}
		...
		\label{DynMassePhotone:L-T0_Energie-0171}
	\end{equation}
	...
	\begin{equation}
		...
		\label{DynMassePhotone:L-T0_Energie-0195}
	\end{equation}
	
	From this foundation emerge the key parameters:
	
	\subsubsection*{T0 Model Parameters for Photon Analysis}
\begin{align}
	...
	\begin{equation}
		m_\gamma = \omega
		\label{DynMassePhotone:L-DynMassePhotonenNichtlokalEn-1164}
	\end{equation}
	...
	\begin{equation}
		...
		\label{DynMassePhotone:L-Moll_CandelaEn-1062}
	\end{equation}
...
\textbf{Vereinfachung:} Da alle Messungen in unserem endlichen, beobachtbaren Universum lokal erfolgen, wird nur die \textbf{lokalisierte Feldgeometrie} verwendet:
	...
	\begin{equation}
		...
		\label{DynMassePhotone:L-DynMassePhotonenNichtlokalEn-1165}
	\end{equation}
	...
	\begin{equation}
		...
		\label{DynMassePhotone:L-DynMassePhotonenNichtlokalEn-1166}
	\end{equation}
	
	where:
	\begin{equation}
		\epsilon(\omega_1, \omega_2) = \alpha_{\text{corr}} \left|\frac{1}{\omega_1} - \frac{1}{\omega_2}\right| \frac{2G\langle m \rangle}{r}
		\label{DynMassePhotone:L-DynMassePhotonenNichtlokalEn-1167}
	\end{equation}
	...
	\begin{equation}
		...
		\label{DynMassePhotone:L-DynMassePhotonenNichtlokalEn-1168}
	\end{equation}
	...
	\begin{equation}
		...
		\label{DynMassePhotone:L-DynMassePhotonenNichtlokalEn-1169}
	\end{equation}
