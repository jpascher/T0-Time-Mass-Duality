...
% Standardized preamble - T0_Anomale_Magnetische_Momente_En.tex
\input{T0_preamble_En}

\title{\textbf{Extended Lagrangian Density with Time Field for Explaining the Muon \(g-2\) Anomaly}}
	\large The T0-Theory: Time-Mass Duality and Anomalous Magnetic Moments}
