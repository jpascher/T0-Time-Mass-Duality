...
% Standardized preamble - T0_lagrndian_De.tex
\input{T0_preamble_De}

\title{\textbf{T0-Theorie: Die T0-Zeit-Masse-Dualität}}
	\large Vollständige theoretische Formulierung und experimentelle Vorhersagen}
\begin{document}
