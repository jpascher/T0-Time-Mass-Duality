...
% Standardized preamble - T0_Gravitationskonstante_En.tex
\input{T0_preamble_En}

\title{\textbf{T0 Theory: The Gravitational Constant}}
	\large Systematic Derivation of $G$ from Geometric Principles}
