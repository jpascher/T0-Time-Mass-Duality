...
% Standardized preamble - T0-QFT-ML_Addendum_De.tex
\input{T0_preamble_De}

\title{\textbf{T0 Quantenfeldtheorie: ML-abgeleitete Erweiterungen}}
	\large Addendum zum vollständigen QFT-QM-QC Framework}
