...
% Standardized preamble - T0-Theory-vs-Synergetics_De.tex
\input{T0_preamble_De}

\title{\textbf{T0-Theorie vs. Synergetics-Ansatz}}
	\large Wie natürliche Einheiten die geometrische Physik vereinfachen}
