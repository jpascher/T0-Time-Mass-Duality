...
% Standardized preamble - gravitationskonstnte_En.tex
\input{T0_preamble_En}

\title{\textbf{Calculation of the Gravitational Constant from SI Constants}}
	\large The T0-Theory: Emergence of G from Spacetime Geometry}
