...
% Standardized preamble - T0_Dokumentenübersicht_En.tex
\input{T0_preamble_En}

\title{\textbf{T0-Theory: Document Series Overview}}
	\large A Revolutionary Geometric Reformulation of Physics}
