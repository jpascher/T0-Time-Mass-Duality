...
% Standardized preamble - gravitationskonstnte_De.tex
\input{T0_preamble_De}

\title{\textbf{Berechnung der Gravitationskonstanten aus SI-Konstanten}}
	\large Die T0-Theorie: Emergenz von G aus der Raumzeit-Geometrie}
