...
% Standardized preamble - T0_lagrndian_En.tex
\input{T0_preamble_En}

\title{\textbf{T0-Theory: The T0-Time-Mass Duality}}
	\large Complete Theoretical Formulation and Experimental Predictions}
