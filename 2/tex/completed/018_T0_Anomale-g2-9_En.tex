...
% Standardized preamble - T0_Anomale-g2-9_En.tex
\input{T0_preamble_En}

\title{\textbf{Unified Calculation of the Anomalous Magnetic Moment in the T0 Theory (Rev. 9 -- Revised)}}
	\large Complete Contribution from $\xi$ with Torsion Extension -- Parameter-Free Geometric Solution}
