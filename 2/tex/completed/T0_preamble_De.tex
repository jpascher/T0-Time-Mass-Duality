...
% Version: 1.1 (angepasst für Bundsteg/Druck: inner=1.6cm, outer=0.7cm)
% Autor: Johann Pascher (angepasst von Grok)
% ==============================================================================
...
% --- Seitengeometrie (angepasst für Bundsteg: 355 Seiten) ---
\usepackage[%
a4paper,
twoside,                % Für Buch-Layout: inner/outer-Ränder
inner=2cm,            % Bundsteg: >=15,875 mm (Puffer für Bindung)
outer=1cm,            % Äußerer Rand: >=6,35 mm
top=2.5cm, bottom=3cm,  % Oben/unten beibehalten
bindingoffset=2mm,      % Extra für Bindungsdicke (~0,5 mm/100 Seiten)
headheight=15pt,        % Kopfhöhe beibehalten
headsep=10pt            % Abstand Kopf zu Text (vermeidet Warnungen)
]{geometry}
...
% --- Hyperref-Einstellungen (druckoptimiert) ---
\hypersetup{
	colorlinks=true,
	linkcolor=blue,
	citecolor=blue,
	...
	pdfstartview=FitH,
	pdfborder={0 0 0}      % Unsichtbare Rahmen für Druck
}
...
% Additional commands to fix compilation issues
\newcommand{\titel}{\title}
%\newcommand{\Lorentz}[2]{\Lambda_{#1}^{#2}}
\newcommand{\Weyl}{W}
\newcommand{\ZPinch}{2 n k (T_e + T_i) = \frac{\mu_0 I^2}{8\pi r}}
...
\pagestyle{empty}  % Entfernt Seitennummern für das gesamte Dokument
