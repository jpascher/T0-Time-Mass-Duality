...
% Standardized preamble - T0_Anomale-g2-6_De.tex
\input{T0_preamble_De}

\title{\textbf{Vereinheitlichte Berechnung des anomalen magnetischen Moments in der T0-Theorie (Rev. 6)}}
	\large Vollständiger Beitrag von $\xi$ mit Torsion-Erweiterung -- Parameterfreie geometrische Lösung}
