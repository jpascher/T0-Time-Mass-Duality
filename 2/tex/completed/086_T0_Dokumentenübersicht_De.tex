...
% Standardized preamble - T0_Dokumentenübersicht_De.tex
\input{T0_preamble_De}

\title{\textbf{T0-Theorie: Dokumentenserieübersicht}}
	\large Eine revolutionäre geometrische Reformulierung der Physik}
