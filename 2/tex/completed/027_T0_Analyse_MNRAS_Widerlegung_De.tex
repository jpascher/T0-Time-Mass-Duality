...
% Standardized preamble - T0_Analyse_MNRAS_Widerlegung_De.tex
\input{T0_preamble_De}

\title{\textbf{Analyse des MNRAS-Papiers 544: Eine Falsifizierung modifizierter Gravitationsmodelle und eine indirekte Bestätigung der T0-Theorie}}
