...
\title{\textbf{Erweiterte Lagrange-Dichte mit Zeitfeld zur Erklärung des Myon \(g-2\)-Anomalie}}
	\large Die T0-Theorie: Zeit-Masse-Dualität und anomale magnetische Momente}
