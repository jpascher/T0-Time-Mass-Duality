...
% Standardized preamble - T0_koide-formel-3_En.tex
\input{T0_preamble_En}

\title{\textbf{Proof: The Koide Formula Implicitly Contains $\xi$}}
	\large Geometric Derivation of Lepton Mass Symmetry}
