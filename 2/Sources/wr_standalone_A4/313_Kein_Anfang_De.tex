...
\textbf{Damit ist die Stelle präzise benannt -- und sie ist klein.}
$T_0$ selbst ist \emph{nicht} offen: Es ist überbestimmt
(Abschn.~I.3, zwei Sektoren auf $0{,}1\,\%$). Offen ist allein die
\emph{Umrechnung} der 061-Einheit auf den Korpus-Anker:
$1$~eV$/E_0 = 1{,}352\times10^{-7}$ mit $\log_\xi = 1{,}77$ --
keine ganze Potenz. Solange sie fehlt, wird eine Skalenwahl als
Herleitung gelesen. Nach A085 ist das unzulässig, sobald
...
$T_0$ & \emph{überbestimmt} (zwei Sektoren, $0{,}1\,\%$); offen ist
  allein die Umrechnung $1$~eV$/E_0$ ($\log_\xi = 1{,}77$)
  & [K]/offen \\
\end{longtable}
}
