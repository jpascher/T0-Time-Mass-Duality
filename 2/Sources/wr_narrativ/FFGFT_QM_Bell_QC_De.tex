...
\begin{titlepage}
  ...
  {\Huge\bfseries\color{blue!70!black}Quanten, Bell und\\[0.2cm]Quantenrechner}\\[0.6cm]
...
% --- Teil I ---
\part{Grundlagen}
\input{../qmb-ch/QMB_n01_grundlage}
\input{../qmb-ch/QMB_n02_zustand_messung}
\input{../qmb-ch/QMB_n03_verschraenkung}

% --- Teil II ---
\part{Bellsche Ungleichung}
\input{../qmb-ch/QMB_n04_bell_theorem}
\input{../qmb-ch/QMB_n05_bell_ffgft}
\input{../qmb-ch/QMB_n06_nogo}
\input{../qmb-ch/QMB_n07_chsh_experiment}

% --- Teil III ---
\part{Quantenrechner}
\input{../qmb-ch/QMB_n08_qubit_formalismus}
\input{../qmb-ch/QMB_n09_algorithmen}
\input{../qmb-ch/QMB_n10_spin_qubit}
\input{../qmb-ch/QMB_n11_hardware}
\input{../qmb-ch/QMB_n12_grenze}

% --- Teil IV ---
\part{Zustandsraum}
\input{../qmb-ch/QMB_n13_hilbertraum}
\input{../qmb-ch/QMB_n14_gitter_spektral}
\input{../qmb-ch/QMB_n15_zeit_superposition}

\appendix
\input{../qmb-ch/QMB_n_symbole}
\input{../qmb-ch/QMB_n_lit}
\input{../qmb-ch/QMB_n_ai}
