...
\chapter*{Die Hodge-Vermutung und die T\textsuperscript{4}/Z\textsubscript{3}-Geometrie}
\addcontentsline{toc}{chapter}{Die Hodge-Vermutung und die T⁴/Z₃-Geometrie}
...
\paragraph{Singuläre Varietäten.}
$T^4/\mathbb{Z}_3$ ist singulär in den neun Fixpunkten. Die Hodge-Vermutung
ist für singuläre Varietäten nicht als Millennium-Problem formuliert.
Eine minimale Auflösung der Singularitäten würde eine K3-artige Fläche oder
eine Calabi-Yau-Fläche erzeugen; die Hodge-Aussage für diese Auflösung
erfordert eine separate Untersuchung.
