...
algebraically confirmed by Doc.~321 [B]).
...
\textbf{[B]} The complete algebraic derivation of the $SU(3)_c$
gauge structure from $\mathbb{Z}_3$ triality is carried out in
Doc.~321 (\S3--4). The eight bilinear transition operators between
the three eigensectors $\mathcal{H}_0, \mathcal{H}_1, \mathcal{H}_2$
of $L^2(T^4)$ satisfy the $\mathfrak{su}(3)$ commutation relations
with canonical structure constants. $N_c = 3$ is algebraically
necessary, not postulated.

\textbf{[K]} Doc.~049: ``Nodes cannot exist alone, must form neutral
combinations.'' Algebraically sharpened by Doc.~321: only states
with triality $T_R = 0$ are asymptotic states -- confinement as
triality selection.

\begin{tcolorbox}[colback=green!6!white,colframe=green!50!black,
  title=Status of the colour charge thesis -- closed by Doc.~321 \textbf{[B]}]
The $SU(3)_c$ emergence from $\mathbb{Z}_3$ triality is algebraically
proved (Doc.~321). Colour charge is geometrically fundamental:
the three $\mathbb{Z}_3$ eigensectors are the three colour degrees
of freedom. Confinement as $T_R=0$ selection is the algebraic form
of Doc.~049.
\end{tcolorbox}
...
\begin{itemize}
  ...
  \item \textbf{Doc.~049}: Confinement formulation -- algebraically
    sharpened by Doc.~321 [K]
  \item \textbf{Doc.~321}: Algebraic derivation of $SU(3)_c$ from
    $\mathbb{Z}_3$ triality; $N_c=3$; confinement as $T_R=0$ selection [B]
  \item \textbf{Doc.~322}: Hilbert-space embedding; fixed-point boundary
    conditions on $T^4/\mathbb{Z}_3$ [K]
\end{itemize}
...
\begin{enumerate}
  \item \textbf{$SU(3)_c$ emergence from $\mathbb{Z}_3$ triality.}
    [\textbf{B} -- closed by Doc.~321] Eight Gell-Mann operators derived
    algebraically from $\mathbb{Z}_3$ eigensectors; $N_c=3$ necessary.
  ...
  \item \textbf{Formal boundary conditions on $T^4/\mathbb{Z}_3$.}
    [\textbf{K} -- worked out in Doc.~322] Fixed-point boundary conditions
    and Hilbert-space embedding complete.
\end{enumerate}
