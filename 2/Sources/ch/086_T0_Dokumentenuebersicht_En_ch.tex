...
\begin{tabular}{lcc}
	...
	\begin{documentbox}
		...
		\end{equation}
		\emph{Correction (Doc.~190 C6):} the earlier wavelength-dependent form
		$z(\lambda_0,d)=\xi d\,\lambda_0/E_\xi$ is superseded -- the fractal
		path-lengthening is \emph{achromatic} (finite-element simulation). In depth:
