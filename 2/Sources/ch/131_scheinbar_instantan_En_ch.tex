\section*{Abstract}
	...
	\begin{center}
		\begin{tikzpicture}[scale=1.2]
			% Title
			\node at (6, 7) { \textbf{Local Constraint vs. Global Propagation}};
	...
	\begin{tcolorbox}[colback=t0blue!5!white, colframe=t0blue!75!black, title=T0 Prediction]
		...
		\begin{itemize}
			\item Effective fractal dimension: $D_f^{\,\text{eff}} \approx 2.973$ (local: $D_f^{\text{space}} = 3 - \xi \approx 2.9999$)
	...
	\begin{center}
		\begin{tikzpicture}[scale=1.3]
			% Title
			\node at (0, 6) { \textbf{The Fundamental Energy-Time Duality}};
