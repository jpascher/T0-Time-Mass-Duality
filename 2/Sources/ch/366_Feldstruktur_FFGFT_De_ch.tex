% 366_Feldstruktur_FFGFT_De_ch.tex
...
Modenkompatibilitätsbedingungen dieses Knotens (§\,10).
...
$(n_\theta, n_\varphi)$ & Wicklungszahlen einer Feldmode auf $T^4$; topologische Invarianten \\
\midrule
\multicolumn{2}{l}{\textit{Antennentechnik}} \\
$R_\mathrm{str}$ & Strahlungswiderstand (Widerstand der Antenne gegenüber abgestrahlter Leistung) \\
...
$\Delta\theta_{3\,\mathrm{dB}}$ & Halbwertsbreite der Hauptkeule \\
...
experimentell. Eine Hochfrequenzsignalquelle (${\sim}900\,\mathrm{MHz}$)
...
Vektorbündeln über diesem Träger; ihre Periodizitätsbedingungen erzwingen
...
eines Feldes im Raum ist das Ergebnis dieser Kompatibilitätsbedingungen,
...
Polarisationsfehlerwinkel sind.

Jeder Faktor dieser Gleichung entspricht einer Kompatibilitätsbedingung
zwischen den Trägern:

\begin{center}
\begin{tabular}{@{}lll@{}}
\toprule
\textbf{Faktor} & \textbf{Physikalische Bedeutung} & \textbf{FFGFT-Entsprechung} \\
\midrule
$G_S$ & Bündelung des sendenden Trägers & Modengeometrie des Quellfeldes \\
$G_E$ & Bündelung des empfangenden Trägers & Modengeometrie des Empfängerfeldes \\
$(\lambda/4\pi r)^2$ & Freiraumdämpfung & Geometrischer Ausbreitungsfaktor \\
$\cos^2\psi$ & Polarisationsüberlapp & Kompatibilität der Wicklungsrichtungen \\
\bottomrule
\end{tabular}
\end{center}
...
verschwindet bei Resonanz. Das ist eine ganzzahlige Modenkompatibilitätsbedingung
...
des Patches kompatibel sind. Kreuzpolarisationsentkopplung ($> 30\,\mathrm{dB}$)
...
\begin{tabular}{@{}llll@{}}
\toprule
\textbf{Typ} & \textbf{Gewinn} & \textbf{$\Delta\theta_{3\,\mathrm{dB}}$}
             & \textbf{Modengeometrie} \\
\midrule
...
Hornantenne   & 15--25\,dBi & $3°$--$15°$ & TE$_{10}$-Aperturmode \\
Paraboloid ($D=3\,\mathrm{m}$, 10\,GHz) & 40\,dBi & $0{,}7°$ & Fourier-Apertur \\
Patch         & 5--8\,dBi  & $60°$--$120°$ & Resonanzmode im Dielektrikum \\
Phased Array ($N$) & $N \cdot G_\mathrm{elem}$ & $\propto 1/\sqrt{N}$ & Phasengesteuertes Array \\
\bottomrule
\end{tabular}
\end{center}
...
elektromagnetisches Feld noch reine Ladungsträgerschwingung --- es ist
...
gleichzeitig zu erfüllende Kompatibilitätsbedingungen, desto
...
\]
sind Kompatibilitätsbedingungen: nur Übergänge, bei denen die
...
\begin{tabular}{@{}lll@{}}
\toprule
\textbf{Eigenschaft} & \textbf{Antenne} & \textbf{Teilchen (Knoten)} \\
\midrule
...
sind die Impedanzanpassungsbedingungen dieses Resonators: ein
...
\subsection*{Kristallgitter: Bragg-Bedingung als Kompatibilitätsbedingung}
...
Manifestation der Quantisierungsbedingung auf dem Torus \SM.
...
Impedanzanpassungsbedingung zwischen Photon (Dipolstrahlung) und
...
\begin{tabular}{@{}lllll@{}}
\toprule
\textbf{Skala} & \textbf{Träger} & \textbf{Kopplungsbedingung}
  & \textbf{Beispiel} & \textbf{Analogon} \\
\midrule
Antenne & Strahlergeometrie & $\cos^2\psi$, Impedanz
  & Dipol/Yagi & Friis-Gleichung \\
Atom & Coulombpotential & $\Delta l=\pm1$
  & H-Linien & Auswahlregel \\
Molekül & eff. Potential & $\partial\mu/\partial Q \neq 0$
  & IR-Aktivität & Dipolkopplung \\
Kristall & Gitterperiodizität & $2d\sin\theta=n\lambda$
  & Bragg-Reflex & Phased Array \\
Periodensystem & Schalenstruktur & Überlapp $S_{AB}$
  & Kovalenz & Aperturüberlapp \\
Molekülbindung & Orbitalgeometrie & Symmetriekompatibilität
  & HOMO/LUMO & Modenüberlapp \\
Planeten & Gravitationsfeld & $p\,n_1 = q\,n_2$
  & Laplace-Resonanz & Arnold-Zunge \\
\bottomrule
\end{tabular}
\end{center}
...
quantitative Grenze der Modenunterscheidbarkeit.
