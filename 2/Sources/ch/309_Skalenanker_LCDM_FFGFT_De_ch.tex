...
% ============================================================
% Nachtrag 7. September 2026 — R71: Seitenwahl in der Hubble-Spannung
% Quelle: Dok. 190-Archiv-2 (R71)
% Quelldokument bleibt unverändert (append-only, vgl. R50).
% ============================================================

\section*{Nachtrag R71: Seitenwahl in der Hubble-Spannung (Stand 7.~September 2026)}

\textbf{R71 — Verschärfung der Aussage zur Hubble-Spannung.}

Die Hubble-Spannung ($5\sigma$ zwischen Frühuniversum-Kalibrierung
aus CMB/BAO und lokaler Distanzleiter) ist in der FFGFT-Analyse
dieses Dokuments als „strukturell absent" eingetragen --- weil FFGFT
$H_0$ nicht aus einer expandierenden Geometrie, sondern als emergente,
dekompaktifizierte Größe behandelt.

\textbf{Präzisierung (R71):} Diese Einstufung ist korrekt, aber zu knapp.
Die Aussage „strukturell absent" bedeutet nicht, dass FFGFT die Spannung erklärt,
sondern dass das Modell \emph{nur einen} $H_0$-Wert kennt (den kalibrierten),
ohne zwischen Früh- und Spätmessung zu unterscheiden. Das ist eine Schwäche,
keine Stärke: FFGFT kann die Spannung weder reproduzieren noch auflösen,
weil die Geometrie keine expandierende Kausalstruktur enthält, aus der
zwei verschiedene Messepocheneffekte folgen könnten.

Korrekte Einordnung: Die Hubble-Spannung ist in FFGFT \emph{nicht modellierbar},
nicht modellunabhängig absent. Die Tabelle in diesem Dokument ist entsprechend
zu lesen: „strukturell absent" = „nicht im Modell vorgesehen", kein Erklärungsanspruch.
