...
acht Generatoren von $SU(3)_c$ (Dok.~145, [S]; algebraisch best\"{a}tigt
durch Dok.~321 [B]).
...
\textbf{[B]} Die vollst\"{a}ndige algebraische Herleitung der
$SU(3)_c$-Eichstruktur aus der $\mathbb{Z}_3$-Trialit\"{a}t ist in
Dok.~321 ausgef\"{u}hrt (\S3--4). Die acht bilinearen
\"{U}bergangsoperatoren zwischen den drei Eigensektoren
$\mathcal{H}_0, \mathcal{H}_1, \mathcal{H}_2$ von $L^2(T^4)$
erf\"{u}llen die $\mathfrak{su}(3)$-Kommutatorrelationen mit
kanonischen Strukturkonstanten. $N_c = 3$ ist algebraisch notwendig.

\textbf{[K]} Dok.~049: ``Nodes cannot exist alone, must form neutral
combinations.'' Algebraisch pr\"{a}zisiert durch Dok.~321:
Nur Zust\"{a}nde mit Trialit\"{a}t $T_R = 0$ sind asymptotische
Zust\"{a}nde -- Confinement als Trialit\"{a}ts-Selektion.

\begin{tcolorbox}[colback=green!6!white,colframe=green!50!black,
  title=Status der Farbladungs-These -- geschlossen durch Dok.~321 \textbf{[B]}]
Die $SU(3)_c$-Emergenz aus $\mathbb{Z}_3$-Trialit\"{a}t ist
algebraisch bewiesen (Dok.~321). Farbladung ist geometrisch fundamental:
die drei $\mathbb{Z}_3$-Eigensektoren sind die drei Farbfreiheitsgrade.
Confinement als $T_R=0$-Selektion ist die algebraische Form
von Dok.~049.
\end{tcolorbox}
...
\begin{itemize}
  ...
  \item \textbf{Dok.~049}: Confinement-Formulierung -- algebraisch
    präzisiert durch Dok.~321 [K]
  \item \textbf{Dok.~321}: Algebraische Herleitung $SU(3)_c$ aus
    $\mathbb{Z}_3$-Trialität; $N_c=3$; Confinement als $T_R=0$-Selektion
    [B]
  \item \textbf{Dok.~322}: Hilbertraum-Einbettung; Fixpunkt-Randbedingungen
    auf $T^4/\mathbb{Z}_3$ [K]
\end{itemize}
...
\begin{enumerate}
  \item \textbf{$SU(3)_c$-Emergenz aus $\mathbb{Z}_3$-Trialität.}
    [\textbf{B} -- geschlossen durch Dok.~321] Die acht Gell-Mann-Operatoren
    sind algebraisch aus den $\mathbb{Z}_3$-Eigensektoren hergeleitet;
    $N_c=3$ ist algebraisch notwendig.
  ...
  \item \textbf{Formale Randbedingungen auf $T^4/\mathbb{Z}_3$.}
    [\textbf{K} -- ausgearbeitet in Dok.~322] Fixpunkt-Randbedingungen
    $\psi_\chi(x_0+y) = \chi\cdot\psi_\chi(x_0+g_*(y))$ und
    Hilbertraum-Einbettung vollständig.
\end{enumerate}
