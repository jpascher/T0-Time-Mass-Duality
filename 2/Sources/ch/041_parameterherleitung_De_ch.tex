...
% ============================================================
% Nachtrag 7. September 2026 — Registrierte Inkonsistenzen (K-041, R77)
% Quelle: Dok. 190-Archiv-2, deklariert 25. August 2026 (K-041)
%         und Dok. 190 Register R77 (Einordnung früher Formeln)
% Quelldokument bleibt unverändert (append-only, vgl. R50).
% ============================================================

\section*{Nachtrag: Interne Inkonsistenzen und Einordnung (Stand 7.~September 2026)}

\textbf{Hinweis:} Das Quelldokument bleibt inhaltlich unverändert
(append-only-Prinzip, vgl.\ Dok.~190, R50). Die folgenden Einträge
dokumentieren Stellen, an denen gedruckte Formeln und Tabellenwerte
im Dokument mit dem dokumenteigenen $\xi=(4/3)\cdot10^{-4}$ nicht
übereinstimmen. Auflösung erfordert Autorenkontrolle am Quelldokument.

\paragraph{K-041-a: CKM-CP-Phase $\delta_\mathrm{CKM}$ (deklariert 25.~Aug.~2026).}
Die gedruckte Formel $\delta_\mathrm{CKM}=\arcsin(2\sqrt{2}\cdot\sqrt{\xi}/3)$
ergibt $0{,}011$\,rad, nicht den Tabellenwert $1{,}20$\,rad.
Kandidat: $\arcsin(2\sqrt{2}/3)=1{,}231$\,rad --- der Faktor $\sqrt{\xi}$
ist vermutlich ein Satzfehler. Ob dieser Kandidat eine Korpusgröße ist,
ist am Quelldokument zu klären.

\paragraph{K-041-b: PMNS-Reaktorwinkel $\theta_{13}$ (deklariert 25.~Aug.~2026).}
Die gedruckte Formel $\theta_{13}=\arcsin(\xi^{1/3})$ ergibt $2{,}93°$,
nicht den Tabellenwert $8{,}57°$.
Kandidat: Argument $1/300=25\xi$ ergibt $8{,}59°$.
Ob $1/300$ eine eigenständige Korpusgröße ist, ist am Quelldokument zu klären.

\paragraph{K-041-c: CKM-Element $|V_{us}|$ (deklariert 25.~Aug.~2026).}
Die Formel mit Dok.~006-Massen ergibt $|V_{us}|=0{,}2124$;
Tabellenwert $0{,}22452$ (Abweichung $5{,}4\,\%$).
Mögliche Ursache: abweichende Massen oder $f_\mathrm{Cab}$-Definition
innerhalb dieses Dokuments.

\paragraph{R77: Einordnung früher Kopplungskonstanten-Formeln (deklariert im Register Dok.~190).}
...
(Dok.~336--348). Die Formeln in diesem Dokument bleiben archiviert;
numerische Verwendung erfordert Rückgriff auf die Nachfolgedokumente.
