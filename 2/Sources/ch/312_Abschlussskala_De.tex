...
\textbf{offen und muss hergeleitet werden} (Kap.~5). Er wird hier
...
(Kap.~1.1), ist die Metrik dynamisch -- und damit greift die
...
die Eddington-Frage als offene Stelle im Register (Kap.~5, Punkt~C)
...
voll gültigen Feldgleichungen (Kap.~4.2): Nachweis, dass die
...
Übernahme der vollen Feldgleichungen (Kap.~1.1) die
...
Modenzählung aus Beiblatt~312C, da dieselben Randbedingungen
...
(Kap.~1.1) ist also auch auf der Zeitseite konsistent: Die FFGFT
...
\begin{enumerate}
  ...
  \item \textbf{Relational:} In der Lesart des vorigen Kapitels ist
        ...
        Beiblatt~312C (C1$'$): Kausalität und Stabilität hängen an
...
(Kap.~1.1): Arbeitsteilung statt Widerlegung.
