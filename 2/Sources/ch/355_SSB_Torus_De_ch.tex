...
\textbf{Übersicht:} Alle SM-Fermion-Quantenzahlen und deren Belegstatus
sind in Dok.~356 (Teilchendiagramm) und Dok.~357 (Belegtabelle) zusammengefasst.
...
\begin{itemize}
  ...
  \item $7$: Ordnung-7-Elemente existieren in G$(6)$ über GF$(9)$ (Dok.~341 §6,
    \texttt{pruef\_341\_root7\_gf9}) \BM; ihre Lesart als \emph{Phasen}
    $k\cdot360°/7$ ist eine $\mathbb{R}$-Interpretation --- Charakteristik~3 kennt
    keine Winkel, und $\cos(2\pi/7)\notin\mathrm{GF}(3^k)$ für alle $k$ --- daher \SM
