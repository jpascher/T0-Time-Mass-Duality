...
$\mathbb{Z}_3$-Paarung $(k,-k)$. Die Defektindizes sind $(0,0)$ --
...
Voller Beweis der Selbstadjungiertheit von $\hat{F}$
  & [B] ausgeführt & Dok.~327 \\
Klassifikation des Defektindex von $\hat{F}$
  & [B] $(0,0)$, trivial & Dok.~327 \\
...
von $\hat{F}$ ist bewiesen (Dok.~327, R86): $\xi = \lambda_{\min}(\hat{F}_{D_4})$
ist damit als Spektralwert wohldefiniert.
