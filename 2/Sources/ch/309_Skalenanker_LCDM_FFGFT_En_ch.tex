...
% ============================================================
% Addendum 7 September 2026 — R71: Side-choice in the Hubble tension
% Source: Doc. 190-Archive-2 (R71)
% Source document remains unchanged (append-only, cf. R50).
% ============================================================

\section*{Addendum R71: Side-choice in the Hubble Tension (7~September 2026)}

\textbf{R71 --- Sharpened statement on the Hubble tension.}

The Hubble tension ($5\sigma$ between early-universe calibration from
CMB/BAO and the local distance ladder) is listed in the FFGFT analysis
of this document as ``structurally absent'' --- because FFGFT treats $H_0$
not from an expanding geometry but as an emergent, decompactified quantity.

\textbf{Clarification (R71):} This classification is correct but too brief.
``Structurally absent'' does not mean FFGFT explains the tension, but that
the model knows \emph{only one} $H_0$ value (the calibrated one), without
distinguishing between early- and late-time measurements. This is a weakness,
not a strength: FFGFT can neither reproduce nor resolve the tension, because
the geometry contains no expanding causal structure from which two different
measurement-epoch effects could follow.

Correct reading: the Hubble tension is \emph{not modelable} within FFGFT,
not model-independently absent. The table in this document is to be read
accordingly: ``structurally absent'' = ``not provided for in the model'',
no explanatory claim.
