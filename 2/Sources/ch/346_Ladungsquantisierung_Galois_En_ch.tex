...
\chapter*{Charge Quantisation from GF$(27)^*$: Electric Charge and Colour Algebraically Forced}
...
$O_1,O_3\subset\mathrm{QR}_{13}$; $O_2,O_4\subset\mathrm{NQR}_{13}$. $\square$
\end{proof}
