\section*{Abstract}
		Die T0-Theorie löst alle sieben physikalischen Rätsel aus Sabine Hossenfelders Video durch die fundamentale Konstante $\xi = \frac{4}{3} \times 10^{-4}$. Mit den originalen Parametern $(r_e, r_\mu, r_\tau) = (\frac{4}{3}, \frac{16}{5}, \frac{25}{9})$ und $(p_e, p_\mu, p_\tau) = (\frac{3}{2}, 1, \frac{2}{3})$ werden die Massenverhältnisse, Kopplungskonstanten und kosmologischen Parameter auf $\sim 1\,\%$ Genauigkeit reproduziert. Die $\xi$-Geometrie offenbart die zugrundeliegende Einheit der Physik und integriert ein statisches Universum ohne Big Bang.
	...
	\begin{align}
		m_e &= \frac{4}{3} \cdot \xi^{3/2} \cdot v = 0.000505\,\si{\giga\electronvolt} \quad (\Delta = 1{,}2\,\%) \\
		m_\mu &= \frac{16}{5} \cdot \xi^{1} \cdot v = 0.10496\,\si{\giga\electronvolt} \quad (\Delta = 0{,}7\,\%) \\
		m_\tau &= \frac{25}{9} \cdot \xi^{2/3} \cdot v = 1.7834\,\si{\giga\electronvolt} \quad (\Delta = 0{,}4\,\%)
	\end{align}
	\textbf{Experimentelle Werte (PDG 2024):}
	\begin{align}
	...
	\textbf{Koide-Formel (aus PDG-Massen):}
	\begin{align}
		Q &= \frac{m_e^{\text{exp}} + m_\mu^{\text{exp}} + m_\tau^{\text{exp}}}{(\sqrt{m_e^{\text{exp}}} + \sqrt{m_\mu^{\text{exp}}} + \sqrt{m_\tau^{\text{exp}}})^2} \\
		&= \frac{0.000511 + 0.105658 + 1.77686}{(\sqrt{0.000511} + \sqrt{0.105658} + \sqrt{1.77686})^2} \\
		&= 0.666661 \approx \frac{2}{3} \quad (\Delta = 0{,}001\,\%)
	\end{align}
	\begin{equation}
		Q \approx \frac{2}{3} \quad \checkmark
	\end{equation}
	FFGFT erklärt $Q = 2/3$ durch die geometrische Folge der Exponenten
	$p_{n+1} = (2/3)\,p_n$, die dasselbe Verhältnis $q = 2/3$ trägt
	wie der Koide-Wert $Q = 2/3$.
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{ll}
			...
			$r_i$ & Dimensionslose Skalierungsfaktoren für Leptonen: $(r_e, r_\mu, r_\tau) = \left(\frac{4}{3}, \frac{16}{5}, \frac{25}{9}\right)$ \\
	...
	\begin{thebibliography}{99}
		...
		\bibitem{koide1981} Yoshio Koide, Ä Charm-Tau Mass Formula'', Progress of Theoretical Physics, Bd. 66, S. 2285, 1981.
		
		\bibitem{koide1982} Yoshio Koide, Ön the Mass of the Charged Leptons'', Progress of Theoretical Physics, Bd. 69, S. 1823, 1983.
		...
		\bibitem{milgrom1983} Mordehai Milgrom, Ä modification of the Newtonian dynamics as a possible alternative to the hidden mass hypothesis'', Astrophysical Journal, Bd. 270, S. 365, 1983.
		...
		\bibitem{bednyakov2011} V. A. Bednyakov et al., Ön the metastability of the Standard Model vacuum'', arXiv:hep-ph/0104016, 2001.
		...
		\bibitem{t0_kosmologie} Johann Pascher, ``T0-Theory: Cosmology – Static Universe and $\xi$-Field Manifestations'', T0 Document Series, Document 6, 2025. 
		...
		\bibitem{casimir1948} H. B. G. Casimir, Ön the attraction between two perfectly conducting plates'', Proc. K. Ned. Akad. Wet., 51, 793, 1948.
		
	\end{thebibliography}
% ============================================================
% Nachtrag 7. September 2026 — P17: DE/DM-Relation zirkulär
% Quelle: Dok. 190-Archiv-1 (P17)
% Quelldokument bleibt unverändert (append-only, vgl. R50).
% ============================================================

\section*{Nachtrag P17: Einschränkungen zur DE/DM-Relation (7.~September 2026)}

\textbf{DE/DM-Relation ist zirkulär (P17, Dok.~190-Archiv-1):}
Die in diesem Dokument hergeleitete Relation zwischen Dunkler Energie und
Dunkler Materie ergibt für \emph{jeden} Wert von $\xi$ das Verhältnis $2{,}5$
--- sie ist damit eine algebraische Identität, keine physikalische Vorhersage.
Die Relation darf nicht als Bestätigung des $\xi$-Werts gewertet werden.

\textbf{MOND teil-hergeleitet:} Der Faktor $\xi^{1/4}$ in der MOND-Skala
$a_0 \propto \xi^{1/4}$ ist aus der Geometrie hergeleitet; die Konstante
$K_M$ bleibt frei. Die Ableitung ist keine vollständige Herleitung von MOND.

\textbf{CMB-Relationen:} Die CMB-Vorhersagen in diesem Dokument sind von
der DE/DM-Zirkularität \emph{nicht} betroffen und bleiben gültig.

Dieses Dokument ist für die DE/DM-Relation als vorgemerkt einzustufen;
eine überarbeitete Behandlung steht aus.
