...
$\sum_k g_k^2\,\delta(\omega-\omega_k)$ -- ebenfalls nicht-Markovsch
(Rückfluss, Revivals), mit Exponentialform $\to$ interne Variable. \emph{Dieselbe
Objektklasse.} Wo der Raum forkt (5- gegen 3-zählig), stehen sich auf der Zeit-Ebene
zwei Kerne desselben Typs gegenüber: \emph{räumliche Gabelung, möglicher
...
schwache Nulls, nicht den generischen Biexponential). Die $\chi$-Brücke ist also
\emph{strukturelle Verwandtschaft}, kein Eindeutigkeitsanspruch -- konsistent mit
Dok.~276/281 (auch $\varphi$ ist nicht spezifisch).
\end{enumerate}
...
Kandidat -- nicht HLV-eindeutig (Run~M1: ein generischer Biexponential schlägt den
HLV-Kern). Bridge-Kandidat, kein Eindeutigkeitsanspruch.
