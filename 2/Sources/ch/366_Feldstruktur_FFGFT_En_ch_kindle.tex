% 366_Feldstruktur_FFGFT_En_ch_kindle.tex
% Johann Pascher, 19 September 2026 -- Kindle 6x9 edition
...
\textbf{[S]} & structurally plausible \\
\textbf{[POSIT]} & motivated input \\
\textbf{[E]} & established mathematics/physics \\
...
$(n_\theta, n_\varphi)$ & winding numbers on $T^4$; topological invariants \\
\midrule
\multicolumn{2}{l}{\textit{Antenna engineering}} \\
$R_\mathrm{rad}$ & radiation resistance (power radiated into space) \\
...
$\Delta\theta_{3\,\mathrm{dB}}$ & half-power beamwidth \\
...
\toprule
\textbf{Factor} & \textbf{Meaning} & \textbf{FFGFT} \\
\midrule
$G_T$ & transmit focussing & source mode geom. \\
$G_R$ & receive focussing & receive mode geom. \\
$(\lambda/4\pi r)^2$ & free-space loss & propagation factor \\
$\cos^2\psi$ & polarisation overlap & winding compat. \\
\bottomrule
\end{tabular}
\end{center}
...
\toprule
\textbf{Type} & \textbf{Gain} & \textbf{$\Delta\theta$}
             & \textbf{Mode geom.} \\
\midrule
...
\toprule
\textbf{Property} & \textbf{Antenna} & \textbf{Particle} \\
\midrule
...
\begin{center}
\begin{tabular}{@{}llp{2.2cm}p{1.8cm}p{2cm}@{}}
\toprule
\textbf{Scale} & \textbf{Carrier} & \textbf{Coupling condition}
  & \textbf{Example} & \textbf{Analogue} \\
\midrule
Antenna & radiator & $\cos^2\psi$, $Z$ & Yagi & Friis \\
Atom & Coulomb & $\Delta l=\pm1$ & H lines & sel.rule \\
Molecule & potential & $\partial\mu/\partial Q\neq0$ & IR & dipole \\
Crystal & lattice & $2d\sin\theta=n\lambda$ & Bragg & array \\
Per.table & shells & overlap $S_{AB}$ & bond & aperture \\
Mol.bond & orbital & symm.compat. & HOMO & modes \\
Planets & gravity & $p\,n_1=q\,n_2$ & Laplace & Arnold \\
\bottomrule
\end{tabular}
\end{center}
