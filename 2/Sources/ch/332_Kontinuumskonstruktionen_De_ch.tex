...
Fassung dieses Dokuments zurück; siehe Dok.~190, Registereinträge R96 und R97.
\end{quellbox}
...
(stetig für Auswertung, $C^1$ bzw.\ ein Sobolev-Raum $H^1$ für
Differenzierbarkeit) ist an jedem Punkt $t\in\mathbb{R}$ statt nur modulo
$R_m$ auswertbar, ableitbar, mit nicht-periodischen Testfunktionen
vergleichbar. Diese Eigenschaft gehört dem Repräsentanten, nicht dem
