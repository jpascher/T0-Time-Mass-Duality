...
\begin{tabular}{lccc}
	...
	\begin{theorem}
		Die Koide-Relation $Q = \frac{2}{3}$ ist eine direkte mathematische Konsequenz der T0-Exponenten $(p_e, p_\mu, p_\tau) = \left(\frac{3}{2}, 1, \frac{2}{3}\right)$ und der zugehörigen Verhältnisse $(r_e, r_\mu, r_\tau) = \left(\frac{4}{3}, \frac{16}{5}, \frac{25}{9}\right)$.
	\end{theorem}
...
In diesem Dokument erscheinen zwei verschiedene Genauigkeitsangaben für
die Koide-Relation:
$\Delta Q < 0{,}00003\,\%$ (interne Berechnung) und $0{,}001\,\%$ (externe Darstellung).

\textbf{Beide sind korrekt} (P1, Dok.~190-Archiv-1) --- sie beschreiben verschiedene
Dinge: Der Wert $\Delta Q < 0{,}00003\,\%$ ist das direkte numerische Ergebnis
der Rechnung mit den PDG-Massen; der Wert $0{,}001\,\%$ ist die für externe
Publikationen gerundete Angabe, die die Messgenauigkeit der Eingangsmassen
einschließt. Bei der Lektüre ist die jeweilige Verwendung zu beachten.
