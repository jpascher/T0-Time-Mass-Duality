...
\]
The $\varepsilon_i$ are \emph{computed residuals} from PDG \QM\ against FFGFT bare \KM\ ---
not numbers taken from the QED literature. The column ``Presumed origin'' is an
attribution \SM, not a citation.

\begin{center}
\begin{tabular}{@{}lll@{}}
\toprule
Particle & $\varepsilon_i$ & Presumed origin \SM\ \\
\midrule
