...
\begin{align}
  ...
  m_{\nu_3} \text{ (table value)}= \mathbf{44.51}~\mathbf{meV}.
\end{align}
...
\begin{equation}
  \Delta m_{32}^2 = (44.51~\text{meV})^2 - (9.084~\text{meV})^2
  = 1981.1 - 82.5 = 1898.6~\text{meV}^2
  = \mathbf{1.90\times10^{-3}~\text{eV}^2}.
\end{equation}
PDG~2023: $2.44\times10^{-3}$~eV$^2$. Deviation: $-22\,\%$.

\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!60!black,
  title={Open point: atmospheric mass-squared difference}]
$\Delta m_{21}^2$ agrees to $+8\,\%$, within the typical FFGFT range.
$\Delta m_{32}^2$ deviates by $-22\,\%$ (factor $\sim1.3$). The fixed-point
exponents $p_i$ are secured~[K]; the source of the $\Delta m_{32}^2$
discrepancy is an open point. Status: \textbf{[S]}.
\end{tcolorbox}

\subsubsection{Cosmological mass sum}

\begin{equation}
  \sum_i m_{\nu_i} = 0.976 + 9.084 + 44.51~\text{meV}
  = 54.57~\text{meV} = 0.0546~\text{eV}.
\end{equation}
...
the $\mathbb{Z}_3$ projection. \textbf{[S]} Full algebraic derivation
of the Gell-Mann matrices from orbifold modes is planned for Doc.~321.
...
$\Delta m_{32}^2$ ($-22\,\%$)                 & this Doc.          & [S] open \\
$SU(3)_c$ from $\mathbb{Z}_3$                  & Doc.~321 (planned) & [S] \\
Weinberg angle $\theta_W$ from $\xi$           & open bridge        & --- \\
