...
\textbf{Note (31~August 2026):} This section derives neutrino masses from
orbifold fixed points ($F_2, F_5, F_7$, exponents $\{9/4,2,9/5\}$) and
achieves $\Delta m^2_\text{atm}$ with a deviation of $+13.8\,\%$ (bridge R87).
Doc.~339/340 (August 2026) derives both mass differences from the
$GF(27)^*$ Frobenius orbit structure and closes R87 at $1.0\,\%$
deviation [K]. The present fixed-point derivation is retained as a
historical development step; the current derivation is Doc.~340.


\textbf{Addendum (3 September 2026, Doc.~343 Theorem~D$'''$):} The quadratic
character mod~13 (self-inverseness of the Frobenius orbit under $k\mapsto k^{-1}$)
determines Majorana/Dirac for the Galois masses in Doc.~340: $\nu_1$ (orbit $O_1$)
and $\nu_2$ (orbit $O_3$) are Majorana, $\nu_3$ (orbit $O_4$) is a
\textbf{Dirac neutrino} \textbf{[B]}. The fixed-point assignment $F_2,F_5,F_7$ in
this section provides no Majorana/Dirac character; this follows only from the
Galois algebra of Doc.~340/343.
