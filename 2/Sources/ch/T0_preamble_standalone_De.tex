...
\hyphenation{Ver-hält-nis-formel Be-rech-nung T0-Ver-hält-nis-for-mel T0-Be-rech-nung}
...
\newcommand{\taupar}{\tau}
% Proper reduced Compton wavelength notation
\newcommand{\lambdabar}{{\mkern-2mu\mathchar '26\mkern-5mu\lambda}}
% --- Provided Commands ---
