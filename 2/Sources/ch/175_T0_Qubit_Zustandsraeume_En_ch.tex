...
% ============================================================
% Addendum 7 September 2026 — R61: xi_Higgs withdrawn
% Source: Doc. 190-Archive-2 (R61)
% Source document remains unchanged (append-only, cf. R50).
% ============================================================

\section*{Addendum R61: Status of $\xi_\text{Higgs}$ (7~September 2026)}

The quantity $\xi_\text{Higgs} \approx 1.038\times10^{-5}$ used in this
document is \textbf{withdrawn} (R61, Doc.~190-Archive-2). Justification
and canonical replacement ($\xi_0 = 4/30000$): see addendum in Doc.~174.
