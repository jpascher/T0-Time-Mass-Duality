...
\end{quote}
	...
	\begin{revolutionary}
		Heisenbergs Unschärferelation $\Delta E \times \Delta t \geq \hbar/2 = 1/2$ (natürliche Einheiten) beweist unwiderlegbar, dass eine klassische Urknall-Singularität mit unendlicher Dichte physikalisch unmöglich ist und durch einen winzigen, aber endlichen Kern mit minimaler Längenskala $L_0$ (aus $\xi$) ersetzt wird.
	\end{revolutionary}
