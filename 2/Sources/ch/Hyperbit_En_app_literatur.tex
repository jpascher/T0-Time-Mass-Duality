...
\item[{[P1]}] J.~Pascher, \textit{A271 — Landauer und die Phase Space Accounting},
...
\item[{[P2]}] J.~Pascher, \textit{A272 — carrier und Information},
  FFGFT-Korpus, Juli 2026.\\
...
\item[{[P4]}] J.~Pascher, \textit{A280/A281 — Landauer-Phase Space Accounting
  (erweitert) / carrier und Information (erweitert)},
  FFGFT-Korpus, 2026.\\
  \href{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/A_Serie_Export/pdf/A280_Landauer_phase space_Buchhaltung_De.pdf}{A280 PDF}
  $\cdot$
...
\item[{[P7]}] J.~Pascher, \textit{Dok.\,257 — Informationseinheit auf $T^4$},
  ...
  $\cdot$ $\Ebit = \hbar c/L$, winding quantum $\Delta w = 1$; Kap.\,\ref{ch:informationseinheit_skala}.
...
\item[{[T3]}] J.~R.~Munkres, \textit{Topology}, 2nd ed.,
  Prentice Hall, 2000.\\
  Kap.\,9: fundamental group; Kap.\,11: Seifertvon-Kampen-Theorem.
