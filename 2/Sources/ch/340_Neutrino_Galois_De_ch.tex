...
\begin{enumerate}
\item Die Zahl $11=|\mathbb{Z}_{13}|-2$ regiert beide Massendifferenzen
  nach demselben algebraischen Prinzip \KM:
  \begin{itemize}
  \item Solare Ableitung: $11/3=(|\mathbb{Z}_{13}|-2)/|\text{Frobenius-Ordnung}|=(13-2)/3$
  \item Atmosphärische Masse: $m_{\nu_3}=11\,m_{\nu_1}$, da alle $11$
    nicht-fixierten Elemente von $\mathbb{Z}_{13}$ zur dynamischen
    Massenoszillation beitragen (die $2$ Fixpunkte $\{+1,-1\}$ sind invariant).
  \end{itemize}
  Beide Ableitungen sind unter demselben Galois-Prinzip vereinigt.
