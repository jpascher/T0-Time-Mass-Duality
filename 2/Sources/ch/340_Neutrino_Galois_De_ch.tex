...
Der Reaktorwinkel $\theta_{13}$ folgt aus dem Massenquotienten
...
\quad(\text{gemessen: }0.0220,\;\text{Abw.\ }7.4\,\%)
\]
Die Summenregel $\sin^2\theta_{13}=(2/3)\,R_\nu$ folgt aus dem
$A_4$-Zwei-Null-Texturmodell mit TM$_2$-Mischungsmatrix
\cite{Razzaghi2022}; in Galois-Lesart ist der Faktor
$2/3=\min(\text{Orbit}_2)/\max(\text{Orbit}_1)=2/9\cdot3$.
...
\]
Die Konsistenz beider $\theta_{12}$-Werte aus unabhängigen Herleitungen
stärkt die Verbindung zwischen $A_4$/TM$_2$ und der GF$(27)^*$-Struktur.
...
\item $\sin^2\theta_{23}=0.433$--$0.441$ (unteres Oktant) --
  gemessen und Galois: $0.545$--$0.560$ (oberes Oktant).
\item $\delta_{CP}\approx\pm51°$ --
  T2K-Hinweis und Galois ($k=10$): $\approx-83°$.
...
\item Algebraische Begründung für das $+1$ in $m_{\nu_3}=11\,m_{\nu_1}$
  -- $11=|\mathbb{Z}_{13}|-2$ ist die sauberste Galois-Antwort \KM;
  Kissing$(E_8)$/Kissing$(D_4)+1=11$ ergänzend plausibel \SM.
\item Vollständige Galois-Herleitung des Faktors $2/3$ in der
  $\theta_{13}$-Summenregel ohne Rückgriff auf das A$_4$-Modell.
\item Verbindung der diskreten Orbit-Phasen $2\pi k/13$ mit der
  PMNS-$U$-Matrix.
\end{enumerate}

Prüfskript: \texttt{pruef\_340\_neutrino\_galois.py}
(12/12 Assertions bestanden).
...
\emph{Erklärt 30.~August 2026, ergänzt 30.~August 2026 ($\theta_{13}$, T$_{13}$-Literatur)}
