...
% -------------------------------------------------------------------
	...
	\textbf{Ergänzung (Nachtrag 3.~September 2026, Dok.~343 Satz~D$'''$)}\\[3pt]
	Dok.~343 zeigt: Der quadratische Charakter mod~13 (Selbstinversheit des Orbits
	unter $k\mapsto k^{-1}$) bestimmt Majorana/Dirac für die gesamte Fermion-Schicht.
	$O_1$ und $O_3$ sind selbstinvers $\Rightarrow$ Majorana ($\nu_1$, $\nu_2$). $O_4$
	ist nicht selbstinvers $\Rightarrow$ \textbf{$\nu_3$ ist ein Dirac-Neutrino} \BM.
	Die Vorhersage $m_{ee}\approx7{,}1$~meV in diesem Dokument gilt unter genau dieser
	Annahme. Die invertierte Hierarchie ist dadurch stärker ausgeschlossen.
