...
\begin{tabular}{lcc}
	...
	\begin{documentbox}
		...
		\end{equation}
		\emph{Korrektur (Dok.~190 K6):} die frühere wellenlängenabhängige Form
		$z(\lambda_0,d)=\xi d\,\lambda_0/E_\xi$ ist überholt -- die fraktale
		Wegverlängerung ist \emph{achromatisch} (Finite-Elemente-Simulation).
		Vertiefung: Dok.~280 (z$\to$Zeit als $\Lambda$CDM-Übertragung, kosmologische
