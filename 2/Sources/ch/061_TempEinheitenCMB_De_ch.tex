...
\begin{tabular}{lcc}
	...
	\end{table}
{$^*$Die an $H_0$ kalibrierte T0-Beschreibung $H_0^{\text{T0}} = E_H/\hbar \approx 66{,}2\,$km/s/Mpc ($-1{,}9\%$ Abweichung von Planck) sowie die vollständige Auflösung der Hubble-Spannung sind in Dokument~026 (Geometrische Kosmologie) zentralisiert.}
