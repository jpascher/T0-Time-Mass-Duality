...
% ============================================================
% Addendum 7 September 2026 — P35: xi^N triviality
% Source: Doc. 190-Archive-2 (P35)
% Source document remains unchanged (append-only, cf. R50).
% ============================================================

\section*{Addendum P35: $\xi^N$ Triviality (7~September 2026)}

Expressions of the form ``$X = \xi^N$'' are intrinsically meaningless on their
own (P35, Doc.~190-Archive-2). Full justification: addendum P35 in Doc.~182.
For the scale tables and $\xi$-powers in this document: only exponents whose
form is derived geometrically forward are non-trivial. Retrospectively fitted
exponents are to be classified as \textbf{[S]}.

% ============================================================
% Addendum 7 September 2026 — R92(ii): Schwarzschild identity
% Source: Doc. 190-Archive-2 (R92); moved from register to here
% Source document remains unchanged (append-only, cf. R50).
% ============================================================

\section*{Addendum R92(ii): Schwarzschild Radius and $L_0$ --- Identity, not a Test (7~September 2026)}

The old edition of Doc.~190 (23~August 2026, now Archive-2) stated under
Precision~4: an object with $M_0 = \xi m_P/2$ would have Schwarzschild
radius exactly $L_0$.

\textbf{This is an identity, not a physical test.}
From $r_s = 2GM/c^2$ and $\ell_P = \sqrt{\hbar G/c^3}$ it follows
that $Gm_P/c^2 = \ell_P$ (by definition), hence:
\[
  r_s(x\,m_P/2) = \frac{2G\cdot x\,m_P/2}{c^2} = x\cdot\frac{Gm_P}{c^2} = x\,\ell_P
\]
for \emph{every} $x\in\mathbb{R}^+$. With $x=\xi$ it follows that
$r_s(\xi m_P/2)=\xi\,\ell_P=L_0$ trivially --- the equation tests neither
$\xi$ nor the exponent in $L_0=\xi\,\ell_P$. It is dimensional bookkeeping,
not a substantive finding.

The classification as a ``consistency check'' in the old Doc.~190 was too strong.
The relation $L_0=\xi\,\ell_P$ is established by independent arguments \textbf{[K]}
(Docs.~180, 327); this identity contributes nothing to that.
