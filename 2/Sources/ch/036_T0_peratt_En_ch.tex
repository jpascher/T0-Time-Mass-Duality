\section*{Abstract}
	...
	T0 unifies both approaches via the $\xi$-field: a static universe with fractal geometry, where redshift arises as a geometric path effect in the $\xi$-field (see Document~026 for the quantitative derivation).
