...
\textbf{[E]} & \emph{Established} --- textbook- oder Konsensuswissen. \\[3pt]
\textbf{[L]} & \emph{Referencese reference} --- external primary reference. \\[3pt]
...
präzise, belegt sie mit aktueller References, und skizziert, was eine
...
\item Satz~C \BM: Group-equivariant networks (G-CNNs) für kontinuierliche
...
% ============================================================
\section{Satz A: HRV band limits in the Galois grid}
% ============================================================
...
die die Algebra bereits getropen hat. Das entspricht der Idee des
``inductive bias'' aus der Lerntheorie --- nur algebraisch begründet statt
empirisch gewählt \LM\,\cite{ILCRBlog2023}.

% ============================================================
\section{Satz B: The resolution limit appears empirically}
% ============================================================
...
% ============================================================
\section{Satz C: What group-equivariant networks achieve --- and where the gap is}
% ============================================================
...
% ============================================================
\section{Satz D: The admissibility criterion is not PAC-learnable}
% ============================================================
...
\subsection*{Hidden layers: $(\mathbb{Z}/13)^*$-Equivarianz}
...
\subsection*{Resolution filter: $100\xi$-Schwelle}
...
\subsection*{Stability rating: Arnold tongue width}
...
\subsection*{What this achieves over standard AI}
...
\item \textbf{Neue Biomarker:} Statt LF/HF-Ratio (ein einzelner Zahlenwert)
  ...
  schwingt. Das ist neu und hat keine Entsprechung in der References \SM.
...
\item Der algebraische Orbit-Biomarker in §6 ist eine Hypothese; seine
  physiologische Bedeutung ist open.
...
für Formulierung, LaTeX-Satz, Referencesrecherche und die Erstellung des
