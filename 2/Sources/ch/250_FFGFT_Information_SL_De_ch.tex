...
Ausdrücke der Form „$X = \xi^N$" sind für sich allein aussagelos
(P35, Dok.~190-Archiv-2). Vollständige Begründung: Nachtrag P35 in Dok.~182.
Für die Skalentabellen und $\xi$-Potenzen in diesem Dokument gilt:
Nur Exponenten, deren Form geometrisch vorwärts hergeleitet ist,
sind nicht-trivial. Nachträglich angepasste Exponenten sind als \textbf{[S]}
einzustufen.

% ============================================================
% Nachtrag 7. September 2026 — R92(ii): Schwarzschild-Identität
% Quelle: Dok. 190-Archiv-2 (R92); aus dem Register hierher verschoben
% Quelldokument bleibt unverändert (append-only, vgl. R50).
% ============================================================

\section*{Nachtrag R92(ii): Schwarzschild-Radius und $L_0$ --- Identität, keine Probe (7.~September 2026)}

In der alten Fassung von Dok.~190 (23.~August 2026, jetzt Archiv-2)
stand unter Präzisierung~4 die Aussage: ein Objekt mit $M_0 = \xi m_P/2$
hätte den Schwarzschild-Radius genau $L_0$.

\textbf{Das ist eine Identität, keine physikalische Probe.}
Aus $r_s = 2GM/c^2$ und $\ell_P = \sqrt{\hbar G/c^3}$ folgt
$Gm_P/c^2 = \ell_P$ (Definition), also:
\[
  r_s(x\,m_P/2) = \frac{2G\cdot x\,m_P/2}{c^2} = x\cdot\frac{Gm_P}{c^2} = x\,\ell_P
\]
für \emph{jedes} $x\in\mathbb{R}^+$. Mit $x=\xi$ folgt $r_s(\xi m_P/2)=\xi\,\ell_P=L_0$
trivialerweise --- die Gleichung testet weder $\xi$ noch den Exponenten in $L_0=\xi\,\ell_P$.
Sie ist dimensionale Buchhaltung, kein inhaltlicher Befund.

Die Einstufung als „Konsistenzprüfung" in der alten Dok.~190 war zu hoch gegriffen.
Die Verbindung $L_0=\xi\,\ell_P$ ist durch eigenständige Argumente belegt \textbf{[K]}
(Dok.~180, 327); diese Identität trägt dazu nichts bei.
