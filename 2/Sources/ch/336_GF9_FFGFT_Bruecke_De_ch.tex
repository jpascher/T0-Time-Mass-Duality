...
\begin{itemize}
  \item \textbf{Fixpunkte} ($x^3=x$): $\{0,1,2\} = \mathrm{GF}(3)$ — genau die
    FFGFT-Sektoren $\Delta w\in\{0,1,2\}$ \BM
...
\begin{align*}
  \|x\| = 1&: \{i,\,2i,\,1,\,2\}\quad \text{— rein reell/imaginär (leicht)} \\
  \|x\| = 2&: \{1{+}i,\,1{+}2i,\,2{+}i,\,2{+}2i\}\quad \text{— gemischt (schwer)}
\end{align*}
