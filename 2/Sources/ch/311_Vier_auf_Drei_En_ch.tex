...
\subsection*{How sharp the assignment is}

The five neighbouring integer exponents come out very differently ---
the neighbours of 36 lie roughly a hundred times further away:
\begin{center}
\begin{tabular}{crr}
\toprule
$n$ & $(75/74)^n$ & against $16/\pi^2$ \\
\midrule
34 & $1.578354$ & $-2.639\,\%$ \\
35 & $1.599683$ & $-1.323\,\%$ \\
...
\end{tabular}
\end{center}
Not a fit with a soft edge, but a window with two edges: the exponent
is unambiguous.

Two qualifications belong next to this. The $0.010\,\%$ measures the
rounding of $35.9926$ to the integer~36, not the agreement of the two
routes --- their distance is $0.098$ in the exponent and is covered by
the stated precision of the factor~100 (register 190, R67). And the
sharpness concerns the \emph{assignment} to the integer, not the
\emph{derivation}: why a recursion depth should correspond to a
packing density remains open (P35).
