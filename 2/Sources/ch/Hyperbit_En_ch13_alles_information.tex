...
\section{Information ohne carrier?}

Hier liegt die entscheidende Spannung zu A271--A273:

In der Landauer-Analyse ist Information \emph{immer} an einen carrier
gebunden. Ein Bit ohne carrier ist eine abstrakte Kategorie, keine
...
Medium kodiert. Das Universum ist sein eigener carrier.

Das ist kein Widerspruch, sondern eine Grenzfall-Situation: Wenn das Medium
\emph{selbst} aus Information besteht, gibt es keinen unabhängigen carrier
mehr.

\begin{laierspur}
Ein Buch enthält Information auf Papier --- der carrier ist das Papier.
Aber was ist, wenn das Papier selbst aus Buchstaben besteht?
Dann ist der carrier und der Inhalt dasselbe. Das ist die Situation im
Universum, wenn man es als geometrische Struktur versteht: Die Geometrie
ist das carriermedium und die Information gleichzeitig.
\end{laierspur}
...
aus den Galois group orders des Körpers $\mathrm{GF}(3^n)$ und den
...
\[
  ...
  = \frac{4}{30000}
\]
Die drei Galois-Faktoren haben konkrete algebraicallye Bedeutung: \status{K Dok.\,338}
...
Die Antwort auf das „Warum" von $\xi$ ist damit algebraically, nicht
