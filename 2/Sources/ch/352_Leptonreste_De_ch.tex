...
PDG erfüllt $d = c\sqrt{2}$ auf $0{,}07\cdot\xi$. FFGFT-Vorhersagen verfehlen es um
$+12\cdot\xi$ --- derselbe Faktor $\sim 170$ wie beim $Q$-Vergleich, konsistent.
...
\item \textbf{Amplitude $d/c$ --- revidiert auf \KM\ (s.~§\,9):} Die bare FFGFT-Amplitude
  verfehlt $\sqrt{2}$ um $+12\cdot\xi$. Die generationsabhängigen Korrekturen $\varepsilon_i$
  bringen $d/c$ quantitativ auf $\sqrt{2}$ --- zu 101\,\% erklärt.
\end{enumerate}
...
Die fallende $\varepsilon_i$-Struktur ist keine freie Annahme, sondern eine Konsequenz
der massenabhängigen QED-Renormierung in Kombination mit der SI-Projektion. FFGFT
liefert die Bare-Massen; die Spreizung der $\varepsilon_i$ ist eine externe
\QM-Tatsache in ihrer Größenordnung. Ob die QED-Selbstenergie aus der T$^4$/Z$_3$-Geometrie
herleitbar ist, bleibt offen \SM\ --- das ist die R113-Brücke.
