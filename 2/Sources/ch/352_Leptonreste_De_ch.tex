...
\[
  ...
  \varepsilon_i = \frac{m_i^{\rm PDG}}{m_i^\circ} - 1 \quad\KM
\]
Die $\varepsilon_i$ sind \emph{berechnete Residuen} aus PDG \QM\ gegen FFGFT-bare \KM\ ---
keine aus der QED-Literatur übernommenen Zahlen. Die Spalte ,,Vermutete Herkunft`` ist
eine Attribution \SM, kein Zitat.

\begin{center}
\begin{tabular}{@{}lll@{}}
\toprule
Teilchen & $\varepsilon_i$ & Vermutete Herkunft \SM\ \\
\midrule
