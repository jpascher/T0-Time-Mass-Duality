...
\subsection*{Wie scharf die Zuordnung ist}

Die fünf benachbarten ganzzahligen Exponenten fallen sehr
unterschiedlich aus --- die Nachbarn der 36 liegen rund hundertmal
weiter weg:
\begin{center}
\begin{tabular}{crr}
\toprule
$n$ & $(75/74)^n$ & gegen $16/\pi^2$ \\
\midrule
34 & $1{,}578354$ & $-2{,}639\,\%$ \\
35 & $1{,}599683$ & $-1{,}323\,\%$ \\
36 & $1{,}621301$ & $\mathbf{+0{,}010\,\%}$ \\
37 & $1{,}643210$ & $+1{,}361\,\%$ \\
38 & $1{,}665416$ & $+2{,}731\,\%$ \\
\bottomrule
\end{tabular}
\end{center}
Kein Fit mit weichem Rand, sondern ein Fenster mit zwei Rändern: der
Exponent ist eindeutig.

Zwei Einordnungen gehören daneben. Die $0{,}010\,\%$ messen die
Rundung von $35{,}9926$ auf die Ganzzahl~36, nicht die Übereinstimmung
der beiden Wege --- deren Abstand beträgt $0{,}098$ im Exponenten und
ist durch die Angabegenauigkeit des Faktors~100 gedeckt (Register 190,
R67). Und die Schärfe betrifft die \emph{Zuordnung} zur Ganzzahl,
nicht die \emph{Herleitung}: warum eine Rekursionstiefe einer
Packungsdichte entsprechen sollte, bleibt offen (P35).
