...
deterministisch). Die $O(1/k)$-Asymptotik ist benannt. Dieser Prüfstand ist eine skript-verifizierte \emph{Illustration} des $e$-Kriteriums (Dok.~295), kein eigenständiger neuer Befund; sein Wert ist, die Achse operativ sichtbar zu machen. FFGFT selbst trägt eine \emph{einzige}, krümmungstreue Windung --- der gleichförmige Akkumulator ist eine Kontrastfolie aus dem Brücken-Kontext, kein FFGFT-Objekt; die Trennfrage stellt FFGFT \emph{für die Brücke}, nicht für sich.
