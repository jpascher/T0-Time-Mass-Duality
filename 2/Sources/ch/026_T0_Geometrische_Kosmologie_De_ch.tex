\section*{Abstract}
	...
	\end{equation}
	Die T0-Beschreibung nutzt die Hubble-Energie $E_H = E_0 \cdot \xi^{41/4}$, woraus sich $H_0^{\text{T0}} = E_H/\hbar \approx 66{,}2\,$km/s/Mpc ergibt ($-1{,}9\%$ Abweichung von Planck); der Exponent $41/4$ ist dabei an den gemessenen $H_0$ kalibriert, nicht parameterfrei (siehe unten sowie Dok.~190, P35).
	...
	\begin{center}
		...
		\begin{tabular}{lccc}
			...
			\midrule
			\textbf{T0-Beschreibung} & \textbf{66{,}2} & \textbf{an $H_0$ kalibriert} & $H_0 = E_H/\hbar$ \\
