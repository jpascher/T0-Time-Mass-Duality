...
\end{equation}
	...
	\begin{itemize}
		...
		\item Skalierung auf Massenbereich: $321.87/1.314 \approx 245$ (Faktor $1.314$ ist ein empirischer Anker; er folgt aus $K = R_{pe}/(4/3)^7$, nicht aus einer unabhängigen geometrischen Ableitung)
	\end{itemize}
