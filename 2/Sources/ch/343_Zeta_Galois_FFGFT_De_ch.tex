...
\textbf{Deutung \BM.} Dok.~341 legt für die Leptonen die Ordnung~26 in G$(6)$
fest; die Klasse folgt hier: Geladene Leptonen sind Dirac-Teilchen und gehören
in $\{f_3,f_4\}$. Die Majorana-Schicht $\{f_1,f_2\}$ ist vollständig mit
aktiven Neutrinos besetzt: Dok.~340 setzt $\nu_1$ in $O_1=f_1$ (Majorana) und
$\nu_2$ in $O_3=f_2$ (Majorana) sowie $\nu_3$ in $O_4$ (Dirac-Orbit, nicht
selbstinvers). Das ist kein Widerspruch, sondern eine Aussage: $\nu_3$ ist ein
