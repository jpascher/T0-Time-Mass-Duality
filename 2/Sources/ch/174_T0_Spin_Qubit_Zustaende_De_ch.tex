...
(algebraischer Kopplungsparameter, via $\lambda_h^2 v^2/(16\pi^3 m_h^2)$) ist
\textbf{zurückgezogen} (R61, Dok.~190-Archiv-2).

\textbf{Grund:} Die Auswahl von $\xi_\text{Higgs}$ erfolgte, weil er das gemessene
Fenster trifft --- die Zwei-Räume-Doktrin (geometrisches $\xi_0$ vs.\ algebraisches
$\xi_\text{Higgs}$) ist Rationalisierung nach der Auswahl, keine unabhängige Begründung.
Ein datengetrieben gewählter Parameter ist kein zweiter Fundamentalparameter.

\textbf{Gültig bleibt:} $\xi_0 = 4/30000$ als geometrisches Verhältnis $L_0/\ell_P$.
Die Rechnungen in diesem Dokument, die $\xi_\text{Higgs}$ verwenden, sind als
Vorstudien einzuordnen; für kanonische Ableitungen gilt ausschließlich $\xi_0$.
Maßgeblich: Dok.~174 (R61), Dok.~190-Archiv-2.
