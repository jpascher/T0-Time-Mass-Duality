% ==============================================================================
% FFGFT: Fundamentale Fraktalgeometrische Feldtheorie - Shared German Preamble
% Version: 2.0
% Author: Johann Pascher
% Date: 2025
% ==============================================================================
%
% Dies ist die standardisierte gemeinsame Präambel für alle deutschen FFGFT-Dokumente.
% (Früher bekannt als T0-Theorie)
% Platzieren Sie diese Datei im Verzeichnis Ihres Dokuments oder verwenden Sie einen Pfad wie:
%   \input{path/to/T0_preamble_shared_De}
%
% Verwendung:
%   \documentclass[12pt,a4paper]{article}  % oder book, report, etc.
...
% ==============================================================================
%
% ONTOLOGISCHE GRUNDLAGE DER FFGFT:
%
% Das dynamische Vakuumfeld T(x,t) ist das fundamentale fraktalgeometrische Feld
% und bildet die alleinige ontologische Grundlage der gesamten Physik. Es ist das
% Universum selbst - ein allumfassendes, dynamisch-intrinsisch-fraktal-geometrisches
% Kontinuum. Alle anderen Felder (elektromagnetisches Feld, Higgs-Feld,
% Gravitationsfeld, starke und schwache Wechselwirkungsfelder) sind lediglich
% partielle, abgeleitete Manifestationen oder Projektionen dieses einen primären
% Vakuumfeldes. Die gesamte Physik reduziert sich somit auf die Dynamik und Geometrie
% des fundamentalen fraktalgeometrischen Feldes T(x,t), dessen intrinsische
% fraktale Struktur durch den einzigen geometrischen Parameter ξ = (4/3) × 10^{-4}
