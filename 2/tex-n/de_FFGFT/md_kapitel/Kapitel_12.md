...
Φ(t) = ρ(t) e^{iθ(t)}
Here, ρ(t) is the vacuum amplitude determining vacuum energy density, and θ(t) encodes dynamic vacuum
field.
...
The Big Bang corresponds to the moment when the vacuum transitioned from the unstable state ρ ≈ 0 to
the stable dynamic vacuum field state ρ = ρ₀. This transition releases energy, sets θ(t) into coherent
...
• Pre-Big-Bang: ρ ≈ 0, incoherent vacuum
• Phase transition: ρ grows, θ becomes coherent
• Inflation: V(ρ) nearly constant
• Reheating: Φ couples to matter
• Radiation era
• Matter era
