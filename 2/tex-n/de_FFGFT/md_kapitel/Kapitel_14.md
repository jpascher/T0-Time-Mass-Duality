...
A(∂ₜ²ρ + 3H∂ₜρ) − B(∂ᵣ²ρ + 2∂ᵣρ/r) + U'(ρ) = 0,
where H = ȧ/a.
In a thin-front approximation ρ(r,t) ≈ f(r − R(t)), the evolution of R(t) obeys:
σ R¨ + 3H σ R˙ + (2σ / R) = ΔU,
where:
• σ is surface tension of the amplitude front,
• ΔU = U(0) − U(ρ₀) is the vacuum-energy difference driving expansion.
...
• The maximal speed is the vacuum amplitude signal speed c_ρ = √(B/A).
