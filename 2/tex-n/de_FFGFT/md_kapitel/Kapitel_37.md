...
m_ν ∝ B (∂θ/∂x)² evaluated at long coherence scales,
...
• Fundamental phase gradient for one charge: |∂θ/∂x|_e ≈ 1.63 × 10¹³ m⁻¹
• Coherence length: L_coh ≈ √(ħ/B) → enormous (cosmic-scale)
• Deep-field acceleration: a₀ ≈ 10⁻¹⁰ m/s²
• Speed of light: c = √(K₀/ρ₀)
