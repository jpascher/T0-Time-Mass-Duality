...
\title{033 T0-Theorie-vs-Synergetics De}
\author{}
\date{January 2025}

% Define custom environments
\newenvironment{gemeinsam}
{\begin{tcolorbox}[colback=green!5!white, colframe=green!50!black, title=Gemeinsame Grundlagen, fonttitle=\bfseries]}
	{\end{tcolorbox}}

\newenvironment{vergleich}
{\begin{tcolorbox}[colback=blue!5!white, colframe=blue!50!black, title=Vergleich, fonttitle=\bfseries]}
	{\end{tcolorbox}}

\newenvironment{vorteil}
{\begin{tcolorbox}[colback=orange!5!white, colframe=orange!50!black, title=T0-Vorteil, fonttitle=\bfseries]}
	{\end{tcolorbox}}

% Define the xi parameter
\newcommand{\xipar}{\xi}
\newcommand{\xiScaling}{1.333 \times 10^{-4}}
...
\begin{document}
	...
	\textbf{T0 fügt hinzu:}
	\begin{itemize}
		\item Gravitation als $\xipar$-Feld-Kopplung
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{p{0.2\textwidth} p{0.35\textwidth} p{0.3\textwidth}}
			...
			\bottomrule
		\end{tabular}
		\caption{Vergleich der Teilchenmassen-Berechnungen}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{p{0.2\textwidth} p{0.35\textwidth} p{0.3\textwidth}}
			...
			\bottomrule
		\end{tabular}
		\caption{Vergleich der fundamentalen Konstanten}
	\end{table}
	...
	\textbf{Erweiterung:} Die Stärke der Synergetik liegt in ihrer intuitiven Visualisierung, z. B. die Darstellung von 92 Elementen als Tetraeder-Schalen, die Schüler leichter verstehen als abstrakte Gleichungen. Dies macht sie ideal für Einstiegskurse in geometrische Physik.
	...
	\textbf{Erweiterung:} T0s Stärke ist die mathematische Präzision, z. B. die Ableitung von $G$ aus $\xipar^2 \alpha^{11/2}$, die keine Fits erfordert und in SymPy verifizierbar ist. Dies ermöglicht automatisierte Simulationen.
	...
	\begin{vorteil}
		...
		\begin{center}
			\begin{tikzpicture}[node distance=2.5cm]
				\node[draw, rectangle, fill=blue!20, text width=4cm, align=center] (nat) {Natürliche Einheiten\\$c = \hbar = 1$};
				\node[draw, rectangle, fill=green!20, text width=4cm, align=center, below of=nat] (dual) {Zeit-Masse-Dualität\\$T \cdot m = 1$};
				\node[draw, rectangle, fill=orange!20, text width=4cm, align=center, below of=dual] (geo) {Reine Geometrie\\Nur $\xipar$};
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{p{4cm}p{5cm}p{5cm}}
			...
			\textbf{Parameter} & Implizit $1/137$ & $\xipar = \frac{4}{3} \times 10^{-4}$ \\
			\textbf{Einheiten} & SI (m, kg, s) & Natürlich ($c=\hbar=1$) \\
			\textbf{Konversionsfaktoren} & 2+ empirische & 0 empirische \\
			...
			\bottomrule
		\end{tabular}
		\caption{Vollständiger Vergleich der Ansätze}
	\end{table}
