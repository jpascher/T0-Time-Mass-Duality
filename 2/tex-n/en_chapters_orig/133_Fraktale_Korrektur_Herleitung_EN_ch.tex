...
\begin{document}
	...
	\begin{enumerate}
		...
		\item The correction is small ($\sim 1.3\
	\end{enumerate}
	...
	When comparing different calculation paths for physical quantities like $\alpha$, one observes small deviations typically of order $\sim 0.1\
