...
The derivation shows the necessity of:
\begin{itemize}
...
The successful derivation of the gravitational constant shows the potential of T0 theory for a unified description of all natural constants. Future work should:

\begin{itemize}
	\item Systematically derive further natural constants
