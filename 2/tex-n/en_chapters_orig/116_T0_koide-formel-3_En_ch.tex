...
\section*{Abstract}
	...
	\begin{thebibliography}{99}
		...
		J. Pascher, ``T0 Theory: Foundations of the Time-Mass Duality Framework''2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Grundlagen_en.pdf}
		
		\bibitem{T0Feinstruktur}
		J. Pascher, ``T0 Theory: Derivation of the Fine Structure Constant from $\xi$''2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Feinstruktur_En.pdf}
		
		\bibitem{T0Gravitation}
		J. Pascher, ``T0 Theory: Geometric Derivation of the Gravitational Constant''2024). 
