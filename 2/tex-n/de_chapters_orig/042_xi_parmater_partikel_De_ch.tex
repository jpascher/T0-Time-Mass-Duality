...
\chapter{Der $\xi$ Parameter und Teilchendifferenzierung in der T0-Theorie: Mathematische Analyse, Geometrische Interpretation und Universelle Feldmuster Eine umfassende Untersuchung der geometrischen Grundlagen und Vereinheitlichung}
...
\begin{table}[htbp]
	...
	\small   % ← etwas kleiner → mehr Platz
	
	\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} l c c p{4.8cm} @{\extracolsep{\fill}}}
		\toprule
		\textbf{Kontext} & \textbf{Wert [$\times 10^{-4}$]} & \textbf{Phys. Bedeutung} & \textbf{Anwendung} \\
		\midrule
