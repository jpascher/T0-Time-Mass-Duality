...
% Original: \chapter{\textbf{T0-Theorie vs. Synergetics-Ansatz}
...
\begin{table}[htbp]
	...
	\begin{tabular}{p{0.18\textwidth} p{0.23\textwidth} p{0.18\textwidth} p{0.13\textwidth} p{0.13\textwidth}}
		\toprule
		\textbf{Konstante} & \textbf{Synergetics (zahlenlastig)} & \textbf{T0 (überschaubar)} & \textbf{Experiment} & \textbf{Besser} \\
		\midrule
