% 133_Fraktale_Korrektur_Herleitung_DE_ch.tex
% Automatically generated from: 133_Fraktale_Korrektur_Herleitung_De.tex
% Created: 2026-01-12 08:41:16
% Language: DE
% Content hash: db1f6e583035573f066d6f418b72eb83
...
\section{Fraktale Korrektur Herleitung}
	...
	Mit $K_{\text{frak}} \approx 0.987$ beträgt die Korrektur nur $\sim 1.3\
	...
	\begin{table}[h]
		...
		\begin{tabular}{lcc}
			...
			\midrule
			Massenverhältnisse & $0\
			Qualitative Vorhersagen & $< 2\
			Semi-quantitativ & $\sim 1\
			Präzisionsmessungen & $1.3\
			\bottomrule
		\end{tabular}
	...
	\begin{enumerate}
		...
		\item Die Korrektur ist klein ($\sim 1.3\
	\end{enumerate}
	...
	Beim Vergleich verschiedener Berechnungswege für physikalische Größen wie $\alpha$ beobachtet man kleine Abweichungen von typischerweise $\sim 0.1\
	...
	\begin{tcolorbox}[colback=yellow!5!white,colframe=orange!75!black,title={Doppelte Quelle der Abweichungen}]
		...
		\textbf{2. Numerische Rundungsfehler} (Nebeneffekt $\sim 0.01\
		\begin{itemize}
		...
		Differenz $\alpha_1 - \alpha_2 \approx 1.3\
		Differenz $\alpha_1 - \alpha_{\text{exp}} \approx 0.005\
	\end{tcolorbox}
