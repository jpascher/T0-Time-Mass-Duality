...
\end{keypoint}	
	...
	**Identical to SI version** – ratios are invariant!
	...
	\begin{enumerate}
		\item The T0 Dirac equation $(i\partial\!\!\!/_{\text{frak}} - m(x))\Psi = 0$ 
		integrates:
		\begin{itemize}
			\item Fractal metric ($D_f = 3 - \xi$)
			\item Dynamic mass ($m(x) = 1/(c^2 T(x))$)
			\item Torus topology
		\end{itemize}
		
		\item Spin-1/2 is interpreted as a **topological winding number**, not as a 
		matrix property
		
		\item The fundamental prediction is the **ratio** $a_\tau/a_\mu = (m_\tau/m_\mu)^2$
		
		\item This follows from **mass-proportional coupling** to the time field
		
		\item Absolute values are **phenomenological** (like QCD in SM), but ratios 
		are **fundamental**
	\end{enumerate}
	...
	\begin{thebibliography}{9}
		...
		\href{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/FFGFT_Narrative_Master_En.pdf}{FFGFT\_Narrative\_Master\_En.pdf},
		2025.
		...
		\href{https://github.com/jpascher/T0-Time-Mass-Duality}{Document 050\_dirac\_geometric},
		2026.
