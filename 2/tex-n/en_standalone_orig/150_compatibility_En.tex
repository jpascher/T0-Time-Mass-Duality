...
\begin{document}
	...
	\begin{itemize}
		\item \textbf{Dokument 149} (\texttt{FFGFT-torsion\_De.tex}): Describes a \enquote{four-dimensional brain-convolution torus}
		\item \textbf{Dokument 018} (\texttt{T0\_Anomale-g2-10\_De.tex}): Uses a \enquote{4-dimensional torsion lattice}
		\item \textbf{Dokument 145} (\texttt{FFGFT\_donat-teil1\_De.tex}): Defines a \enquote{fractal dimension $D_f = 3 - \xi$}
	\end{itemize}
	...
	\subsection{Dokument 149: FFGFT-torsion\_De.tex}
	...
	\subsection{Dokument 018: T0\_Anomale-g2-10\_De.tex}
	...
	\subsection{Dokument 145: FFGFT\_donat-teil1\_De.tex}
	...
	\begin{enumerate}
		\item Dokument 149: \texttt{149\_FFGFT-torsion\_De.tex} -- 4D-torsion crystal-Formulierung
		\item Dokument 018: \texttt{018\_T0\_Anomale-g2-10\_De.tex} -- Anomale Momente im 4D-Gitter
		\item Dokument 145: \texttt{145\_FFGFT\_donat-teil1\_De.tex} -- Fraktale Dimensionsformulierung
	\end{enumerate}
