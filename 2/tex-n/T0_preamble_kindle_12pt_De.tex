% T0 Kindle Preamble - 12pt German Version
% External preamble for T0_Anwendungen_De.tex

\documentclass[12pt,ebook]{memoir}

% Custom page size: 6 x 9 inches (Standard Trade Paperback format)
% Increased side margins to 1.0in for KDP spine compatibility
\usepackage[paperwidth=6in,paperheight=9in,top=0.8in,bottom=0.8in,left=1.0in,right=1.0in]{geometry}
...
pdfstartview=FitH,
pdftitle={Was steckt hinter den sieben Rätseln der Physik?},
pdfsubject={Eine Reise zu den tiefsten Geheimnissen des Universums – und wie eine neue Theorie sie verbindet},
pdfauthor={},
unicode=true
}
...
% Line spacing optimized for 12pt
\setSingleSpace{1.25}

% Better heading formatting for German - prevent overfull boxes in chapter/section titles
\setsecheadstyle{\Large\bfseries\raggedright}
\setsubsecheadstyle{\large\bfseries\raggedright}
\setsubsubsecheadstyle{\normalsize\bfseries\raggedright}
\setparaheadstyle{\normalsize\bfseries\raggedright}

% Chapter titles - slightly smaller to prevent overflow
...
\newtheorem{insight}[theorem]{Einsicht}
