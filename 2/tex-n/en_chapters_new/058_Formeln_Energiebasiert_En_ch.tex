...
\large Quadratic Mass Scaling from Standard QFT
	...
	Detailed formulas and numerical predictions for anomalous magnetic moments of leptons
	are collected and maintained in the dedicated T0 document \texttt{018\_T0\_Anomale-g2-10\_De.tex}.
	This formula collection only references that work conceptually and does not repeat its
	equations, values, or experimental comparison tables.
