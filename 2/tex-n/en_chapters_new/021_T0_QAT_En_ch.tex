\chapter{\textbf{T0-QAT: $\xi$-Aware Quantization-Aware Training}}

\hfuzz=200pt

\title{\textbf{T0-QAT: $\xi$-Aware Quantization-Aware Training}}
...
\section*{Abstract}
	...
	The complete theoretical derivation is available in the T0 Theory GitHub Repository\footnote{}, including:
	\begin{itemize}
