...
% Define Weyl tensor symbol for this chapter
\newcommand{\Weyl}{W}
% Define Z-pinch equation placeholder
\newcommand{\ZPinch}{\frac{\partial P}{\partial r} = -\frac{J_z B_\theta}{c}}
% Define synchrotron power placeholder  
