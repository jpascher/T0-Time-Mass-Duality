...
\section*{Abstract}
	...
	{\small $^*$Cosmological deviations: $H_0^{\text{T0}} = \xi \cdot c \approx 40\,$km/s/Mpc is a parameter-free prediction. The experimental value $H_0^{\text{exp}} \approx 70\,$km/s/Mpc (factor $\approx 7/4$) is model-dependent and assumes an expanding Friedmann universe. In T0 the universe is static -- age, critical density and Hubble length are Friedmann concepts without direct T0 counterpart.}
