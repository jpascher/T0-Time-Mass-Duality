...
T0 theory predicts specific corrections to the magnetic moments of leptons. The anomalous magnetic moments are described by the combination of Standard Model contributions and T0 corrections:
...
\begin{table}[h]
	\centering
	\small % For better fit and readability; remove if needed
