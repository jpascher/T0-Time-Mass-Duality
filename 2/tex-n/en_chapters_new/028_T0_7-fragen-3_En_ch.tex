...
\begin{itemize}
    ...
    \item \text{Lepton Masses:} -- \quad m_i = r_i \cdot \xi^{p_i} \cdot v
    \item \text{Gravitation:} -- \quad G = \frac{\xi}{2} \cdot K_{\text{SI}}
    \item \text{Cosmology:} -- \quad \frac{\rho_{\text{DE}}}{\rho_{\text{DM}}} = \xi^{-0.102666}
    \item \text{Fine-Tuning:} -- \quad \lambda_H(M_P) \propto \xi^{1/4}
    ...
    \item \bibitem{planck2018} Planck Collaboration, ``Planck 2018 results. VI. Cosmological parameters'', Astronomy \& Astrophysics, Vol. 641, A6, 2020.
    \item \bibitem{planck2020} Planck Collaboration, ``Planck 2018 results. VI. Cosmological parameters'', A\&A, 641, A6, 2020.
\end{itemize}
