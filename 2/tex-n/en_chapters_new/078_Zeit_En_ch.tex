...
\section*{Abstract}
	...
	\begin{itemize}
		...
		\item Heisenberg's uncertainty principle forbids a classical Big Bang singularity with infinite density: $\Delta E \times \Delta t \geq \hbar/2$; instead, a tiny but finite core with minimal length scale $L_0$ (from $\xi$) remains.
