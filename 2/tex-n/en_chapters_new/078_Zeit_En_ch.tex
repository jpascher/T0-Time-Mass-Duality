% Chapter file: 078_Zeit_En_ch.tex
% Source: 078_Zeit_En.tex
...
\section*{Abstract}
	...
	%\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Central Insight]
     \begin{equation}
	\begin{aligned}
		\text{Distance to } \Lzero \uparrow
		&\quad \Rightarrow \quad \text{Time continuity} \uparrow \\
		&\quad \Rightarrow \quad \text{Constant direction} \uparrow
	\end{aligned}
\end{equation}
	%\end{tcolorbox}
...
\begin{align}
	...
	L = 10^{-3}\,\text{m (mm)} &: \quad
	\text{\shortstack[l]{Practically continuous,\\constant direction}} \\
