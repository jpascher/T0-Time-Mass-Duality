...
\begin{itemize}
    \item $m = m_{\text{base}} \cdot K_{\text{corr}} \cdot QZ \cdot RG \cdot D \cdot f_{\text{NN}}$ -- General mass formula in T0 theory with ML correction
    ...
    \item $\xi$ -- Fundamental geometry parameter of the T0 theory; $\xi = \frac{4}{30000} \approx 1.333 \times 10^{-4}$
