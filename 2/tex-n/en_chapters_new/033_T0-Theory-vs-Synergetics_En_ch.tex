...
\section*{Abstract}
	...
	\begin{center}
		\begin{tikzpicture}[node distance=2.5cm]
			\node[draw, rectangle, fill=t0blue!20, text width=4cm, align=center, minimum height=1.5cm] (nat) {\textbf{Natural Units}\\[0.3em]$c = \hbar = 1$};
			\node[draw, rectangle, fill=t0green!20, text width=4cm, align=center, minimum height=1.5cm, below of=nat] (dual) {\textbf{Time-Mass Duality}\\[0.3em]$T \cdot m = 1$};
			\node[draw, rectangle, fill=t0orange!20, text width=4cm, align=center, minimum height=1.5cm, below of=dual] (geo) {\textbf{Pure Geometry}\\[0.3em]Only $\xi_{\text{par}}$};
			
			\draw[->, thick, >=stealth] (nat) -- (dual);
			\draw[->, thick, >=stealth] (dual) -- (geo);
		\end{tikzpicture}
	\end{center}
