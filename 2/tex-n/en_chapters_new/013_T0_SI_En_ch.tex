...
% Original: \chapter{\textbf{The Complete Closure of T0-Theory}
...
\section*{Abstract}
	...
	\begin{derivation}
		...
		However, the \emph{specific numerical value} in SI units is not arbitrary. From FFGFT:
		\begin{align}
	...
	\begin{insight}
		\textbf{Temperature as energy scale in FFGFT:}
