...
\textbf{Conceptual Basis:} Bridge to Standard Model formulation
...
The EFT matching provides the fundamental relationship:
\begin{equation}
...
\begin{longtable}{|l|c|c|c|c|c|l|}
	\hline
	Fermion & Gen. & Family & Spin & $r_f$ & Exponent $p_f$ & Symmetry \\
	\hline
	\endfirsthead
	\hline
	Fermion & Gen. & Family & Spin & $r_f$ & Exponent $p_f$ & Symmetry \\
...
The following analysis shows the explicit calculation of all fermions using both methods:

\subsection{Basics and Experimental Input Data}
\label{subsec:basics}
...
Therefore, $r_c \approx 2$ has been used in the corrected universal table.
...
\begin{keyresult}{True Meaning of Equivalence}{}
...
links both methods mathematically. If $r_i$ is determined from experimental masses, $f_i$ follows automatically and vice versa.
...
\begin{important}{No Adjustable Parameters}{}
	...
	\end{equation}
	This eliminates all free parameters and makes the model fully predictive.
\end{important}

\subsection{Universal Quantum Numbers Table}
...
\begin{table}[H]
	...
	\begin{tabular}{lcccccc}
		...
		\bottomrule
	\end{tabular}
	\caption{Complete universal quantum numbers table for all fermions}
...
\begin{enumerate}
	\item \textbf{Geometric interpretation:} Particle masses as manifestations of 3D space geometry
...
The T0 model demonstrates that the search for a theory of everything may not lie in greater complexity, but in radical simplification. The ultimate truth may be extraordinarily simple.
...
\begin{thebibliography}{99}
	...
	Pascher, J. (2025). \textit{Field-Theoretic Derivation of the $\beta_T$ Parameter in Natural Units ($\hbar = c = 1$)}. Available at: \url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/093_DerivationVonBeta_En.pdf}
	
	\bibitem{pascher_qft_2025}
	Pascher, J. (2025). \textit{Complete Derivation of Higgs Mass and Wilson Coefficients}. T0 Theory Project Documentation.
	...
	\bibitem{nufit_2024}
	Esteban, I., et al. (2024). \textit{NuFit-6.0: Updated Global Analysis of Three-Color Neutrino Oscillations}. J. High Energy Phys. 12, 216.
	...
	Mendeleev, D. (1869). \textit{On the Relationships of Properties to Atomic Weights of Elements}. Journal of Chemistry, 12, 405--406.
