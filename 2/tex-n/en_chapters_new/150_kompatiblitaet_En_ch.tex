\chapter{\textbf{Compatibility Analysis of T0 Dimension Formulations}\\[0.5cm]
	 Unification of 4D Torsion Crystal and Fractal Dimension\\[0.3cm]
...
\section*{Abstract}
	...
	\begin{equation}
		K_{\text{frak}} \approx 0.9867 \quad \Leftrightarrow \quad \text{ca. 1.33\% correction} \quad \Leftrightarrow \quad \text{$\sim$2\%}
	\end{equation}
