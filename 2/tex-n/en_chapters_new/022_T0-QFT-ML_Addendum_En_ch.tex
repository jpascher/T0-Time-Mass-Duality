...
\section*{Abstract}
	...
	\textbf{Validation}: Reduces $\Delta$ from 12.3\% to $<0.1\%$ at $5\pi/4$; $\text{CHSH}^{\text{T0}} = 2.8275$ (vs.~QM 2.8284), $\Delta=0.04\%$.
	...
	\end{equation}
	\textbf{Objection}: Does $\text{CHSH}^{\text{T0}}=2.8275$ violate Bell's bound (2)?
