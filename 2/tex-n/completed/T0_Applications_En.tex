\documentclass[25pt]{extbook}

% Custom page size: 6 x 9 inches (Standard Trade Paperback format) - MUST be loaded before shared preamble  
\PassOptionsToPackage{paperwidth=6in,paperheight=9in,top=0.8in,bottom=0.8in,left=0.75in,right=0.75in}{geometry}
