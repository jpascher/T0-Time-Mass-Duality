...
Φ = ρ e^{iθ},
where:
• ρ(x,t) = vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0) → inertia & gravity
...
• DVFT defines gravity as vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0) deformation ρ(x), valid for both localized and
superposed states.
