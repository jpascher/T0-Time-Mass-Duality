...
with:
• ρ(x,t) – vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0) (determines inertia and gravitational potential),
...
where:
• ρ₀ is the equilibrium vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0),
