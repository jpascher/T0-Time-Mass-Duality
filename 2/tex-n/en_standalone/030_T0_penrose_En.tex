...
\begin{abstract}
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025a). T0 Time-Mass Duality Theory [Repository]. GitHub. .
		
		\bibitem{pascher2025qm}
		Pascher, J. (2025b). Quantum Mechanics in T0 Framework. 020\_T0\_QM-QFT-RT\_En.pdf.
		
		\bibitem{pascher2025rel}
		Pascher, J. (2025c). Relativity Extensions in T0. 020\_T0\_QM-QFT-RT\_En.pdf.
		
		\bibitem{pascher2025si}
		Pascher, J. (2025d). SI Units and T0. 013\_T0\_SI\_En.pdf.
		
		\bibitem{pascher2025g2}
		Pascher, J. (2025e). Muon g-2 in T0. 018\_T0\_Anomale-g2-10\_En.pdf.
		
		\bibitem{pascher2025cmb}
		Pascher, J. (2025f). CMB in T0. Zwei-Dipoles-CMB\_En.pdf.
		
		\bibitem{pascher2025casimir}
		Pascher, J. (2025g). Casimir Effect in T0. 091\_Casimir\_En.pdf.
		
		\bibitem{pascher2025kosmo}
		Pascher, J. (2025h). Cosmology in T0. 025\_T0\_Kosmologie\_En.pdf.
		
		\bibitem{pascher2025alpha}
		Pascher, J. (2025i). Fine Structure Constant from $\xi$. 087\_En.pdf.
		
		\bibitem{pascher2025gravity}
		Pascher, J. (2025j). Gravitational Constant from $\xi$. 045\_gravitationskonstante\_En.pdf.
