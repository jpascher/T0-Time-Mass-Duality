...
\begin{document}
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}[node distance=1.5cm]
			...
			\node (fundamental) [rectangle, draw=red, thick, fill=red!5, minimum width=6cm, minimum height=2.5cm, align=center, below of=practical, yshift=-2.5cm] {\textbf{Fundamental Science Perspective}\\[0.2cm]$E = m$ with $T \cdot m = 1$\\[0.2cm]Shows ultimate simplicity};
			
			\draw[<->, thick] (practical.south) -- (fundamental.north);
			\node at (0,-2.8) [align=center] {\textbf{Connection:}\\[0.1cm]$E = mc^2 = E = m$\\[0.1cm]Same reality, different descriptions};
		\end{tikzpicture}
