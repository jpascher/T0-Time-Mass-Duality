...
\begin{document}
	...
	\subsection{Regularization: Zeta Function (Sketch)}
	
	For the formal regularization of the mode sum, zeta function regularization is recommended. The spectral zeta function is defined as:
	...
	\subsection{RG Sketch and Models for \(\gamma\)}
	...
	\subsection{Implicit Coupling Models}
	...
	\begin{figure}[htbp]
		\centering
		% Hier würde normalerweise eine Grafik eingefügt
	...
	\begin{thebibliography}{99}
		\bibitem{dhital2024} Dhital, A. et al. (2024). Experimental determination of Casimir length scales.
		\bibitem{xu2022} Xu, J. et al. (2022). Precision measurements of Casimir forces in sphere-plate geometry.
	\end{thebibliography}
