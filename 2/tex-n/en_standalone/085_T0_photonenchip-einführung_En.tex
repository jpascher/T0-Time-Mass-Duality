...
% Check if important environment exists, define if not
\makeatletter
\@ifundefined{important}{%
	\newenvironment{important}{%
		\begin{tcolorbox}[colback=yellow!10!white, colframe=yellow!50!black, title=Important Note, fonttitle=\bfseries]
		}{%
		\end{tcolorbox}
	}
}{}
\@ifundefined{formula}{%
	\newenvironment{formula}{%
		\begin{tcolorbox}[colback=blue!5!white, colframe=blue!30!black, title=Formula, fonttitle=\bfseries]
		}{%
		\end{tcolorbox}
	}
}{}
...
% Define custom column types only if they don't exist
\makeatletter
...
\begin{document}
	...
	\begin{table}[H]
		\centering
		\begin{tabular}{>{\raggedright\arraybackslash}p{2.8cm} >{\raggedright\arraybackslash}p{6cm} >{\raggedright\arraybackslash}p{4cm}}
			\toprule
	...
	\begin{itemize}
		...
		\item \textbf{Integrated Photonics for 6G Research:} Projects like \textbf{6G-ADLANTIK} and \textbf{6G-RIC} (Fraunhofer HHI) develop photonic-electronic integration components to unlock the THz frequency range for 6G and improve network resilience (SUSTAINET) \cite{hhi_6g}.
