...
The elegance lies in the fact that a single geometric constant $\xi$ determines all observable phenomena, from subatomic particles to cosmological structures.	
	...
	\begin{itemize}
		\item 040\_Hdokument\_En.pdf (Master document)
		...
		\item 093\_DerivationVonBeta\_En.pdf ($\betapar$-parameter derivation)
		\item 008\_T0\_xi-und-e\_En.pdf ($\xipar$-parameter analysis)
		\item 059\_system\_En.pdf (System-theoretical foundations)
