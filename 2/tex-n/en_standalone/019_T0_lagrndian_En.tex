% Filename: 019\_T0\_lagrndian\_En.pdf
...
\begin{abstract}
	...
	A detailed quantitative treatment of lepton anomalous magnetic moments (including muon, electron, and tau g-2, their experimental status, and numerical T0 predictions) is provided in the dedicated anomaly document \texttt{018\_T0\_Anomale-g2-10\_En.pdf}.
	In this Lagrangian overview, we only note that such precision tests exist as consistency checks of the theory; explicit formulas, numerical values, and comparison tables are not repeated here.
