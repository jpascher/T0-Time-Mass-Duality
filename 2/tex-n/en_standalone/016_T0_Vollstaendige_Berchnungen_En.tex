% Dateiname: 016_T0_Vollstaendige_Berechnungen_De.tex
...
\begin{document}
	...
	im dedizierten Dokument \texttt{018\_T0\_Anomale-g2-10\_De.tex} zentralisiert.
	...
	\begin{table}[h]
		...
		\begin{tabular}{>{\raggedright}p{4cm}cc}
			\toprule
			\textbf{Kategorie} & \textbf{Anzahl} & \textbf{Durchschnittlicher Fehler [\%]} \\
			\midrule
			...
			\bottomrule
		\end{tabular}
		\caption{Statistische Leistung der T0-Konstantenvorhersagen}
	\end{table}
	...
	\section{Zusammenfassung und wissenschaftliche Einordnung}
	
	\subsection{Revolutionäre Aspekte}
	
	Die T0-Theorie Version 3.2 repräsentiert einen paradigmatischen Wandel in der theoretischen Physik:
	...
	\begin{enumerate}
		...
		\item \textbf{Geometrische Grundlage:} Alle Physik aus einer einzigen Konstante $\xi$
		\item \textbf{Mathematische Perfektion:} Ausschließlich exakte Beziehungen, keine freien Parameter
		\item \textbf{Experimentelle Validierung:} >99\% Übereinstimmung in kritischen Tests
		\item \textbf{Vorhersagekraft:} Neue Phänomene und überprüfbare Vorhersagen
		\item \textbf{Konzeptionelle Eleganz:} Vereinheitlichung aller fundamentalen Kräfte und Skalen
	\end{enumerate}
	...
	\begin{itemize}
		...
		\item \textbf{Konstantenproblem:} Warum haben Naturkonstanten ihre spezifischen Werte?
