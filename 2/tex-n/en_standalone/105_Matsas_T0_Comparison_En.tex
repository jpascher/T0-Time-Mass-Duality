...
\begin{document}
	...
	\begin{enumerate}
		\item \textbf{Extended Lagrangian Density}: T0 has developed a complete extended Lagrangian density that unifies QFT, QM, and RT (see T0 field theory documents)
		...
		\item \textbf{Complete QFT Lagrangian}: Standard Model Lagrangian terms systematically derived from T0 principles (see extended Lagrangian documents)
	\end{enumerate}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\item \textbf{Unification}: Casimir effect and CMB as manifestations of same $\xi$-vacuum structure (see document 091\_Casimir\_En)
