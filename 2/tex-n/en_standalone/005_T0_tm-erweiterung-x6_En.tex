% Filename: 005_T0_tm-erweiterung-x6_En.tex
...
\end{adjustbox}
	...
	\begin{table}[h]
		...
		\resizebox{\textwidth}{!}{
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}p{0.30\textwidth}@{}}@{}p{0.30\textwidth}@{}}p{3cm}@{}p{0.30\textwidth}@{}}p{3cm}@{}p{0.30\textwidth}@{}}}
			\toprule
...
\end{adjustbox}
	...
	\begin{table}[h]
		...
		\resizebox{\textwidth}{!}{
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{@{}p{0.15\textwidth}@{\hspace{2mm}}p{0.15\textwidth}@{\hspace{2mm}}p{0.15\textwidth}@{\hspace{2mm}}p{0.15\textwidth}@{\hspace{2mm}}p{0.15\textwidth}@{\hspace{2mm}}p{0.15\textwidth}@{}}
			\toprule
...
\end{adjustbox}
	...
	\begin{table}[h]
		\centering
\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{@{}p{0.30\textwidth}@{}}p{12cm}}
			\toprule
