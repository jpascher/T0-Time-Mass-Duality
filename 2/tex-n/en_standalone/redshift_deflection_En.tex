...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{FFGFT: Redshift Mechanism}
\fancyhead[R]{\thepage}
...
\title{\Huge\textbf{FFGFT: Redshift Mechanism}\\
...
\begin{document}
	...
	\begin{thebibliography}{99}
		...
		Pascher, Johann (2025). 
		\textit{Vereinfachte Lagrange-Dichte und Zeit-Massen-Dualität in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}. 
		T0-Theory Project. 
		...
		Pascher, Johann (2025). 
		\textit{Temperatureinheiten in natürlichen Einheiten: Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) und statisches Universum}. 
		T0-Theory Project. 
