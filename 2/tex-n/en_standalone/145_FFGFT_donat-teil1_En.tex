...
\]
This is a parameter-free prediction. The discrepancy with the model-dependent standard value $H_0^{\text{exp}} \approx 70\,$km/s/Mpc (factor $\approx 7/4$) is an open research question.
