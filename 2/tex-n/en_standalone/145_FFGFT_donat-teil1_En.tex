...
\begin{document}
	...
	As a complement, two interactive visualizations are provided in the \texttt{2/html} directory (GitHub view, open in browser):
	\begin{itemize}
		\item \href{https://github.com/jpascher/T0-Time-Mass-Duality/raw/main/2/html/torus_geometry_ffgf.html}{\texttt{torus\_geometry\_ffgf.html}} – animated torus geometry with energy flow and selectable scale (proton, planet, galaxy).
		\item \href{https://github.com/jpascher/T0-Time-Mass-Duality/raw/main/2/html/t0_subplanck_structure.html}{\texttt{t0\_subplanck\_structure.html}} – comparison of the effective Planck boundary and the fundamental t₀ sub-Planck scale (Λ₀, τ₀).
	\end{itemize}
