...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textsc{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Die elegantere Lösung}}
...
\title{\textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) vs. Synergetics-Ansatz}\\[0.5cm]
...
\begin{document}
	...
	\begin{vergleich}
		...
		\textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie):}
		\begin{itemize}
	...
	\begin{vorteil}
		\textbf{Die zentrale Einsicht der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie):}
	...
	\subsection{Für Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}
	...
	Pascher, J. (2025). 
	\textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Die Gravitationskonstante}. 
	...
	Pascher, J. (2025). 
	\textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Neutrinos}. 
	T0-Dokumentenserie, Dokument 5.
	
	\bibitem{t0_kosmologie}
	Pascher, J. (2025). 
	\textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Kosmologie}. 
	...
	\bibitem{t0_anomale}
	Pascher, J. (2025). 
	\textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Anomale Magnetische Momente}. 
