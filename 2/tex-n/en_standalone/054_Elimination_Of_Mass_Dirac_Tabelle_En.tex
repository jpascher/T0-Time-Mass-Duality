...
% Standardized preamble - 054_Elimination_Of_Mass_Dirac_Tabelle_En.tex
\input{../../../T0_preamble_shared_En}

\usepackage{adjustbox} % For resizebox with longtable, if necessary, but changed to table here
...
\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{@{}p{0.30\textwidth}@{}}p{2cm}p{3cm}p{2.5cm}p{6cm}p{1cm}}
				\toprule
				...
				$\xi$ (Higgs-energy ratio, flat) & 1 & $\xi = \frac{\lambda_h^2 v^2}{16\pi^3 E_h^2}$ & $\mathbf{1.316 \times 10^{-4}}$ & $1.320 \times 10^{-4}$ (99.7\%) & $\checkmark$ \\
				
				$\xi$ (Higgs-energy ratio, spherical) & 1 & $\xi = \frac{\lambda_h^2 v^2}{24\pi^{5/2} E_h^2}$ & $\mathbf{1.557 \times 10^{-4}}$ & New (T0) & $\star$ \\
				
				% DERIVED CONSTANTS
				\multicolumn{6}{l}{\textbf{CONSTANTS FROM SCALE RATIOS}} \\
				\midrule
				Electron mass (from $\xi$) & MeV & $m_e = f(\xi, \text{Higgs})$ & $\mathbf{0.511}$ MeV & $0.511$ MeV (99.998\%) & $\checkmark$ \\
				
				Compton wavelength & m & $\lambda_C = \frac{\hbar}{m_e c}$ from $\xi$ & $\mathbf{3.862 \times 10^{-13}}$ & $3.862 \times 10^{-13}$ (99.989\%) & $\checkmark$ \\
				
				Planck length & m & $\ell_P$ from $\xi$-scale & $\mathbf{1.616 \times 10^{-35}}$ & $1.616 \times 10^{-35}$ (99.984\%) & $\checkmark$ \\
				
				% ANOMALOUS MAGNETIC MOMENTS
				\multicolumn{6}{l}{\textbf{ANOMALOUS MAGNETIC MOMENTS}} \\
				\midrule
				Electron g-2 (T0) & 1 & $a_e^{(T0)} = \frac{1}{2\pi} \xi^2 \frac{1}{12}$ & $\mathbf{2.309 \times 10^{-10}}$ & New & $\star$ \\
				
				Muon g-2 (T0) & 1 & $a_\mu^{(T0)} = \frac{1}{2\pi} \xi^2 \frac{1}{12}$ & $\mathbf{2.309 \times 10^{-10}}$ & New & $\star$ \\
				
				Muon g-2 anomaly & 1 & $\Delta a_{\mu}$ (exp.) & $\mathbf{2.51 \times 10^{-9}}$ & $2.51 \times 10^{-9}$ (Fermilab) & $\checkmark$ \\
				
				T0 share of muon anomaly & \% & $\frac{a_{\mu}^{(T0)}}{\Delta a_{\mu}} \times 100\%$ & $\mathbf{9.2\%}$ & Calculated (100\%) & $\checkmark$ \\
				
				% QED CORRECTIONS
				\multicolumn{6}{l}{\textbf{QED CORRECTIONS (Ratio Calculations)}} \\
				\midrule
				Vertex correction & 1 & $\frac{\Delta\Gamma}{\Gamma^{\mu}} = \xi^2$ & $\mathbf{1.742 \times 10^{-8}}$ & New & $\star$ \\
				
				Energy independence (1 MeV) & 1 & $f(E/E_P)$ at 1 MeV & $\mathbf{1.000}$ & New & $\star$ \\
				
				Energy independence (100 GeV) & 1 & $f(E/E_P)$ at 100 GeV & $\mathbf{1.000}$ & New & $\star$ \\
				...
				$H_0$ vs SH0ES & km/s/Mpc & Same formula & $\mathbf{69.9}$ & $74.0 \pm 1.4$ (Ceph., 94.4\%) & $\checkmark$ \\
				
				$H_0$ vs H0LiCOW & km/s/Mpc & Same formula & $\mathbf{69.9}$ & $73.3 \pm 1.7$ (Lens, 95.3\%) & $\checkmark$ \\
				
				Universe age & Gyr & $t_U = 1/H_0$ & $\mathbf{14.0}$ & $13.8 \pm 0.2$ (98.6\%) & $\checkmark$ \\
				
				$H_0$ energy equivalent & GeV & $H_0 = \xi_{sph}^{15.697} E_P$ & $\mathbf{1.490 \times 10^{-42}}$ & New (T0) & $\star$ \\
				
				$H_0/E_P$ scale ratio & 1 & $H_0/E_P = \xi_{sph}^{15.697}$ & $\mathbf{1.220 \times 10^{-61}}$ & Theory (100\%) & $\checkmark$ \\
				
				% PHYSICAL FIELDS
				\multicolumn{6}{l}{\textbf{PHYSICAL FIELDS}} \\
				\midrule
				Schwinger E-field & V/m & $E_S = \frac{m_e^2 c^3}{e\hbar}$ & $\mathbf{1.32 \times 10^{18}}$ & $1.32 \times 10^{18}$ (100\%) & $\checkmark$ \\
				
				Critical B-field & T & $B_c = \frac{m_e^2 c^2}{e\hbar}$ & $\mathbf{4.41 \times 10^{9}}$ & $4.41 \times 10^{9}$ (100\%) & $\checkmark$ \\
				
				Planck E-field & V/m & $E_P = \frac{c^4}{4\pi\varepsilon_0 G}$ & $\mathbf{1.04 \times 10^{61}}$ & $1.04 \times 10^{61}$ (100\%) & $\checkmark$ \\
				
				Planck B-field & T & $B_P = \frac{c^3}{4\pi\varepsilon_0 G}$ & $\mathbf{3.48 \times 10^{52}}$ & $3.48 \times 10^{52}$ (100\%) & $\checkmark$ \\
				
				% PLANCK CURRENT VERIFICATION
				\multicolumn{6}{l}{\textbf{PLANCK CURRENT VERIFICATION}} \\
				\midrule
				Planck current (std.) & A & $I_P = \sqrt{\frac{c^6\varepsilon_0}{G}}$ & $\mathbf{9.81 \times 10^{24}}$ & $3.479 \times 10^{25}$ (28.2\%) & $\times$ \\
				
				Planck current (complete) & A & $I_P = \sqrt{\frac{4\pi c^6\varepsilon_0}{G}}$ & $\mathbf{3.479 \times 10^{25}}$ & $3.479 \times 10^{25}$ (99.98\%) & $\checkmark$ \\
...
\end{adjustbox}
	...
	{\large Simple relations are more accurate than complex formulas due to reduced accumulation of rounding errors}
...
\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{@{}p{0.30\textwidth}@{}}p{2cm}p{2.5cm}p{3cm}p{5cm}p{0.8cm}}
				...
				\multicolumn{6}{l}{\textbf{NOTE: Complex formulas show 99.98-100.04\% agreement (rounding errors)}} \\
...
\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{@{}p{0.30\textwidth}@{}}p{2cm}p{4cm}p{3cm}p{4cm}p{0.8cm}}
				\toprule
				\textbf{Quantity} & \textbf{Relation} & \textbf{Example} & \textbf{Electron Case} & \textbf{Num. Value} & \textbf{Stat.} \\
				\midrule
				...
				\multicolumn{6}{l}{\textbf{INVERSE ENERGY RELATIONS - EXACT}} \\
				\midrule
				...
				$\xi$ (spherical) & $E_h/E_P$ & Corrected & $1.557 \times 10^{-4}$ & New T0 (100\%) & $\star$ \\
				
				$\xi$ geometric & $E_\ell/E_P$ & Length-en. ratio & $8.37 \times 10^{-23}$ & Geometry (100\%) & $\checkmark$ \\
				
				EM geom. factor & Ratio & $\sqrt{4\pi/9}$ & $1.18270$ & Exact (100\%) & $\star$ \\
				
				% COMPLETE SI UNITS ENERGY COVERAGE
				\multicolumn{6}{l}{\textbf{SI UNITS ENERGY COVERAGE - 7/7 UNITS}} \\
				\midrule
				
				El. current & $I = E/T$ & Energy flow & $[E]$ Dimension & Direct (100\%) & $\checkmark$ \\
				
				Amount of substance (Mol) & $[E^2]$ Dim. & Energy density & Dim. structure & SI-def. $N_A$ (Def.) & $\star$ \\
				
				Luminous intensity & $[E^3]$ Dim. & En.-flow perception & Dim. structure & SI-def. 683 lm/W (Def.) & $\star$ \\
				
				% NOTE ON PERFECT AGREEMENT
				\multicolumn{6}{l}{\textbf{NOTE: Simple energy relations show 100\% agreement (no errors)}} \\
...
\end{adjustbox}
	...
	\begin{tcolorbox}[colback=red!10!white,colframe=red!75!black,title={CRITICAL WARNING: $\xi$-Parameter Confusion}]
		...
		\textbf{CONSEQUENCE OF CONFUSION:} Incorrectly interpreted physics, wrong predictions, dimensional errors.
...
\end{adjustbox}
	...
	\section{Key Insights from the Verification}
	
	\subsection{Main Results}
	
	\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title={Main Results of the T0 Verification}]
