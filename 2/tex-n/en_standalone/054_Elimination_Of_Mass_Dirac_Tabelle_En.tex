...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{p{3.2cm}p{1.2cm}p{2.5cm}p{1.8cm}p{2.0cm}p{1.0cm}p{0.6cm}}
			...
			\midrule
			$\xi$ (Flat) & 1 & $\xi = \frac{\lambda_h^2 v^2}{16\pi^3 E_h^2}$ & $\mathbf{1.316\times10^{-4}}$ & $1.320\times10^{-4}$ & $\mathbf{99.7\%}$ & $\checkmark$ \\
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{p{3.2cm}p{1.6cm}p{2.5cm}p{2cm}p{2.0cm}p{1.0cm}p{0.6cm}}
			...
			$H_0$ vs SH0ES & km/s/Mpc & Same formula & $\mathbf{40.0}$ & $74.0$ & $\mathbf{54.1\%}^*$ & $\triangle$ \\
			$H_0$ vs H0LiCOW & km/s/Mpc & Same formula & $\mathbf{40.0}$ & $73.3$ & $\mathbf{54.6\%}^*$ & $\triangle$ \\
			Universe age & Gyr & $t_U = 1/H_0$ & $\mathbf{14.0}$ & $13.8$ & $\mathbf{98.6\%}$ & $\checkmark$ \\
			$H_0$ energy units & GeV & $H_0^{\text{T0}} = \xi \cdot c$ & $\mathbf{8.52\times10^{-43}}$ & T0 prediction & $\mathbf{N/A}$ & $\star$ \\
			$H_0/E_P$ ratio & 1 & $H_0^{\text{T0}} = \xi \cdot c$ & $\mathbf{6.97\times10^{-62}}$ & Theory & $\mathbf{100.0\%}$ & $\checkmark$ \\
			\bottomrule
		\end{tabular}
	}
\end{table}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{p{3.2cm}p{1.6cm}p{2.5cm}p{2cm}p{2.0cm}p{1.0cm}p{0.6cm}}
			...
			\textbf{Physical Quantity} & \textbf{SI Unit} & \textbf{T0 Ratio Formula} & \textbf{T0 Calculation} & \textbf{CODATA/Experimental} & \textbf{Agreement} & \textbf{Status} \\
			\midrule
			Schwinger E-field & V/m & $E_S = \frac{m_e^2 c^3}{e\hbar}$ & $\mathbf{1.32\times10^{18}}$ & $1.32\times10^{18}$ & $\mathbf{100.0\%}$ & $\checkmark$ \\
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{p{3.2cm}p{1.6cm}p{2.5cm}p{2cm}p{2.0cm}p{1.0cm}p{0.6cm}}
			...
			\midrule
			Planck time & s & $t_P = \sqrt{\frac{\hbar G}{c^5}}$ & $\mathbf{5.392\times10^{-44}}$ & $5.391\times10^{-44}$ & $\mathbf{100.016\%}$ & $\checkmark$ \\
...
\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Main Results of T0 Verification]
	...
	\begin{itemize}
		...
		\item Cosmological $H_0^{\text{T0}} = \xi \cdot c \approx 40\,$km/s/Mpc (parameter-free prediction, factor $7/4$ to model-dependent standard value)
