...
• ρ becomes vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0) (origin of inertia, curvature, gravity, mass),
...
As a result:
• QFT’s vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0) ρ was treated as mathematical,
...
• vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0) determines inertial properties.
...
• vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0) ρ is fundamental,
• curvature is ∇ρ,
