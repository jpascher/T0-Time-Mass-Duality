...
\begin{itemize}
\item \textbf{007\_T0\_Neutrinos\_En.tex}: Photon-analogy derivation with $m_\nu = \frac{\xi^2}{2} \times m_e = 4.54$ meV, double $\xi$ suppression (quasi-massless + weak interaction)
\item \textbf{047\_neutrino-Formel\_En.tex}: Detailed neutrino formula derivation from T0 parameters, cosmological bounds at ~15 meV
