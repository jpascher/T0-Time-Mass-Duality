...
\title{\textbf{T0 Theory: Extension to Bell Tests}}
\maketitle
...
\begin{abstract}
	...
	\textbf{Educational Context:} For an excellent introduction to Bell's theorem and the philosophical tensions between locality and realism, see the comprehensive video explanation by Richard Behiel\cite{youtube_bell2025}.
...
\end{adjustbox}
	...
	\begin{thebibliography}{9}
		...
		Richard Behiel (2025). \emph{Bell's Theorem: The Quantum Venn Diagram Paradox}. 
		YouTube video. \url{https://www.youtube.com/watch?v=g69cW_Xt4EM}.
