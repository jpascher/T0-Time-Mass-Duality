% Filename: 006\_T0\_Teilchenmassen\_En.pdf
...
\title{\textbf{T0-Theory: Particle Masses}}
\maketitle
...
\begin{tabular}{lccccc}
		...
		\textbf{*Neutrinos:} Require separate analysis (see 007\_T0\_Neutrinos\_En.pdf)
	\end{experimental}
...
\normalsize
	...
	\begin{warning}
		...
		\textbf{Reference:} Complete neutrino analysis in Document 007\_T0\_Neutrinos\_En.pdf
	\end{warning}
	...
	\begin{itemize}
		\item \textbf{003\_T0\_Grundlagen\_v1\_En.pdf:} Fundamental $\xi_0$-geometry
		\item \textbf{011\_T0\_Feinstruktur\_En.pdf:} Electromagnetic coupling constant
		\item \textbf{012\_T0\_Gravitationskonstante\_En.pdf:} Gravitational analog to masses
		\item \textbf{007\_T0\_Neutrinos\_En.pdf:} Special case of neutrino physics
	\end{itemize}
