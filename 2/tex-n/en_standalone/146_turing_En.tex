...
\tableofcontents
	...
	\begin{itemize}
		\item Hubble radius: $R_{\text{Hubble}} = c/H_0^{\text{T0}} = c/(\xi \cdot c) = 1/\xi \approx 2.31 \times 10^{26} \, \text{m}$ (corresponding to $H_0^{\text{T0}} = \xi \cdot c \approx 40$ km/s/Mpc)
	...
	\[
	\Delta T_{\text{obs}} \approx \Delta T_{\text{intrinsic}} \times (1 + 1.333\times10^{-4} \times 149.8) \approx \Delta T_{\text{intrinsic}} \times 1.0198
	\]
