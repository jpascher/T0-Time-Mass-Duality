...
\begin{itemize}
\item \textbf{116\_T0\_koide-formel-3\_En.pdf} (2/pdf/): Fundamental T0-Yukawa derivation with $m = r \cdot \xi^p \cdot v$, exact mass ratios from $\xi$ exponents $(r,p)$ for each lepton
\item \textbf{046\_Teilchenmassen\_En.pdf} (2/pdf/): Complete T0 particle mass systematics
