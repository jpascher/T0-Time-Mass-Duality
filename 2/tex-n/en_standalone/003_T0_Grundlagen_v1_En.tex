% Filename: 003\_T0\_Grundlagen\_v1\_En.pdf
...
\begin{abstract}
	...
	\begin{itemize}
		\item \textbf{011\_T0\_Feinstruktur\_En.pdf}: Mathematical Derivation of the Fine Structure Constant
		\item \textbf{012\_T0\_Gravitationskonstante\_En.pdf}: Detailed Calculation of Gravity
		\item \textbf{006\_T0\_Teilchenmassen\_En.pdf}: Systematic Mass Calculation of All Fermions
		\item \textbf{007\_T0\_Neutrinos\_En.pdf}: Special Treatment of Neutrino Physics
		\item \textbf{025\_T0\_Kosmologie\_En.pdf}: Cosmological Applications of the T0-Theory
		\item \textbf{020\_T0\_QM-QFT-RT\_En.pdf}: Complete Quantum Field Theory in the T0 Framework with Quantum Mechanics and Quantum Computing Applications
	\end{itemize}
