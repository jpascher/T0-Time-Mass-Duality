% Filename: 022\_T0-QFT-ML\_Addendum\_En.pdf
...
\title{\textbf{T0 Quantum Field Theory: ML-Derived Extensions}}
\maketitle
...
\begin{tabular}{lccc}
	...
	This work synthesizes insights from ML simulations (November 2025) performed in the context of the International Year of Quantum. Special thanks to the T0 community for foundational documents (020\_T0\_QM-QFT-RT\_En.pdf, 023\_Bell\_En.pdf, 035\_QM\_En.pdf) and ongoing experimental collaborations (MPD Rydberg, IBM Quantum, DUNE).
