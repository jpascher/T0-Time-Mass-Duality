...
\title{\textbf{Unit Conventions and the Speed of Light c}\\[0.5cm]
	\large E=mc² vs. E=m: Two Equivalent Perspectives\\[0.3cm]
...
\begin{document}
	...
	\begin{itemize}
		...
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/013_T0_SI_En.pdf}
		
		\item \textbf{Document 014}: Natural vs. SI Units \\
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/014_T0_nat-si_En.pdf}
		
		\item \textbf{Document 015}: Systematics of Natural Units \\
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/015_NatEinheitenSystematik_En.pdf}
		
		\item \textbf{Document 077}: E=mc² = E=m Analysis \\
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/077_E-mc2_En.pdf}
		
		\item \textbf{Document 101}: Circularity of Constants (α Conventions) \\
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/101_zirkularitaet-Konstanten_En.pdf}
		
		\item \textbf{Document 133}: Fractal Correction K\_frak Derivation \\
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/133_Fraktale_Korrektur_Herleitung_En.pdf}
	\end{itemize}
	...
	\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Summary]
		\begin{enumerate}
			\item \textbf{E=mc² and E=m are mathematically equivalent} -- different only in unit system
			\item \textbf{c=1 (natural units)} is exact, not approximate, in particle physics/theory
			\item \textbf{c=299,792,458 m/s (SI)} is required for experiment, engineering, education
			\item \textbf{T0 perspective}: c is a ratio $L/T$, not a fundamental law of nature
			\item \textbf{Unit choice does not change physics} -- only notation
			\item \textbf{Parallel to α}: Both are conventions/derived quantities, not fundamental
		\end{enumerate}
	\end{tcolorbox}
	
	\subsection{Practical Recommendation}
	
	\textbf{For theoretical work:} Use c=1 (natural units) \\
	\textbf{For experimental/applied work:} Use c explicitly (SI units)
	
	\textbf{Important:} Be consistent within a calculation and document the unit choice.
	
	\subsection{T0 Deeper Insight}
	
	The T0 theory shows that the debate ``c=1 or c=299,792,458?'' can ultimately be reduced to \textbf{unit conventions} -- similar to the debate about α=1 vs. α=1/137 in Document 101.
	
	The fundamental physics resides in \textbf{dimensionless quantities} like $\xi = \frac{4}{3} \times 10^{-4}$, from which all other constants emerge.
	
	c is a \textbf{derived ratio}, not a fundamental constant.
	
	\subsection{Outlook}
	
	Future work could investigate:
	\begin{itemize}
		\item Experimental tests of the T0 prediction of variable c-values at different scales
		\item Precision measurements to verify the Time-Mass Duality $T \cdot m = 1$
		\item Didactic approaches to convey the equivalence of natural/SI units
	\end{itemize}
	
	\begin{thebibliography}{99}
		\bibitem{dok013} Johann Pascher, \emph{The Complete Closure of T0 Theory: From $\xi$ to the 2019 SI Reform}, Document 013, T0 Theory Series (2024).
		
		\bibitem{dok014} Johann Pascher, \emph{Natural vs. SI Units}, Document 014, T0 Theory Series (2024).
		
		\bibitem{dok015} Johann Pascher, \emph{Systematics of Natural Units}, Document 015, T0 Theory Series (2024).
		
		\bibitem{dok077} Johann Pascher, \emph{E=mc² = E=m: The Constant Illusion Exposed}, Document 077, T0 Theory Series (2024).
		
		\bibitem{dok101} Johann Pascher, \emph{The Circularity in the Debate over Fundamental Constants}, Document 101, T0 Theory Series (2025).
		
		\bibitem{dok133} Johann Pascher, \emph{Fractal Correction K\_frak -- Complete Mathematical Proof}, Document 133, T0 Theory Series (2025).
