...
\fancyhead[R]{FFGFT: Mass Variation as an Equivalent to Time Dilation}
\fancyfoot[C]{\thepage}
...
\hypersetup{
	...
	citecolor=blue,
	urlcolor=blue,
	pdftitle={FFGFT: Mass Variation as an Equivalent to Time Dilation},
	pdfauthor={Johann Pascher}
}
% Fix for Unicode ξ in text mode
\DeclareUnicodeCharacter{03BE}{$\xi$}
\title{\textbf{FFGFT: Mass Variation as an Equivalent to Time Dilation}\\
