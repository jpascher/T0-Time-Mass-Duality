...
• ρ(x,t) — vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0)
• θ(x,t) — vacuum phase
...
• As the universe expands, vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0) relaxes, causing large-scale phase dispersion.
