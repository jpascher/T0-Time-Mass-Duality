...
\begin{document}
	...
	Fractal DVFT (based on T0-theory) offers an alternative, unified explanation: quantum phenomena emerge as dynamics of the fractal vacuum field \(\Phi = \rho e^{i\theta / \xi}\), with the scale parameter \(\xi = \frac{4}{3} \times 10^{-4}\) (dimensionless).
