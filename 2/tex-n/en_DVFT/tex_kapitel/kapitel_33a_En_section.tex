\maketitle
	...
	Fractal DVFT (based on T0-theory) offers an alternative derivation: the exclusion principle as a natural consequence of topological defects in the fractal vacuum phase field, grounded in Time-Mass Duality and the scale parameter \(\xi = \frac{4}{3} \times 10^{-4}\) (dimensionless).
