...
\title{Kapitel 6: Reinterpretation von \(E = mc^2\) in der T0-Time-Mass-Duality}
\author{}
\date{}
...
Die Äquivalenz von Masse und Energie \(E = mc^2\) wird in der T0-Theorie nicht als separates Postulat eingeführt, sondern ergibt sich zwangsläufig aus der fundamentalen Dualität zwischen Zeit und Masse in der fraktalen Skalenhierarchie.
