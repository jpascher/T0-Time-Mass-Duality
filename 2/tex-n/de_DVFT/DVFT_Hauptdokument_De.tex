...
\large Fraktale T0-Zeit-Masse-Dualität\\[1em]
Vollständige Dokumentation aller Kapitel}
\author{}
\date{\today}
...
\chapter{Herleitung des Pauli-Ausschlussprinzips in fraktaler T0-Geometrie}
...
\chapter{Planck-Einheiten und Universalkonstanten in fraktaler T0-Geometrie}
...
\chapter{Qubits, Schrödinger- und Dirac-Gleichungen in T0-Geometrie}
