\section*{Zusammenfassung}
	...
	Die T0-Theorie erweitert die Wellen-Teilchen-Dualität auf eine komplementäre Time-Mass-Dualität, wodurch absolute Zeit und variable Masse als Aspekte eines einheitlichen geometrischen Feldes betrachtet werden. Dies ermöglicht eine Vereinheitlichung von Quantenmechanik und Allgemeiner Relativitätstheorie durch ein fraktales Vakuumsubstrat mit Skalenparameter \(\xi = \frac{4}{3} \times 10^{-4}\) (dimensionslos, als Maß für den fraktalen Packungsdefizit) und fraktaler Dimension \(D_f = 3 - \xi \approx 2.999867\) (dimensionslos, Hausdorff-Dimension der effektiven Raumzeit).
