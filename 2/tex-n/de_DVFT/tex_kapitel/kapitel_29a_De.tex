...
\begin{document}
	...
	\begin{center}
		\begin{tabular}{p{0.45\textwidth}p{0.45\textwidth}}
			\textbf{Andere Interpretationen} & \textbf{T0-Fraktale DVFT} \\
			\hline
