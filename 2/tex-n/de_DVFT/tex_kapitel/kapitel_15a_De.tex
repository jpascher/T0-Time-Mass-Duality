...
\begin{document}
	...
	Die T0-Theorie leitet die Perihelion-Präzession des Merkur vollständig und parameterfrei aus dem fraktalen Skalenparameter \(\xi\) ab. Im Starkfeld-Regime reproduziert sie exakt die ART-Vorhersage, ergänzt um eine kleine, höherordnungliche fraktale Korrektur. Diese Übereinstimmung bestätigt die Theorie auf Sonnensystem-Skalen und ermöglicht testbare Abweichungen auf galaktischen Skalen (z.~B. flache Rotationskurven ohne Dunkle Materie).
