...
\chapter{T0-Modell: Vollständige parameterfreie Teilchenmassen-Berechnung Direkte geometrische Methode vs. Erweiterte Yukawa-Methode Mit vollständiger \\Neutrino-Quantenzahlen-Analyse und QFT-Herleitung}
...
\section*{Abstract}
	...
	\begin{longtable}{|l|c|c|c|c|c|l|}
		\hline
		Fermion & Gen. & Family & Spin & $r_f$ & Exponent $p_f$ & Symmetrie \\
		\hline
		\endfirsthead
		\hline
		Fermion & Gen. & Family & Spin & $r_f$ & Exponent $p_f$ & Symmetrie \\
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025). \textit{Feldtheoretische Ableitung des $\beta_T$-Parameters in natürlichen Einheiten ($\hbar = c = 1$)}. Verfügbar unter: \url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/093_DerivationVonBeta_En.pdf}
