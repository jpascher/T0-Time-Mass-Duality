...
\section*{Abstract}
	...
	\begin{align}
		...
		\textbf{2. Experimenteller Input:} \quad & m_e^{\mathrm{SI}} = 9.1093837 \times 10^{-31}~\mathrm{kg} \quad \text{(gemessen)} \\
		...
		\textbf{5. Tiefgreifende Schlussfolgerung:} \quad & \text{Die T0-Theorie MeV-Skala \textbf{vorhersagt}}
	\end{align}
...
\begin{table}[h]
	\centering
	\small % Optional: für noch mehr Platz; entfernen bei Bedarf
