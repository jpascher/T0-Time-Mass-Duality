...
\end{table}
	...
	Unterschied: Fit ist iterativ (Bell $\to$ Neutrino $\to$ Rydberg), fraktale Korrektur statisch (geometrisch fix). Fit = Änwendung'' der Fraktalität auf Daten;\\ ohne Fraktalität bräuchte T0 Fits $>$10\% (unphysikalisch).
