...
% Original: \chapter{\Huge\textbf{T0-Theorie: Verbindungen zum Mizohata-Takeuchi-Gegenbeispiel}
...
\section*{Abstract}
  ...
  \begin{equation}
	\begin{aligned}
		\log R
		&\approx -\frac{\log K_\text{frak}}{\xi}
		= \frac{\xi}{\xi}
		= 1 \\
		&\quad (\text{normiert in } D_f\text{-Metriken}) \, .
	\end{aligned}
\end{equation}
