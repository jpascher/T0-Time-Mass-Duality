...
\begin{longtable}{@{} 
	...
	\small % Kompakte Schrift für bessere Passung
...
\begin{table}[h]
	\centering
	\small % Für bessere Passung und Lesbarkeit; bei Bedarf entfernen
...
\begin{longtable}{@{} 
	...
	\small % Kompakte Schrift für bessere Passung und Lesbarkeit
...
\end{longtable}
	...
	\begin{lstlisting}[language=Python, basicstyle=\small\ttfamily]
		...
		# Exakte Bruchrechnungen für r und p
	...
	\begin{itemize}
		...
		\item \textbf{Feinabstimmung:} Warum ist das Universum für Leben öptimiert''?
	\end{itemize}
