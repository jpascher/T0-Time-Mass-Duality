\chapter{\textbf{The Planck-Scale Structure of the Conversion Factors}\\[0.5cm]
	\large Why $G = (\ell_P^2 \times c^3)/\hbar$ justifies the form of the factors from Document 012\\[0.3cm]
