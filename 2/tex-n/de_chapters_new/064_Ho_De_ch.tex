\chapter{Das T0-Modell: Die Hubble-Konstante in einem statischen Universum \\
...
\section*{Abstract}
	...
	\begin{longtable}{p{4cm}p{4cm}p{4cm}}
		\hline
		\textbf{Symbol} & \textbf{Bedeutung} & \textbf{Natürliche Einheiten} \\
		\hline
...
\begin{important}
	Für die detaillierte Herleitung und physikalische Begründung dieses Parameters siehe das Dokument ``Parameterherleitung'' (verfügbar unter: ).
\end{important}
...
\end{equation}
	...
	Für kosmologische Beobachtungen, bei denen der Energieverlust klein im Vergleich zur anfänglichen Photonen-Energie bleibt ($\xi x \ll 1$), können wir die Differentialgleichung störungstheoretisch lösen. Die resultierende Energie als Funktion der Entfernung wird:
	...
	\subsection{Energieunabhängigkeit}
	
	Ein wesentliches Merkmal des korrigierten T0-Energieverlust-Mechanismus ist, dass die Rotverschiebung nur von der Entfernung abhängt, nicht von der Photonenenergie. Dies stimmt mit Beobachtungen überein: Alle Spektrallinien einer fernen Galaxie zeigen dieselbe Rotverschiebung, unabhängig von der Wellenlänge. Kein zusätzlicher Energieskalen-Parameter wird benötigt.
...
\begin{align}
	...
	&= 1{,}78 \times 10^{-17} \qquad \\
	&\text{(natürliche Einheiten)}
\end{align}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{lccc}
			...
			\midrule
			\rowcolor{blue!20}
			\textbf{T0-Vorhersage} & \textbf{40{,}0} & \textbf{Parameterfrei} & \textbf{$H_0 = \xi \cdot c$} \\
	...
	Die T0-Vorhersage $H_0^{\text{T0}} = 40\,$km/s/Mpc ist ein parameterfreies Ergebnis. Das Verhältnis $H_0^{\text{exp}}/H_0^{\text{T0}} \approx 7/4$ (auf $0{,}07\%$ genau) könnte geometrische Bedeutung im Torsionskristall-Formalismus haben. Die Diskrepanz entsteht, weil der ``experimentelle\'\' $H_0$ modellabhängig ist und ein expandierendes Friedmann-Universum voraussetzt.
	...
	\begin{formula}
		...
		\begin{equation}
			\boxed{H_0^{\text{T0}} = \xi \cdot c \approx 40{,}0\,\text{km/s/Mpc}}
		\end{equation}
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025). \textit{T0-Theorie: Universelle $\xi$-Konstante und kosmischer Mikrowellen-Hintergrund}. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/063_cosmic_De.pdf}
		
		\bibitem{pascher_redshift_2025}
		Pascher, J. (2025). \textit{T0-Theorie: Wellenlängenabhängiger Rotverschiebungs-Mechanismus}. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/061_TempEinheitenCMB_De.pdf}
		
		\bibitem{pascher_t0_energie_2025}
		Pascher, J. (2025). \textit{T0-Modell: Energiebasierte Formulierung}. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/010_T0_Energie_De.pdf}
