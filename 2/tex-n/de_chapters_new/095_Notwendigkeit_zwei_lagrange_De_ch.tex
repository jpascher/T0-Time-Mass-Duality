...
\chapter{Die Notwendigkeit zweier Lagrange-Formulierungen: Vereinfachte Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) und erweiterte Standard-Modell Darstellungen Mit dem universellen Zeitfeld und $\xi$-Parameter}
...
\section{Einleitung: Mathematische Modelle und ontologische Realität}
	...
	\begin{itemize}
		\item Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) mit ihrem universellen Energiefeld $\delta E(x,t)$ hat keine direkte Entsprechung in unserer Wahrnehmung
	...
	\begin{tcolorbox}[colback=purple!5!white,colframe=purple!75!black,title=Kernaussage]
		...
		\begin{itemize}
			\item \textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}: Maximale Abstraktion, minimale Parameter, weiteste Entfernung von der Erfahrung
