...
% Tabelle 1: Zeit-Dualität und Massen (FIXED for KDP - normal 10pt font, simplified structure)
% Normal 10pt font (NOT \small) - KDP compliant, fully readable
\begin{table}[htbp]
\centering
\begin{tabular}{llll}
	\toprule
	...
	\midrule
	Massen & $m = \frac{\hbar}{T_0 c^2} \sum_k \xi^k \phi_k$ & $m = \gamma m_0$ via & Masse als inverse \\
	& Hierarchien als $\xi^n$ & Disentanglement & Zeit-Fluktuation \\
	\midrule
	Energie & $E = m c^2$ emergent & $E_c = m_0 c^2 + j \gamma m_0 v c$ & Parameterfrei durch \\
	& $E \propto \xi^{-1/2} T_0$ & $\| E_c \| = m_0 c^2$ & Modulus-Konserv. \\
	\bottomrule
\end{tabular}
\end{table}
...
% Tabelle 2: Fraktale Iteration (FIXED for KDP - normal 10pt font, simplified structure)
% Normal 10pt font (NOT \small) - KDP compliant, fully readable
\begin{table}[htbp]
\centering
\begin{tabular}{llll}
	...
	\textbf{Aspekt} & \textbf{T0-Theorie} & \textbf{DoT-Theorie} & \textbf{Parallele} \\
	\midrule
	Fraktale & $d_H \approx 2.37$ & Fraktale Dimension & Zeit fraktal \\
	Iteration & QM/GR via $\alpha = \xi^2/4\pi$ & via Levels & iteriert \\
	\midrule
	$c$-Ableitung & $c = 1 / \sqrt{\xi T_0}$ & Speed of Creation & Beide geometrisch \\
	& Korrektur 0.07\% & Quanten-Schaum & aus Zeit-Dualität \\
	\bottomrule
\end{tabular}
\end{table}
