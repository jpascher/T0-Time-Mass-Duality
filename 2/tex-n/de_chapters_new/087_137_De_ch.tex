% Chapter file: 087_137_De_ch.tex
% Source: 087_137_De.tex

% Original: \chapter{\textbf{Das verborgene Geheimnis von 1/137}
...
\allowdisplaybreaks
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) offenbart, dass alle das Problem rückwärts betrachtet hatten. Die Feinstrukturkonstante ist nicht fundamental - sie ist \textbf{abgeleitet}.
	
	\subsection{Der Paradigmenwechsel}
	...
	Ausgehend von $\xi$ allein leitet die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) ab:
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) macht präzise Vorhersagen mit \textbf{null} freien Parametern:
	...
	\subsection{Das neue Verständnis}
		\begin{itemize}
