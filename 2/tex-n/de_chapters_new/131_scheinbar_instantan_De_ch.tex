\chapter{{ \color{t0blue}T0-Formalismus}\\
	{ Vollständige Auflösung der scheinbaren Instantanität}\\
	\vspace{1cm}
	{ Eine feldtheoretische Analyse der Kausalität in der Quantenmechanik}}
