% Chapter file: 018_T0_Anomale-g2-9_De_ch.tex
% Source: 018_T0_Anomale-g2-9_De.tex

\chapter{\textbf{Vereinheitlichte Berechnung des anomalen magnetischen Moments in der T0-Theorie (Rev. 9 -- Überarbeitet)}}
...
\begin{table}[htbp]
	...
	\end{tabular}
	\caption{Symbolverzeichnis für die T0-Theorie}
\end{table}
...
\begin{table}[htbp]
	...
	\begin{tabular}{p{3.5cm} p{4.5cm} p{5cm}}
		...
		\hline
		\textbf{g-2-Anomalie} & Kern $\Delta a_\mu^{\text{T0}} = 153 \times 10^{-11}$ aus Ein-Schleife + Einbettung; passt Pre/Post-2025 ($\sim 0.15 \sigma$). & Strings prognostizieren BSM-Beiträge (z.\,B. via KK-Moden), aber unspezifisch ($\pm 10\%$ Unsicherheit). \\
		\hline
		...
		\hline
		\textbf{Testbarkeit} & Prognosen: Tau g-2 ($4.33 \times 10^{-7}$); Elektron-Konsistenz via Einbettung. Keine LHC-Signale, aber Resonanz bei 5.22 GeV. & Hohe Energien (Planck-Skala); indirekt (z.\,B. Schwarzes-Loch-Entropie). Wenige Low-Energy-Tests. \\
		\hline
		\textbf{Schwächen} & Noch jung (2025); Einbettung neu (November); mehr QCD-Details benötigt. & Moduli-Stabilisierung ungelöst; keine vereinheitlichte Theorie; Landscape-Problem. \\
		\hline
...
\begin{result}{Zusammenfassung des Vergleichs (Rev. 9)}
	T0 ist ``minimalistisch-geometrisch'' (4D, 1 Parameter, low-energy fokussiert), Strings ``maximalistisch-dimensional'' (hoch-dim., vibrierend, Planck-fokussiert). T0 löst g-2 präzise (Einbettung), Strings generisch -- T0 könnte Strings als Hochenergie-Limit ergänzen.
\end{result}

\appendix
\section{Anhang: Umfassende Analyse der Leptonen-anomalen magnetischen Momente in der T0-Theorie (Rev. 9 -- Überarbeitet)}
Dieser Anhang erweitert die vereinheitlichte Berechnung aus dem Haupttext mit einer detaillierten Diskussion zur Anwendung auf Leptonen-g-2-Anomalien ($a_\ell$). Er beantwortet Schlüssel-Fragen: Erweiterte Vergleichstabellen für Elektron, Myon und Tau; Hybrid (SM + T0) vs. reine T0-Perspektiven; Pre/Post-2025-Daten; Unsicherheitsbehandlung; Einbettungsmechanismus zur Auflösung von Elektron-Inkonsistenzen; und Vergleiche mit dem September-2025-Prototyp (integriert aus Original-Doc). Präzise technische Ableitungen, Tabellen und umgangssprachliche Erklärungen vereinheitlichen die Analyse. T0-Kern: $\Delta a_\ell^\text{T0} = 153 \times 10^{-11} \times (m_\ell / m_\mu)^2$. Passt zu Pre-2025-Daten (4.2$\sigma$ Auflösung) und Post-2025 ($\sim 0.15\sigma$). DOI: 10.5281/zenodo.17390358. Rev. 9: RG-Dualitätskorrektur ($p=-2/3$). Überarbeitung: Embedding-Formeln ohne extra Dämpfung, $\lambda$-Kalibrierung aus Sept.-Doc erklärt und geometrisch verknüpft.

\textbf{Schlüsselwörter/Tags:} T0-Theorie, g-2-Anomalie, Leptonen-magnetische Momente, Einbettung, Unsicherheiten, fraktale Raumzeit, Zeit-Masse-Dualität.
...
\begin{table}[htbp]
	\centering
	\footnotesize
	\begin{tabular}{p{1.2cm} p{2cm} p{1.2cm} p{2.5cm} p{2cm} p{2cm} p{2cm}}
		\toprule
...
\begin{table}[htbp]
	\centering
	\small
	\begin{tabular}{p{1.5cm} p{4cm} p{4cm} p{2cm} p{1.5cm}}
		\toprule
		Lepton & Exp.-Wert (Pre-2025) & SM-Wert (Pre-2025) & Diskr. ($\sigma$) & Unsicherh. (Exp.) \\
		\midrule
		Elektron (e) & $1159652180.73(28) \times 10^{-12}$ & $1159652180.73(28) \times 10^{-12}$ (QED-dom.) & 0 $\sigma$ & $\pm$0.24 ppb \\
		Myon ($\mu$) & $116592059(22) \times 10^{-11}$ & $116591810(43) \times 10^{-11}$ (datengetriebene HVP $\sim$6920) & 4.2 $\sigma$ & $\pm$0.20 ppm \\
		Tau ($\tau$) & Grenze: $|a_\tau|$ $<$ $9.5 \times 10^{8} \times 10^{-11}$ & SM $\sim$ $1$--$10 \times 10^{-8}$ (ew/QED) & Konsistent (Grenze) & N/A \\
		\bottomrule
	\end{tabular}
...
\begin{table}[htbp]
	\centering
	\footnotesize
	\begin{tabular}{p{1.5cm} p{1.8cm} p{0.9cm} p{2.8cm} p{3.8cm} p{1.5cm}}
		\toprule
		Lepton & Perspektive & T0-Wert ($ \times 10^{-11}$) & SM Pre-2025 ($ \times 10^{-11}$) & Total (SM + T0) / Exp. Pre-2025 ($ \times 10^{-11}$) & Abw. ($\sigma$) \\
		\midrule
		Elektron (e) & SM + T0 (Hybrid) & 0.0036 & $115965218.073(28) \times 10^{-11}$ (QED-dom.) & $115965218.076 \approx$ Exp. $115965218.073(28) \times 10^{-11}$ & 0 $\sigma$ \\
		Myon ($\mu$) & SM + T0 (Hybrid) & 153 & $116591810(43) \times 10^{-11}$ (datengetriebene HVP $\sim$6920) & $116591963 \approx$ Exp. $116592059(22) \times 10^{-11}$ & $\sim$0.02 $\sigma$ \\
		Tau ($\tau$) & SM + T0 (Hybrid) & 43300 & $\sim$10 (ew/QED; Grenze $<$ $9.5\times10^{8} \times 10^{-11}$) & $<$ $9.5\times10^{8} \times 10^{-11}$ (Grenze) -- T0 innerhalb & Konsistent \\
		\bottomrule
	\end{tabular}
	\caption{Hybrid vs. Reine T0: Hybrid-Perspektive -- Pre-2025-Daten ($ \times 10^{-11}$; Tau-Grenze skaliert)}
	\label{tab:hybrid_pure_hybrid}
\end{table}
...
\begin{table}[htbp]
	...
	\begin{tabular}{p{1.5cm} p{1.8cm} p{0.9cm} p{2.8cm} p{3.8cm} p{1.5cm}}
		...
		Lepton & Perspektive & T0-Wert ($ \times 10^{-11}$) & SM Pre-2025 ($ \times 10^{-11}$) & Total (SM + T0) / Exp. Pre-2025 ($ \times 10^{-11}$) & Abw. ($\sigma$) \\
		\midrule
		Elektron (e) & Reine T0 & 0.0036 & Eingebettet & 115965218.076 (embed) $\approx$ Exp. via Skalierung & 0 $\sigma$ \\
		Myon ($\mu$) & Reine T0 & 153 & Eingebettet (HVP $\approx$ fraktale Dämpfung) & 116592059 (embed + Kern) -- Exp. implizit skaliert & N/A (prognostisch) \\
		Tau ($\tau$) & Reine T0 & 43300 & Eingebettet (ew $\approx$ Geometrie aus $\xi$) & 43300 (progn.) $<$ Grenze $9.5\times10^{8} \times 10^{-11}$ & 0 $\sigma$ (Grenze) \\
		\bottomrule
	\end{tabular}
	\caption{Hybrid vs. Reine T0: Reine T0-Perspektive -- Pre-2025-Daten ($ \times 10^{-11}$; Tau-Grenze skaliert)}
	\label{tab:hybrid_pure_pure}
\end{table}
...
\begin{table}[htbp]
	\centering
	\small
	\begin{tabular}{p{1.5cm} p{1.5cm} p{1.5cm} p{2.5cm} p{2.5cm} p{2cm}}
		\toprule
		Lepton & Ansatz & T0-Kern ($ \times 10^{-11}$) & Voller Wert im Ansatz ($ \times 10^{-11}$) & Pre-2025 Exp. ($ \times 10^{-11}$) & \% Abweichung (zu Ref.) \\
		\midrule
		Myon ($\mu$) & Hybrid (SM + T0) & 153 & SM $116591810 + 153 = 116591963 \times 10^{-11}$ & $116592059 \times 10^{-11}$ & $0.009$ \% \\
		Myon ($\mu$) & Reine T0 & 153 (Kern) & Betten SM ein $\to$ $\sim 116591963 \times 10^{-11}$ (skaliert) & $116592059 \times 10^{-11}$ & $0.009$ \% \\
		Elektron (e) & Hybrid (SM + T0) & 0.0036 & SM $115965218.073 + 0.0036 = 115965218.076 \times 10^{-11}$ & $115965218.073 \times 10^{-11}$ & $2.6 \times 10^{-12}$ \% \\
		Elektron (e) & Reine T0 & 0.0036 (Kern) & Betten QED ein $\to$ $\sim 115965218.076 \times 10^{-11}$ (via $\xi$) & $115965218.073 \times 10^{-11}$ & $2.6 \times 10^{-12}$ \% \\
		\bottomrule
	\end{tabular}
