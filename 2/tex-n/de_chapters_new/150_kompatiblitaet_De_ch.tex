\chapter{\textbf{Kompatibilitätsanalyse der T0-Dimensionsformulierungen}\\[0.5cm]
	 Vereinheitlichung von 4D-Torsionskristall und fraktaler Dimension\\[0.3cm]
...
\section*{Abstract}
	...
	\begin{equation}
		K_{\text{frak}} \approx 0{,}9867 \quad \Leftrightarrow \quad \text{ca. 1{,}33\% Korrektur} \quad \Leftrightarrow \quad \text{$\sim$2\%}
	\end{equation}
	{$\sim$2\% in Observablen
