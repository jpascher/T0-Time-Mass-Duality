% Chapter file: 038_Markov_De_ch.tex
% Source: 038_Markov_De.tex

\chapter{Markov-Ketten im Kontext der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Deterministisch oder stochastisch? Ein Traktat zu Mustern, Voraussetzungen und Unsicherheit}
...
\section*{Abstract}
	...
	\begin{table}[h]
		\centering
		%
		\begin{tabular}{@{}p{0.27\textwidth}@{\hspace{2mm}}p{0.35\textwidth}@{\hspace{2mm}}p{0.32\textwidth}@{}}
			\toprule
