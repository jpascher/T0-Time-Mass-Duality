\chapter{\textbf{Die Planck-Skalen-Struktur der Umrechnungsfaktoren}\\[0.5cm]
	 Warum $G = (\ell_P^2 \times c^3)/\hbar$ die Form der Faktoren aus Dokument 012 begründet\\[0.3cm]
