...
\begin{longtable}{p{2.6cm}p{1.5cm}p{3.4cm}p{2cm}p{2.6cm}p{0.8cm}}
	\caption{T0-Modell-Berechnungs-Verifikation: Skalen-Verhältnisse vs. CODATA/Experimentelle Werte} \\
	\label{tab:t0-verifikation-long} \\
	\toprule
	...
	\midrule
	Leptonen-g-2 (T0, qualitativ) 
	& -- & konzeptionelles Beitragsmuster gesteuert durch $\xi$ 
	& -- & siehe \texttt{018\_T0\_Anomale-g2-10\_De.tex} & -- \\
	Myon g-2 Anomalie 
	& 1 & $\Delta a_{\mu}$ (exp.) 
	& $\mathbf{2.51 \times 10^{-9}}$ & $2.51 \times 10^{-9}$ (Fermilab) & $\checkmark$ \\
	T0-Anteil Myon-Anom. 
	& \% & $\frac{a_{\mu}^{(T0)}}{\Delta a_{\mu}} \times 100\%$ 
	& $\mathbf{9.2\%}$ & Berechnet (100\%) & $\checkmark$ \\
	...
	& $\mathbf{1.742 \times 10^{-8}}$ & Neu & $\star$ \\
	Energie-Unabh. (1 MeV) 
	& 1 & $f(E/E_P)$ bei 1 MeV & $\mathbf{1.000}$ & Neu & $\star$ \\
	Energie-Unabh. (100 GeV) 
	& 1 & $f(E/E_P)$ bei 100 GeV & $\mathbf{1.000}$ & Neu & $\star$ \\
	
	\pagebreak  % ← hier erzwingst du den Seitenwechsel genau zwischen den Blöcken
	...
	$H_0$ vs SH0ES 
	& km/s/Mpc & Dieselbe Formel & $\mathbf{69.9}$ & $74.0 \pm 1.4$ (Ceph., 94.4\%) & $\checkmark$ \\
	$H_0$ vs H0LiCOW 
	& km/s/Mpc & Dieselbe Formel & $\mathbf{69.9}$ & $73.3 \pm 1.7$ (Linse, 95.3\%) & $\checkmark$ \\
	Universum-Alter 
	& Gyr & $t_U = 1/H_0$ & $\mathbf{14.0}$ & $13.8 \pm 0.2$ (98.6\%) & $\checkmark$ \\
	$H_0$ Energie-Einh. 
	& GeV & $H_0 = \xi_{sph}^{15.697} E_P$ 
	& $\mathbf{1.490 \times 10^{-42}}$ & Neu (T0) & $\star$ \\
	$H_0/E_P$ Skalen-Verh. 
	& 1 & $H_0/E_P = \xi_{sph}^{15.697}$ 
	& $\mathbf{1.220 \times 10^{-61}}$ & Theorie (100\%) & $\checkmark$ \\
...
\end{longtable}
	...
	\begin{table}[htbp]
		...
		%
			\begin{tabular}{p{2.4cm}p{1.8cm}p{2.4cm}p{2.4cm}p{2.4cm}p{0.8cm}}
				...
				\multicolumn{6}{l}{\textbf{HINWEIS: 99.98-100.04\% Übereinstimmung (Rundungsfehler)}} \\
	...
	\begin{table}[htbp]
		...
		%
			\begin{tabular}{p{2.4cm}p{1.8cm}p{2.4cm}p{2.4cm}p{2.4cm}p{0.8cm}}
				...
				\multicolumn{6}{l}{\textbf{HINWEIS: Einfache Energie-Beziehungen zeigen 100\% Übereinstimmung}} \\
	...
	\begin{thebibliography}{9}
		...
		Verfügbar unter: \url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/064_Ho_En.pdf}
		
		\bibitem{pascher_beta_derivation_2025}
		Pascher, J. (2025). \textit{Feldtheoretische Ableitung des $\beta_T$-Parameters in natürlichen Einheiten ($\hbar = c = 1$)}. \\
		Verfügbar unter: \url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/093_DerivationVonBeta_En.pdf}
		...
		Verfügbar unter: \url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/052_EliminationOfMass_En.pdf}
		...
		Verfügbar unter: \url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/062_Moll_Candela_En.pdf}
