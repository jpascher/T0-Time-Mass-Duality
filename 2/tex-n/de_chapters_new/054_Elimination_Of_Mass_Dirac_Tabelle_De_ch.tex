	...
	\begin{table}[H]
		...
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{p{3.2cm}p{1.2cm}p{2.8cm}p{2.5cm}p{2.3cm}p{1.0cm}p{0.6cm}}
				...
				\midrule
				$\xi$ (Flach) & 1 & $\xi = \frac{\lambda_h^2 v^2}{16\pi^3 E_h^2}$ & $\mathbf{1,316\times10^{-4}}$ & $1,320\times10^{-4}$ & $\mathbf{99,7\%}$ & $\checkmark$ \\
	...
	\begin{table}[H]
		...
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{p{3.2cm}p{1.6cm}p{2.8cm}p{2.5cm}p{2.3cm}p{1.0cm}p{0.6cm}}
				...
				\textbf{Physikalische Größe} & \textbf{SI-Einheit} & \textbf{T0-Ver-hältnis-formel} & \textbf{T0-Be-rech-nung} & \textbf{CODATA/Experimentell} & \textbf{Übereinstimmung} & \textbf{Status} \\
				\midrule
				$H_0$ (T0) & km/s/Mpc & $H_0^{\text{T0}} = \xi \cdot c$ & $\mathbf{40{,}0}$ & $67,4$ (Planck) & $\mathbf{59{,}3\%}^*$ & $\triangle$ \\
				$H_0$ vs SH0ES & km/s/Mpc & Gleiche Formel & $\mathbf{40{,}0}$ & $74,0$ & $\mathbf{54{,}1\%}^*$ & $\triangle$ \\
				$H_0$ vs H0LiCOW & km/s/Mpc & Gleiche Formel & $\mathbf{40{,}0}$ & $73,3$ & $\mathbf{54{,}6\%}^*$ & $\triangle$ \\
				Universumsalter & Gyr & statisch: $\infty$ & $\mathbf{\infty}$ & $13,8$ & -- & $\triangle$ \\
				$H_0$ Energieeinheiten & GeV & $H_0^{\text{T0}} = \xi \cdot c$ & $\mathbf{8{,}52\times10^{-43}}$ & T0-Vorhersage & $\mathbf{N/A}$ & $\star$ \\
				$H_0/E_P$-Verhältnis & 1 & $H_0^{\text{T0}} = \xi \cdot c$ & $\mathbf{6{,}97\times10^{-62}}$ & Theorie & $\mathbf{100,0\%}$ & $\checkmark$ \\
				\bottomrule
			\end{tabular}
		}
	\end{table}
	...
	\begin{table}[H]
		...
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{p{3.2cm}p{1.6cm}p{2.8cm}p{2.5cm}p{2.3cm}p{1.0cm}p{0.6cm}}
				...
				\textbf{Physikalische Größe} & \textbf{SI-Einheit} & \textbf{T0-Ver-hältnis-formel} & \textbf{T0-Be-rech-nung} & \textbf{CODATA/Experimentell} & \textbf{Übereinstimmung} & \textbf{Status} \\
				\midrule
				Schwinger E-Feld & V/m & $E_S = \frac{m_e^2 c^3}{e\hbar}$ & $\mathbf{1,32\times10^{18}}$ & $1,32\times10^{18}$ & $\mathbf{100,0\%}$ & $\checkmark$ \\
	...
	\begin{table}[H]
		...
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{p{3.2cm}p{1.6cm}p{2.8cm}p{2.5cm}p{2.3cm}p{1.0cm}p{0.6cm}}
				...
				\midrule
				Planck-Zeit & s & $t_P = \sqrt{\frac{\hbar G}{c^5}}$ & $\mathbf{5,392\times10^{-44}}$ & $5,391\times10^{-44}$ & $\mathbf{100,016\%}$ & $\checkmark$ \\
	...
	\begin{table}[H]
		...
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{p{3.0cm}p{1.5cm}p{2.8cm}p{2.8cm}p{2.2cm}p{1.2cm}p{0.6cm}}
				...
				\midrule
				\multicolumn{7}{l}{\textbf{DIRKTE ENERGIEIDENTITÄTEN - KEINE RUNDUNGSFEHLER}} \\
				\midrule
				Masse & $E = m$ & Energie = Masse & $0,511$ MeV & Gleicher Wert & $\mathbf{100\%}$ & $\checkmark$ \\
	...
	\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Hauptergebnisse der T0-Verifikation]
		...
		\begin{itemize}
			...
			\item Kosmologisches $H_0^{\text{T0}} = \xi \cdot c \approx 40\,$km/s/Mpc (parameterfreie Vorhersage, Faktor $7/4$ zum modellabhängigen Standardwert)
