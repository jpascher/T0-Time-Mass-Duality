\chapter{E=mc² = E=m: Zwei äquivalente Perspektiven \\
	Einheitenkonventionen in der Relativitätstheorie \\
	 Von SI-Einheiten zu natürlichen Einheiten}
...
\section*{Abstract}
	...
	\textbf{Wenn man $c^2$ als Ümrechnungsfaktor'' definiert}:
	\begin{equation}
		E = mc^2
	\end{equation}
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}[node distance=1.5cm]
			...
			\node at (0,-3) [align=center] {\textbf{Verbindung:}\\[0.1cm]$E = mc^2 = E = m$\\[0.1cm]Dieselbe Realität, unterschiedliche Beschreibungen};
		\end{tikzpicture}
	...
	\begin{itemize}
		...
		\item Ühren laufen bei hohen Geschwindigkeiten langsamer''
	\end{itemize}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{|l|c|c|}
			...
			GPS-Korrektur & Ühren laufen anders'' & ``c ist anders'' \\
	...
	\begin{itemize}
		...
		\item \textbf{Ästhetik}: Üniverselle Konstante'' klang elegant
	...
	\textbf{Nicht wegen äbsoluter Wahrheit'', sondern wegen}:
	...
	\textbf{T0 beansprucht KEINE äbsolute Wahrheit''.}
	...
	\begin{itemize}
		...
		\item Ünd \textbf{mehr testbare} Vorhersagen macht''
	\end{itemize}
	...
	\textbf{Nach allen diesen Kriterien ist T0 ``besser'' als Einstein – aber nicht äbsolut wahr''.}
