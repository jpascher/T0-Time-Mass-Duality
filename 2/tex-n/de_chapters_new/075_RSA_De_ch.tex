...
\section*{Abstract}
	...
	\begin{table}[htbp]
		\centering
		%
		\begin{tabular}{p{2.3cm}p{2.3cm}p{2.3cm}p{2.3cm}p{2.2cm}}
			\toprule
...
\begin{table}[htbp]
	...
	\begin{tabular}{p{2.3cm}p{2.3cm}p{2.3cm}p{2.3cm}p{2.2cm}}
		...
		\midrule
		T0-Shor & RAM-Limitierung & Direkt & Direkt & Speicher-skalierung \\
		QC & Elektronen-zustände & Exponen\-tielle Kodierung & Mess-kollaps & I/O-Komplexität \\
		T0 + QC & Elektronen-zustände & Selbes QC-Problem & Selbes QC-Problem & I/O-Komplexität \\
		\bottomrule
	\end{tabular}
