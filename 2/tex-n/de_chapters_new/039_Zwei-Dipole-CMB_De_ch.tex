\chapter{Kommentar: CMB- und Quasar-Dipol-Anomalie -- Eine dramatische Bestätigung der T0-Vorhersagen!}
	...
	In meinen Projektdokumenten (\texttt{redshift\_deflection\_De.pdf}, \texttt{063\_cosmic\_De.pdf}) ist genau beschrieben:
	...
	\begin{tabular}{p{3.5cm}p{5cm}p{3.5cm}}
		...
		Geschw.-widerspruch & Unmöglich & Verschiedene Phänomene \\
