...
% Standardized preamble - 114\_T0\_freqeunz\_De.pdf
...
\begin{document}
	...
	\begin{enumerate}
		...
		T0\_Framework\_En.pdf - Mathematical foundations of T0 theory, field equations and mass variation (2024)
		
		\item \textbf{T0-Theorie Grundlagen (Deutsch)} \\
		T0\_Framework\_De.pdf - Mathematische Grundlagen der T0-Theorie, Feldgleichungen und Massenvariation (2024)
		
		\item \textbf{Rotverschiebungsanalyse in T0 (Englisch)} \\
		T0\_Redshift\_Analysis\_En.pdf - Analysis of redshift in T0, comparison with standard model (2024)
		
		\item \textbf{T0 Kosmologie (Deutsch)} \\
		T0\_Cosmology\_De.pdf - Kosmologische Anwendungen der T0-Theorie, Hubble-Parameter, Dunkle Energie (2024)
		
		\item \textbf{T0 Kosmologie (Englisch)} \\
		T0\_Cosmology\_En.pdf - Cosmological applications of T0 theory, Hubble parameter, dark energy (2024)
		
		\item \textbf{T0 Numerische Implementation (Englisch)} \\
		T0\_Numerics\_Implementation\_En.pdf - Numerical methods and code implementation for T0 calculations (2024)
		
		\item \textbf{T0 GitHub Repository} \\
		T0-Time-Mass-Duality - Vollständiges Code-Repository mit allen Skripten und Dokumenten
