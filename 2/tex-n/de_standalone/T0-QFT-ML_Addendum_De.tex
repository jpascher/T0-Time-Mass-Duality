...
\hypersetup{
	...
	pdfsubject={Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie), Maschinelles Lernen, QFT-Erweiterungen}
}
...
\begin{document}
	...
	\subsection{Drei-Ebenen-Hierarchie der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025). \textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Erweiterung auf Bell-Tests — ML-Simulationen}.
		Bell\_De.pdf, November 2025.
		
		\bibitem{pascher_qm_summary_2025}
		Pascher, J. (2025). \textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Zusammenfassung der Erkenntnisse}.
