...
\title{Kapitel 27: Teilchen-Massenhierarchie\\
\large (Angepasst an T0-Theorie)}
\author{Dynamische Vakuumfeldtheorie\\
Neu formuliert auf T0 Zeit-Masse-Dualität Grundlage}
\date{}
...
Elektron & $m_e \sim \xi^{-1/2} m_0$ & $\sim 0{,}5$ MeV ✓ \\
Myon & $m_\mu \sim \xi^1 \cdot m_e$ & $\sim 105$ MeV ✓ \\
