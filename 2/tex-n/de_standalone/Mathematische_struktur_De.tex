...
\hypersetup{
	...
	pdfsubject={Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie), Geometrische Physik, Fundamentale Konstanten}
}
...
% Titel
\title{\textbf{Zur mathematischen Struktur der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): \ Warum Zahlenverhältnisse nicht direkt gekürzt werden dürfen}\\[0.5cm]
...
\begin{document}
	...
	\tableofcontents
	\newpage	
	\section*{Zur mathematischen Struktur der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Warum Zahlenverhältnisse nicht direkt gekürzt werden dürfen}
	
	\subsection*{Einleitung}
	
	In der theoretischen Physik stellt sich oft die Frage, welche mathematischen Operationen legitim sind und welche nicht. Ein besonders interessantes Problem tritt in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) auf, wo scheinbar einfache Zahlenverhältnisse wie $\frac{2}{3}$ und $\frac{8}{5}$ eine tiefere strukturelle Bedeutung besitzen, die ein direktes Kürzen verbietet.
...
Allerdings darf diese Konvention nicht darüber hinwegtäuschen, dass $\alpha$ in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) einen bestimmten numerischen Wert hat, der durch $\xi$ bestimmt wird.
...
\end{tcolorbox}
	...
	\noindent \textbf{1.1.1} Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) beginnt mit einer einzigen dimensionslosen Konstante, die aus der Geometrie des dreidimensionalen Raums abgeleitet wird:
	...
	\noindent \textbf{3.1.1} Die fundamentale Formel der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) für den Kopplungsparameter $\varepsilon$ lautet:
	\begin{keyresult}
		\begin{equation}
...
\begin{tcolorbox}[colback=green!5,colframe=green!75!black,title=Zentrales Ergebnis]
	\noindent \textbf{10.1} Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) zeigt, dass alle fundamentalen physikalischen Konstanten aus einem einzigen geometrischen Parameter $\xipar = \frac{4}{3} \times 10^{-4}$ ohne empirische Eingaben abgeleitet werden können.
	\begin{equation}
...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=\textbf{Die Essenz}]
	\noindent \textbf{11.9.1} Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) kann auf eine einzige Formel reduziert werden:
...
\noindent \textbf{12.1.1} Aus der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) haben wir die Massenformeln:
\begin{align}
	m_e &= c_e \cdot \xi^{5/2} \\
...
\noindent \textbf{13.2.1} Die Koeffizienten ergeben sich aus der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) mit:
...
\section{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Exakte Formeln und Werte}

\subsection{In der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}
...
\section{Exakte Koeffizienten aus der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}
...
\begin{align*}
	...
	\text{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie):} &\quad m_e = \frac{3\sqrt{3}}{2\pi\alpha^{1/2}} \cdot \xi^{5/2}
\end{align*}
...
\begin{align*}
	...
	\text{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie):} &\quad m_\mu = \frac{9}{4\pi\alpha} \cdot \xi^2
\end{align*}
...
\noindent \textbf{24.5.1} Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) zeigt: \textbf{$\alpha$ ist kein freier Parameter!}
...
\noindent \textbf{24.10.1} Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) zeigt:
\begin{center}
	\fbox{
...
\subsection{Die eigentliche Aussage der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}
...
Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) schlägt vor:
\begin{align*}
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black]
	...
	\begin{enumerate}
		...
		\item Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) die Beziehung zwischen Leptonmassen und $\alpha$ genau beschreibt
	\end{enumerate}
\end{tcolorbox}
