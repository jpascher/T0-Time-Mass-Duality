...
\begin{document}
	...
	\begin{table}[htbp]
		\centering
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{p{6cm}p{2.5cm}p{3cm}p{2.5cm}p{5cm}p{0.8cm}}
				\toprule
	...
	\begin{table}[htbp]
		\centering
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{p{3.5cm}p{2cm}p{2.5cm}p{3cm}p{5cm}p{0.8cm}}
				\toprule
	...
	\begin{table}[htbp]
		\centering
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{p{3.5cm}p{2cm}p{4cm}p{3cm}p{4cm}p{0.8cm}}
				\toprule
