...
\usepackage{adjustbox} % Für resizebox mit longtable, falls nötig, aber hier zu table geändert
...
\begin{document}
	...
	% Zu table geändert für resizebox, \footnotesize für Passung
	\footnotesize
	\begin{table}[htbp]
		\centering
		\resizebox{\textwidth}{!}{%
\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{@{}p{0.30\textwidth}@{}}p{2.5cm}p{3cm}p{2.5cm}p{5cm}p{0.8cm}}
				\toprule
				\textbf{Größe} & \textbf{Einheit} & \textbf{T0-Formel} & \textbf{T0-Wert} & \textbf{CODATA} & \textbf{Stat.} \\
				\midrule
				% FUNDAMENTALES SKALEN-VERHÄLTNIS
				\multicolumn{6}{l}{\textbf{FUNDAMENTALES SKALEN-VERHÄLTNIS}} \\
				\midrule
				
				$\xi$ (Higgs-Energie-Verhältnis, Flach) & 1 & $\xi = \frac{\lambda_h^2 v^2}{16\pi^3 E_h^2}$ & $\mathbf{1.316 \times 10^{-4}}$ & $1.320 \times 10^{-4}$ (99.7\%) & $\checkmark$ \\
				
				$\xi$ (Higgs-Energie-Verhältnis, Sphär.) & 1 & $\xi = \frac{\lambda_h^2 v^2}{24\pi^{5/2} E_h^2}$ & $\mathbf{1.557 \times 10^{-4}}$ & Neu (T0) & $\star$ \\
				
				% ABGELEITETE KONSTANTEN
				\multicolumn{6}{l}{\textbf{KONSTANTEN AUS SKALEN-VERHÄLTNISSEN}} \\
				\midrule
				Elektronmasse (aus $\xi$) & MeV & $m_e = f(\xi, \text{Higgs})$ & $\mathbf{0.511}$ MeV & $0.511$ MeV (99.998\%) & $\checkmark$ \\
				
				Compton-Wellenlänge & m & $\lambda_C = \frac{\hbar}{m_e c}$ aus $\xi$ & $\mathbf{3.862 \times 10^{-13}}$ & $3.862 \times 10^{-13}$ (99.989\%) & $\checkmark$ \\
				
				Planck-Länge & m & $\ell_P$ aus $\xi$-Skal. & $\mathbf{1.616 \times 10^{-35}}$ & $1.616 \times 10^{-35}$ (99.984\%) & $\checkmark$ \\
				
				% ANOMALE MAGNETISCHE MOMENTE
				\multicolumn{6}{l}{\textbf{ANOMALE MAGNETISCHE MOMENTE}} \\
				\midrule
				Elektron g-2 (T0) & 1 & $a_e^{(T0)} = \frac{1}{2\pi} \xi^2 \frac{1}{12}$ & $\mathbf{2.309 \times 10^{-10}}$ & Neu & $\star$ \\
				
				Myon g-2 (T0) & 1 & $a_\mu^{(T0)} = \frac{1}{2\pi} \xi^2 \frac{1}{12}$ & $\mathbf{2.309 \times 10^{-10}}$ & Neu & $\star$ \\
				
				Myon g-2 Anomalie & 1 & $\Delta a_{\mu}$ (exp.) & $\mathbf{2.51 \times 10^{-9}}$ & $2.51 \times 10^{-9}$ (Fermilab) & $\checkmark$ \\
				
				T0-Anteil Myon-Anom. & \% & $\frac{a_{\mu}^{(T0)}}{\Delta a_{\mu}} \times 100\%$ & $\mathbf{9.2\%}$ & Berechnet (100\%) & $\checkmark$ \\
				
				% QED-KORREKTUREN
				\multicolumn{6}{l}{\textbf{QED-KORREKTUREN (Verhältnis-Berechnungen)}} \\
				\midrule
				Vertex-Korrektur & 1 & $\frac{\Delta\Gamma}{\Gamma^{\mu}} = \xi^2$ & $\mathbf{1.742 \times 10^{-8}}$ & Neu & $\star$ \\
				
				Energie-Unabh. (1 MeV) & 1 & $f(E/E_P)$ bei 1 MeV & $\mathbf{1.000}$ & Neu & $\star$ \\
				
				Energie-Unabh. (100 GeV) & 1 & $f(E/E_P)$ bei 100 GeV & $\mathbf{1.000}$ & Neu & $\star$ \\
				
				% KOSMOLOGISCHE SKALEN-VORHERSAGEN
				\multicolumn{6}{l}{\textbf{KOSMOLOGISCHE SKALEN-VORHERSAGEN}} \\
				\midrule
				
				Hubble-Parameter $H_0$ & km/s/Mpc & $H_0 = \xi_{sph}^{15.697} E_P$ & $\mathbf{69.9}$ & $67.4 \pm 0.5$ (Planck, 103.7\%) & $\checkmark$ \\
				
				$H_0$ vs SH0ES & km/s/Mpc & Dieselbe Formel & $\mathbf{69.9}$ & $74.0 \pm 1.4$ (Ceph., 94.4\%) & $\checkmark$ \\
				
				$H_0$ vs H0LiCOW & km/s/Mpc & Dieselbe Formel & $\mathbf{69.9}$ & $73.3 \pm 1.7$ (Linse, 95.3\%) & $\checkmark$ \\
				
				Universum-Alter & Gyr & $t_U = 1/H_0$ & $\mathbf{14.0}$ & $13.8 \pm 0.2$ (98.6\%) & $\checkmark$ \\
				
				$H_0$ Energie-Einh. & GeV & $H_0 = \xi_{sph}^{15.697} E_P$ & $\mathbf{1.490 \times 10^{-42}}$ & Neu (T0) & $\star$ \\
				
				$H_0/E_P$ Skalen-Verh. & 1 & $H_0/E_P = \xi_{sph}^{15.697}$ & $\mathbf{1.220 \times 10^{-61}}$ & Theorie (100\%) & $\checkmark$ \\
				
				% PHYSIKALISCHE FELDER
				\multicolumn{6}{l}{\textbf{PHYSIKALISCHE FELDER}} \\
				\midrule
				Schwinger E-Feld & V/m & $E_S = \frac{m_e^2 c^3}{e\hbar}$ & $\mathbf{1.32 \times 10^{18}}$ & $1.32 \times 10^{18}$ (100\%) & $\checkmark$ \\
				
				Kritisches B-Feld & T & $B_c = \frac{m_e^2 c^2}{e\hbar}$ & $\mathbf{4.41 \times 10^{9}}$ & $4.41 \times 10^{9}$ (100\%) & $\checkmark$ \\
				
				Planck E-Feld & V/m & $E_P = \frac{c^4}{4\pi\varepsilon_0 G}$ & $\mathbf{1.04 \times 10^{61}}$ & $1.04 \times 10^{61}$ (100\%) & $\checkmark$ \\
				
				Planck B-Feld & T & $B_P = \frac{c^3}{4\pi\varepsilon_0 G}$ & $\mathbf{3.48 \times 10^{52}}$ & $3.48 \times 10^{52}$ (100\%) & $\checkmark$ \\
				
				% PLANCK-STROM-VERIFIKATION
				\multicolumn{6}{l}{\textbf{PLANCK-STROM-VERIFIKATION}} \\
				\midrule
				Planck-Strom (Std.) & A & $I_P = \sqrt{\frac{c^6\varepsilon_0}{G}}$ & $\mathbf{9.81 \times 10^{24}}$ & $3.479 \times 10^{25}$ (28.2\%) & $\times$ \\
				
				Planck-Strom (Vollst.) & A & $I_P = \sqrt{\frac{4\pi c^6\varepsilon_0}{G}}$ & $\mathbf{3.479 \times 10^{25}}$ & $3.479 \times 10^{25}$ (99.98\%) & $\checkmark$ \\
...
\end{adjustbox}
	...
	\begin{table}[htbp]
		...
		\resizebox{\textwidth}{!}{%
\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{@{}p{0.30\textwidth}@{}}p{2cm}p{2.5cm}p{3cm}p{5cm}p{0.8cm}}
				\toprule
				\textbf{Größe} & \textbf{Einheit} & \textbf{Planck-Formel} & \textbf{T0-Wert} & \textbf{CODATA} & \textbf{Stat.} \\
				\midrule
				% PLANCK-EINHEITEN AUS FUNDAMENTALEN KONSTANTEN
				\multicolumn{6}{l}{\textbf{PLANCK-EINHEITEN AUS KOMPLEXEN FORMELN}} \\
				\midrule
				Planck-Zeit & s & $t_P = \sqrt{\frac{\hbar G}{c^5}}$ & $\mathbf{5.392 \times 10^{-44}}$ & $5.391 \times 10^{-44}$ (100.016\%) & $\checkmark$ \\
				
				Planck-Länge & m & $\ell_P = \sqrt{\frac{\hbar G}{c^3}}$ & $\mathbf{1.617 \times 10^{-35}}$ & $1.616 \times 10^{-35}$ (100.030\%) & $\checkmark$ \\
				
				Planck-Masse & kg & $m_P = \sqrt{\frac{\hbar c}{G}}$ & $\mathbf{2.177 \times 10^{-8}}$ & $2.176 \times 10^{-8}$ (100.044\%) & $\checkmark$ \\
				
				Planck-Temperatur & K & $T_P = \sqrt{\frac{\hbar c^5}{G k_B^2}}$ & $\mathbf{1.417 \times 10^{32}}$ & $1.417 \times 10^{32}$ (99.988\%) & $\checkmark$ \\
				
				Planck-Strom & A & $I_P = \sqrt{\frac{4\pi c^6 \varepsilon_0}{G}}$ & $\mathbf{3.479 \times 10^{25}}$ & $3.479 \times 10^{25}$ (99.980\%) & $\checkmark$ \\
				
				% HINWEIS AUF RUNDUNGSFEHLER
				\multicolumn{6}{l}{\textbf{HINWEIS: Komplexe Formeln zeigen 99.98-100.04\% Übereinstimmung (Rundungsfehler)}} \\
...
\end{adjustbox}
	...
	\begin{table}[htbp]
		...
		\resizebox{\textwidth}{!}{%
\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{@{}p{0.30\textwidth}@{}}p{2cm}p{4cm}p{3cm}p{4cm}p{0.8cm}}
				\toprule
				\textbf{Größe} & \textbf{Beziehung} & \textbf{Beispiel} & \textbf{Elektron-Fall} & \textbf{Num. Wert} & \textbf{St.} \\
				\midrule
				% DIREKTE IDENTITÄTEN - KEINE RUNDUNGSFEHLER
				\multicolumn{6}{l}{\textbf{DIREKTE ENERGIE-IDENTITÄTEN - KEINE RUNDUNGSFEHLER}} \\
				\midrule
				
				Masse & $E = m$ & Energie = Masse & $0.511$ MeV & Derselbe Wert (100\%) & $\checkmark$ \\
				
				Temperatur & $E = T$ & Energie = Temp. & $5.93 \times 10^9$ K & Direkt (100\%) & $\checkmark$ \\
				
				Frequenz & $E = \omega$ & Energie = Freq. & $7.76 \times 10^{20}$ Hz & Direkt (100\%) & $\checkmark$ \\
				
				% INVERSE BEZIEHUNGEN - EXAKT
				\multicolumn{6}{l}{\textbf{INVERSE ENERGIE-BEZIEHUNGEN - EXAKT}} \\
				\midrule
				
				Länge & $E = 1/L$ & Energie = 1/Länge & $3.862 \times 10^{-13}$ m & Invers (100\%) & $\checkmark$ \\
				
				Zeit & $E = 1/T$ & Energie = 1/Zeit & $1.288 \times 10^{-21}$ s & Invers (100\%) & $\checkmark$ \\
				
				% T0-ENERGIE-PARAMETER - REINE VERHÄLTNISSE
				\multicolumn{6}{l}{\textbf{T0-ENERGIE-PARAMETER - REINE VERHÄLTNISSE}} \\
				\midrule
				
				$\xi$ (Flach) & $E_h/E_P$ & Energie-Verh. & $1.316 \times 10^{-4}$ & Higgs-Physik (100\%) & $\checkmark$ \\
				
				$\xi$ (Sphär.) & $E_h/E_P$ & Korrigiert & $1.557 \times 10^{-4}$ & Neu T0 (100\%) & $\star$ \\
				
				$\xi$ Geometr. & $E_\ell/E_P$ & Längen-En.-Verh. & $8.37 \times 10^{-23}$ & Geometrie (100\%) & $\checkmark$ \\
				
				EM-Geom.-Faktor & Verhältnis & $\sqrt{4\pi/9}$ & $1.18270$ & Exakt (100\%) & $\star$ \\
				
				% VOLLSTÄNDIGE SI-EINHEITEN-ENERGIE-ABDECKUNG
				\multicolumn{6}{l}{\textbf{SI-EINHEITEN-ENERGIE-ABDECKUNG - 7/7 EINHEITEN}} \\
				\midrule
				
				El. Strom & $I = E/T$ & Energie-Fluss & $[E]$ Dimension & Direkt (100\%) & $\checkmark$ \\
				
				Stoffmenge (Mol) & $[E^2]$ Dim. & Energiedichte & Dim. Struktur & SI-def. $N_A$ (Def.) & $\star$ \\
				
				Lichtstärke & $[E^3]$ Dim. & En.-Fl.-Wahrn. & Dim. Struktur & SI-def. 683 lm/W (Def.) & $\star$ \\
				
				% HINWEIS AUF PERFEKTE ÜBEREINSTIMMUNG
				\multicolumn{6}{l}{\textbf{HINWEIS: Einfache Energie-Beziehungen zeigen 100\% Übereinstimmung (keine Fehler)}} \\
...
\end{adjustbox}
	...
	% Einheitliche table mit resizebox
	\begin{table}[htbp]
		\centering
		\resizebox{\textwidth}{!}{%
\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{@{}p{0.30\textwidth}@{}}|p{4cm}@{}p{0.30\textwidth}@{}}|p{4cm}|}
				\hline
