...
% Standardized preamble - 054_Elimination_Of_Mass_Dirac_Tabelle_De.pdf
...
\tableofcontents
	...
	\begin{landscape}
		...
		\begin{longtable}{p{5.5cm}p{1.8cm}p{3.5cm}p{2.5cm}p{3.5cm}p{1.8cm}p{1cm}}
			...
			\midrule
			Leptonen-g-2 (T0, qualitativ) & -- & konzeptionelles Beitragsmuster gesteuert durch $\xi$ & -- & siehe \texttt{018\_T0\_Anomale-g2-10\_De.pdf} & -- & -- \\
