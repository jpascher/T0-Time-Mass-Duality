...
% Standardized preamble - 033_T0-Theory-vs-Synergetics_De.tex
...
\begin{document}
	...
	\noindent\textbf{Elektron}
	\begin{itemize}
		\item Synergetics: $\frac{1}{f_e} \times C_{\text{conv}}$, mit $f_e=1/137$
		\item T0: $m_e = \omega_e = T_e^{-1} = \xipar^{-1} \cdot k_e$
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Myon}
	\begin{itemize}
		\item Synergetics: $\frac{1}{f_\mu} \times C_{\text{conv}}$
		\item T0: $m_\mu = \sqrt{m_e \cdot m_\tau}$
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Proton}
	\begin{itemize}
		\item Synergetics: Komplex mit Faktoren (1836 aus Vektoren)
		\item T0: $m_p = 1836 \times m_e$
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Anzahl empirischer Faktoren}
	\begin{itemize}
		\item Synergetics: 2+ empirische (leitet $1/137$ von $\alpha$ ab)
		\item T0: 0 empirische ($\xipar$ primär)
	\end{itemize}
	...
	\noindent\textbf{Feinstrukturkonstante $\alpha$}
	\begin{itemize}
		\item Synergetics: $1/137$ (direkt aus Marker)
		\item T0: $\xipar \cdot E_0^2$
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Gravitationskonstante $G$}
	\begin{itemize}
		\item Synergetics: $\frac{1/\alpha^2 - 1}{(h - 1)/2} \cdot C \cdot C_1$
		\item T0: $\xipar^2 \cdot \alpha^{11/2}$
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Planck-Konstante $h$}
	\begin{itemize}
		\item Synergetics: Dimensionsbehaftet (6.625)
		\item T0: $2\pi$
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Komplexität}
	\begin{itemize}
		\item Synergetics: Mittel-Hoch (leitet $1/137$ von $\alpha$ ab)
		\item T0: Niedrig ($\xipar$ primär)
	\end{itemize}
	...
	\noindent\textbf{Grundlage}
	\begin{itemize}
		\item Synergetics (Video): Tetraeder-Packung
		\item T0-Theorie: Tetraeder-Packung
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Parameter}
	\begin{itemize}
		\item Synergetics (Video): Implizit $1/137$ (abgeleitet von $\alpha$)
		\item T0-Theorie: $\xipar = \frac{4}{3} \times 10^{-4}$ (primär geometrisch)
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Einheiten}
	\begin{itemize}
		\item Synergetics (Video): SI (m, kg, s)
		\item T0-Theorie: Natürlich ($c=\hbar=1$)
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Konversionsfaktoren}
	\begin{itemize}
		\item Synergetics (Video): 2+ empirische (z.\,B. 7.783, 3.521 – schwer durchschaubar)
		\item T0-Theorie: 0 empirische
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Zeit-Masse}
	\begin{itemize}
		\item Synergetics (Video): Implizit über Frequenz
		\item T0-Theorie: Explizite Dualität $Tm=1$
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Feinstruktur $\alpha$}
	\begin{itemize}
		\item Synergetics (Video): 0.003\% Abweichung
		\item T0-Theorie: 0.003\% Abweichung
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Gravitation $G$}
	\begin{itemize}
		\item Synergetics (Video): <0.0002\% (mit Faktoren)
		\item T0-Theorie: <0.0002\% (geometrisch)
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Teilchenmassen}
	\begin{itemize}
		\item Synergetics (Video): 99.0\% Genauigkeit
		\item T0-Theorie: 99.1\% Genauigkeit
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Muon g-2}
	\begin{itemize}
		\item Synergetics (Video): Nicht adressiert
		\item T0-Theorie: \textbf{Exakt gelöst!}
	\end{itemize}
	...
	\begin{itemize}
		\item Synergetics (Video): Nicht adressiert
		\item T0-Theorie: Spezifische Vorhersage
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Kosmologie}
	\begin{itemize}
		\item Synergetics (Video): Statisches Universum
		\item T0-Theorie: Statisches Universum
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{CMB-Erklärung}
	\begin{itemize}
		\item Synergetics (Video): Geometrisches Feld
		\item T0-Theorie: Casimir-CMB-Ratio
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Dokumentation}
	\begin{itemize}
		\item Synergetics (Video): Präsentationen
		\item T0-Theorie: 8 detaillierte Papiere
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Mathematik}
	\begin{itemize}
		\item Synergetics (Video): Grundlegend + Faktoren (beeindruckend, aber tabellenlastig)
		\item T0-Theorie: Reine Geometrie
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Pädagogik}
	\begin{itemize}
		\item Synergetics (Video): Exzellente Analogien
		\item T0-Theorie: Systematisch
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Visualisierung}
	\begin{itemize}
		\item Synergetics (Video): Hervorragend
		\item T0-Theorie: Gut
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Testbarkeit}
	\begin{itemize}
		\item Synergetics (Video): Gut
		\item T0-Theorie: Sehr gut
	\end{itemize}
	...
	\subsection{Fundamentale Konstanten - Numerische Präzision}
	
	\noindent\textbf{Feinstrukturkonstante $\alpha^{-1}$}
	\begin{itemize}
		\item Synergetics: 137.04
		\item T0: 137.04
		\item Experiment: 137.036
		\item Vergleich: Gleich
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Gravitationskonstante $G$ [$10^{-11}$ SI-Einheiten]}
	\begin{itemize}
		\item Synergetics: 6.6743
		\item T0: 6.6743
		\item Experiment: 6.6743
		\item Vergleich: Gleich
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Elektronmasse $m_e$ [MeV]}
	\begin{itemize}
		\item Synergetics: 0.504
		\item T0: 0.511
		\item Experiment: 0.511
		\item Vergleich: \textbf{T0 besser}
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Myonmasse $m_\mu$ [MeV]}
	\begin{itemize}
		\item Synergetics: 105.1
		\item T0: 105.7
		\item Experiment: 105.66
		\item Vergleich: \textbf{T0 besser}
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Tauonmasse $m_\tau$ [MeV]}
	\begin{itemize}
		\item Synergetics: 1727.6
		\item T0: 1777
		\item Experiment: 1776.86
		\item Vergleich: \textbf{T0 besser}
	\end{itemize}
	
	\vspace{0.3cm}
	\noindent\textbf{Gesamtgenauigkeit}
	\begin{itemize}
		\item Synergetics: 99.0\%
		\item T0: 99.1\%
		\item Vergleich: \textbf{T0 besser}
	\end{itemize}
