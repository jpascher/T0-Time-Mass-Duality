...
\end{adjustbox}
	...
	\begin{table}[ht]
		...
		\resizebox{\textwidth}{!}{%
\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{@{}p{0.13\textwidth}@{\hspace{2mm}}p{0.13\textwidth}@{\hspace{2mm}}p{0.13\textwidth}@{\hspace{2mm}}p{0.13\textwidth}@{\hspace{2mm}}p{0.13\textwidth}@{\hspace{2mm}}p{0.13\textwidth}@{\hspace{2mm}}p{0.13\textwidth}@{\hspace{2mm}}p{0.13\textwidth}@{}}
			\toprule
...
\end{adjustbox}
	...
	\begin{table}[ht]
		...
		\resizebox{\textwidth}{!}{%
\begin{adjustbox}{max width=\textwidth}
				\begin{tabular}{@{}p{0.30\textwidth}@{}}@{}p{0.30\textwidth}@{}}p{2.5cm}p{3cm}p{2.5cm}}
			\toprule
...
\end{adjustbox}
	...
	\begin{table}[ht]
		...
		\resizebox{\textwidth}{!}{%
\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{@{}p{0.30\textwidth}@{}}@{}p{0.30\textwidth}@{}}p{4cm}@{}p{0.30\textwidth}@{}}p{1.5cm}}
			\toprule
