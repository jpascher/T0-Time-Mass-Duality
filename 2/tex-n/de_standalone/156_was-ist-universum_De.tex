...
\begin{document}
	...
	\begin{center}
		\begin{tabular}{ll}
			...
			$\downarrow$ & \\[0.3cm]
			\textbf{Level 1:} & Geometrie -- 4D-Torsionskristall, $D_f = 3-\xi$ \\
			& \textit{Emergente Struktur} \\[0.3cm]
			$\downarrow$ & \\[0.3cm]
			\textbf{Level 2:} & Zeit-Masse-Dualität -- $T \cdot m = 1$ \\
			& \textit{Emergente Differenzierung} \\[0.3cm]
			$\downarrow$ & \\[0.3cm]
			\textbf{Level 3:} & Teilchen -- Resonanzen, Wicklungszahlen \\
			& \textit{Emergente Muster} \\[0.3cm]
			$\downarrow$ & \\[0.3cm]
			\textbf{Level 4:} & Kräfte -- Energie-Gradienten \\
			& \textit{Emergente Wechselwirkungen} \\[0.3cm]
			$\downarrow$ & \\[0.3cm]
			\textbf{Level 5:} & Beobachtbare Welt -- Raum-Zeit, Materie, Expansion \\
	...
	\subsection{Die triune Natur des Fundamentalen}
