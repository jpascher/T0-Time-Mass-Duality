...
\title{DVFT Kapitel 26: SOLUTION TO THE BARYONIC ASYMMETRY\\
...
\end{enumerate}
DVFT satisfies all three using the single T0-Vakuum field Φ = ρ e^{i$\theta$}, without introducing extra fields, new
...
\end{enumerate}
The early universe in DVFT undergoes a transition from a highly coherent T0-Vakuum phase (large ρ, uniform
