...
\begin{document}
	...
	\title{E=mc² = E=m: Die Konstanten-Illusion enttarnt \\
		Warum Einsteins c-Konstante den fundamentalen Fehler verbirgt \\
	...
	\begin{abstract}
		Diese Arbeit enthüllt den zentralen Punkt der Einsteinschen Relativitätstheorie: E=mc² ist mathematisch identisch mit E=m. Der einzige Unterschied liegt in Einsteins Behandlung von c als „Konstante“ statt als dynamisches Verhältnis. Durch die Festlegung von c = 299.792.458 m/s wird die natürliche Zeit-Masse-Dualität T·m = 1 künstlich „eingefroren“, was zu scheinbarer Komplexität führt. Die T0-Theorie zeigt: c ist kein fundamentales Naturgesetz, sondern nur ein Verhältnis, das variabel sein muss, wenn die Zeit variabel ist. Einsteins Fehler lag nicht in E=mc² selbst, sondern in der Konstantsetzung von c.
	\end{abstract}
	...
	\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Die fundamentale Erkenntnis]
		...
		\textbf{Einsteins Fehler}: c = 299.792.458 m/s = konstant
	...
	\section{Einsteins fundamentaler Fehler: Die Konstantsetzung}
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}[node distance=1.5cm]
			\node (practical) [rectangle, draw=blue, thick, fill=blue!5, minimum width=6cm, minimum height=2cm, align=center] {\textbf{Praktische Ingenieurperspektive}\\$E = mc^2$ mit $c = 299.792.458$ m/s\\Funktioniert perfekt für Technologie};
			
			\node (fundamental) [rectangle, draw=red, thick, fill=red!5, minimum width=6cm, minimum height=2cm, align=center, below of=practical, yshift=-1cm] {\textbf{Fundamentale Wissenschaftsperspektive}\\$E = m$ mit $T \cdot m = 1$\\Zeigt ultimative Einfachheit};
			
			\draw[<->, thick] (practical.south) -- (fundamental.north);
			\node at (0,-1.5) [align=center] {\textbf{Verbindung:}\\$E = mc^2 = E = m$\\Dieselbe Realität, unterschiedliche Beschreibungen};
		\end{tikzpicture}
	...
	\textbf{Einsteins Fehler war nicht, einen Referenzpunkt zu wählen}:
	\begin{itemize}
		\item \textbf{Sondern den falschen Referenzpunkt zu wählen!}
	\end{itemize}
	...
	\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Die Referenzpunkt-Illusion]
		...
		\textbf{Einsteins Fehler}: Er definierte einen absoluten Referenzpunkt für c
	\end{tcolorbox}
	...
	\textbf{Einsteins Fehler war nicht nur die c-Konstantsetzung, sondern auch der Anspruch auf absolute Wahrheit seiner mathematischen Konstrukte.}
	...
	\begin{itemize}
		...
		\item T0-Vorhersage: $c$ ändert sich mit der Expansion des Universums
	\end{itemize}
	...
	\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Die fundamentale Wahrheit]
		...
		Die Konstantsetzung war Einsteins fundamentaler Fehler.
	...
	\textbf{Einsteins Fehler}: Konstantsetzung von c
