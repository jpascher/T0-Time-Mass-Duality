...
\begin{document}
	...
	\textbf{Dies ist eine gültige Wahl}für technische und experimentelle Anwendungen.
	...
	\textbf{Dies ist konsistent}, da beide L und T sich transformieren.
	...
	\subsection{Einsteins Perspektiven verglichen}
...
\end{adjustbox}
	...
	\textbf{Die SI-Konvention war nicht, einen Bezugspunkt zu wählen}:
	...
	\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Die Bezugspunkt-Konvention]
		...
		\textbf{Die SI-Konvention}: Er definierte einen absoluten Bezugspunkt für c
	\end{tcolorbox}
	...
	\subsection{T0s Auflösung der Bezugspunkt-Konvention}
	...
	\textbf{Die SI-Konvention war nicht nur die c-Konstant-Setzung, sondern auch der Anspruch auf absolute Wahrheit seiner mathematischen Konstrukte.}
	...
	\textbf{Die Einheitenkonvention bricht zusammen bei}:
	\begin{itemize}
	...
	\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Die große Ironie]
		...
		aber \textbf{verbarg sie hinter der Einheitenkonvention} $E = mc^2$!
...
\end{adjustbox}
	...
	\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Die fundamentale Wahrheit]
		...
		T0 erweitert diese Perspektive durch Rückkehr zur natürlichen Variabilität.
	\end{tcolorbox}
	
	\subsection{Physik nach der Einheitenkonvention}
