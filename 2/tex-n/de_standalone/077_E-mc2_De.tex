...
\begin{document}
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}[node distance=1.5cm]
			...
			\node (fundamental) [rectangle, draw=red, thick, fill=red!5, minimum width=6cm, minimum height=2.5cm, align=center, below of=practical, yshift=-2.5cm] {\textbf{Fundamentale Wissenschaftsperspektive}\\[0.2cm]$E = m$ mit $T \cdot m = 1$\\[0.2cm]Zeigt ultimative Einfachheit};
			
			\draw[<->, thick] (practical.south) -- (fundamental.north);
			\node at (0,-2.8) [align=center] {\textbf{Verbindung:}\\[0.1cm]$E = mc^2 = E = m$\\[0.1cm]Dieselbe Realität, unterschiedliche Beschreibungen};
		\end{tikzpicture}
