...
Tμν(\phi) = ∂μ\phi* ∂ν\phi + ∂μ\phi ∂ν\phi* − gμν(…)
...
a vacuum phase transition from ρ ≈ 0 to ρ_0, producing inflation, reheating, and the origin of space and time
without infinities.
...
dark energy to residual dynamic vacuum field energy, ε_vac = ρ_0²θ̇² + V(ρ_0), providing a natural physical
