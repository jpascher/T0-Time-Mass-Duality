...
Theory (DVFT). Curvature emerges from the interplay between the metric g_{$\mu$?} and the T0-Vakuum phase
...
\end{enumerate}
T^{($\theta$,DVFT)}_{$\mu$?} = 2?? $\partial$I?/$\partial$g^{$\mu$?} + 2?? $\partial$I?/$\partial$g^{$\mu$?} ? g_{$\mu$?}(?? I? + ?? I?).
...
T^{($\theta$)}_{$\mu$?} = T^{($\theta$,kess)}_{$\mu$?} + T^{($\theta$,DVFT)}_{$\mu$?}.
