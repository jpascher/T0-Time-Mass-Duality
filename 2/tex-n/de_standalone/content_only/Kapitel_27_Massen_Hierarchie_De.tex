...
Φ = ρ e^{iθ},
where:
\textbullet{} ρ(x,t) = vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0) → inertia & gravity
\textbullet{} θ(x,t) = vacuum phase → quantum behavior
...
superposed states.
\textbullet{} A proton in superposition does NOT produce two fields — it produces one unified field ∝ |ψ|².
