...
\textbullet{} baryons \rightarrow positive winding number of θ
\textbullet{} antibaryons \rightarrow negative winding number of θ
...
\textbullet{} natural baryon-number violation
\textbullet{} no need for sphalerons or beyond-Standard-Model operators
...
θ \rightarrow -θ (charge conjugation)
x \rightarrow -x (parity),
then the vacuum itself contains a CP-odd bias. This implies:
\textbullet{} different energy costs for +B and -B topological domains
\textbullet{} asymmetric decay of baryon vs antibaryon-like structures
\textbullet{} a preferred direction for phase unwinding
...
adiabatic.
During this epoch:
\textbullet{} ρ varies rapidly
\textbullet{} θ develops domains and defects
\textbullet{} particle masses change dynamically
\textbullet{} vacuum stiffness evolves in time
...
5. Freezing: once ρ stabilizes near ρ_0, baryon-number-changing processes shut off.
...
To calculate the observed ratio η_B \approx 6 \times 10⁻^1^0, DVFT requires:
\textbullet{} Explicit CP-odd terms in the θ-Lagrangian
\textbullet{} Vacuum stiffness parameters A, B, κ, λ
\textbullet{} Dynamics of domain-wall collapse rates
\textbullet{} Evolution of the dynamic vacuum field scale
...
\textbullet{} Sphaleron transitions are too weak
\textbullet{} CKM CP violation is too small
\textbullet{} No natural out-of-equilibrium period exists
Leptogenesis works only by adding massive particles whose masses and couplings remain unmeasured.
DVFT differs sharply:
\textbullet{} All Sakharov conditions emerge from Φ = ρ e^{iθ}.
\textbullet{} Baryon number is topological, not accidental.
\textbullet{} CP violation arises from dynamics, not arbitrary phases.
\textbullet{} Non-equilibrium is inherent to early dynamic vacuum field.
\textbullet{} No new fields or heavy particles are needed.
...
\textbullet{} baryon number as topological phase winding
\textbullet{} CP violation from intrinsic vacuum phase bias
\textbullet{} non-equilibrium from early dynamic vacuum field dynamics
\textbullet{} net baryon asymmetry from biased topological relaxation
International Journal for Multidisciplinary Research (IJFMR)
E-ISSN: 2582-2160 \textbullet{} Website: www.ijfmr.com \textbullet{} Email: editor@ijfmr.com
