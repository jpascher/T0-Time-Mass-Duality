...
DVFT connects neutrino masses to T0-Vakuum stiffness parameters (A?, ?, ?). The mass scale is:
...
\end{enumerate}
DVFT predicts perturbed Koide-like mass relations due to small deviations ?_i in $\theta$:
$\theta$_{?_i} = $\theta$? + 2?i/3 + ?_i.
