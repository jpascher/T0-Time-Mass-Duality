...
\begin{itemize}
  \item If MAST-QG observes superposition at 10?--10?? amu $\rightarrow$ DVFT is falsified.
  \item If collapse occurs in this window $\rightarrow$ DVFT is strongly supported.
\end{itemize}
Conclusion
