...
\textbullet{} Fundamental phase gradient for one charge: |∂θ/∂x|_e ≈ 1.63 × 10¹³ m⁻¹
\textbullet{} Coherence length: L_coh ≈ √(ħ/B) → enormous (cosmic-scale)
\textbullet{} Deep-field acceleration: a_0 ≈ 10⁻¹⁰ m/s²
\textbullet{} Speed of light: c = √(K_0/ρ_0)
