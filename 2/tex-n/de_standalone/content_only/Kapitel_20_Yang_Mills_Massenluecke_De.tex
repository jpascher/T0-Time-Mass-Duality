CHAPTER 21: RON FOLMAN'S T^3 QUANTUM GRAVITY EXPERIMENT
1. Introduction
...
Φ = ρ e^{iθ}
where:
\textbullet{} ρ(x) is the vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0) (stiffness)
\textbullet{} θ(x) is the vacuum phase (curvature potential)
...
Δz(t) \propto t^2 \rightarrow ż(t) \propto t.
Thus:
Δφ = (m/ħ) \int g ż(t) dt \propto \int g t dt \propto g T^2.
But the displacement itself was already \propto t^2, so the *full phase* becomes:
Δφ \propto g \int t^2 dt = (g/3) T^3.
