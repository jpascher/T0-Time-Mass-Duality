\begin{enumerate}
  \item Introduction
\end{enumerate}
In Dynamic T0-Vakuum field--Curvature Theory (FFGFT), physical space exi\footnote{Siehe auch T0-Dokument: \texttt{009_T0_xi_ursprung_De.pdf}}sts only where the T0-Vakuum
...
\begin{enumerate}
  \item Fundamental FFGFT Amplitude Equation
\end{enumerate}
The FFGFT T0-Vakuum field is:
...
in ? propagate with finite characteristic speed. This is the fundamental reason FFGFT forbids infinite
...
\begin{enumerate}
  \item FFGFT uses a local field equation; local PDEs forbid instantaneous global change.
...
\begin{enumerate}
  \item FFGFT Prediction and Observational Fit
\end{enumerate}
FFGFT predicts:
\begin{itemize}
...
This makes FFGFT testable against horizon scale, CMB\footnote{Siehe auch T0-Dokument: \texttt{030_T0_CMB-Anomalie_De.pdf}} structure, and early-universe expansion histories.
Conclusion
\begin{itemize}
