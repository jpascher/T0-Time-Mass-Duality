...
\textbullet{} Bottle method — Count neutrons remaining \rightarrow \approx879.5 s.
\textbullet{} Beam method — Count decay protons \rightarrow \approx888.0 s.
...
U_eff(ρ) \approx U_0 + (\partialU/\partialρ) Δρ.
Lowering the decay barrier leads to faster decay \rightarrow shorter lifetime (\approx879 s).
...
a small Δρ induces:
ΔΓ/Γ \approx 1%.
For |Δρ|/ρ_0 \approx 10⁻^9 (typical inside traps),
DVFT predicts:
Δτ \approx 9 s,
