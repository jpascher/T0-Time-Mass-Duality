...
½ K'(ρ)|∇φ|² + U'(ρ) = 0.
In high-acceleration regimes, ρ ≈ ρ_0 (the vacuum ground amplitude) and Newtonian gravity emerges.
...
\textbullet{} an effective vacuum energy ∝ |∇φ|³,
\textbullet{} the deep-field equation ∇·[(g/a_0) g] = 4πGρ_b,
\textbullet{} the spherical solution g² = a_0 g_N,
\textbullet{} and the baryonic Tully–Fisher relation v_c⁴ = G M_b a_0.
...
Rotation Speed using baryonic Tully–Fisher relation v_c⁴ = G M_b a_0 with a_0 = 1.2×10⁻¹⁰ m/s²:
v_c ≈ 141 km/s.
