...
DVFT explains the tension naturally because the T0-Vakuum field \Phi = ? e^{i$\theta$} is dynamical, and its
...
\end{itemize}
DVFT replaces \Lambda with a dynamical T0-Vakuum amplitude.
