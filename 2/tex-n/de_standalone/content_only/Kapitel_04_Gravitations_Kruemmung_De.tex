...
T^{(θ,DVFT)}_{μν} = 2α_1 ∂I_1/∂g^{μν} + 2α_2 ∂I_2/∂g^{μν} − g_{μν}(α_1 I_1 + α_2 I_2).
...
\textbullet{} X is large → 𝓛_X ≈ constant.
\textbullet{} DVFT invariants I_1, I_2 are suppressed.
\textbullet{} T^{(θ)}_{μν} ≈ −Λ_eff g_{μν}.
