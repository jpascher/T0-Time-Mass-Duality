...
g = -\nablaρ.
Singularities require ρ \rightarrow \infty or \nablaρ \rightarrow \infty. DVFT forbids both because the vacuum has finite stiffness and
...
U(ρ) \rightarrow \infty as |ρ - ρ_0| \rightarrow \infty.
Therefore:
\textbullet{} ρ cannot diverge,
\textbullet{} \nablaρ cannot diverge,
...
δρ(x) = G m \int d^3x' |ψ(x')|^2 / |x - x'|.
This deformation is always finite because:
\textbullet{} |ψ(x)|^2 is normalizable,
...
ρ(x,t) = ρ_0 + G m_e \int d^3x' |ψ(x',t)|^2 / |x - x'|.
...
\textbullet{} no r \rightarrow 0 divergence occurs.
...
3. Quantum particles generate finite vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0) deformations from |ψ|^2.
4. Gravity emerges as \nablaρ, which can never diverge.
