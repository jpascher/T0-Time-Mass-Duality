...
\textbullet{} extremely responsive to \nablaθ and local changes in ρ.
...
ρ(x) = ρ_0 + Δρ,
where |Δρ/ρ_0| \approx 10⁻^6 near dense nuclear activity.
...
For Δρ/ρ_0 \approx 10⁻^6 and γ \approx 10^3–10^4:
ΔP \approx 5–7%.
...
α(ρ_0 + Δρ) \approx α(ρ_0) + (\partialα/\partialρ) Δρ.
