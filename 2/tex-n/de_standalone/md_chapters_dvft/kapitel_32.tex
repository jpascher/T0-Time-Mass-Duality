...
\rho(x) = \rho_0 + Δ\rho,
where |Δ\rho/\rho_0| \approx 10⁻⁶ near dense nuclear activity.
Such amplitude fluctuations modify the neutrino phase propagation equation:
\partial^2_t\theta - v^2_\theta \nabla^2\theta + \alpha(\rho)\theta = 0,
...
For Δ\rho/\rho_0 \approx 10⁻⁶ and \gamma \approx 10^3–10⁴:
ΔP \approx 5–7\%.
...
\alpha(\rho_0 + Δ\rho) \approx \alpha(\rho_0) + (\partial\alpha/\partial\rho) Δ\rho.
