...
ds\textsuperscript{2} = -dt\textsuperscript{2} + a(t)\textsuperscript{2} [ dr\textsuperscript{2}/(1-kr\textsuperscript{2}) + r\textsuperscript{2} d\Omega\textsuperscript{2} ]
In DVFT, the Friedmann equations become:
(da/dt)\textsuperscript{2} / a\textsuperscript{2} = (8\piG/3) \varepsilon_vac
d\textsuperscript{2}a/dt\textsuperscript{2} / a = -(4\piG/3)(\varepsilon_vac + 3p_vac)
...
$\bullet$ \rho(t)  $\approx$  0
$\bullet$ \theta(t) undefined or fluctuating
...
encourages a phase transition toward the minimum at \rho = \rho$_0$.
...
the stable dynamic vacuum field state \rho = \rho$_0$. This transition releases energy, sets \theta(t) into coherent
...
DVFT inflation ends naturally when \rho(t) settles near \rho$_0$ and \theta(t) becomes coherent.
...
$\bullet$ |d\theta/dt|  $\leq$  \theta_max
$\bullet$ \rho(t) finite
$\bullet$ V(\rho) finite
$\bullet$ \varepsilon_vac finite
...
temperature.
In DVFT:
$\bullet$ Before the Big Bang, the vacuum was nearly homogeneous
$\bullet$ The vacuum phase transition occurred everywhere simultaneously
$\bullet$ Vacuum-phase waves propagate at c, enforcing coherence
...
\rho reached the critical threshold, the vacuum rolled down its potential to \rho$_0$, initiating dynamic vacuum
...
$\bullet$ Not matter.
$\bullet$ Not energy.
$\bullet$ Not space as pure geometry.
What expanded was:
$\bullet$ the vacuum amplitude \rho(t).
...
$\bullet$ Pre-Big-Bang: \rho  $\approx$  0, incoherent vacuum
$\bullet$ Phase transition: \rho grows, \theta becomes coherent
$\bullet$ Inflation: V(\rho) nearly constant
$\bullet$ Reheating: \Phi couples to matter
$\bullet$ Radiation era
$\bullet$ Matter era
$\bullet$ Dark energy era: residual dynamic vacuum field
Conclusion
