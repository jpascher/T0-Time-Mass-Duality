...
L = \theta (g_s\textsuperscript{2} / 32\pi\textsuperscript{2}) G_{\muν} ṠG^{\muν}
Experimentally, neutron EDM measurements require:
\theta < 10⁻¹\textsuperscript{0}
...
DVFT enforces:
$\bullet$ Continuous global \theta(x,t)
$\bullet$ No multi-sector vacuum structure
$\bullet$ No misalignment between QCD and vacuum phases
...
Standard Model: Offers no explanation; \theta must be tuned < 10⁻¹\textsuperscript{0}.
...
$\bullet$ No axions.
$\bullet$ No fine-tuning.
$\bullet$ No new symmetries.
$\bullet$ Complete alignment with experiment.
$\bullet$ Directly derived from the single vacuum phase field.
