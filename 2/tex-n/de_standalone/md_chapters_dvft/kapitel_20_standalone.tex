...
L_\theta = B \rho² (\partial_\mu \theta)(\partial^\mu \theta)
This term is \textit{absent} in the pure Yang–Mills Lagrangian, and it produces nonzero excitation energy even
for small fluctuations. This directly creates the mass gap.
4. Origin of the Mass Gap
Small phase perturbations have energy:
E ∼ B \rho₀² (\partial\theta)²
The minimal nonzero excitation corresponds to the smallest allowed variation of \theta, producing the massgap formula:
m_gap² ∼ B \rho₀²
Since B and \rho₀ are nonzero and finite, the mass gap is guaranteed.
This provides:
...
This matches:
• glueball masses,
• QCD confinement scale \Lambda_QCD,
...
DVFT gives:
• a finite vacuum energy from \rho₀ and K₀,
• a nonzero minimal excitation from B \rho₀²,
