...
𝓛 = ½ A |\partialₜ\Phi|^2 − ½ B(\rho) |\nabla\Phi|^2 − U(\rho) − \rho_b \varphi(\rho,\theta),
where:
...
\partialₜ\theta = \omega_0(1 + \varphi/c^2) ⇒ \nabla\theta = (\omega_0/c^2) \nabla\varphi.
...
𝓛_eff = − (a_0^2/8\piG) F(|\nabla\varphi|^2/a_0^2) − \rho_b \varphi,
with:
F(y) = (2/3) y^{3/2}.
...
• and the baryonic Tully–Fisher relation v_c⁴ = G M_b a_0.
...
Rotation Speed using baryonic Tully–Fisher relation v_c⁴ = G M_b a_0 with a_0 = 1.2\times10⁻¹⁰ m/s^2:
v_c \approx 141 km/s.
