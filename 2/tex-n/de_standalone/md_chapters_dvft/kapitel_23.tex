...
• Bottle method — Count neutrons remaining \rightarrow \approx879.5 s.
• Beam method — Count decay protons \rightarrow \approx888.0 s.
...
In DVFT, neutron decay rate depends on local vacuum amplitude \rho and stiffness K_0.
...
U_eff(\rho) \approx U_0 + (\partialU/\partial\rho) Δ\rho.
...
• vacuum amplitude remains at \rho_0,
...
ΔΓ/Γ \approx 1\%.
For |Δ\rho|/\rho_0 \approx 10⁻⁹ (typical inside traps),
DVFT predicts:
Δ\tau \approx 9 s,
