...
• \theta(x,t) = vacuum phase (coherent, quantized excitations \rightarrow photons).
...
• Low intensity, high frequency \rightarrow immediate emission.
• High intensity, low frequency \rightarrow no emission.
...
\delta\theta \rightarrow \delta\rho_e \rightarrow defect escape.
