...
1. Introduction
This document presents a strict DVFT-based derivation of dark energy, with no reference to external darkenergy models. The goal is to show how cosmic acceleration arises solely from the vacuum amplitude ρ
...
This is the DVFT dark-energy equation: the cosmic vacuum amplitude ρ evolves in its potential U(ρ)
...
• a stable minimum at ρ₀ (preferred vacuum amplitude),
...
1. The vacuum amplitude ρ has a preferred value ρ₀ (microphysical equilibrium).
