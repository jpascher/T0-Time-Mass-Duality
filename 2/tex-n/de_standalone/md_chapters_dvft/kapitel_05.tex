...
T\mu\nu(\Phi) = \partial\mu\Phi\textit{ \partial\nu\Phi + \partial\mu\Phi \partial\nu\Phi} − g\mu\nu(…)
Phase gradients δ\theta propagate at light speed, modifying T\mu\nu(\Phi). Einstein's GR equation then becomes:
G\mu\nu = 8\piG ( T\mu\nu (m) + T\mu\nu(\Phi))
...
saturation in its potential V(|\Phi|²). As a collapsing object approaches the classical singularity, the vacuum
...
dark energy to residual dynamic vacuum field energy, \epsilon_vac = \rho₀²\thetȧ² + V(\rho₀), providing a natural physical
