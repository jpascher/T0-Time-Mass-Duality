...
• Neutrino Mass Scale:
m_ν ∝ B (\partial\theta/\partialx)^2 evaluated at long coherence scales, yielding naturally small masses: 0.01–0.05 eV.
...
• Coherence length:
L_coh \approx \sqrt(ħ/B) \rightarrow enormous (cosmic-scale)
