...
DVFT satisfies all three using the single vacuum field Φ = \rho e^{i\theta}, without introducing extra fields, new
...
• baryons → positive winding number of \theta
• antibaryons → negative winding number of \theta
...
5. Freezing: once \rho stabilizes near \rho₀, baryon-number-changing processes shut off.
...
To calculate the observed ratio \eta_B \approx 6 \times 10⁻¹⁰, DVFT requires:
• Explicit CP-odd terms in the \theta-Lagrangian
• Vacuum stiffness parameters A, B, \kappa, \lambda
...
\eta_B ∼ (\DeltaE_CP / T_dynamic vacuum field).
...
• All Sakharov conditions emerge from Φ = \rho e^{i\theta}.
