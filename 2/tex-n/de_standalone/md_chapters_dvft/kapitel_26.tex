...
\eta_B  $\approx$  6  $\times$  10⁻¹\textsuperscript{0}.
...
$\bullet$ baryons → positive winding number of \theta
$\bullet$ antibaryons → negative winding number of \theta
...
$\bullet$ natural baryon-number violation
$\bullet$ no need for sphalerons or beyond-Standard-Model operators
...
$\bullet$ different energy costs for +B and −B topological domains
$\bullet$ asymmetric decay of baryon vs antibaryon-like structures
$\bullet$ a preferred direction for phase unwinding
...
adiabatic.
During this epoch:
$\bullet$ \rho varies rapidly
$\bullet$ \theta develops domains and defects
$\bullet$ particle masses change dynamically
$\bullet$ vacuum stiffness evolves in time
...
5. Freezing: once \rho stabilizes near \rho$_0$, baryon-number-changing processes shut off.
...
To calculate the observed ratio \eta_B  $\approx$  6  $\times$  10⁻¹\textsuperscript{0}, DVFT requires:
$\bullet$ Explicit CP-odd terms in the \theta-Lagrangian
$\bullet$ Vacuum stiffness parameters A, B, κ, \lambda
$\bullet$ Dynamics of domain-wall collapse rates
$\bullet$ Evolution of the dynamic vacuum field scale
The baryon asymmetry emerges from the imbalance in domain decay:
\eta_B ∼ (ΔE_CP / T_dynamic vacuum field).
DVFT uniquely provides a physical meaning to ΔE_CP as the energy bias between opposite-winding
phase domains. This makes \eta_B calculable once the vacuum potential is fully specified.
8. Distinction Between DVFT and Standard Approaches
Standard Model baryogenesis fails because:
$\bullet$ Sphaleron transitions are too weak
$\bullet$ CKM CP violation is too small
$\bullet$ No natural out-of-equilibrium period exists
Leptogenesis works only by adding massive particles whose masses and couplings remain unmeasured.
DVFT differs sharply:
$\bullet$ All Sakharov conditions emerge from \Phi = \rho e^{i\theta}.
$\bullet$ Baryon number is topological, not accidental.
$\bullet$ CP violation arises from dynamics, not arbitrary phases.
$\bullet$ Non-equilibrium is inherent to early dynamic vacuum field.
$\bullet$ No new fields or heavy particles are needed.
...
3. A specific scale for CP-odd vacuum terms, constrained by \eta_B.
...
$\bullet$ baryon number as topological phase winding
$\bullet$ CP violation from intrinsic vacuum phase bias
$\bullet$ non-equilibrium from early dynamic vacuum field dynamics
$\bullet$ net baryon asymmetry from biased topological relaxation
International Journal for Multidisciplinary Research (IJFMR)
E-ISSN: 2582-2160 $\bullet$ Website: www.ijfmr.com $\bullet$ Email: editor@ijfmr.com
