...
• decoherence,
• entropy.
With ρ = 0, vacuum stiffness (K₀) and vacuum inertial density (ρ₀) are also zero:
K₀ = Bρ² → 0,
ρ₀ = Aρ² → 0.
This means:
...
• inertia (ρ₀ = Aρ²),
• stiffness (K₀ = Bρ²),
• a well-defined wave speed c = √(K₀/ρ₀).
...
• regions with larger ρ acquired larger inertial density,
• gradients in ρ generated curvature,
