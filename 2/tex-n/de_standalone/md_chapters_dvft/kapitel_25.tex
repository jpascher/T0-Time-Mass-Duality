...
\theta_{ν_e} = \theta_0
\theta_{ν_\mu} = \theta_0 + 2\pi/3
\theta_{ν_\tau} = \theta_0 + 4\pi/3.
Thus:
• three leptons,
• three neutrinos,
...
\theta_{ν_i} = \theta_0 + 2\pii/3 + \delta_i,
DVFT produces:
• nearly degenerate masses,
• small differences Δm^2,
...
U_{ij} ∝ \langle \theta_i | \theta_j \rangle.
Because neutrinos are phase-only modes, their coupling angles are large, producing:
• large \theta_1_2 (solar angle),
• large \theta_2_3 (atmospheric angle),
• nonzero \theta_1_3 (reactor angle).
...
In DVFT:
• charged leptons have amplitude-phase excitations \rightarrow Dirac-like,
• neutrinos have pure phase oscillations \rightarrow naturally Majorana-like.
