...
U(\rho) = κ(\rho − \rho_0)^2 + \lambda(\rho − \rho_0)⁴ + …
...
DVFT \rightarrow m_i ∝ (1 − cos\theta_i)
Three equally spaced phase eigenmodes \rightarrow \theta_i = \theta_0 + 2\pii/3
This produces: (\sqrtm_e, \sqrtm_\mu, \sqrtm_\tau) lying at 120° in mass space.
