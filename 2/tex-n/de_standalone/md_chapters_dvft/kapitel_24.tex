...
\theta_e = \theta₀,
\theta_\mu = \theta₀ + 2\pi/3,
\theta_\tau = \theta₀ + 4\pi/3.
International Journal for Multidisciplinary Research (IJFMR)
E-ISSN: 2582-2160 ● Website: www.ijfmr.com ● Email: editor@ijfmr.com
IJFMR250664112 Volume 7, Issue 6, November-December 2025 55
Then:
m_e = K(1 − cos\theta₀)
m_\mu = K(1 − cos(\theta₀ + 2\pi/3))
m_\tau = K(1 − cos(\theta₀ + 4\pi/3)).
...
Three equally spaced phase eigenmodes → \theta_i = \theta₀ + 2\pii/3
...
• amplitude–phase coupling in Φ = \rho e^{i\theta},
