...
Δ\theta = \theta$_1$ − \theta$_2$ = constant
...
$\bullet$ \theta$_1$ → \theta$_1$ + \delta\theta$_1$
$\bullet$ \theta$_2$ → \theta$_2$ + \delta\theta$_2$
$\bullet$ \delta\theta$_1$  $\neq$  \delta\theta$_2$
...
$\bullet$ The vacuum field \Phi spans the entire apparatus.
$\bullet$ Phase coherence or decoherence is global, not local.
$\bullet$ The final coincidence sorting groups events by their vacuum-phase relationships.
...
\Phi → (\Phi$_1$ e^{i\delta\theta$_1$}) + (\Phi$_2$ e^{i\delta\theta$_2$})
Δ\theta = \theta$_1$ − \theta$_2$ + (\delta\theta$_1$ − \delta\theta$_2$) → undefined
Eraser restores coherence:
\delta\theta$_1$ = \delta\theta$_2$ ⇒ Δ\theta = constant
International Journal for Multidisciplinary Research (IJFMR)
E-ISSN: 2582-2160 $\bullet$ Website: www.ijfmr.com $\bullet$ Email: editor@ijfmr.com
...
In DVFT:
$\bullet$ A photon is a localized excitation riding on the vacuum field.
$\bullet$ Its trajectory is not determined by classical paths but by vacuum-phase geometry.
$\bullet$ Which-path detection modifies the vacuum phase, not the photon itself.
$\bullet$ Erasure restores the phase structure, enabling interference to reappear.
...
$\bullet$ Vacuum-phase coherence
$\bullet$ Vacuum-phase decoherence
$\bullet$ Entanglement-induced phase tagging
$\bullet$ Erasure-induced re-coherence
