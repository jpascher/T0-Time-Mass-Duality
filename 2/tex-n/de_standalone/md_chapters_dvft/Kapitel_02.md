...
• θ(x): Phase, related to timing and coherence.
...
θ(t) = μ t
where μ arises from the curvature of V at the minimum (μ² ≈ λ ρ₀², analogous to the Higgs mass). This
...
• Matter-induced convergence of θ.
• Compression of θ gradients.
...
Φ = ρ₀ e^{iμt}
The moment when ρ rose from 0 to ρ₀ and θ gained coherence is the Big Bang. No external trigger was
