...
factor:
Ψ \rightarrow e^{i\alpha} Ψ.
Repeating the exchange twice corresponds to a 2\pi rotation of the configuration, which must return to the
same state:
(e^{i\alpha})^2 = 1 \rightarrow e^{i\alpha} = \pm1.
Thus DVFT allows two topological classes:
• e^{i\alpha} = +1 \rightarrow symmetric state \rightarrow bosons
• e^{i\alpha} = –1 \rightarrow antisymmetric state \rightarrow fermions
...
• Only \alpha = 0 or \pi are allowed \rightarrow bosons or fermions.
2. Fermionic antisymmetry:
\alpha = \pi \rightarrow Ψ is antisymmetric \rightarrow Ψ(x,x) = 0 \rightarrow exclusion.
