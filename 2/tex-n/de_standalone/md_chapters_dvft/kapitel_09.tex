...
X = -g^{\muν} $\partial$\mu\theta $\partial$ν\theta.
...
dominates.
2. Strong Field Regime (X >> a$_0$\textsuperscript{2})
...
L_\theta = (\rho$_0$/2) X - (\eta/(3 a$_0$\textsuperscript{2})) X^{3/2} - Λ_v,
...
3. Weak Field Regime (X ~ a$_0$\textsuperscript{2})
As accelerations approach a$_0$, nonlinear vacuum effects begin to contribute. Here X is comparable to a$_0$\textsuperscript{2}
and the X^{3/2} correction in the Lagrangian becomes relevant. The response function
L_X = \rho$_0$/2 - (\eta/(2 a$_0$\textsuperscript{2})) X^{1/2}
departs from a constant and begins to depend on the local phase gradient. Observable consequences
include:
$\bullet$ small deviations from Newtonian potential in extended systems,
$\bullet$ mild corrections to post-Newtonian parameters,
$\bullet$ subtle modifications to gravitational lensing and Shapiro delay.
...
4. Deep Field Regime (X << a$_0$\textsuperscript{2}, Galactic Scale)
...
where φ is the gravitational potential related to \theta through the background dynamic vacuum field. The
...
g\textsuperscript{2}(r) = a$_0$ g_N(r),
...
$\bullet$ the baryonic Tully--Fisher relation v_c⁴ = G M_b a$_0$,
$\bullet$ no requirement for dark matter halos.
Thus the deep field regime is responsible for MOND-like behavior emerging naturally from DVFT
vacuum microphysics.
5. Ultra-Deep Cosmological Regime (g << a$_0$, Dark Energy Scale)
On scales comparable to or larger than the Hubble radius, typical gravitational accelerations become far
smaller than a$_0$. In this ultra-deep regime, phase gradients are extremely small and the kinetic contributions
...
\varepsilon_vac  $\approx$  \rho_$\infty$\textsuperscript{2} \mu\textsuperscript{2} + V(\rho_$\infty$),
p_vac  $\approx$  \rho_$\infty$\textsuperscript{2} \mu\textsuperscript{2} - V(\rho_$\infty$),
International Journal for Multidisciplinary Research (IJFMR)
E-ISSN: 2582-2160 $\bullet$ Website: www.ijfmr.com $\bullet$ Email: editor@ijfmr.com
...
$\bullet$ X → 0,
$\bullet$ L_X → \rho$_0$/2,
$\bullet$ the stress--energy tensor of \theta reduces to an effective cosmological constant term,
$\bullet$ the Friedmann equations predict accelerated expansion.
Thus, dark energy is not an independent fluid but the asymptotic vacuum state of \Phi when typical
gravitational gradients fall far below a$_0$ on cosmological scales.
...
theories; they are different limits of the same underlying dynamics controlled by X and the parameters (\rho$_0$,
\eta, a$_0$, Λ_v). As a characteristic acceleration in a system changes, the vacuum smoothly interpolates
between:
$\bullet$ GR-like behavior in compact objects and Solar System tests,
$\bullet$ modified dynamics in galaxies (deep field),
$\bullet$ effective dark energy at horizon-scale averages (ultra-deep field).
...
$\bullet$ galactic rotation curves,
$\bullet$ cluster dynamics,
$\bullet$ cosmic acceleration,
$\bullet$ the absence of singularities,
$\bullet$ with a single set of vacuum parameters. Structure formation proceeds in a background where:
$\bullet$ early universe: kinetic and potential terms of \Phi drive inflation-like expansion,
$\bullet$ intermediate epochs: matter dominates and deep-field corrections shape halo dynamics,
$\bullet$ late universe: ultra-deep regime emerges, and dark-energy-like behavior dominates.
...
$\bullet$ Strong field: GR limit, X >> a$_0$\textsuperscript{2}, linear response, compact objects.
$\bullet$ Weak field: transitional, X ~ a$_0$\textsuperscript{2}, small nonlinear corrections.
$\bullet$ Deep field: galactic scale, X << a$_0$\textsuperscript{2} but gradients still relevant, g\textsuperscript{2} = a$_0$ g_N, no dark matter.
International Journal for Multidisciplinary Research (IJFMR)
E-ISSN: 2582-2160 $\bullet$ Website: www.ijfmr.com $\bullet$ Email: editor@ijfmr.com
IJFMR250664112 Volume 7, Issue 6, November-December 2025 24
$\bullet$ Ultra-deep cosmological field: g << a$_0$ on horizon scales, residual vacuum energy acts as dark energy (w
 $\approx$  -1).
