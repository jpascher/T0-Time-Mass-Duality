...
g = −\nabla\rho.
Singularities require \rho \rightarrow \infty or \nabla\rho \rightarrow \infty. DVFT forbids both because the vacuum has finite stiffness and
...
where:
• \rho_0 is the equilibrium vacuum amplitude,
...
U(\rho) \rightarrow \infty as |\rho − \rho_0| \rightarrow \infty.
Therefore:
• \rho cannot diverge,
...
\delta\rho(x) = G m \int d^3x' |ψ(x')|^2 / |x − x'|.
...
\rho(x,t) = \rho_0 + G m_e \int d^3x' |ψ(x',t)|^2 / |x − x'|.
...
• no r \rightarrow 0 divergence occurs.
...
6. No infinite self-energy, no point divergences, no r \rightarrow 0 explosion exists.
