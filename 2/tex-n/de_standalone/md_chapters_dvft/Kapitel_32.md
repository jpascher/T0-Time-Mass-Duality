...
• extremely responsive to ∇θ and local changes in ρ.
...
identifies the correct environmental variable: Δρ—the modification of vacuum amplitude due to nuclear
processes.
7. DVFT Predictions for Experimental Verification
If DVFT is correct, then:
• The deficit should increase with reactor power.
• Different isotopic mixtures (U-235 vs Pu-239) should produce different Δρ and thus different
deficits.
• Temperature variations in the reactor core should subtly alter the ν̄ₑ flux.
...
Modifying the vacuum amplitude by Δρ induces:
α(ρ₀ + Δρ) ≈ α(ρ₀) + (∂α/∂ρ) Δρ.
