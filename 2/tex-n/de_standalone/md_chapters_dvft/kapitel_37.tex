...
gives: |\partial\theta/\partialx| \approx 1.63 \times 10¹³ m⁻¹.
...
m_\nu ∝ B (\partial\theta/\partialx)² evaluated at long coherence scales,
...
• Fundamental phase gradient for one charge: |\partial\theta/\partialx|_e \approx 1.63 \times 10¹³ m⁻¹
• Coherence length: L_coh \approx \sqrt(ħ/B) → enormous (cosmic-scale)
• Deep-field acceleration: a₀ \approx 10⁻¹⁰ m/s²
• Speed of light: c = \sqrt(K₀/\rho₀)
