...
where 𝐹𝑋 = $\partial$𝐹/ $\partial$𝑋. Curvature arises because T𝜇𝜈
(\Phi)
...
2𝐹𝑋$\nabla$
𝜇𝜃) = 0.
Step-by-step: From ℒ\Phi, $\partial$ℒ/ $\partial$($\partial$𝜇𝜃) = −\rho
2𝐹𝑋$\nabla$
