...
$\bullet$ The vacuum is a structured medium with stiffness K$_0$ and inertial density \rho$_0$.
$\bullet$ The fundamental dynamic vacuum field equation defines the propagation of all phase excitations.
$\bullet$ Physical laws must retain their form in every inertial frame.
...
\rho$_0$ $\partial$\textsuperscript{2}_t \theta - K$_0$ $\partial$\textsuperscript{2}_x \theta = 0.
Define the natural propagation speed of vacuum phase waves:
c = $\sqrt$(K$_0$ / \rho$_0$).
This yields the canonical form:
(1/c\textsuperscript{2}) $\partial$\textsuperscript{2}_t \theta - $\partial$\textsuperscript{2}_x \theta = 0.
...
$\bullet$ AD - BC = 1 (preserves phase structure),
$\bullet$ A = D = \gamma,
$\bullet$ B = -\gamma v,
$\bullet$ C = -\gamma v / c\textsuperscript{2},
where the Lorentz factor emerges naturally:
\gamma = 1 / $\sqrt$(1 - v\textsuperscript{2}/c\textsuperscript{2}).
This yields the Lorentz transformation:
x' = \gamma (x - vt),
t' = \gamma (t - vx/c\textsuperscript{2}).
...
c\textsuperscript{2} dt\textsuperscript{2} - dx\textsuperscript{2} = c\textsuperscript{2} d\tau\textsuperscript{2},
proper time is naturally defined as:
d\tau\textsuperscript{2} = dt\textsuperscript{2} - dx\textsuperscript{2}/c\textsuperscript{2}.
...
\rho_χ $\partial$\textsuperscript{2}_t χ - K_χ $\partial$\textsuperscript{2}_x χ + \mu\textsuperscript{2} χ = 0,
leading to the dispersion relation:
\omega\textsuperscript{2} = c\textsuperscript{2} k\textsuperscript{2} + \omega$_0$\textsuperscript{2},
where \omega$_0$ = m$_0$ c\textsuperscript{2} / ħ.
Defining energy E = ħ\omega and momentum p = ħk gives:
E\textsuperscript{2} = p\textsuperscript{2} c\textsuperscript{2} + m$_0$\textsuperscript{2} c⁴.
This produces:
E = \gamma m$_0$ c\textsuperscript{2},
p = \gamma m$_0$ v.
...
$\bullet$ Lorentz transformations,
$\bullet$ Time dilation,
$\bullet$ Length contraction,
$\bullet$ Relativistic mass increase,
$\bullet$ The energy--momentum relation.
