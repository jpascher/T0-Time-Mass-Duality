...
(□ + m^2)ψ = 0
Now write ψ = e^{-imt/ħ} \varphi. Taking the non-relativistic limit yields the Schrödinger equation:
iħ \partial\varphi/\partialt = -ħ^2/(2m) \nabla^2\varphi + V_eff \varphi
In DVFT, the background vacuum phase modifies the effective time experienced by matter:
t \rightarrow t + \beta \theta(x)
...
• When the vacuum phase \theta is coherent \rightarrow ψ interferes.
• Measurement interactions scramble \theta locally \rightarrow ψ collapses.
