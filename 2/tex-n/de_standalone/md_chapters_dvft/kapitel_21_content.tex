...
Δ\varphi = (m/ħ) \int [\nabla\theta · (ẋ_1 - ẋ_2)] dt.
Let \nabla\theta = g ẑ (constant). Then:
Δ\varphi = (mg/ħ) \int (ż_1 - ż_2) dt.
...
Δz(t) ∝ t^2 \rightarrow ż(t) ∝ t.
Thus:
Δ\varphi = (m/ħ) \int g ż(t) dt ∝ \int g t dt ∝ g T^2.
But the displacement itself was already ∝ t^2, so the *full phase* becomes:
Δ\varphi ∝ g \int t^2 dt = (g/3) T^3.
