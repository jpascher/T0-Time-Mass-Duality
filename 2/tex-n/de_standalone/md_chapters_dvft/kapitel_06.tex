...
𝓛_free = (\rho_0/2)[ (1/c^2)(\partial_t\varphi)^2 − (\nabla\varphi)^2 ] − (1/2) m_\theta^2 \varphi^2.
By defining a canonically normalized field:
\varphi_c = \sqrt\rho_0 \varphi,
the free field Lagrangian becomes:
𝓛_free = (1/2)[ (1/c^2)(\partial_t\varphi_c)^2 − (\nabla\varphi_c)^2 ] − (1/2) m_\theta^2 \varphi_c^2.
...
(1/c^2) \partial_t^2 \varphi_c − \nabla^2 \varphi_c + m_\theta^2 \varphi_c = 0.
...
𝓗 = (1/2c^2)(\partial_t\varphi_c)^2 + (1/2)(\nabla\varphi_c)^2 + (1/2) m_\theta^2 \varphi_c^2,
