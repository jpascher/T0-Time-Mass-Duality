...
𝜌(𝑥) is vacuum amplitude and \theta(x) is vacuum phase. The vacuum possesses an intrinsic field with its
...
𝑖𝜃(𝑥)
, where 𝜌(𝑥) represents the vacuum amplitude (inertial density) and \theta(x)
