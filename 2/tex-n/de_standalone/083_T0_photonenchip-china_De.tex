...
% Standardized preamble - 083_T0_photonenchip-china_De.pdf
\input{T0_preamble_standalone_De}

\title{\textbf{T0-Theorie: Chinas Photonischer Quantenchip – 1000x-Speedup für AI}\\
...
\begin{document}
	...
	\begin{abstract}
		...
		(Download relevanter T0-Dokumente: Geometrischer Qubit-Formalismus, ξ-Aware Quantization, Koide-Formel für Massen.)
	\end{abstract}
	...
	\begin{thebibliography}{9}
		...
		\bibitem{t0qm} J. Pascher, ''Geometrischer Formalismus der T0-Quantenmechanik,'' T0-Repo v1.0 (2025). Download.
		\bibitem{t0qat} J. Pascher, ''T0-QAT: $\xi$-Aware Quantization,'' T0-Repo v1.0 (2025). Download.
		\bibitem{koide} J. Pascher, ''Koide-Formel in T0,'' T0-Repo v1.0 (2025). Download.
