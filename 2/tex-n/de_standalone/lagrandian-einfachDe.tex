...
\fancyhead[R]{Vereinfachte Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}
\fancyfoot[C]{\thepage}
...
\hypersetup{
	...
	citecolor=blue,
	urlcolor=blue,
	pdftitle={Vereinfachte Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Elegante Lagrange-Dichte für Zeit-Masse-Dualität},
	pdfauthor={Johann Pascher},
	pdfsubject={Theoretische Physik},
	pdfkeywords={T0-Modell, Vereinfachte Lagrange-Funktion, Antiteilchen, Zeit-Masse-Dualität, Natürliche Einheiten}
}

\title{Vereinfachte Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): \\
...
\begin{document}
	...
	Die ursprünglichen Formulierungen der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) verwenden komplexe Lagrange-Dichten mit geometrischen Termen, Kopplungsfeldern und mehrdimensionalen Strukturen. Diese Arbeit zeigt, dass die fundamentale Physik der Zeit-Masse-Dualität durch eine dramatisch vereinfachte Lagrange-Dichte erfasst werden kann.
	...
	\begin{itemize}
		...
		\item \textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}: $\Lag = \varepsilon \cdot (\partial \deltam)^2$ als ultimative Vereinfachung
	\end{itemize}
	
	\section{Fundamentalgesetz der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}
	
	\subsection{Die zentrale Beziehung}
	
	Das einzige fundamentale Gesetz der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) ist:
	...
	In der vereinfachten Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) wird die quantenmechanische Wellenfunktion direkt mit der Massenfeldanregung identifiziert:
	...
	Da die Zeit selbst in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) dynamisch ist mit $T(x,t) = 1/m(x,t)$, erhalten wir die modifizierte Form:
	...
	\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Philosophische Erkenntnis]
		Die vereinfachte Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) zeigt, dass die tiefste Physik nicht in der Komplexität, sondern in der Einfachheit liegt:
	...
	\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Paradigmenwechsel]
		Die vereinfachte Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) stellt einen Paradigmenwechsel dar:
	...
	Die wahre Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) ist von atemberaubender Einfachheit:
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025). \textit{Von der Zeitdilatation zur Massenvariation: Mathematische Kernformulierungen der Zeit-Masse-Dualitäts-Theorie}. Ursprünglicher Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)-Rahmen.
