...
% Standardized preamble - 008_T0_xi-und-e_De.tex
...
\begin{document}
	...
	\subsection{Klarstellung: Keine numerische Anpassung}
	
	\begin{erkenntnis}
		\textbf{Fundamentale Ableitung, nicht Fitting:}
		
		Der Parameter $\xi = \frac{4}{3} \times 10^{-4}$ basiert auf fundamentalen geometrischen Prinzipien und nicht auf willkürlichen Anpassungen an experimentelle Daten. Die Übereinstimmung mit bekannten physikalischen Konstanten und experimentellen Messungen ergibt sich als eine Konsequenz der fraktalen Struktur $D_f = 3 - \xi$.
		
		Die tetraedrische Geometrie, die zur Herleitung von $\xi$ verwendet wird, ist eine intrinsische Eigenschaft der Raumzeit-Struktur. Die bemerkenswerte Präzision, mit der $\xi$-basierte Vorhersagen experimentelle Ergebnisse reproduzieren (z.B. Teilchenmassen, Feinstrukturkonstante), bestätigt die Gültigkeit dieser geometrischen Grundlage.
	\end{erkenntnis}
	...
	\begin{erkenntnis}
		\textbf{Die Einheit der physikalischen Konstanten:}
		...
		\begin{align}
			c^2 &\sim \frac{1}{\xi \cdot D_f} \label{eq:c_from_xi} \\
			h &\sim \sqrt{\xi} \label{eq:h_from_xi} \\
			G &\sim \xi^3 \label{eq:G_from_xi}
		\end{align}
	...
	\begin{beziehung}
		\textbf{Von der Geometrie zur Dynamik:}
	...
	\begin{abhandlung}
		\textbf{Jenseits der numerischen Willkür:}
