...
% Standardized preamble - 145_FFGFT_donat-teil1_De.pdf
...
\begin{document}
	...
	\]
	Dies ist eine parameterfreie Vorhersage. Die Diskrepanz zum modellabhängigen Standardwert $H_0^{\text{exp}} \approx 70\,$km/s/Mpc (Faktor $\approx 7/4$) ist eine offene Forschungsfrage.
	
	\subsubsection{Kosmologische Implikationen}
	
	- \textbf{Lösung der Hubble-Spannung}: Die Hubble-Spannung ($67$--$73\,$km/s/Mpc) spiegelt die Modellabhängigkeit der experimentellen $H_0$-Extraktion wider. In T0 gibt es einen einzigen Wert $H_0^{\text{T0}} = \xi \cdot c \approx 40\,$km/s/Mpc.
