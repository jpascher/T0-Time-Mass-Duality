...
\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{@{}p{0.30\textwidth}@{\hspace{2mm}}p{0.30\textwidth}@{}}p{4cm}ccccc}
			\toprule
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{@{}p{0.30\textwidth}@{\hspace{2mm}}p{0.30\textwidth}@{}}p{2.5cm}ccccc}
			\toprule
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{@{}p{0.30\textwidth}@{\hspace{2mm}}p{0.30\textwidth}@{}}p{5cm}p{1.5cm}p{2cm}p{2.5cm}p{2cm}p{2.5cm}}
			\toprule
...
\end{table}
	...
	\begin{table}[h]
		\centering
\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{@{}p{0.30\textwidth}@{\hspace{2mm}}p{0.30\textwidth}@{}}p{4cm}cc}
			\toprule
