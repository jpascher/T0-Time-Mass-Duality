...
\begin{document}
	...
	\begin{longtable}{>{\raggedright}p{4.0cm}p{1.2cm}p{1.8cm}p{2.0cm}p{1.6cm}p{2.0cm}}
		...
		Hubble-Länge & $l_{\text{Hubble}}$ & 2.314e+26 & 1.364e+26 & 69.7$^*$ & $\si{\meter}$ \\
	...
	{\small $^*$Kosmologische Abweichungen: $H_0^{\text{T0}} = \xi \cdot c \approx 40\,$km/s/Mpc ist eine parameterfreie Vorhersage. Der experimentelle Wert $H_0^{\text{exp}} \approx 70\,$km/s/Mpc (Faktor $\approx 7/4$) ist modellabhängig und setzt ein expandierendes Friedmann-Universum voraus. In T0 ist das Universum statisch -- Alter, kritische Dichte und Hubble-Länge sind Friedmann-Konzepte ohne direkte T0-Entsprechung.}
