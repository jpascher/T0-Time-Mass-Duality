...
\title{Kapitel 24: Ableitung der Koide-Formel\\(Angepasst an T0-Theorie)}
...
\begin{itemize}
\item \textbf{116\_T0\_koide-formel-3\_De.tex}: Fundamentale T0-Yukawa-Ableitung mit $m = r \cdot \xi^p \cdot v$, exakte Massenverhältnisse aus $\xi$-Exponenten $(r,p)$ für jedes Lepton
\item \textbf{046\_Teilchenmassen\_De.tex}: Vollständige T0-Teilchenmassen-Systematik
