...
% Standardized preamble - 061\_TempEinheitenCMB\_De.pdf
\input{T0_preamble_standalone_De}

\title{Temperatureinheiten in natürlichen Einheiten: \\
		T0-Theorie und statisches Universum \\
		($\xi$-basierte universelle Methodik)\\
		\large Einschließ{}lich vollständiger CMB-Berechnungen und kosmologischer Rotverschiebung}
\author{}
\date{}
...
\end{itemize}
	...
	% ================== VOLLSTÄNDIGER CMB-ABSCHNITT AUS 039\_Zwei-Dipole-CMB\_De.pdf ==================
