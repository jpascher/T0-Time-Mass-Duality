...
\title{FFGFT Kapitel 20: SOLUTION TO THE YANG–MILLS MASS GAP PROBLEM\\
...
\end{enumerate}
FFGFT (als effektive phänomenologische Schicht von T0) postuliert a single complex T0-Vakuum field:
Φ(x) = ρ(x) e^{i$\theta$(x)}
with:
\begin{itemize}
