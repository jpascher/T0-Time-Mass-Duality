...
% Standardized preamble - 032\_T0\_umkehrung\_De.pdf
...
\title{T0-Time-Mass-Dualitäts-Theorie: Zwingende Ableitung der Fraktaldimension $D_f$ aus dem Lepton-Massenverhältnis \\
	\large Validierung der geometrischen Grundlagen - Komplementär zu 006\_T0\_Teilchenmassen\_De.pdf}
\author{}
\date{}
...
\begin{document}
	...
	\begin{important}{Dokumenten-Komplementarität}{}
		Dieses Dokument konzentriert sich auf die \textbf{Validierung der Fraktaldimension} $D_f$ aus experimentellen Lepton-Massen. Es ergänzt das Hauptdokument \emph{006\\_T0\\_Teilchenmassen\\_De.pdf}, das die vollständige systematische Massenberechnung für alle Fermionen präsentiert.
	\end{important}
	...
	\begin{table}[H]
		...
		\begin{tabular}{lccc}
			...
			Erweiterte Yukawa & $5.11\times10^{-4}$ & $99.9\%$ & 006\_T0\_Teilchenmassen\_De.pdf \\
	...
	\begin{keyresult}{Zwingende Fraktaldimension}{}
		...
		\textbf{Dies beweist:} Das experimentelle Massenverhältnis erzwingt die fraktale Geometrie -- keine freien Parameter! Diese unabhängige Validierung bestätigt die Grundlagen von \emph{006\_T0\_Teilchenmassen\_De.pdf}.
	\end{keyresult}
	...
	\begin{itemize}
		...
		\item \textbf{Methoden-Konsistenz:} Unabhängige Bestätigung von \emph{006\_T0\_Teilchenmassen\_De.pdf}
	...
	\begin{table}[H]
		...
		\begin{tabular}{p{6cm}p{6cm}}
			\toprule
			\textbf{006\_T0\_Teilchenmassen\_De.pdf (Hauptdokument)} & \textbf{Dieses Dokument (Validierung)} \\
			\midrule
