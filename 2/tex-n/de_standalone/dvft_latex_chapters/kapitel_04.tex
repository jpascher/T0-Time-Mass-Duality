...
where:
𝓛_X = \partial𝓛_\theta/\partialX = \rho$_0$/2 − (\eta/(2a$_0$$^2$)) X^{1/2}.
...
T^{(\theta,DVFT)}_{\mu\nu} = 2\alpha$_1$ \partialI$_1$/\partialg^{\mu\nu} + 2\alpha$_2$ \partialI$_2$/\partialg^{\mu\nu} − g_{\mu\nu}(\alpha$_1$ I$_1$ + \alpha$_2$ I$_2$).
...
• X is large \to 𝓛_X \approx constant.
• DVFT invariants I$_1$, I$_2$ are suppressed.
• T^{(\theta)}_{\mu\nu} \approx −Λ_eff g_{\mu\nu}.
