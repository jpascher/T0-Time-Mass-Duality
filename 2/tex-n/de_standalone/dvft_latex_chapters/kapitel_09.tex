...
L_\theta = (\rho_0/2) X - (\eta/(3 a_0^2)) X^{3/2} - Λ_v,
...
• the baryonic Tully–Fisher relation v_c^4 = G M_b a_0,
...
\eta, a_0, Λ_v). As a characteristic acceleration in a system changes, the vacuum smoothly interpolates
between:
