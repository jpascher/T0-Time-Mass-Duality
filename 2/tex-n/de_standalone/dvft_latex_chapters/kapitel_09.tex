...
dominates.
2. Strong Field Regime (X >> a$_0$$^2$)
...
L_\theta = (\rho$_0$/2) X - (\eta/(3 a$_0$$^2$)) X^{3/2} - Λ_v,
...
3. Weak Field Regime (X ~ a$_0$$^2$)
As accelerations approach a$_0$, nonlinear vacuum effects begin to contribute. Here X is comparable to a$_0$$^2$
and the X^{3/2} correction in the Lagrangian becomes relevant. The response function
L_X = \rho$_0$/2 - (\eta/(2 a$_0$$^2$)) X^{1/2}
...
4. Deep Field Regime (X << a$_0$$^2$, Galactic Scale)
...
• the baryonic Tully–Fisher relation v_c⁴ = G M_b a$_0$,
...
• Strong field: GR limit, X >> a$_0$$^2$, linear response, compact objects.
• Weak field: transitional, X ~ a$_0$$^2$, small nonlinear corrections.
• Deep field: galactic scale, X << a$_0$$^2$ but gradients still relevant, g$^2$ = a$_0$ g_N, no dark matter.
International Journal for Multidisciplinary Research (IJFMR)
E-ISSN: 2582-2160 ● Website: www.ijfmr.com ● Email: editor@ijfmr.com
IJFMR250664112 Volume 7, Issue 6, November-December 2025 24
• Ultra-deep cosmological field: g << a$_0$ on horizon scales, residual vacuum energy acts as dark energy (w
\approx -1).
