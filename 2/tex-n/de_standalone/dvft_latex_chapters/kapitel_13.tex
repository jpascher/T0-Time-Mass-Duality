...
Time in DVFT is vacuum phase evolution. But without amplitude, c$^2$ = K$_0$/\rho$_0$ = undefined. Therefore, in
...
• inertia (\rho$_0$ = A\rho$^2$),
• stiffness (K$_0$ = B\rho$^2$),
• a well-defined wave speed c = \sqrt(K$_0$/\rho$_0$).
...
• The universe began as pure phase with \$rho = 0$ and \$theta = constant$.
