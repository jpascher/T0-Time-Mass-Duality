...
supports exactly three stable oscillation modes with 120^\circ vacuum phase separation:
\theta_{\nu_e} = \theta$_0$
\theta_{\nu_\mu} = \theta$_0$ + 2\pi/3
\theta_{\nu_\tau} = \theta$_0$ + 4\pi/3.
Thus:
• three leptons,
• three neutrinos,
...
• large \theta$_1$$_2$ (solar angle),
• large \theta$_2$$_3$ (atmospheric angle),
• nonzero \theta$_1$$_3$ (reactor angle).
...
In DVFT:
• charged leptons have amplitude-phase excitations \to Dirac-like,
• neutrinos have pure phase oscillations \to naturally Majorana-like.
