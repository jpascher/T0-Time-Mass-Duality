...
• \theta$_1$ \to \theta$_1$ + \delta\theta$_1$
• \theta$_2$ \to \theta$_2$ + \delta\theta$_2$
• \delta\theta$_1$ \neq \delta\theta$_2$
...
\Phi \to (\Phi$_1$ e^{i\delta\theta$_1$}) + (\Phi$_2$ e^{i\delta\theta$_2$})
Δ\theta = \theta$_1$ − \theta$_2$ + (\delta\theta$_1$ − \delta\theta$_2$) \to undefined
Eraser restores coherence:
\delta\theta$_1$ = \delta\theta$_2$ \Rightarrow Δ\$theta = constant$
International Journal for Multidisciplinary Research (IJFMR)
E-ISSN: 2582-2160 ● Website: www.ijfmr.com ● Email: editor@ijfmr.com
