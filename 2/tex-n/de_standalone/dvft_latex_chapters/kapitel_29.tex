...
• \theta_1 \to \theta_1 + \delta\theta_1
• \theta_2 \to \theta_2 + \delta\theta_2
• \delta\theta_1 \neq \delta\theta_2
...
\Phi \to (\Phi_1 e^{i\delta\theta_1}) + (\Phi_2 e^{i\delta\theta_2})
Δ\theta = \theta_1 − \theta_2 + (\delta\theta_1 − \delta\theta_2) \to undefined
Eraser restores coherence:
\delta\theta_1 = \delta\theta_2 \Rightarrow Δ\theta = constant
International Journal for Multidisciplinary Research (IJFMR)
E-ISSN: 2582-2160 ● Website: www.ijfmr.com ● Email: editor@ijfmr.com
