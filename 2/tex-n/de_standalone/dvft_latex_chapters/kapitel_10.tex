...
U(\rho) = Λ_0 + (κ/2)(\rho - \rho_0)^2 + (\lambda/4)(\rho - \rho_0)^4 + …
Where:
...
The measured value:
\rho_Λ \approx 7 \times 10⁻^2^7 kg/m^3
...
• On cosmic scales, \rho \approx \rho_0 \Rightarrow w \approx -1, matching dark-energy observations.
