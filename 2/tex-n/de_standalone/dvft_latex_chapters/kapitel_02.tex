...
which exhibits a minimum at \rho = \rho$_0$ and U(1) symmetry in the complex plane (\Phi \to \Phi e^{i\alpha}). At this
...
\theta(t) = \mu t
where \mu arises from the curvature of V at the minimum (\mu$^2$ \approx \lambda \rho$_0$$^2$, analogous to the Higgs mass). This
