...
dynamic vacuum field described by a complex scalar \varphi(𝑥)=\rho(𝑥)𝑒
𝑖\theta(𝑥) where \varphi(𝑥) is dynamic vacuum field,
\rho(𝑥) is vacuum amplitude and \theta(x) is vacuum phase. The vacuum possesses an intrinsic field with its
...
vacuum field \varphi(𝑥)=\rho(𝑥)𝑒
𝑖\theta(𝑥)
, where \rho(𝑥) represents the vacuum amplitude (inertial density) and \theta(x)
