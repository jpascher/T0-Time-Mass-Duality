...
• baryons \to positive winding number of \theta
• antibaryons \to negative winding number of \theta
...
\theta \to −\theta (charge conjugation)
x \to −x (parity),
...
L \supset \alpha \cdot \partialₜ\theta + \beta \cdot (\nabla\theta ⋅ P_odd),
...
To calculate the observed ratio \eta_B \approx 6 \times 10⁻^1^0, DVFT requires:
