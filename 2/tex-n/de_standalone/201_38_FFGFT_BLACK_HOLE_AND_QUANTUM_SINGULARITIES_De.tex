...
\title{FFGFT Kapitel 38: BLACK HOLE AND QUANTUM SINGULARITIES\\
...
g = −$\nabla$ρ.
Singularities require ρ → $\infty$ or $\nabla$ρ → $\infty$. FFGFT forbids both because the T0-Vakuum has finite stiffness and
inertial density, encoded in the potential U(ρ).
\begin{enumerate}
  \item Why Singularities Cannot Exist in FFGFT: The T0-Vakuum Potential U(ρ)
\end{enumerate}
FFGFT (als effektive phänomenologische Schicht von T0) postuliert the T0-Vakuum has a microphysical potential:
...
In FFGFT, as matter compresses and raises ρ(x), the T0-Vakuum potential U(ρ) rapidly increases. At
