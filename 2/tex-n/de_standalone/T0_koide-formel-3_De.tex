...
\fancyhead[R]{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Koide-Formel und $\xi$}
\fancyfoot[C]{\thepage}
...
\hypersetup{
	...
	pdfsubject={Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie), Koide-Formel, Leptonmassen}
}
...
\title{\textbf{Beweis: Die Koide-Formel enthält implizit $\xi$}\\[0.5cm]
	...
	\normalsize aus der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}
...
\begin{document}
	...
	\begin{abstract}
		Wir beweisen, dass die Koide-Formel für Leptonmassen keine unabhängige empirische Relation ist, sondern eine mathematische Konsequenz der geometrischen Konstante $\xi = \frac{4}{3} \times 10^{-4}$ aus der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie). Die Quantenverhältnisse $(r,p)$ der T0-Yukawa-Formel $m = r \cdot \xi^p \cdot v$ erzeugen automatisch die Koide-Symmetrie $Q = \frac{2}{3}$ ohne zusätzliche Parameter oder fraktale Korrekturen.
	\end{abstract}
	...
	In der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) entstehen Teilchenmassen durch:
	...
	Die Feinstrukturkonstante in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie):
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) zeigt eine tiefe Verbindung:
	...
	\begin{theorem}
		...
		Die 1981 empirisch entdeckte Symmetrie enthielt bereits die fundamentale geometrische Konstante $\xi = \frac{4}{3} \times 10^{-4}$, ohne dass dies erkannt wurde. Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) zeigt:
	...
	\begin{thebibliography}{99}
		...
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Grundlagen des Zeit-Masse-Dualitäts-Frameworks'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Grundlagen_en.pdf}
		
		\bibitem{T0Feinstruktur}
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Ableitung der Feinstrukturkonstante aus $\xi$'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Feinstruktur_En.pdf}
		
		\bibitem{T0Gravitation}
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Geometrische Herleitung der Gravitationskonstante'', HTL Leonding (2024). 
		...
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Systematische Berechnung der Teilchenmassen'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Teilchenmassen_En.pdf}
		
		\bibitem{T0SI}
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): SI-Reform 2019 als $\xi$-Kalibrierung'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_SI_En.pdf}
		
		\bibitem{T0Verhaeltnis}
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Verhältnisse vs. absolute Werte -- Fraktale Korrekturen'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_verhaeltnis-absolut_En.pdf}
		
		\bibitem{T0MuonG2}
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Anomale magnetische Momente und Muon g-2'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Anomale_Magnetische_Momente_En.pdf}
		
		\bibitem{T0QFT}
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Quantenfeldtheorie und Relativitätstheorie'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_QM-QFT-RT_En.pdf}
		
		\bibitem{T0Bibliographie}
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Vollständige Bibliographie (131+ Dokumente)'', HTL Leonding (2024). 
