...
% Standardized preamble - 040_Hdokument_De.pdf
\input{T0_preamble_standalone_De}

\title{{ T0 Modell: Vollständiges Framework}\\
		{ Universelle Energiefeld-Theorie}\\
...
\maketitle
	...
	\title{Natürliche Einheiten und energie-basierte Physik}
\maketitle
	...
	\title{Universelle Energiefeld-Theorie}
\maketitle
	...
	\title{Die $\xi$-Konstante und geometrische Grundlagen}
\maketitle
...
wobei $n$ von der Dimension der Kopplung abhängt. Dies ermöglicht die Berechnung aller Teilchenmassen aus einem einzigen geometrischen Prinzip.
	...
	\title{Parameter-freie Teilchenphysik}
\maketitle
	...
	\title{Experimentelle Überlegungen und theoretische Vorhersagen}
\maketitle
	...
	\title{Kosmologische Anwendungen}
\maketitle
	...
	\title{Quantenmechanik-Revolution}
\maketitle
	...
	\title{Philosophische und konzeptuelle Implikationen}
\maketitle
	...
	\title{Zusammenfassung und kritische Bewertung}
\maketitle
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025). \textit{T0 Modell: Vollständiges Framework - Master-Dokument}. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/040_Hdokument_De.pdf}
		
		\bibitem{pascher_cosmic_2025}
		Pascher, J. (2025). \textit{T0 Model: Universal $\xi$-Constant and Cosmic Phenomena}. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/063_cosmic_De.pdf} und \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/063_cosmic_En.pdf}
		
		\bibitem{pascher_teilchenmassen_2025}
		Pascher, J. (2025). \textit{T0 Model: Complete Particle Mass Derivations}. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/006_T0_Teilchenmassen_De.pdf} und \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/006_T0_Teilchenmassen_En.pdf}
		
		\bibitem{pascher_t0_energie_2025}
		Pascher, J. (2025). \textit{T0 Model: Energy-Based Formulation and Muon g-2}. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/010_T0_Energie_De.pdf} und \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/010_T0_Energie_En.pdf}
		
		\bibitem{pascher_redshift_2025}
		Pascher, J. (2025). \textit{T0 Model: Wavelength-Dependent Redshift and Deflection}. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/061_TempEinheitenCMB_De.pdf} und \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/061_TempEinheitenCMB_En.pdf}
		
		\bibitem{pascher_temp_einheiten_2025}
		Pascher, J. (2025). \textit{T0 Model: Natural Units and CMB Temperature}. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/062_Moll_Candela_De.pdf} und \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/062_Moll_Candela_En.pdf}
		
		\bibitem{pascher_beta_derivation_2025}
		Pascher, J. (2025). \textit{T0 Model: Beta Parameter Derivation from Field Theory}. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/093_DerivationVonBeta_De.pdf} und \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/093_DerivationVonBeta_En.pdf}
