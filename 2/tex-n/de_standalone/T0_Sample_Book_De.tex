...
\title{\Huge\textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Zeit-Masse-Dualität}\\[1cm]\Large Alle Naturkonstanten aus einer Zahl: $\alpha \approx 1/137$}
...
\chapter{Einführung in die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}

Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) ist ein neuer Ansatz zur Vereinheitlichung der fundamentalen Physik. Die zentrale These lautet:
...
Das Kernprinzip der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) ist die Zeit-Masse-Dualität:
\begin{equation}
...
Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) liefert eine geometrische Herleitung der Hubble-Konstante:
\begin{equation}
...
Hier sind die wichtigsten Formeln der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) zusammengefasst.
