...
% Standardized preamble - 056\_universale-ableitung\_De.pdf
\input{T0_preamble_standalone_De}

\title{\textbf{Universelle Ableitung aller physikalischen Konstanten\\aus der Feinstrukturkonstante und Planck-Länge}\\[0.5cm]
	\large Mit Klarstellung der charakteristischen Energie E\_0\\und Entkräftung der Zirkularitäts-Einwände\\[0.3cm]
