...
\title{Das T0-Energiefeld-Modell:\\[0.3cm]
...
\begin{document}
	...
	\begin{abstract}
		...
		\begin{itemize}
			...
			\item Charakteristische Energie: $E_0 = \sqrt{m_e \cdot m_\mu} = 7{,}348$ MeV (SI)
		\end{itemize}
		
		\textbf{Vorhersagen (SI-Werte):} Leptonmassen mit 2\% Genauigkeit, anomale magnetische Momente, Feinstrukturkonstante $\alpha \approx 1/137$ mit 0,03\% Übereinstimmung.
