...
\begin{document}
	...
	\subsection{Was ist die Natur des dynamischen Vakuumfeldes $\Phi(x)$?}
	...
	\subsection{Was ist die Rolle der $\rho$ Vakuumamplitude?}
	...
	\subsection{Was ist die Rolle der Vakuumphase $\theta$?}
	...
	\subsection{Begründung für die Form $\Phi = \rho e^{i\theta}$?}
	...
	\subsection{Ausgehend von T0s Vereinfachtem Lagrangian}
	...
	\subsection{Einbeziehung des T0 Erweiterten Lagrangians}
	...
	\subsection{Vollständiger Angepasster Action}
	...
	\subsection{Stress-Energie-Tensor-Ableitung aus T0}
	...
	\subsection{Nichtlineare Wellengleichung-Adaptation}
	...
	\subsection{Integration der Vereinfachten Dirac-Gleichung aus T0}
	...
	\subsection{Alternative Darstellungen von Quantenzuständen}
	...
	\subsection{Kern-Feldgleichung aus T0-Theorie}
	...
	\subsection{Phasen-Feldgleichung (Goldstone-ähnlicher Modus)}
	...
	\subsection{Nichtlineare Wellengleichungen und Höherordentliche Terme}
	...
	\subsection{Stress-Energie-Tensor Direkt aus T0-Schwankungen}
	...
	\subsection{Kopplung an Einsteins Feldgleichungen}
	...
	\subsection{Schwachfeld-Grenze und Newtonsche Gravitation}
	...
	\subsection{Relativistische Propagation und Kein Instantanes Action-at-a-Distance}
	...
	\subsection{Stabilität und Abwesenheit von Ghosts/Ostrogradsky-Instabilität}
	...
	\subsection{Vergleich mit Originalen DVFT-Feldgleichungen}
	...
	\subsection{Großskalige Kohärenz und Horizontproblem ohne Inflation}
	...
	\subsection{Kosmische Beschleunigung und Dunkle Energie}
	...
	\subsection{Dunkle Materie und Galaktische Rotationskurven}
	...
	\subsection{CMB-Anisotropien und Leistungsspektrum}
	...
	\subsection{Frühes Universum und Big-Bang-Alternative}
	...
	\subsection{Beobachtbare Signaturen und Tests}
	...
	\subsection{Niederenergie-Effektive Theorie aus T0}
	...
	\subsection{Ableitung der Deep-MOND-Grenze}
	...
	\subsection{Baryonische Tully–Fisher-Relation}
	...
	\subsection{Vorhersagen für die SPARC-Probe}
	...
	\subsection{External Field Effect und Tidal-Stabilität}
	...
	\subsection{Zentrale Oberflächendichte-Relation und Freeman-Limit}
	...
	\subsection{Vergleich mit CDM-Vorhersagen}
	...
	\subsection{Welle-Teilchen-Dualität aus T0-Knotenanregungen}
	...
	\subsection{Superposition als Vakuumphasen-Kohärenz}
	...
	\subsection{Verschränkung als korrelierte T0-Knoten}
	...
	\subsection{Dekohärenz aus Vakuumphasen-Zusammenbruch}
	...
	\subsection{Das Messproblem Gelöst}
	...
	\subsection{Schrödinger-Gleichung-Ableitung aus T0}
	...
	\subsection{Anomaler Magnetischer Moment (g-2)-Beiträge}
	...
	\subsection{Schwarzen-Loch-Bildung aus T0-Vakuum-Kollaps}
	...
	\subsection{Ereignishorizont als Phasenkohärenz-Grenze}
	...
	\subsection{Interieure Lösung: Stabiler Vakuumkern}
	...
	\subsection{Hawking-Strahlung aus Vakuumphasen-Fluktuationen}
	...
	\subsection{Verdampfungs-Endpunkt und Informationserhaltung}
	...
	\subsection{Thermodynamik und Entropie}
	...
	\subsection{Vergleich mit ART-Singularitäten}
	...
	\subsection{Quantengravitations-Regime}
