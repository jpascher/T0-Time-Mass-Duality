...
\title{FFGFT Kapitel 21: RON FOLMAN'S T³ QUANTUM GRAVITY EXPERIMENT\\
...
FFGFT (als effektive phänomenologische Schicht von T0) postuliert a complex T0-Vakuum field:
Φ = ρ e^{i$\theta$}
where:
\begin{itemize}
...
Δz(t) ∝ t² → ż(t) ∝ t.
Thus:
Δφ = (m/ħ) $\int$ g ż(t) dt ∝ $\int$ g t dt ∝ g T².
