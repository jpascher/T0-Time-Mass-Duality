...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Verbindungen zum Mizohata-Takeuchi-Gegenbeispiel}
\fancyhead[R]{\thepage}
...
\hypersetup{
	...
	pdfsubject={Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie), dispersive PDEs, Fraktale Geometrie, Mizohata-Takeuchi-Vermutung, Quantenphysik}
}
...
\title{\Huge\textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Verbindungen zum Mizohata-Takeuchi-Gegenbeispiel}\\
...
\begin{document}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) prognostiziert quantifizierbare Abweichungen bei der Ausbreitung von Quantenwellenpaketen und spektralen Linienbreiten in fraktalen Medien:
	...
	\begin{thebibliography}{5}
		...
		\bibitem{T0_g2_erweiterung} J. Pascher, ``g-2 Extension of the FFGFT: Fractal Dimensions,'' T0-Repo, v2.0 (2025). \href{https://github.com/jpascher/T0-Time-Mass-Duality/raw/main/2/tex/T0_g2-erweiterung-4_De.tex}{Download}.
