...
% Standardized preamble - 004_T0_Modell_Uebersicht_De.pdf
\input{T0_preamble_standalone_De}

\title{{ T0-Modell: Vollständige Dokumentenanalyse}\\
	{ und strukturierte Zusammenfassung}\\
	\vspace{1cm}
...
Die Eleganz liegt darin, dass eine einzige geometrische Konstante $\xi$ alle beobachtbaren Phänomene bestimmt, von subatomaren Teilchen bis zu kosmologischen Strukturen.
	...
	\begin{enumerate}
		\item \textbf{040\_Hdokument\_De.pdf} - Master-Dokument des vollständigen T0-Frameworks
		\item \textbf{081\_Zusammenfassung\_De.pdf} - Umfassende theoretische Abhandlung
		\item \textbf{010\_T0\_Energie\_De.pdf} - Energie-basierte Formulierung
		\item \textbf{063\_cosmic\_De.pdf} - Kosmologische Anwendungen
		\item \textbf{093\_DerivationVonBeta\_De.pdf} - Ableitung des $\beta$-Parameters
		\item \textbf{042\_xi\_parmater\_partikel\_De.pdf} - Mathematische Analyse des $\xipar$-Parameters
		\item \textbf{059\_system\_De.pdf} - Systemtheoretische Grundlagen
		\item \textbf{068\_T0vsESM\_ConceptualAnalysis\_De.pdf} - Vergleich mit dem Standardmodell
	\end{enumerate}
	...
	\textbf{Dokumentenverweis:} \textit{040\_Hdokument\_De.pdf}, \textit{081\_Zusammenfassung\_De.pdf}
	...
	\textbf{Dokumentenverweis:} \textit{010\_T0\_Energie\_De.pdf}, \textit{059\_system\_De.pdf}
	...
	\textbf{Dokumentenverweis:} \textit{010\_T0\_Energie\_De.pdf}, \textit{040\_Hdokument\_De.pdf}
	...
	\textbf{Dokumentenverweis:} \textit{042\_xi\_parmater\_partikel\_De.pdf}, \textit{093\_DerivationVonBeta\_De.pdf}
	...
	\textbf{Dokumentenverweis:} \textit{010\_T0\_Energie\_De.pdf}
	...
	\textbf{Dokumentenverweis:} \textit{T0-Theorie: Formeln fuer xi und Gravitationskonstante.md}
	...
	\textbf{Dokumentenverweis:} \textit{059\_system\_De.pdf}
	...
	\textbf{Dokumentenverweis:} \textit{063\_cosmic\_De.pdf}
	...
	\textbf{Dokumentenverweis:} \textit{131\_scheinbar\_instantan\_De.pdf}, \textit{035\_QM\_De.pdf}, \textit{010\_T0\_Energie\_De.pdf}
	...
	\textbf{Dokumentenverweis:} \textit{010\_T0\_Energie\_De.pdf}, \textit{081\_Zusammenfassung\_De.pdf}
	...
	\textbf{Dokumentenverweis:} \textit{040\_Hdokument\_De.pdf}
	...
	\begin{itemize}
		\item 040\_Hdokument\_De.pdf (Master-Dokument)
		\item 081\_Zusammenfassung\_De.pdf (Theoretische Abhandlung)
		\item 010\_T0\_Energie\_De.pdf (Energie-basierte Formulierung)
		\item 063\_cosmic\_De.pdf (Kosmologische Anwendungen)
		\item 093\_DerivationVonBeta\_De.pdf ($\beta$-Parameter Ableitung)
		\item 042\_xi\_parmater\_partikel\_De.pdf ($\xipar$-Parameter Analyse)
		\item 059\_system\_De.pdf (Systemtheoretische Grundlagen)
		\item 068\_T0vsESM\_ConceptualAnalysis\_De.pdf (Standardmodell-Vergleich)
	\end{itemize}
