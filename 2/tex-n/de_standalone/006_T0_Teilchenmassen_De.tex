...
% Standardized preamble - 006\_T0\_Teilchenmassen\_De.pdf
...
\begin{document}
	...
	\begin{experimental}
		...
		\textbf{*Neutrinos:} Erfordern separate Analyse (siehe 007\_T0\_Neutrinos\_De.pdf)
	\end{experimental}
	...
	\begin{warning}
		...
		\textbf{Verweis:} Vollständige Neutrino-Analyse in Dokument 007\_T0\_Neutrinos\_De.pdf
	\end{warning}
	...
	\begin{itemize}
		\item \textbf{003\_T0\_Grundlagen\_v1\_De.pdf:} Fundamentale $\xi_0$-Geometrie
		\item \textbf{011\_T0\_Feinstruktur\_De.pdf:} Elektromagnetische Kopplungskonstante
		\item \textbf{012\_T0\_Gravitationskonstante\_De.pdf:} Gravitatives Analogon zu Massen
		\item \textbf{007\_T0\_Neutrinos\_De.pdf:} Spezialfall der Neutrino-Physik
	\end{itemize}
