...
\end{adjustbox}
	...
	\begin{experimental}
		...
		\begin{center}
\begin{adjustbox}{max width=\textwidth}
			\begin{tabular}{@{}p{0.25\textwidth}@{\hspace{2mm}}p{0.12\textwidth}@{\hspace{2mm}}p{0.18\textwidth}@{\hspace{2mm}}p{0.12\textwidth}@{\hspace{2mm}}p{0.12\textwidth}@{\hspace{2mm}}p{0.15\textwidth}@{}}
				\toprule
