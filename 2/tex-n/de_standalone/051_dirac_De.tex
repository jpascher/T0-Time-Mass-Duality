...
% Standardized preamble - 051_dirac_De.tex
...
\begin{document}
	...
	\end{enumerate}
% DIESES KAPITEL EINFÜGEN IN 051_dirac_De_v2.tex
...
\end{keypoint}	
	...
	**Identisch mit SI-Version** – Verhältnisse sind invariant!
	...
	\begin{enumerate}
		\item Die T0-Dirac-Gleichung $(i\partial\!\!\!/_{\text{frak}} - m(x))\Psi = 0$ 
		integriert:
		\begin{itemize}
			\item Fraktale Metrik ($D_f = 3 - \xi$)
			\item Dynamische Masse ($m(x) = 1/(c^2 T(x))$)
			\item Torus-Topologie
		\end{itemize}
		
		\item Spin-1/2 wird als **topologische Wicklungszahl** interpretiert, nicht als 
		Matrixeigenschaft
		
		\item Die fundamentale Vorhersage ist das **Verhältnis** $a_\tau/a_\mu = (m_\tau/m_\mu)^2$
		
		\item Dies folgt aus der **massenproportionalen Kopplung** an das Zeitfeld
		
		\item Absolute Werte sind **phänomenologisch** (wie QCD im SM), aber Verhältnisse 
		sind **fundamental**
	\end{enumerate}
...
\begin{thebibliography}{9}
	...
	\href{https://github.com/jpascher/T0-Time-Mass-Duality}{T0-Time-Mass-Duality Repository},
	2026.
	
	\bibitem{XiNarrative}
	J. Pascher,
	\textit{Die Xi-Erzählung: Von einer einzigen Zahl zur Feinstrukturkonstanten},
	\href{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/FFGFT_Narrative_Master_De.pdf}{FFGFT\_Narrative\_Master\_De.pdf},
	2025.
	...
	\href{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_xi_ursprung.pdf}{T0\_xi\_ursprung.pdf},
	2025.
	
	\bibitem{T0DiracSimplified}
	J. Pascher,
	\textit{Dirac-Gleichung in der T0-Theorie: Geometrische Clifford-Algebra-Formulierung},
	\href{https://github.com/jpascher/T0-Time-Mass-Duality}{Dokument 050\_dirac\_geometrisch},
	2026.
