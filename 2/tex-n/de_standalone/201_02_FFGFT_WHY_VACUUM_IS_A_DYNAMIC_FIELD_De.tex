...
\title{FFGFT Kapitel 2: WHY VACUUM IS A DYNAMIC FIELD\\
...
\begin{enumerate}
  \item Introduction
\end{enumerate}
The FFGFT framework models spacetime as arising from a complex scalar T0-Vakuum field Φ(x) = ρ(x)
...
\end{itemize}
For FFGFT, dynamic T0-Vakuum field is an intrinsic property of Φ, not the result of an external force or prime
mover.
\begin{enumerate}
  \item Unified Answer
\end{enumerate}
