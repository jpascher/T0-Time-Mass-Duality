...
% Standardized preamble - 019_T0_lagrangian_De.tex
\input{T0_preamble_standalone_De}
\usepackage[compat=1.1.0]{tikz-feynman} % Recommended for newer TeX versions[citation:2]
\title{\textbf{T0-Theorie: Lagrangian-Formulierung}\\[0.5cm]
