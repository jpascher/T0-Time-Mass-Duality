...
Conclusion
• Space creation corresponds to the outward propagation of the vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0) ρ.
• The boundary speed v_b(t) is finite because the amplitude field obeys a hyperbolic PDE.
• The maximal speed is the vacuum amplitude ($\\rho_0 = 1/\\xi^2$ from T0) signal speed c_ρ = √(B/A).
