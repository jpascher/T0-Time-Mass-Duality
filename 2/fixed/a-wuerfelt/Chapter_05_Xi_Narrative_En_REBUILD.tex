...
A detailed quantitative discussion of lepton anomalous magnetic moments – including structural ratio relations, numerical values, and current experimental status – is presented in the dedicated T0 document \texttt{018\_T0\_Anomale-g2-12\_En.tex}.
...
\begin{align}
	...
	\frac{m_\tau}{m_\mu} &= \frac{r_\tau}{r_\mu} \xi^{p_\tau - p_\mu} = \frac{25/9}{16/5} \xi^{-1/3} 
...
\begin{itemize}
	...
	\item \textbf{Absolute g-2 values:} cannot be calculated ab initio in T0; only ratios are meaningful, and detailed numerical values are discussed in \texttt{018\_T0\_Anomale-g2-12\_En.tex}
