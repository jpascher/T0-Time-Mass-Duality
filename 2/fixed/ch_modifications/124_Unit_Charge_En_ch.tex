...
\begin{tabular}{lll}
	...
	\end{equation}
	with $f_{\text{fractal}}(r) = \prod_{n=1}^{137} \left(1 + \delta_n \cdot \xi \cdot \left(\frac{4}{3}\right)^{n-1}\right)$ and effective fractal dimension $D_f^{\,\text{eff}} \approx 2.973$.
	...
	T0 integrates with kinematic mechanics: Charge emerges as a rotating EM vortex, stabilized by fractal correction. No Dirac delta—$\rho(r)$ is a helical pattern, enabling singularity-free simulations. Applications: g-2 anomaly predictions and LHC mass spectra.
	...
	\begin{description}[leftmargin=1cm]
		...
		\item[$D_f^{\text{eff}}$] Effective fractal dimension; $D_f^{\text{eff}} \approx 2.973$ (local: $D_f^{\text{space}} = 3 - \xi \approx 2.9999$)
	\end{description}
