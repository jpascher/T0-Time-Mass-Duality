...
\section{Lepton-Lebensdauern und die starke Kopplungskonstante}

Eine weitere quantitative Vorhersage betrifft die starke Kopplungskonstante, die sich erstmals rein geometrisch ableiten lässt:
\begin{equation}
\alpha_s(m_\tau) = D \cdot \xsi^{1/4} = 0{,}3224
\end{equation}
wobei $D = 3$ die Raumdimension ist. Dieser Wert weicht nur $2{,}3\%$ vom experimentellen Ergebnis ab. In Kombination mit der Torus-Geometrie ergibt sich eine Vorhersage des Lebensdauer-Verhältnisses $\tau_\mu/\tau_\tau$ mit $0{,}19\%$ Genauigkeit --- vollständig aus T0-Parametern, ohne experimentelle Eingabe außer den Leptonmassen (\href{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/160_T0_Lepton-Lebensdauer-Verh_De.pdf}{Dok.~160}).
