...
% Part in TOC: small, bold, NO page break
\makeatletter
...
% Only Parts and Chapters in TOC (no Sections/Subsections)
...
\chapter{What IS the Universe? The Fundamental Ontology of T0 Theory Energy as Sole Reality — Time and Mass as Emergent Duality}
...
\chapter{Anomale magnetische Momente in der FFGFT-Theorie Geometrische Herleitung aus der Zeit-Masse-Dualität Rein geometrische Formeln und präzise Verhnältnis-Vorheirsagen}
\input{../ch/149_FFGFT-torsion_En_ch}

\chapter{Compatibility Analysis of T0 Dimension Formulations Unification of 4D Torsion Crystal and Fractal Dimension Documents 149, 018, and 145 Compared}
\input{../ch/150_kompatiblitaet_En_ch}

\chapter{Ontological Reality and Narrative Structure of T0 Theory From Fundamental Structure to Observable Physics Hierarchical Levels of Physical Reality}
...
\chapter{Ontological Hierarchy of Energy Reduction The Levels of Fundamental Reality in Natural Units From Time-Mass Duality to Universal Energy Field}
\input{../ch/153_energie-reduktion-on_En_ch}

\chapter{Adapted Dynamic Vacuum Field Theory (DVFT) Fully Grounded in T0 Time-Mass Duality Theory}
...
\chapter{Why the Brain Folding Metaphor Fits Perfectly The Universe as a Folded Brain Self-Similarity, Surface Maximization, and Information}
\input{../ch/154_Cortex_En_ch}

\chapter{DNA Double Helix and Chromosome Compaction Astonishing Parallels to T0-Torus Geometry From Molecular Winding to Highest Information Density}
