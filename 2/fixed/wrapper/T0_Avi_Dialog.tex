...
Torsion & Implizit in $\Tfield = 1/m$ und $\Dfrak$ & Nirgendwo verschwindend (Axiom) \\
...
\begin{enumerate}
  \item \textbf{Torsion in T0 (etabliert):} Der T0-Feldpropagator $G(x_i, x_j)$ trägt implizit eine Torsionskomponente -- diese folgt aus $\Tfield = 1/m$ und $\Dfrak = 3 - \xipar$. Die quantitative Übereinstimmung von $\tau_{\min}$ (Rosenthal) mit dem aus $\xipar$ abgeleiteten Torsionsparameter ist der nächste formale Schritt.
  ...
  \item \textbf{CP-Phase Konvergenz:} Gibt $\delta \sim \arctan(\xipar/(1+\xipar))$ denselben Wert wie $270° + \arctan(\varphi^{-3})$? Numerisch: $\arctan(1.333\times10^{-4}) \approx 0.0076°$ vs. $13.28°$ -- die Übereinstimmung ist nicht direkt, aber die Strukturen könnten über unterschiedliche Skalen konvergieren.
