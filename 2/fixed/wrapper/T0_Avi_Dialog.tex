...
\medskip
\textbf{Das Elektron als topologischer Defekt = Gödel-Rest.}
Du beschreibst das Elektron als irreduziblen Wirbel im Superfluid -- stabil weil topologisch eingeschrieben, nicht vernichtbar durch lokale Felder. In FFGFT ist dasselbe Objekt der \emph{Gödel-Rest} $\varepsilon > 0$ der SU(8)-Struktur: die irreduzible Komponente die das System nicht eliminieren kann, weil $T = 0$ algebraisch verboten ist. Zwei Bilder, ein Objekt. Die Windungszahl im Superfluid-Bild entspricht direkt den Quantenzahlen $(n, \ell, j)$ auf dem FFGFT-Torus.
...
Topologischer Defekt (Superfluid-Wirbel) $\;\longleftrightarrow\;$ Gödel-Rest der SU(8)-Struktur\\[0.3em]
