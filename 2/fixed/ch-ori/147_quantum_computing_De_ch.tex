...
\begin{itemize}
	...
	\item \textbf{Experimentell validiert:} CHSH = 2,827888 stimmt mit IBM-Daten innerhalb von 0,014 Prozent überein
\end{itemize}
...
\begin{keyresult}[Chi-Quadrat-Test für T0-Kompatibilität]
	...
	\end{equation}
	\textbf{Schlussfolgerung:} $p > 0.05$ $\Rightarrow$ Daten \textbf{kompatibel} mit T0-Theorie bei 95 Prozent Konfidenzniveau.
\end{keyresult}
...
\begin{enumerate}
	...
	\item \textbf{Hardware-Qualität:} 127-Qubit-Chip hat 3 Prozent Überschuss vs. 72 Prozent für 73-Qubit
	\item \textbf{Perfekte Übereinstimmung:} Sherbrooke (127) stimmt innerhalb 0.0006 Prozent mit Theorie überein
\end{enumerate}
...
\begin{itemize}
	\item \textbf{Bell-Treue:} 97.4 Prozent Durchschnitt mit 40× niedrigerer Varianz als QM-Vorhersage
	\item \textbf{73-Qubit-CHSH:} $2.8275 \pm 0.0002$, kompatibel mit T0 (Δ = 0.014 Prozent)
	\item \textbf{127-Qubit-CHSH:} $2.8278 \pm 0.0001$, nahezu perfekte Übereinstimmung (Δ = 0.0006 Prozent)
	\item \textbf{Statistische Signifikanz:} Alle Tests kompatibel bei 95 Prozent CL ($p > 0.05$)
\end{itemize}
