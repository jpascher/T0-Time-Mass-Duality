	...
	Seit über einem Jahrhundert erkennen Physiker die Feinstrukturkonstante $\alpha = 1/137.035999\ldots$ als eine der fundamentalsten und rätselhaftesten Zahlen der Physik.
	
	\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Historische Anerkennung]
		\begin{itemize}
			...
			\item \textbf{Wolfgang Pauli:} War sein ganzes Leben lang von der Zahl 137 besessen. Er starb im Krankenhauszimmer Nummer 137.
	...
	\begin{tcolorbox}[colback=green!5!white,colframe=green!50!black,title=Der Paradigmenwechsel]
	...
	\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Erkenntnis]
	...
	\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Die vollständige Entschlüsselung]
	...
	\begin{tcolorbox}[colback=purple!5!white,colframe=purple!75!black,title=Entdeckung]
	...
	\begin{align}
		...
		\text{Fraktale Dimension:} & \quad D_f^{\text{eff}} \approx 2{,}973 \rightarrow \text{Skalenfaktor } 10^{-4}
	\end{align}
	...
	\begin{tcolorbox}[colback=green!5!white,colframe=green!50!black,title=Verifizierte Vorhersagen]
		\begin{align}
	...
	\subsection{Vergleich aller Berechnungsmethoden für 1/137}
	...
	\begin{tcolorbox}[colback=orange!5!white,colframe=orange!75!black,title=Das neue Verständnis]
		\begin{itemize}
	...
	\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Erkenntnis]
