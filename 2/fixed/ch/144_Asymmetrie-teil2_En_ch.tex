...
Predictions (neutrino oscillations, cosmological constant \(\Lambda\)) are derived from $\xi$ and consistent with empirical fits; the complete derivation is still under development. The documentation, however, does not provide complete uncertainty analyses – an extension would be possible.
