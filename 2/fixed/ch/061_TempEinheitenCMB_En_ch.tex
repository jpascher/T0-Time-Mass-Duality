...
\begin{tabular}{p{3cm}p{3cm}p{3cm}p{3cm}}
	...
	This yields $z_{\text{rec}}^{T0} \approx 1089.5$, which differs from 
...
\begin{tabular}{l l l l}
	...
	\begin{enumerate}
		...
		\item \textbf{CMB without inflation}: The theory successfully explains the CMB at $z \approx 1100$ without requiring inflation, and derives primordial perturbations from T-field quantum fluctuations.
