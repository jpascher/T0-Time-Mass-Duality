	...
	\begin{enumerate}
		...
		\item \textbf{Scale structure:} Through the anomalous dimension $\gamma$, a scale dependence of $\xi$ becomes apparent. This scale structure follows in FFGFT from the recursion $\mathcal{R}$ on the torus geometry (Doc.~202/203); it is not the result of a renormalization procedure, but is comparable in effect to the renormalization group of quantum field theory.
	...
	\begin{longtable}{>{\raggedright\arraybackslash}p{1cm} >{\raggedright\arraybackslash}p{7cm} >{\raggedright\arraybackslash}p{2.5cm}}
		\toprule
	...
	\begin{longtable}{>{\raggedright\arraybackslash}p{1.5cm} >{\raggedright\arraybackslash}p{6.5cm} >{\raggedright\arraybackslash}p{2.5cm}}
		\toprule
		\textbf{Symbol} & \textbf{Meaning} & \textbf{Value/Unit} \\
		\midrule
