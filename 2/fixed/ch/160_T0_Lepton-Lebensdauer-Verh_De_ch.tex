	...
	\begin{itemize}
		\item \textbf{Vorfaktor $D = 3$:} Die räumliche Dimensionalität des Torus (drei spatiale Windungsrichtungen). In der SM-Korrespondenz entspricht dies dem Vorfaktor, der dort als $N_c$ ($N_c=3$ Farbladungen) erscheint.
	...
	\begin{itemize}
		\item $D = 3$ ist ganzzahlig und entspricht den drei Windungsdimensionen des Torus (SM-Korrespondenz: $N_c=3$-Vorfaktor)
	...
	\begin{itemize}
		...
		\item $D = 3$: räumliche Windungsdimensionen des Torus (SM-Korrespondenz: $N_c=3$)
