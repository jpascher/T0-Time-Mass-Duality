...
In Kapitel~173 erschien der Spin im Rahmen der Ising-Maschine und
...
(Kapitel~173, Abschnitt über den minimalen Resonator).
...
Aus Kapitel~173: ein Quantenpunkt kann $0, 1, 2, 3, \ldots$
...
Der fraktale Korrekturfaktor $\Kfrak$ (Kapitel~173)
...
\textbf{3. Dekohärenz-Zeitskalen und $\xi$-Hierarchie:}\\
Warum sind $T_2$ in Si/SiGe ($\sim 10$\,ms) und
$T_1$ in P:Si ($> 1$\,s) so dramatisch verschieden von
Exziton-Kohärenzzeiten ($\sim 10$\,ps)?
Der Unterschied ist 9 Größenordnungen ---
entspricht das einer Stufe in der $\xi$-Hierarchie?
$\xi^{-1} \approx 7500$: eine Stufe überbrückt
$\sim 4$ Größenordnungen. Zwei Stufen $\sim 8$ Größenordnungen.
Das wäre eine erstaunliche Übereinstimmung.\\[6pt]
