...
% Date: June 2026
% Status: Active derivation. R29 open.
% ============================================================================

\section*{Overview}

This document shows step by step how the observed CMB peak ratios follow
from the T$^4$ lattice structure of FFGFT. All numbers are directly
reproducible. What is not yet derived is clearly marked as open.

\textbf{Result up front:} The dominant T$^4$ peaks at
$|n|^2 = 3, 18, 42, 78$ produce ratios
$1\,:\,2{.}449\,:\,3{.}742\,:\,5{.}099$,
which agree with the observed CMB peaks ($1\,:\,2{.}441\,:\,3{.}682\,:\,5{.}091$)
to $< 2\%$ -- with no free parameter.
...
Doc.~190 (R14 path-lengthening, R20 $R_H$ as external parameter),
...
\subsection*{11.1 What follows from $\xi$ alone -- no free parameter}
...
T$^4$ peaks at $|n|^2 = 1, 6, 14, 26$ &
  ...
  Input: only $\xi = 1/7500$. \\
\addlinespace
Factor~3 (spatial dimensions) &
  Observer measures $k_\mathrm{obs}^2 = (n_1^2+n_2^2+n_3^2)/L^2$;
  most symmetric mode $(1,1,1,0)$ gives $3$. Consistent with
  $D_f = 3-\xi = 2{.}999867$. \\
\addlinespace
Visible peaks $\{3, 18, 42, 78\}$ &
  $3 \cdot \{1, 6, 14, 26\} = \{3, 18, 42, 78\}$
  (all genuine local maxima). \\
\addlinespace
Ratios $1:2{.}449:3{.}742:5{.}099$ &
...
\textbf{Not a single one of these values was fitted to CMB data.}
...
as fractal path-lengthening $z(d)$ (Doc.~190, R14).
...
FFGFT derives $H_0 = 66{.}2$\,km/s/Mpc from $\xi^{41/4}$.
