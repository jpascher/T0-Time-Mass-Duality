...
This is familiar from electromagnetism - it is the wave equation for electromagnetic fields in vacuum. The difference: In the T0-Model, this one equation describes not only light, but all physical phenomena.
...
Standard quantum mechanics uses probabilistic descriptions because it has only incomplete information. This is like noise analysis in your systems: When you do not know the exact noise source, you use statistical models.
...
\begin{itemize}
	...
	\item Hubble constant: $H_0 \approx 66.2\,$km/s/Mpc (see Document~026) \checkmark
\end{itemize}
