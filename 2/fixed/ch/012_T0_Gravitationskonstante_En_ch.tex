\section*{Abstract}
	...
	\end{enumerate}
		...
		\subsection{T0 Perspective: G in Two Representations}
	
	\begin{keyresult}
		\textbf{G from the T0 viewpoint:}
		
		\textbf{1. In T0 natural units:}
		\begin{equation}
			c = \hbar = \alpha = G = 1
		\end{equation}
		All constants are set to 1 (maximal simplification).
		
		\textbf{2. Reconstruction of the SI value:}
		
		\textbf{a) From $\xi$ (this document):}
		\begin{equation}
			G_{\text{SI}} = \frac{\xi^2}{4m_e} \times C_{\text{dim}} \times C_{\text{conv}} \times K_{\text{frak}}
		\end{equation}
		Explicit derivation of all conversion factors (Sections 3--8).
		
		\textbf{b) Alternative Planck formulation (Document 127):}
		\begin{equation}
			G = \frac{\ell_P^2 \times c^3}{\hbar}
		\end{equation}
		Shows the direct connection to the quantum-gravity scale.
		
		\textbf{Both representations are equivalent and show: G is emergent, not fundamental!}
		
		Only free parameter in T0: $\xi = \frac{4}{3} \times 10^{-4}$
	\end{keyresult}
	
	\subsection{Document Structure}
	
	This document focuses on the technical-mathematical derivation of the $\xi$-based formulation with full justification of all conversion factors. For the philosophical perspective (``Why is G emergent?'') and practical consequences, see Document 127.
...
\section{The Fundamental T0 Relation}
	...
	The justification lies in the electron's role as the lightest charged particle and its fundamental importance for electromagnetic interaction.
		...
		\subsection{Connection to the Planck Scale}
	
	The fundamental T0 relation $G = \frac{\xi^2}{4m_e}$ (in natural units) is equivalent to the Planck-based formulation:
	...
	\begin{itemize}
		\item \textbf{Planck perspective:} G emerges at the quantum-gravity scale $\ell_P \approx 1.616 \times 10^{-35}$\,m
		\item \textbf{T0 perspective:} G follows from the geometric parameter $\xi$ and the electron mass
		\item \textbf{Equivalence:} Both show that G is not fundamental
	\end{itemize}
	
	The Planck formulation is conceptually elegant and shows the direct connection to quantum gravity. The $\xi$-based T0 formulation (which we use in the following) makes all conversion steps from natural to SI units explicit and shows the geometric origin.
	
	\textbf{For detailed discussion of the Planck perspective, philosophical implications, and practical consequences, see Document 127.}
...
\section{Dimensional Analysis in Natural Units}
	...
	\subsection{Stage 6: Fractal Correction}
	
	The final correction accounts for the effective fractal dimension $D_f^{\,\text{eff}} \approx 2.973$ (cumulative over the RG running) with the consistent formula:
	\begin{equation}
	...
	Application of fractal correction:
	\begin{equation}
	...
	\begin{itemize}
		...
		\item Same effective fractal dimension: $D_f^{\,\text{eff}} \approx 2.973$
	\end{itemize}
	...
	\begin{derivation}
		...
		\begin{align}
			D_f^{\,\text{eff}} &\approx 2.973 \quad \text{(effective fractal dimension over RG running)} \\
			K_{\text{frak}} &= 1 - \frac{D_f - 2}{68} = 1 - \frac{0.94}{68} = 0.986
		\end{align}
		
		\textbf{Geometric Meaning:} 
		The factor 68 corresponds to the tetrahedral symmetry of the T0 space structure. The effective fractal dimension $D_f^{\,\text{eff}} \approx 2.973$ describes the cumulative effect of spacetime porosity ($D_f^{\,\text{space}} = 3 - \xi \approx 2.9999$) over the RG running.
	...
	\begin{derivation}
		...
		The value $D_f^{\,\text{eff}} \approx 2.973$ is not chosen arbitrarily but follows necessarily from the consistency condition of two independent derivation paths for the mass ratio $m_e/m_\mu$ (cf.\ Doc.~133).
		...
		\begin{itemize}
			...
			\item This is \textbf{only possible} with $D_f^{\,\text{eff}} \approx 2.973$
		\end{itemize}
		...
		The solution of this equation necessarily yields $D_f^{\,\text{eff}} \approx 2.973$. Any other value would lead to inconsistent predictions for $\alpha$.
		
		\textbf{Physical Significance:}
		The effective fractal dimension $D_f^{\,\text{eff}} \approx 2.973$ ensures that:
		\begin{itemize}
	...
	\begin{keyresult}
		\textbf{Consistency of Fractal Correction:}
	...
	\begin{verification}
		...
		\begin{enumerate}
			...
			\item The \textbf{effective fractal dimension} $D_f^{\,\text{eff}} \approx 2.973$ is universal for all scaling phenomena
		\end{enumerate}
