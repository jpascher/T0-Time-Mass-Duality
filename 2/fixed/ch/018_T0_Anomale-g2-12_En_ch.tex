\section*{Abstract}
	...
	\begin{itemize}
		...
		\item T0 from bridge formula: $a_\tau = 1.282 \times 10^{-3}$
	...
	\begin{itemize}
		\item \textbf{SM circularity:} The SM extracts $\alpha$ from the $a_e$ measurement and then computes $a_e$ with this $\alpha$. For electron and muon, this is a circular fit --- not an independent prediction.
		\item \textbf{T0 derives $\alpha$:} From $\xi$ alone, without measurement. The $0.0005\%$ deviation is a genuine, independent prediction.
