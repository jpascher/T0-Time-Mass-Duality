\section*{Abstract}
	...
	\begin{align}
		...
		k_{\text{geom}}^{\text{rec}} &= \frac{4\pi/7491.91}{a_e^{\exp}} = \frac{1.681 \times 10^{-3}}{1.15965 \times 10^{-3}} = 1.449
	\end{align}
	
	Wait, let me correct this with the right numbers from the Python script:
	\begin{align}
