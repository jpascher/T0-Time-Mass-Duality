...
Dieser Schluss ist ein Kategorienfehler. Er verwechselt zwei strukturell
...
Die Analogie zu FFGFT ist direkt: Die Wicklungsstruktur auf $T^4$ ist
eine geometrische Konfiguration — sie existiert, hat Konsequenzen
(Massenverhältnisse, Kopplungskonstanten), aber sie \emph{kostet} keine
laufende Energie. Erst dynamische Übergänge zwischen Konfigurationen —
Prozesse — haben Energiedimension.
