...
\end{table}
	...
	\begin{tcolorbox}[colback=red!5,colframe=red!50,title=Korrektur (Mai 2026)]
		Der folgende Abschnitt stammt aus einer Arbeitsnotiz (Nov.~2025) und nimmt einen Wert $S \approx 2.8275 \pm 0.0002$ als „identifizierte 2025-Daten'' eines 73-Qubit-Bell-Tests an. Dieser Wert ist in verfügbaren Aufzeichnungen \emph{nicht belegt} und sollte nicht als reale Messung gelesen werden. Die tatsächliche Hardware-Messung (Dok.~147, IBM Heron r2, Mai 2026) ergibt $S = 2.74$ ($96{,}9\%$ der Tsirelson-Schranke), wobei die Abweichung von $2\sqrt{2}$ NISQ-Dekohärenz ist und nicht der $\xi$-Effekt. Der nachfolgende $\xi$-Fit an $2.8275$ ist damit gegenstandslos; die theoretische $\ln N$-Skalenformel bleibt als Struktur gültig.
	\end{tcolorbox}
