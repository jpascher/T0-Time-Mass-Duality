\section*{Abstract}
	...
	The $\xi$-term is closely related to precision observables such as the muon g-2 anomaly \cite{muong2_2023, pascher2025g2}; detailed quantitative predictions are documented separately in \texttt{018\_T0\_Anomale-g2-10\_En.pdf}.
	\begin{equation}
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025a). T0-Theorie der Zeit-Masse-Dualität [Repository]. GitHub. .
		
		\bibitem{pascher2025qm}
		Pascher, J. (2025b). Quantenmechanik in T0-Framework. 034\_T0\_QM-optimierung\_De.pdf.
		
		\bibitem{pascher2025rel}
		Pascher, J. (2025c). Relativitätserweiterungen in T0. 020\_T0\_QM-QFT-RT\_De.pdf.
		
		\bibitem{pascher2025si}
		Pascher, J. (2025d). SI-Einheiten und T0. 013\_T0\_SI\_De.pdf.
		
		\bibitem{pascher2025g2}
		Pascher, J. (2025e). Myon g-2 in T0. 018\_T0\_Anomale-g2-10\_De.pdf.
		
		\bibitem{pascher2025cmb}
		Pascher, J. (2025f). CMB in T0. 039\_Zwei-Dipole-CMB\_De.pdf.
		
		\bibitem{pascher2025casimir}
		Pascher, J. (2025g). Casimir-Effekt in T0. 091\_Casimir\_De.pdf.
		
		\bibitem{pascher2025kosmo}
		Pascher, J. (2025h). Kosmologie in T0. 025\_T0\_Kosmologie\_De.pdf.
		
		\bibitem{pascher2025alpha}
		Pascher, J. (2025i). Feinstrukturkonstante aus $\xi$. 011\_T0\_Feinstruktur\_De.pdf.
		
		\bibitem{pascher2025gravity}
		Pascher, J. (2025j). Gravitationskonstante aus $\xi$. 012\_T0\_Gravitationskonstante\_De.pdf.
