...
% Titel: Die Casimir-Skala als kosmisches Bindeglied:
...
Fünf scheinbar unverbundene Skalen -- von der Sub-Planck-Länge bis zur Hubble-Länge --
bilden eine lückenlose $\xi$-Potenzleiter mit nahezu konstantem Stufenabstand.

\clearpage

% ==============================================================================
\section{Ausgangslage: Drei scheinbar unverbundene Phänomene}
\label{sec:ausgangslage}
% ==============================================================================

\subsection{Casimir-Effekt und Vakuumstruktur (Dokument~091)}
...
% ==============================================================================
\section{Herleitung der Verbindungsformel}
...
\subsection{Multiplikation der beiden Relationen}
...
\subsection{Der Exponent 41/4 als Summe zweier bekannter Exponenten}
...
\subsection{Fünf Skalen in einer Leiter}

Wir berechnen alle relevanten Skalen als $\xi$-Potenzen der Planck-Länge $\ell_P$:
...
\begin{table}[H]
    ...
    \begin{tabular}{lccc}
        ...
        $\ell_P$                  & Planck-Länge           & $1{,}62 \times 10^{-35}$ & $n = \phantom{+}0{,}0$ \\
        $\bar\lambda_e$           & Compton-Wellenlänge    & $3{,}86 \times 10^{-13}$ & $n = -5{,}77$ \\
...
\subsection{Gleichmässige Stufenstruktur}
...
\subsection{Das geometrische Mittel}
...
\begin{insightBox}[Die Casimir-Skala als kosmisches Bindeglied]
    Die Casimir-Vakuumskala $L_\xi \approx 100\,\mu\text{m}$ liegt auf der
    $\xi$-Potenzleiter genau zwischen der Planck-Länge und der Hubble-Länge.
...
\subsection{Vorfaktoren und ihre Bedeutung}
...
\subsection{Warum der Exponent 41/4 fundamental ist}
...
\begin{keyresult}[Erklärung des Exponenten 41/4]
...
\subsection{Casimir-Präzisionsmessungen}
...
\subsection{H\texorpdfstring{$_0$}{0}-Messung als indirekter Casimir-Test}
...
\begin{table}[H]
    \centering
    \caption{Numerische Verifikation der vollständigen Kette}
    \label{tab:numerical}
    \begin{tabular}{lll}
        \toprule
...
\begin{foundation}[Drei unabhängige Eingaben -- ein konsistentes System]
