\section{Einleitung: Verhältnisbasierte vs. parameterbasierte Physik}
	...
	\begin{table}[H]
		...
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{p{3.2cm}p{1.6cm}p{2.8cm}p{2.5cm}p{2.3cm}p{1.0cm}p{0.6cm}}
				...
				\textbf{Physikalische Größe} & \textbf{SI-Einheit} & \textbf{T0-Ver-hältnis-formel} & \textbf{T0-Be-rech-nung} & \textbf{CODATA/Experimentell} & \textbf{Übereinstimmung} & \textbf{Status} \\
				\midrule
				$H_0$ (T0) & km/s/Mpc & siehe Dok.~026 & $\mathbf{66{,}2}$ & $67,4$ (Planck) & $\mathbf{1{,}9\%}$ & $\checkmark$ \\
				$H_0$ vs SH0ES & km/s/Mpc & siehe Dok.~026 & $\mathbf{66{,}2}$ & $74,0$ & $\mathbf{10{,}5\%}^*$ & $\triangle$ \\
				$H_0$ vs H0LiCOW & km/s/Mpc & siehe Dok.~026 & $\mathbf{66{,}2}$ & $73,3$ & $\mathbf{9{,}7\%}^*$ & $\triangle$ \\
				Universumsalter & Gyr & statisch: $\infty$ & $\mathbf{\infty}$ & $13,8$ & -- & $\triangle$ \\
				$H_0$ Energieeinheiten & eV & siehe Dok.~026 & $\mathbf{1{,}41\times10^{-33}}$ & T0-Vorhersage & $\mathbf{N/A}$ & $\star$ \\
				$E_H/E_P$-Verhältnis & 1 & siehe Dok.~026 & $\mathbf{1{,}15\times10^{-39}}$ & Theorie & $\mathbf{N/A}$ & $\star$ \\
				\bottomrule
			\end{tabular}
		}
	\end{table}
	...
	\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Hauptergebnisse der T0-Verifikation]
		...
		\begin{itemize}
			...
			\item Kosmologisches $H_0 \approx 66{,}2\,$km/s/Mpc (siehe Dokument~026)
