...
\begin{tabular}{lcc}
			...
			\midrule
			$H_0$ [km/s/Mpc] & 66,2$^*$ & parameterfrei \\
	...
	\end{table}
{$^*$Die parameterfreie T0-Vorhersage $H_0^{\text{T0}} = E_H/\hbar \approx 66{,}2\,$km/s/Mpc ($-1{,}9\%$ Abweichung von Planck) sowie die vollständige Auflösung der Hubble-Spannung sind in Dokument~026 (Geometrische Kosmologie) zentralisiert.}
...
\begin{tabular}{p{3cm}p{3cm}p{3cm}p{3cm}}
	...
	\begin{revolutionary}
		Die T0-Theorie besteht einen erfolgreichen Selbstkonsistenztest: Die aus der Teilchenphysik abgeleitete $\xi$-Konstante sagt die aus der CMB gemessene Vakuumenergiedichte vorher.
	\end{revolutionary}
...
\begin{tabular}{l l l l}
	...
	\begin{formula}
		...
		\begin{align}
			...
			T_{\text{CMB}} &= \frac{16}{9} \xi^2 \times E_\xi \quad \text{(CMB auf 0{,}0002\,\% vorhergesagt)} \\
	...
	\begin{enumerate}
		...
		\item \textbf{CMB ohne Inflation}: Die Theorie erklärt die CMB ohne Inflation und ohne eine Entkopplung bei irgendeinem kosmologischen $z$ (stationäre $\xi$-Feld-Thermalisierung in einem unendlich alten Universum) und leitet primordiale Störungen aus T-Feld-Quantenfluktuationen ab.
