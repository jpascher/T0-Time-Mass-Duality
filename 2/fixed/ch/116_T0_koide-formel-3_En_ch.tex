\section*{Abstract}
	...
	This formula is experimentally confirmed to $\Delta Q < 0.001\,\%$ (PDG 2024).
	The internal consistency of the T0 formulae achieves $\Delta Q < 0.00003\,\%$
	(agreement between T0 calculation and PDG values).
	...
	\begin{folgerung}
		...
		\begin{itemize}
			...
			\item The prefactors $(4/3, 16/5, 25/9)$ give approximate lepton masses ($\sim 1\,\%$ accuracy)
			\item $Q = 2/3$ follows from the experimental PDG masses (agreement $< 0.001\,\%$), not directly from the prefactors
	...
	\begin{theorem}
		...
		The symmetry empirically discovered in 1981 already contained the fundamental geometric constant $\xi = \frac{4}{3} \times 10^{-4}$, without this being recognized. T0 theory shows:
		...
		\begin{enumerate}
			...
			\item Extensions to neutrinos and hadrons reinforce the universality
		\end{enumerate}
	\end{theorem}
	
	\vspace{1cm}
	
	\noindent\textbf{Historical irony:} Koide discovered in 1981 a relation that already contained $\xi$, but only 40 years later does the geometric foundation become visible. The high accuracy of the Koide formula (matching experimental measurements to $< 0.001\%$) is no coincidence, but a consequence of its ratio-based nature.
