\section*{Abstract}
	...
	\begin{table}[h]
		...
		\resizebox{\textwidth}{!}{
			\begin{tabular}{>{\raggedright}p{4cm}ccccc}
				...
				Kosmologie & 4 & 55.2 & 41.0 & 69.7 & Modellabhängig$^*$ \\
				\bottomrule
			\end{tabular}
		}
	...
	\begin{longtable}{>{\raggedright}p{4.0cm}p{1.2cm}p{1.8cm}p{2.0cm}p{1.6cm}p{2.0cm}}
		...
		Alter des Universums & $t_{\text{Universum}}$ & $\infty$ & 4.351e+17 & -- & $\si{\second}$ \\
		Kritische Dichte & $\rho_{\text{krit}}$ & 3.001e-27 & 8.558e-27 & 65.0$^*$ & $\si{\kilogram \per \meter^3}$ \\
	...
	{\small $^*$Kosmologische Abweichungen: Die T0-Theorie sagt die Hubble-Energie $E_H = E_0 \cdot \xi^{41/4} = 1{,}41 \times 10^{-33}\,$eV vorher, woraus sich $H_0^{\text{T0}} = E_H/\hbar \approx 66{,}2\,$km/s/Mpc ergibt ($-1{,}9\%$ Abweichung von Planck). Der Exponent $41/4$ bedarf einer Begründung aus der $\xi$-Feldtheorie. In T0 ist das Universum statisch -- Alter, kritische Dichte und Hubble-Länge sind Friedmann-Konzepte ohne direkte T0-Entsprechung.}
	...
	\begin{itemize}
		...
		\item \textbf{Teilchen-r-Parameter:} $\frac{4}{3}$, $\frac{16}{5}$, $\frac{25}{9}$, $\frac{25}{2}$, $\frac{26}{9}$, $\frac{3}{2}$, $\frac{1}{28}$
