\section*{Abstract}
	...
	Diese Formel ist experimentell auf $\Delta Q < 0{,}001\,\%$ bestätigt (PDG 2024).
	Die interne Konsistenz der T0-Formeln erreicht $\Delta Q < 0{,}00003\,\%$
	(Übereinstimmung zwischen T0-Rechnung und PDG-Werten).
	...
	\begin{folgerung}
		...
		\begin{itemize}
			...
			\item Die Vorfaktoren $(4/3, 16/5, 25/9)$ liefern Näherungswerte für die Leptonmassen ($\sim 1\,\%$ Genauigkeit)
			\item $Q = 2/3$ folgt aus den experimentellen PDG-Massen (Übereinstimmung $< 0{,}001\,\%$), nicht aus den Vorfaktoren direkt
	...
	\begin{thebibliography}{99}
		...
		\url{https://doi.org/10.5281/zenodo.17390358}
