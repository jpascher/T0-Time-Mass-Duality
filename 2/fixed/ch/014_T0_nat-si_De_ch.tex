...
\textbf{5. Tiefgreifende Schlussfolgerung:} Die T0-Theorie \textbf{vorhersagt} die MeV-Massenskala
	...
	\begin{itemize}
		...
		\item Fraktale Korrektursverfahren für Präzisionsanpassung
	\end{itemize}
...
\end{table}
	...
	\begin{table}[h]
		...
		\begin{tabular}{p{3cm}p{10cm}}
			...
			$f_{\text{fraktal}}$ & Fraktale Korrektursfunktion \\
			...
			$\delta_n$ & Fraktale Korrekturskoeffizienten; dimensionslos \\
			\bottomrule
		\end{tabular}
