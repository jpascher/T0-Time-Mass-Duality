...
\begin{itemize}
	...
	\item \textbf{T0 theory:} Achieves \textbf{complete parameter-freedom} except for $\xi$, whereby units like time or length become secondary consequences of the geometric structure. Even the time unit emerges from $\xi$ through the Planck time $t_P = \sqrt{\hbar G/c^5}$ where both $G$ and $c$ are $\xi$-derived.
\end{itemize}
