\section*{Abstract}
	...
	\begin{longtable}{>{\raggedright}p{2cm}ccccccc}
		...
		Tau & $\frac{25}{9}$ & $\frac{2}{3}$ & 2.610e-03 & 1783.4 & 1776.9 & 0.37 \\
	...
	\begin{table}[h]
		...
		\resizebox{\textwidth}{!}{
			\begin{tabular}{>{\raggedright}p{4cm}ccccc}
				...
				Cosmology & 4 & 55.2 & 41.0 & 69.7 & Model-dependent$^*$ \\
				\bottomrule
			\end{tabular}
		}
	...
	\begin{longtable}{>{\raggedright}p{4.0cm}p{1.2cm}p{1.8cm}p{2.0cm}p{1.6cm}p{2.0cm}}
		...
		Age of the universe & $t_{\text{Universe}}$ & $\infty$ & 4.351e+17 & -- & $\si{\second}$ \\
		Critical density & $\rho_{\text{crit}}$ & 3.001e-27 & 8.558e-27 & 65.0$^*$ & $\si{\kilogram \per \meter^3}$ \\
		Hubble length & $l_{\text{Hubble}}$ & 2.314e+26 & 1.364e+26 & 69.7$^*$ & $\si{\meter}$ \\
	...
	{\small $^*$Cosmological deviations: T0 predicts the Hubble energy $E_H = E_0 \cdot \xi^{41/4} = 1.41 \times 10^{-33}\,$eV, yielding $H_0^{\text{T0}} = E_H/\hbar \approx 66.2\,$km/s/Mpc ($-1.9\%$ deviation from Planck). The exponent $41/4$ requires justification from $\xi$-field theory. In T0 the universe is static -- age, critical density and Hubble length are Friedmann concepts without direct T0 counterpart.}
	...
	\begin{itemize}
		...
		\item \textbf{Particle $r$ parameters:} $\frac{4}{3}$, $\frac{16}{5}$, $\frac{25}{9}$, $\frac{25}{2}$, $\frac{26}{9}$, $\frac{3}{2}$, $\frac{1}{28}$
