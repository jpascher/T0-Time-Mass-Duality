\section*{Abstract}
	...
	\begin{itemize}
		...
		\item ✓ Fraktale Korrektur $K_\text{frak}^{3/2}$ reduziert Abweichung von ~2\% auf 0{,}01--0{,}15\%
		\item ✓ Korrektur stimmt mit experimenteller Rekonstruktion auf 0{,}014\% überein
	\end{itemize}
	...
	\begin{itemize}
		\item \textbf{Einzelne Massen:} ~0{,}4--1{,}2\% Abweichung
	...
	\begin{align}
		...
		&= 1{,}114 \times 10^{-4} \\
		a_\tau^{\text{vorhergesagt}} &= 1{,}166 \times 10^{-3} + 1{,}114 \times 10^{-4} \\
		&= 1{,}280 \times 10^{-3}
	\end{align}
	...
	\begin{itemize}
		\item T0-Vorhersage (ideal): $a_\tau = 1{,}269 \times 10^{-3}$
		\item T0-Vorhersage (korrigiert): $a_\tau = 1{,}245 \times 10^{-3}$
		\item Aus Verhältnis: $a_\tau = 1{,}277 \times 10^{-3}$
	\end{itemize}
	...
	\begin{table}[h]
		...
		\resizebox{\textwidth}{!}{\begin{tabular}{lcc}
			...
			Aus Verhältnis & $1{,}277 \times 10^{-3}$ & Nur $f$ (exakt) \\
			\midrule
			Spannweite & $1{,}25$--$1{,}28 \times 10^{-3}$ & $\pm 1{,}3\%$ \\
			\bottomrule
		\end{tabular}}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			\item ✓ Bestätigt fraktale Korrektur $k_{\text{eff}} = k_\text{geom}/K_\text{frak}^{3/2}$
			\item ✓ Zeigt, dass die ~2\% Abweichung vollständig durch $K_\text{frak}^{3/2}$ erklärt wird
	...
	\begin{enumerate}
		...
		\item Testbare Tau-Vorhersage: $a_\tau = 1{,}245$--$1{,}277 \times 10^{-3}$
	\end{enumerate}
