...
\textbf{Der Faktor~3 ist die fraktale Dimension $D_f$.}
Die Peaks $3, 18, 42, 78$ sind nicht willkürlich -- sie sind genau
$D_f \cdot \{1, 6, 14, 26\}$ mit $D_f = 3 - \xi \approx 3$.
Das folgt aus der fraktalen Dispersionsrelation (Dok.~051):
\[
  k_\mathrm{eff}^2 = D_f \cdot k_\mathrm{Torus}^2
  \quad\Rightarrow\quad
  \ell^2 \propto D_f \cdot |n|^2 \approx 3\cdot|n|^2.
\]
Die T$^4$-Grundpeaks $|n|^2 = 1, 6, 14, 26$ werden durch $D_f$
auf die beobachtbare Serie $3, 18, 42, 78$ verschoben.
Die ``dazwischenliegenden'' Peaks ($|n|^2 = 6, 10, 14, \ldots$
im Torus-Spektrum) liegen nach Multiplikation mit $D_f$
\emph{zwischen} den CMB-Peaks -- daher nicht sichtbar.
Die vollständige Herleitung aus dem Tetrad-Formalismus
steht in Dok.~268.
