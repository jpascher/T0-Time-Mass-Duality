\section*{Abstract}
	...
	\begin{tcolorbox}[colback=blue!10!white, colframe=blue!75!black, title=Verweise auf komplementäre T0-Formulierungen]
		...
		\begin{itemize}
			...
			Zeigt, wie derselbe Parameter $\xi$ die kosmologische Rotverschiebung in einem statischen Universum erklärt (siehe Dokument~026)
		\end{itemize}
	...
	\begin{keyresult}
		...
		\begin{itemize}
			...
			\item \textbf{Hinweis:} Dieses Modell ($K_{\text{frak}} = 1 - (D_{\text{frak}}-2)/68$) ist eine vereinfachte Darstellung. Dok.~133 verwendet das äquivalente Modell $K_{\text{frak}} = 1 - 100\xi \approx 0{,}9867$ (vollständige Herleitung). Beide Modelle sind konsistent für Näherungsrechnungen; für Präzisionsvorhersagen gilt Dok.~133.
	...
	\begin{itemize}
		\item \textbf{Sub-atomare Skala:} Anomale magnetische Momente
		\item \textbf{Teilchenphysik:} Leptonmassen, Feinstrukturkonstante
		\item \textbf{Kosmologische Skala:} Hubble-Konstante, Rotverschiebung
	\end{itemize}
