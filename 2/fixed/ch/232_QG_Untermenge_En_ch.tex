...
In FFGFT the full geometry lives on a 4-torus $T^4 = T^3 \times S^1$.
...
remembers that the graph came from a 4-torus triangulation. In
...
The 4-torus has a very specific topology: four compact loops, each
...
4-torus geometry, every point can be connected to every other --
yielding $K_N$.
...
\midrule
4-torus $T^4$ & complete graph $K_N$ & discretisation + topology forgetting \\[3pt]
