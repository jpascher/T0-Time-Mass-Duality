...
\begin{itemize}
  ...
  \item $\xi_\text{UIFT}$: dimensionless parameter of the UIFT framework (Doc.~190~R13), related to $\xi_\text{FFGFT}$ via the bridge factor $414{,}684$
\end{itemize}
...
$\xi_\text{UIFT}$ & Dimensionless parameter of UIFT: $k_BT_\text{CMB}\ln 2/(m_ec^2)$ (Doc.~190 R13) \\
...
\begin{enumerate}
  ...
  \item The \texorpdfstring{$\tau\cdot\mu$}{tau.mu} identity confirms structural alignment at the
  ...
  \item The appropriate response to Marco Gericke's mail:
    \begin{enumerate}
      ...
      \item[(c)] Propose a joint short note: mapping $\xi_\text{FFGFT}$ to the
        ...
        where $\xi_\text{UIFT}$ is the dimensionless parameter of the UIFT framework),
