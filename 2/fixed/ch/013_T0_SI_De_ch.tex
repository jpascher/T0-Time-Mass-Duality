\section*{Abstract}
	...
	\begin{insight}
		...
		\begin{equation}
			\frac{\xi_{\text{FFGFT}}}{\xi_{\text{UIFT}}} = \frac{m_e c^2 / \text{eV}}{(16/9) \cdot \ln 2} \approx 414\,684
		\end{equation}
	...
	Der Faktor $\xi_{\text{FFGFT}}/\xi_{\text{UIFT}} \approx 414\,684$ ist mehr als
	...
	$\approx 414\,684$ ist nichts anderes als der Projektionsfaktor zwischen einer
