...
\begin{tabular}{lcccccc}
	...
	\begin{thebibliography}{99}
		\bibitem{pascher_t0_energie_2025_en}
		Pascher, J. (2025). \textit{The T0 Model (Planck-Referenced): A Reformulation of Physics}. Available at: 
		
		\bibitem{pascher_derivation_2025_en}
		Pascher, J. (2025). \textit{Field-Theoretic Derivation of the $\beta_T$ Parameter in Natural Units ($\hbar = c = 1$)}. Available at: 
		
		\bibitem{pascher_qft_2025_en}
		Pascher, J. (2025). \textit{Complete Derivation of the Higgs Mass and Wilson Coefficients}. T0-Theory Project Documentation.
		
		\bibitem{pascher_units_2025_en}
		Pascher, J. (2025). \textit{Natural Unit Systems: Universal Energy Conversion and Fundamental Length-Scale Hierarchy}. Available at: 
		
		\bibitem{katrin_2024_en}
		KATRIN Collaboration. (2024). \textit{Direct Neutrino-Mass Measurement Based on 259 Days of KATRIN Data}. arXiv:2406.13516.
		
		\bibitem{nufit_2024_en}
		...
		\bibitem{gell_mann_1964_en}
		Gell-Mann, M. (1964). \textit{A schematic model of baryons and mesons}. Physics Letters, 8(3), 214--215.
		
		\bibitem{mendeleev_1869_en}
		Mendeleev, D. (1869). \textit{On the Relations of the Properties to the Atomic Weights of the Elements}. Zeitschrift für Chemie, 12, 405--406.
		
		\bibitem{muon_g2_2023_en}
