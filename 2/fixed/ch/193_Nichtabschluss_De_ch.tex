...
\midrule
$\mathcal{T}_i = (n_i, l_i, j_i)$ & Torusmode des Teilchens $i$: Haupt-, Bahn-, Spinquantenzahl \\
$r_i = f(\mathcal{T}_i)$ & Geometrischer Vorfaktor (injektiv aus Quantenzahlen) \\
$p_i = g(\mathcal{T}_i)$ & Exponent in der Massenformel \\
$\mathcal{P}$ & Menge aller in FFGFT zulässigen Paare $(r_i, p_i)$ \\
$v = 246\,\text{GeV}$ & Higgs-Vakuumerwartungswert (Skalenfaktor) \\
$\xi_0 = 4/30000$ & Geometrischer Basisparameter \\
$K_{\text{frak}}$ & Fraktale Korrektur ($\approx 0{,}986$) \\
$\mathbb{R}$ & Reelle Zahlen (Messwerte ohne Strukturerinnerung) \\
$\mathbf{v}_e \otimes \mathbf{v}_\mu$ & Tensorprodukt-Zustand (bedeutungslos in Ein-Teilchen-Theorie) \\
$(64/15,\;5/2)$ & Kreuzprodukt-Paar --- nicht in $\mathcal{P}$, kein FFGFT-Teilchen \\
\bottomrule
\end{tabular}
}
\end{center}
