...
# ---------------------------------------------------------------------------
print("\n" + "-"*70)
print("1. GRAVITATIONSKONSTANTE G")
print("-"*70)

print("\nSymbolische Formel:")
print("   G = (tp_eff² × c⁵) / ℏ")
print("\nEinsetzen der Definitionen:")
print("   G = ((t₀ × f_ideal)² × c⁵) / ℏ")
print("   G = ((t₀ × 30000/4)² × c⁵) / ℏ")
print("   G = (t₀² × (7500)² × c⁵) / ℏ")
...
print(f"   G_B18 = {G_b18:.12e} m³/(kg·s²)")
print(f"   G_Exp = {G_exp:.12e} m³/(kg·s²)")
print(f"   Abweichung: {abs(G_b18-G_exp)/G_exp*100:.4f}%")

print("\nÄquivalente Form (mit temporaler Skala):")
print("   G = k_G / (T × π)")
print("   wobei T = 100 Mio Jahre")
print("         k_G = G × T × π (aus obiger Formel berechnet)")
