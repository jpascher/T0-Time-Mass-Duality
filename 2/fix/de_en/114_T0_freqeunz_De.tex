...
% Standardized preamble - T0_freqeunz_De.tex
...
\begin{document}
	...
	\begin{itemize}
		\item In verschiedenen Dokumenten (z. B. Lerner oder Timescape) wird ,,tired light`` oft impliziert, aber die fehlende Frequenzabhängigkeit schwächt sie – z. B. Lerners Absorption wäre abhängig, passt aber nicht zu Supernovae-Spektren. Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) (Pascher) vermeidet dies, indem sie Rotverschiebung als Feld-Effekt sieht, ohne explizite Abhängigkeit.
	...
	\begin{enumerate}
		\item \textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) Grundlagen (Englisch)} \\
		...
		\item \textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) Grundlagen (Deutsch)} \\
		\href{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Framework_De.pdf}{T0\_Framework\_De.pdf} - Mathematische Grundlagen der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie), Feldgleichungen und Massenvariation (2024)
		...
		\href{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Cosmology_De.pdf}{T0\_Cosmology\_De.pdf} - Kosmologische Anwendungen der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie), Hubble-Parameter, Dunkle Energie (2024)
