...
\begin{document}
	...
	\title{Erweiterung: Fraktale Dualität in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) – Jenseits konstanter Zeit}
	\maketitle
...
% Tabelle 1: Erste drei Aspekte
	\resizebox{\textwidth}{!}{%
		\begin{tabularx}{\textwidth}{XXXX}
			\toprule
			\textbf{Berechnungsaspekt} & \textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)} & \textbf{DoT-Theorie} & \textbf{Parallele / Gemeinsamkeit} \\
			\midrule
