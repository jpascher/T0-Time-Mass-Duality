...
% Entferne die physik-Paket-Konflikte
...
\title{Kapitel 34: Lösung des Strong-CP-Problems in der fraktalen T0-Geometrie}
\author{}
\date{}
...
\begin{document}
	...
	\begin{tcolorbox}[title={\textbf{Wichtige Symbole und ihre Einheiten}}, colback=blue!5!white, colframe=blue!75!black]
		\begin{tabular}{p{0.25\textwidth}p{0.35\textwidth}p{0.3\textwidth}}
			...
			\(\theta_{\text{QCD}}\) & CP-verletzender Parameter in QCD & dimensionslos (radiant) \\
			\(\theta(x,t)\) & Lokales Vakuumphasenfeld & dimensionslos (radiant) \\
			\(G \tilde{G}\) & Topologischer Term in QCD-Lagrange & \si{\per\meter\tothe{4}} \\
			\(\Lambda_{\text{QCD}}\) & QCD-Skala & \si{\mega\electronvolt} \\
			\(\delta \theta\) & Fraktale Phasenfluktuation & dimensionslos (radiant) \\
			\(m_n\) & Neutronenmasse & \si{\kilo\gram} \\
			\(\theta_n\) & Neutronen-EDM-Winkel & dimensionslos \\
			\(d_n\) & Neutronen-elektrisches Dipolmoment & \si{\elementarycharge\meter} \\
