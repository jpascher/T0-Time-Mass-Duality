\chapter{Chapter 25: The Neutrino Mass Problem in Fractal T0 Geometry}
\label{chap:25-en}
...
\begin{equation}
	m_0^\nu \approx \frac{\hbar}{c l_0} \cdot \xi^3 \approx 0.05~\text{eV}/c^2.
\end{equation}
...
\textbf{Unit check:}
\begin{align*}
[m_0^\nu] &= \text{J}\cdot\text{s} / (\text{m/s} \cdot \text{m}) = \text{kg} \quad (\text{converted to eV}/c^2).
\end{align*}
