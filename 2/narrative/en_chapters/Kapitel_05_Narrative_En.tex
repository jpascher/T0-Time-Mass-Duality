...
The speed of light is thus not a fundamental constant, but emerges from the relationship between the fractal parameter $\xi$ and the fundamental time scale $T_0 = 1/\sqrt{\xi}$ (in natural units $c = \hbar = 1$). In SI units this corresponds to $t_0 = \hbar/E_0 \approx 8.9 \times 10^{-23}$~s with $E_0 = \sqrt{m_e \cdot m_\mu} \approx 7.4$~MeV.
