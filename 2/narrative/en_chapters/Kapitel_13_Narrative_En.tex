...
\section*{Introduction}
	...
	\begin{aligned}
		...
		\theta &= \text{constant} \quad \text{(static, disordered time struct.)} \\
	...
	The "beginning" is not a point of infinite density, no mathematical pathology. It is a regular physical transition with a tiny but finite core radius $L_0$ -- comprehensible, calculable, non-singular.
