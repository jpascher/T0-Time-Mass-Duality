\chapter{Alternative to GR + $\Lambda$CDM in Fractal T0 Geometry  Narrative Version of FFGFT}
	...
	These equations describe, within the standard model, the expansion of the universe depending on matter, radiation, curvature, and a cosmological constant. In FFGFT, this ``expansion'' is reinterpreted as fractal scale change. However, the model typically requires six or more free parameters and additional assumptions such as inflation and dark matter particles.
	...
	where $l_0 = l_P \cdot \xi \approx \SI{2.15e-39}{\meter}$ is the fundamental correlation length.
