...
\end{equation}
	...
	\begin{center}
		\begin{tabular}{p{0.45\textwidth}p{0.45\textwidth}}
			...
			\hline
			Point-like, instantaneous & Delocalised, phase-coherent \\
