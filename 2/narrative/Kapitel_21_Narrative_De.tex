...
\title{\textbf{Kapitel 21: Teilchenmassen aus der Hierarchie} \\
\large Teilchenphysik 1 \\
...
In den vorherigen Kapiteln haben wir die Grundlagen der Fundamentalen Fraktalgeometrischen Feldtheorie (FFGFT) kennengelernt. Dieses Kapitel widmet sich nun spezifisch der Frage: wie teilchenmassen aus der hierarchie durch $\xi$ erklärt werden
...
Die Behandlung von \textbf{Teilchenmassen aus der Hierarchie} in der FFGFT folgt direkt aus der fraktalen Geometrie und der Zeit-Masse-Dualität.

\subsection{Grundlegende Überlegungen}

In diesem Kontext ist besonders wichtig zu verstehen, dass wie teilchenmassen aus der hierarchie durch $\xi$ erklärt werden
...
In diesem Kapitel haben wir untersucht, wie die FFGFT teilchenmassen aus der hierarchie behandelt. Die zentrale Erkenntnis bleibt: Der Parameter $\xi$ und die fraktale Struktur der Raumzeit genügen, um alle beobachteten Phänomene zu erklären.
