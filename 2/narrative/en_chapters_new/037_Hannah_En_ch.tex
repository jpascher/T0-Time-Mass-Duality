...
% Original: \chapter{\Huge\textbf{FFGFT: Connections to Mizohata-Takeuchi Counterexample}
\chapter{FFGFT: Connections to Mizohata-Takeuchi Counterexample}
...
\section*{Abstract}
	...
	the FFGFT forecasts quantifiable deviations in quantum wavepacket spreading and spectral linewidths within fractal media:
	...
	\begin{thebibliography}{5}
		...
		\bibitem{T0_g2_erweiterung} J. Pascher, ``g-2 Extension of the FFGFT: Fractal Dimensions,'' T0-Repo, v2.0 (2025). \href{https://github.com/jpascher/T0-Time-Mass-Duality/raw/main/2/tex/T0_g2-erweiterung-4_En.tex}{Download}.
