...
\chapter{FFGFT: The T0-Time-Mass Duality}
...
\section*{Abstract}
	...
	\begin{explanation}
		...
		The reduction from $4.2\sigma$ to $0.6\sigma$ discrepancy is consistent with FFGFT:
		\begin{itemize}
...
\begin{tabular}{L{2.5cm}C{2cm}C{2cm}L{3.5cm}}
			...
			Mass Scaling & $m_\ell^2$ & - & Fundamental prediction of FFGFT \\
			\bottomrule
		\end{tabular}
	...
	\section{Key Features of FFGFT}
	
	\subsection{Quadratic Mass Scaling}
	
	\begin{keyresult}
		The fundamental prediction of FFGFT is the quadratic mass scaling:
		\begin{align}
	...
	\begin{keyresult}
		the FFGFT contains no free parameters:
		\begin{itemize}
