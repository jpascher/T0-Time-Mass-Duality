% Chapter file: 065_redshift_deflection_En_ch.tex
% Source: 065_redshift_deflection_En.tex

\chapter{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Rotverschiebungsmechanismus}
...
\allowdisplaybreaks
	...
	\begin{equation}
		\int_{\lambdazero}^{\lambda} d\lambda' = \frac{\xi}{\Exi} \int_0^x dx'
	\end{equation}
	
	Dies ergibt:
	\begin{equation}
		\lambda - \lambdazero = \frac{\xi x}{\Exi}
	\end{equation}
	...
	F\"ur kleine $\xi$-Effekte, wo $\frac{\xi x}{\Exi} \ll \lambdazero$, k\"onnen wir entwickeln:
	\begin{equation}
		z \approx \frac{\xi x}{\Exi \lambdazero} = \frac{\xi x \cdot E_0}{\Exi} \quad (\text{nat\"urliche Einheiten, da } E_0 = 1/\lambdazero)
	\end{equation}
	
	\begin{important}
		\textbf{Schl\"ussel-T0-Vorhersage: Wellenl\"angenabh\"angige Rotverschiebung}
		\begin{equation}
			\boxed{z(\lambdazero) = \frac{\xi x}{\Exi \lambdazero} \quad (\text{nat\"urliche Einheiten, } \hbar = c = 1)}
		\end{equation}
		...
		\begin{itemize}
			...
			\item Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): $z$ variiert mit der Wellenl\"ange -- $z \propto 1/\lambda_0$ (gr\"o\ss{}ere $z$ f\"ur k\"urzere $\lambda_0$) - testbare Vorhersage!
		\end{itemize}
	...
	\begin{formula}
		...
		\end{equation}
		(nat\"urliche Einheiten: $h = 1$; konventionelle Einheiten: $h = \hbar$)
	\end{formula}
	...
	\begin{equation}
		\frac{z(\lambda_1)}{z(\lambda_2)} = \frac{\lambda_2}{\lambda_1}
	\end{equation}
	...
	\begin{experiment}
		...
		\begin{itemize}
			...
			\item Vorhergesagtes Verh\"altnis: $\frac{z_{\text{Ly}\alpha}}{z_{\text{H}\alpha}} = \frac{656,3}{121,6} \approx 5,40$
	...
	\begin{itemize}
		...
		\item Vorhergesagtes Verh\"altnis: $\frac{z_{21\text{cm}}}{z_{\text{H}\alpha}} = \frac{6,563 \times 10^{-7}}{0,21} \approx 3,1 \times 10^{-6}$
	\end{itemize}
	...
	\begin{experiment}
		...
		\begin{enumerate}
			...
			\item Test ob $z \propto 1/\lambda$ Beziehung gilt
	...
	Die Vorhersage der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) einer wellenl\"angenabh\"angigen Rotverschiebung stellt eines ihrer markantesten und testbarsten Merkmale dar. Die aktuelle experimentelle Situation ist jedoch komplex und erfordert eine sorgf\"altige Analyse.
	...
	Wenn Messungen $z \propto 1/\lambda_0$ wie vorhergesagt detektieren:
	...
	\begin{formula}[title=Drei Kompensationsmechanismen]
		...
		\begin{enumerate}
			\item \textbf{IGM-Dispersion}: $z_{\text{IGM}} \propto -\lambda^{-2}$ (wirkt $z_{\text{T0}} \propto 1/\lambda$ entgegen)
			\item \textbf{Gravitations-Schichtung}: $z_{\text{grav}}(r(\lambda))$ variiert mit Emissionstiefe
			\item \textbf{Nichtlineare Korrekturen}: H\"ohere Ordnungsterme $\propto (\xi x /\Exi \lambda_0)^n$ fl\"achen Antwort ab
		\end{enumerate}
	...
	\begin{itemize}
		\item T0-Effekt: $z_{\text{T0}} \propto 1/\lambda$ (k\"urzere Wellenl\"angen st\"arker rotverschoben)
	...
	F\"ur angemessene IGM-Dichte k\"onnte dies T0s inverse lineare $\lambda$-Abh\"angigkeit pr\"azise aufheben.
	...
	\begin{equation}
		z = \frac{\xi x }{\Exi \lambda_0}\left[1 - \alpha\left(\frac{\xi x }{\Exi \lambda_0}\right) + \beta\left(\frac{\xi x }{\Exi \lambda_0}\right)^2 + ...\right]
	\end{equation}
	...
	Wenn Kompensation best\"atigt wird, ben\"otigt die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie):
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) steht an einem kritischen Wendepunkt. Die Vorhersage der wellenl\"angenabh\"angigen Rotverschiebung wird entweder:
	...
	\begin{experiment}
		...
		\begin{enumerate}
			...
			\item Anpassung linearer Beziehung: $z = \alpha / \lambda + \beta$
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) beschreibt ein statisches, ewig existierendes Universum, in dem:
	\begin{itemize}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) hat nat\"urliche Anpassungsmechanismen:
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) bietet eine revolution\"are Alternative zur expansionsbasierten Kosmologie durch eine einzige universelle Konstante $\xiconst$. Die Vorhersage der wellenl\"angenabh\"angigen Rotverschiebung bietet einen klaren experimentellen Test zur Unterscheidung zwischen T0 und Standardkosmologie. W\"ahrend die aktuelle Pr\"azision kaum die Nachweisschwelle erreicht, sollten spektroskopische Instrumente der n\"achsten Generation diese fundamentale Vorhersage definitiv testen.
	...
	\begin{thebibliography}{99}
		...
		\bibitem{pascher2025}
		Pascher, Johann (2025). 
		\textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Vollst\"andige Herleitung und experimentelle Tests}. 
		T0-Theory Project. 
