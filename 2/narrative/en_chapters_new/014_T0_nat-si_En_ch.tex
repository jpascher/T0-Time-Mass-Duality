...
\begin{itemize}
    ...
    \item $\xi$ -- Fundamental geometry parameter of FFGFT; $\xi = \frac{4}{3} \times 10^{-4}$
    \item $E_0$ -- Reference energy in FFGFT; $E_0 = 7.400~\mathrm{MeV}$
    ...
    \item $\alpha = \xi (E_0/1\mathrm{MeV})^2$ -- Fundamental relationship in FFGFT
