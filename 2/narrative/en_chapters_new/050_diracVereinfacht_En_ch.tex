...
\chapter{Simplified Dirac Equation in FFGFT:}
...
\section*{Abstract}
	...
	the FFGFT reveals that what we call ``electrons'' and other fermions are simply **field node patterns** in the universal field $\deltam(x,t)$:
	...
	\section{Simplified Dirac Equation in FFGFT}
	
	\subsection{From Spinors to Field Nodes}
	
	In the FFGFT, the Dirac equation becomes:
