% Chapter file: 116_T0_koide-formel-3_En_ch.tex
% Source: 116_T0_koide-formel-3_En.tex
...
\section*{Abstract}
	...
	In the FFGFT, particle masses arise from:
	...
	\begin{table}[h]
		...
		\begin{tabular}{lcc}
			\toprule
			\textbf{Aspect} & \textbf{Koide (1981)} & \textbf{FFGFT} \\
			\midrule
	...
	The fine structure constant in the FFGFT:
	...
	the FFGFT reveals a deep connection:
	...
	\begin{theorem}
		...
		The symmetry empirically discovered in 1981 already contained the fundamental geometric constant $\xi = \frac{4}{3} \times 10^{-4}$, without this being recognized. the FFGFT shows:
	...
	\begin{thebibliography}{99}
		...
		J. Pascher, ``FFGFT: Foundations of the Time-Mass Duality Framework'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Grundlagen_en.pdf}
		
		\bibitem{T0Feinstruktur}
		J. Pascher, ``FFGFT: Derivation of the Fine Structure Constant from $\xi$'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Feinstruktur_En.pdf}
		
		\bibitem{T0Gravitation}
		J. Pascher, ``FFGFT: Geometric Derivation of the Gravitational Constant'', HTL Leonding (2024). 
		...
		J. Pascher, ``FFGFT: Systematic Calculation of Particle Masses'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Teilchenmassen_En.pdf}
		
		\bibitem{T0SI}
		J. Pascher, ``FFGFT: SI Reform 2019 as $\xi$-Calibration'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_SI_En.pdf}
		
		\bibitem{T0Verhaeltnis}
		J. Pascher, ``FFGFT: Ratios vs. Absolute Values -- Fractal Corrections'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_verhaeltnis-absolut_En.pdf}
		
		\bibitem{T0MuonG2}
		J. Pascher, ``FFGFT: Anomalous Magnetic Moments and Muon g-2'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Anomale_Magnetische_Momente_En.pdf}
		
		\bibitem{T0QFT}
		J. Pascher, ``FFGFT: Quantum Field Theory and Relativity Theory'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_QM-QFT-RT_En.pdf}
		
		\bibitem{T0Bibliographie}
		J. Pascher, ``FFGFT: Complete Bibliography (131+ Documents)'', HTL Leonding (2024). 
