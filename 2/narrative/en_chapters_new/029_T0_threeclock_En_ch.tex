% Chapter file: 029_T0_threeclock_En_ch.tex
% Source: 029_T0_threeclock_En.tex

% Original: \chapter{\textbf{Single-Clock Metrology and the Three-Clock Experiment}
...
of the article and relates them to the FFGFT. In particular, it compares
...
In the FFGFT, \texttt{T0\_SI\_En} develops a comprehensive derivation
...
This basic assumption is directly analogous to the FFGFT, where the
...
In the FFGFT, this observation appears explicitly in \texttt{T0\_xi-and-e\_En}
in the form
\begin{equation}
  T \cdot m = 1 \, .
\end{equation}
...
\begin{itemize}
  ...
  \item the FFGFT formulates the duality explicitly and anchors it in the
...
the FFGFT addresses this issue by introducing Planck length, Planck time
...
the FFGFT, especially in \texttt{T0\_SI\_En}, \texttt{T0\_xi\_origin\_En}
...
J.~Pascher,
\textit{FFGFT: Complete conclusion of the FFGFT – From $\xi$ to the SI 2019 reform},
HTL Leonding, 2024,
...
J.~Pascher,
\textit{FFGFT: $\xi$ and $e$ – The fundamental connection},
HTL Leonding, 2025,
