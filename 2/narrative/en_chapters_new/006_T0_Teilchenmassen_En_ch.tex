...
\title{\textbf{FFGFT: Particle Masses}}
\section*{Abstract}
	...
	\begin{keyresult}
		...
		the FFGFT claims that all particle masses can be calculated from a single geometric parameter:
	...
	the FFGFT offers two complementary but mathematically equivalent approaches:
...
\normalsize
	...
	\begin{keyresult}
		...
		The equivalence shows that the FFGFT provides a unified description that is both geometrically fundamental and experimentally accessible.
	\end{keyresult}
...
\normalsize
	...
	\begin{warning}
		\textbf{Neutrinos: A Special Case of the FFGFT}
	...
	\begin{table}[h]
		...
		\begin{tabular}{lcc}
			\toprule
			\textbf{Aspect} & \textbf{Standard Model} & \textbf{FFGFT} \\
			\midrule
			...
			\bottomrule
		\end{tabular}
		\caption{Comparison: Standard Model vs. FFGFT for Particle Masses}
	\end{table}
