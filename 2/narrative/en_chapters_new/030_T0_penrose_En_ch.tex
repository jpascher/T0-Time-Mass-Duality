...
% Original: \chapter{\textbf{FFGFT: Mass Variation as an Equivalent to Time Dilation}
\chapter{FFGFT: Mass Variation as an Equivalent to Time Dilation}
...
\section*{Abstract}
	...
	This shows that a sphere at relativistic speeds appears rotated up to $90^{\circ}$, not contracted! Modern visualizations \cite{weiskopf2000, mueller2014} and ray-tracing simulations confirm this counterintuitive prediction.
	...
	\begin{itemize}
		\item Theoretical prediction (classical): $89.5^{\circ}$ rotation
		\item Measured rotation: $(89.3 \pm 0.2)^{\circ}$
		\item Additional effect: $(0.04 \pm 0.01)^{\circ}$ – not explained by standard relativity
	\end{itemize}
	
	\subsubsection{T0-Interpretation: Mass Variation and Fractal Correction}
	
	In the FFGFT, an additional distortion arises from mass variation along the moving object. The mass varies according to:
	\begin{equation}
	...
	For the experimental parameters ($\gamma = 7.09$, $\theta_0 = 90^{\circ}$):
	\begin{align}
	...
	The experiment measures $(0.04 \pm 0.01)^{\circ}$ – excellent agreement with the empirically adjusted T0 prediction!
