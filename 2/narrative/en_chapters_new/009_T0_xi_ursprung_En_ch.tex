...
\begin{tabular}{lccc}
	...
	In FFGFT, $\kappa = 7$ corresponds to a \textbf{complete octavation} of the mass spectrum:
	\begin{itemize}
...
%}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{p{3cm}p{8cm}p{3cm}}
			...
			\midrule
			$\xi$ & Fundamental geometric parameter of FFGFT & $\frac{4}{30000} \approx 1.333\times10^{-4}$ \\
			...
			\bottomrule
		\end{tabular}
		\caption{Fundamental parameters of FFGFT}
	\end{table}
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025). \textit{FFGFT: Foundations and Extensions}.
