...
% Original: \chapter{\textbf{T0 Cosmology: Redshift as a Geometric Path Effect in a Static Universe}
\chapter{T0 Cosmology: Redshift as a Geometric Path Effect in a St...}
...
\allowdisplaybreaks
	...
	\begin{thebibliography}{9}
		...
		J. Pascher, \textit{FFGFT: Summary of Findings}, T0-Document Series, Nov. 2025.
