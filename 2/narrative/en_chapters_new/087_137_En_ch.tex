% Chapter file: 087_137_En_ch.tex
% Source: 087_137_En.tex
...
\section{The Century-Old Riddle}
	...
	the FFGFT reveals that everyone had been looking at the problem backwards. The fine-structure constant is not fundamental - it is \textbf{derived}.
	...
	Starting from $\xi$ alone, the FFGFT derives:
	...
	the FFGFT makes precise predictions with \textbf{zero} free parameters:
...
\begin{tabular}{lccc}
				\toprule
				\textbf{Parameter} & \textbf{FFGFT} & \textbf{Musical Spiral} & \textbf{Experiment} \\
				\midrule
