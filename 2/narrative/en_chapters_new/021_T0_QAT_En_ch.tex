% Chapter file: 021_T0_QAT_En_ch.tex
% Source: 021_T0_QAT_En.tex

% Original: \chapter{\textbf{T0-QAT: $\xi$-Aware Quantization-Aware Training}
...
\section*{Abstract}
	...
	The parameter $\xi = \frac{4}{3} \times 10^{-4}$ is not an empirical optimization but derives from first principles in the Fundamental Fractal-Geometric Field Theory (FFGFT), previously known as Fundamental Fractal-Geometric Field Theory (FFGFT),. This fundamental constant represents the minimal noise floor inherent in physical systems and provides a natural regularization boundary for numerical precision limits.
	
	The complete theoretical derivation is available in the FFGFT GitHub Repository\footnote{\url{https://github.com/jpascher/T0-Time-Mass-Duality/releases/tag/v3.2}}, including:
	\begin{itemize}
...
\begin{tabular}{lccc}
	...
	\begin{verbatim}
		# Fundamental constant from FFGFT
		xi = 4.0/3 * 1e-4
