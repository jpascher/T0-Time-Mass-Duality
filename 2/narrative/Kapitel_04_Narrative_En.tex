...
\usepackage{siunitx} % Für korrekte Einheiten und Exponenten
...
\title{\textbf{Chapter 4: Modifizierte Schwarzschild-Metrik in T0} \\
	\large Schwarze Löcher ohne Singularitäten \\
...
\begin{document}
	...
	\begin{center}
		...
		\begin{tabular}{p{0.28\textwidth}|p{0.32\textwidth}|p{0.32\textwidth}}
			\toprule
			\textbf{Aspekt} & \textbf{Allgemeine Relativität} & \textbf{Fraktale FFGFT} \\
			\midrule
			Zentrale Krümmung & Unendlich (Singularität) & Endlich: \(\leq \xi^2 / l_P^2\) \\
			Innere Struktur & Punktmasse & Fraktaler Kern mit \(r_c \approx r_s \xi^{1/2}\) \\
			Information & Verloren (Paradoxon) & Erhalten in Fraktalstruktur \\
			Parameter & Keiner (aber inkomplett) & Nur \(\xi\) \\
			\bottomrule
		\end{tabular}
	\end{center}
	...
	\section{Conclusion: Schwarze Löcher als Fenster in die Fraktalität}
	...
	In den nächsten Chaptern erkunden wir, wie diese Metrik Quantengravitation ermöglicht und Dunkle Materie erklärt.
