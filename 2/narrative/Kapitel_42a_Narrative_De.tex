...
\usepackage{hyperref}
\usepackage{siunitx}
\usepackage{array}  % Added for better table control

% Set geometry BEFORE fancyhdr setup
...
\hypersetup{
	...
	pdfencoding=unicode,
	bookmarksopen=true,
	pdftitle={Kapitel 42: Planck-Einheiten und universelle Konstanten in der fraktalen T0-Geometrie},
	pdfauthor={}
}

\DeclareSIUnit\plancklength{\ell_P}
\DeclareSIUnit\planckmass{m_P}
\DeclareSIUnit\plancktime{t_P}
...
\pdfstringdefDisableCommands{%
	...
	\def\psi{psi}%
	\def\xi{xi}%
	\def\hbar{\text{hbar}}%  Added to fix the issue
}
