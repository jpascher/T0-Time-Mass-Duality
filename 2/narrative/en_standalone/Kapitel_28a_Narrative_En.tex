...
\title{\textbf{Chapter 28: Why Newton's Law Does Not Apply to Quantum Particles in Fractal T0 Geometry} \\
...
\begin{document}
	...
	\begin{equation}
		[\delta \rho] = \text{dimensionless} \cdot \si{kg^{1/2}/m^{3/2}} \cdot \text{dimensionless} = \si{kg^{1/2}/m^{3/2}}.
	\end{equation}
