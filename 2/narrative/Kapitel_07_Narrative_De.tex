...
\title{\textbf{Kapitel 7: Gravitationsregime} \\
\large Stark-, Schwach- und Tieffeld \\
...
In den vorherigen Kapiteln haben wir die Grundlagen der Fundamentalen Fraktalgeometrischen Feldtheorie (FFGFT) kennengelernt. Dieses Kapitel widmet sich nun spezifisch der Frage: wie die drei Regime der Gravitation durch $\xi$ vereinheitlicht werden
...
Die Behandlung von \textbf{Gravitationsregime} in der FFGFT folgt direkt aus der fraktalen Geometrie und der Zeit-Masse-Dualität.

\subsection{Grundlegende Überlegungen}

In diesem Kontext ist besonders wichtig zu verstehen, dass wie die drei regime der gravitation durch $\xi$ vereinheitlicht werden
...
In diesem Kapitel haben wir untersucht, wie die FFGFT gravitationsregime behandelt. Die zentrale Erkenntnis bleibt: Der Parameter $\xi$ und die fraktale Struktur der Raumzeit genügen, um alle beobachteten Phänomene zu erklären.
