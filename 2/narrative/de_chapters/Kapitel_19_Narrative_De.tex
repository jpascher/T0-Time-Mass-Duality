\chapter{Vakuumfluktuationen und die Lösung des kosmologischen Konstantenproblems in T0}
	...
	\textbf{Einordnung:} Die reine \(\xi^2\)-Skalierung ergibt \(\rho_{\text{vac}} \sim 1{,}8 \times 10^{-8} \, \rho_{\text{crit}}\) -- das ist bereits eine dramatische Verbesserung gegenüber der QFT-Vorhersage, die um \(10^{120}\) Größenordnungen zu hoch liegt. Die FFGFT reduziert die Diskrepanz von 120 auf etwa 8 Größenordnungen. Der verbleibende Vorfaktor, der \(\rho_{\text{vac}}\) auf den beobachteten Wert \(\Omega_\Lambda \approx 0{,}7\) bringt, hängt von der \(\rho_0\)-Skalierung und den Umrechnungsfaktoren natürliche \(\to\) SI-Einheiten ab (siehe Dok~008, 091). Die exakte Übereinstimmung erfordert die vollständige Berücksichtigung der fraktalen Moduszählung bei effektiver Dimension \(d = 3 + \delta\) mit \(\delta \sim \xi\).
	...
	\begin{center}
		...
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{p{0.45\textwidth}p{0.45\textwidth}}
				...
				120 Größenordnungen zu hoch & Richtige Größenordnung ($\sim 8$ Ordnungen verbleibend) \\
