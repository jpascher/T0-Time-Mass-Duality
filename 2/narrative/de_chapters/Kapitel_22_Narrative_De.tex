\chapter{Kapitel 22: Maximale Masse für makroskopische Quantenüberlagerung in der fraktalen T0-Geometrie}
\label{chap:22}
...
\section*{Kapitel 22: Maximale Masse für makroskopische Quantenüberlagerung in der fraktalen T0-Geometrie}
	...
	\begin{center}
		\begin{tabular}{p{0.45\textwidth}p{0.45\textwidth}}
			...
			Keine feste Vorhersage & \(\approx \SI{1.2e8}{\u}\) \\
		\end{tabular}
	\end{center}
