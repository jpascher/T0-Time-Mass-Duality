\chapter{Ableitung des Pauli'schen Ausschlussprinzips in der fraktalen T0-Geometrie}
	...
	Die Steifigkeit \(B = \rho_0^2 \xi^{-2}\) macht doppelte Windungen (\(n=1\) statt \(n=1/2 + 1/2\)) um den Faktor \(\xi^{-2} \approx 5.6 \times 10^7\) energiereicher – praktisch unmöglich bei normalen Temperaturen.
