...
\section*{Kapitel 25: Das Neutrinomassen-Problem in der fraktalen T0-Geometrie}
	...
	\begin{tcolorbox}[title={\textbf{Wichtige Symbole und ihre Einheiten}}, colback=blue!5!white, colframe=blue!75!black]
		\begin{tabular}{p{0.3\textwidth}p{0.3\textwidth}p{0.35\textwidth}}
			...
			\(m_{\nu_i}\) & Masse des $i$-ten Neutrinos & \si{\ev\per c\squared} \\
			\(m_0^\nu\) & Referenzmasse für Neutrinos & \si{\ev\per c\squared} \\
			...
			\(m_1, m_2, m_3\) & Massen der drei Generationen & \si{\ev\per c\squared} \\
			\(U_{ij}\) & PMNS-Mischungselement & dimensionslos \\
			\(\Delta \theta_{ij}\) & Phasenunterschied zwischen Moden $i$ und $j$ & dimensionslos (radiant) \\
			\(\sum m_\nu\) & Summe der Neutrinomassen & \si{\ev\per c\squared} \\
	...
	\begin{align*}
		[m_0^\nu] &= \si{\joule\second} / (\si{\meter\per\second} \cdot \si{\meter}) = \si{\kilo\gram} \quad (\text{umgerechnet in eV}/c^2).
	\end{align*}
