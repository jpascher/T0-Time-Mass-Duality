\chapter{Reaktor-Antineutrino-Anomalie – Aktualisierte Betrachtung (Stand Januar 2026)}
	...
	Verbesserte Summationsmethoden und neue Messungen (z. B. Daya Bay, RENO, PROSPECT) haben das globale Defizit eliminiert. Ein kleiner \enquote{Bump} bei 4–6 MeV bleibt jedoch in einigen Datensätzen diskutiert.
	...
	Die fraktal erweiterte Korrelationslänge \(l_0 \xi^{-1}\) setzt die Resonanzenergie – passend zum verbleibenden \enquote{Bump}.
