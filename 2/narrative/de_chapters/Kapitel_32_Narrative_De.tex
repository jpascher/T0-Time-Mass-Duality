\chapter{Kapitel 32: Reaktor-Antineutrino-Anomalie – Aktualisierte Betrachtung (Stand Januar 2026)}
\label{chap:32}

\section*{Kapitel 32: Reaktor-Antineutrino-Anomalie – Aktualisierte Betrachtung (Stand Januar 2026)}
	...
	\begin{tcolorbox}[title={\textbf{Wichtige Symbole und ihre Einheiten}}, colback=blue!5!white, colframe=blue!75!black]
		\begin{tabular}{p{0.3\textwidth}p{0.3\textwidth}p{0.35\textwidth}}
			...
			\hline
			\(\xi\) & Fraktaler Skalenparameter (Maß für Vakuum-Modifikation) & dimensionslos \\
			\(\delta \rho\) & Lokale Amplitude-Änderung durch Reaktor & \si{\kilo\gram^{1/2}\per\meter^{3/2}} \\
			\(\rho_0\) & Vakuumgleichgewichtsdichte & \si{\kilo\gram^{1/2}\per\meter^{3/2}} \\
			\(R_{\text{obs}}/R_{\text{pred}}\) & Verhältnis beobachtete zu vorhergesagte Rate & dimensionslos \\
			\(E_\nu\) & Antineutrino-Energie & \si{\mev} \\
			\(l_0\) & Fraktale Korrelationslänge & \si{\meter} \\
			\(L\) & Basislinie (Abstand Reaktor-Detektor) & \si{\meter} \\
			\(\Delta m^2\) & Massendifferenz (bei sterilen Neutrinos) & \si{\electronvolt\squared} \\
		\end{tabular}
	\end{tcolorbox}
