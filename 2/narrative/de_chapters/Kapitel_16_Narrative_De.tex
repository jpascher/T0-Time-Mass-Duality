\chapter{Die Hubble-Spannung in der fraktalen T0-Geometrie – Narrative Version}


\section{Die Hubble-Spannung in der fraktalen T0-Geometrie}
...
\end{equation}
	...
	Ergänzend liefert die T0-Theorie eine parameterfreie Vorhersage der Hubble-Energie $E_H = E_0 \cdot \xi^{41/4} = 1{,}41 \times 10^{-33}\,$eV, woraus sich $H_0^{\text{T0}} = E_H/\hbar \approx 66{,}2\,$km/s/Mpc ergibt -- eine Abweichung von nur $-1{,}9\%$ vom Planck-CMB-Wert ($67{,}4\,$km/s/Mpc). Die verbleibende Differenz zwischen diesem Grundwert und lokalen Messungen ($\approx 73\,$km/s/Mpc) entspricht genau der hier abgeleiteten $\approx 8\%$-Backreaction durch fraktale Strukturbildung.
