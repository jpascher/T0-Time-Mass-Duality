...
\section{Raum-Schöpfung als fraktale Amplitude-Front in der T0-Time-Mass-Dualität}
	...
	Wo Masse hoch ist (hohe $\tilde{m}$), wird die Zeit \enquote{dünn} (kleine $\tilde{T}$) – wie in dicht gepackten Gehirnregionen, wo Gedanken schnell fließen. Umgekehrt: Bei niedriger Masse \enquote{dehnt} sich die Zeit – mehr Raum für komplexe Verbindungen.
	...
	$S(t_0) \approx 1 + \xi \ln(10^4) \approx 1{,}001$ ist der Streckungsfaktor (dimensionslos), $t_0$ das Universumsalter ($\SI{4.35e17}{\second}$).
	
	Mit $v_b \approx 1{,}000013\,c$ und $S \approx 1{,}001$ ergibt die Formel $R \approx c\,t_0 \cdot 1{,}001 \approx \SI{13.8}{\gigalightyear}$. Der beobachtete Wert $\SI{46.5}{\gigalightyear}$ erfordert einen zusätzlichen Streckungsfaktor $\approx 3{,}4$, dessen Herleitung aus der vollständigen zeitabhängigen Integration Gegenstand laufender Forschung ist.
