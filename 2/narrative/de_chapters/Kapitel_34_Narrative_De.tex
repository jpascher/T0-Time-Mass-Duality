\chapter{Lösung des Strong-CP-Problems in der fraktalen T0-Geometrie}
	...
	Das Strong-CP-Problem fragt, warum der CP-verletzende Parameter \(\theta_{\text{QCD}}\) in QCD kleiner als \(10^{-10}\) ist, obwohl er natürlich O(1) sein sollte. In der FFGFT wird \(\theta_{\text{QCD}}\) durch fraktale Phasenkohärenz auf Null relaxiert, reguliert durch \(\xi = \frac{4}{3} \times 10^{-4}\).
