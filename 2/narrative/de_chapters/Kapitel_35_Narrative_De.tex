\chapter{Erklärung quantenmechanischer Phänomene in der fraktalen T0-Geometrie}
	...
	Der Phasenunterschied \(\Delta \theta\) zwischen den Pfaden 1 und 2 entsteht aus der Weglängendifferenz \(\Delta L\). Die fraktale Phase bleibt kohärent über beide Pfade – kein ontologisches \enquote{beide Pfade gleichzeitig}.
	...
	Die Summe der Phasen ist fest – Messung an einem fixiert die Phase lokal, aber das Feld war bereits global kohärent. Es gibt keine instantane Signalübertragung, sondern vorbestehende fraktale Phasenkohärenz.
	...
	Der exponentielle Abfall entsteht aus Phasenakkumulation unter der Barriere, mit fraktaler Korrektur \(\xi \ln(d/l_0)\) für Phasenkohärenz.
