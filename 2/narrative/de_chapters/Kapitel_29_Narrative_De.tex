\chapter{Das Delayed-Choice-Quantum-Eraser-Experiment in der fraktalen T0-Geometrie}
	...
	Die Korrelationsfunktion \(C(\Delta x)\) wächst logarithmisch mit dem Abstand \(\Delta x\). Der führende Term \(\xi \ln(|\Delta x|/l_0)\) entsteht aus der Summation über fraktale Stufen, der quadratische Term aus höheren Korrekturen. Dadurch bleibt die Phase über große Distanzen kohärent, aber mit kontrollierter, schwacher Phasenkohärenz durch den kleinen Faktor \(\xi\).
