\chapter{Warum die Raumzeit fraktal und dual sein muss  Eine Notwendigkeit, keine Willkür  Narrative Version der FFGFT}
...
Wenn wir versuchen, Quantenfeldtheorie auf einer perfekt glatten Raumzeit zu betreiben, erhalten wir \textbf{unendliche Werte}. Die Berechnungen divergieren – sie explodieren buchstäblich ins Unendliche. Physiker nennen das \enquote{ultraviolette Divergenzen} (ultraviolett, weil sie bei sehr kleinen Wellenlängen, also hohen Energien, auftreten). Um diese Unendlichkeiten loszuwerden, müssen wir zu einem Trick greifen, der \enquote{Renormierung} heißt – wir subtrahieren geschickt Unendlichkeiten voneinander und hoffen, dass am Ende etwas Sinnvolles übrig bleibt. Das funktioniert, aber es fühlt sich an wie Schummeln.

Noch schlimmer: In der Nähe von Schwarzen Löchern oder beim Urknall sagt uns die Allgemeine Relativitätstheorie, dass die Krümmung der Raumzeit gegen unendlich geht – eine \textbf{Singularität} entsteht. An diesen Punkten brechen alle physikalischen Gesetze zusammen. Die Theorie sagt uns: \enquote{Hier kann ich dir nicht mehr helfen.} Das ist zutiefst unbefriedigend.
...
\textbf{Eine fundamentale Konsequenz:} Die Zeit-Masse-Dualität bedeutet, dass Zeit nicht von Energie und Masse trennbar ist -- sie \textit{ist} Masse, nur dual betrachtet. Unser gewohntes Bild von \enquote{drei Raumdimensionen plus einer separaten Zeitdimension} (3+1) ist eine Projektion unseres dreidimensionalen Denkens auf ein genuïn vierdimensionales System. In der FFGFT gibt es keine \enquote{Zeitachse} unabhängig von der Massenverteilung: Wo sich Masse ändert, ändert sich Zeit -- und umgekehrt. Das Universum ist nicht \enquote{Raum plus Zeit}, sondern ein einheitliches vierdimensionales Vakuumfeld $\Phi = \rho\, e^{i\theta}$, in dem $\rho$ (Amplitude/Masse) und $\theta$ (Phase/Zeit) untrennbar verwoben sind.
