\chapter{Teilchen-Massenhierarchie und Gravitationsschwäche in der fraktalen T0-Geometrie}
	...
	Die Gleichgewichtsdichte \(\rho_0\) setzt die fundamentale Energie-Skala, \(\xi^{-2} \approx 5.625 \times 10^7\) verstärkt sie enorm, weil die fraktale Struktur das Vakuum extrem steif macht – kleine Deformationen kosten viel Energie. Gravitation wirkt als schwache Deformation der Amplitude \(\delta \rho\), daher ist sie um den Faktor \(\xi^2\) geschwächt im Vergleich zu anderen Kräften, die direkt an der Phase \(\theta\) koppeln.
	...
	\begin{equation}
		\frac{G}{g_w^2} \approx \xi^2 \approx 1.78 \times 10^{-8},
	\end{equation}
