\chapter{Kapitel 40: Glaubwürdige Alternative zu GR und QFT in der fraktalen T0-Geometrie}
\label{chap:40}

\section*{Kapitel 40: Glaubwürdige Alternative zu GR und QFT in der fraktalen T0-Geometrie}
	...
	\begin{tcolorbox}[title={\textbf{Wichtige Symbole und ihre Einheiten}}, colback=blue!5!white, colframe=blue!75!black]
		\begin{tabular}{p{0.3\textwidth}p{0.3\textwidth}p{0.35\textwidth}}
			...
			\(G\) & Gravitationskonstante (emergent) & \si{\meter\cubed\per\kilo\gram\per\second\squared} \\
			\(g_s\) & Starke Kopplung & dimensionslos \\
			\(g_w\) & Schwache Kopplung & dimensionslos \\
			\(g_{\text{em}}\) & Elektromagnetische Kopplung & dimensionslos \\
	...
	\begin{align*}
		[G] &= \si{\joule\second} \cdot \si{\meter\per\second} / (\si{\kilo\gram^{1/2}\per\meter^{3/2}})^2 = \si{\meter\cubed\per\kilo\gram\per\second\squared}.
	\end{align*}
