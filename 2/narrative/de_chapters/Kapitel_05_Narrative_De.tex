\chapter{Die Spezielle Relativitätstheorie Emergenz aus der fraktalen Hierarchie}
...
Die Lichtgeschwindigkeit ist also keine fundamentale Konstante, sondern emergiert aus dem Verhältnis zwischen dem fraktalen Parameter $\xi$ und der fundamentalen Zeitskala $T_0 = 1/\sqrt{\xi}$ (in natürlichen Einheiten $c = \hbar = 1$). In SI-Einheiten entspricht dies $t_0 = \hbar/E_0 \approx 8{,}9 \times 10^{-23}$~s mit $E_0 = \sqrt{m_e \cdot m_\mu} \approx 7{,}4$~MeV.
