...
\section*{Abstract}
	...
	\begin{itemize}
		\item \textbf{G-Messungen} dienen zur Verifikation der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT)
	...
	\begin{formula}[Die revolutionäre Erkenntnis]
		...
		\textbf{Das ist der Durchbruch der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT)!}
	\end{formula}
