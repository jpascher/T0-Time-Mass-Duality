...
\section*{Abstract}
	...
	\begin{abhandlung}
		...
		Eine der radikalsten Aussagen der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) ist, dass die Raumzeit auf fundamentaler Ebene fraktale Eigenschaften besitzt. Die effektive Dimension hängt von der Energieskala ab:
	...
	\begin{beziehung}
		...
		In der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) erhält $e$ eine besondere Bedeutung als der natürliche Übersetzer zwischen diskreter geometrischer Struktur und kontinuierlicher dynamischer Entwicklung.
	\end{beziehung}
	...
	\begin{erkenntnis}
		...
		Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) erklärt natürlicherweise, warum die Vakuumenergiedichte so unglaublich klein ist im Vergleich zur Planck-Skala.
	\end{erkenntnis}
