...
\section*{Abstract}
	...
	\begin{keyresult}{Exakte Übereinstimmung}{exakt}
		Durch die physikalisch abgeleiteten Korrekturfaktoren werden exakte Übereinstimmungen mit allen experimentellen Daten erreicht, während die parameterfreie Natur der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) vollständig erhalten bleibt.
	\end{keyresult}
	...
	Trotz der Korrekturfaktoren bleibt das fundamentale Prinzip der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) erhalten:
	...
	\begin{itemize}
		\item \textbf{Erfolgreiche Erweiterung} der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) auf Hadronen
