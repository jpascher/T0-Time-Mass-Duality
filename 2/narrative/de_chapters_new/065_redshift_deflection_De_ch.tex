...
% Original: \chapter{\Huge\textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Rotverschiebungsmechanismus}
\chapter{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Rotverschiebungsmechanismus}
...
\section*{Abstract}
	...
	\begin{important}
		...
		\begin{itemize}
			...
			\item Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): $z$ variiert mit der Wellenl\"ange - testbare Vorhersage!
		\end{itemize}
	...
	\begin{longtable}{lcc}
		\caption{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) vs. Standardkosmologie} \\
		\toprule
		\textbf{Aspekt} & \textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)} & \textbf{$\Lambda$CDM} \\
		\midrule
		\endfirsthead
		\multicolumn{3}{c}%
	...
	Die Vorhersage der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) einer wellenl\"angenabh\"angigen Rotverschiebung stellt eines ihrer markantesten und testbarsten Merkmale dar. Die aktuelle experimentelle Situation ist jedoch komplex und erfordert eine sorgf\"altige Analyse.
	...
	Wenn Kompensation best\"atigt wird, ben\"otigt die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT):
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) steht an einem kritischen Wendepunkt. Die Vorhersage der wellenl\"angenabh\"angigen Rotverschiebung wird entweder:
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) beschreibt ein statisches, ewig existierendes Universum, in dem:
	\begin{itemize}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) hat nat\"urliche Anpassungsmechanismen:
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) bietet eine revolution\"are Alternative zur expansionsbasierten Kosmologie durch eine einzige universelle Konstante $\xiconst$. Die Vorhersage der wellenl\"angenabh\"angigen Rotverschiebung bietet einen klaren experimentellen Test zur Unterscheidung zwischen T0 und Standardkosmologie. W\"ahrend die aktuelle Pr\"azision kaum die Nachweisschwelle erreicht, sollten spektroskopische Instrumente der n\"achsten Generation diese fundamentale Vorhersage definitiv testen.
	...
	\begin{thebibliography}{99}
		...
		\bibitem{pascher2025}
		Pascher, Johann (2025). 
		\textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Vollst\"andige Herleitung und experimentelle Tests}. 
		T0-Theory Project. 
