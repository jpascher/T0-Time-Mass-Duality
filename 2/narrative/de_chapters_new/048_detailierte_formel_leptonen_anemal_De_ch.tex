...
\section*{Abstract}
	...
	\section{Der Casimir-Effekt in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)}
	
	Der Casimir-Effekt in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) behält die Standard-$d^{-4}$-Abhängigkeit bei, erhält aber kleine QFT-Korrekturen:
	\begin{equation}
	...
	\begin{summary}
		\textbf{Kernerkenntnisse der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT):}
		\begin{itemize}
