...
\section*{Abstract}
	...
	\section{Der Casimir-Effekt in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie)}
	
	Der Casimir-Effekt in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) behält die Standard-$d^{-4}$-Abhängigkeit bei, erhält aber kleine QFT-Korrekturen:
	\begin{equation}
	...
	\begin{summary}
		\textbf{Kernerkenntnisse der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie):}
		\begin{itemize}
