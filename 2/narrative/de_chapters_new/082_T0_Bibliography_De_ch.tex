...
% Titel und Autor
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025).
		\textit{Der vollständige Abschluss der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT): Von $\xi$ zur SI-Reform 2019}.
		...
		Pascher, J. (2025).
		\textit{T0 Verhältnis vs. Absolut: Die Rolle der fraktalen Korrektur in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT)}.
		HTL Leonding, Österreich.
		...
		Pascher, J. (2025).
		\textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT): Vereinigter Rechner Bericht}.
		HTL Leonding, Österreich.
		...
		Pascher, J. (2025).
		\textit{Notwendigkeit zweier Lagrange-Funktionen in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT)}.
		HTL Leonding, Österreich.
		...
		Pascher, J. (2025).
		\textit{T0 Kosmologie: Kosmologische Anwendungen der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT)}.
		HTL Leonding, Österreich.
		...
		\bibitem{instantan}
		Pascher, J. (2025).
		\textit{Scheinbar instantane Effekte in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT)}.
		HTL Leonding, Österreich.
		...
		\bibitem{emc2}
		Pascher, J. (2025).
		\textit{E=mc²: Neuinterpretation in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT)}.
		HTL Leonding, Österreich.
