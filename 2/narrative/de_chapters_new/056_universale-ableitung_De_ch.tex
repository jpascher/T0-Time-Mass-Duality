...
\section*{Abstract}
	...
	\section{Die charakteristische Energie E\_0 und Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)}
	...
	Falls die Teilchenmassen selbst aus der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) berechnet w\"urden:
	\begin{align}
	...
	\begin{tcolorbox}[colback=green!10!white,colframe=green!75!black,title=Die Revolution\"are E\_0-Erkenntnis]
		Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) zeigt: Nur \textbf{eine einzige geometrische Konstante} $\xi = \frac{4}{3} \times 10^{-4}$ gen\"ugt, um die Feinstrukturkonstante mit beispielloser Pr\"azision vorherzusagen.
	...
	\begin{tcolorbox}[colback=blue!10!white,colframe=blue!75!black,title=Fraktale Korrekturen k\"urzen sich in Verh\"altnissen]
		Die wichtigste Erkenntnis der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) ist, dass die fraktale Korrektur $K_{\text{frak}}$ sich bei \textbf{Verh\"altnissen} vollst\"andig herausk\"urzt:
	...
	Aus der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) folgt das Massenverh\"altnis:
	\begin{align}
	...
	\begin{tcolorbox}[colback=green!10!white,colframe=green!75!black,title=Die ultimative Revolution\"are Erkenntnis]
		Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) zeigt: Nur \textbf{eine einzige geometrische Konstante} $\xi = \frac{4}{3} \times 10^{-4}$ gen\"ugt, um:
