...
\section*{Abstract}
	...
	Der Parameter $\xi = \frac{4}{3} \times 10^{-4}$ ist keine empirische Optimierung, sondern leitet sich aus ersten Prinzipien der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) der Zeit-Masse-Dualität ab. Diese fundamentale Konstante repräsentiert den minimalen Rauschpegel, der physikalischen Systemen inhärent ist, und bietet eine natürliche Regularisierungsgrenze für numerische Präzisionslimits.
	...
	\begin{verbatim}
		...
		# xi aus Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) (Zeit-Masse-Dualität)
		xi = 4.0/3 * 1e-4
