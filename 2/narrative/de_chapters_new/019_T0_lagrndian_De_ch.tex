...
\chapter{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT): Die T0-Zeit-Masse-Dualität}
...
\section*{Abstract}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) postuliert eine fundamentale Dualität zwischen Zeit und Masse:
	\begin{equation}
		T(x,t) \cdot m(x,t) = 1
	\end{equation}
	...
	\begin{keyresult}
		Die gesamte Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) basiert auf einem einzigen fundamentalen Parameter:
		\begin{equation}
	...
	\begin{explanation}
		...
		Die Reduktion von $4.2\sigma$ auf $0.6\sigma$ Diskrepanz ist konsistent mit der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT):
		\begin{itemize}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{L{2.5cm}C{2cm}C{2cm}L{3.5cm}}
			...
			Massen-Skalierung & $m_\ell^2$ & - & Fundamentale Vorhersage der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) \\
			\bottomrule
		\end{tabular}
	...
	\section{Schlüsselmerkmale der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT)}
	
	\subsection{Quadratische Massenskala}
	
	\begin{keyresult}
		Die fundamentale Vorhersage der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) ist die quadratische Massenskala:
		\begin{align}
	...
	\begin{keyresult}
		Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) enthält keine freien Parameter:
		\begin{itemize}
	...
	\begin{keyresult}
		Dieses Dokument hat die vollständige Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) mit dem fundamentalen Parameter $\xi = \frac{4}{3} \times 10^{-4}$ entwickelt:
	...
	\begin{keyresult}
		Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) mit $\xi = \frac{4}{3} \times 10^{-4}$ repräsentiert eine umfassende und konsistente Formulierung, die mathematische Strenge mit experimenteller Testbarkeit vereint. Die Theorie bietet:
		...
		Die entwickelten Vorhersagen liefern testbare Konsequenzen der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) und eröffnen neue Wege zur Erforschung der fundamentalen Raumzeit-Struktur.
	\end{keyresult}
	...
	\begin{center}
		...
		\vspace{0.3cm}
		Fundamentale Fraktalgeometrische Feldtheorie (FFGFT): Zeit-Masse-Dualitäts-Rahmenwerk\\
		Johann Pascher\\
	\end{center}
