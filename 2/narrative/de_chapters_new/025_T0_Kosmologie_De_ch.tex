...
\section*{Abstract}
	...
	Da die Zeit-Energie-Dualität einen Urknall verbietet, muss die CMB einen anderen Ursprung haben als die z=1100-Entkopplung der Standardkosmologie. Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) erklärt die CMB durch $\xi$-Feld-Quantenfluktuationen.
	...
	\subsection{Das mathematische Modell der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)}
	
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) bietet ein mathematisches Modell für die beobachtete kosmische Rotverschiebung, das **alternative Interpretationen** zulässt, ohne sich auf eine spezifische physikalische Ursache festzulegen.
	...
	\begin{warning}
		...
		Durch das Anbieten multipler Interpretationen vermeidet die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT):
		\begin{itemize}
	...
	\begin{experiment}
		...
		Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) sagt spezifische Verhältnisse vorher, die von der Standardkosmologie abweichen.
	\end{experiment}
	...
	\begin{revolutionary}
		...
		\begin{itemize}
			...
			\item \textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): 1 Parameter ($\xipar$)}
		\end{itemize}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) demonstriert, dass:
	...
	\begin{itemize}
		...
		\item \textbf{Zukunftsvision:} Technologische Anwendungen der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)
	\end{itemize}
	...
	\begin{thebibliography}{30}
		...
		Pascher, J. (2025). 
		\textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Gravitationskonstante}. 
		...
		Pascher, J. (2025). 
		\textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Kosmische Beziehungen}. 
