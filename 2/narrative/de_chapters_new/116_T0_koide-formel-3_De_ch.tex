...
\section*{Abstract}
	...
	In der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) entstehen Teilchenmassen durch:
	...
	\begin{table}[h]
		...
		\begin{tabular}{lcc}
			\toprule
			\textbf{Aspekt} & \textbf{Koide (1981)} & \textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)} \\
			\midrule
	...
	Die Feinstrukturkonstante in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT):
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) zeigt eine tiefe Verbindung:
	...
	\begin{theorem}
		...
		Die 1981 empirisch entdeckte Symmetrie enthielt bereits die fundamentale geometrische Konstante $\xi = \frac{4}{3} \times 10^{-4}$, ohne dass dies erkannt wurde. Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) zeigt:
	...
	\begin{thebibliography}{99}
		...
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Grundlagen des Zeit-Masse-Dualitäts-Frameworks'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Grundlagen_en.pdf}
		
		\bibitem{T0Feinstruktur}
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Ableitung der Feinstrukturkonstante aus $\xi$'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Feinstruktur_En.pdf}
		
		\bibitem{T0Gravitation}
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Geometrische Herleitung der Gravitationskonstante'', HTL Leonding (2024). 
		...
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Systematische Berechnung der Teilchenmassen'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Teilchenmassen_En.pdf}
		
		\bibitem{T0SI}
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): SI-Reform 2019 als $\xi$-Kalibrierung'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_SI_En.pdf}
		
		\bibitem{T0Verhaeltnis}
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Verhältnisse vs. absolute Werte -- Fraktale Korrekturen'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_verhaeltnis-absolut_En.pdf}
		
		\bibitem{T0MuonG2}
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Anomale magnetische Momente und Muon g-2'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Anomale_Magnetische_Momente_En.pdf}
		
		\bibitem{T0QFT}
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Quantenfeldtheorie und Relativitätstheorie'', HTL Leonding (2024). 
		\url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_QM-QFT-RT_En.pdf}
		
		\bibitem{T0Bibliographie}
		J. Pascher, ``Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Vollständige Bibliographie (131+ Dokumente)'', HTL Leonding (2024). 
