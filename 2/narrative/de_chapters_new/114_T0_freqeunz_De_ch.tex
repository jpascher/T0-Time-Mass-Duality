...
\section*{Abstract}
	...
	\begin{enumerate}
		\item \textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) Grundlagen (Englisch)} \\
		...
		\item \textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) Grundlagen (Deutsch)} \\
		\href{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Framework_De.pdf}{T0\_Framework\_De.pdf} - Mathematische Grundlagen der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT), Feldgleichungen und Massenvariation (2024)
		...
		\href{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/T0_Cosmology_De.pdf}{T0\_Cosmology\_De.pdf} - Kosmologische Anwendungen der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT), Hubble-Parameter, Dunkle Energie (2024)
