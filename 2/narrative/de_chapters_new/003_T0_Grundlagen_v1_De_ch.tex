...
\section*{Abstract}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) basiert auf der revolutionären Hypothese, dass alle physikalischen Phänomene aus der geometrischen Struktur des dreidimensionalen Raums ableitbar sind. Im Zentrum steht ein einziger universeller Parameter:
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{lcc}
			\toprule
			\textbf{Aspekt} & \textbf{Standardmodell} & \textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)} \\
			\midrule
			...
			\bottomrule
		\end{tabular}
		\caption{Vergleich zwischen Standardmodell und Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)}
	\end{table}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) erkennt an, dass die Raumzeit auf Planck-Skalen aufgrund von Quantenfluktuationen eine fraktale Struktur aufweist:
...
Diese Dualitaet ist nicht nur eine mathematische Beziehung, sondern spiegelt eine fundamentale Eigenschaft der Raumzeit wider. Sie erklaert, warum schwere Teilchen staerker an die temporale Struktur der Raumzeit koppeln.
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) arbeitet in natürlichen Einheiten, wobei:
	...
	\begin{foundation}
		\textbf{Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) kann auf verschiedenen Ebenen verstanden werden:}
...
Die einfachste Anwendung der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) verwendet direkte geometrische Beziehungen:
\begin{equation}
...
Die Parameter $r_i$ und $p_i$ sind exakte rationale Zahlen, die aus der Quantenzahlen-Zuordnung der T0-Geometrie folgen.
	...
	\begin{foundation}
		...
		Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) bietet eine mögliche Antwort: Das Universum ist mathematisch beschreibbar, weil es \textbf{selbst} mathematisch strukturiert ist. Der Parameter $\xipar$ ist nicht nur eine Beschreibung der Natur - er \textbf{ist} die Natur.
...
Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) hat bereits mehrere experimentelle Tests bestanden:
...
Dieses Grundlagendokument bildet den Ausgangspunkt einer systematischen Darstellung der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT). Die folgenden Dokumente vertiefen spezielle Aspekte:
...
\begin{itemize}
	...
	\item \textbf{T0\_Kosmologie\_De.tex}: Kosmologische Anwendungen der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)
\end{itemize}
...
\end{itemize}
	...
	\begin{enumerate}
		\item Pascher, J. (2025). \textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Herleitung der Gravitationskonstanten}. Technische Dokumentation.
