...
\end{equation}
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025). \textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT): Universelle $\xi$-Konstante und kosmischer Mikrowellen-Hintergrund}. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/cosmicDe.pdf}
		
		\bibitem{pascher_redshift_2025}
		Pascher, J. (2025). \textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT): Wellenlängenabhängiger Rotverschiebungs-Mechanismus}. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/redshift_deflectionDe.pdf}
