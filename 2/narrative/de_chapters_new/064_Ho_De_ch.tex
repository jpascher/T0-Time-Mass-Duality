% Chapter file: 064_Ho_De_ch.tex
% Source: 064_Ho_De.tex

\chapter{Das T0-Modell: Die Hubble-Konstante in einem statischen Universum Energieverlust durch das universelle $\xi$-Feld}
...
\end{equation}
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025). \textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Universelle $\xi$-Konstante und kosmischer Mikrowellen-Hintergrund}. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/cosmicDe.pdf}
		
		\bibitem{pascher_redshift_2025}
		Pascher, J. (2025). \textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Wellenlängenabhängiger Rotverschiebungs-Mechanismus}. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/redshift_deflectionDe.pdf}
