...
\allowdisplaybreaks
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) offenbart, dass alle das Problem rückwärts betrachtet hatten. Die Feinstrukturkonstante ist nicht fundamental - sie ist \textbf{abgeleitet}.
	...
	Ausgehend von $\xi$ allein leitet die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) ab:
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) macht präzise Vorhersagen mit \textbf{null} freien Parametern:
	...
	\begin{table}[h]
		...
		\scalebox{0.8}{
			\begin{tabular}{lccc}
				\toprule
				\textbf{Parameter} & \textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)} & \textbf{Musikalische Spirale} & \textbf{Experiment} \\
				\midrule
