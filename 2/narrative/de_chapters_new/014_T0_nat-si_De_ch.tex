...
\section*{Abstract}
	...
	\section{In der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) besonders relevant}
	
	\subsection{Geometrische Natur der Konstanten}
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) zeigt besonders deutlich, warum natürliche Einheiten fundamental sind:
	\begin{equation}
	...
	\subsection{Die fundamentale Vorhersage der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)}
	
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) macht eine bemerkenswerte Vorhersage: Die Elektronenmasse in geometrischen Einheiten ist exakt:
	...
	\begin{align}
		...
		\textbf{5. Tiefgreifende Schlussfolgerung:} \quad & \text{Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) \textbf{vorhersagt} die MeV-Massenskala}
	\end{align}
	...
	\begin{table}[h]
		...
		\begin{tabular}{p{6cm}p{6cm}}
			\toprule
			\textbf{Konventionelle Physik} & \textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)} \\
			\midrule
	...
	Diese sind \textbf{identisch} nicht per Definition, sondern weil die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) die fundamentale Massenskala korrekt vorhersagt.
	
	\subsection{Die tiefgreifende Implikation}
	
	\begin{center}
		\fbox{\parbox{0.8\textwidth}{
				\textbf{Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) ``verwendet'' nicht die MeV-Definition.}\\
				\textbf{Sie leitet ab, warum das MeV die Massenskala hat, die es hat.}
		}}
	\end{center}
	
	Die konventionelle Definition $1~\mathrm{MeV}/c^2 = 1.782662 \times 10^{-30}~\mathrm{kg}$ erscheint willkürlich, aber die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) enthüllt sie als Konsequenz fundamentaler Geometrie.
	...
	\section{Quantisierte Massenberechnung in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)}
	
	\subsection{Fundamentales Massenquantisierungsprinzip}
	
	In der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) sind Teilchenmassen \textbf{quantisiert} und folgen aus dem fundamentalen Geometrieparameter $\xi$ durch diskrete Skalierungsbeziehungen:
	...
	Für detaillierte Herleitungen aller Elementarteilchenmassen im T0-Rahmen, einschließlich Quarks, Leptonen und Eichbosonen, wird auf die separate umfassende Behandlung ``Teilchenmassen in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)'' verwiesen, die folgendes bietet:
	...
	\section{Konkrete Umrechnung in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)}
	...
	SI-Einheiten sind menschliche Konventionen, die die geometrische Reinheit der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) ``verunreinigen''. Um exakte Übereinstimmung mit Experimenten zu erreichen, muss die fraktale Renormierung \textbf{explizit angewendet} werden, weil:
...
\end{table}
	...
	Bei der Anwendung der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) sind folgende fundamentale Unterscheidungen zu beachten:
	...
	\section{Besondere Bedeutung für die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)}
	
	\subsection{Die tiefere Einsicht}
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) enthüllt, dass natürliche Einheiten nicht nur eine Rechenvereinfachung sind, sondern die \textbf{wahre geometrische Natur der Physik} ausdrücken:
	\begin{itemize}
	...
	\begin{table}[h]
		...
		\begin{tabular}{p{3cm}p{10cm}}
			...
			$\xi$ & Fundamentaler Geometrieparameter der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT); $\xi = \frac{4}{3} \times 10^{-4}$ \\
			$E_0$ & Referenzenergie in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT); $E_0 = 7.400~\mathrm{MeV}$ \\
	...
	\begin{table}[h]
		...
		\begin{tabular}{p{4cm}p{10cm}}
			...
			$\alpha = \xi (E_0/1\mathrm{MeV})^2$ & Fundamentaler Zusammenhang in Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) \\
			...
			\bottomrule
		\end{tabular}
		\caption{Fundamentale Zusammenhänge in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) und Skalierung zu physikalischen Einheiten}
	\end{table}
