...
\section*{Abstract}
	...
	In der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) entspricht $\kappa = 7$ einer \textbf{vollständigen Oktavierung} des Massenspektrums:
	\begin{itemize}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{p{3cm}p{8cm}p{3cm}}
			...
			\midrule
			$\xi$ & Fundamentaler geometrischer Parameter der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) & $\frac{4}{30000} \approx 1.333\times10^{-4}$ \\
			...
			\bottomrule
		\end{tabular}
		\caption{Fundamentale Parameter der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT)}
	\end{table}
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025). \textit{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT): Grundlagen und Erweiterungen}.
