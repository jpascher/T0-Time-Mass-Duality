% Chapter file: 037_Hannah_De_ch.tex
% Source: 037_Hannah_De.tex

% Original: \chapter{\Huge\textbf{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Verbindungen zum Mizohata-Takeuchi-Gegenbeispiel}
\chapter{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie): Verbindungen zum Mizohata-Takeuchi-Gegenbeispiel}
...
\section*{Abstract}
	...
	\begin{table}[htbp]
		\centering
		%
		\begin{tabular}{@{}p{0.28\textwidth}@{\hspace{2mm}}p{0.28\textwidth}@{\hspace{2mm}}p{0.38\textwidth}@{}}
			\toprule
