...
\section*{Abstract}
	...
	\subsection{Ausgangspunkt der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)}
	
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) basiert auf der fundamentalen geometrischen Beziehung zwischen dem charakteristischen Längenparameter $\xi$ und der Gravitationskonstante:
	...
	\begin{itemize}
		...
		\item In der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) eine natürliche Massenskala definiert
	\end{itemize}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) berücksichtigt die fraktale Natur der Raumzeit auf Planck-Skalen:
	...
	Die Formel zeigt, dass die Gravitation in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT):
	\begin{itemize}
	...
	Die erfolgreiche Herleitung der Gravitationskonstanten zeigt das Potential der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) für eine einheitliche Beschreibung aller Naturkonstanten. Zukünftige Arbeiten sollten:
