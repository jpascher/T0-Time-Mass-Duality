...
\section*{Abstract}
	...
	\subsection{Ausgangspunkt der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT)}
	
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) basiert auf der fundamentalen geometrischen Beziehung zwischen dem charakteristischen Längenparameter $\xi$ und der Gravitationskonstante:
	...
	\begin{itemize}
		...
		\item In der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) eine natürliche Massenskala definiert
	\end{itemize}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) berücksichtigt die fraktale Natur der Raumzeit auf Planck-Skalen:
	...
	Die Formel zeigt, dass die Gravitation in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT):
	\begin{itemize}
	...
	Die erfolgreiche Herleitung der Gravitationskonstanten zeigt das Potential der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) für eine einheitliche Beschreibung aller Naturkonstanten. Zukünftige Arbeiten sollten:
