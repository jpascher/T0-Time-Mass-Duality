...
\chapter{Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT): Teilchenmassen}
...
\section*{Abstract}
	...
	\begin{keyresult}
		...
		Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) behauptet, dass alle Teilchenmassen aus einem einzigen geometrischen Parameter berechenbar sind:
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) bietet zwei komplementäre, aber mathematisch äquivalente Ansätze:
	...
	\begin{keyresult}
		...
		Die Äquivalenz zeigt, dass die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) eine einheitliche Beschreibung bietet, die sowohl geometrisch fundamental als auch experimentell zugänglich ist.
	\end{keyresult}
	...
	\begin{warning}
		\textbf{Neutrinos: Ein Sonderfall der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT)}
	...
	\begin{table}[h]
		...
		\begin{tabular}{lcc}
			...
			\bottomrule
		\end{tabular}
		\caption{Vergleich: Standardmodell vs. Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) für Teilchenmassen}
	\end{table}
