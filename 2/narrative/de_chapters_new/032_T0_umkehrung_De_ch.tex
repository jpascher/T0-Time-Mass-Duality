...
\section*{Abstract}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT) bietet mehrere mathematisch äquivalente Methoden zur Massenberechnung. In diesem Dokument verwenden wir die \textbf{direkte geometrische Methode} speziell zur Validierung der Fraktaldimension.
	...
	\begin{table}[H]
		...
		\begin{tabular}{lccc}
			...
			\bottomrule
		\end{tabular}
		\caption{Konsistenz der Massenberechnungsmethoden in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT)}
	...
	\begin{table}[H]
		...
		\begin{tabular}{p{6cm}p{6cm}}
			...
			\bottomrule
		\end{tabular}
		\caption{Komplementäre Rollen der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT)-Dokumente}
