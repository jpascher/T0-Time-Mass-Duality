...
\section*{Abstract}
	...
	\begin{derivation}
		...
		Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) postuliert eine fundamentale geometrische Beziehung zwischen dem charakteristischen L{\"a}ngenparameter $\xi$ und der Gravitationskonstante:
	...
	\begin{keyresult}
		...
		Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) sagt vorher, dass der Massenskalierungsfaktor sein muss:
		\begin{equation}
	...
	\begin{insight}
		...
		Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) sagt alle drei nur aus $\xi$ vorher, mit der Randbedingung:
		\begin{equation}
	...
	\begin{derivation}
		...
		Jedoch ist der \emph{spezifische numerische Wert} in SI-Einheiten nicht willk{\"u}rlich. Aus der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT):
		\begin{align}
...
\begin{insight}
\textbf{Temperatur als Energieskala in der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT):}

In der Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) wird Temperatur nat{\"u}rlicherweise als Energie ausgedr{\"u}ckt:
\begin{equation}
...
\begin{insight}
\textbf{Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher FFGFT) enth{\"u}llt, warum diese spezifischen Werte geometrisch notwendig sind:}
