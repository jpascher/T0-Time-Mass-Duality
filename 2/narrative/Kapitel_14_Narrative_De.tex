...
\begin{document}
	...
	In den vorangegangenen dreizehn Kapiteln haben wir die fundamentalen Prinzipien der FFGFT kennengelernt: die Time-Mass-Dualität, die fraktale Geometrie mit Parameter $\xi = \frac{4}{3} \times 10^{-4}$, und das kosmische Gehirn als zentrale Metapher. Wir verstehen nun, dass das Universum nicht expandiert im herkömmlichen Sinne, sondern sich durch zunehmende fraktale Faltung bei konstantem Volumen entwickelt – ähnlich wie ein reifendes Gehirn komplexere Windungen ausbildet.
	
	Dieses Kapitel baut direkt auf diesen Erkenntnissen auf und untersucht eine der radikalsten Konsequenzen der Theorie: \textbf{Raum selbst ist nicht fundamental}. Was wir als „Expansion des Universums" wahrnehmen, ist tatsächlich die Fortpflanzung einer fraktalen Amplitude-Front durch das Vakuum – ein Prozess, der physikalischen Raum erst erschafft, wo vorher keiner war.
	
	Stellen Sie sich vor, Sie beobachten die Entwicklung eines neuronalen Netzwerks im Zeitraffer: Neuronen feuern nicht einfach in einem vorgegebenen Raum, sondern die neuronale Aktivität \textit{definiert} erst den funktionalen Raum, in dem Information verarbeitet werden kann. Analog dazu definiert im kosmischen Gehirn die Ausbreitung der Vakuum-Amplitude $\rho(\vec{x},t)$ erst den physikalischen Raum selbst.
	
	Diese Sichtweise löst eines der größten Rätsel der Kosmologie: Warum ist das beobachtbare Universum 46,5 Milliarden Lichtjahre groß, obwohl es nur 13,8 Milliarden Jahre alt ist? Die Antwort liegt nicht in einer mysteriösen Inflation, sondern in der Tatsache, dass die Amplitude-Front sich mit einer Geschwindigkeit knapp über der Lichtgeschwindigkeit ausbreitet – ohne dabei die Kausalität zu verletzen, denn sie überträgt keine Information, sondern erschafft erst die Voraussetzung dafür.
	...
	Aus den vorangegangenen Kapiteln kennen wir die Time-Mass-Dualität als fundamentales Prinzip der FFGFT. Hier manifestiert sie sich als Motor der Raum-Schöpfung:
	...
	\begin{center}
		\begin{tabular}{p{0.3\textwidth}p{0.3\textwidth}p{0.3\textwidth}}
			...
			Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) & Fraktale Amplitude-Front mit $v_b > c$ & Natürlich aus $\xi$, parameterfrei \\
		\end{tabular}
	\end{center}
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) revolutioniert unser Verständnis von Raum:
	...
	Die Fundamentale Fraktalgeometrische Feldtheorie (FFGFT, früher T0-Theorie) zeigt damit, dass die beobachtete Größe und Struktur des Universums keine feinabgestimmten Parameter oder zusätzliche Felder erfordert, sondern natürliche Konsequenzen einer einzigen geometrischen Größe sind: der fraktalen Packungsdichte $\xi$.
	
	\subsection*{Progressive Narrative Zusammenfassung}
	
	Dieses Kapitel erweitert unser Verständnis der FFGFT um eine fundamentale Einsicht: Raum ist nicht die Bühne, auf der die Physik stattfindet, sondern ein emergentes Phänomen, das aus der Dynamik des fraktalen Vakuums entsteht. Die Amplitude-Front, die wir als „Expansion" wahrnehmen, ist im kosmischen Gehirn vergleichbar mit der Ausbreitung neuronaler Aktivität, die erst den funktionalen Raum für Informationsverarbeitung definiert.
	
	In den folgenden Kapiteln werden wir sehen, wie diese Einsicht weitere kosmologische Rätsel löst und testbare Vorhersagen ermöglicht, die die FFGFT von konkurrierenden Theorien unterscheiden.
