...
\title{\textbf{Kapitel 27: Neutrinomassen} \\
\large Teilchenphysik 7 \\
...
In den vorherigen Kapiteln haben wir die Grundlagen der Fundamentalen Fraktalgeometrischen Feldtheorie (FFGFT) kennengelernt. Dieses Kapitel widmet sich nun spezifisch der Frage: wie neutrinomassen durch $\xi$ erklärt werden
...
Die Behandlung von \textbf{Neutrinomassen} in der FFGFT folgt direkt aus der fraktalen Geometrie und der Zeit-Masse-Dualität.

\subsection{Grundlegende Überlegungen}

In diesem Kontext ist besonders wichtig zu verstehen, dass wie neutrinomassen durch $\xi$ erklärt werden
...
In diesem Kapitel haben wir untersucht, wie die FFGFT neutrinomassen behandelt. Die zentrale Erkenntnis bleibt: Der Parameter $\xi$ und die fraktale Struktur der Raumzeit genügen, um alle beobachteten Phänomene zu erklären.
