...
Die Gravitationskonstante folgt aus $\xipar$ und der Elektronmasse:
...
Für die Umrechnung in SI-Einheiten benötigen wir zusätzliche Faktoren:
...
\item $\Kfrak = 0.986$ (fraktale Korrektur)
\end{itemize}
...
\item Gravitationskonstante: $G = \frac{\xipar^2}{4m_e} \times C_{\text{conv}} \times \Kfrak$
