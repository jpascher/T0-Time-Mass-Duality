...
\title{\textbf{Chapter 8: Quantengravitation in der FFGFT} \\
	\large Von der Schleife zur fraktalen Emergenz \\
...
\begin{document}
	...
	\begin{center}
		...
		\begin{tabular}{p{0.28\textwidth}|p{0.32\textwidth}|p{0.32\textwidth}}
			...
			Testbarkeit & Schwierig & Präzise Vorhersagen (Chapter 7) \\
			\bottomrule
		\end{tabular}
	\end{center}
