...
# Einführung
	...
	**Strange-Quark:**
	...
	\begin{itemize}
		\item **Spin-Struktur**: Unterschiedliche Renormierung der u/d-Quark Beiträge erklärt $K_{\text{Neutron}}$
		\item **Konfinement**: Räumliche Begrenzung der Quark-Wellenfunktionen führt zu $K_{\text{Strange}}$
		\item **Chirale Dynamik**: Symmetriebrechung für leichte Quarks erklärt $K_{u/d}$
	\end{itemize}
	...
	\begin{itemize}
		\item **Erfolgreiche Erweiterung** der T0-Theorie auf Hadronen
		\item **Exakte Übereinstimmung** mit experimentellen Daten
		\item **Physikalisch abgeleitete** Korrekturfaktoren
		\item **Parameterfreiheit** durch Konsistenzbedingungen
		\item **Universelle m²-Skalierung** erhalten
	\end{itemize}
	...
	\begin{itemize}
		\item **Strange-Quark g-2**: Präzise Lattice-QCD Tests möglich
		\item **Charm/Bottom-Quarks**: Vorhersagen für schwere Quarks
		\item **Neutron-Spin-Struktur**: Weitere Forschung zur Ableitung von $K_{\text{Neutron}}$
	\end{itemize}
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025). *T0 Hadron Physical Derivation Script*.
