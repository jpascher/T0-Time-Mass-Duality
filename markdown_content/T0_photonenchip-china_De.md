...
# Einleitung: Der photonische Quantenchip als Katalysator
	...
	\begin{itemize}
		\item **Design:** Monolithisch integriert (Co-Packaging von Elektronik und Photonik), skalierbar bis $\SI{1}{Million}{Qubits}$ (hybrid).
		\item **Leistung:** $1000\times$-Speedup für parallele Tasks; $100\times$ geringerer Energieverbrauch;\\ Raumtemperatur-stabil.
		\item **Produktion:** $\SI{12000}{Wafer}/\text{Jahr}$, Ausbeute-Optimierung für industrielle Skalierung.
		\item **Anwendungen:** Molekülsimulationen (Biomed), Trajektorien-Optimierung (Aerospace), Algo-Trading (Finanz).
	\end{itemize}
