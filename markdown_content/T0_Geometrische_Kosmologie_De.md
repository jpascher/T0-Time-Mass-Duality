...
# Einleitung: Das Problem der Rotverschiebung neu gestellt
	...
	\begin{enumerate}
		\item **Keine Expansion:** Das Universum dehnt sich nicht aus.
		\item **Keine Dunkle Energie:** Das Konzept wird überflüssig.
		\item **Die Hubble-Konstante neu interpretiert:** $\Hubble$ ist keine Expansionsrate, sondern eine fundamentale Konstante, die die Wechselwirkung des Lichts mit der Geometrie des T0-Vakuums beschreibt.
	\end{enumerate}
