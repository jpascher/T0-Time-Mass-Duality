...
\begin{abstract}
	...
	**Bemerkenswert:** Die Exponenten $(2/3, 1/2)$ sind direkt mit den T0-Exponenten-Differenzen verknüpft:
	...
	\begin{theorem}
		**Verhältnis-Invarianz der Koide-Formel**
	...
	\begin{itemize}
		\item **Koide:** Reine Geometrie
		\item **$\alpha$:** Geometrie + Energieskala
		\item **$G$:** Geometrie + Energieskala + Raum-Zeit-Metrik
	\end{itemize}
	
	# Fazit
	
	\begin{theorem}
		**Die Koide-Formel ist die reinste $\xi$-Manifestation.**
