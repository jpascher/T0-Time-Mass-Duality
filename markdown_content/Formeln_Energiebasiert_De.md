...
# FUNDAMENTALE KONSTANTEN
	...
	**Elektron g-2 Vergleich:**
	...
	\begin{enumerate}
		...
		\item **One-Loop-Integral:** $(g_T^\ell)^2/(8\pi^2) \propto m_\ell^2$
		\item **Verhältnisbildung:** $a_\ell/a_\mu = (m_\ell/m_\mu)^2$
	\end{enumerate}
	...
	\begin{table}[h]
		...
		\begin{tabular}{@{}lccc@{}}
			\toprule
			**Lepton** & **T0-Vorhersage** & **Experiment** & **Abweichung** \\
			\midrule
	...
	\begin{important}
		**Zentrales Ergebnis:** Die T0-Theorie mit quadratischer Massenskalierung bietet eine vollständige, parameterfreie Beschreibung der leptonischen Anomalien basierend auf Standard-Quantenfeldtheorie. Dies stellt einen fundamentalen Fortschritt dar.
	\end{important}
