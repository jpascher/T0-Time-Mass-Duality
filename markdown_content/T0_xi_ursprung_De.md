...
# Das Zirkularitätsproblem: Eine ehrliche Analyse
	...
	**Kritik**: Warum gerade $\kappa = 7$? Warum $K = 245$? Scheint dies nicht wie ein Rückwärts-Fitting?
	...
	\begin{itemize}
		\item **Faktor 3**: Entspricht der Anzahl der Raumdimensionen
		\item **Faktor $2^2 = 4$**: Entspricht der Anzahl der Raumzeit-Dimensionen (3+1)
		\item **Faktor $5^4$**: Emergiert aus der fraktalen Struktur der Raumzeit
	\end{itemize}
	...
	\begin{tcolorbox}[colback=yellow!5!white,colframe=orange!75!black,title={Fundamentale Begründung für $\xi = \frac{4}{30000}$}]
		**1. Fraktale Raumzeit-Struktur**:
		\begin{equation}
			D_f = 3 - \xi \Rightarrow \xi = 1 - \frac{D_f}{3} = 1.333 \times 10^{-4}
		\end{equation}
		
		**2. 4-Dimensionale Raumzeit**:
		\begin{equation}
			\xi_4 \sim (10^{-1})^4 = 10^{-4}
		\end{equation}
		
		**3. Fundamentale Längenverhältnisse**:
		\begin{equation}
	...
	\begin{itemize}
		\item **Faktor 3**: Raumdimensionen
		\item **Faktor 4**: Raumzeit-Dimensionen ($2^2$)
		\item **Faktor 625**: $5^4$ - fraktale Skalierung der Mikrostruktur
	\end{itemize}
	...
	\begin{itemize}
		\item **Griechische Buchstaben** werden für fundamentale Parameter und Konstanten verwendet
		\item **Lateinische Buchstaben** bezeichnen typischerweise messbare Größen
		\item **Indizes** kennzeichnen spezifische Teilchen oder Verhältnisse
		\item **Fettdruck** hebt besonders wichtige Konzepte hervor
		\item **Farbige Boxen** gruppieren zusammenhängende Konzepte
	\end{itemize}
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025). *T0-Theorie: Grundlagen und Erweiterungen*.
