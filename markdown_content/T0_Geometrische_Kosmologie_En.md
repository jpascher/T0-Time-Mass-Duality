...
# Introduction: The Redshift Problem Reframed
	...
	# The Finite Element Model of the T0 Vacuum
	...
	# Results: Redshift as Geometric Path Stretching
	...
	# Quantitative Derivation of the Hubble Constant
	...
	\begin{enumerate}
		\item **No Expansion:** The universe is not expanding.
		\item **No Dark Energy:** The concept becomes obsolete.
		\item **The Hubble Constant Reinterpreted:** $\Hubble$ is not an expansion rate but a fundamental constant describing the interaction of light with the geometry of the T0 vacuum.
	\end{enumerate}
	...
	\begin{thebibliography}{9}
		...
		J. Pascher, *T0-Theory: Summary of Findings*, T0-Document Series, Nov. 2025.
		
		\bibitem{pascher:geometric_formalism}
		J. Pascher, *The Geometric Formalism of T0 Quantum Mechanics*, T0-Document Series, Nov. 2025.
