...
# Introduction
	...
	**T0-field velocity in different media**:
	\begin{align}
	...
	**Group velocity** (important for information propagation):
	\begin{equation}
	...
	**Resonance cavity dimensions** for period $r$:
	\begin{equation}
	...
	**Periodic boundaries** for resonance enhancement:
	\begin{equation}
	...
	**Geometry factors for different cavity shapes**:
	\begin{align}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{lccccc}
			\toprule
			**Material** & $\boldsymbol{\epsilon_r}$ & $\boldsymbol{\mu_r}$ & $\boldsymbol{c_{T0}/c}$ & $\boldsymbol{\xi_{eff}/\xi_0}$ & **Applications** \\
			\midrule
	...
	**Cavity shape optimization** for maximum period resolution:
	...
	**Coherent detection in N-cavity array**:
	\begin{equation}
	...
	**Optimal spacing between cavities**:
	\begin{equation}
	...
	**Phase coherence length**:
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{lcc}
			\toprule
			**Resource** & **Standard Shor** & **T0-Shor** \\
			\midrule
	...
	**Energy conservation in weighted form**:
	\begin{equation}
	...
	**Worst-case scenario**: Uniform distribution
	\begin{equation}
		F(m)_{uniform} = 1 \quad \text{(no advantage)}
	\end{equation}
	
	**Best-case scenario**: Perfect prior knowledge
	\begin{equation}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{lccc}
			\toprule
			**Method** & **Operations** & **Memory** & **Success Rate** \\
			\midrule
	...
	\begin{enumerate}
		\item **Existence**: Solutions exist for given boundary conditions
		\item **Uniqueness**: Solutions are unique
		\item **Continuous dependence**: Small changes in data produce small changes in solution
	\end{enumerate}
	...
	**Right side**: $[\rho/T^2] = [M L^{-3} \cdot T^{-2}]$
