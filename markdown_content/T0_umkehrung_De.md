...
# Einleitung
	...
	\begin{important}{Dokumenten-Komplementarität}{}
		Dieses Dokument konzentriert sich auf die **Validierung der Fraktaldimension** $D_f$ aus experimentellen Lepton-Massen. Es ergänzt das Hauptdokument *Teilchenmassen\_De.pdf*, das die vollständige systematische Massenberechnung für alle Fermionen präsentiert.
	\end{important}
	...
	**Experimentelle Validierung:** Abweichung zu CODATA ($\SI{0.000511}{\giga\electronvolt}$): $-0.20\%$.
	...
	**Experimentelle Validierung:** Abweichung zu CODATA ($\SI{0.105658}{\giga\electronvolt}$): $+0.002\%$.
	...
	\begin{keyresult}{Zwingende Fraktaldimension}{}
		...
		**Dies beweist:** Das experimentelle Massenverhältnis erzwingt die fraktale Geometrie -- keine freien Parameter! Diese unabhängige Validierung bestätigt die Grundlagen von *Teilchenmassen\_De.pdf*.
	\end{keyresult}
	...
	\begin{important}{Volle Transparenz}{}
		Zur Reproduktion aller numerischen Berechnungen siehe das externe Skript `t0\_df\_from\_masses\_geometry.py` im Repository-Ordner.
	\end{important}
	...
	\begin{itemize}
		\item **Parameterfreiheit:** $D_f$ wird aus experimentellen Massen erzwungen
		\item **Methoden-Konsistenz:** Unabhängige Bestätigung von *Teilchenmassen\_De.pdf*
		\item **Geometrische Fundierung:** Experimentelle Daten bestimmen Raumzeit-Struktur
		\item **Vorhersagekraft:** Testbare Konsequenzen für g-2 und neue Physik
	\end{itemize}
	...
	\begin{table}[H]
		...
		\begin{tabular}{p{6cm}p{6cm}}
			\toprule
			**Teilchenmassen\_De.pdf (Hauptdokument)** & **Dieses Dokument (Validierung)** \\
			\midrule
	...
	\begin{itemize}
		\item Pascher, J. (2025). *T0-Modell: Vollständige parameterfreie Teilchenmassen-Berechnung* (Teilchenmassen\_De.pdf). Verfügbar unter: \url{https://github.com/jpascher/T0-Time-Mass-Duality/tree/main/2/pdf/Teilchenmassen_De.pdf}
		
		\item Pascher, J. (2025). *T0-Time-Mass-Duality Repository*, GitHub v1.6. Verfügbar unter: \url{https://github.com/jpascher/T0-Time-Mass-Duality}
		
		\item CODATA (2025). *Fundamentale physikalische Konstanten*, NIST.
	\end{itemize}