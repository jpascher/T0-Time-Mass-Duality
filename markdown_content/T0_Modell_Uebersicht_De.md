...
\begin{enumerate}
	\item **Lokalisierte sphärische Felder**: Beschreiben punktförmige Teilchen. Parameter: $\xi = \frac{\ell_P}{r_0}$, $\beta = \frac{r_0}{r}$.
	\item **Lokalisierte nicht-sphärische Felder**: Für komplexe Systeme mit Multipol-Entwicklung ähnlich eurer Antennentheorie.
	\item **Ausgedehnte homogene Felder**: Kosmologische Anwendungen mit modifiziertem $\xi_{\text{eff}} = \xi/2$ durch Abschirmungseffekte.
\end{enumerate}
...
Die Eleganz liegt darin, dass eine einzige geometrische Konstante $\xi$ alle beobachtbaren Phänomene bestimmt, von subatomaren Teilchen bis zu kosmologischen Strukturen.
	...
	**GitHub-Pfad:** \url{https://github.com/jpascher/T0-Time-Mass-Duality/blob/main/2/pdf/}
	
	\begin{enumerate}
		\item **HdokumentDe.pdf** - Master-Dokument des vollständigen T0-Frameworks
		\item **Zusammenfassung\_De.pdf** - Umfassende theoretische Abhandlung
		\item **T0-Energie\_De.pdf** - Energie-basierte Formulierung
		\item **cosmic\_De.pdf** - Kosmologische Anwendungen
		\item **DerivationVonBetaDe.pdf** - Ableitung des $\beta$-Parameters
		\item **xi\_parameter\_partikel\_De.pdf** - Mathematische Analyse des $\xipar$-Parameters
		\item **systemDe.pdf** - Systemtheoretische Grundlagen
		\item **T0vsESM\_ConceptualAnalysis\_De.pdf** - Vergleich mit dem Standardmodell
	\end{enumerate}
	...
	**Dokumentenverweis:** *HdokumentDe.pdf*, *Zusammenfassung\_De.pdf*
	...
	**Dokumentenverweis:** *T0-Energie\_De.pdf*, *systemDe.pdf*
	...
	**Dokumentenverweis:** *T0-Energie\_De.pdf*, *HdokumentDe.pdf*
	...
	**Dokumentenverweis:** *xi\_parameter\_partikel\_De.pdf*, *DerivationVonBetaDe.pdf*
	...
	**Dokumentenverweis:** *T0-Energie\_De.pdf*
	...
	**Dokumentenverweis:** *CompleteMuon\_g-2\_AnalysisDe.pdf*, *detailierte\_formel\_leptonen\_anemal\_De.pdf*
	...
	**Dokumentenverweis:** *CompleteMuon\_g-2\_AnalysisDe.pdf*, *T0-Theorie: Formeln fuer xi und Gravitationskonstante.md*
	...
	**Dokumentenverweis:** *cosmic\_De.pdf*
	...
	**Dokumentenverweis:** *QM-Detrmistic\_p\_De.pdf*, *scheinbar\_instantan\_De.pdf*, *QM-testenDe.pdf*, *T0-Energie\_De.pdf*
	...
	**Dokumentenverweis:** *T0-Energie\_De.pdf*, *Zusammenfassung\_De.pdf*
