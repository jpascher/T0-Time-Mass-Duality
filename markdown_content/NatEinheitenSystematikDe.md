	...
	{\small
		\begin{table}[htbp]
			...
			\begin{adjustbox}{width=0.98\textwidth}
				\begin{tabular}{lll}
					\toprule
					**Symbol** & **Bedeutung** & **Einheiten/Notizen** \\
					\midrule
					\multicolumn{3}{c}{**Fundamentale Konstanten**} \\
					...
					\midrule
					\multicolumn{3}{c}{**Kopplungskonstanten**} \\
					...
					\midrule
					\multicolumn{3}{c}{**Physikalische Größen**} \\
					...
					\midrule
					\multicolumn{3}{c}{**Spezielle Skalen \& Notation**} \\
...
# Einleitung
	...
	Natürliche Einheiten sind Einheitensysteme, in denen fundamentale physikalische Konstanten auf Eins gesetzt werden, um Berechnungen zu vereinfachen und die zugrundeliegende mathematische Struktur physikalischer Gesetze zu offenbaren. Die bekanntesten Systeme sind **Planck-Einheiten** (für Gravitation und Quantenphysik) und **atomare Einheiten** (für Quantenchemie).
	...
	\begin{table}[htbp]
		...
		\begin{adjustbox}{width=0.95\textwidth}
			\begin{tabular}{lllll}
				\toprule
				**System** & **Konstanten = 1** & **Basiseinheiten** & **Anwendungen** & **Notizen** \\
				\midrule
	...
	Planck erkannte, dass diese Einheiten *ihre Bedeutung für alle Zeiten und für alle, einschließlich außerirdischer und nicht-menschlicher Kulturen notwendigerweise behalten* \cite{planck1900}.
	...
	\begin{itemize}
		\item **Vereinfachte Gleichungen** (z.B. $E = m$ statt $E = mc^2$)
		\item **Keine überflüssigen Konstanten** in Berechnungen
		\item **Universelle Skalierung** für fundamentale Physik
		\item **Offenbaren fundamentaler Beziehungen** zwischen physikalischen Größen
		\item **Bieten Dimensionskonsistenz-Prüfungen**
		\item **Eliminieren willkürliche Umwandlungsfaktoren**
		\item **Heben die universelle Rolle der Energie hervor**
	\end{itemize}
	...
	**Länge:** Aus der Beziehung $\hbar c = 1$ folgt:
	\begin{equation}
		[L] = \frac{[\hbar][c]}{[E]} = [E]^{-1}
	\end{equation}
	
	**Zeit:** Aus $\hbar = 1$ und $E = \hbar \omega$ folgt:
	\begin{equation}
		[T] = \frac{[\hbar]}{[E]} = [E]^{-1}
	\end{equation}
	
	**Masse:** Aus $E = mc^2$ und $c = 1$ folgt:
	\begin{equation}
		[M] = [E]
	\end{equation}
	...
	**Ladung:** In Planck-Einheiten aus $F = \frac{1}{4\pi\varepsilon_0} \frac{q^2}{r^2}$:
	\begin{equation}
		[q] = [E]^{1/2}
	\end{equation}
	...
	\begin{table}[htbp]
		...
		\begin{adjustbox}{width=0.9\textwidth}
			\begin{tabular}{lccc}
				\toprule
				**Physikalische Größe** & **SI-Dimension** & **Natürliche Dimension** & **Herleitung** \\
				\midrule
	...
	\begin{table}[htbp]
		...
		\begin{adjustbox}{width=0.95\textwidth}
			\begin{tabular}{lccc}
				\toprule
				**Skala** & **Symbol** & **SI-Wert (m)** & **Natürliche Einheiten ($l_P = 1$)** \\
				\midrule
	...
	\begin{table}[htbp]
		...
		\begin{adjustbox}{width=0.9\textwidth}
			\begin{tabular}{lll}
				\toprule
				**Physikalische Größe** & **Umwandlung zu SI** & **Beispiel (1 GeV)** \\
				\midrule
	...
	\begin{table}[htbp]
		...
		\begin{adjustbox}{width=0.8\textwidth}
			\begin{tabular}{lll}
				\toprule
				**Planck-Einheit** & **Natürlicher Wert** & **SI-Wert** \\
				\midrule
	...
	## Nachteile
	\begin{itemize}
		\item **Unintuitive für makroskopische Anwendungen**
		\item **Umwandlung zu SI erfordert Kenntnis** fundamentaler Konstanten
		\item **Anfängliche Unvertrautheit** für an SI-Einheiten Gewöhnte
		\item **Ingenieurspräferenz** für praktische SI-Einheiten
	\end{itemize}
	...
	\begin{table}[htbp]
		...
		\begin{adjustbox}{width=0.9\textwidth}
			\begin{tabular}{llll}
				\toprule
				**Kraft** & **Dimensionslose Kopplung** & **Typischer Wert** & **Reichweite** \\
				\midrule
	...
	\begin{table}[htbp]
		...
		\begin{adjustbox}{width=0.95\textwidth}
			\begin{tabular}{lcccc}
				\toprule
				**SI-Einheit** & **SI-Dimension** & **Natürliche Dimension** & **Umwandlung** & **Genauigkeit** \\
				\midrule
	...
	\begin{thebibliography}{10}
		...
		*Classical Electrodynamics*,
		...
		J. Pascher,
		*Jenseits der Planck-Skala: Die T0-Länge in der Quantengravitation*,
		24. März 2025.
