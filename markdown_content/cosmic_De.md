...
\end{tcolorbox}
	...
	**Experimentelle Bestätigung:**
	...
	\begin{enumerate}
		\item **Universelle $\xi$-Skalierung**: Alle Phänomene folgen aus $\xi = \frac{4}{3} \times 10^{-4}$
		...
		\item **Dimensionale Konsistenz**: Vollständig in natürlichen Einheiten formuliert
		\item **Einheitenunabhängige Physik**: Exakte mathematische Verhältnisse
	\end{enumerate}
	...
	\begin{thebibliography}{20}
		...
		*Geometric Determination of the Gravitational Constant: From the T0-Model*. 
		...
		Pascher, Johann (2025). 
		*T0-Theorie: Wellenlängenabhängige Rotverschiebung ohne Distanzannahmen*. 
		T0-Theorie Projekt. 
