...
# Introduction
	...
	\begin{important}{Document Complementarity}{}
		This document focuses on the **validation of fractal dimension** $D_f$ from experimental lepton masses. It complements the main document *ParticleMasses\_En.pdf*, which presents the complete systematic mass calculation for all fermions.
	\end{important}
	...
	T0-theory offers several mathematically equivalent methods for mass calculation. In this document we use the **direct geometric method** specifically to validate the fractal dimension.
	...
	**Experimental Validation:** Deviation from CODATA ($\SI{0.000511}{\giga\electronvolt}$): $-0.20\%$.
	...
	\begin{table}[H]
		...
		\begin{tabular}{lccc}
			\toprule
			**Method** & **$m_e$ [GeV]** & **Accuracy** & **Source** \\
			\midrule
	...
	**Experimental Validation:** Deviation from CODATA ($\SI{0.105658}{\giga\electronvolt}$): $+0.002\%$.
	...
	\begin{keyresult}{Compelling Fractal Dimension}{}
		...
		**This proves:** The experimental mass ratio compels the fractal geometry -- no free parameters! This independent validation confirms the foundations of *ParticleMasses\_En.pdf*.
	\end{keyresult}
	...
	\begin{important}{Full Transparency}{}
		For reproduction of all numerical calculations see the external script `t0\_df\_from\_masses\_geometry.py` in the repository folder.
	\end{important}
	...
	\begin{itemize}
		\item **Parameter Freedom:** $D_f$ is compelled by experimental masses
		\item **Method Consistency:** Independent confirmation of *ParticleMasses\_En.pdf*
		\item **Geometric Foundation:** Experimental data determines spacetime structure
		\item **Predictive Power:** Testable consequences for g-2 and new physics
	\end{itemize}
	...
	\begin{table}[H]
		...
		\begin{tabular}{p{6cm}p{6cm}}
			\toprule
			**ParticleMasses\_En.pdf (Main Doc)** & **This Document (Validation)** \\
			\midrule
