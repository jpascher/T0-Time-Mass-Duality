...
# Einleitung: Das Instantanitätsproblem
	...
	**1. Die vollständige Feldgleichung:**
	\begin{equation}
		\nabla^2 m = 4\pi G \rho(\mathbf{x},t) \cdot m \label{eq:field_equation}
	\end{equation}
	wobei $\rho(\mathbf{x},t)$ die Massendichte ist. Diese Gleichung ist *nicht* instantan, sondern eine Wellengleichung mit endlicher Ausbreitungsgeschwindigkeit $v \leq c$.
	...
	**2. Die modifizierte Schrödinger-Gleichung:**
	\begin{equation}
	...
	\begin{center}
		\begin{tikzpicture}[scale=1.2]
			% Titel
			\node at (6, 7) {\Large **Lokale Zwangsbedingung vs. Globale Ausbreitung**};
			
			% Lokale Zwangsbedingung (links)
			\draw[thick, fill=t0blue!20] (0,0) circle (2);
			\node at (0, 3) {**Lokale Ebene**};
	...
	\begin{tcolorbox}[colback=t0blue!5!white, colframe=t0blue!75!black, title=T0-Vorhersage]
		...
		\end{itemize}
		Dies ist *keine* empirische Anpassung, sondern eine geometrische Vorhersage.
	\end{tcolorbox}
	...
	\begin{center}
		\begin{tikzpicture}[scale=1.3]
			% Titel
			\node at (0, 6) {\Large **Die fundamentale Energie-Zeit-Dualität**};
			...
			\node at (0, -2.5) {**Komplementaritätsprinzip:**};
			...
			\node at (0, -0.8) {\small **Planck-Skala:** Alle gleich};
			
			% Skalenabhängigkeit
			\node[right] at (-1, 2.5) {\small **Dominant bei:**};
	...
	\begin{itemize}
		\item **Planck-Skala:** Alle Aspekte sind gleichwertig, keine Näherung gültig
		\item **Atomare Skala:** Energie-Zeit-Dualität dominiert, Gravitation vernachlässigbar
		\item **Makroskopische Skala:** Masse-Aspekt dominant, Quanteneffekte unterdrückt
		\item **Kosmologische Skala:** Raum-Zeit-Struktur dominant, lokale Quanteneffekte irrelevant
	\end{itemize}
	...
	\begin{tcolorbox}[colback=t0yellow!10!white, colframe=t0yellow!75!black, title=Wichtige Einsicht]
		Singularitäten sind **nicht** das Ziel der T0-Theorie. Sie repräsentieren vielmehr Grenzen der Anwendbarkeit:
		\begin{itemize}
	...
	\begin{itemize}
		\item **Hochenergiephysik:** Energie-Aspekt dominant, Zeit-Aspekt unscharf
		\item **Kosmologie:** Zeit-Aspekt auf großen Skalen dominant, lokale Energie unscharf
		\item **Quantengravitation:** Beide Aspekte wichtig, keine einfache Näherung möglich
	\end{itemize}
	...
	\begin{enumerate}
		\item **Skalenbeachtung:** Immer prüfen, welche Skala dominant ist
		\item **Kleine Effekte ernst nehmen:** $\xi$-Korrekturen und Gravitationseffekte nicht ignorieren
		\item **Singularitäten vermeiden:** Als Hinweis auf Theoriegrenzen verstehen
		\item **Komplementarität respektieren:** Nicht alle Aspekte können gleichzeitig scharf sein
		\item **Experimentelle Überprüfbarkeit:** Nur Vorhersagen machen, die prinzipiell messbar sind
	\end{enumerate}
	...
	\begin{itemize}
		\item **Lokale Bedingung:** $T \cdot E = 1$ an beiden Messorten
		\item **Gemeinsames Feld:** Verschränkte Teilchen teilen Feldkonfiguration
		\item **Kausale Ausbreitung:** Feldänderungen propagieren mit $c$
		\item **Korrelation ohne Kommunikation:** Vorstrukturiertes Feld, keine Signalübertragung
	\end{itemize}
	...
	**Numerisches Beispiel:**
	...
	\begin{enumerate}
		\item **Satelliten-Bell-Test:** Verschränkte Photonen zwischen Erdstation und Satellit
		\item **Lunar Laser Ranging:** Präzisionsmessung von Quantenkorrelationen Erde-Mond
		\item **Deep Space Quantum Network:** Test bei interplanetaren Distanzen
	\end{enumerate}
	...
	\begin{enumerate}
		\item **Lokale Ebene:** $T \cdot E = 1$ als Zwangsbedingung (keine Dynamik)
		\item **Feld-Ebene:** Wellengleichung mit Ausbreitung $v \leq c$ (kausale Dynamik)
		\item **Messbare Ebene:** Erscheint instantan wegen $\Delta t < $ Auflösung
	\end{enumerate}
	...
	\begin{thebibliography}{99}
		...
		T0-Theorie Grundlagen (2024). *Zeit-Masse-Dualität und geometrische Feldtheorie*. Internes Forschungsdokument.
