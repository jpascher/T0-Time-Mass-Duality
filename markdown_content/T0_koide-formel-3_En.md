...
\begin{abstract}
	...
	\begin{beweis}
		...
		**Experimental:** $\frac{m_e}{m_\mu} = 0.004836$ (PDG 2024)\\
		**Deviation:** $< 0.5\%$
	\end{beweis}
	...
	\begin{beweis}
		...
		**Experimental:** $\frac{m_\mu}{m_\tau} = 0.05947$ (PDG 2024)\\
		**Deviation:** $< 3\%$
	\end{beweis}
	...
	\begin{beweis}
		...
		**Experimental:** $\frac{m_e}{m_\tau} = 0.0002876$ (PDG 2024)\\
		**Deviation:** $< 0.7\%$
	\end{beweis}
	...
	\begin{folgerung}
		**The Koide formula is not an independent symmetry, but a direct manifestation of $\xi$.**
	...
	**Experimental:** $\alpha = \frac{1}{137.036} = 0.0072973525693$\\
	**Error:** $0.006\%$
	...
	**Remarkable:** The exponents $(2/3, 1/2)$ are directly linked to the T0 exponent differences:
	\begin{itemize}
	...
	\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title={Semi-pure $\xi$-Form}]
		**Accuracy:** $\Delta \alpha \approx 0.006\%$
	...
	\begin{theorem}
		**Ratio Invariance of the Koide Formula**
	...
	\begin{table}[h]
		...
		\begin{tabular}{lcc}
			\toprule
			**Constant** & **Type** & **Fractal Correction?** \\
			\midrule
			$Q$ (Koide) & Ratio & **NO** \\
			$m_p/m_e$ & Ratio & **NO** \\
			$\alpha$ & Absolute with Scale & **MINIMAL** \\
			$G$ & Absolute with SI & **YES** \\
			\bottomrule
		\end{tabular}
	...
	\begin{folgerung}
		**All three fundamental constants arise from $\xi$:**
	...
	\begin{itemize}
		\item **Koide:** Pure Geometry
		\item **$\alpha$:** Geometry + Energy Scale
		\item **$G$:** Geometry + Energy Scale + Space-Time Metric
	\end{itemize}
	
	# Conclusion
	
	\begin{theorem}
		**The Koide formula is the purest $\xi$-manifestation.**
	...
	**Historical Irony:** Koide discovered a relation in 1981 that already contained $\xi$, but only 40 years later does the geometric foundation become visible. The perfect accuracy of the Koide formula ($< 0.00003\%$) is no coincidence, but a consequence of its ratio-based nature.
	...
	\begin{thebibliography}{99}
		...
		\bibitem{Brannen2005}
		C. P. Brannen, ``The Lepton Masses'', *arXiv:hep-ph/0501382* (2005).
		\url{https://brannenworks.com/MASSES2.pdf}
		
		\bibitem{Brannen2007}
		C. P. Brannen, ``Koide mass equations for hadrons'', *arXiv:0704.1206* (2007).
		\url{http://www.brannenworks.com/koidehadrons.pdf}
		
		\bibitem{PhaseVectors2025}
		Anonymous, ``The Koide Relation and Lepton Mass Hierarchy from Phase Vectors'', *rxiv.org* (2025).
		\url{https://rxiv.org/pdf/2507.0040v1.pdf}
		
		\bibitem{KoideReview2005}
		M. I. Tanimoto, ``The strange formula of Dr. Koide'', *arXiv:hep-ph/0505220* (2005).
