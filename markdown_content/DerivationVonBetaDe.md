...
# Einführung und Motivation
	...
	**Asymptotische Randbedingung**: Für große Entfernungen soll das Zeitfeld einen konstanten Wert $T_0$ annehmen:
	\begin{equation}
	...
	**Verhalten am Ursprung**: Verwendung des Gaußschen Satzes \citep{griffiths1999,jackson1998} für eine kleine Kugel um den Ursprung:
	\begin{equation}
	...
	\begin{itemize}
		\item **Gravitationspotential**: $\beta$ ist proportional zum Newtonschen Potential $\Phi = -Gm/r$
		\item **Schwarzschild-Radius**: $\beta = r_s/(2r)$ in geometrischen Einheiten
		\item **Fluchtgeschwindigkeit**: $\beta$ ist verwandt mit $v_{\text{esc}}^2/c^2$
	\end{itemize}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{lcc}
			\toprule
			**Physikalisches System** & **Typischer $\beta$-Wert** & **Regime** \\
			\midrule
	...
	\begin{itemize}
		\item **Energieerhaltung**: Durch die Lagrange-Formulierung gewährleistet
		\item **Impulserhaltung**: Aus der räumlichen Translationsinvarianz
		\item **Dimensionskonsistenz**: In allen Herleitungsschritten verifiziert
	\end{itemize}
	...
	\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Hauptergebnisse]
		\begin{enumerate}
			\item **Exakte Herleitung**: $\beta = \frac{2Gm}{r}$ aus der fundamentalen Feldgleichung
			\item **Dimensionskonsistenz**: Der Parameter ist dimensionslos in natürlichen Einheiten
			\item **Physikalische Interpretation**: $\beta$ misst die Stärke des dynamischen Zeitfeldes
			\item **Verbindung zur ART**: Identität mit dem Gravitationsparameter der allgemeinen Relativitätstheorie
			\item **Testbare Vorhersagen**: Spezifische experimentelle Signaturen vorhergesagt
		\end{enumerate}
	\end{tcolorbox}
