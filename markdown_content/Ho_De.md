...
# Einleitung: Die Hubble-Konstante neu gedacht
	...
	\begin{longtable}{|c|l|l|}
		\hline
		**Symbol** & **Bedeutung** & **Dimension [Natürliche Einheiten]** \\
		\hline
	...
	\begin{itemize}
		...
		\item **Masse**: $[M] = [E]$ (Energie)
		\item **Frequenz**: $[\omega] = [E]$ (Energie)
	\end{itemize}
...
# Das universelle $\xi$-Feld-Framework
...
\end{equation}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{lccc}
			\toprule
			**Quelle** & **$H_0$ (km/s/Mpc)** & **Unsicherheit** & **Methode** \\
			\midrule
			\rowcolor{blue!20}
			**T0-Vorhersage** & **67{,**2} & **Parameterfrei** & **$\xi$-Feld-Theorie** \\
	...
	\begin{thebibliography}{99}
		...
		Pascher, J. (2025). *T0-Theorie: Universelle $\xi$-Konstante und kosmischer Mikrowellen-Hintergrund*. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/cosmicDe.pdf}
		
		\bibitem{pascher_redshift_2025}
		Pascher, J. (2025). *T0-Theorie: Wellenlängenabhängiger Rotverschiebungs-Mechanismus*. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/redshift_deflectionDe.pdf}
		
		\bibitem{pascher_t0_energie_2025}
		Pascher, J. (2025). *T0-Modell: Energiebasierte Formulierung*. Verfügbar unter: \url{https://jpascher.github.io/T0-Time-Mass-Duality/2/pdf/T0-EnergieDe.pdf}
		...
		\bibitem{wong_2020}
		Wong, K. C., et al. (2020). *H0LiCOW measurement of H0 from lensed quasars*. Mon. Not. R. Astron. Soc. 498, 1420.
