			...
			\begin{adjustbox}{width=0.98\textwidth}
				\begin{tabular}{lll}
					...
					**Symbol** & **Meaning** & **Units/Notes** \\
					\midrule
					\multicolumn{3}{c}{**Fundamental Constants**} \\
					...
					\midrule
					\multicolumn{3}{c}{**Coupling Constants**} \\
					...
					\midrule
					\multicolumn{3}{c}{**Physical Quantities**} \\
					...
					\midrule
					\multicolumn{3}{c}{**Special Scales \& Notation**} \\
...
# Introduction
	...
	\begin{table}[htbp]
		...
		\begin{adjustbox}{width=0.95\textwidth}
			\begin{tabular}{lllll}
				\toprule
				**System** & **Constants Set to 1** & **Base Units** & **Applications** & **Notes** \\
				\midrule
	...
	Planck recognized that these units *``retain their meaning for all times and for all, including extraterrestrial and non-human cultures necessarily''* \cite{planck1900}.
	...
	**Length:** From the relation $\hbar c = 1$ it follows:
	\begin{equation}
		[L] = \frac{[\hbar][c]}{[E]} = [E]^{-1}
	\end{equation}
	
	**Time:** From $\hbar = 1$ and $E = \hbar \omega$ it follows:
	\begin{equation}
		[T] = \frac{[\hbar]}{[E]} = [E]^{-1}
	\end{equation}
	
	**Mass:** From $E = mc^2$ and $c = 1$ it follows:
	\begin{equation}
		[M] = [E]
	\end{equation}
	...
	**Charge:** In Planck units from $F = \frac{1}{4\pi\varepsilon_0} \frac{q^2}{r^2}$:
	\begin{equation}
		[q] = [E]^{1/2}
	\end{equation}
	...
	\begin{table}[htbp]
		...
		\begin{adjustbox}{width=0.9\textwidth}
			\begin{tabular}{lccc}
				\toprule
				**Physical Quantity** & **SI Dimension** & **Natural Dimension** & **Derivation** \\
				\midrule
	...
	\begin{table}[htbp]
		...
		\begin{adjustbox}{width=0.95\textwidth}
			\begin{tabular}{lccc}
				\toprule
				**Scale** & **Symbol** & **SI Value (m)** & **Natural Units ($l_P = 1$)** \\
				\midrule
	...
	\begin{table}[htbp]
		...
		\begin{adjustbox}{width=0.9\textwidth}
			\begin{tabular}{lll}
				\toprule
				**Physical Quantity** & **Conversion to SI** & **Example (1 GeV)** \\
				\midrule
	...
	\begin{table}[htbp]
		...
		\begin{adjustbox}{width=0.8\textwidth}
			\begin{tabular}{lll}
				\toprule
				**Planck Unit** & **Natural Value** & **SI Value** \\
				\midrule
	...
	\begin{table}[htbp]
		...
		\begin{adjustbox}{width=0.9\textwidth}
			\begin{tabular}{llll}
				\toprule
				**Force** & **Dimensionless Coupling** & **Typical Value** & **Range** \\
				\midrule
	...
	\begin{table}[htbp]
		...
		\begin{adjustbox}{width=0.95\textwidth}
			\begin{tabular}{lcccc}
				\toprule
				**SI Unit** & **SI Dimension** & **Natural Dimension** & **Conversion** & **Accuracy** \\
				\midrule
	...
	\begin{thebibliography}{10}
		...
		*Classical Electrodynamics*,
		...
		J. Pascher,
		*Beyond the Planck Scale: The T0 Length in Quantum Gravity*,
		March 24, 2025.
