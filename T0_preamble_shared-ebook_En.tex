...
% Math Font wird nach unicode-math gesetzt (siehe unten)
...
\RequirePackage{unicode-math}    % THEN unicode-math
...
% === CHAPTER 6: PAGE LAYOUT (eBook format - smaller margins) ===
...
\renewcommand{\cftchapfont}{\small\color{black}}           % Chapter klein
\renewcommand{\cftsecfont}{\footnotesize\color{blue}}         % Section sehr klein
\renewcommand{\cftsubsecfont}{\scriptsize\color{blue}}        % Subsection winzig
\renewcommand{\cftchappagefont}{\small}
\renewcommand{\cftsecpagefont}{\footnotesize\color{blue}}
\renewcommand{\cftsubsecpagefont}{\scriptsize\color{blue}}
\renewcommand{\cfttoctitlefont}{\large\bfseries\color{blue}}  % TOC-Titel normal (war \Large)
