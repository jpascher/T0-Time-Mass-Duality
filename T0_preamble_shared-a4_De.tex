...
\counterwithout{section}{chapter}  % Falls Kapitel existieren
...
% Caution environment (Vorsicht)
\newenvironment{vorsicht}{%
	\begin{mdframed}[linecolor=orange!40!red,linewidth=1pt,roundcorner=4pt,backgroundcolor=orange!5]%
	}{%
	\end{mdframed}%
}
