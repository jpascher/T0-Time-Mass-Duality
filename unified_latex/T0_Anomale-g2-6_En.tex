...
```
	...
	[label=\textbf{Step \arabic*:}]
		...
		- Scaling $\times 10^{11} \approx 251.6 \times 10^{-11}$.
...
```
	...
	\begin{interpretation}{Key Differences / Implications}
			...
			- \textbf{Core Idea}: T0: 4D-extending, geometric (no extra Dim.); Strings: high-dim., fundamentally changing. T0 more testable (g-2).
			- \textbf{Unification}: T0: Minimalist (1 parameter $\xi$); Strings: Many moduli (landscape problem, $\sim 10^{500}$ vacua). T0 parameter-free.
			- \textbf{g-2 Anomaly}: T0: Exact ($\sim 0\sigma$ post-2025); Strings: Generic, no precise prediction. T0 empirically stronger.
