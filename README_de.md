...
### Mai 2026 (v1.0.14): Dreieck-Matrix-Reduktionstheorem und Brücken zur Bewusstseinsdiskussion 🔺

Dieses Release ergänzt zwei neue Dokumente, die zentrale Begriffe aus den Diskussionen der *Information Physics Institute*-Mailingliste algebraisch im Z₃-Skelett der FFGFT verankern und dieses Skelett mit den bestehenden bewusstseinsbezogenen FFGFT-Dokumenten (Dok. 100, Dok. 170) verbinden. Dok. 206 beweist das Dreieck-Matrix-Reduktionstheorem; Dok. 207 stellt unter expliziten methodischen Selbstkontrollen die strukturellen Brücken zur Bewusstseinsdiskussion her. Dreizehn reproduzierbare Python-Skripte begleiten Dok. 206.
