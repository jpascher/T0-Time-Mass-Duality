...
LaTeX-Struktur: Wrapper in `2/Sources/wr_standalone_A4/` und `2/Sources/wr_books/`
referenzieren Präambeln aus `2/Sources/pri-end/`. Kapitelinhalte in
`2/Sources/ch/` als `NNN_..._De/En_ch.tex`.
...
|---------|-----|-------------|
| v1.2.3 | *(wird beim Zenodo-Upload vergeben)* | Der Umkehrtest: **fundamental ⇔ umkehrbar**; Information ist der AUSGANG eines Comparators, keine Grundeinheit; das Bit als ultimative (irreduzible, irreversible) Reduktion, Landauer kT ln2 als diese Irreversibilität (Dok. 301). Drei Ebenen von Information (Bit / Beschreibung / absolute Identität). Reflexiver Schluss in zwei Registern: zeitliche und topologische Randlosigkeit als Folgerungen gebucht (Rekursion ohne erreichbaren Rand, ∂T⁴=∅, Zeit = D(k), kein Anfang / kein Außen); Realisten-Setzung und Diagnose des Wort-Reflexes als über-die-Mathematik-hinaus markiert (P35). FFGFT ausdrücklich Ebene 2 (Beschreibung) |
...
| v1.1.0 | [20117635](https://doi.org/10.5281/zenodo.20117635) | Hilbertraum-Bijektion |
| v1.0.14 | [20041543](https://doi.org/10.5281/zenodo.20041543) | Dreieck-Matrix-Reduktion |
