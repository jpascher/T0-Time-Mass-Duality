...
\item
  Kapitel 2 --- Dualität, Symmetrien und der ξ‑Parameter (mit
  numerischer Intuition)
\item
  Kapitel 3 --- Geometrische Bilder und einfache Modelle
\item
  Kapitel 4 --- Wie aus simplen Ideen Teilchenmassen entstehen (Koide,
  Beispiele)
\item
...
\tightlist
\item
  Zusätzliche, kleine Effektterme proportional zu ξ verändern die
  effektiven vertex‑Faktoren (Kopplungen).
\item
  Geometrisch bestimmte Summationsmuster in Schleifenintegralen führen
  zu numerischen Faktoren, die in Kombination mit ξ
...
\tightlist
\item
  g‑2: Vergleich mit nächsten Fermilab‑Auswertungen, kombinierte
  Theorie‑Verbesserungen
\item
...
\tightlist
\item
  ξ (xi): kleiner, dimensionsloser Parameter; typische Größenordnung
  \textasciitilde4/3×10⁻⁴ in vorläufigen Fits.
\item
...
\tightlist
\item
  {[}1{]} Pascher, J. (2025). T0\_Complete\_Book\_De.pdf. Release V3.4.
  \url{https://github.com/jpascher/T0-Time-Mass-Duality}
\item
  {[}2{]} Particle Data Group (PDG). \url{https://pdg.lbl.gov/}
\item
  {[}3{]} Fermilab Muon g-2 Collaboration. Physical Review Letters.
\item
  {[}4{]} Zenodo-Archiv: \url{https://doi.org/10.5281/zenodo.17522475}
\end{itemize}
