...
# -*- coding: utf-8 -*-
"""
a282_rechenkugel.py  --  Pruefskript zu FFGFT A282 "Die Rechenkugel"
...
Aufruf:  python3 a282_rechenkugel.py
"""
...
E_cmos_lo  = 1e-17        # J    CMOS-Schaltvorgang, untere Angabe (A280)
E_cmos_hi  = 1e-16        # J    CMOS-Schaltvorgang, obere Angabe (A280)
...
print("=" * 78)
print("A282 -- Die Rechenkugel: Pruefskript")
print("=" * 78)
...
# ------------------------------------------------------------
# Check 11 -- Rueckkopplungsschranke (A281, Gl. 7):
...
print(f"         eigenen Ensemble-Vorbehalt (A281, Abschnitt 5).")
