...
% longtable: bricht automatisch über Seiten um (tabular konnte das nicht)
\begin{longtable}{lp{\dimexpr\textwidth-3.2cm\relax}}
\toprule
...
\endhead
\midrule
\multicolumn{2}{r}{\textit{(Fortsetzung nächste Seite)}} \\
\endfoot
\bottomrule
\endlastfoot
