...
This document subsumes: Doc.~013 (dimensional analysis, gravitational constant
from $\xi$, Planck length, conversion factors), Doc.~014 (natural units,
dimension table, scaling factor $S_{T0}$, derivation vs.\ back-computation),
Doc.~015 (unit conversions, energy dimension table, force/pressure/charge).
