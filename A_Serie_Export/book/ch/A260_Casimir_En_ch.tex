...
\end{align}
Sub-Planck (spacetime granulation), Planck length,
and characteristic vacuum length scale (measurable).
...
This document subsumes: Doc.~091 (modified Casimir theory, length scale hierarchy,
numerical verification, experimental predictions and tests). \emph{Not} taken over:
the Casimir vacuum scaling from Doc.~091 (excluded sector, outside A-series core)
