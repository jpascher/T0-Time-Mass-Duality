...
\begin{align}
  \xi &\;\xrightarrow{\text{geometry}}\; r_0,E_0^\text{scale}
...
This document subsumes: Doc.~070 (mathematical structure of T0 theory: circular
...
Doc.~093 ($\beta$-parameter derivation, self-consistency condition).
