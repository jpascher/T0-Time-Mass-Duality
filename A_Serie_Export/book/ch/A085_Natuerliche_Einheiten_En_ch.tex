...
\begin{align}
  c    &:\;\text{length}      \leftrightarrow\text{time}, \notag\\
  \hbar&:\;\text{mass}        \leftrightarrow\text{time}, \notag\\
...
\begin{itemize}
  \item That $\tilde T\cdot m=1$ reduces the four-dimension system to one
    ...
    \path{python/A_Serie_Skripte/a085_natuerliche_einheiten.py}
\end{itemize}
...
the corresponding parts of: Doc.~013 (SI), Doc.~014 (natural/SI), Doc.~015
(systematics of natural units), Doc.~012 (units section). Incorporated: P40.
