...
% Version: 3.1 – KOMA-Script Support (LuaLaTeX only)
...
% - scrbook (KOMA-Script) für Print-Versionen → BCOR + DIV in documentclass
% - book (Standard) für eBook-Versionen → geometry wird unten geladen
%
...
% === KAPITEL 0: COUNTER FIX (muss als ERSTES kommen) ===
% FIX: Verhindert "No room for a new \write" Fehler bei vielen \input Befehlen
% morewrites erweitert die Anzahl verfügbarer write streams von 16 auf 256
\RequirePackage{morewrites}

% === KAPITEL 1: GRUNDLEGENDE PAKETE (müssen ZUERST kommen) ===
\RequirePackage{fontspec}
% unicode-math wird später geladen (nach mathtools)
...
% Dann unicode-math (MUSS VOR amsmath kommen!)
\RequirePackage{unicode-math}

% Math Font (MUSS NACH unicode-math kommen)
% WICHTIG: Libertinus Math für korrekte \underbrace-Darstellung!
\setmathfont{Libertinus Math}[Scale=1.0]

% Jetzt erst die AMS-Pakete (NACH unicode-math!)
% amssymb entfernt - Konflikt mit unicode-math (Symbole bereits definiert)
...
% Benutzerdefinierte SI-Einheiten für Narrative und Bücher
...
% WICHTIG: Geometry-Handling hängt von der Document Class ab:
%
% PRINT-VERSIONEN (scrbook):
%   - Verwenden BCOR=16mm und DIV=calc in \documentclass
%   - KEIN \usepackage{geometry} nötig!
%   - KOMA-Script berechnet Ränder automatisch
%
% eBOOK-VERSIONEN (book class):
%   - Verwenden \usepackage{geometry} mit Kindle-Format
%   - Siehe Teil*_ebook_*.tex für geometry-Einstellungen
%   - Format: 6" x 9" mit symmetrischen Rändern

\setlength{\headheight}{15pt}

% A4 page geometry (210 x 297 mm)
\usepackage[
  paperwidth=6in,    % = 432bp im PDF (exakt 6.000")
  paperheight=9in,   % = 648bp im PDF (exakt 9.000")
  top=0.75in,
  bottom=0.75in,
  inner=0.875in,     % Bundsteg (KDP-Min 0.625" für 414 S.)
  outer=0.625in,     % Außenrand
  twoside,
  headheight=14pt,
  headsep=8pt,
  footskip=0.4in
...
% Line break tolerance for narrow pages
\sloppy
\emergencystretch=4em

% Auto-resize wide tabular environments to fit page width
\usepackage{etoolbox}
...
\usepackage{hyperref}
% =============================================================================
% TOC-Tiefe und Appendix-Zähler Konfiguration
% =============================================================================
% Verhindert "Counter too large" Fehler bei >26 Appendizes
% Beschränkt Inhaltsverzeichnis auf erste Ebene
\setcounter{tocdepth}{1}        % Nur chapter und section im TOC
\setcounter{secnumdepth}{1}     % Nur chapter und section nummeriert

% Erweitere Appendix-Zähler für mehr als 26 Kapitel
\usepackage{alphalph}
\makeatletter
...
% Additional common environments - synchronisiert mit Englischer Version
\newenvironment{gemeinsam}{\begin{quote}}{\end{quote}}
\newenvironment{vergleich}{\begin{quote}}{\end{quote}}
\newenvironment{vorteil}{\begin{quote}}{\end{quote}}
\newenvironment{beweisumgebung}{\begin{quote}}{\end{quote}}
\newenvironment{bemerkung}{\begin{quote}}{\end{quote}}

% === FIX: Unterstützt >26 Appendices ===
% Standard LaTeX verwendet \Alph (A-Z, max 26) für Appendices
% Dies ändert zu arabischen Zahlen für unbegrenzte Appendices
\makeatletter
\renewcommand\appendix{\par
  \setcounter{chapter}{0}%
  \setcounter{section}{0}%
  \gdef\@chapapp{\appendixname}%
  \gdef\thechapter{\@arabic\c@chapter}}  % Geändert von \@Alph zu \@arabic
\makeatother
...
\renewcommand{\cftchapfont}{\footnotesize\color{black}}     % Chapter sehr klein (war \small)
\renewcommand{\cftsecfont}{\scriptsize\color{blue}}        % Section winzig (war \footnotesize)
\renewcommand{\cftsubsecfont}{\tiny\color{blue}}           % Subsection minimal (war \scriptsize)
\renewcommand{\cftchappagefont}{\footnotesize}
\renewcommand{\cftsecpagefont}{\scriptsize\color{blue}}
\renewcommand{\cftsubsecpagefont}{\tiny\color{blue}}
\renewcommand{\cfttoctitlefont}{\normalsize\bfseries\color{blue}}  % TOC-Titel kleiner (war \large)

% Optimierte Einrückungen für lange Titel
...
% Define firstpage style (used by some docs)
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textsc{FFGF Theorie}}
...
% ==============================================================================
% Zusätzliche Pakete die nicht in Preamble sind
\usepackage{longtable}
\usepackage{listings}
...
% === CHAPTER 6: PAGE LAYOUT (A4 two-sided book format)
% === GEOMETRY ENTFERNT ===
% Geometry wird jetzt in den Master-Dokumenten definiert (Teil*.tex)
% Siehe UMSTELLUNG_2_PREAMBLES_COMPLETE.txt für Details

% ============================================================================

% =============================================================================
% cleardoublepage: leere Seite einfügen, aber OHNE Kopfzeile und Seitenzahl
% =============================================================================
\makeatletter
\def\cleardoublepage{%
  \clearpage
...
% Additional definitions for shared preambles
% ============================================================================

% Weyl tensor and related physics definitions
\providecommand{\Weyl}{\mathrm{Weyl}}
\providecommand{\ZPinch}{\nabla p = \mathbf{J} \times \mathbf{B}}
\providecommand{\SynchPower}{P_{\text{synch}}}

% Lambda bar (Compton wavelength)
\providecommand{\lambdabar}{\bar{\lambda}}

% Feynman diagrams - requires LuaLaTeX
\usepackage[compat=1.1.0]{tikz-feynman}

% Vorsicht/Warning Environment
\newenvironment{vorsicht}{%
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=\textbf{Vorsicht}]
}{%
  \end{tcolorbox}
}
