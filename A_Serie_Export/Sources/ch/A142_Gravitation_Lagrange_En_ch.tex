...
\begin{itemize}[leftmargin=2em,itemsep=2pt,topsep=2pt]
  \item Dimensional consistency of all terms numerically; limiting case Dirac
    ...
    \path{python/A_Serie_Skripte/a142_gravitation_lagrange.py}
\end{itemize}
...
This document subsumes: Doc.~067 (time-field Lagrangian density with dimensional
...
taken over: the section on a static universe from Doc.~067 -- it does not belong
