...
| 📦 Zenodo v1.2.3 | [DOI 10.5281/zenodo.21396624](https://doi.org/10.5281/zenodo.21396624) (supersedes v1.2.2 · [21266963](https://doi.org/10.5281/zenodo.21266963)) |
...
| Version | DOI | Focus |
|---------|-----|-------|
| v1.2.3 | [21396624](https://doi.org/10.5281/zenodo.21396624) | **Doc. 301 — the reversibility test:** fundamental ⟺ reversible; information is the OUTPUT of a comparator, the bit the ultimate irreversible reduction, Landauer kT ln2 that irreversibility; three levels of information (bit / description / absolute identity); reflexive close — temporal & topological boundarylessness as consequences, the realist posit and the “Word reflex” marked beyond the mathematics (P35). **Doc. 302 — elementary cells, one-bit capacity and partition invariance (a spectral answer):** the minimal information unit is the topological winding quantum Δw=1 (π₁(T⁴)≅ℤ⁴, scale-universal, Doc. 257); ln2 is the thermodynamic shadow (E_bit=ħc/L, Landauer a special case); area excluded as a fundamental bit-definition (∂T⁴=∅, a lossy projection surface); four-category governance ledger — declared assumption / definition (bit≙Δw=1) / derived / empirical / named posit. **Doc. 303 — representational identity across role changes:** a definition identifies an object, governance preserves its identity across later transitions; a five-way preservation record (preserve / project / transform / substitute / bridge) prevents silent role drift between independently developed frameworks. **Doc. 304 — the memory reflex:** experienced time presupposes time rather than producing it (counterpart of the Word reflex); time is D(k)=Σ100ξ_n→ln(1+k/75), fundamental, and the accumulation-vs-kernel boundary sits in time, not memory; a measurement excerpt is reference-less and the apparent uniformity of time is a linearisation artefact with verified error e=x−ln(1+x) (scale-invariant 1−ln2), the linearisation living in the projection not the measurement; inference from measurement to cause limited by a holographic blur; a dedicated provenance section draws the bridge to an external operational Mτ/MB as a restricted, optional candidate (Category B), symmetric, named provenance, no benchmark performed (P35). **Doc. 305 — the curvature-fidelity discriminator:** at equal reach a reach metric cannot separate a curvature-faithful (log-spiral) from a uniform accumulator, while the e-criterion does — self-similarity D(2k)−D(k)→ln2, pitch decay 1/n, scale ratio→e (proven, script-verified); no cognitive-MB specificity established (restricted, Category B). **Doc. 306 — native time–energy reciprocity:** the Heisenberg-based justification for the absence of a cosmic initial singularity (Docs. 025/063) is *replaced*, not refuted — three defects named (an inverted implication: finite Δt gives a *finite* bound, not ΔE→∞; a misapplication: energy–time uncertainty is not canonical and its Δt is an observable's change time, not a cosmic age; and a breach of ledger style). The replacing chain is native: T·m = 1, hence T·E = 1 (an equation, not an inequality) ⇒ E→∞ ⟺ T→0; but FFGFT time carries a minimal increment d₁ = 100ξ₁ = 1/75 fixed by ξ, so E is bounded above and an infinite density is structurally excluded. Plus the boundary question: ∂T⁴ = ∅ — "what was at t=0?" presupposes a boundary a compact torus does not have; the question is wrongly posed, not wrongly answered. Also **Doc. 190 R48** — the Doc. 304 bridge-boundary revision registered — and **R49/R50** — the Spiral-Time vocabulary cited at first use (Doc. 304), and the Heisenberg-import replacement registered, with Docs. 025/063 marked no longer authoritative for that point · **Doc. 307 — time in the state space, or beside it:** whether time is a direction *within* the state space or a parameter *beside* it — same operator formalism, different placement; the lepton masses in three inter-translatable representations (quantum numbers + fractal correction K_frak / Yukawa-ladder / Z₃-circulant-Koide with θ=2/9), the dimensionless ratios exact and only the SI step carrying corrections; time discrete (d₁=100ξ=1/75, Doc. 306) yet a common base tick because the modes stand in exact relation (harmonics, not free clocks); cosmological sector deliberately excluded; A4 standalone with full bibliography. Also **Doc. 190 R54** — N₀ (ladder base unit ≈38.6) is not a theory base unit but a ladder-internal open factor, and the discreteness of Doc. 306 implies a common base tick via the exact mode relations |
| v1.2.2 | [21266963](https://doi.org/10.5281/zenodo.21266963) | FFGFT-internal clarifications: Standard Model as a decompactified projection of the compact T⁴ structure (Doc. 298); the fractal correction factor **K_frak = 1 − 100ξ = 74/75** read from the closure comma of the 75-winding, anchored in Doc. 133 (RG running, m_e/m_μ consistency) — the comma re-expresses 100ξ, it does not derive it (Doc. 300); ι embedding protocol with a derived witness (BLP back-flow 5.125), time sector **admitted, not forced** (Doc. 299). HLV secondary, test direction FFGFT→HLV |
| v1.2.1 | [21203746](https://doi.org/10.5281/zenodo.21203746) | FFGFT-internal clarification of the time-winding: the log spiral with ratio e (Doc. 295) is equivalently a Hilbert-space memory kernel (Doc. 283, on the lossless bijection H = L²(T⁴)⊗ℂ³, Doc. 230/282) — the Hilbert-space translation covers time too; several equivalent routes to the same result (representational robustness, not additional evidence, P35). Also Doc. 296: Time, Openness and Invariance — narrative overview of observer/scale structure, scale sequence as projection shifts, transitions/anomalies, open time structure (no beginning, no end). Also Doc. 297: HLV as a possible subset — candidate note; Markov-limit/hard-reset kernel as embedding candidate for Marcel's U₃; accumulation as the actual memory achievement |
