...
| 📦 Zenodo v1.2.0 | DOI to be assigned on upload (supersedes v1.1.9 · [21193007](https://doi.org/10.5281/zenodo.21193007)) |
...
| Version | DOI | Focus |
|---------|-----|-------|
| v1.2.0 | *DOI on upload* | Spiral-time comparison completed: FFGFT's time-winding (log spiral with e) against HLV's spiral time — two disjoint HLV "spiral times", e-criterion negative (no HLV strand carries e), basis/dimensions same number/different meaning, time also as a Hilbert-space memory kernel (Doc. 294/295) |
