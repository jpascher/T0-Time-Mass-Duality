...
Diese Revision fügt zwei neue Dokumente hinzu, die den Galois-Sektor
von GF(27)* auf den Neutrino-Bereich ausdehnen:

### Dok. 339 — Frobenius-Trennung massiv/masselos in GF(27)*
- Frobenius-Zerlegung GF(27)* ≅ Z₂ × Z₁₃, vier Dreier-Orbits
- Fixpunkte {+1,−1} = massiver Sektor; 8 Dreier-Orbits = Gluonen
- Konforme Skalierungssymmetrie k↦3k im Typ-III-Pullback
- Prüfskript: `pruef_339_frobenius.py` (6/6 Assertions)
- Status: [K]

### Dok. 340 — Neutrino-Massenhierarchie aus GF(27)*
- Atmosphärische Massendifferenz: Δm²_atm = 120·m_ν² (Abw. 1.0 %)
- Solare Massendifferenz: Δm²_sol = (11/3)·m_ν² (Abw. 0.46 %)
- Beide aus der Zahl 11 = max({7,8,11}) = 4. Frobenius-Orbit in Z₁₃
- Orbit 3 {4,10,12} selbstinvers → Majorana-Charakter; Σ = 26 = |GF(27)*|
- Venting-Amplitude p = 5/24 = |A₅:A₄| / Kissing(D₄), algebraisch bewiesen
  via Branching-Rule ρ₄↓_A₄ = ρ₃^A₄ ⊕ ρ₁^A₄
- SICC-Venting-Formel identisch mit Standard-Oszillationsformel
- Neutrinomassen (normale Hierarchie): m₁ = 4.54, m₃ = 9.81, m₂ = 49.96 meV
  Summe 64.3 meV < 120 meV (Planck-Grenze) ✓
- m_ee ≈ 7.1 meV < 36 meV (KamLAND-Zen) ✓
- Prüfskript: `pruef_340_neutrino_galois.py` (10/10 Assertions)
- Status: [B] für Gruppentheorie, [K] für Massendifferenzen
