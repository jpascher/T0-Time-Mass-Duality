...
% =============================================================================
% SECTION 2: Page Geometry - KDP 6x9" Format
% =============================================================================
% Set page size to 6x9 inches with KDP-compliant margins
\usepackage[paperwidth=6in, paperheight=9in, inner=0.625in, outer=0.625in, top=0.625in, bottom=1.0in, twoside]{geometry}
...
% =============================================================================
% SECTION 3a: Kindle Formula Optimization
% =============================================================================
% Prevent inline math formulas from being scaled down for Kindle readability
% \everymath{\displaystyle}      % Use display style in all inline math - COMMENTED OUT: causes "Improper \halign" errors with align environments
% \everydisplay{\displaystyle}   % Ensure display math uses display style - COMMENTED OUT: causes "Improper \halign" errors with align environments
\relpenalty=10                 % Allow line breaks at relation symbols
\binoppenalty=10               % Allow line breaks at binary operators

% Increase math subscript/superscript sizes for Kindle readability
\DeclareMathSizes{11}{11}{9}{8}    % For 11pt base: script=9pt, scriptscript=8pt
\DeclareMathSizes{10.95}{11}{9}{8} % For normalsize
