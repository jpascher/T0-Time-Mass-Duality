...
% Additional common environments
\provideenvironment{vorsicht}{%
	\begin{mdframed}[linecolor=orange!50,linewidth=2pt,roundcorner=4pt,backgroundcolor=orange!10]%
	\textbf{Caution:} 
	}{%
	\end{mdframed}%
}

\provideenvironment{warnung}{%
	\begin{mdframed}[linecolor=red!60,linewidth=2pt,roundcorner=4pt,backgroundcolor=red!15]%
	\textbf{Warning:} 
	}{%
	\end{mdframed}%
}

\provideenvironment{hinweis}{%
