...
\emergencystretch=3em      % Allow more stretch to avoid overfull boxes
\hyphenpenalty=500         % Make hyphenation more likely
\tolerance=2000            % Increase tolerance for word spacing
\hbadness=2000            % Suppress overfull warnings below this threshold
